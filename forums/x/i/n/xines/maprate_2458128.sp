...
public OnPluginStart()
{
	...
	MapRateTime = CreateConVar("sm_maprate_time", "60", "Time in seconds for vote to send.", FCVAR_PLUGIN|FCVAR_NOTIFY);
...
public Action CheckPlayer(Handle timer, any serial)
{
...
{
	CreateTimer(GetConVarFloat(MapRateTime), CheckPlayer, GetClientSerial(client));
	g_lastRateTime[client] = GetTime();
}