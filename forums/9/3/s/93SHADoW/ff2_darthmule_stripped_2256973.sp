...
public Plugin:myinfo = {
    ...
    author = "Darthmule, edit by Deathreus, updated by SHADoW NiNE TR3S",
    version = "1.3",
};
...
Rage_Condition(const String:ability_name[], index)
{
    ...
    {
        if(IsClientInGame(i) && IsPlayerAlive(i) && GetClientTeam(i)!=FF2_GetBossTeam() && !TF2_IsPlayerInCondition(i,TFCond_Ubercharged))
        {
