...
bool:CanBeRolled(client, g_eCurrentPerk:nPerk)
{
	...
	switch(nPerk)
	{
		...
		case PERK_HOMING:
		{
			...
			if(!StrContains(strPrimary,"tf_weapon_rocketlauncher") || !StrContains(strPrimary,"tf_weapon_compound_bow") || !StrContains(strPrimary,"tf_weapon_flaregun") || !StrContains(strPrimary,"tf_weapon_crossbow"))
			{
