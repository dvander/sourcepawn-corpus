...
rage_new_weapon:	arg0 - slot (def.0)
					...
					arg8 - timed weapon? (0 - no, any other value - time limit in seconds).
					arg9 - old weapon's classname
					arg10 - old weapon's index
					arg11 - old weapon's attributes
					arg12 - old weapon's slot (0 - primary. 1 - secondary. 2 - melee. 3 - pda. 4 - spy's watches)
					arg13 - old weapon's ammo
					arg14 - old weapon's clip size (if any)
*/
#pragma semicolon 1
