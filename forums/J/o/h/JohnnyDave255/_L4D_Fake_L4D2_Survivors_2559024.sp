...
#define BILL		GetEntProp(client, Prop_Send, "m_survivorCharacter") == 8
...
#define SET_CHARACTER_BILL 			SetEntProp(client, Prop_Send, "m_survivorCharacter", 8);
		...
		if (GetClientTeam(client)==2)
		{
			if(GetConVarInt(cvarPluginMode)==1)
			{
				...
				switch(model)
				{
					...
					case 4: // Bill
					{
						SetEntData(client, FindSendPropInfo("CTerrorPlayer", "m_survivorCharacter"), 8, 1, true);
