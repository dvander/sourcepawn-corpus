...
#define PLUGIN_VERSION "1.4.c" // custom
...
new Handle:l4d2_tank_dead_hint;
...
public OnPluginStart()
{
	...
	else
	{
		...
		l4d2_tank_dead_hint = CreateConVar("l4d2_tank_dead_hint", "", "", FCVAR_PLUGIN|FCVAR_SPONLY);
...
//		return Plugin_Continue;
	...
	else if (StrEqual("Tank", strBuffer, false))
	{
		...
		new String:cvar_l4d2_tank_dead_hint[256];
		GetConVarString(l4d2_tank_dead_hint, cvar_l4d2_tank_dead_hint, sizeof(cvar_l4d2_tank_dead_hint));
		if (StrEqual(cvar_l4d2_tank_dead_hint, "", false) == true)
		{
			PrintHintTextToAll(cvar_l4d2_tank_dead_hint);
		}
