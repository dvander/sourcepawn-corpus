...
public Action:Command_Say(client, args)
{
	...
	{
		if (DifficultyMultiplier[client] != 0.5)
		{
			SetClientInfo(client, "_dv", "easy");
			DifficultyMultiplier[client] = 0.5;
	...
	{
		if (DifficultyMultiplier[client] != 1.5)
		{
			SetClientInfo(client, "_dv", "hard");
			DifficultyMultiplier[client] = 1.5;
			GetTotalDifficultyMultiplier();
			Autodifficulty(GetRealClientCount(true));
			PrintToChatAll("\x05%N changed Difficulty Multiplier to \x04%f.", client, DifficultyMultiplier[0]);
		}
...
//	GetTotalDifficultyMultiplier();
	...
	if (playerscount > 4)
	{
		...
		SetConVarInt(z_smoker_speed, 210 + RoundToZero(1.2 * (playerscount - 4) * DifficultyMultiplier[0]), false, false); 
		SetConVarInt(z_boomer_speed, 175 + RoundToZero(1.5 * (playerscount - 4) * DifficultyMultiplier[0]), false, false); 
		...
		SetConVarInt(l4d_loot_charger_cycles, RoundToZero(playerscount * DifficultyMultiplier[0]), false, false);

		SetConVarInt(l4d_loot_tank_chance, RoundToZero(playerscount / 20.0), false, false);
		SetConVarInt(l4d_loot_tank_cycles, RoundToZero(playerscount * 1.6 * DifficultyMultiplier[0]), false, false);

		SetConVarInt(z_hunter_health, 250 + RoundToZero(137.5 * playerscount * DifficultyMultiplier[0]), false, false);
		SetConVarInt(z_smoker_health, 80 + RoundToZero(146.0 * playerscount * DifficultyMultiplier[0]), false, false);
		SetConVarInt(z_boomer_health, 50 + RoundToZero(47.5 * playerscount * DifficultyMultiplier[0]), false, false);
		SetConVarInt(z_charger_health, 600 + RoundToZero(400.0 * playerscount * DifficultyMultiplier[0]), false, false);
		SetConVarInt(z_spitter_health, 50 + RoundToZero(47.5 * playerscount * DifficultyMultiplier[0]), false, false);
		SetConVarInt(z_jockey_health, 325 + RoundToZero(167.1875 * (playerscount - 4) * DifficultyMultiplier[0]), false, false);
		SetConVarInt(z_witch_health, 1000 + RoundToZero(200.0 * playerscount * DifficultyMultiplier[0]), false, false);
		SetConVarInt(z_health, RoundToZero(12.5 * playerscount * DifficultyMultiplier[0]), false, false);

		SetConVarInt(grenadelauncher_damage, 400 + RoundToZero(725 * (playerscount - 4) * DifficultyMultiplier[0]), false, false);
	}
	else
	{
		SetConVarInt(z_hunter_health, 250, false, false);
	...
	SetConVarInt(l4d_loot_hunter_cycles, RoundToZero(playerscount * DifficultyMultiplier[0]), false, false);
	SetConVarInt(l4d_loot_smoker_cycles, RoundToZero(playerscount * DifficultyMultiplier[0]), false, false);
	SetConVarInt(l4d_loot_boomer_cycles, RoundToZero(playerscount * DifficultyMultiplier[0]), false, false);
	SetConVarInt(l4d_loot_spitter_cycles, RoundToZero(playerscount * DifficultyMultiplier[0]), false, false);
	SetConVarInt(l4d_loot_jockey_cycles, RoundToZero(playerscount * DifficultyMultiplier[0]), false, false);
}