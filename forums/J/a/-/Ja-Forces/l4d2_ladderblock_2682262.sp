...
public void OnPluginStart()
{
	...
	g_hCvarFlags = CreateConVar("l4d2_ladderblock_flags", "862", "Who can push trolls when climbs on the ladder. Flags (add together): 0=Disable, 2=Smoker, 4=Boomer, 8=Hunter, 16=Spitter, 64=Charger, 256=Tank, 512=Survivors, 862=All", 0, true, 0.0, true, 862.0);
	g_hCvarImmune = CreateConVar("l4d2_ladderblock_immune", "0", "What class is immune. Flags (add together): 0=Disable, 2=Smoker, 4=Boomer, 8=Hunter, 16=Spitter, 32=Jockey, 64=Charger, 256=Tank, 512=Survivors, 894=All", 0, true, 0.0, true, 894.0);
	
	AutoExecConfig(true, "l4d2_ladderblock");
...
public void SDKHook_cb_Touch(int entity, int other)
{
	...
	if (IsGuyTroll(entity, other))
	{
		...
		if (iClass != 5 && g_iCvarFlags & (1 << iClass))
		{
			...
			if (g_iCvarImmune & (1 << iClass) || g_bInCharge[other]) 
			{
				return;
			}
