...
public OnPluginStart(){
  g_versionConVar = CreateConVar("dod_damage_report_version", PLUGIN_VERSION, "Damage report version", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);
...
{
  new healthDmg = GetEventInt(event,"damage");	//dmg_health
