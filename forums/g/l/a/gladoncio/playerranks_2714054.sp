...
#define PLUGIN_PREFIX_PLAIN 		"[Player Ranks 4.0.2]"		   		// Our console friendly prefix.
...
public bool:OnClientConnect(client, String:rejectmsg[], maxlen)
{
 ...
 CreateTimer(15.0, Timer_Advertise2, client);
...
{
 if (IsClientInGame(client))
ServerCommand("sm_rcon sm plugins load playerranks");
 else if (IsClientConnected(client))
  CreateTimer(15.0, Timer_Advertise, client);
  
}

 public Action:Timer_Advertise2(Handle:timer, any:client)
{
 if (IsClientInGame(client))
 CPrintToChat(client, "{azure}[Servilive]{blue} Visita servilive.cl");
 else if (IsClientConnected(client))
  CreateTimer(15.0, Timer_Advertise2, client);
}
