...
public Action:Cmd_RateList(client,args)
{
	...
	new String:interp[10],String:update[10],String:cmd[10],String:rate[10],String:name[32],String:interpolate[10]
	
	PrintToConsole(client,"Name Rate UpdateRate CmdRate Interp Interpolate")
	...
	for (new i=1; i<=maxplayers;i++)
	{
		...
		PrintToConsole(client,"%s %s %s %s %s %s",name,rate,update,cmd,interp,interpolate)
