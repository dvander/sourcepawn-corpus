...
#define PLUGIN_NAME "Log Connections - LL Mod"

public Plugin:myinfo =
{
	name = PLUGIN_NAME,
	author = "Xander Player_1, goodBEan",
	description = "This plugin logs players' connect and disconnect times along with their Name, SteamID, and IP Address to a text file at /sourcemod/logs/ seperate from the server logs.",
