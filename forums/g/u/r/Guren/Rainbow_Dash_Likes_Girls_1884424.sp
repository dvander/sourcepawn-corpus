// File Name : Rainbow Dash Likes Girls.sp
// File Version : 1.0.1
...
public Action:Command_encrypt(client, Arguments)
{
	...
	new String:ScanChar[256], String:MainChar[256], String:OriginalChar[256];
...
public Action:Command_decrypt(client, Arguments)
{
	...
	new String:ScanChar[256], String:MainChar[256], Length = 0;
	GetCmdArg(1, ScanChar, sizeof(ScanChar));
