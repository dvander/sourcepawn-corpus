...
#define sNotice "\x01[\x0700FF00Notice\x01]"
...
{
	CreateConVar("nmrih_weaponmenu_version", Plugin_Version, "This is the version of the Weapon Menu the server is running.", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
