...
public OnPluginStart()
{
	...
	*/
	...
	"Which sound should we play when ammo is picked up?\n1 = cstrike/sound/items/itempickup.wav \n2 = hl2/sound/items/ammo_pickup.wav", _, true, 1.0, true, 2.0)), OnSoundTypeChanged);
...
public DropAmmo(any:weapon, any:WeaponSlot0, any:WeaponSlot1, any:client, any:ammo)
{
	...
	if((ent = CreateEntityByName("prop_physics_multiplayer")) != -1)
	{
		...
		DispatchKeyValue(ent, "massScale", "10.0"); // A scale multiplier for the object's mass, too light and it moves too easy with blasts
		...
		SetEntProp(ent, Prop_Send, "m_CollisionGroup", COLLISION_GROUP_DEBRIS|COLLISION_GROUP_WEAPON);
