...
public OnPluginStart(){
	CreateConVar("sm_saysounds_version", PLUGIN_VERSION, "Say Sounds Version", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
	...
	cvarplayifclsndoff = CreateConVar("sm_play_cl_snd_off","0","Allow clients turned their sounds off to trigger sounds? (0=off | 1=on)",FCVAR_PLUGIN);
	/*####FernFerret####*/
