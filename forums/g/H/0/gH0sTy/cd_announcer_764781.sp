...
public OnPluginStart()
{
	...
	PrintMode	=	CreateConVar( "cd_mode", 	"1",	"1 = by SteamId, 2 = by Ip, 3 = ip and SteamId, 4 = No ip and SteamId (Def 1)" );
...
public OnClientPostAdminCheck( client ){
	...
	decl String:gIp[16], String:gAuth[21], String:gCountry[46], String:gCountry2[3];
	decl String:Time[21], String:iLogFileLoc[PLATFORM_MAX_PATH], String:LogFileLoc[PLATFORM_MAX_PATH];
	//new bool:gCountryShort=false;
			...
			switch( Code )
			{
				case 0: 
				{
					switch( Log )
					{
						...
						case 1:
						{
							PrintToChatAll( "%t", "Connected_Country_1", gName);
							WriteFileLine( File,"[%s] %s[%s][%s] connected", Time, gName, gAuth, gIp );
						}
						case 2:	WriteFileLine( File,"[%s] %s[%s][%s] connected", Time, gName, gAuth, gIp );
					}
				...
				case 1: 
				{
					switch( Log )
					{
						case 0: PrintToChatAll( "%t", "Connected_Country_2", gName, gCountry);
						case 1:
						{
							PrintToChatAll( "%t", "Connected_Country_2", gName, gCountry);
							WriteFileLine( File,"[%s] %s(%s)[%s][%s] connected", Time, gName, gCountry, gAuth, gIp );
						}
						case 2:	WriteFileLine( File,"[%s] %s(%s)[%s][%s] connected", Time, gName, gCountry, gAuth, gIp );
					}						
...
public OnClientDisconnect( client )
{
	...
	decl String:gName[MAX_NAME_LENGTH+1], String:iFile[256];
	decl String:gIp[26], String:gAuth[21], String: gCountry[46], String: gCountry2[3];
	decl String:Time[21],  String:iLogFileLoc[PLATFORM_MAX_PATH], String:LogFileLoc[PLATFORM_MAX_PATH];
			...
			switch( Code )
			{
				case 0: 
				{
					switch( Log )
					{
						...
						case 1:
						{
							PrintToChatAll( "%t", "Disconnected_Country_1", gName);
							WriteFileLine( File,"[%s] %s[%s][%s] disconnected", Time, gName, gAuth, gIp );
						}
						case 2:	WriteFileLine( File,"[%s] %s[%s][%s] disconnected", Time, gName, gAuth, gIp );
					}
				...
				case 1: 
				{
					switch( Log )
					{
						case 0: PrintToChatAll( "%t", "Disconnected_Country_2", gName, gCountry);
						case 1:
						{
							PrintToChatAll( "%t", "Disconnected_Country_2", gName, gCountry);
							WriteFileLine( File,"[%s] %s(%s)[%s][%s] disconnected", Time, gName, gCountry, gAuth, gIp );
						}
						case 2:	WriteFileLine( File,"[%s] %s(%s)[%s][%s] disconnected", Time, gName, gCountry, gAuth, gIp );
					}						
