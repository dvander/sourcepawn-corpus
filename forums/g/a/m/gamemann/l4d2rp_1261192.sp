...
public Action:CmdPick(client, args)
{
    ...
    switch(RandomPick)
    {
        case 1:
        {
			...
			SetCommandFlags("give", Flags && client);
        ...
        case 4:
        {
            if(GetConVarInt(HordeE))
            {
				...
				SetCommandFlags("director_force_panic_event", Flags && client);
        ...
        case 7:
        {
            ...
            {
				new Flags = GetCommandFlags("z_mob_spawn_max_size");
				SetCommandFlags("z_mob_spawn_max_size", Flags && client);
        ...
        case 9:
        {
            ...
            {
				new Flags = GetCommandFlags("director_force_panic_forever");
				SetCommandFlags("director_force_panic_forever", Flags && client);
