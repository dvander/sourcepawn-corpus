...
#define PLUGIN_VERSION 		"1.9-gabuch2"
...
ConVar g_hCvarAllow, g_hCvarMPGameMode, g_hCvarModes, g_hCvarModesOff, g_hCvarModesTog, g_hCvarChance1, g_hCvarChance2, g_hCvarChance3, g_hCvarCount, g_hGameDrop, g_hCvarDrop, g_hCvarSize, g_hCvarSpeed, g_hCvarHeal, g_hCvarRefillTier3;// g_hCvarSizeStart
int g_iCvarChance1, g_iCvarChance2, g_iCvarChance3, g_iTotalChance, g_iCvarCount, g_iDeathCount, g_iCvarHeal;
bool g_bCvarAllow, g_bMapStarted, g_bCvarRefillTier3;
...
void HealPlayer(int client)
{
	if(!L4D_IsPlayerIncapacitated(client))
	{
		...
		int iTempHealth = L4D_GetPlayerTempHealth(client);
		if(iHealth+iTempHealth+g_iCvarHeal > 100)
			L4D_SetPlayerTempHealth(client, 100-iHealth);
		else
			L4D_SetPlayerTempHealth(client, g_iCvarHeal+iTempHealth);
