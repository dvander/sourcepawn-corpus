...
ClientSaveToFileSave(targetid)
{
	...
	if(savetofilemode != 0)
	{
		...
		KvSetNum(kv, "Rookie Level", ClientLevelJob[targetid][1])
		KvSetNum(kv, "Scout Level", ClientLevelJob[targetid][2])
		KvSetNum(kv, "Soldier Level", ClientLevelJob[targetid][3])
		KvSetNum(kv, "Medic Level", ClientLevelJob[targetid][4])
		KvSetNum(kv, "Pain Master Level", ClientLevelJob[targetid][5])
		KvSetNum(kv, "Sniper Level", ClientLevelJob[targetid][6])
		KvSetNum(kv, "Weapon Dealer Level", ClientLevelJob[targetid][7])
		KvSetNum(kv, "Firebug Level", ClientLevelJob[targetid][8])
		KvSetNum(kv, "Witch Hunter Level", ClientLevelJob[targetid][9])
		KvSetNum(kv, "Tank Buster Level", ClientLevelJob[targetid][10])
		KvSetNum(kv, "Task Force Level", ClientLevelJob[targetid][11])
		KvSetNum(kv, "General Level", ClientLevelJob[targetid][12])
		KvSetNum(kv, "Mighty Master Level", ClientLevelJob[targetid][13])
		KvRewind(kv)
...
ClientSaveToFileLoad(targetid)
{
	...
	if(savetofilemode != 0)
	{
		...
		ClientLevelJob[targetid][1] = KvGetNum(kv, "Rookie Level", 0)
		ClientLevelJob[targetid][2] = KvGetNum(kv, "Scout Level", 0)
		ClientLevelJob[targetid][3] = KvGetNum(kv, "Soldier Level", 0)
		ClientLevelJob[targetid][4] = KvGetNum(kv, "Medic Level", 0)
		ClientLevelJob[targetid][5] = KvGetNum(kv, "Pain Master Level", 0)
		ClientLevelJob[targetid][6] = KvGetNum(kv, "Sniper Level", 0)
		ClientLevelJob[targetid][7] = KvGetNum(kv, "Weapon Dealer Level", 0)
		ClientLevelJob[targetid][8] = KvGetNum(kv, "Firebug Level", 0)
		ClientLevelJob[targetid][9] = KvGetNum(kv, "Witch Hunter Level", 0)
		ClientLevelJob[targetid][10] = KvGetNum(kv, "Tank Buster Level", 0)
		ClientLevelJob[targetid][11] = KvGetNum(kv, "Task Force Level", 0)
		ClientLevelJob[targetid][12] = KvGetNum(kv, "General Level", 0)
		ClientLevelJob[targetid][13] = KvGetNum(kv, "Mighty Master Level", 0)
		CloseHandle(kv)
	}
}
