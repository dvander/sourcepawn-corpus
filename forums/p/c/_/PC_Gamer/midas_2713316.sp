...
#define DMG_MELEE 	DMG_CLUB | DMG_SLASH | DMG_BLAST_SURFACE | DMG_NEVERGIB
...
public Plugin myinfo = 
{
	...
	description = "Victim turns to gold when hit by melee weapon",
...
public void OnPluginStart()
{
	...
	RegAdminCmd("sm_nomidas", Command_NoMidas, ADMFLAG_SLAY, "Enjoy being King Midas");	
...
{
	if( !IsValidClient(victim) || !IsValidClient(attacker) || !g_bIsMidas[attacker] || g_bIsMidas[attacker] == g_bIsMidas[victim])
