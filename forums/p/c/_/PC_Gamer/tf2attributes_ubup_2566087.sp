...
//									* 0.5 * (MoneyForTeamRatio[team_c]) * (MoneyForTeamRatio[team_c]))
//						iCashtmpb += iCashtmpc 
//						SetEntProp(client_id, Prop_Send, "m_nCurrency", iCashtmpb);
//						client_iCash[client_id] = iCashtmpb
//					}
...
public UberShopinitMenusHandlers()
{
	...
	cvar_StartMoney = 					CreateConVar("sm_uu_startmoney", "1000", "Sets the starting money: default 600");
