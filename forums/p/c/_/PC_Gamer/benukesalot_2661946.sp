...
public OnPluginStart()
{
	...
	CreateConVar("nukesalot_version", PLUGIN_VERSION, "[TF2] Be the Nukesalot version", FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_SPONLY);
	g_hCvarThirdPerson = CreateConVar("bedeflector_thirdperson", "0", "Whether or not nukesalot ought to be in third-person", 0, true, 0.0, true, 1.0);
