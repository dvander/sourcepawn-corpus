...
public OnPluginStart()
{
	...
	cvar_show_damage = CreateConVar("sm_show_damage", "1");
	cvar_show_damage_ff = CreateConVar("sm_show_damage_ff", "1");
	cvar_show_damage_own_dmg = CreateConVar("sm_show_damage_own_dmg", "1");
	cvar_show_damage_text_area = CreateConVar("sm_show_damage_text_area", "1");
