...
new Handle:bleedTimer[MAXPLAYERS+1];
...
{
	name = "DoD Realism Physics",
	author = "psychocoder, playboycyberclub",
...
{
	CreateConVar("sm_realismphysics_version", PLUGIN_VERSION, "Version of dodRealismPhysics", FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);
	C_Drop = CreateConVar("sv_realismphysics_drop", "1", " When players get hurt in the arm, they drop their weapon (0 to disable, 1 to enable: default=1)");
	C_Slow = CreateConVar("sv_realismphysics_slow", "1", " Slow down player with more weight (0 to disable, 1 to enable: default=1)");
	C_Grav = CreateConVar("sv_realismphysics_grav", "0", " Change jump height of player with more height (0 to disable, 1 to enable: default=0)");
	C_Blood = CreateConVar("sv_realismphysics_blood", "1", "show blood on screen if you get a hit ofer 40dmg in upper chest or head (0 to disable, 1 to enable: default=0)");
	C_Slow_Value = CreateConVar("sv_realismphysics_slow_value", "0.15", "max slow down newspeed=1-value (default: 0.15)");
	C_Grav_Value = CreateConVar("sv_realismphysics_grav_value", "0.15", "max more gravity down newgravity=1+value (default: 0.15)");
	C_Bleed = CreateConVar("sv_realismphysics_bleed", "1", "aktivate bleeding on hit over 40dmg (0 to disable, 1 to enable: default=0)");
	C_SelfHealBleed = CreateConVar("sv_realismphysics_selfhealbleed", "1", "player cann write !medic to chat and heal bleeding (0 to disable, 1 to enable: default=1)");
	C_FreezeTime = CreateConVar("sv_realismphysics_freezetime", "3.0", "time in seconds how long players freez if he called !medic (littler than 1.0 to disable, default: 3.0)");
	//camping
	C_Camp = CreateConVar("sv_camp", "1", "Activate camp module (0 to disable, 1 to enable: default=1)");	
	C_CampMaxCount = CreateConVar("sv_camp_time", "60", "Time in seconds which player can camp. (default = 60)");
	C_SlapDiff = CreateConVar("sv_camp_diff_time", "10", "Time in seconds between slaps for camping. (default = 10)");
	C_SlapDmg = CreateConVar("sv_camp_slap_dmg", "20", "Dmg for camping. (default = 20)");
