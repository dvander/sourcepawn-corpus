...
public Plugin:myinfo =
{
	...
	author = "Kirisame and modified by Psykotik",
...
{
	PrintToChatAll("\x04You can type\x05 !stats \x04to see your personal kill stats\x04");
}
...
{
	PrintToChat(Client, "\x03Your Personal Skill Stats Info: ");
	PrintToChat(Client, "\x01Boomers Killed:\x04%d\x01/Smokers Killed:\x04%d\x01/Hunters Killed:\x04%d\x01/Jockeys Killed:\x04%d\x01/Chargers Killed:\x04%d\x01/Spitters Killed:\x04%d\x01", playerBoomerKilled[Client], playerSmokerKilled[Client], playerHunterKilled[Client], playerJockeyKilled[Client], playerChargerKilled[Client], playerSpitterKilled[Client]);
	PrintToChat(Client, "\x01Witches Killed:\x04%d\x01/Tank total damage:\x04%d\x01/Common Infected Killed:\x04%d\x01", playerWitchKilled[Client], playerTankDamage[Client], playerCommonKilled[Client]);
