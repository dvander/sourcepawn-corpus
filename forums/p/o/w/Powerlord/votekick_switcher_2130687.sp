...
public OnPluginStart() {
	updaterCvar = CreateConVar("votekick_switcher_auto_update", "0", "Allow Votekick Switcher to update itself? Has no effect if Updater is not installed.");
