...
public PrecacheCharacter(characterIndex)
{
	...
	KvGetString(BossKV[characterIndex], "name", s, PLATFORM_MAX_PATH);
	...
	{	
		...
		{	
			...
			new String:debugString[] = "[FF2 DEBUG] Precached %d model(s) for %s";
			
			PrintToChatAll(debugString, i-1, name);
			PrintToServer(debugString, i-1, name);
		}
		...
		{	
			...
			new String:debugString[] = "[FF2 DEBUG] Precached %d sounds for %s";
