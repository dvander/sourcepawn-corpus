...
public OnPluginStart()
{
	...
	AutoExecConfig(true, "l4d2_Auto_Insanity");
}
	...
	if (Enabled)
	{
		...
		switch (PlayerCount)
		{
			...
			case 2:
			{
			   ...
			   SetConVarInt(FindConVar("z_exploding_health"), 25);
			   SetConVarInt(FindConVar("z_charger_health"), 300);
			   SetConVarInt(FindConVar("z_hunter_health"), 125);
			   SetConVarInt(FindConVar("z_jockey_health"), 25);
			   SetConVarInt(FindConVar("z_gas_health"), 125);
			   SetConVarInt(FindConVar("z_spitter_health"), 75);
			   ...
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_easy"), 120);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_normal"), 110);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_hard"), 100);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_expert"), 90);

			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_easy"), 240);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_normal"), 220);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_hard"), 200);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_expert"), 180);

			   SetConVarInt(FindConVar("z_mega_mob_spawn_min_interval"), 420);
			   SetConVarInt(FindConVar("z_mega_mob_spawn_max_interval"), 360);
			   SetConVarInt(FindConVar("z_mega_mob_size"), 40);
			...
			case 3:
			{
			   ...
			   SetConVarInt(FindConVar("z_exploding_health"), 40);
			   SetConVarInt(FindConVar("z_charger_health"), 450);
			   SetConVarInt(FindConVar("z_hunter_health"), 175);
			   SetConVarInt(FindConVar("z_jockey_health"), 75);
			   SetConVarInt(FindConVar("z_gas_health"), 175);
			   SetConVarInt(FindConVar("z_spitter_health"), 100);
			   SetConVarInt(FindConVar("z_tank_health"), 3000);
			   ...
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_easy"), 110);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_normal"), 100);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_hard"), 90);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_expert"), 80);

			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_easy"), 220);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_normal"), 200);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_hard"), 180);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_expert"), 160);

			   SetConVarInt(FindConVar("z_mega_mob_spawn_min_interval"), 400);
			   SetConVarInt(FindConVar("z_mega_mob_spawn_max_interval"), 600);
			   SetConVarInt(FindConVar("z_mega_mob_size"), 50);


			}
			case 4: // these values are the director defaults
			{
			   SILimit = 3;
			   SpawnTimeMin = 40.0;
			   SpawnTimeMax = 80.0;
			   ...
			   SetConVarInt(FindConVar("z_background_limit"), 50);
			   SetConVarInt(FindConVar("z_common_limit"), 40);

			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_easy"), 100);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_normal"), 90);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_hard"), 80);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_expert"), 70);

			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_easy"), 150);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_normal"), 135);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_hard"), 120);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_expert"), 105);

			   SetConVarInt(FindConVar("z_mega_mob_spawn_min_interval"), 380);
			   SetConVarInt(FindConVar("z_mega_mob_spawn_max_interval"), 570);
			...
			case 5:
			{
			   ...
			   SetConVarInt(FindConVar("z_charger_health"), 650);
			   SetConVarInt(FindConVar("z_hunter_health"), 275);
			   SetConVarInt(FindConVar("z_jockey_health"), 125);
			   SetConVarInt(FindConVar("z_gas_health"), 275);
			   SetConVarInt(FindConVar("z_spitter_health"), 175);
			   SetConVarInt(FindConVar("z_tank_health"), 5000);

			   SetConVarInt(FindConVar("survivor_speed"), 220);

			   SetConVarInt(FindConVar("z_background_limit"), 60);
			   SetConVarInt(FindConVar("z_common_limit"), 45);

			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_easy"), 95);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_normal"), 85);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_hard"), 75);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_expert"), 65);

			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_easy"), 142);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_normal"), 127);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_hard"), 112);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_expert"), 97);

			   SetConVarInt(FindConVar("z_mega_mob_spawn_min_interval"), 360);
			   SetConVarInt(FindConVar("z_mega_mob_spawn_max_interval"), 540);
			...
			case 6:
			{
			   ...
			   SetConVarInt(FindConVar("z_charger_health"), 700);
			   SetConVarInt(FindConVar("z_hunter_health"), 300);
			   SetConVarInt(FindConVar("z_jockey_health"), 150);
			   SetConVarInt(FindConVar("z_gas_health"), 300);
			   SetConVarInt(FindConVar("z_spitter_health"), 200);
			   SetConVarInt(FindConVar("z_tank_health"), 6000);

			   SetConVarInt(FindConVar("survivor_speed"), 230);

			   SetConVarInt(FindConVar("z_background_limit"), 70);
			   SetConVarInt(FindConVar("z_common_limit"), 50);

			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_easy"), 90);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_normal"), 80);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_hard"), 70);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_expert"), 60);

			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_easy"), 135);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_normal"), 120);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_hard"), 105);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_expert"), 90);

			   SetConVarInt(FindConVar("z_mega_mob_spawn_min_interval"), 340);
			   SetConVarInt(FindConVar("z_mega_mob_spawn_max_interval"), 510);
			...
			case 7:
			{
			   ...
			   SetConVarInt(FindConVar("z_exploding_health"), 125);
			   SetConVarInt(FindConVar("z_charger_health"), 750);
			   SetConVarInt(FindConVar("z_hunter_health"), 320);
			   SetConVarInt(FindConVar("z_jockey_health"), 175);
			   SetConVarInt(FindConVar("z_gas_health"), 325);
			   SetConVarInt(FindConVar("z_spitter_health"), 225);
			   SetConVarInt(FindConVar("z_tank_health"), 7000);

			   SetConVarInt(FindConVar("survivor_speed"), 240);

			   SetConVarInt(FindConVar("z_background_limit"), 80);
			   SetConVarInt(FindConVar("z_common_limit"), 55);

			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_easy"), 85);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_normal"), 75);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_hard"), 65);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_expert"), 55);

			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_easy"), 127);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_normal"), 112);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_hard"), 97);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_expert"), 82);

			   SetConVarInt(FindConVar("z_mega_mob_spawn_min_interval"), 320);
			   SetConVarInt(FindConVar("z_mega_mob_spawn_max_interval"), 480);
			...
			case 8:
			{
			   ...
			   SetConVarInt(FindConVar("z_exploding_health"), 150);
			   SetConVarInt(FindConVar("z_charger_health"), 800);
			   SetConVarInt(FindConVar("z_hunter_health"), 350);
			   SetConVarInt(FindConVar("z_jockey_health"), 200);
			   SetConVarInt(FindConVar("z_gas_health"), 350);
			   SetConVarInt(FindConVar("z_spitter_health"), 250);
			   SetConVarInt(FindConVar("z_tank_health"), 8000);

			   SetConVarInt(FindConVar("survivor_speed"), 250);

			   SetConVarInt(FindConVar("z_background_limit"), 90);
			   SetConVarInt(FindConVar("z_common_limit"), 60);

			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_easy"), 80);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_normal"), 70);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_hard"), 60);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_expert"), 50);

			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_easy"), 120);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_normal"), 105);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_hard"), 90);
			   SetConVarInt(FindConVar("z_mob_spawn_max_interval_expert"), 75);

			   SetConVarInt(FindConVar("z_mega_mob_spawn_min_interval"), 300);
