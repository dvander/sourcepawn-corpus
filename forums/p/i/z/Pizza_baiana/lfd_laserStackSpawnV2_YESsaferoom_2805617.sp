...
public void OnPluginStart() {
	cvarChance = CreateConVar("laser_autospawn_chance", "100", "Chance of a laser box spawning on the ammo pile", FCVAR_NONE);
	cvarIgnoreSaferoom = CreateConVar("laser_autospawn_ignoresaferoom", "0", "If set to 1 the laserboxes will not spawn in the saferoom", FCVAR_NONE);
