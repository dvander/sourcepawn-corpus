...
//Parachute Model
#define PARACHUTE_MODEL        "parachute_bf"

//Parachute Textures
#define PARACHUTE_PACK        "pack_carbon"
#define PARACHUTE_TEXTURE    "parachute_c"
...
public OnMapStart(){
	...
	AddFileToDownloadsTable("sound/misc/psound.mp3");
	PrecacheSoundAny("misc/psound.mp3");
}
...
public OpenParachute(client){
    ...
    if(GetConVarInt(g_model) == 1){
        ...
        EmitSoundToClient(client, "misc/psound.mp3");
    }
}
