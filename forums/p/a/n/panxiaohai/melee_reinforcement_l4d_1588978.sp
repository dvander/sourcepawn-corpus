...
public OnPluginStart()
{
	...
	l4d_antishove_enable = CreateConVar("l4d_antishove_enable", "1", "anti shove 0:disable, 1:eanble ", FCVAR_PLUGIN);
  	...
  	l4d_melee_pushback[ZOMBIECLASS_HUNTER]  = CreateConVar("l4d_melee_pushback_hunter", "0", "probalility of push back when you melee attacke a hunter[0.0,100.0]", FCVAR_PLUGIN);
 	l4d_melee_pushback[ZOMBIECLASS_SMOKER]  = CreateConVar("l4d_melee_pushback_smoker", "0", "", FCVAR_PLUGIN);	
 	l4d_melee_pushback[ZOMBIECLASS_BOOMER]  = CreateConVar("l4d_melee_pushback_boomer", "0", "", FCVAR_PLUGIN);
 	l4d_melee_pushback[ZOMBIECLASS_JOCKEY]  = CreateConVar("l4d_melee_pushback_jockey", "0", "", FCVAR_PLUGIN);
 	l4d_melee_pushback[ZOMBIECLASS_SPITTER] = CreateConVar("l4d_melee_pushback_spitter", "0", "", FCVAR_PLUGIN);	
	l4d_melee_pushback[ZOMBIECLASS_CHARGER] = CreateConVar("l4d_melee_pushback_charger", "30", "", FCVAR_PLUGIN);
 	l4d_melee_pushback[ZOMBIECLASS_TANK   ] = CreateConVar("l4d_melee_pushback_tank", "100", "", FCVAR_PLUGIN); 
 
 	l4d_shove_pushback[ZOMBIECLASS_HUNTER]  = CreateConVar("l4d_shove_pushback_hunter", "0", "probalility of push back when you shove a hunter[0.0,100.0]", FCVAR_PLUGIN);
 	l4d_shove_pushback[ZOMBIECLASS_SMOKER]  = CreateConVar("l4d_shove_pushback_smoker", "0", "", FCVAR_PLUGIN);	
 	l4d_shove_pushback[ZOMBIECLASS_BOOMER]  = CreateConVar("l4d_shove_pushback_boomer", "100", "", FCVAR_PLUGIN);
 	l4d_shove_pushback[ZOMBIECLASS_JOCKEY]  = CreateConVar("l4d_shove_pushback_jockey", "0", "", FCVAR_PLUGIN);
 	l4d_shove_pushback[ZOMBIECLASS_SPITTER] = CreateConVar("l4d_shove_pushback_spitter", "0", "", FCVAR_PLUGIN);	
	l4d_shove_pushback[ZOMBIECLASS_CHARGER] = CreateConVar("l4d_shove_pushback_charger", "100", "", FCVAR_PLUGIN);
 	l4d_shove_pushback[ZOMBIECLASS_TANK   ] = CreateConVar("l4d_shove_pushback_tank", "100", "", FCVAR_PLUGIN); 
	
	l4d_claw_fling[ZOMBIECLASS_HUNTER]  	= CreateConVar("l4d_claw_fling_hunter", "100", "probalility of been fling when you shoved by hunter[0.0,100.0]", FCVAR_PLUGIN);
 	l4d_claw_fling[ZOMBIECLASS_SMOKER]  	= CreateConVar("l4d_claw_fling_smoker", "0", "", FCVAR_PLUGIN);	
 	l4d_claw_fling[ZOMBIECLASS_BOOMER]  	= CreateConVar("l4d_claw_fling_boomer", "100", "", FCVAR_PLUGIN);
 	l4d_claw_fling[ZOMBIECLASS_JOCKEY]  	= CreateConVar("l4d_claw_fling_jockey", "0", "", FCVAR_PLUGIN);
 	l4d_claw_fling[ZOMBIECLASS_SPITTER]		= CreateConVar("l4d_claw_fling_pitter", "100", "", FCVAR_PLUGIN);	
	l4d_claw_fling[ZOMBIECLASS_CHARGER] 	= CreateConVar("l4d_claw_fling_charger", "100", "", FCVAR_PLUGIN);
 	l4d_claw_fling[ZOMBIECLASS_TANK] =		  CreateConVar("l4d_claw_fling_tank", "100", "", FCVAR_PLUGIN);
