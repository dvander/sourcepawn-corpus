...
public OnPluginStart()
{
	...
	l4d_fly_msg=CreateConVar("l4d_fly_msg", "2", "how many times to display usage information , 0 disable  ", FCVAR_PLUGIN);	
	l4d_fly_fuel=CreateConVar("l4d_fly_fuel", "200.0", "the fuel of jet pack [seconds]", FCVAR_PLUGIN);	
	l4d_fly_speed=CreateConVar("l4d_fly_speed", "100.0", "max speed of jet pack", FCVAR_PLUGIN);	
	l4d_fly_infected=CreateConVar("l4d_fly_infected", "1", "infected use 0:disable, 1:enable  ", FCVAR_PLUGIN);
	...
	l4d_fly_drop_tank=CreateConVar("l4d_fly_drop_tank", "80.0", "chance of drop from tank", FCVAR_PLUGIN);
	l4d_fly_drop_witch=CreateConVar("l4d_fly_drop_witch", "50.0", "chance of drop from witch", FCVAR_PLUGIN);
...
OnAir(client, button, Float:intervual)
{
