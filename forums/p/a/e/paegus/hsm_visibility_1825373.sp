...
new const
	String:cszVisModelFile[]		= "models/executive/hr_model_plantpot01.mdl",	// Default visible model.
...
public Plugin:myinfo = {
	name		= "H:SM - Visibility",
	author		= "Paegus",
	description	= "Allows Hidden to reveal himself",
...
public OnPluginStart() {
	...
	RegConsoleCmd ("+visible", cmd_Visible, "Makes Hidden player visible using model defined by hsm_vis_model")
	RegConsoleCmd ("-visible", cmd_Hidden, "Makes Hidden player invisible again.")
...
// Process client's +visible command
public Action:cmd_Visible (client,argc) {
	if (CanAppear(client)) {
...
// Process client's -visible command
public Action:cmd_Hidden (client, argc) {
	if (CanDisappear(client)) {
