...
Versions:
	...
	1.4.1
		* Fixed "get target team" bug
		* Added automatic config file generetion
...
//	CreateConVar("sm_team_join_control_version", PLUGIN_VERSION, "Auto Join Control Version", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);
	CreateConVar("sm_team_join_control_version", PLUGIN_VERSION, "Auto Join Control Version", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_UNLOGGED|FCVAR_DONTRECORD|FCVAR_REPLICATED|FCVAR_NOTIFY);
...
public OnClientPutInServer(client)
{
	...
	if (g_gameType == TF2 || g_gameType == CSGO)
	{
