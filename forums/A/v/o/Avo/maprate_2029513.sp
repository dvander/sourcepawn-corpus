...
GetCurrentWorkshopMap(String:szMap[], iMapBuf, String:szWorkShopID[], iWorkShopBuf)
{
    ...
    if (ExplodeString(szCurMap, "/", szCurMapSplit, 2, 64) == 2)
    {      
    ...
    {
      strcopy(szMap, iMapBuf, szCurMapSplit[0]);
    }
}  

public OnMapStart()
{
	GetCurrentWorkshopMap(g_current_map, sizeof(g_current_map), g_current_wid, sizeof(g_current_wid));
