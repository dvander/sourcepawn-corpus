...
ConVar g_cEnableNoBloodSplatter = null;
ConVar g_cEnableNoBloodSplash = null;
...
public void OnPluginStart()
{
	...
	g_cEnablePlugin = CreateConVar("onlyhs_enable", "1", "Enable / Disable Only HeadShot Plugin", _, true, 0.0, true, 1.0);
	g_cEnableOneShot = CreateConVar("onlyhs_oneshot", "0", "Enable / Disable kill enemy with one shot", _, true, 0.0, true, 1.0);
	g_cAllowGrenade = CreateConVar("onlyhs_allow_grenade", "0", "Enable / Disable Grenade Damage", _, true, 0.0, true, 1.0);
	g_cAllowWorld = CreateConVar("onlyhs_allow_world", "0", "Enable / Disable World Damage", _, true, 0.0, true, 1.0);
	g_cAllowKnife = CreateConVar("onlyhs_allow_knife", "0", "Enable / Disable Knife Damage", _, true, 0.0, true, 1.0);
	g_cAllowedWeapons = CreateConVar("onlyhs_allow_weapons", "deagle;elite", "Which weapon should be permitted ( Without 'weapon_' )?");
	g_cEnableNoBlood = CreateConVar("onlyhs_disable_blood", "0", "Enable / Disable No Blood", _, true, 0.0, true, 1.0);
	g_cEnableNoBloodSplatter = CreateConVar("onlyhs_disable_blood_splatter", "0", "Enable / Disable No Blood Splatter", _, true, 0.0, true, 1.0);
	g_cEnableNoBloodSplash = CreateConVar("onlyhs_disable_blood_splash", "0", "Enable / Disable No Blood Splash", _, true, 0.0, true, 1.0);
