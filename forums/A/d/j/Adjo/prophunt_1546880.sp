	   ...
	   && IsClientInGame(attacker) && GetClientTeam(attacker) == TEAM_BLUE)
	{
		...
		if(IsValidEntity(GetEntPropEnt(attacker, Prop_Send, "m_hActiveWeapon")) )
		{
			switch(GetEntProp(GetEntPropEnt(attacker, Prop_Send, "m_hActiveWeapon"), Prop_Send, "m_iItemDefinitionIndex"))
			{
				...
				case WEP_SHOTGUNHEAVY, WEP_SHOTGUNSOLLY, WEP_SHOTGUNENGINEER, WEP_BACKBURNER, WEP_SHOTGUNPYRO, WEP_SHOTGUN_UNIQUE, WEP_RESERVE: 
				{
					damage = FloatMul(damage, 0.8);
				}
				case WEP_MINIGUN, WEP_MINIGUN_UNIQUE, WEP_ROCKETLAUNCHER, WEP_ROCKETLAUNCHER_UNIQUE, WEP_DIRECTHIT, WEP_BLACKBOX, WEP_BRASSBEAST, WEP_IRONCURTAIN, WEP_TOMISLAV, WEP_LIBERTY, WEP_SCREEN: 
				{
