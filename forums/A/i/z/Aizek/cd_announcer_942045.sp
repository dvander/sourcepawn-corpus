...
public OnConfigsExecuted()
{
	...
	if(FileExists(FileLocation)) PrecacheSound(FileLocation);
			...
			switch(GetConVarInt(PrintCountry)) {
				case 0: {
					switch(log) {
						...
						case 1: {
							PrintToChatAll("%t", "Connected_Auth_1", gName, gAuth);
			...
			switch(GetConVarInt(PrintCountry)) {
				case 0: {
					switch(log) {
						...
						case 1: {
							PrintToChatAll("%t", "Disconnected_Auth_1", gName, gAuth);
