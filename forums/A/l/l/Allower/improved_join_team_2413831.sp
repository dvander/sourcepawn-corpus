...
{ 
    ...
    author = "Oshizu, ReFlexPoison (Helped many times with plugin) and Allower", 
...
{ 
    ...
    //2 = Terrorists {orange} 
    //3 = Counter-Terrorists {blue} 
    else if(StrEqual(g_strGame, "csgo")) 
    { 
        switch(iOldTeam) 
        { 
            case 0, 1: 
            { 
                switch(iNewTeam) 
                { 
                    case 0: CPrintToChatAll("Player {grey2}%N joined team {grey2}Unassigned", iClient); 
                    case 1: CPrintToChatAll("Player {grey2}%N{default} joined team {grey2}Spectators", iClient); 
                    case 2: CPrintToChatAll("Player {grey2}%N{default} joined team {orange}Terrorists", iClient); 
                    case 3: CPrintToChatAll("Player {grey2}%N{default} joined team {blue}Counter-Terrorists", iClient); 
                } 
            } 
            case 2: 
            { 
                switch(iNewTeam) 
                { 
                    case 0: CPrintToChatAll("Player {orange}%N joined team {grey2}Unassigned", iClient); 
                    case 1: CPrintToChatAll("Player {orange}%N{default} joined team {grey2}Spectators", iClient); 
                    case 2: CPrintToChatAll("Player {orange}%N{default} joined team {orange}Terrorists", iClient); 
                    case 3: CPrintToChatAll("Player {orange}%N{default} joined team {blue}Counter-Terrorists", iClient); 
                } 
            } 
            case 3: 
            { 
                switch(iNewTeam) 
                { 
                    case 0: CPrintToChatAll("Player {blue}%N joined team {grey2}Unassigned", iClient); 
                    case 1: CPrintToChatAll("Player {blue}%N{default} joined team {grey2}Spectators", iClient); 
                    case 2: CPrintToChatAll("Player {blue}%N{default} joined team {orange}Terrorists", iClient); 
                    case 3: CPrintToChatAll("Player {blue}%N{default} joined team {blue}Counter-Terrorists", iClient); 
                } 
            } 
        } 
