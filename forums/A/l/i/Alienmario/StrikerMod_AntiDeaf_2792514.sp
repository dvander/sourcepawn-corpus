...
public void OnPluginStart()
{
	...
	cv_disablering = CreateConVar("strkmod_disable_ring","1","Disable Explosion Ear Ringing/Confusion");
	cv_debugring = CreateConVar("strkmod_debug_ring","0","Debug SetPlayerDSP hook");
}
