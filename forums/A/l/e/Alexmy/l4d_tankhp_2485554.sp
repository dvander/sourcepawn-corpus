...
{
	name = "[L4D] Tank health gauge",
	author = "ztar, edited by AlexMy",
...
public Action:Event_PlayerHurt(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	/* Notify Tank health */
	if(GetEntProp(target, Prop_Send, "m_zombieClass") == 5 && GetConVarInt(TankAnnounce))
	{
		new i, j;
