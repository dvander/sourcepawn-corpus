...
public PlayerMenuHandler(Handle:PlayerMenu, MenuAction:action, client, option)
{
	if (action == MenuAction_Select)
	{
		switch (option)
		{
			case 0: FakeClientCommandEx(client, "say /silent");
			case 1: FakeClientCommandEx(client, "say /laser");
			case 2: FakeClientCommandEx(client, "say /laser");
			case 3: FakeClientCommandEx(client, "say /speed");
			case 4: FakeClientCommandEx(client, "say /magazine");			
			case 5: FakeClientCommandEx(client, "say /upgrades");
		}
	}
}