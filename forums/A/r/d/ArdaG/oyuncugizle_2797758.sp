...
{
	name = "Oyuncuları Gizleme",
	description = "Oyuncuları Gizleme",
	author = "",
	version = "1.0",
...
public Event_PlayerTeam(Handle:event, String:name[], bool:dontBroadcast)
{
	...
	client << 2 + 2684/* ERROR unknown load Binary */ = GetEventInt(event, "team", 0);
	return 0;
}
...
/* ERROR! class lysis.nodes.types.DJump cannot be cast to class lysis.nodes.types.DJumpCondition (lysis.nodes.types.DJump and lysis.nodes.types.DJumpCondition are in unnamed module of loader 'app') */
 function "Hook_SetTransmit" (number 2)
public void:OnClientPutInServer(client)
{
	client << 2 + 2420/* ERROR unknown load Binary */ = 0;
	SDKHook(client, 6, 5);
	return 0;
}
...
{
	RegConsoleCmd("sm_hide", 11, "", 0);
	RegConsoleCmd("sm_gizle", 11, "", 0);
	HookEvent("player_team", 3, 1);
	return 0;
}


/* ERROR! class lysis.nodes.types.DJump cannot be cast to class lysis.nodes.types.DJumpCondition (lysis.nodes.types.DJump and lysis.nodes.types.DJumpCondition are in unnamed module of loader 'app') */
 function "Oyunculari_Gizleme" (number 5)
