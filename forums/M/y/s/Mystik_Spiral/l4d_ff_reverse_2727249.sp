...
public Plugin:myinfo =
{
	...
	version = "0.1.1.2MS",
	url = "https://forums.alliedmods.net/showthread.php?t=117977"
};
...
public Action:Eventx_player_hurt(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if( (strlen(WeaponUsed) <= 0) || (AttackerId == VictimId)  ) { return Plugin_Continue; }
	if( (GetClientTeam(VictimId) != 2) || (GetClientTeam(AttackerId) != 2) ) { return Plugin_Continue; }
