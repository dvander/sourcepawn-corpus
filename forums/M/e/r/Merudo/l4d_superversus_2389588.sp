 ...
 * ========================================================
v1.5.4r
-Added admin command "!spawn_bots", that also spawn more bots as necessary. By Guillaume
v1.5.4
...
public OnPluginStart()
{
	...
	/// Added in v1.5.4r
	RegAdminCmd("sm_spawn_bots", Command_Spawn_Bots, ADMFLAG_CONVARS, "Spawn survivor bots, to fill up to l4d_survivor_limit");
