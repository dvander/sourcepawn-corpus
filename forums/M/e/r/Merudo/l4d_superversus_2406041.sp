...
// CONSTANTS
// *********************************************************************************
#define PLUGIN_VERSION		"1.8.15.3"
...
public void OnPluginStart()
{
	...
	Management = CreateConVar("l4d_management", "3", "3: Enable teammenu & commands, 2: commands only, 1: !infected,!survivor,!join only, 0: Nothing", CVAR_FLAGS, true, 0.0, true, 2.0);
...
public void OnMapStart() 
{
	...
	OnInfectedChanged(null, "",""); OnSurvivorChanged(null, "","");
}
...
{	
	...
	{
		PrintToChat(client, "\x01You are on the \x05Infected Team\x01.");
	}
