...
// CONSTANTS
// *********************************************************************************
#define PLUGIN_VERSION		"1.8.12.2"
...
public Plugin myinfo =
{
	...
	url         = "https://forums.alliedmods.net/showthread.php?p=2403272#post2403272"
}
...
public void OnClientDisconnect(int client)
{
	...
	if(RoundStarted == true)			// if not bot or during transition
	{
...
{ 
	...
	{
		SubDirector = CreateTimer(FindConVar("z_ghost_delay_max").FloatValue, BotInfectedCounter, true, TIMER_FLAG_NO_MAPCHANGE);
	}
}
