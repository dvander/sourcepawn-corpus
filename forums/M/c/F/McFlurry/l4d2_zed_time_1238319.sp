...
public OnPluginStart()
{
	...
	CreateConVar("l4d2_zed_time_version", PLUGIN_VERSION, "Version of Zed Time", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_DONTRECORD|FCVAR_REPLICATED|FCVAR_NOTIFY);
	Enable = CreateConVar("l4d2_zed_time_enable", "1", "Zed Time enable", FCVAR_PLUGIN);
	ZedSurvivorchance = CreateConVar("l4d2_zed_surv_chance", "40", "1 in chance of a survivor triggering Zed Time", FCVAR_PLUGIN);
	ZedInfectedchance = CreateConVar("l4d2_zed_infct_chance", "20", "1 in chance of a infected triggering Zed Time", FCVAR_PLUGIN);
	ZedPipeChance = CreateConVar("l4d2_zed_pipe_chance", "10", "1 in chance of a pipe bomb explosion triggering Zed Time", FCVAR_PLUGIN);
	ZedExplosionChance = CreateConVar("l4d2_zed_boomer_explosion_chance", "10", "1 in chance of an exploding boomer triggering Zed Time", FCVAR_PLUGIN);
	TeamRestrict = CreateConVar("l4d2_zed_restrict", "1", "Restrict Zed Time to team 1(survivors), 2(infected), or 3(allow all teams)", FCVAR_PLUGIN);
	ZedModes = CreateConVar("l4d2_zed_modes", "coop,versus,realism,teamversus", "Which modes should this plugin be enabled in?", FCVAR_PLUGIN);
	ZedWitch = CreateConVar("l4d2_zed_witch", "10", "Witch Zed time chance when killed", FCVAR_PLUGIN);
	ZedAmazing = CreateConVar("l4d2_zed_extreme_shot", "150", "The distance required to increase the chance of Zed time happening on a kill.", FCVAR_PLUGIN);
	ZedTank = CreateConVar("l4d2_zed_tank", "2", "Tank Zed time chance when killed", FCVAR_PLUGIN);
	ZedTimer = CreateConVar("l4d2_zed_timer", "1.0", "How long time stays slowed down.", FCVAR_PLUGIN);
	ZedCharger = CreateConVar("l4d2_zed_charger", "1", "Enable Zed time for Chargers?", FCVAR_PLUGIN);
	ZedSmoker = CreateConVar("l4d2_zed_smoker", "1", "Enable Zed time for Smokers?", FCVAR_PLUGIN);
	ZedJockey = CreateConVar("l4d2_zed_jockey", "1", "Enable Zed time for Jockeys?", FCVAR_PLUGIN);
	ZedHunter = CreateConVar("l4d2_zed_hunter", "1", "Enable Zed time for Hunters?", FCVAR_PLUGIN);
	ZedBoomer = CreateConVar("l4d2_zed_boomer", "1", "Enable Zed time for Boomers?", FCVAR_PLUGIN);
