 ...
 * #### 
 * Special Zombie List: 
 * boomer, hunter, smoker, tank, spitter, jockey, charger, zombie, witch, witch_bride
 *
 * ####
 * Changelog:
 * v0.8
...
public Action:Command_SpawnWeapon(client, args)
{
	...
	if (StrEqual(weapon, "weapon_rifle", false) || StrEqual(weapon, "weapon_rifle_ak47", false) || StrEqual(weapon, "weapon_rifle_desert", false) || StrEqual(weapon, "weapon_rifle_sg552", false) || StrEqual(weapon, "weapon_rifle_m60", false))
	{
...
switch(action)
	{
		...
		case MenuAction_Select:
		{
			...
			if (StrEqual(weapon, "weapon_rifle", false) || StrEqual(weapon, "weapon_rifle_ak47", false) || StrEqual(weapon, "weapon_rifle_desert", false) || StrEqual(weapon, "weapon_rifle_m60", false))
			{
				maxammo = GetConVarInt(AssaultMaxAmmo);
			}
			else if (StrEqual(weapon, "weapon_smg", false) || StrEqual(weapon, "weapon_smg_silenced", false) || StrEqual(weapon, "weapon_smg_mp5", false))
