...
new bool:g_bHaveMapStartFired = false;
new bool:g_bHaveRoundStartFired = false;
...
public OnMapStart()
{
    g_bHaveMapStartFired = true;
    if (!g_bHaveRoundStartFired)
    {
...
public OnMapEnd()
{
    g_bHaveMapStartFired = false;
    g_bHaveRoundStartFired = false;
}

public Action:Event_RoundStart(Handle:event, String:name[], bool:dontBroadcast)
{
    if (!g_bHaveMapStartFired)
    {
        return;
    }
    g_bHaveRoundStartFired = true;
