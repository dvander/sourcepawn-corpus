...
{	
	...
	Format(g_strCampaignFirstMap[6], 32, "c9m1_alleys");
	Format(g_strCampaignFirstMap[7], 32, "c10m1_caves");
	Format(g_strCampaignFirstMap[8], 32, "c11m1_greenhouse");
	Format(g_strCampaignFirstMap[9], 32, "c12m1_hilltop");
	Format(g_strCampaignFirstMap[10], 32, "c7m1_docks");
	Format(g_strCampaignFirstMap[11], 32, "c6m1_riverbank");
	...
	Format(g_strCampaignLastMap[6], 32, "c9m2_lots");
	Format(g_strCampaignLastMap[7], 32, "c10m5_houseboat");
	Format(g_strCampaignLastMap[8], 32, "c11m5_runway");
	Format(g_strCampaignLastMap[9], 32, "c12m5_cornfield");
	Format(g_strCampaignLastMap[10], 32, "c7m3_port");
	Format(g_strCampaignLastMap[11], 32, "c6m3_port");
	...
	Format(g_strCampaignName[6], 32, "Crash Course");
	Format(g_strCampaignName[7], 32, "Death Toll");
	Format(g_strCampaignName[8], 32, "Dead Air");
	Format(g_strCampaignName[9], 32, "Blood Harvest");
	Format(g_strCampaignName[10], 32, "The Sacrifice");
	Format(g_strCampaignName[11], 32, "The Passing");
