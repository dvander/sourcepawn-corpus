...
{	
	...
	Format(g_strCampaignFirstMap[0], 13, "c1m1_hotel");
	Format(g_strCampaignFirstMap[1], 13, "c2m1_highway");
	Format(g_strCampaignFirstMap[2], 13, "c3m1_plankcountry");
	Format(g_strCampaignFirstMap[3], 13, "c4m1_milltown_a");
	Format(g_strCampaignFirstMap[4], 13, "c5m1_waterfront");
	Format(g_strCampaignFirstMap[5], 13, "c8m1_apartment");
	Format(g_strCampaignFirstMap[6], 13, "c9m1_alleys");
	Format(g_strCampaignFirstMap[7], 13, "c10m1_caves");
	Format(g_strCampaignFirstMap[8], 13, "c11m1_greenhouse");
	Format(g_strCampaignFirstMap[9], 13, "c12m1_hilltop");
	Format(g_strCampaignFirstMap[10], 13, "c7m1_docks");
	Format(g_strCampaignFirstMap[11], 13, "c6m1_riverbank");
	Format(g_strCampaignFirstMap[12], 13, "c13m1_alpinecreek");

	//Last Maps of the Campaign
	Format(g_strCampaignLastMap[0], 13, "c1m4_atrium");
	Format(g_strCampaignLastMap[1], 13, "c2m5_concert");
	Format(g_strCampaignLastMap[2], 13, "c3m4_plantation");
	Format(g_strCampaignLastMap[3], 13, "c4m5_milltown_escape");
	Format(g_strCampaignLastMap[4], 13, "c5m5_bridge");
	Format(g_strCampaignLastMap[5], 13, "c8m5_rooftop");
	Format(g_strCampaignLastMap[6], 13, "c9m2_lots");
	Format(g_strCampaignLastMap[7], 13, "c10m5_houseboat");
	Format(g_strCampaignLastMap[8], 13, "c11m5_runway");
	Format(g_strCampaignLastMap[9], 13, "c12m5_cornfield");
	Format(g_strCampaignLastMap[10], 13, "c7m3_port");
	Format(g_strCampaignLastMap[11], 13, "c6m3_port");
	Format(g_strCampaignLastMap[12], 13, "c13m4_cutthroatcreek");

	//Campaign Names
	Format(g_strCampaignName[0], 13, "Dead Center");
	Format(g_strCampaignName[1], 13, "Dark Carnival");
	Format(g_strCampaignName[2], 13, "Swamp Fever");
	Format(g_strCampaignName[3], 13, "Hard Rain");
	Format(g_strCampaignName[4], 13, "The Parish");
	Format(g_strCampaignName[5], 13, "No Mercy");
	Format(g_strCampaignName[6], 13, "Crash Course");
	Format(g_strCampaignName[7], 13, "Death Toll");
	Format(g_strCampaignName[8], 13, "Dead Air");
	Format(g_strCampaignName[9], 13, "Blood Harvest");
	Format(g_strCampaignName[10], 13, "The Sacrifice");
	Format(g_strCampaignName[11], 13, "The Passing");
	Format(g_strCampaignName[12], 13, "Cold Stream");
	...
	//Scavenge Maps
	Format(g_strScavengeMap[0], 13, "c8m1_apartment");
	Format(g_strScavengeMap[1], 13, "c8m5_rooftop");
	Format(g_strScavengeMap[2], 13, "c1m4_atrium");
	Format(g_strScavengeMap[3], 13, "c7m1_docks");
	Format(g_strScavengeMap[4], 13, "c7m2_barge");
	Format(g_strScavengeMap[5], 13, "c6m1_riverbank");
	Format(g_strScavengeMap[6], 13, "c6m2_bedlam");
	Format(g_strScavengeMap[7], 13, "c6m3_port");
	Format(g_strScavengeMap[8], 13, "c2m1_highway");
	Format(g_strScavengeMap[9], 13, "c3m1_plankcountry");
	Format(g_strScavengeMap[10], 13, "c4m1_milltown_a");
	Format(g_strScavengeMap[11], 13, "c4m2_sugarmill_a");
	Format(g_strScavengeMap[12], 13, "c5m2_park");
	
	//Scavenge Map Names
	Format(g_strScavengeMapName[0], 13, "Apartments");
	Format(g_strScavengeMapName[1], 13, "Rooftop");
	Format(g_strScavengeMapName[2], 13, "Mall Atrium");
	Format(g_strScavengeMapName[3], 13, "Brick Factory");
	Format(g_strScavengeMapName[4], 13, "Barge");
	Format(g_strScavengeMapName[5], 13, "Riverbank");
	Format(g_strScavengeMapName[6], 13, "Underground");
	Format(g_strScavengeMapName[7], 13, "Port");
	Format(g_strScavengeMapName[8], 13, "Motel");
	Format(g_strScavengeMapName[9], 13, "Plank Country");
	Format(g_strScavengeMapName[10], 13, "Milltown");
	Format(g_strScavengeMapName[11], 13, "Sugar Mill");
	Format(g_strScavengeMapName[12], 13, "Park");
}
