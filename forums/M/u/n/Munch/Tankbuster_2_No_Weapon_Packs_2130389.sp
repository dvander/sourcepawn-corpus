...
#pragma semicolon 1
#include <sourcemod>
#define PLUGIN_VERSION "1.2.1.no.weapon.packs"

new Handle:g_max_give[46];
new max_give[46]; //array for storing initial quota of each item
...
public OnPluginStart()
{
	...
	g_max_give[0] = CreateConVar("sm_quota_adrenaline", "-1", " Quota Given to each player for obtaining adrenaline in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[1] = CreateConVar("sm_quota_defibrillator", "-1", " Quota Given to each player for obtaining defibrillator in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[2] = CreateConVar("sm_quota_first_aid_kit", "-1", " Quota Given to each player for obtaining first_aid_kit in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[3] = CreateConVar("sm_quota_pain_pills", "-1", " Quota Given to each player for obtaining pain_pills in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[4] = CreateConVar("sm_quota_chainsaw", "-1", " Quota Given to each player for obtaining chainsaw in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[5] = CreateConVar("sm_quota_pumpshotgun", "-1", " Quota Given to each player for obtaining pumpshotgun in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[6] = CreateConVar("sm_quota_autoshotgun", "-1", " Quota Given to each player for obtaining autoshotgun in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[7] = CreateConVar("sm_quota_shotgun_chrome", "-1", " Quota Given to each player for obtaining shotgun_chrome in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[8] = CreateConVar("sm_quota_shotgun_spas", "-1", " Quota Given to each player for obtaining shotgun_spas in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[9] = CreateConVar("sm_quota_pistol", "-1", " Quota Given to each player for obtaining pistol in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[10] = CreateConVar("sm_quota_pistol_magnum", "-1", " Quota Given to each player for obtaining pistol_magnum in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[11] = CreateConVar("sm_quota_hunting_rifle", "-1", " Quota Given to each player for obtaining hunting_rifle in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[12] = CreateConVar("sm_quota_rifle", "-1", " Quota Given to each player for obtaining rifle in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[13] = CreateConVar("sm_quota_rifle_ak47", "-1", " Quota Given to each player for obtaining rifle_ak47 in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[14] = CreateConVar("sm_quota_rifle_desert", "-1", " Quota Given to each player for obtaining rifle_desert in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[15] = CreateConVar("sm_quota_rifle_sg552", "-1", " Quota Given to each player for obtaining rifle_sg552 in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[16] = CreateConVar("sm_quota_smg", "-1", " Quota Given to each player for obtaining smg in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[17] = CreateConVar("sm_quota_smg_mp5", "-1", " Quota Given to each player for obtaining smg_mp5 in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[18] = CreateConVar("sm_quota_smg_silenced", "-1", " Quota Given to each player for obtaining smg_silenced in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[19] = CreateConVar("sm_quota_sniper_awp", "-1", " Quota Given to each player for obtaining sniper_awp in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[20] = CreateConVar("sm_quota_sniper_military", "-1", " Quota Given to each player for obtaining sniper_military in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[21] = CreateConVar("sm_quota_sniper_scout", "-1", " Quota Given to each player for obtaining sniper_scout in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[22] = CreateConVar("sm_quota_grenade_launcher", "-1", " Quota Given to each player for obtaining grenade_launcher in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[23] = CreateConVar("sm_quota_fireworkcrate", "-1", " Quota Given to each player for obtaining fireworkcrate in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[24] = CreateConVar("sm_quota_gascan", "-1", " Quota Given to each player for obtaining gascan in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[25] = CreateConVar("sm_quota_molotov", "-1", " Quota Given to each player for obtaining molotov in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[26] = CreateConVar("sm_quota_oxygentank", "-1", " Quota Given to each player for obtaining oxygentank in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[27] = CreateConVar("sm_quota_propanetank", "-1", " Quota Given to each player for obtaining propanetank in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[28] = CreateConVar("sm_quota_pipe_bomb", "-1", " Quota Given to each player for obtaining pipe_bomb in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[29] = CreateConVar("sm_quota_vomitjar", "-1", " Quota Given to each player for obtaining vomitjar in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[30] = CreateConVar("sm_quota_gnome", "-1", " Quota Given to each player for obtaining gnome in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[31] = CreateConVar("sm_quota_upgradepack_incendiary", "-1", " Quota Given to each player for obtaining upgradepack_incendiary in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[32] = CreateConVar("sm_quota_upgradepack_explosive", "-1", " Quota Given to each player for obtaining upgradepack_explosive in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[33] = CreateConVar("sm_quota_baseball_bat", "-1", " Quota Given to each player for obtaining baseball_bat in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[34] = CreateConVar("sm_quota_cricket_bat", "-1" ," Quota Given to each player for obtaining cricket_bat in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[35] = CreateConVar("sm_quota_crowbar", "-1", " Quota Given to each player for obtaining crowbar in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[36] = CreateConVar("sm_quota_electric_guitar", "-1", " Quota Given to each player for obtaining electric_guitar in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[37] = CreateConVar("sm_quota_fireaxe", "-1", " Quota Given to each player for obtaining fireaxe in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[38] = CreateConVar("sm_quota_frying_pan", "-1", " Quota Given to each player for obtaining frying_pan in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[39] = CreateConVar("sm_quota_katana", "-1", " Quota Given to each player for obtaining katana in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[40] = CreateConVar("sm_quota_machete", "-1", " Quota Given to each player for obtaining machete in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[41] = CreateConVar("sm_quota_tonfa", "-1", " Quota Given to each player for obtaining tonfa in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[42] = CreateConVar("sm_quota_knife", "-1", " Quota Given to each player for obtaining knife in each round ( -1 = unlimited 0 = disabled )");	
	g_max_give[43] = CreateConVar("sm_quota_golfclub", "-1", " Quota Given to each player for obtaining golfclub in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[44] = CreateConVar("sm_quota_riotshield", "-1", " Quota Given to each player for obtaining riotshield in each round ( -1 = unlimited 0 = disabled )");
	g_max_give[45] = CreateConVar("sm_quota_rifle_m60", "-1", " Quota Given to each player for obtaining rifle_m60 in each round ( -1 = unlimited 0 = disabled )");
...
public Action:TankBuster(clientId) {
	...
	AddMenuItem(menu, "option43", "Golf Club * Only if level allows");
	AddMenuItem(menu, "option44", "Riot Shield * CSS * Only if level allows");
	AddMenuItem(menu, "option45", "M60 Machine Gun");
...
public TankBusterMenuHandler(Handle:menu, MenuAction:action, client, itemNum)
{
	...
	if ( action == MenuAction_Select ) {  
		switch (itemNum)
		{
			...
			case 0: //adrenaline
			{
				if ( give_quota0[client] > 0 || give_quota0[client] < 0) {
					...
					if (give_quota0[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain an adrenaline until next round",give_quota0[client]);
					}
			...
			case 1: //defibrillator
			{
				if ( give_quota1[client] > 0 || give_quota1[client] < 0) {
					...
					if (give_quota1[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a defibrillator until next round",give_quota1[client]);
					}
			...
			case 3: //pain_pills
			{
				if ( give_quota3[client] > 0 || give_quota3[client] < 0) {
					...
					if (give_quota3[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a pain_pills until next round",give_quota3[client]);
					}
			...
			case 4: //chainsaw
			{
				if ( give_quota4[client] > 0 || give_quota4[client] < 0) {
					...
					if (give_quota4[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain chainsaw until next round",give_quota4[client]);
					}
			...
			case 5: //pumpshotgun
			{
				if ( give_quota5[client] > 0 || give_quota5[client] < 0) {
					...
					if (give_quota5[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain pumpshotgun until next round",give_quota5[client]);
					}
					else if (give_quota5[client] == 0){
			...
			case 6: // autoshotgun
			{
				if ( give_quota6[client] > 0 || give_quota6[client] < 0) {
					...
					if (give_quota6[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a autoshotgun until next round",give_quota6[client]);
					}
			...
			case 7: // shotgun_chrome
			{
				if ( give_quota7[client] > 0 || give_quota7[client] < 0) {
					...
					if (give_quota7[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a shotgun_chrome until next round",give_quota7[client]);
					}
			...
			case 8: // shotgun_spas
			{
				if ( give_quota8[client] > 0 || give_quota8[client] < 0) {
					...
					if (give_quota8[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a shotgun_spas until next round",give_quota8[client]);
					}
			...
			case 9: // pistol
			{
				if ( give_quota9[client] > 0 || give_quota9[client] < 0) {
					...
					if (give_quota9[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a pistol until next round",give_quota9[client]);
					}
			...
			case 10: // pistol_magnum
			{
				if ( give_quota10[client] > 0 || give_quota10[client] < 0) {
					...
					if (give_quota10[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a pistol_magnum until next round",give_quota10[client]);
					}
			...
			case 11: // hunting_rifle
			{
				if ( give_quota11[client] > 0 || give_quota11[client] < 0) {
					...
					if (give_quota11[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a hunting_rifle until next round",give_quota11[client]);
					}
			...
			case 12: // rifle
			{
				if ( give_quota12[client] > 0 || give_quota12[client] < 0) {
					...
					if (give_quota12[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a rifle until next round",give_quota12[client]);
					}
			...
			case 13: // rifle_ak47
			{
				if ( give_quota13[client] > 0 || give_quota13[client] < 0) {
					...
					if (give_quota13[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a rifle_ak47 until next round",give_quota13[client]);
					}
			...
			case 14: // rifle_desert
			{
				if ( give_quota14[client] > 0 || give_quota14[client] < 0) {
					...
					if (give_quota14[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a rifle_desert until next round",give_quota14[client]);
					}
			...
			case 15: // rifle_sg552
			{
				if ( give_quota15[client] > 0 || give_quota15[client] < 0) {
					...
					if (give_quota15[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a rifle_sg552 until next round",give_quota15[client]);
					}
			...
			case 16: // smg
			{
				if ( give_quota16[client] > 0 || give_quota16[client] < 0) {
					...
					if (give_quota16[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a smg until next round",give_quota16[client]);
					}
					else if (give_quota16[client] == 0){
			...
			case 17: // smg_mp5
			{
				if ( give_quota17[client] > 0 || give_quota17[client] < 0) {
					...
					if (give_quota17[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a smg_mp5 until next round",give_quota17[client]);
					}
			...
			case 18: // smg_silenced
			{
				if ( give_quota18[client] > 0 || give_quota18[client] < 0) {
					...
					if (give_quota18[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a smg_silenced until next round",give_quota18[client]);
					}
			...
			case 19: // sniper_awp
			{
				if ( give_quota19[client] > 0 || give_quota19[client] < 0) {
					...
					if (give_quota19[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a sniper_awp until next round",give_quota19[client]);
					}
			...
			case 20: // sniper_military
			{
				if ( give_quota20[client] > 0 || give_quota20[client] < 0) {
					...
					if (give_quota20[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a sniper_military until next round",give_quota20[client]);
					}
			...
			case 21: // sniper_scout
			{
				if ( give_quota21[client] > 0 || give_quota21[client] < 0) {
					...
					if (give_quota21[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a sniper_scout until next round",give_quota21[client]);
					}
			...
			case 22: // grenade_launcher
			{
				if ( give_quota22[client] > 0 || give_quota22[client] < 0) {
					...
					if (give_quota22[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a grenade_launcher until next round",give_quota22[client]);
					}
			...
			case 23: // fireworkcrate
			{
				if ( give_quota23[client] > 0 || give_quota23[client] < 0) {
					...
					if (give_quota23[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a fireworkcrate until next round",give_quota23[client]);
					}
			...
			case 24: // gascan
			{
				if ( give_quota24[client] > 0 || give_quota24[client] < 0) {
					...
					if (give_quota24[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a gascan until next round",give_quota24[client]);
					}
			...
			case 25: // molotov
			{
				if ( give_quota25[client] > 0 || give_quota25[client] < 0) {
					...
					if (give_quota25[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a molotov until next round",give_quota25[client]);
					}
			...
			case 26: // oxygentank
			{
				if ( give_quota26[client] > 0 || give_quota26[client] < 0) {
					...
					if (give_quota26[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a oxygentank until next round",give_quota26[client]);
					}
			...
			case 28: // pipe_bomb
			{
				if ( give_quota28[client] > 0 || give_quota28[client] < 0) {
					...
					if (give_quota28[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a pipe_bomb until next round",give_quota28[client]);
					}
			...
			case 29: // vomitjar
			{
				if ( give_quota29[client] > 0 || give_quota29[client] < 0) {
					...
					if (give_quota29[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a vomitjar until next round",give_quota29[client]);
					}
			...
			case 30: // gnome
			{
				if ( give_quota30[client] > 0 || give_quota30[client] < 0) {
					...
					if (give_quota30[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a gnome until next round",give_quota30[client]);
					}
			...
			case 31: // upgradepack_incendiary
			{
				if ( give_quota31[client] > 0 || give_quota31[client] < 0) {
					//Give the player a autoshotgun
					...
					//Notify remaining quota
					if (give_quota31[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a upgradepack_incendiary until next round",give_quota31[client]);
					}
					else if (give_quota31[client] == 0){
			...
			case 32: // upgradepack_explosive
			{
				if ( give_quota32[client] > 0 || give_quota32[client] < 0) {
					...
					if (give_quota32[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a upgradepack_explosive until next round",give_quota32[client]);
					}
			...
			case 33: // baseball_bat
			{
				if ( give_quota33[client] > 0 || give_quota33[client] < 0) {
					...
					if (give_quota33[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a baseball_bat until next round",give_quota33[client]);
					}
			...
			case 34: // baseball_bat
			{
				if ( give_quota34[client] > 0 || give_quota34[client] < 0) {
					...
					if (give_quota34[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a baseball_bat until next round",give_quota34[client]);
					}
			...
			case 35: // crowbar
			{
				if ( give_quota35[client] > 0 || give_quota35[client] < 0) {
					...
					if (give_quota35[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a crowbar until next round",give_quota35[client]);
					}
			...
			case 36: // electric_guitar
			{
				if ( give_quota36[client] > 0 || give_quota36[client] < 0) {
					...
					if (give_quota36[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a electric_guitar until next round",give_quota36[client]);
					}
			...
			case 37: // fireaxe
			{
				if ( give_quota37[client] > 0 || give_quota37[client] < 0) {
					...
					if (give_quota37[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a fireaxe until next round",give_quota37[client]);
					}
			...
			case 38: // frying_pan
			{
				if ( give_quota38[client] > 0 || give_quota38[client] < 0) {
					...
					if (give_quota38[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a frying_pan until next round",give_quota38[client]);
					}
			...
			case 39: // katana
			{
				if ( give_quota39[client] > 0 || give_quota39[client] < 0) {
					...
					if (give_quota39[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a katana until next round",give_quota39[client]);
					}
			...
			case 40: // machete
			{
				if ( give_quota40[client] > 0 || give_quota40[client] < 0) {
					...
					if (give_quota40[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a machete until next round",give_quota40[client]);
					}
			...
			case 41: // tonfa
			{
				if ( give_quota41[client] > 0 || give_quota41[client] < 0) {
					...
					if (give_quota41[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a tonfa until next round",give_quota41[client]);
					}
			...
			case 42: // knife
			{
				if ( give_quota42[client] > 0 || give_quota42[client] < 0) {
					...
					if (give_quota42[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a knife until next round",give_quota42[client]);
					}
			...
			case 43: // Golf Club
			{
				if ( give_quota43[client] > 0 || give_quota43[client] < 0) {
					...
					if (give_quota43[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a Golf Club until next round",give_quota43[client]);
					}
			...
			case 44: // Riot Shield * CSS
			{
				if ( give_quota44[client] > 0 || give_quota44[client] < 0) {
					...
					if (give_quota44[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain a Riot Shield until next round",give_quota44[client]);
					}
			...
			case 45: // M60 machine gun
			{
				if ( give_quota45[client] > 0 || give_quota45[client] < 0) {
					...
					if (give_quota45[client] > 0) {
						PrintToChat(client, "\x04[SM] \x01You have %d more chance to obtain an M60 until next round",give_quota45[client]);
					}
