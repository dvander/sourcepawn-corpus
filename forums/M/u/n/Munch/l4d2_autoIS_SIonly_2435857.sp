...
public OnPluginStart()
{
	...
	AutoExecConfig(true, "l4d2_autoIS_SIonly");
}
	...
	if (Enabled)
	{
		...
		switch (PlayerCount)
		{
			case 1:
			{
			   ...
			   WitchLimit = 1;
			   WitchPeriod = 300.0;
			   SetConVarInt(FindConVar("z_exploding_health"), 25);		//boomer default 50
			   SetConVarInt(FindConVar("z_charger_health"), 150);		//charger default 600
			   SetConVarInt(FindConVar("z_hunter_health"), 60);		//hunter default 250
			   SetConVarInt(FindConVar("z_jockey_health"), 25);		//jockey default 325
			   SetConVarInt(FindConVar("z_gas_health"), 60);		//smoker default 250
			   SetConVarInt(FindConVar("z_spitter_health"), 40);		//spitter default 150
			   SetConVarInt(FindConVar("z_tank_health"), 1000);		//tank default 4000

			   SetConVarInt(FindConVar("director_no_mobs"), 1);
			   SetConVarInt(FindConVar("z_background_limit"), 0);
			   SetConVarInt(FindConVar("z_common_limit"), 0);
			   SetConVarInt(FindConVar("z_mob_spawn_min_size"), 0);
			   SetConVarInt(FindConVar("z_mob_spawn_max_size"), 0);
			   SetConVarInt(FindConVar("z_mega_mob_size"), 0);
			}
			case 2:
			{
			   SILimit = 3;
			   ...
			   WitchPeriod = 270.0;
			   SetConVarInt(FindConVar("z_exploding_health"), 25);		//boomer default 50
			   SetConVarInt(FindConVar("z_charger_health"), 300);		//charger default 600
			   SetConVarInt(FindConVar("z_hunter_health"), 125);		//hunter default 250
			   SetConVarInt(FindConVar("z_jockey_health"), 25);		//jockey default 325
			   SetConVarInt(FindConVar("z_gas_health"), 125);		//smoker default 250
			   SetConVarInt(FindConVar("z_spitter_health"), 75);		//spitter default 150
			   SetConVarInt(FindConVar("z_tank_health"), 2000);		//tank default 4000
			...
			case 3:
			{
			   ...
			   WitchLimit = 1;
			   WitchPeriod = 240.0;
			   SetConVarInt(FindConVar("z_exploding_health"), 40);		//boomer default 50
			   SetConVarInt(FindConVar("z_charger_health"), 450);		//charger default 600
			   SetConVarInt(FindConVar("z_hunter_health"), 175);		//hunter default 250
			   SetConVarInt(FindConVar("z_jockey_health"), 75);		//jockey default 325
			   SetConVarInt(FindConVar("z_gas_health"), 175);		//smoker default 250
			   SetConVarInt(FindConVar("z_spitter_health"), 100);		//spitter default 150
			   SetConVarInt(FindConVar("z_tank_health"), 3000);		//tank default 4000
			...
			case 4:
			{
			   ...
			   WitchLimit = 2;
			   WitchPeriod = 210.0;
			   SetConVarInt(FindConVar("z_exploding_health"), 50);		//boomer default 50
			   SetConVarInt(FindConVar("z_charger_health"), 600);		//charger default 600
			   SetConVarInt(FindConVar("z_hunter_health"), 250);		//hunter default 250
			   SetConVarInt(FindConVar("z_jockey_health"), 100);		//jockey default 325
			   SetConVarInt(FindConVar("z_gas_health"), 250);		//smoker default 250
			   SetConVarInt(FindConVar("z_spitter_health"), 150);		//spitter default 150
			   SetConVarInt(FindConVar("z_tank_health"), 4000);		//tank default 4000
			...
			case 5:
			{
			   ...
			   WitchLimit = 2;
			   WitchPeriod = 180.0;
			   SetConVarInt(FindConVar("z_exploding_health"), 75);		//boomer default 50
			   SetConVarInt(FindConVar("z_charger_health"), 650);		//charger default 600
			   SetConVarInt(FindConVar("z_hunter_health"), 275);		//hunter default 250
			   SetConVarInt(FindConVar("z_jockey_health"), 125);		//jockey default 325
			   SetConVarInt(FindConVar("z_gas_health"), 275);		//smoker default 250
			   SetConVarInt(FindConVar("z_spitter_health"), 175);		//spitter default 150
			   SetConVarInt(FindConVar("z_tank_health"), 5000);		//tank default 4000
			...
			case 6:
			{
			   ...
			   WitchLimit = 2;
			   WitchPeriod = 150.0;
			   SetConVarInt(FindConVar("z_exploding_health"), 100);		//boomer default 50
			   SetConVarInt(FindConVar("z_charger_health"), 700);		//charger default 600
			   SetConVarInt(FindConVar("z_hunter_health"), 300);		//hunter default 250
			   SetConVarInt(FindConVar("z_jockey_health"), 150);		//jockey default 325
			   SetConVarInt(FindConVar("z_gas_health"), 300);		//smoker default 250
			   SetConVarInt(FindConVar("z_spitter_health"), 200);		//spitter default 150
			   SetConVarInt(FindConVar("z_tank_health"), 6000);		//tank default 4000
			...
			case 7:
			{
			   ...
			   WitchLimit = 3;
			   WitchPeriod = 120.0;
			   SetConVarInt(FindConVar("z_exploding_health"), 125);		//boomer default 50
			   SetConVarInt(FindConVar("z_charger_health"), 750);		//charger default 600
			   SetConVarInt(FindConVar("z_hunter_health"), 320);		//hunter default 250
			   SetConVarInt(FindConVar("z_jockey_health"), 175);		//jockey default 325
			   SetConVarInt(FindConVar("z_gas_health"), 325);		//smoker default 250
			   SetConVarInt(FindConVar("z_spitter_health"), 225);		//spitter default 150
			   SetConVarInt(FindConVar("z_tank_health"), 7000);		//tank default 4000
			...
			case 8:
			{
			   ...
			   WitchLimit = 3;
			   WitchPeriod = 90.0;
			   SetConVarInt(FindConVar("z_exploding_health"), 150);		//boomer default 50
			   SetConVarInt(FindConVar("z_charger_health"), 800);		//charger default 600
			   SetConVarInt(FindConVar("z_hunter_health"), 350);		//hunter default 250
			   SetConVarInt(FindConVar("z_jockey_health"), 200);		//jockey default 325
			   SetConVarInt(FindConVar("z_gas_health"), 350);		//smoker default 250
			   SetConVarInt(FindConVar("z_spitter_health"), 250);		//spitter default 150
			   SetConVarInt(FindConVar("z_tank_health"), 8000);		//tank default 4000
