...
ConVar g_hCvarAllow, g_hCvarDecayRate, g_hCvarGlow, g_hCvarGlowCol, g_hCvarHeal, g_hCvarMPGameMode, g_hCvarModes, g_hCvarModesOff, g_hCvarModesTog, g_hCvarRandom, g_hCvarRate, g_hCvarSafe, g_hCvarTemp;
int g_iColaCount, g_iCola[MAXPLAYERS+1], g_iColas[MAX_COLAS][2], g_iCvarGlow, g_iCvarGlowCol, g_iCvarHeal, g_iCvarRandom, g_iCvarSafe, g_iCvarTemp, g_iPlayerSpawn, g_iRoundStart;
