...
#define MODEL_GUARD1             "models/infected/hulk.mdl"
#define MODEL_GUARD2             "models/infected/hulk_dlc3.mdl"
#define MODEL_GUARD3             "models/infected/hulk_l4d1.mdl"
...
static const char sTankSounds[90][] =
{
    ...
    "player/tank/voice/growl/tank_fail_01.wav",
    "player/tank/voice/growl/tank_fail_02.wav",
    "player/tank/voice/growl/tank_fail_03.wav",
    "player/tank/voice/growl/tank_fail_04.wav",
    "player/tank/voice/growl/tank_fail_05.wav",
    ...
    "player/tank/voice/pain/tank_fire_01.wav",
    "player/tank/voice/pain/tank_fire_02.wav",
    "player/tank/voice/pain/tank_fire_03.wav",
    "player/tank/voice/pain/tank_fire_04.wav",
    "player/tank/voice/pain/tank_fire_05.wav",
    "player/tank/voice/pain/tank_fire_06.wav",
    "player/tank/voice/pain/tank_fire_07.wav",
    "player/tank/voice/pain/tank_fire_08.wav",
...
ConVar l4d_tank_guard_bestpose_onback;
ConVar l4d_tank_guard_bestpose_ondown;
ConVar l4d_tank_guard_pose_onback;
ConVar l4d_tank_guard_pose_down;
ConVar l4d_tank_guard_damage;
ConVar l4d_tank_guard_range;
ConVar l4d_tank_guard_gun_count;
ConVar l4d_tank_guard_shotonback;
ConVar l4d_tank_guard_steal;
ConVar l4d_tank_guard_spriteowner;
ConVar l4d_tank_guard_lose_in_death;
ConVar l4d_tank_guard_lose_in_afk;
ConVar l4d_tank_guard_bots;
ConVar l4d_tank_guard_prioritize_human_players;
ConVar l4d_tank_guard_give_random;
ConVar l4d_tank_guard_weapon_type;
ConVar l4d_tank_guard_arc;
ConVar l4d_tank_guard_glowtype;
ConVar l4d_tank_guard_glowflashing;
ConVar l4d_tank_guard_glowminrange;
ConVar l4d_tank_guard_glowmaxrange;
ConVar l4d_tank_guard_showbar;
ConVar l4d_tank_guard_mode;
ConVar l4d_tank_guard_scoredamage;
ConVar l4d_tank_guard_chance;
ConVar l4d_tank_guard_saferoom;
ConVar l4d_tank_guard_gamemodeson;
ConVar l4d_tank_guard_gamemodesoff;
ConVar l4d_tank_guard_gamemodestoggle;
ConVar l4d_tank_guard_mapson;
ConVar l4d_tank_guard_mapsoff;
ConVar l4d_tank_guard_model;
ConVar l4d_tank_guard_yell;
...
public void OnPluginStart()
{
    ...
    LoadTranslations("tank_guard.phrases");
    ...
    l4d_tank_guard_bestpose_onback = CreateConVar("l4d_tank_guard_bestpose_onback", "1", "0: random pose, 1: best pose, 2: specific pose (uses pose_onback cvars)", FCVAR_NOTIFY, true, 0.0, true, 2.0);
    l4d_tank_guard_bestpose_ondown = CreateConVar("l4d_tank_guard_bestpose_ondown", "1", "0: random pose, 1: best pose, 2: specific pose (uses pose_down cvars)", FCVAR_NOTIFY, true, 0.0, true, 2.0);
    l4d_tank_guard_pose_onback = CreateConVar("l4d_tank_guard_pose_onback", sBestAnimOnBack, "0: off, 1-82: default tank pose while on back. (l4d_tank_guard_bestpose_onback must be: 2)", FCVAR_NOTIFY, true, 0.0, true, 82.0);
    l4d_tank_guard_pose_down = CreateConVar("l4d_tank_guard_pose_down", sBestAnimDown, "0: off, 1-82: default tank pose while down. (l4d_tank_guard_bestpose_onback must be: 2)", FCVAR_NOTIFY, true, 0.0, true, 82.0);
    l4d_tank_guard_damage = CreateConVar("l4d_tank_guard_damage", "0.5", "attack dmage, 1.0: normal [0.1, 1.0]", FCVAR_NOTIFY);
    l4d_tank_guard_range = CreateConVar("l4d_tank_guard_range", "600.0", "attack range", FCVAR_NOTIFY);
    l4d_tank_guard_gun_count = CreateConVar("l4d_tank_guard_gun_count", "5", "gun count [0, 6]", FCVAR_NOTIFY);
    l4d_tank_guard_shotonback = CreateConVar("l4d_tank_guard_shotonback", "0", "0: do not shot on back, 1: shot", FCVAR_NOTIFY);
    l4d_tank_guard_steal = CreateConVar("l4d_tank_guard_steal", "0", "Enables/Disables other clients to steal(pick up) a Tank from other owners while on the ground. 0 = Disable, 1 = Enable.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
    l4d_tank_guard_spriteowner = CreateConVar("l4d_tank_guard_spriteowner", "1", "Show/Hide the sprite indicating which Tank in the ground is from the owner. 0 = Hide, 1 = Show.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
    l4d_tank_guard_lose_in_death = CreateConVar("l4d_tank_guard_lose_in_death", "0", "Lose tank when player dies. 0 = Disable, 1 = Enable.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
    l4d_tank_guard_lose_in_afk = CreateConVar("l4d_tank_guard_lose_in_afk", "0", "Lose tank when player goes afk. 0 = Disable, 1 = Enable.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
    l4d_tank_guard_bots = CreateConVar("l4d_tank_guard_bots", "0", "Allow bots to get Tank Guard 0 = Disable, 1 = Enable.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
    l4d_tank_guard_prioritize_human_players = CreateConVar("l4d_tank_guard_prioritize_human_players", "0", "Prioritize human players. 0 = Disable, 1 = Enable.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
    l4d_tank_guard_give_random = CreateConVar("l4d_tank_guard_give_random", "0", "Give tank to a random player if the killer already has one. 0 = Disable, 1 = Enable.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
    l4d_tank_guard_weapon_type = CreateConVar("l4d_tank_guard_weapon_type", "0", "Weapon type given to the tank. 0 = Random, 1 = Assault Rifle, 2 = Hunting Rifle, 3 = Auto Shotgun.", FCVAR_NOTIFY, true, 0.0, true, 3.0);
    l4d_tank_guard_arc = CreateConVar("l4d_tank_guard_arc", "360", "The arc that the tank guard will search for targets.", FCVAR_NOTIFY, true, 0.0, true, 360.0);
    l4d_tank_guard_glowtype = CreateConVar("l4d_tank_guard_glowtype", "3", "The Tank Guard glow outline type. (0 = None, 1 = On Use, 2 = On Look At, 3 = Constant.", FCVAR_NOTIFY, true, 0.0, true, 3.0);
    l4d_tank_guard_glowflashing = CreateConVar("l4d_tank_guard_glowflashing", "0", "The Tank Guard will have a glow outline flashing.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
    l4d_tank_guard_glowminrange = CreateConVar("l4d_tank_guard_glowminrange", "0", "The minimum range that a client can be away from the Tank Guard until the glow starts to outline.", FCVAR_NOTIFY, true, 0.0);
    l4d_tank_guard_glowmaxrange = CreateConVar("l4d_tank_guard_glowmaxrange", "0", "The maximum range that a client can be away from the Tank Guard until the glow stops to outline.", FCVAR_NOTIFY, true, 0.0);
    l4d_tank_guard_showbar = CreateConVar("l4d_tank_guard_showbar", "1", "Shows a progress bar while putting the Tank Guard down (L4D2 only). 0 = Disable, 1 = Enable.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
    l4d_tank_guard_mode = CreateConVar("l4d_tank_guard_mode", "1", "Criteria based on to give the Tank Guard. 0 = Last Hit, 1 = Most Damage.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
    l4d_tank_guard_scoredamage = CreateConVar("l4d_tank_guard_scoredamage", "1", "Enables the Tank Guard hits and kills count as the owner.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
    l4d_tank_guard_chance = CreateConVar("l4d_tank_guard_chance", "100.0", "% chance to get a Tank Guard when a tank is killed.", FCVAR_NOTIFY, true, 0.0, true, 100.0);
    l4d_tank_guard_saferoom = CreateConVar("l4d_tank_guard_saferoom", "0", "Enables carrying the Tank Guard across maps when reaches alive to the saferoom with it on back. Removes on map change. 0 = Disable, 1 = Enable", FCVAR_NOTIFY, true, 0.0, true, 1.0);
    l4d_tank_guard_gamemodeson = CreateConVar("l4d_tank_guard_gamemodes_on", "", "Turn on the plugin in these game modes, separate by commas (no spaces). Empty = all.\nKnown values: coop,realism,versus,survival,scavenge,teamversus,teamscavenge,\nmutation[1-20],community[1-6],gunbrain,l4d1coop,l4d1vs,holdout,dash,shootzones.", FCVAR_NOTIFY);
    l4d_tank_guard_gamemodesoff = CreateConVar("l4d_tank_guard_gamemodes_off", "", "Turn off the plugin in these game modes, separate by commas (no spaces). Empty = none.\nKnown values: coop,realism,versus,survival,scavenge,teamversus,teamscavenge,\nmutation[1-20],community[1-6],gunbrain,l4d1coop,l4d1vs,holdout,dash,shootzones.", FCVAR_NOTIFY);
    l4d_tank_guard_gamemodestoggle = CreateConVar("l4d_tank_guard_gamemodes_toggle", "0", "Turn on the plugin in these game modes.\nKnown values: 0 = all, 1 = coop, 2 = survival, 4 = versus, 8 = scavenge.\nAdd numbers greater than 0 for multiple options.\nExample: \"3\", enables for \"coop\" (1) and \"survival\" (2).", FCVAR_NOTIFY, true, 0.0, true, 15.0);
    l4d_tank_guard_mapson = CreateConVar("l4d_tank_guard_mapson", "", "Allow the plugin being loaded on these maps, separate by commas (no spaces). Empty = all.\nExample: \"l4d_hospital01_apartment,c1m1_hotel\"", FCVAR_NOTIFY);
    l4d_tank_guard_mapsoff = CreateConVar("l4d_tank_guard_mapsoff", "", "Prevent the plugin being loaded on these maps, separate by commas (no spaces). Empty = none.\nExample: \"l4d_hospital01_apartment,c1m1_hotel\"", FCVAR_NOTIFY);
    l4d_tank_guard_yell = CreateConVar("l4d_tank_guard_yell", "15.0", "How long should the Tank Guard down wait to yell. 0 = OFF", FCVAR_NOTIFY, true, 0.0);
    l4d_tank_guard_model = CreateConVar("l4d_tank_guard_model", "1", "Tank model given on kill. 0 = Random, 1 = Tank Model.", FCVAR_NOTIFY, true, 0.0, true, 1.0);

    // Hook Plugin ConVars Change
    hCvar_MPGameMode.AddChangeHook(Event_ConVarChanged);
    l4d_tank_guard_gamemodeson.AddChangeHook(Event_ConVarChanged);
    l4d_tank_guard_gamemodesoff.AddChangeHook(Event_ConVarChanged);
    l4d_tank_guard_gamemodestoggle.AddChangeHook(Event_ConVarChanged);
    l4d_tank_guard_mapson.AddChangeHook(Event_ConVarChanged);
    l4d_tank_guard_mapsoff.AddChangeHook(Event_ConVarChanged);

    #if DEBUG
        RegConsoleCmd("sm_w", CmdTest);
    #endif

    AutoExecConfig(true, "tank_guard_l4d");

    HookEvent("player_hurt", player_hurt);
    HookEvent("tank_killed", tank_killed, EventHookMode_Pre);
    ...
    RegConsoleCmd("sm_tankyell", sm_tankyell);
    RegConsoleCmd("sm_tankoff", sm_tankoff);
    RegConsoleCmd("sm_tankon", sm_tankon);
    RegConsoleCmd("sm_tankpose", sm_tankpose);
    RegConsoleCmd("sm_tankpose2", sm_tankpose2);

    RegAdminCmd("sm_givetank", sm_givetank, ADMFLAG_ROOT, "Gives a Tank to the target");
    ResetAllState();
}
...
void GetCvars()
{
    ...
    l4d_tank_guard_gamemodeson.GetString(sCvar_GameModesOn, sizeof(sCvar_GameModesOn));
    ReplaceString(sCvar_GameModesOn, sizeof(sCvar_GameModesOn), " ", "", false);
    l4d_tank_guard_gamemodesoff.GetString(sCvar_GameModesOff, sizeof(sCvar_GameModesOff));
    ReplaceString(sCvar_GameModesOff, sizeof(sCvar_GameModesOff), " ", "", false);
    iCvar_GameModesToggle = l4d_tank_guard_gamemodestoggle.IntValue;
    l4d_tank_guard_mapson.GetString(sCvar_MapsOn, sizeof(sCvar_MapsOn));
    ReplaceString(sCvar_MapsOn, sizeof(sCvar_MapsOn), " ", "", false);
    l4d_tank_guard_mapsoff.GetString(sCvar_MapsOff, sizeof(sCvar_MapsOff));
...
public void player_spawn(Event event, const char[] name, bool dontBroadcast)
{
    ...
    if (l4d_tank_guard_saferoom.IntValue == 1)
    {
...
public void OnEntityCreated(int entity, const char[] classname)
{
    ...
    if (StrEqual(classname, "tank", false))
        SDKHook(entity, SDKHook_OnTakeDamageAlive, OnTankTakeDamage);
}

public Action OnTankTakeDamage(int tank, int &attacker, int &inflictor, float &damage, int &damagetype, int &weapon, float damageForce[3], float damagePosition[3], int damagecustom)
{
    ...
    if (!IsIncapped(tank))
    {
        g_guardDamage[tank][attacker][0] += RoundFloat(damage);
        g_guardDamage[tank][attacker][1] = attacker;
    }
...
{
    if (GetConVarInt(l4d_tank_guard_scoredamage) == 0)
        return Plugin_Continue;
    ...
    if (StrEqual(classname, "env_weaponfire", false))
    {
        ...
        ReplaceString(targetname, sizeof(targetname), "clienttankguard", "");
...
Action sm_givetank(int client, int args)
{
    if (args == 0)
    {
        if (IsValidClient(client))
            PrintToChat(client, "\x05Usage: \x04!givetank \x03<target>");
        return Plugin_Handled;
    }
    ...
    for (int i = 0; i < target_count; i++)
    {
        ...
        {
            GuardType[target_list[i]] = GetRandomInt(0,2);
...
{
    PrintToChat(client, "Enumerating tank");
    ...
    while (-1 != (ent = FindEntityByClassname(ent, "prop_dynamic"))) {
        ...
        if (StrEqual(sName, MODEL_GUARD1, false)) {
            PrintToChat(client, "find the tank guard: %i, owner: %i", ent, GetGuardOwner(ent));
        }
...
public void OnMapStart()
{
    ...
    GuardModel3 = PrecacheModel(MODEL_GUARD3, true);
    ...
    for (int i = 0; i < sizeof(sTankSounds); i++)
    {
        PrecacheSound(sTankSounds[i]);
    }
}
...
public Action sm_tankpose(int client, int args)
{
    for(int i = 1; i<= MaxClients; i++)
    {
...
public Action sm_tankpose2(int client, int args)
{
    char sArg[256];
    GetCmdArg(1, sArg, sizeof(sArg));
    ...
    {
        if (!IsValidEntity(TankGuardEnt[i])) continue;

        SetEntProp(TankGuardEnt[i], Prop_Send, "m_nSequence", anim);
        SetEntPropFloat(TankGuardEnt[i], Prop_Send, "m_flPlaybackRate", 1.0);
    }
...
public Action sm_tankoff(int client, int args)
{
    if (IsValidClient(client))
    {
        GuardViewOff[client] = true;
        CPrintToChat(client, "%t", "View_Off"); // \x04tank \x03view is \x04off, \x03but others still can see it on your back");
    }
}

public Action sm_tankon(int client, int args)
{
    if (IsValidClient(client))
    {
        GuardViewOff[client] = false;
        CPrintToChat(client, "%t", "View_On"); // \x04tank \x03view is \x04on");
    }
}

public Action sm_tankyell(int client, int args)
{
    if (IsValidClient(client))
    {
        for(int i = 0; i<GuardCount; i++)
        {
            ...
            int owner = GetEntPropEnt(TankGuardEnt[i], Prop_Send, "m_hOwnerEntity");
            ...
            if (owner == client)
            {
                ...
                if (args == 0)
                {
                    soundIndex = GetRandomInt(0, sizeof(sTankSounds)-1);
                    EmitAmbientSound(sTankSounds[soundIndex], NULL_VECTOR, TankGuardEnt[i]);
                }
                else
                {
                    char sArg[256];
                    ...
                    soundIndex = StringToInt(sArg);
                    if (soundIndex > sizeof(sTankSounds)-1)
                        soundIndex = 0;
                }
...
public void player_hurt(Handle event, char[] name, bool dontBroadcast)
{
    int entityid = GetClientOfUserId(GetEventInt(event, "userid"));
...
public Action player_death(Event hEvent, const char[] strName, bool DontBroadcast)
{
    ...
    {
        if (l4d_tank_guard_lose_in_death.IntValue == 1)
        {
...
{
    if (l4d_tank_guard_lose_in_afk.IntValue == 1)
    {
...
public Action tank_killed(Event hEvent, const char[] strName, bool DontBroadcast)
{
    ...
    if (GetRandomFloat(0.1, 100.0) > GetConVarFloat(l4d_tank_guard_chance))
        return Plugin_Continue;
    ...
    if (tank > 0)
    {
        ...
        switch (l4d_tank_guard_mode.IntValue)
        {
            case 0:
            {
                ...
                if (attacker == 0)
                    attacker = lastAttacker[tank];
                else if (l4d_tank_guard_bots.IntValue == 0 && IsValidClient(attacker) && IsFakeClient(attacker))
                    attacker = lastHumanAttacker[tank];
                else if (l4d_tank_guard_prioritize_human_players.IntValue == 1 && IsValidClient(attacker) && IsFakeClient(attacker) && IsValidClient(lastHumanAttacker[tank]))
                    attacker = lastHumanAttacker[tank];
            }
            case 1:
            {
                ...
                //{
                //    PrintToServer("g_guardDamage[tank = %i][i = %i][0] = %i | %i | %N", tank, i, g_guardDamage[tank][i][0], g_guardDamage[tank][i][1],  g_guardDamage[tank][i][1]);
                //}

                SortCustom2D(g_guardDamage[tank], sizeof(g_guardDamage[]), SortByDamageDesc);
                ...
                for (int i = 0; i < sizeof(g_guardDamage[]); i++)
                {
                    if (g_guardDamage[tank][i][0] <= 0)
                        continue;

                    tempAttacker = g_guardDamage[tank][i][1];
                    ...
                    if (l4d_tank_guard_bots.IntValue == 0 && IsValidClient(tempAttacker) && IsFakeClient(tempAttacker))
                        continue;

                    if (l4d_tank_guard_give_random.IntValue == 1)
                    {
                    ...
                    if (l4d_tank_guard_prioritize_human_players.IntValue == 1 && IsFakeClient(tempAttacker))
                    {
                        if (tempAttacker2 == 0)
        ...
        lastAttacker[tank] = 0;
        lastHumanAttacker[tank] = 0;

        if (IsValidClient(attacker) && IsPlayerAlive(attacker) && GetClientTeam(attacker) == L4DTEAM_SURVIVOR)
        {
            if (l4d_tank_guard_model.IntValue == 0)
            {
                GuardType[attacker] = GetRandomInt(0,2);
            }
            else
            {
                int modelIndex = GetEntProp(tank, Prop_Send, "m_nModelIndex");

                if (modelIndex == GuardModel1)
                    GuardType[attacker] = 0;
                else if (modelIndex == GuardModel2)
                    GuardType[attacker] = 1;
                else if (modelIndex == GuardModel3)
                        GuardType[attacker] = 2;
                else
                    GuardType[attacker] = 0;
            }
            ...
            {
                case 0: CPrintToChatAll("%t", "Tank_on_back0", sName); // \x04%N \x03put tank on his back", attacker);
                case 1: CPrintToChatAll("%t", "Tank_on_back1", sName); // \x04%N \x03put tank on his back", attacker);
                case 2: CPrintToChatAll("%t", "Tank_on_back2", sName); // \x04%N \x03put tank on his back", attacker);
                case 3: CPrintToChatAll("%t", "Tank_on_back3", sName); // \x04%N \x03put tank on his back", attacker);
                case 4: CPrintToChatAll("%t", "Tank_on_back4", sName); // \x04%N \x03put tank on his back", attacker);
            }

            CPrintToChat(attacker, "%t", "Keys1"); // "\x03press\x04!use button \x03to put tank down");
            //CPrintToChat(attacker, "%t", "Keys2"); // "\x04!tank \x03 - toggle to see or hide your own tank");
        }
    }
    return Plugin_Continue;
}
...
void CreateDecoration(int client, bool showTrophy)
{
    ...
    if (GuardType[client] == 0)
        ...
        model = MODEL_GUARD2;
    else if (GuardType[client] == 2)
        model = MODEL_GUARD3;
    else
        model = MODEL_GUARD1;

    int tank = CreateEntityByName("prop_dynamic_override");
    ...
    DispatchKeyValue(tank, "parentname", tname);

    SetVariantString(tname);
    AcceptEntityInput(tank, "SetParent",tank, tank, 0);
    SetVariantString("medkit");
    AcceptEntityInput(tank, "SetParentAttachment");

    int anim = 0;
    switch (l4d_tank_guard_bestpose_onback.IntValue)
    {
        case 0: anim = Anim[GetRandomInt(0,AnimCount-1)];
        case 1: anim = best_anim_onback;
        case 2: anim = l4d_tank_guard_pose_onback.IntValue;
    }
    ...
    SetEntProp(tank, Prop_Send, "m_nSequence", anim);
    SetEntPropFloat(tank, Prop_Send, "m_flPlaybackRate", 1.0);

    GuardEnt[client] = tank;

    //if (l4d_tank_guard_bestpose_onback.IntValue == 0)
    //    CreateTimer(15.0, TimerAnimTank, client, TIMER_FLAG_NO_MAPCHANGE| TIMER_REPEAT);
    ...
    if (bL4D2Version)
    {
        ...
        SetEntProp(tank, Prop_Send, "m_iGlowType", l4d_tank_guard_glowtype.IntValue);
        SetEntProp(tank, Prop_Send, "m_bFlashing", l4d_tank_guard_glowflashing.IntValue);
        SetEntProp(tank, Prop_Send, "m_nGlowRangeMin", l4d_tank_guard_glowminrange.IntValue);
        SetEntProp(tank, Prop_Send, "m_nGlowRange", l4d_tank_guard_glowmaxrange.IntValue);
        ...
        {
            SetEntProp(tank, Prop_Send, "m_glowColorOverride", clientGlowColor);
            SetEntProp(tank, Prop_Send, "m_bFlashing", clientGlowFlashing);
            CreateTimer(0.1, tTankGlow, EntIndexToEntRef(tank), TIMER_REPEAT | TIMER_FLAG_NO_MAPCHANGE);
        }
        else
        {
            SetEntProp(tank, Prop_Send, "m_glowColorOverride", red + (green * 256) + (blue* 65536));
        }
    }
    ...
    DispatchKeyValueFloat(ent, "targetarc", l4d_tank_guard_arc.FloatValue);
    DispatchKeyValueFloat(ent, "targetrange", l4d_tank_guard_range.FloatValue);

    //1 : Assault Rifle
    //2 : Hunting Rifle
    //3 : Auto Shotgun
    char sWeaponType[2];
    if (l4d_tank_guard_weapon_type.IntValue == 0)
        Format(sWeaponType, sizeof(sWeaponType), "%i", GetRandomInt(1,3));
    else
        Format(sWeaponType, sizeof(sWeaponType), "%i", l4d_tank_guard_weapon_type.IntValue);
    ...
    DispatchKeyValueFloat(ent, "damagemod", l4d_tank_guard_damage.FloatValue);
    ...
    if (l4d_tank_guard_shotonback.IntValue == 1)AcceptEntityInput(ent, "Enable");
    ...
    #if DEBUG
    PrintToChatAll("Created tank decoration: %i", tank);
    #endif
}
void CreateGuard(int client)
{
    int anim = 0;
    switch (l4d_tank_guard_bestpose_ondown.IntValue)
    {
        case 0: anim = Anim[GetRandomInt(0,AnimCount-1)];
        case 1: anim = best_anim_down;
        case 2: anim = l4d_tank_guard_pose_down.IntValue;
    }
    ...
    int tank = CreateEntityByName("prop_dynamic_override");
    DispatchKeyValue(tank, "model", GuardType[client] ? MODEL_GUARD2 : MODEL_GUARD1);
    DispatchKeyValueFloat(tank, "fademindist", 10000.0);
    DispatchKeyValueFloat(tank, "fademaxdist", 20000.0);
    DispatchKeyValueFloat(tank, "fadescale", 0.0);

    DispatchSpawn(tank);

    //TeleportEntity(tank, Float:{0.0, 0.0, 0.0}, NULL_VECTOR, NULL_VECTOR);
    TeleportEntity(tank, pos, ang, NULL_VECTOR);
    ...
    char tName[128];
    Format(tName, sizeof(tName), "target%i",tank);
    DispatchKeyValue(tank , "targetname", tName);

    DispatchKeyValue(tank, "parentname", tName);
    SetVariantString(tName);
    AcceptEntityInput(tank, "SetParent", tank, tank, 0);

    if (l4d_tank_guard_spriteowner.IntValue == 1)
    {
        ...
        AcceptEntityInput(env_sprite, "SetParent", tank);

        char tNameSprite[64];
        Format(tNameSprite, sizeof(tNameSprite), "tankguardsprite%i", client);
    ...
    CreateTimer(GetConVarFloat(l4d_tank_guard_yell), tmrTankYell, EntIndexToEntRef(tank), TIMER_REPEAT|TIMER_FLAG_NO_MAPCHANGE);
    ...
    float pos2[3];
    int count = l4d_tank_guard_gun_count.IntValue;
    if (count<1)count = 1;
    ...
    for(int i = 0; i<count; i++)
    {
        ...
        char targetName[64];
        Format(targetName, sizeof(targetName), "clienttankguard%i", EntIndexToEntRef(client));
        DispatchKeyValue(ent, "targetname", targetName);

        DispatchKeyValue(ent, "parentname", tName);
        SetVariantString(tName);
        AcceptEntityInput(ent, "SetParent", tank, tank, 0);

        if (i%5 == 0) SetVariantString("mouth");
        else if (i%5 == 1) SetVariantString("lhand");
        else if (i%5 == 2) SetVariantString("rhand");
        else if (i%5 == 3) SetVariantString("lfoot");
        else if (i%5 == 4) SetVariantString("rfoot");
    ...
    TankGuardEnt[GuardCount] = tank;
    GuardCount++;

    #if DEBUG
    PrintToChatAll("Created tank guard: %i", tank);
    #endif
}

public Action tmrTankYell(Handle timer, any entity)
{
    if (EntRefToEntIndex(entity) != INVALID_ENT_REFERENCE)
    {
        int entIndex = EntRefToEntIndex(entity);

        int soundIndex = GetRandomInt(0, sizeof(sTankSounds)-1);
        EmitAmbientSound(sTankSounds[soundIndex], NULL_VECTOR, entIndex);
        return Plugin_Continue;
    }
...
public Action tTankGlow(Handle timer, int iEntRef)
{
...
{
    char tName[32];
    Format(tName, sizeof(tName), "tankguardsprite%i", client);
...
int CreateButton(float pos[3], int client)
{
    ...
    else
    {
        ...
        Format(sTemp, sizeof(sTemp), "%N's Tank", client);
        DispatchKeyValue(button, "use_sub_string", sTemp);
        DispatchKeyValue(button, "use_string", "Tank Guard");
    }
...
public void OnPressed(const char[] output, int caller, int activator, float delay)
{
    if (IsValidClient(activator))
    {
        ...
        if (l4d_tank_guard_steal.IntValue == 0 && IsValidClient(owner))
        {
            if (!IsValidClient(owner))
                return;
            ...
            if (activator != owner)
            {
                CPrintToChat(activator, "%t", "Steal_Tank", owner);
                return;
            }
        }
        ...
        if (IsValidEntity(TankGuardEnt[find]))
        {
            int modelIndex = GetEntProp(TankGuardEnt[find], Prop_Send, "m_nModelIndex");
            ...
            AcceptEntityInput(TankGuardEnt[find], "kill");
        }
        GuardEntSpawned[activator] = 0;

        for(int i = find; i<GuardCount; i++)
        {
            TankGuardEnt[i] = TankGuardEnt[i+1];
        ...
        PrintHintText(activator, "%t", "Put_back"); // "you put tank on back"
    }
}
...
public void PreThinkClient(int client)
{
    ...
    if (button & IN_USE)
    {
        ...
        if (!ClientIN_USE[client])
        {
            if (bL4D2Version)
            {
                if (l4d_tank_guard_showbar.IntValue == 1)
                {
        ...
        if (GetEngineTime() - PressTime[client] > fButtonTime)
        {
            ...
            CreateGuard(client);
            PrintHintText(client, "%t", "Put_down"); // "you put tank down"
        }
    }
    else
    {
...
//public Action TimerAnimTank(Handle timer, any client)
//{
//    if (IsGuard(GuardEnt[client]))
//    {
//        if (IsValidClient(client) && IsPlayerAlive(client) && GetClientTeam(client) == L4DTEAM_SURVIVOR)
...
stock bool IsGuardEntity(int iEntity)
{
    if (IsValidEntity(iEntity))
    {
        ...
        return StrEqual(sClassname, "tank");
    }
    return false;
}
...
bool IsAllowedMap()
{
    ...
    GetConVarString(l4d_tank_guard_mapson, sCvar_MapsOn, sizeof(sCvar_MapsOn));
    GetConVarString(l4d_tank_guard_mapsoff, sCvar_MapsOff, sizeof(sCvar_MapsOff));
    ReplaceString(sCvar_MapsOn, sizeof(sCvar_MapsOn), " ", "", false);
