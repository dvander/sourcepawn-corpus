...
public void OnPluginStart()
{
    ...
    g_hCvar_MinDamage = CreateConVar("l4d_deadly_tank_hittables_mindamage", "8.0", "Minimum damage necessary received from a prop_physics to apply deadly damage.\n0 = No damage check.", CVAR_FLAGS, true, 0.0);
...
Action OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype)
{
    ...
    if (g_bCvar_MinDamage && damage < g_fCvar_MinDamage)
        return Plugin_Continue;
...
Action CmdPrintCvars(int client, int args)
{
    ...
    PrintToConsole(client, "l4d_deadly_tank_hittables_team : %i (SPECTATOR = %s | SURVIVOR = %s | INFECTED = %s | HOLDOUT = %s)", g_iCvar_Team,
    ...
    PrintToConsole(client, "l4d_deadly_tank_hittables_damage_check : %.1f", g_fCvar_MinDamage);
    PrintToConsole(client, "");
    PrintToConsole(client, "======================================================================");
    PrintToConsole(client, "");
