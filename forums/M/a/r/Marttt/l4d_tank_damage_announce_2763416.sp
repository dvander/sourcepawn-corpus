...
bool IsTankDying()
{
	...
	return !!GetEntData(tankclient, g_iOffset_Incapacitated);
}
...
void PrintTankDamage()
{
	...
	int survivor_clients[MAXPLAYERS+1]; // Array to store survivor client indexes in, for the display iteration
	int percent_damage;
	int damage;
