...
public void OnPluginStart()
{
    ...
    FindConVar("sv_cheats").AddChangeHook(Event_SvCheatsChanged); // sv_cheats changes rollback shadow settings
...
public void Event_SvCheatsChanged(ConVar convar, const char[] oldValue, const char[] newValue)
{
    LateLoad();
}
...
public Action CmdToggle(int client, int args)
{
    ...
    PrintToChat(client, "Shadows %s", !g_bToggle ? "Disabled" : "Enabled");
...
public Action CmdPrintCvars(int client, int args)
{
    ...
    PrintToConsole(client, "----------------------------------------------------------------------");
    PrintToConsole(client, "");
    PrintToConsole(client, "Current Shadow Status : %s", !g_bToggle ? "Disabled" : "Enabled");
    PrintToConsole(client, "");
    PrintToConsole(client, "======================================================================");
    PrintToConsole(client, "");
