...
public void OnPluginStart()
{
	...
	CreateConVar(						"l4d_trophy_version",		PLUGIN_VERSION, "Achievement Trophy plugin version.", CVAR_FLAGS_PLUGIN_VERSION);
...
public void Event_WitchHurt(Handle event, char[] name, bool dontBroadcast)
{
	if (!g_bCvarWitch)
		return;
...
public void Event_TankHurt(Event event, const char[] name, bool dontBroadcast)
{
	if (!g_bCvarTank)
		return;
	...
	if (GetZombieClass(tank) != g_bTankZombieClass)
		return;
