...
public OnPluginStart()
{
	...
	g_cvars[CVAR_DISCO] = CreateConVar("lights_disco_enable", "0", "Automatically enable Disco Mode.", FCVAR_NOTIFY);
	g_cvars[CVAR_FLAG] = CreateConVar("lights_flag", "z", "Flag required to use the commands.", FCVAR_NOTIFY);
...
stock GetNameFromColor(value, String:color[], color_size)
{
	switch (value)
	{
...
stock GetColorFromInt(value, String:color[], color_size)
{
	switch (value)
	{
