...
public void OnPluginStart()
{
    ...
    g_hCvar_Enabled     = CreateConVar("l4d_tank_rock_nice_shot_enable", "1", "Enable/Disable the plugin.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_Chance      = CreateConVar("l4d_tank_rock_nice_shot_chance", "100", "Chance (%) to a teammate emit a nice shot voice line.\n0 = OFF.", CVAR_FLAGS, true, 0.0, true, 100.0);
    g_hCvar_LaughChance = CreateConVar("l4d_tank_rock_nice_shot_laugh_chance", "100", "Chance (%) to the attacker laugh when the rock is destroyed.\n0 = OFF.", CVAR_FLAGS, true, 0.0, true, 100.0);
    ...
    // Admin Commands
    RegAdminCmd("sm_print_cvars_l4d_tank_rock_nice_shot", CmdPrintCvars, ADMFLAG_ROOT, "Prints the plugin related cvars and their respective values to the console.");
}
