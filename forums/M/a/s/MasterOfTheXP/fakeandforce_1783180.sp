...
public OnPluginStart()
{
	...
	RegConsoleCmd("sm_faf", Command_fakeandforce, "sm_faf - Lists all Fake and Force commands.");
	RegConsoleCmd("sm_fakeach", Command_fakeach, "sm_fakeach <target> <achievement> - Fake getting an achievement, even fake ones.");
	RegConsoleCmd("sm_fakeact", Command_fakeactivity, "sm_fakeactivity <admin> <action> [target] - Fakes admin activity.");
	RegConsoleCmd("sm_fakeactivity", Command_fakeactivity, "sm_fakeactivity <admin> <action> [target] - Fakes admin activity.");
	RegConsoleCmd("sm_fakeaddtime", Command_faketime, "sm_faketime <seconds> - Fakes adding seconds to the round timer.");
	RegConsoleCmd("sm_fakeandforce", Command_fakeandforce, "sm_fakeandforce - Lists all Fake and Force commands.");
	RegConsoleCmd("sm_fakeblock", Command_fakeblock, "sm_fakeblock <target> [control point name] - Fakes the defense of a Control Point.");
	RegConsoleCmd("sm_fakebuy", Command_fakebuy, "sm_fakebuy <target> <item> - Fake someone buying something from the Mann. Co Store.");
	RegConsoleCmd("sm_fakeconnect", Command_fakejoin, "sm_fakejoin <username> [IP] [Steam ID, commas instead of colons] - Fakes a client connect. Specify _ to skip arguments.");
	RegConsoleCmd("sm_fakecraft", Command_fakecraft, "sm_fakecraft <target> <item> - Fake someone crafting something.");
	RegConsoleCmd("sm_fakedamage", Command_fakedamage, "sm_fakedmg <victim> [amount] [attacker] - Fakes damage being dealt.");
	RegConsoleCmd("sm_fakedmg", Command_fakedamage, "sm_fakedmg <victim> [amount] [attacker] - Fakes damage being dealt.");
	RegConsoleCmd("sm_fakeded", Command_fakedeath, "sm_fakedeath <victim> [killer] [assister] [weapon] [flags] - Fakes a death. Specify _ to skip arguments.");
	RegConsoleCmd("sm_fakedeath", Command_fakedeath, "sm_fakedeath <victim> [killer] [assister] [weapon] [flags] - Fakes a death. Specify _ to skip arguments.");
	RegConsoleCmd("sm_fakedefend", Command_fakeblock, "sm_fakeblock <target> [control point name] - Fakes the defense of a Control Point.");
	RegConsoleCmd("sm_fakedisconnect", Command_fakequit, "sm_fakequit <target> [reason] - Fake someone leaving the server.");
	RegConsoleCmd("sm_fakeearn", Command_fakeearn, "sm_fakeearn <target> <item> - Fake someone earning something from winning duels.");
	RegConsoleCmd("sm_fakeeyeboss", Command_fakemono, "sm_fakemono [defeat?] - Fakes a MONOCULUS! spawn.");
	RegConsoleCmd("sm_fakefind", Command_fakefind, "sm_fakefind <target> <item> - Fake someone finding something from an item drop.");
	RegConsoleCmd("sm_fakefish", Command_fakefish, "sm_fakefish <victim> [attacker] [assister] [weapon] - Fakes a Holy Mackerel/Unarmed Combat hit-notice. Specify _ to skip arguments.");
	RegConsoleCmd("sm_fakeheal", Command_fakeheal, "sm_fakeheal <target> [amount] - Fakes a Crusader's Crossbow heal.");
	RegConsoleCmd("sm_fakehhh", Command_fakehhh, "sm_fakehhh [defeat?] - Fakes a Horsemann spawn.");
	RegConsoleCmd("sm_fakehit", Command_fakefish, "sm_fakefish <victim> [attacker] [assister] [weapon] - Fakes a Holy Mackerel/Unarmed Combat hit-notice. Specify _ to skip arguments.");
	RegConsoleCmd("sm_fakehorsemann", Command_fakehhh, "sm_fakehhh [defeat?] - Fakes a Horsemann spawn.");
	RegConsoleCmd("sm_fakeitemrename", Command_fakerenameitem, "sm_fakerenameitem <target> <original item name> <new item name> - Fake someone renaming an item.");
	RegConsoleCmd("sm_fakejoin", Command_fakejoin, "sm_fakejoin <username> [IP] [Steam ID, commas instead of colons] - Fakes a client connect. Specify _ to skip arguments.");
	RegConsoleCmd("sm_fakekill", Command_fakedeath, "sm_fakedeath <victim> [killer] [assister] [weapon] [flags] - Fakes a death. Specify _ to skip arguments.");
	RegConsoleCmd("sm_fakeleave", Command_fakequit, "sm_fakequit <target> [reason] - Fake someone leaving the server.");
	RegConsoleCmd("sm_fakemono", Command_fakemono, "sm_fakemono [defeat?] - Fakes a MONOCULUS! spawn.");
	RegConsoleCmd("sm_fakemonoculus", Command_fakemono, "sm_fakemono [defeat?] - Fakes a MONOCULUS! spawn.");
	RegConsoleCmd("sm_fakepart", Command_fakequit, "sm_fakequit <target> [reason] - Fake someone leaving the server.");
	RegConsoleCmd("sm_fakequit", Command_fakequit, "sm_fakequit <target> [reason] - Fake someone leaving the server.");
	RegConsoleCmd("sm_fakerenameitem", Command_fakerenameitem, "sm_fakerenameitem <target> <original item name> <new item name> - Fake someone renaming an item.");
	RegConsoleCmd("sm_fakereceive", Command_fakereceive, "sm_fakereceive <target> <item> - Fake someone receiving a gift.");
	RegConsoleCmd("sm_faketime", Command_faketime, "sm_faketime <seconds> - Fakes adding seconds to the round timer.");
	RegConsoleCmd("sm_faketrade", Command_faketrade, "sm_faketrade <target> <item> - Fake someone finishing a trade and receiving an item.");
	RegConsoleCmd("sm_fakeunbox", Command_fakeunbox, "sm_fakeunbox <target> <item> - Fake someone uncrating something.");
	RegConsoleCmd("sm_forcecmd", Command_forcecmd, "sm_forcecmd <target> <command> - Force someone to execute a command. Game-changing commands like 'quit' or 'bind' do not work.");
	RegConsoleCmd("sm_forcecmd2", Command_forcecmd2, "sm_forcecmd2 <target> <command> - Force someone to execute a command. Game-changing commands like 'quit' or 'bind' do not work.");
	RegConsoleCmd("sm_forcesay", Command_forcesay, "sm_forcesay <target> <text> - Force someone to say something.");
	RegConsoleCmd("sm_forcesay_team", Command_forcesayteam, "sm_forcesay_team <target> <text> - Force someone to say something to their team.");
	RegConsoleCmd("sm_forcesayteam", Command_forcesayteam, "sm_forcesayteam <target> <text> - Force someone to say something to their team.");
	RegConsoleCmd("sm_forcetaunt", Command_forcetaunt, "sm_forcetaunt <target> - Forces someone to taunt.");
	RegConsoleCmd("sm_forcevoice", Command_forcevoice, "sm_forcevoice <target> <voice command id or name> - Force someone to use a voice command.");
	RegConsoleCmd("sm_forcevoicecmd", Command_forcevoice, "sm_forcevoice <target> <voice command id or name> - Force someone to use a voice command.");
	RegConsoleCmd("sm_forcevoicemenu", Command_forcevoice, "sm_forcevoice <target> <voice command id or name> - Force someone to use a voice command.");
...
public Action:Command_fakerenameitem(client, args)
{
	...
	for (new i = 0; i < target_count; i++)
	{
		...
		else if (StrContains(arg2, "Haunted", false) == 0) Format(itemString, 128, "%s \x078650AC%s\x01", itemString, arg2);
		...
		else if (StrContains(arg2, "Haunted", false) == 0) Format(itemString, 128, "%s to \x078650AC%s\x01", itemString, arg3);
