...
#define GrenadeColor   {225,0,0,225}
new GrenadeSprite;
...
public OnMapStart()
{
    ...
    GrenadeSprite = PrecacheModel("materials/sprites/laserbeam.vmt");
...
public OnEntitySpawned(entity)
{
    ...
    if(War3_GetRace(client)==thisRaceID)
    {
        ...
        {
            if(strcmp(class_name, "hegrenade_projectile") == 0)
            {
                TE_SetupBeamFollow(entity, GrenadeSprite,  0, Float:1.0, Float:10.0, Float:10.0, 5, GrenadeColor);
                TE_SendToAll();
            }
        }
    }
