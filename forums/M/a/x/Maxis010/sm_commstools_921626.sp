...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_mute", Command_Mute, ADMFLAG_CHAT, "sm_mute <#userid|name>")
	RegAdminCmd("sm_gag", Command_Gag, ADMFLAG_CHAT, "sm_gag <#userid|name>")
	RegAdminCmd("sm_silence", Command_Silence, ADMFLAG_CHAT, "sm_silence <#userid|name>")
	
	RegAdminCmd("sm_pmute", Command_PermaMute, ADMFLAG_CHAT, "sm_pmute <#userid|name> <reason>")
	RegAdminCmd("sm_pgag", Command_PermaGag, ADMFLAG_CHAT, "sm_pgag <#userid|name> <reason>")
	RegAdminCmd("sm_psilence", Command_PermaSilence, ADMFLAG_CHAT, "sm_psilence <#userid|name> <reason>")
