...
new String:OriginalName[MAXPLAYERS+1][MAX_NAME_LENGTH];
...
new Handle:LANcountry = INVALID_HANDLE;
new Handle:ChangeName = INVALID_HANDLE;
new Handle:PluginVersionCVAR = INVALID_HANDLE;

new Handle:ip_regex = INVALID_HANDLE;
