...
public Action:Command_SetMyClass(client, args)
{
	if(args != 1)
	{
		...
		AddMenuItem(cm, "3", "Pyro");
		AddMenuItem(cm, "4", "Demoman");
		AddMenuItem(cm, "5", "Heavy");
		AddMenuItem(cm, "6", "Engineer");
		AddMenuItem(cm, "7", "Medic");
		AddMenuItem(cm, "8", "Sniper");
		AddMenuItem(cm, "9", "Spy");
		AddMenuItem(cm, "10", "Random");
