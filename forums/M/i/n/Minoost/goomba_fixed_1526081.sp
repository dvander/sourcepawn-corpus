...
public OnPluginStart()
{
	...
	g_Cvar_DamageAdd = CreateConVar("goomba_dmg_add", "25.0", "Add this amount of damages after goomba_dmg_lifemultiplier calculation", 0, true, 0.0, false, 0.0);
		...
		if(StrEqual(edictName, "player"))
		{
			...
			{				
				...
				{	
					...
					SDKHooks_TakeDamage(victim, client, client, victim_health * GetConVarFloat(g_Cvar_DamageLifeMultiplier) + GetConVarFloat(g_Cvar_DamageAdd), DMG_PREVENT_PHYSICS_FORCE | DMG_BLAST | DMG_AIRBOAT);
...
public Action:Event_PlayerDeath(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	new Float:damagebits = GetEventFloat(event, "damagebits");
	
	if(damagebits == (DMG_PREVENT_PHYSICS_FORCE | DMG_BLAST | DMG_AIRBOAT))
	{
