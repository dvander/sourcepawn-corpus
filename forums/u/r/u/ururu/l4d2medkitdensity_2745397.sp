...
* 
* Version 1.5.1
* 		- fixed a bug where Medkit would continue to be generated after a round failure
* Version 1.5
...
public evtItemPickup(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	{
		// Timer_DelayChangeDensity should only be called on the first pickup
		if(!g_bFirstItemPickedUp)
		{
			CreateTimer(0.1, Timer_DelayChangeDensity)			
