...
public Action:MensajesSpawn(Handle:timer, any:client)
{
 ...
 {
   PrintToChat(client, "\x04[Shop] \x05Kill Zombies to get credits. max.= 150 credits!");
   PrintToChat(client, "\x04[Shop] \x05Type \x03!awards \x05to spend your credits on prizes for 1 Round!");
 }
}
