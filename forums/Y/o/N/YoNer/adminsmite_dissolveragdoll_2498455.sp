...
#define PLUGIN_VERSION "2.1yL4D2"
#define SOUND_THUNDER "ambient/explosions/explode_2.wav"
#define SOUND_THUNDER2 "ambience/rainscapes/thunder_close01.wav"
#define SOUND_THUNDER3 "ambient/weather/thunderstorm/thunder_3.wav"

public Plugin:myinfo =
{
	name = "Admin Smite",
	author = "Hipster, Bacardi mess this",
	description = "Slay players with a lightning bolt effect, dissolve ragdoll, Sound Mod by YoNer - L4D2 version",
	version = PLUGIN_VERSION,
	url = "http://forums.alliedmods.net/showpost.php?p=1237036&postcount=27"
};
...
public OnMapStart()
{
	...
	PrecacheSound(SOUND_THUNDER2, true);
	PrecacheSound(SOUND_THUNDER3, true);
...
PerformSmite(client, target)
{
	...
	clientpos[2] += 63; // increase y-axis by 26 to strike at player's chest instead of the ground
	...
	EmitAmbientSound(SOUND_THUNDER, startpos, client, SNDLEVEL_HELICOPTER);
	EmitAmbientSound(SOUND_THUNDER2, startpos, client, SNDLEVEL_HELICOPTER);
	EmitAmbientSound(SOUND_THUNDER3, startpos, client, SNDLEVEL_HELICOPTER);
	EmitAmbientSound(SOUND_THUNDER, startpos, client, SNDLEVEL_HELICOPTER);
	EmitAmbientSound(SOUND_THUNDER2, startpos, client, SNDLEVEL_HELICOPTER);
	EmitAmbientSound(SOUND_THUNDER3, startpos, client, SNDLEVEL_HELICOPTER);
	ForcePlayerSuicide(target);
	CreateTimer(0.1, DissolveRagdoll, target);
}
