...
ConVar Cvar_WaitTime_Coop, Cvar_WaitTime_Versus, Cvar_WaitTime_Scavenge, Cvar_WaitTime_Survival;
...
void CreateChangeMapTimer(const char[] mapName) {
	float delay = 60.0;
	switch (g_iGameMode) {
		case LMM_GAMEMODE_COOP: {delay=Cvar_WaitTime_Coop.FloatValue;}
		case LMM_GAMEMODE_VERSUS: {delay=Cvar_WaitTime_Versus.FloatValue;}
		case LMM_GAMEMODE_SCAVENGE: {delay=Cvar_WaitTime_Scavenge.FloatValue;}
		case LMM_GAMEMODE_SURVIVAL: {delay=Cvar_WaitTime_Survival.FloatValue;}
	}
...
public void OnPluginStart() {
	...
	Cvar_WaitTime_Coop =		CreateConVar("asc_switch_time_coop",	"60",	"Time before a map will be changed in coop mode");
	Cvar_WaitTime_Versus =		CreateConVar("asc_switch_time_versus",	"60",	"Time before a map will be changed in versus mode");
	Cvar_WaitTime_Scavenge =	CreateConVar("asc_switch_time_scavenge","60",	"Time before a map will be changed in scavenge mode");
	Cvar_WaitTime_Survival =	CreateConVar("asc_switch_time_survival","60",	"Time before a map will be changed in survival mode");
...
Action Timer_WelcomeMessage(Handle timer, any param) {
...
======================================================================================*/
void CVarChange_PreventEmptyServer(Handle hCVar, const char[] strOldValue, const char[] strNewValue) {
...
void CVarChange_ChMapBroadcastInterval(Handle hCVar, const char[] strOldValue, const char[] strNewValue) {
	//If the value was not changed, then do nothing
	if(StrEqual(strOldValue, strNewValue, false))
		return;
...
Action Timer_CheckEmptyServer(Handle timer, any param) {
