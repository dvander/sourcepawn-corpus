...
{	
	...
	g_cvarAutoload 		= CreateConVar("l4d2_spawn_props_autoload", 			"1", "Enable the plugin to auto load the cache?");
...
public void OnClientPutInServer(int client)
{
	if (!g_bLoaded)
    	{
        if (!IsFakeClient(client) && L4D_IsFirstMapInScenario() && !g_bFirst_Map_Objects_Spawned)
        {
...
void SaveRoutingPath(int client, int type)
{
	...
	if(!Exists)
	{
		...
		file.WriteLine("	");
		file.WriteLine("	\"OnTrigger\" \"director_queryill\"");
		file.WriteLine("}");
		file.WriteLine("");
		file.WriteLine("{");
		file.WriteLine("	\"origin\" \"0 0 0\"");
		...
		file.WriteLine("	");
		file.WriteLine("	\"OnMapSpawn\" \"easy_route_blocker                                                                            isable\"");
		file.WriteLine("	\"OnMapSpawn\" \"easy_route_blocker                                                                            isableCollision\"");
		file.WriteLine("	\"OnMapSpawn\" \"medium_route_blocker                                                                              isable\"");
		file.WriteLine("	\"OnMapSpawn\" \"medium_route_blocker                                                                              isableCollision\"");
		file.WriteLine("	\"OnMapSpawn\" \"hard_route_blocker                                                                            isable\"");
		file.WriteLine("	\"OnMapSpawn\" \"hard_route_blocker                                                                            isableCollision\"");
		file.WriteLine("}");
		...
		file.WriteLine("	\"OutAnger\" \"DoHeadBang	nValue\"");
		file.WriteLine("}");
		file.WriteLine("");
		...
		file.WriteLine("	\"classname\" \"logic_relay\"");
		file.WriteLine("	\"OnTrigger\" \"easy_route_blocker nable\"");
		file.WriteLine("	\"OnTrigger\" \"easy_route_blocker nableCollision\"");
		file.WriteLine("}");
		file.WriteLine("");
		...
		file.WriteLine("	\"spawnflags\" \"0\"");
		file.WriteLine("	\"classname\" \"logic_relay\"");
		file.WriteLine("	\"OnTrigger\" \"medium_route_blocker nable\"");
		file.WriteLine("	\"OnTrigger\" \"medium_route_blocker nableCollision\"");
		file.WriteLine("}");
		file.WriteLine("");
		...
		file.WriteLine("	\"spawnflags\" \"0\"");
		file.WriteLine("	\"classname\" \"logic_relay\"");
		file.WriteLine("	\"OnTrigger\" \"hard_route_blocker nable\"");
		file.WriteLine("	\"OnTrigger\" \"hard_route_blocker nableCollision\"");
		file.WriteLine("}");
		file.WriteLine("");
	}
	for(int i=MaxClients; i < MAX_ENTITY; i++)
