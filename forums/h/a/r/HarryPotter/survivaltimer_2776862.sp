...
public OnPluginStart() {
	...
	autoStart = CreateConVar("survival_timer_auto", "1", "The Survival Event Timer is automatically on for players by default but can be manual.", FCVAR_NOTIFY);
	useHints = CreateConVar("survival_timer_hints", "1", "The Survival Event Timer displays hints by default but can display chat messages instead.", FCVAR_NOTIFY);
	...
	HookEvent("mission_lost", event_TimerEnd);
