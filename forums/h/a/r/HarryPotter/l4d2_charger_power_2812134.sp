...
public void OnPluginStart()
{
	...
	g_h_CvarPushLimit = CreateConVar("l4d2_charger_power_push_limit", "5", "How many times object can be moved", FCVAR_NOTIFY, true, 1.0, true, 100.0);
	g_h_CvarRemoveObject = CreateConVar("l4d2_charger_power_remove", "120", "Remove moved object after some time (in seconds)", FCVAR_NOTIFY, true, 0.0, true, 100.0);
