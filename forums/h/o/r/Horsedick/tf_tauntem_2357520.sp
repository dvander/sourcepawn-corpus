...
public Action:Tauntme_Menu(client)
{
	...
	switch(class)
	{
		...
		case TFClass_Sniper:
		{
			...
			AddMenuItem(menu, "30609", "(Sniper)The Killer Solo");
		}
		case TFClass_Soldier:
		{
			AddMenuItem(menu, "1113", "(Soldier)Fresh Brewed Victory Taunt");
			AddMenuItem(menu, "30673", "(Soldier)Soldier's Requiem Taunt");
		}
		...
		{
			AddMenuItem(menu, "1115", "(Engineer)Rancho Relaxo Taunt");
		}
	}
...
public Action:Cmd_Tauntem_List(client, args)
{
	...
	PrintToConsole(client, "-30615: The Boxtrot Taunt");
	PrintToConsole(client, "-30616: The Proletariat Showoff Taunt");
	PrintToConsole(client, "-30621: Burstchester Taunt");
	PrintToConsole(client, "-30672: Zoomin' Broom Taunt");
	PrintToConsole(client, "-30673: Soldier's Requiem Taunt");
