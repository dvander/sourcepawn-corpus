...
#define GETVERSION "1.6.7" //Plugin version
...
new Handle:g_hForward_CommonKilled = INVALID_HANDLE;
...
public OnPluginStart()
{
	...
	g_hForward_CommonKilled = CreateGlobalForward("OnCommonKilled", ET_Event, Param_Cell, Param_Cell, Param_String, Param_Cell);
}
	...
	if(iVictim == 0)
	{
		...
		if(iEntity > 0 && IsValidEntity(iEntity) && IsValidEdict(iEntity))
		{
			...
			if(StrEqual(class, "infected"))
			{
				...
				Forward_OnCommonKilled(iAttacker, iEntity, sWeapon, iDmgType);
			}
		}
	}
...
public OnCommonKilled(attacker, infected, String:weapon[], type)
{
...
public Forward_OnCommonKilled(attacker, infected, String:weapon[], type)
{
	new bool:result;
	Call_StartForward(g_hForward_CommonKilled);
