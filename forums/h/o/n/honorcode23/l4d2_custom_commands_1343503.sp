...
{
	LogDebug("####### Initializating Plugin... #######");
	//Left 4 dead 2 only
	...
	RegAdminCmd("sm_bugplayer", CmdBugPlayer, DESIRED_FLAGS, "Bugs a player forcing him to close the left4dead2.exe process by hand");
	...
	{
		SetFailState("Unable to find the 'VomitPlayer' offset. Please, check if the version of the file is valid");
	}
...
{
	LogDebug("The topmenu library was removed, topmenu is now invalid");
...
public Action:CmdCCRefresh(client, args)
{
	...
	{
		AddToTopMenu (g_hTopMenu, "l4d2vomitplayer", TopMenuObject_Item, MenuItem_VomitPlayer, players_commands, "l4d2vomitplayer", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2incapplayer", TopMenuObject_Item, MenuItem_IncapPlayer, players_commands, "l4d2incapplayer", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2speedplayer", TopMenuObject_Item, MenuItem_SpeedPlayer, players_commands, "l4d2speedplayer", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2sethpplayer", TopMenuObject_Item, MenuItem_SetHpPlayer, players_commands, "l4d2sethpplayer", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2colorplayer", TopMenuObject_Item, MenuItem_ColorPlayer, players_commands, "l4d2colorplayer", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2sizeplayer", TopMenuObject_Item, MenuItem_ScalePlayer, players_commands, "l4d2sizeplayer", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2shakeplayer", TopMenuObject_Item, MenuItem_ShakePlayer, players_commands, "l4d2shakeplayer", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2chargeplayer", TopMenuObject_Item, MenuItem_Charge, players_commands, "l4d2chargeplayer", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2teleplayer", TopMenuObject_Item, MenuItem_TeleportPlayer, players_commands, "l4d2teleplayer", DESIRED_FLAGS);
		
		AddToTopMenu (g_hTopMenu, "l4d2dontrush", TopMenuObject_Item, MenuItem_DontRush, players_commands, "l4d2dontrush", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2airstrike", TopMenuObject_Item, MenuItem_Airstrike, players_commands, "l4d2airstrike", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2changehp", TopMenuObject_Item, MenuItem_ChangeHp, players_commands, "l4d2changehp", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2godmode", TopMenuObject_Item, MenuItem_GodMode, players_commands, "l4d2godmode", DESIRED_FLAGS);
	}
	else
	{
	...
	{
		AddToTopMenu (g_hTopMenu, "l4d2createexplosion", TopMenuObject_Item, MenuItem_CreateExplosion, server_commands, "l4d2createexplosion", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2norescue", TopMenuObject_Item, MenuItem_NoRescue, server_commands, "l4d2norescue", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2gnomerain", TopMenuObject_Item, MenuItem_GnomeRain, server_commands, "l4d2gnomerain", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2survrain", TopMenuObject_Item, MenuItem_SurvRain, server_commands, "l4d2survrain", DESIRED_FLAGS);
		AddToTopMenu (g_hTopMenu, "l4d2gnomewipe", TopMenuObject_Item, MenuItem_GnomeWipe, server_commands, "l4d2gnomewipe", DESIRED_FLAGS);
	}
	else
	{
...
public Action:CmdCheat(client, args)
{
	...
	else
	{
		...
		FakeClientCommand(client, "%s", buffer2);
...
public OnAdminMenuReady(Handle:topmenu)
{
	...
	{
		LogError("[WARNING!] The Player Commands category was invalid! Unable to add items to the menu");
	}
	...
	{
		LogError("[WARNING!] The Server Commands category was invalid! Unable to add items to the menu");
	}
}
...
public MenuHandler_VomitPlayer(Handle:menu2, MenuAction:action, param1, param2)
{
	...
	else if (action == MenuAction_Select)
	{
		...
		LogCommand("%s used the 'Vomit Player' command on '%s'", name, name2);
	}
}
