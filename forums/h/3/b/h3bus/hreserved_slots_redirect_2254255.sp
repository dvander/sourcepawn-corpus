...
public Action:OnTimedRedirect(Handle:timer, any:value)
{
	...
	if(StrEqual("", target))
    {
		new String:kickCommand[250];
		Format(kickCommand, sizeof(kickCommand), "redirect_lockout %d \"%T\"", GetClientUserId(client), "Offers redirect", client, RoundToCeil(displayTime));
