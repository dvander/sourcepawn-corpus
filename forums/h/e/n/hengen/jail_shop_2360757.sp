...
public OnPluginStart()
{
	...
	RegConsoleCmd("sm_market", SHOPMENU);
	RegConsoleCmd("sm_kredi", Creditos);
	RegConsoleCmd("sm_hediye", Command_SendCredits);
	RegConsoleCmd("sm_canlan", Reviver);
	RegConsoleCmd("sm_kredigoster", Command_ShowCredits);
