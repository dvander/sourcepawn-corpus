...
public Action Timer_Hurt(Handle hTimer, any client)
{
	...
	else if (iHealth > 90)
	{
		...
		{
			case 91:
				SetEntProp(client, Prop_Send, "m_iHealth", iHealth + 9);
			case 92:
				SetEntProp(client, Prop_Send, "m_iHealth", iHealth + 8);
			case 93:
				SetEntProp(client, Prop_Send, "m_iHealth", iHealth + 7);
			case 94:
				SetEntProp(client, Prop_Send, "m_iHealth", iHealth + 6);
			case 95:
				SetEntProp(client, Prop_Send, "m_iHealth", iHealth + 5);
			case 96:
				SetEntProp(client, Prop_Send, "m_iHealth", iHealth + 4);
			case 97:
				SetEntProp(client, Prop_Send, "m_iHealth", iHealth + 3);
			case 98:
				SetEntProp(client, Prop_Send, "m_iHealth", iHealth + 2);
			case 99:
