	...
	if (IsValidClient(ent))
	{
		if (StrContains(sound, "player/footsteps/", false) != -1)
		{
			if(b_random == true)
			{
				...
				{
					case 0:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 1.0);
					case 1:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 7777.0);
					case 2:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 933333.0);
					case 3:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 8421376.0);
					case 4:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 4552221.0);
					case 5:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 3100495.0);
					case 6:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 51234123.0);
					case 7:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 5322826.0);
					case 8:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 8355220.0);
					case 9:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 13595446.0);
					case 10:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 8208497.0);
					case 11:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 41234123.0);
					case 12:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 300000.0);
					case 13:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 2.0);
					case 14:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 3.0);
					case 15:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 83552.0);
					case 16:
						TF2Attrib_SetByName(ent, "SPELL: set Halloween footstep type", 9335510.0);
				}
