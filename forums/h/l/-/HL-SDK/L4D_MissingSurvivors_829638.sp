...
new Handle:ZombieLimit   = INVALID_HANDLE;
...
public OnPluginStart()
{
    ...
    // Find survivor and zombie limit cvar
    SurvivorLimit = FindConVar("survivor_limit");
    ZombieLimit   = FindConVar("z_max_player_zombies");
    
    // Change limit vars boundaries
    SetConVarBounds(SurvivorLimit, ConVarBound_Upper, true, 16.0);
    SetConVarBounds(ZombieLimit,   ConVarBound_Upper, true, 16.0);
}
