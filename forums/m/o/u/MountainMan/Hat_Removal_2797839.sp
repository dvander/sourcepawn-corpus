...
public Action:timerHookDelay(Handle:Timer, any:entity)
{
	if(IsValidEdict(entity))
	{
		...
		|| StrContains(sModel, "c_buffpack") != -1
		|| StrContains(sModel, "c_battalion_buffpack") != -1
		|| StrContains(sModel, "c_shogun_warpack") != -1
		|| StrContains(sModel, "mantreads") != -1
		|| StrContains(sModel, "c_paratrooper_pack") != -1
		|| StrContains(sModel, "c_rocketpack") != -1
		|| StrContains(sModel, "demo_booties") != -1
		|| StrContains(sModel, "pegleg") != -1
		|| StrContains(sModel, "c_proto_backpack") != -1
		|| StrContains(sModel, "c_medigun_defensepack") != -1
		|| StrContains(sModel, "xms_sniper_commandobackpack") != -1 ) )
