...
public _PlayerDeath(Handle:event, const String:name[], bool:dontBroadcast)
{
    ...
    if (StrContains(Weapon, "knife_", false) > -1)
    {
        strcopy(Weapon, sizeof(Weapon), "knife");
    }

    if (StrContains(Weapon, "m4a1_", false) > -1)
    {
        strcopy(Weapon, sizeof(Weapon), "m4a1");
    }

    if (StrContains(Weapon, "usp_", false) > -1)
    {
        strcopy(Weapon, sizeof(Weapon), "hkp2000");
    }
