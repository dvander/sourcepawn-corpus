...
public void Event_PlayerSpawn(Handle event, const char[] name, bool dontBroadcast)
{
	...
	if (GetClientTeam(client) == TEAM_INFECTED && AreInfectedAllowed() && MoreSiBotsVersus.BoolValue && IsFakeClient(client)) SetGodMode(client, 0.1);
