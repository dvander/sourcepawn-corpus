...
public Plugin myinfo =
{
	...
	url         = "https://forums.alliedmods.net/showthread.php?p=2396626#post2396626"
}
...
public void OnClientPostAdminCheck(int client)
{
	...
	CreateTimer(10.0, Timer_RecordSteamID, client); // 10 sec, so it takes place after autojoin survivors
}
