...
{
	if (StrEqual(name,"Left 4 Downtown Extension"))	SetConVarInt(KillRes,0);
	else if (StrEqual(name,"left4downtown2")){	SetConVarInt(KillRes,0); SetConVarInt(SiSpMore,0);	dvarMaxSpecials = -1;}
}
