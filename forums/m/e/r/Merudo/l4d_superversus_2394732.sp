...
public Plugin myinfo =
{
	...
	url         = "https://forums.alliedmods.net/showthread.php?p=2394732#post2394732"
}
...
public void DisplayTeamMenu(int client)
{
	...
	for(int i = 1; i <= iMaxClients; i++)
	{
		if(IsClientInGame(i) && GetClientTeam(i) == TEAM_INFECTED)
		{
			...
			if (GetClientTeam(client) == TEAM_INFECTED) // Don't show HP of infected players to survivors
			{
				char m_iHealth[MAX_TARGET_LENGTH];
				if(IsPlayerAlive(i))
				{
