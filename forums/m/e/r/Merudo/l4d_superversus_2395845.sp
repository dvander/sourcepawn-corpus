...
void AutoDifficultyCheck()
{
	...
	PrintToConsoleAll("superversus - Tank HP: %.2fX \tSI HP: %.2fX \t CI spawn rate: %.2fX \tMaxSpecials: %d", TankHp_Multi, sihp_Multi, spawn_multi, MaxSpecials);
}
