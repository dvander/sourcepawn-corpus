...
{
	name = "TF Max Players",
	author = "Nican132,cadavor,JameLess,Thraka,mywarthog",
	description = "Set max players for each class",
	version = PL_VERSION,
...
public OnPluginStart()
{
	...
	CreateConVar("sm_tf_maxclass", PL_VERSION, "TF2 max class", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
