...
public OnPluginStart() {
    RegAdminCmd("sm_build_sentry_here_blue", Command_Sentry, ADMFLAG_GENERIC, "");
	RegAdminCmd("sm_behb", Command_Sentry, ADMFLAG_GENERIC, "");
}
...
public Action:CreateSentry(Handle:timer,any:client) {
    ...
    SetEntData( ent , FindSendPropOffs("CObjectSentrygun","m_nSkin") , team==3?1:0 , 1 , true );
