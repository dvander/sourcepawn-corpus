...
#pragma semicolon 1
#define PLUGIN_VERSION "MasterMe.1.1"
#define DEBUG 0
...
{
	name = "[L4D2] laser sight crosshair removal MasterMe's version",
	author = "Gowness, Edit by MasterMe",
	description = "removes crosshair while holding a laser-equiped weapon, and re-enables with laser remove + fix AWP",
...
{	
	...
	//Laser Sight
	CheatCommandLCR(client, "upgrade_remove", "LASER_SIGHT");
	ClientCommand(client, "crosshair 1");
}
...
CheatCommandLCR(client, const String:command[], const String:arguments[])
{
    if (!client) return;
