...
{
	name        = "Survivor Identity Fix for 5+ Survivors",
	author      = "Merudo",
...
public void OnPluginStart()
{
	...
	HookEvent("player_bot_replace", Event_PlayerToBot, EventHookMode_PostNoCopy);
	HookEvent("bot_player_replace", Event_BotToPlayer, EventHookMode_PostNoCopy);
}
