...
public OnPluginStart()
{
	...
	HookEvent("pumpkin_lord_summoned",	Event_NoticeHooks, EventHookMode_Pre);
	HookEvent("pumpkin_lord_killed",	Event_NoticeHooks, EventHookMode_Pre);
	HookEvent("eyeball_boss_summoned",	Event_NoticeHooks, EventHookMode_Pre);
	HookEvent("eyeball_boss_escaped",	Event_NoticeHooks, EventHookMode_Pre);
	HookEvent("eyeball_boss_killer",	Event_NoticeHooks, EventHookMode_Pre);
	HookEvent("eyeball_boss_killed",	Event_NoticeHooks, EventHookMode_Pre);
	HookEvent("merasmus_summoned",		Event_NoticeHooks, EventHookMode_Pre);
	HookEvent("merasmus_escaped",		Event_NoticeHooks, EventHookMode_Pre);
	HookEvent("merasmus_killed",		Event_NoticeHooks, EventHookMode_Pre);
