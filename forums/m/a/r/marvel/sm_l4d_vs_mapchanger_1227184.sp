...
* Version 1.4.8
*
* -Added Mutation *Versus Survival*
*
* Version 1.4.7
*
...
public OnCVGameModeChange(Handle:convar, const String:oldValue[], const String:newValue[])
{
	...
	if (strcmp(oldValue, newValue) != 0 && (l4d_gamemode() == 1 || l4d_gamemode() == 2 || l4d_gamemode() == 3 || l4d_gamemode() == 4 || l4d_gamemode() == 5 || l4d_gamemode() == 6 || l4d_gamemode() == 7 || l4d_gamemode() == 8 || l4d_gamemode() == 9 || l4d_gamemode() == 10 || l4d_gamemode() == 11))
	{
		HookEvent("round_end", Event_RoundEnd);
		HookEvent("finale_win", Event_FinalWin);
		HookEvent("mission_lost", Event_FinalLost);
