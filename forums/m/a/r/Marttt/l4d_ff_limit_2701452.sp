...
public OnPluginStart()
{
	...
	new String:sDifficulty[20];
	GetConVarString(gamedifficulty, sDifficulty, sizeof(sDifficulty)); 
	if (StrEqual("Easy", sDifficulty, false))
		g_difficulty = 0;
	else if (StrEqual("Normal", sDifficulty, false))
		g_difficulty = 1;
	else if (StrEqual("Hard", sDifficulty, false))
		g_difficulty = 2;
	else if (StrEqual("Impossible", sDifficulty, false))
		g_difficulty = 3;
