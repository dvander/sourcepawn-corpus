...
ConVar g_hCvarAllow, g_hCvarDecayRate, g_hCvarGlow, g_hCvarGlowCol, g_hCvarGnomeRate, g_hCvarHeal, g_hCvarMPGameMode, g_hCvarModes, g_hCvarModesOff, g_hCvarModesTog, g_hCvarRandom, g_hCvarSafe, g_hCvarTemp;
int g_iCvarGlow, g_iCvarGlowCol, g_iCvarHeal, g_iCvarRandom, g_iCvarSafe, g_iCvarTemp, g_iGnomeCount, g_iGnome[MAXPLAYERS+1], g_iGnomes[MAX_GNOMES][2], g_iMap, g_iPlayerSpawn, g_iRoundStart;
