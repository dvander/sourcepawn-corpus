...
{
	LogSpawn("Survival Round Has Started");
	if(g_cvarAutoload.BoolValue && !g_bLoaded && g_bMapStarted)
	{
		g_bLoaded = true;
		SpawnObjects();
	}
...
{
	if(g_cvarAutoload.BoolValue && g_cvarAutoloadType.BoolValue && g_bMapStarted)
	{
