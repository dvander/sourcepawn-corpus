...
void HookEvents()
{
    if (g_bCvar_Enabled && !g_bEventsHooked)
    {
        ...
        AddCommandListener(g_bL4D2 ? Command_ChooseDoorL4D2 : Command_ChooseDoorL4D1, "choose_opendoor");
        AddCommandListener(g_bL4D2 ? Command_ChooseDoorL4D2 : Command_ChooseDoorL4D1, "choose_closedoor");
    ...
    if (!g_bCvar_Enabled && g_bEventsHooked)
    {
        ...
        RemoveCommandListener(g_bL4D2 ? Command_ChooseDoorL4D2 : Command_ChooseDoorL4D1, "choose_opendoor");
        RemoveCommandListener(g_bL4D2 ? Command_ChooseDoorL4D2 : Command_ChooseDoorL4D1, "choose_closedoor");
...
Action Command_ChooseDoorL4D2(int client, const char[] command, int argc)
{
...
Action Command_ChooseDoorL4D1(int client, const char[] command, int argc)
{
    if (IsPlayerIncapacitated(client))
        return Plugin_Handled;
