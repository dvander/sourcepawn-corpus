...
1.8.1 (04-January-2021)
	- Added team Infected support. (Mart)
...
public void OnPluginStart()
{
	...
	g_hCvarAllowInfected =		CreateConVar(	"l4d2_car_alarm_bots_infected",			"3",				"Allow SI to trigger the car alarm. 0=OFF. 1=Enable for SI human players. 2=Enable for SI bots. 3=Both.", CVAR_FLAGS, true, 0.0, true, 3.0 );
	g_hCvarSurvivorDistance =	CreateConVar(	"l4d2_car_alarm_bots_survivor_distance","500",				"Max distance that a survivor can be from the SI to trigger the alarm. 0=No check.", CVAR_FLAGS, true, 0.0 );
