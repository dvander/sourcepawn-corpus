...
stock PrintVector( Float:target[3], String:s[]="")
{
...
//draw line between pos1 and pos2
stock ShowPos(color, Float:pos1[3], Float:pos2[3],Float:life=10.0, Float:length=200.0, Float:width1=1.0, Float:width2=4.0)
{
	decl Float:t[3];
	if(length!=0.0)
	{
...
stock ShowDir(color,Float:pos[3], Float:dir[3],Float:life=10.0, Float:length=200.0, Float:width1=1.0, Float:width2=4.0)
{
	decl Float:pos2[3];
	CopyVector(dir, pos2);
...
stock ShowAngle(color,Float:pos[3], Float:angle[3],Float:life=10.0, Float:length=200.0, Float:width1=1.0, Float:width2=4.0)
{
	decl Float:pos2[3];
...
stock CheckAngle(Float:angle[3])
{
	for(new i=0; i<3; i++)
	{
