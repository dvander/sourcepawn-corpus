...
enum struct PluginCvars
{
    ...
    ConVar l4d_jump_beamring_flags;
    ...
    void Init()
    {
        ...
        this.l4d_jump_beamring_offset       = CreateConVar("l4d_jump_beamring_offset", "24.0", "Beam offset (Z pos) from client's foot.", CVAR_FLAGS, true, 0.0);
        this.l4d_jump_beamring_flags        = CreateConVar("l4d_jump_beamring_flags", "", "Players with these flags can generate the beam.\nEmpty = everyone.\nKnown values at \"\\addons\\sourcemod\\configs\\admin_levels.cfg\".\nExample: \"az\", will enable to players with \"a\" (reservation) or \"z\" (root) flag.", CVAR_FLAGS);
        this.l4d_jump_beamring_team         = CreateConVar("l4d_jump_beamring_team", "1", "Which teams can trigger the beam.\n0 = NONE, 1 = SURVIVOR, 2 = INFECTED, 4 = SPECTATOR, 8 = HOLDOUT.\nAdd numbers greater than 0 for multiple options.\nExample: \"3\", enables for SURVIVOR and INFECTED.", CVAR_FLAGS, true, 0.0, true, 15.0);
        ...
        this.l4d_jump_beamring_flags.AddChangeHook(Event_ConVarChanged);
...
enum struct PluginData
{
    ...
    void GetCvarValues()
    {
        ...
        this.random = StrEqual(this.sColor, "random", false);
        ...
        this.cvars.l4d_jump_beamring_flags.GetString(this.sFlags, sizeof(this.sFlags));
...
public void Event_PlayerJump(Event event, char[] error, bool dontBroadcast)
{
    ...
    if (plugin.flags != 0 && !(GetUserFlagBits(client) & plugin.flags))
        return;
...
Action Cmd_PrintCvars(int client, int args)
{
    ...
    PrintToConsole(client, "l4d_jump_beamring_flags : %i (\"%s\")", plugin.flags, plugin.sFlags);
