...
public OnPluginStart()
{
	...
	GhostFly = CreateConVar("l4d_ghost_fly", "1", "Turn on/off the ability for ghosts to fly.",FCVAR_NONE,true,0.0,true,1.0);
	FlySpeed = CreateConVar("l4d_ghost_fly_speed", "50", "Ghost flying speed.",FCVAR_NONE,true,0.0);
	MaxSpeed = CreateConVar("l4d_ghost_max_speed", "500", "Ghost flying max speed.", FCVAR_NONE, true, 300.0);
	...
	PropMoveCollide = FindSendPropInfo("CBaseEntity",   "movecollide");
	PropMoveType    = FindSendPropInfo("CBaseEntity",   "movetype");
