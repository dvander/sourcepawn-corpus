...
public OnPluginStart()
{
	...
	g_hVotesInterval = CreateConVar("sm_playersvotes_interval", "15.0", "interval between another vote cast", 0, true, 0.0, true, 10000.0);
...
bool:IsImmune (target)
{
	...
	return (immunity != 0 && GetAdminImmunityLevel(GetUserAdmin(target)) >= immunity);
}
