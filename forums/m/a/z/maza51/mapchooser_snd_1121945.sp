/**
 * The altered version from InCognIto
 */
#pragma semicolon 1
...
new Handle:g_CvarSoundName2 = INVALID_HANDLE;
new String:g_soundName2[MAX_FILE_LEN];
...
public OnConfigsExecuted()
{
	...
	GetConVarString(g_CvarSoundName2, g_soundName2, MAX_FILE_LEN);
