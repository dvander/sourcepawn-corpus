...
new TopMenuObject:obj_playerswapcmds = INVALID_TOPMENUOBJECT;
...
public OnAllPluginsLoaded()
{
	...
	obj_playerswapcmds = AddToTopMenu(hAdminMenu, 
		"PlayerSwapCommands",
		TopMenuObject_Category,
		DefaultCategoryHandler,
		INVALID_TOPMENUOBJECT);
						...
						maxlength)
{
	if (action == TopMenuAction_DisplayTitle)
	{
		...
		else if (object_id == obj_playerswapcmds)
		{
			Format(buffer, maxlength, "%T:", "Player Switch Commands", param);
		}
