...
MainMenu(client)
{
	...
	AddMenuItem(menu, "lights", "Добавить Огни");
	AddMenuItem(menu, "lights", "Удалить Все Огни");
...
ClearAll(client)
{
	...
	SetMenuTitle(menu, "Вы уверены, что хотите удалить все огни ?");
...
ChooseLightTypeMenu(client)
{
	...
	SetMenuTitle(menu, "Выберите Тип Огней");
	AddMenuItem(menu, "look", "Ряд Огней");
	AddMenuItem(menu, "lights", "Индивидуальный Огонь");
	SetMenuExitButton(menu, true);
	SetMenuExitBackButton(menu, true);
	DisplayMenu(menu, client, 60);
}
...
AddIndividualLightMenu(client)
{
	...
	SetMenuTitle(menu, "Меню Добавления Огней");
	AddMenuItem(menu, "look", "Посмотрите где прицел чтобы создать огонь", ITEMDRAW_DISABLED);
	AddMenuItem(menu, "lights", "Красный");
	AddMenuItem(menu, "lights", "Зелёный");
	SetMenuExitButton(menu, true);
	SetMenuExitBackButton(menu, true);
	DisplayMenu(menu, client, 60);
}
...
AddLightsMenu(client)
{
	...
	SetMenuTitle(menu, "Меню Добавления Огней");
	AddMenuItem(menu, "look", "Посмотрите где прицел чтобы создать огонь, затем нажмите 2", ITEMDRAW_DISABLED);
	AddMenuItem(menu, "lights", "Начало");
	SetMenuExitButton(menu, true);
	SetMenuExitBackButton(menu, true);
	DisplayMenu(menu, client, 60);
}
...
DecideLightsMenuEnd(client)
{
	...
	SetMenuTitle(menu, "Меню Решения по Огню");
	AddMenuItem(menu, "look", "Сохранить");
	AddMenuItem(menu, "lights", "Отменить");
	SetMenuExitButton(menu, true);
	SetMenuExitBackButton(menu, true);
	DisplayMenu(menu, client, 60);
}
