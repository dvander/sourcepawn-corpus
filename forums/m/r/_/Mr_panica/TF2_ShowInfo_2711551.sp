...
public void OnPluginStart(){
	ConVar CVAR;
	(CVAR = CreateConVar("sm_tf2_showinfo_distance",	"9999.0",	"Maximum info distance", _, true, 0.0)).AddChangeHook(OnDistanceChange);
	g_fDistance = CVAR.FloatValue;

	RegAdminCmd("sm_showuid", CMD_SHOW, ADMFLAG_GENERIC);
	RegAdminCmd("sm_showuidchat", CMD_SHOWINFO, ADMFLAG_GENERIC);
