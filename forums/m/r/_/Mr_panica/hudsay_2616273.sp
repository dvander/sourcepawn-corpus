...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_rhud", RHUDSay, ADMFLAG_GENERIC, "sm_outline <x> <y> <time> <red> <green> <blue> <alpha> <message> - Send user message to all players through hud text");
...
public Action:RHUDSay(client, args)
{
ClearSyncHud(client, gHud);
PrintToConsole(client, "[Hud Say] Худ убран");
return Plugin_Handled;
}
