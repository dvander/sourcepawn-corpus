...
public OnPluginStart()
{
	...
	SetTrieValue(g_hTypes, "gamemode", GAMEMODE);
	...
	if(StrEqual(sGameDir, "left4dead"))
	{
 ...
 * Events
 */
public Event_GameModeChanged(Handle:convar, const String:oldValue[], const String:newValue[])
{
	ExecConfig(GAMEMODE, newValue);
}
