...
SetCvars()
{
	if (Enabled)
	{
		...
		SetConVarInt(FindConVar("z_boomer_limit"), 14);
		SetConVarInt(FindConVar("z_hunter_limit"), 14);
		SetConVarInt(FindConVar("z_smoker_limit"), 14);
		SetConVarInt(FindConVar("z_charger_limit"), 14);
		SetConVarInt(FindConVar("z_spitter_limit"), 14);
		SetConVarInt(FindConVar("z_jockey_limit"), 14);
		SetConVarInt(FindConVar("survival_max_boomers"), 14);
		SetConVarInt(FindConVar("survival_max_hunters"), 14);
		SetConVarInt(FindConVar("survival_max_smokers"), 14);
		SetConVarInt(FindConVar("survival_max_chargers"), 14);
		SetConVarInt(FindConVar("survival_max_spitters"), 14);
		SetConVarInt(FindConVar("survival_max_jockeys"), 14);	
