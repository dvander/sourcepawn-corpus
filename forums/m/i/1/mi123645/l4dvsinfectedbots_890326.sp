...
public OnPluginStart()
{
	...
	h_AllowBoomerBots = CreateConVar("l4d_infectedbots_allow_boomer", "1", "If 1, it will allow boomer bots", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	h_AllowSmokerBots = CreateConVar("l4d_infectedbots_allow_smoker", "1", "If 1, it will allow smoker bots", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	h_AllowHunterBots = CreateConVar("l4d_infectedbots_allow_hunter", "1", "If 1, it will allow hunter bots", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	...
	h_BotHudEnabled = CreateConVar("l4d_infectedbots_showhud", "1", "If infected bots hud will show", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	...
	h_DirectorSpawn = CreateConVar("l4d_infectedbots_director_spawn", "0", "If 1, the director will spawn the special infected instead of the plugin", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	h_TankPlayer = CreateConVar("l4d_infectedbots_tank_playable", "0", "If 1, tanks will be playable in coop/survival", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 1.0);
...
public Action:RoundStart (Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if (IsMapVS)
	{
		...
		if (!RoundStarted)
		{
			...
			//Three timers for coop/versus/survival that allows the survivor bots to bypass areas where they get stuck at, MI 5
...
{
	//Allows tanks to be playable on coop/survival
	if ((GameMode != 2) && (TankPlayer) && (!temptank))
	{
