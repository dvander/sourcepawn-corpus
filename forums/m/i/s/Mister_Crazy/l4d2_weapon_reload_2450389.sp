...
public OnPluginStart()
{
	...
	g_h_reload_rate = CreateConVar("l4d_powerups_weaponreload_rate", "0.5", "The interval incurred by reloading is multiplied by this value (clamped between 0.2 < 0.9)", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.2, true, 0.9);
	HookConVarChange(g_h_reload_rate, Convar_Reload);
	g_fl_reload_rate = 0.5;
