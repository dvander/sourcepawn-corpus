...
new Handle:g_hAllowBotsInCount = INVALID_HANDLE;
...
public OnPluginStart()
{
	...
	g_hAllowBotsInCount = CreateConVar("sm_autorecord_bots", "0", "Do bots count as players?", _, true, 0.0, true, 1.0);
...
public CheckStatus()
{
	...
	{
		new bool:allowbots = GetConVarBool(g_hAllowBotsInCount);
		new iMinClients = GetConVarInt(g_hMinPlayersStart);
		new iNumClients = Client_GetCount(true, allowbots);
