...
public Plugin:myinfo = 
{
	...
	author = "Autor BackAgain, update playboycyberclub, change Micmacx",
...
public Init() {
	...
	CreateConVar("sm_capbon_version", PLUGIN_VERSION,"DoD:S Capture Bonus version", FCVAR_NOTIFY|FCVAR_REPLICATED)
	CvarEnabled = CreateConVar("sm_capbon_enabled", "1", "Enables or disables DoD:S Capture Bonus.",FCVAR_REPLICATED)
...
public DodGetAmmo(client,weapon) {
	new offset = FindSendPropInfo("CDODPlayer", "m_iAmmo")
