...
#define SENTRYBUSTER_CLASSVARIANT	11
...
public OnPostInventoryApplication( Handle:hEvent, const String:strEventName[], bool:bDontBroadcast )
{
	...
	new Handle:iAttributes = INVALID_HANDLE;
	switch( iClass )
	{
		case TFClass_Scout:
		{
			...
			if( iRobotVariant[iClient] == 2 )
			{
				...
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:1.15 );
				SpawnItem( iClient, 13, hAttributes );
			}
			if( iRobotVariant[iClient] == 3 )
				SpawnItem( iClient, 44 );

			if( iRobotVariant[iClient] == 4 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 278 ); PushArrayCell( hAttributes, _:0.25 );
				SpawnItem( iClient, 44, hAttributes );
			}
			if( iRobotVariant[iClient] == 5 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 278 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 326 ); PushArrayCell( hAttributes, _:2 );
				SpawnItem( iClient, 44, hAttributes );
			}
			...
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:1.6 );
				PushArrayCell( hAttributes, 518 ); PushArrayCell( hAttributes, _:1.5 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:0.65 );
				SpawnItem( iClient, 45, hAttributes );
			}
			if( iRobotVariant[iClient] == 8 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 444 ); PushArrayCell( hAttributes, _:0.7 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:1.25 );
				SpawnItem( iClient, 220, hAttributes );
			}
			if( iRobotVariant[iClient] == 9 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:1075 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:2 );
				...
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:5 );
				SpawnItem( iClient, 221, hAttributes );
			}
			if( iRobotVariant[iClient] == 10 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:1490 );
			...
			if( iRobotVariant[iClient] == 11 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:2875 );
				PushArrayCell( hAttributes, 278 ); PushArrayCell( hAttributes, _:0.05 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.7 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.7 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 54 ); PushArrayCell( hAttributes, _:0.75 );
				SpawnItem( iClient, 221, hAttributes );
			}
			if( iRobotVariant[iClient] == 12 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:1475 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.7 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.7 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 278 ); PushArrayCell( hAttributes, _:0.35 );
				SpawnItem( iClient, 0 );
				SpawnItem( iClient, 46, hAttributes );
			}
			if( iRobotVariant[iClient] == 13 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:1075 );
				PushArrayCell( hAttributes, 45 ); PushArrayCell( hAttributes, _:2 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:1.7 );
				PushArrayCell( hAttributes, 518 ); PushArrayCell( hAttributes, _:6 );
				PushArrayCell( hAttributes, 1 ); PushArrayCell( hAttributes, _:0.35 );
				PushArrayCell( hAttributes, 106 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:1.1 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.7 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.7 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:5 );
				SpawnItem( iClient, 45, hAttributes );
			}
			if( iRobotVariant[iClient] == 14 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:1090 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:2 );
				PushArrayCell( hAttributes, 278 ); PushArrayCell( hAttributes, _:0.1 );
				PushArrayCell( hAttributes, 326 ); PushArrayCell( hAttributes, _:2 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.7 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.7 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 444 ); PushArrayCell( hAttributes, _:1.5 );
				SpawnItem( iClient, 44, hAttributes );
			}
			if( iRobotVariant[iClient] == 15 )
				SpawnItem( iClient, 221 );

			if( iRobotVariant[iClient] == 16 )
				SpawnItem( iClient, 648 );

			if( iRobotVariant[iClient] == 17 )
				SpawnItem( iClient, 349 );

			if( iRobotVariant[iClient] == 18 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:1475 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.7 );
			...
			if( iRobotVariant[iClient] == 19 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:9890 );
				PushArrayCell( hAttributes, 278 ); PushArrayCell( hAttributes, _:0.001 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:8 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.7 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:3.0 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:5 );
		...
		{
			if( iRobotVariant[iClient] == 0 )
				SpawnItem( iClient, 18 );

			if( iRobotVariant[iClient] == 1 )
				SpawnItem( iClient, 441 );

			if( iRobotVariant[iClient] == 2 )
				SpawnItem( iClient, 127 );

			if( iRobotVariant[iClient] == 3 )
			{
				SpawnItem( iClient, 18 );
				SpawnItem( iClient, 129 );
				SpawnItem( iClient, 6 );
			}
			if( iRobotVariant[iClient] == 4 )
			{
				...
				SpawnItem( iClient, 18 );
				SpawnItem( iClient, 129, hAttributes );
				SpawnItem( iClient, 6 );
			}
			if( iRobotVariant[iClient] == 5 )
			{
				...
				PushArrayCell( hAttributes, 319 ); PushArrayCell( hAttributes, _:9.0 );
				SpawnItem( iClient, 18 );
				SpawnItem( iClient, 226, hAttributes );
				SpawnItem( iClient, 6 );
			}
			if( iRobotVariant[iClient] == 6 )
			{
				...
				PushArrayCell( hAttributes, 319 ); PushArrayCell( hAttributes, _:9.0 );
				SpawnItem( iClient, 18 );
				SpawnItem( iClient, 354, hAttributes );
				SpawnItem( iClient, 6 );
			}
			if( iRobotVariant[iClient] == 7 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:0.33 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.001 );
				PushArrayCell( hAttributes, 440 ); PushArrayCell( hAttributes, _:0 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:0.9 );
				PushArrayCell( hAttributes, 99 ); PushArrayCell( hAttributes, _:1.25 );
				PushArrayCell( hAttributes, 411 ); PushArrayCell( hAttributes, _:2 );
				PushArrayCell( hAttributes, 16 ); PushArrayCell( hAttributes, _:60 );
				SpawnItem( iClient, 228, hAttributes );
			}
			if( iRobotVariant[iClient] == 8 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 522 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:0.45 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.001 );
				PushArrayCell( hAttributes, 440 ); PushArrayCell( hAttributes, _:-2 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:1.5 );
				PushArrayCell( hAttributes, 100 ); PushArrayCell( hAttributes, _:1.2 );
				PushArrayCell( hAttributes, 411 ); PushArrayCell( hAttributes, _:2 );
				SpawnItem( iClient, 414, hAttributes );
			}
			if( iRobotVariant[iClient] == 9 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:3600 );
				...
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:3 );
			...
			if( iRobotVariant[iClient] == 11 )
			{
				...
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:3600 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:0.6 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.1 );
				PushArrayCell( hAttributes, 440 ); PushArrayCell( hAttributes, _:5.0 );
				PushArrayCell( hAttributes, 103 ); PushArrayCell( hAttributes, _:0.65 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:3 );
			...
			if( iRobotVariant[iClient] == 12 )
			{
				...
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:2 );
			...
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:4000 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:2.0 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.2 );
				PushArrayCell( hAttributes, 440 ); PushArrayCell( hAttributes, _:5.0 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:3 );
				PushArrayCell( hAttributes, 103 ); PushArrayCell( hAttributes, _:0.9 );
				SpawnItem( iClient, 18, hAttributes );
			}
			if( iRobotVariant[iClient] == 14 )
			{
			...
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:59800 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:1.5 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:0.6 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.2 );
				PushArrayCell( hAttributes, 440 ); PushArrayCell( hAttributes, _:7.0 );
				PushArrayCell( hAttributes, 103 ); PushArrayCell( hAttributes, _:1.3 );
				PushArrayCell( hAttributes, 57 ); PushArrayCell( hAttributes, _:250 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:3 );
			...
			if( iRobotVariant[iClient] == 18 )
			{
				...
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:1.6 );
				PushArrayCell( hAttributes, 99 ); PushArrayCell( hAttributes, _:1.25 );
				PushArrayCell( hAttributes, 411 ); PushArrayCell( hAttributes, _:4 );
				PushArrayCell( hAttributes, 16 ); PushArrayCell( hAttributes, _:1000 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:3 );
			...
			if( iRobotVariant[iClient] == 19 )
			{
				...
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:3600 );
				PushArrayCell( hAttributes, 522 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:0.75 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.25 );
				PushArrayCell( hAttributes, 440 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:0.2 );
				PushArrayCell( hAttributes, 100 ); PushArrayCell( hAttributes, _:1.2 );
				PushArrayCell( hAttributes, 411 ); PushArrayCell( hAttributes, _:4 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.5 );
			...
			if( iRobotVariant[iClient] == 20 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:59800 );
				PushArrayCell( hAttributes, 522 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.25 );
				PushArrayCell( hAttributes, 440 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 100 ); PushArrayCell( hAttributes, _:1.2 );
				...
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 405 ); PushArrayCell( hAttributes, _:0.1 );
				PushArrayCell( hAttributes, 478 ); PushArrayCell( hAttributes, _:0.15 );
				SpawnItem( iClient, 414, hAttributes );
			}
			if( iRobotVariant[iClient] == 21 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:3800 );
				PushArrayCell( hAttributes, 440 ); PushArrayCell( hAttributes, _:26.0 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:0.22 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.2 );
				PushArrayCell( hAttributes, 411 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 57 ); PushArrayCell( hAttributes, _:40 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:1.5 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.4 );
				...
				PushArrayCell( hAttributes, 405 ); PushArrayCell( hAttributes, _:0.1 );
				PushArrayCell( hAttributes, 478 ); PushArrayCell( hAttributes, _:0.1 );
				PushArrayCell( hAttributes, 103 ); PushArrayCell( hAttributes, _:0.4 );
				SpawnItem( iClient, 18, hAttributes );
			}
			if( iRobotVariant[iClient] == 22 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:59800 );
				PushArrayCell( hAttributes, 440 ); PushArrayCell( hAttributes, _:26.0 );
				...
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:3 );
				PushArrayCell( hAttributes, 405 ); PushArrayCell( hAttributes, _:0.1 );
				PushArrayCell( hAttributes, 478 ); PushArrayCell( hAttributes, _:0.4 );
				SpawnItem( iClient, 18, hAttributes );
			}
			if( iRobotVariant[iClient] == 23 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:39800 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 522 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:3 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:2 );
				PushArrayCell( hAttributes, 411 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 521 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 99 ); PushArrayCell( hAttributes, _:2 );
				PushArrayCell( hAttributes, 103 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 57 ); PushArrayCell( hAttributes, _:1 );
		...
		{
			if( iRobotVariant[iClient] == 0 )
				SpawnItem( iClient, 21 );

			if( iRobotVariant[iClient] == 1 )
				SpawnItem( iClient, 39 );
			...
			if( iRobotVariant[iClient] == 3 )
			{
				...
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.75 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 103 ); PushArrayCell( hAttributes, _:1.3 );
				SpawnItem( iClient, 740, hAttributes );
			}
			if( iRobotVariant[iClient] == 4 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:2825 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.5 );
				...
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:6 );
			...
			if( iRobotVariant[iClient] == 5 )
			{
				...
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.6 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:6 );
				SpawnItem( iClient, 351, hAttributes );
			}
			if( iRobotVariant[iClient] == 6 )
			{
				hAttributes = CreateArray();
				...
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 255 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.6 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.6 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:6 );
			...
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:54825 );
				PushArrayCell( hAttributes, 255 ); PushArrayCell( hAttributes, _:2.0 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 57 ); PushArrayCell( hAttributes, _:500 );
				...
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:2 );
				PushArrayCell( hAttributes, 405 ); PushArrayCell( hAttributes, _:0.1 );
				PushArrayCell( hAttributes, 478 ); PushArrayCell( hAttributes, _:0.1 );
				SpawnItem( iClient, 21, hAttributes );
			}
		...
		case TFClass_DemoMan:
		{
			if( iRobotVariant[iClient] == SENTRYBUSTER_CLASSVARIANT )
			{
				...
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:7 );
				PushArrayCell( hAttributes, 402 ); PushArrayCell( hAttributes, _:1 );
				SpawnItem( iClient, 307, hAttributes );
			}
			if( iRobotVariant[iClient] == 0 )
				SpawnItem( iClient, 19 );

			if( iRobotVariant[iClient] == 1 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:1.75 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.05 );
				PushArrayCell( hAttributes, 3 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 411 ); PushArrayCell( hAttributes, _:3 );
				SpawnItem( iClient, 19, hAttributes );
			}
			if( iRobotVariant[iClient] == 2 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 31 ); PushArrayCell( hAttributes, _:3 );
			...
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:475 );
				PushArrayCell( hAttributes, 202 ); PushArrayCell( hAttributes, _:2 );
				PushArrayCell( hAttributes, 249 ); PushArrayCell( hAttributes, _:7 );
				PushArrayCell( hAttributes, 326 ); PushArrayCell( hAttributes, _:2.3 );
				PushArrayCell( hAttributes, 498 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:1.5 );
				SpawnItem( iClient, 406 );
				SpawnItem( iClient, 357, hAttributes );
			}
			if( iRobotVariant[iClient] == 4 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:3125 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:-0.4 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.75 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:4 );
				SpawnItem( iClient, 19, hAttributes );
			}
			if( iRobotVariant[iClient] == 5 )
			{
			...
			if( iRobotVariant[iClient] == 6 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:3125 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:0.65 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.1 );
				PushArrayCell( hAttributes, 440 ); PushArrayCell( hAttributes, _:7.0 );
				PushArrayCell( hAttributes, 411 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 103 ); PushArrayCell( hAttributes, _:1.1 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:4 );
			...
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:39825 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.2 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:0.3 );
				PushArrayCell( hAttributes, 3 ); PushArrayCell( hAttributes, _:3.0 );
				PushArrayCell( hAttributes, 103 ); PushArrayCell( hAttributes, _:1.5 );
				PushArrayCell( hAttributes, 57 ); PushArrayCell( hAttributes, _:200 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.32 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.7 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.3 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:4 );
				PushArrayCell( hAttributes, 405 ); PushArrayCell( hAttributes, _:0.1 );
			...
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:49825 );
				PushArrayCell( hAttributes, 466 ); PushArrayCell( hAttributes, _:0 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:1.8 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:2 );
				PushArrayCell( hAttributes, 3 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 103 ); PushArrayCell( hAttributes, _:0.8 );
				PushArrayCell( hAttributes, 411 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:7 );
				PushArrayCell( hAttributes, 522 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 99 ); PushArrayCell( hAttributes, _:1.2 );
				PushArrayCell( hAttributes, 521 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.35 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:4 );
				SpawnItem( iClient, 996, hAttributes );
			}
			if( iRobotVariant[iClient] == 10 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:54850 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 57 ); PushArrayCell( hAttributes, _:500 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.3 );
		...
		{
			if( iRobotVariant[iClient] == 0 )
				SpawnItem( iClient, 15 );

			if( iRobotVariant[iClient] == 1 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:0.1 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:2.5 );
				PushArrayCell( hAttributes, 45 ); PushArrayCell( hAttributes, _:3 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:0.33 );
				SpawnItem( iClient, 11, hAttributes );
			}
			if( iRobotVariant[iClient] == 2 )
				SpawnItem( iClient, 43 );
			...
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:600 );
			...
			if( iRobotVariant[iClient] == 5 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:600 );
				PushArrayCell( hAttributes, 522 ); PushArrayCell( hAttributes, _:0 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:1.5 );
				SpawnItem( iClient, 331, hAttributes );
			}
			if( iRobotVariant[iClient] == 6 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 125 ); PushArrayCell( hAttributes, _:-240 );
			...
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:4700 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:1.5 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.3 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.3 );
			...
			if( iRobotVariant[iClient] == 8 )
			{
				...
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:4700 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:2.5 );
				PushArrayCell( hAttributes, 45 ); PushArrayCell( hAttributes, _:10 );
				PushArrayCell( hAttributes, 1 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 318 ); PushArrayCell( hAttributes, _:0.1 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.7 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.3 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.3 );
				PushArrayCell( hAttributes, 323 ); PushArrayCell( hAttributes, _:1 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:2 );
				SpawnItem( iClient, 11, hAttributes );
			}
			if( iRobotVariant[iClient] == 9 )
			...
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:59700 );
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.6 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.6 );
				PushArrayCell( hAttributes, 57 ); PushArrayCell( hAttributes, _:250 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.3 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.3 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:2 );
			...
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:69700 );
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:1.2 );
				PushArrayCell( hAttributes, 323 ); PushArrayCell( hAttributes, _:2 );
				PushArrayCell( hAttributes, 180 ); PushArrayCell( hAttributes, _:8000 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.3 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.4 );
				PushArrayCell( hAttributes, 405 ); PushArrayCell( hAttributes, _:0.1 );
				PushArrayCell( hAttributes, 478 ); PushArrayCell( hAttributes, _:0.9 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:2 );
				SpawnItem( iClient, 850, hAttributes );
			}
			if( iRobotVariant[iClient] == 13 )
			{
				...
				PushArrayCell( hAttributes, 2 ); PushArrayCell( hAttributes, _:1.2 );
				PushArrayCell( hAttributes, 323 ); PushArrayCell( hAttributes, _:2 );
				PushArrayCell( hAttributes, 180 ); PushArrayCell( hAttributes, _:5000 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.35 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.3 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.3 );
				PushArrayCell( hAttributes, 330 ); PushArrayCell( hAttributes, _:2 );
		...
		case TFClass_Medic:
		{
			...
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 10 ); PushArrayCell( hAttributes, _:2 );
				PushArrayCell( hAttributes, 8 ); PushArrayCell( hAttributes, _:5 );
				iAttributes = CreateArray();
				PushArrayCell( hAttributes, 1 ); PushArrayCell( hAttributes, _:0.1 );
				SpawnItem( iClient, 17, iAttributes );
				SpawnItem( iClient, 29, hAttributes );
			}
			if( iRobotVariant[iClient] == 1 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 10 ); PushArrayCell( hAttributes, _:5 );
				PushArrayCell( hAttributes, 314 ); PushArrayCell( hAttributes, _:-3 );
			...
			if( iRobotVariant[iClient] == 2 )
			{
				...
				PushArrayCell( hAttributes, 8 ); PushArrayCell( hAttributes, _:10 );
				iAttributes = CreateArray();
				PushArrayCell( hAttributes, 1 ); PushArrayCell( hAttributes, _:0.1 );
				SpawnItem( iClient, 17, iAttributes );
			...
			if( iRobotVariant[iClient] == 3 )
				SpawnItem( iClient, 411 );

			if( iRobotVariant[iClient] == 4 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:4350 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.6 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.6 );
				PushArrayCell( hAttributes, 8 ); PushArrayCell( hAttributes, _:200 );
				SpawnItem( iClient, 411, hAttributes );
			}
			if( iRobotVariant[iClient] == 5 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 26 ); PushArrayCell( hAttributes, _:4350 );
				PushArrayCell( hAttributes, 10 ); PushArrayCell( hAttributes, _:0.01 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.5 );
				PushArrayCell( hAttributes, 252 ); PushArrayCell( hAttributes, _:0.6 );
				PushArrayCell( hAttributes, 329 ); PushArrayCell( hAttributes, _:0.6 );
				PushArrayCell( hAttributes, 8 ); PushArrayCell( hAttributes, _:200 );
		...
		case TFClass_Sniper:
		{
			...
			if( iRobotVariant[iClient] == 1 )
			{
				hAttributes = CreateArray();
				PushArrayCell( hAttributes, 1 ); PushArrayCell( hAttributes, _:0.5 );
				SpawnItem( iClient, 56, hAttributes );
			}
			if( iRobotVariant[iClient] == 2 )
			{
			...
			if( iRobotVariant[iClient] == 4 )
			{
				...
				PushArrayCell( hAttributes, 6 ); PushArrayCell( hAttributes, _:0.6 );
				PushArrayCell( hAttributes, 444 ); PushArrayCell( hAttributes, _:0.7 );
				PushArrayCell( hAttributes, 107 ); PushArrayCell( hAttributes, _:0.85 );
				SpawnItem( iClient, 56, hAttributes );
			}
		}
		case TFClass_Spy:
...
stock PickRandomClassVariant( TFClassType:iClass = TFClass_Unknown )
{
	...
	switch( iClass )
	{
		case TFClass_Scout:		return !bGiants ? GetRandomInt(0,9) : GetRandomInt(0,18);
		case TFClass_Soldier:	return !bGiants ? GetRandomInt(0,10) : GetRandomInt(0,25);
		case TFClass_DemoMan:	return !bGiants ? GetRandomInt(0,4) : GetRandomInt(0,11);
		case TFClass_Pyro:		return !bGiants ? GetRandomInt(0,4) : GetRandomInt(0,7);
		case TFClass_Heavy:		return !bGiants ? GetRandomInt(0,7) : GetRandomInt(0,17);
		case TFClass_Medic:		return !bGiants ? GetRandomInt(0,4) : GetRandomInt(0,5);
		case TFClass_Sniper:	return !bGiants ? GetRandomInt(0,6) : GetRandomInt(0,6);
...
stock bool:SetClassVariant( iClient, TFClassType:iClass = TFClass_Unknown, iSVariant = -1 )
{
	...
	if( !bValidVariant )
	{
		...
		switch( iClass )
		{
			case TFClass_Scout:
			{
				if( iVariant >= 0 && iVariant <= 19 )
				{
					bValidVariant = true;
					
					if( iVariant >= 0 && iVariant <= 8 || iVariant >= 15 && iVariant <= 17 )
						iMode = Robot_Stock;
					else if( iVariant >= 9 && iVariant <= 14 || iVariant >= 18 && iVariant <= 19 )
						iMode = Robot_Giant;
				}
			}
			case TFClass_Soldier:
			{
				if( iVariant >= 0 && iVariant <= 23 )
				{
					bValidVariant = true;
					
					if( iVariant >= 3 && iVariant <= 6 || iVariant >= 14 && iVariant <= 16 )
						iNewEffect = Effect_FullCharge;
					else if( iVariant == 12 || iVariant == 13 || iVariant == 17 || iVariant >= 22 && iVariant <= 23 )
			...
			case TFClass_Heavy:
			{
				if( iVariant >= 0 && iVariant <= 16 )
				{
					...
					if( iVariant >= 0 && iVariant <= 3 || iVariant == 6 )
						iMode = Robot_Stock;
					else if( iVariant >= 7 )
						iMode = Robot_Giant;
				}
			...
			case TFClass_Medic:
			{
				if( iVariant >= 0 && iVariant <= 5 )
				{
					...
					if( iVariant >= 0 && iVariant <= 1 || iVariant == 4 )
						iNewEffect = Effect_FullCharge;
	...
	switch( iClass )
	{
		case TFClass_Scout:
		{
			switch( iVariant )
			{
				...
				case 0: strcopy( strBuffer, iBufferSize, "Scout (Type 1)" );
				case 1: strcopy( strBuffer, iBufferSize, "Scout (Type 2)" );
				case 2: strcopy( strBuffer, iBufferSize, "Scout (Type 3)" );
				case 3: strcopy( strBuffer, iBufferSize, "Minor League Scout" );
				case 4: strcopy( strBuffer, iBufferSize, "Hyper League Scout" );
				case 5: strcopy( strBuffer, iBufferSize, "Jumping Sandman Scout" );
				case 6: strcopy( strBuffer, iBufferSize, "Bonk Scout" );
				case 7: strcopy( strBuffer, iBufferSize, "Force-A-Nature Scout" );
				case 8: strcopy( strBuffer, iBufferSize, "Shortstop Scout" );
				case 9: strcopy( strBuffer, iBufferSize, "Super Scout" );
				case 10: strcopy( strBuffer, iBufferSize, "Major League Scout" );
				case 11: strcopy( strBuffer, iBufferSize, "Armored Sandman Scout" );
				case 12: strcopy( strBuffer, iBufferSize, "Giant Bonk Scout" );
				case 13: strcopy( strBuffer, iBufferSize, "Force-A-Nature Super Scout" );
				case 14: strcopy( strBuffer, iBufferSize, "Giant Jumping Sandman Scout" );
				case 15: strcopy( strBuffer, iBufferSize, "Scout (Holy Makeral)" );
				case 16: strcopy( strBuffer, iBufferSize, "Wrap Assassin" );
				case 17: strcopy( strBuffer, iBufferSize, "Scout (Sun-on-a-Stick)" );
				case 18: strcopy( strBuffer, iBufferSize, "Giant Scout" );
				case 19: strcopy( strBuffer, iBufferSize, "Major League" );
			}
		}
		case TFClass_Sniper:
		{
			switch( iVariant )
			{
				...
				case 0: strcopy( strBuffer, iBufferSize, "Sniper" );
				case 1: strcopy( strBuffer, iBufferSize, "Bowman (Type 1)" );
				case 2: strcopy( strBuffer, iBufferSize, "Bowman (Type 2)" );
				case 3: strcopy( strBuffer, iBufferSize, "Sydney Sniper" );
				case 4: strcopy( strBuffer, iBufferSize, "Razorback Sniper (Type 1)" );
				case 5: strcopy( strBuffer, iBufferSize, "Razorback Sniper (Type 2)" );
				case 6: strcopy( strBuffer, iBufferSize, "Bowman Rapid Fire" );
				case 7: strcopy( strBuffer, iBufferSize, "Jarate Master" );
			}
		}
		case TFClass_Soldier:
		{
			switch( iVariant )
			{
				...
				case 0: strcopy( strBuffer, iBufferSize, "Soldier (Type 1)" );
				case 1: strcopy( strBuffer, iBufferSize, "Soldier (Type 2)" );
				case 2: strcopy( strBuffer, iBufferSize, "Soldier (Type 3)" );
				case 3: strcopy( strBuffer, iBufferSize, "Buff Soldier" );
				case 4: strcopy( strBuffer, iBufferSize, "Extended Buff Soldier" );
				case 5: strcopy( strBuffer, iBufferSize, "Extended Backup Soldier" );
				case 6: strcopy( strBuffer, iBufferSize, "Extended Conch Soldier" );
				case 7: strcopy( strBuffer, iBufferSize, "Soldier (Direct Hit + Buff Banner)" );
				case 8: strcopy( strBuffer, iBufferSize, "Black Box Soldier" );
				case 9: strcopy( strBuffer, iBufferSize, "Blast Soldier" );
				case 10: strcopy( strBuffer, iBufferSize, "Giant Soldier" );
				case 11: strcopy( strBuffer, iBufferSize, "Giant Rapid Fire Soldier (Type 1)" );
				case 12: strcopy( strBuffer, iBufferSize, "Giant Rapid Fire Soldier (Type 2)" );
				case 13: strcopy( strBuffer, iBufferSize, "Giant Charged Soldier" );
				case 14: strcopy( strBuffer, iBufferSize, "Giant Burst Fire Soldier" );
				case 15: strcopy( strBuffer, iBufferSize, "Giant Buff Banner Soldier" );
				case 16: strcopy( strBuffer, iBufferSize, "Giant Battalion Soldier" );
				case 17: strcopy( strBuffer, iBufferSize, "Giant Concheror Soldier" );
				case 18: strcopy( strBuffer, iBufferSize, "Sergeant Crits" );
				case 19: strcopy( strBuffer, iBufferSize, "Giant Black Box Soldier" );
				case 20: strcopy( strBuffer, iBufferSize, "Giant Blast Soldier" );
				case 21: strcopy( strBuffer, iBufferSize, "Chief Blast Soldier" );
				case 22: strcopy( strBuffer, iBufferSize, "Colonel Barrage" );
				case 23: strcopy( strBuffer, iBufferSize, "Major Crits (Type 1)" );
				case 24: strcopy( strBuffer, iBufferSize, "Major Crits (Type 2)" );
				case 25: strcopy( strBuffer, iBufferSize, "Major Crits (Atomic)" );
			}
		}
		case TFClass_DemoMan:
		{
			switch( iVariant )
			{
				...
				case 0: strcopy( strBuffer, iBufferSize, "Demoman" );
				case 1: strcopy( strBuffer, iBufferSize, "Burst Fire Demoman" );
				case 2: strcopy( strBuffer, iBufferSize, "Demoknight" );
				case 3: strcopy( strBuffer, iBufferSize, "Samurai Demo" );
				case 4: strcopy( strBuffer, iBufferSize, "Giant Rapid Fire Demoman (Type 1)" );
				case 5: strcopy( strBuffer, iBufferSize, "Giant Rapid Fire Demoman (Type 2)" );
				case 6: strcopy( strBuffer, iBufferSize, "Giant Burst Fire Demoman (Type 2)" );
				case 7: strcopy( strBuffer, iBufferSize, "Giant Demoknight" );
				case 8: strcopy( strBuffer, iBufferSize, "Major Bomber" );
				case 9: strcopy( strBuffer, iBufferSize, "Sir Nukesalot" );
				case 10: strcopy( strBuffer, iBufferSize, "Chief Tavish" );
		...
		case TFClass_Medic:
		{
			switch( iVariant )
			{
				...
				case 0: strcopy( strBuffer, iBufferSize, "Uber Medic (Type 1)" );
				case 1: strcopy( strBuffer, iBufferSize, "Uber Medic (Type 2)" );
				case 2: strcopy( strBuffer, iBufferSize, "Quick-Fix Medic (Type 1)" );
				case 3: strcopy( strBuffer, iBufferSize, "Quick-Fix Medic (Type 2)" );
				case 4: strcopy( strBuffer, iBufferSize, "Giant Medic (Type 1)" );
				case 5: strcopy( strBuffer, iBufferSize, "Giant Medic (Type 2)" );
			}
		}
		case TFClass_Heavy:
		{
			switch( iVariant )
			{
				...
				case 0: strcopy( strBuffer, iBufferSize, "Heavy" );
				case 1: strcopy( strBuffer, iBufferSize, "Heavy Shotgun" );
				case 2: strcopy( strBuffer, iBufferSize, "Heavyweight Champ (Type 1)" );
				case 3: strcopy( strBuffer, iBufferSize, "Heavyweight Champ (Type 2)" );
				case 4: strcopy( strBuffer, iBufferSize, "Steel Gauntlet" );
				case 5: strcopy( strBuffer, iBufferSize, "Steel Gauntlet Pusher" );
				case 6: strcopy( strBuffer, iBufferSize, "Heavy Mittens" );
				case 7: strcopy( strBuffer, iBufferSize, "Giant Heavy" );
				case 8: strcopy( strBuffer, iBufferSize, "Giant Heavy Shotgun" );
				case 9: strcopy( strBuffer, iBufferSize, "Giant Deflector Heavy" );
				case 10: strcopy( strBuffer, iBufferSize, "Giant Heater Heavy (Type 1)" );
				case 11: strcopy( strBuffer, iBufferSize, "Giant Heater Heavy (Type 2)" );
				case 12: strcopy( strBuffer, iBufferSize, "Captain Punch" );
				case 13: strcopy( strBuffer, iBufferSize, "Giant Heal-on-Kill Heavy (Type 1)" );
				case 14: strcopy( strBuffer, iBufferSize, "Giant Heal-on-Kill Heavy (Type 2)" );
				case 15: strcopy( strBuffer, iBufferSize, "Giant Heavy (Brass Beast)" );
				case 16: strcopy( strBuffer, iBufferSize, "Giant Heavy (Natascha)" );
				case 17: strcopy( strBuffer, iBufferSize, "Super Heavyweight Champ" );
			}
		}
		case TFClass_Pyro:
		{
			switch( iVariant )
			{
				...
				case 0: strcopy( strBuffer, iBufferSize, "Pyro" );
				...
				case 4: strcopy( strBuffer, iBufferSize, "Giant Pyro" );
				case 5: strcopy( strBuffer, iBufferSize, "Giant Flare Pyro" );
				case 6: strcopy( strBuffer, iBufferSize, "Giant Airblast Pyro" );
				case 7: strcopy( strBuffer, iBufferSize, "Chief Pyro" );
			}
		}
		case TFClass_Spy:
		{
