...
public OnPluginStart()
{
	...
	g_hFlags                                  = CreateConVar("sm_classrestrict_flags",         "X",   "Admin flags for restricted classes in TF2.");
	...
	g_hLimits[TF_TEAM_BLU][TF_CLASS_MEDIC]    = CreateConVar("sm_classrestrict_blu_medics",    ".2", "Limit for Blu medics in TF2.");
	...
	g_hLimits[TF_TEAM_BLU][TF_CLASS_SNIPER]   = CreateConVar("sm_classrestrict_blu_snipers",   ".22", "Limit for Blu snipers in TF2.");
	g_hLimits[TF_TEAM_BLU][TF_CLASS_SOLDIER]  = CreateConVar("sm_classrestrict_blu_soldiers",  "-1", "Limit for Blu soldiers in TF2.");
	g_hLimits[TF_TEAM_BLU][TF_CLASS_SPY]      = CreateConVar("sm_classrestrict_blu_spies",     ".18", "Limit for Blu spies in TF2.");
	...
	g_hLimits[TF_TEAM_RED][TF_CLASS_MEDIC]    = CreateConVar("sm_classrestrict_red_medics",    ".2", "Limit for Red medics in TF2.");
	...
	g_hLimits[TF_TEAM_RED][TF_CLASS_SNIPER]   = CreateConVar("sm_classrestrict_red_snipers",   ".22", "Limit for Red snipers in TF2.");
	...
	g_hIgnoreAdmin = CreateConVar("sm_classrestrict_ignoreadmins", "1", "If set to 1, admins won't be taken into account when checking if a team is full.");
