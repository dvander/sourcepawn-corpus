...
{
	RemoveOldObjective();
	PrintToChatAll("[SM] Congratulations on completing the old objective!");
...
public Action:Command_ObjTimeLeft(iClient, sArgs)
{
	...
	if(g_iTimeLeft != -1)
	{
		if(g_iTimeLeft/60 == 0 && g_iTimeLeft != 0)
			PrintToChat(iClient, "[SM] You have %d seconds to complete this objective before the National Guard withdraws their support and leaves without you!", g_iTimeLeft%60);
		else if(g_iTimeLeft%60 == 0 && g_iTimeLeft != 0)
		{
			if(g_iTimeLeft/60 == 1)
				PrintToChat(iClient, "[SM] You have 1 minute to complete this objective before the National Guard withdraws their support and leaves without you!");
			else
				PrintToChat(iClient, "[SM] You have %d minutes to complete this objective before the National Guard withdraws their support and leaves without you!", g_iTimeLeft/60);
		}	
		else if(g_iTimeLeft != 0)
			PrintToChat(iClient, "[SM] You have %d minutes and %d seconds to complete this objective before the National Guard withdraws their support and leaves without you!", g_iTimeLeft/60, g_iTimeLeft%60)
	}
	else
...
{
	if(g_iTimeLeft/60 == 0 && g_iTimeLeft != 0)
		PrintToChatAll("[SM] You have %d seconds to complete this objective before the National Guard withdraws their support and leaves without you!", g_iTimeLeft%60);
	else if(g_iTimeLeft%60 == 0 && g_iTimeLeft != 0)
	{
		if(g_iTimeLeft/60 == 1)
			PrintToChatAll("[SM] You have 1 minute to complete this objective before the National Guard withdraws their support and leaves without you!");
		else
			PrintToChatAll("[SM] You have %d minutes to complete this objective before the National Guard withdraws their support and leaves without you!", g_iTimeLeft/60);
	}	
	else if(g_iTimeLeft != 0)
		PrintToChatAll("[SM] You have %d minutes and %d seconds to complete this objective before the National Guard withdraws their support and leaves without you!", g_iTimeLeft/60, g_iTimeLeft%60)
}
