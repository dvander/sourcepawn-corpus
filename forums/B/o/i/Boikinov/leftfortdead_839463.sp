...
public OnPluginStart()
{
    ...
    RegConsoleCmd( "leftfortdead_spawnitem",      SpawnItem, "spawn a prop_dynamic or prop_physics entity", FCVAR_PLUGIN );
    RegConsoleCmd( "leftfortdead_spawnminigun",   SpawnMinigun, "spawn a minigun", FCVAR_PLUGIN );
    RegConsoleCmd( "leftfortdead_spawnammostack", SpawnAmmoStack, "spawn an ammo stack", FCVAR_PLUGIN );
    RegConsoleCmd( "leftfortdead_spawnirondoor",  SpawnIronDoor, "spawn a reinforced iron door", FCVAR_PLUGIN );
    RegConsoleCmd( "leftfortdead_rotate",         RotateEntity, "rotate an entity", FCVAR_PLUGIN );
    RegConsoleCmd( "leftfortdead_remove",         RemoveEntity, "remove an entity, won't remove player by accident", FCVAR_PLUGIN );

    g_cvar_enabled   = CreateConVar( "leftfortdead_enabled", "0", "0: disable Left FORT Dead MOD, 1: enable MOD", FCVAR_PLUGIN | FCVAR_REPLICATED | FCVAR_NOTIFY | FCVAR_DEMO );
