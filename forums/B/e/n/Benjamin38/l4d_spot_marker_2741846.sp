...
public void OnPluginStart()
{
	...
	LoadTranslations("l4d_spot_marker.phrases");
}
...
public void CreateSpotMarker(int client)
{
	...
	if (g_bCvar_Sprite)
	{
		...
		if (g_bCvar_SpriteSpeed && g_bCvar_SpriteMinMax)
		{
			...
			EmitSoundToAll("buttons/bell1.wav", client, team, SNDLEVEL_NORMAL, SND_NOFLAGS, 0.5);
			PrintToChat(client,"%t","spot_mark",client);
		}
	}
}
