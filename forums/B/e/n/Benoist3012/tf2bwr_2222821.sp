...
stock PickRandomClassVariant( TFClassType:iClass = TFClass_Unknown )
{
	...
	switch( iClass )
	{
		...
		case TFClass_Soldier:	return !bGiants ? GetRandomInt(0,5) : GetRandomInt(0,11);
...
#if defined HIDDEN_CODE
				case 10: strcopy( strBuffer, iBufferSize, "Giant Burst Fire Soldier" );
				case 11: strcopy( strBuffer, iBufferSize, "Sergeant Crits" );
#endif
			}
		}
		case TFClass_DemoMan:
