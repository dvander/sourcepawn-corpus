...
{
	name = "MapChooser_ins2",
	author = "AlliedModders LLC, Bacardi mess this",
	description = "Automated Map Voting",
	version = SOURCEMOD_VERSION,
	url = "http://forums.alliedmods.net/showthread.php?t=128317"
};
...
public OnPluginStart()
{
	...
	g_Cvar_Maxrounds = FindConVar("mp_roundlimit"); /*CVAR found from Insurgency */
	g_Cvar_Fraglimit = FindConVar("mp_fraglimit");
	g_Cvar_Bonusroundtime = FindConVar("mp_bonusroundtime");
	
	if (g_Cvar_Winlimit != INVALID_HANDLE || g_Cvar_Maxrounds != INVALID_HANDLE)
	{
		HookEvent("round_end", Event_RoundEnd); /*Insurgency notice this*/
...
public Event_RoundEnd(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	/* This was mess round end vote in Insurgency game */
