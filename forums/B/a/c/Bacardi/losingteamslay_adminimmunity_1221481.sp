...
{
	name = "Losing Team Slayer Admin immunity",
...
public OnPluginStart()
{
	...
	minplayer = CreateConVar("lts_minplayer", "10", "Sets the minimum number of players needed to start plugin");
...
public Action:Delayed_Slay(Handle:timer, any:param)
{
	...
	{
		if(IsClientInGame(i) && CheckCommandAccess(i, "lts_immunity", ADMFLAG_SLAY))
		{
			continue;
		}
