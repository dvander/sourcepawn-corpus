...
public OnPluginStart()
{
	...
	g_hConsoleTagColor = AutoExecConfig_CreateConVar("togcc_tagcolor", "\x02", "Hexadecimal value to use for console tag color (do not include #)", FCVAR_NONE);
	...
	g_hConsoleNameColor = AutoExecConfig_CreateConVar("togcc_namecolor", "\x0E", "Hexadecimal value to use for console name color (do not include #)", FCVAR_NONE);
	...
	g_hConsoleChatColor = AutoExecConfig_CreateConVar("togcc_chatcolor", "\x04", "Hexadecimal value to use for console chat color (do not include #)", FCVAR_NONE);
...
public Action:Command_Say(client, String:Command[], ArgC)
{
	...
	TrimString(sMessage);
	CGOPrintToChatAll("\x02%s%s\x0E%s%s: \x04%s%s", g_sConsoleTagColor, g_sConsoleTag, g_sConsoleNameColor, g_sConsoleName, g_sConsoleChatColor, sMessage);
