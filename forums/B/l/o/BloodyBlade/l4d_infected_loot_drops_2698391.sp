...
ConVar CVarHunterLoot[31];
ConVar CVarBoomerLoot[31];
ConVar CVarSmokerLoot[31];
ConVar CVarTankLoot[31];
//ConVar CVarWitchLoot[31];
...
public void OnPluginStart()
{
	...
	CreateConVar("l4d_loot_ver", PLUGIN_VERSION, "Version of the infected loot drops plugins.", CVAR_FLAGS|FCVAR_SPONLY|FCVAR_DONTRECORD);

	CVarIsEnabled = CreateConVar("l4d_loot_enabled", "1", "Is the plugin enabled.", CVAR_FLAGS);
	HookConVarChange(CVarIsEnabled, Loot_EnableDisable);

	CVarDieSides[0] = CreateConVar("l4d_loot_dice1_sides", "10", "How many sides die 1 has.", CVAR_FLAGS);
	CVarDieSides[1] = CreateConVar("l4d_loot_dice2_sides", "20", "How many sides die 2 has.", CVAR_FLAGS);
	...
	CVarHunterLoot[LOOT_DIENUMBER] = CreateConVar("l4d_loot_hunter_dienumber", "2", "Which die (1, 2, 4, or 4) is used when rolling for the hunter", CVAR_FLAGS, true, 1.0, true, 4.0);
	...
	CVarHunterLoot[LOOT_ITEM_COUNT] = CreateConVar("l4d_loot_hunter_item_count", "1", "How many items are rolled for when the hunter dies.", CVAR_FLAGS, true, 0.0);	

	CVarHunterLoot[LOOT_KIT_MIN] = CreateConVar("l4d_loot_hunter_kit_min", "0", "Min die number for a hunter to drop a kit.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_KIT_MAX] = CreateConVar("l4d_loot_hunter_kit_max", "0", "Max die number for a hunter to drop a kit.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_PILLS_MIN] = CreateConVar("l4d_loot_hunter_pills_min", "0", "Min die number for a hunter to drop pills.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_PILLS_MAX] = CreateConVar("l4d_loot_hunter_pills_max", "0", "Max die number for a hunter to drop pills.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_MOLLY_MIN] = CreateConVar("l4d_loot_hunter_molly_min", "4", "Min die number for a hunter to drop a molitov.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_MOLLY_MAX] = CreateConVar("l4d_loot_hunter_molly_max", "6", "Max die number for a hunter to drop a molitov.", CVAR_FLAGS, true, 0.0);
	...
	CVarHunterLoot[LOOT_PANIC_MIN] = CreateConVar("l4d_loot_hunter_panic_min", "0", "Min die number for a hunter to cause a zombie panic event.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_PANIC_MAX] = CreateConVar("l4d_loot_hunter_panic_max", "0", "Max die number for a hunter to cause a zombie panic event.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_TANK_MIN] = CreateConVar("l4d_loot_hunter_tankspawn_min", "0", "Min die number for a hunter to cause a tank to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_TANK_MAX] = CreateConVar("l4d_loot_hunter_tankspawn_max", "0", "Max die number for a hunter to cause a tank to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_WITCH_MIN] = CreateConVar("l4d_loot_hunter_witchspawn_min", "0", "Min die number for a hunter to cause a witch to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_WITCH_MAX] = CreateConVar("l4d_loot_hunter_witchspawn_max", "0", "Max die number for a hunter to cause a witch to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_COMMON_MIN] = CreateConVar("l4d_loot_hunter_common_min", "0", "Min die number for a hunter to cause common infected to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_COMMON_MAX] = CreateConVar("l4d_loot_hunter_common_max", "0", "Max die number for a hunter to cause common infected to spawn nearby.", CVAR_FLAGS, true, 0.0);

	CVarHunterLoot[LOOT_PISTOL_MIN] = CreateConVar("l4d_loot_hunter_pistol_min", "0", 	"Min die number for a hunter to drop a pistol.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_PISTOL_MAX] = CreateConVar("l4d_loot_hunter_pistol_max", "0", 	"Max die number for a hunter to drop a pistol.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_SMG_MIN] = CreateConVar("l4d_loot_hunter_smg_min", "0", "Min die number for a hunter to drop a small machine gun.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_SMG_MAX] = CreateConVar("l4d_loot_hunter_smg_max", "0", "Max die number for a hunter to drop a small machine gun.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_SHOT_MIN] = CreateConVar("l4d_loot_hunter_shotgun_min", "0", "Min die number for a hunter to drop a shotgun.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_SHOT_MAX] = CreateConVar("l4d_loot_hunter_shotgun_max", "0", "Max die number for a hunter to drop a shotgun.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_RIFLE_MIN] = CreateConVar("l4d_loot_hunter_rifle_min", "0", "Min die number for a hunter to drop an auto rifle.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_RIFLE_MAX] = CreateConVar("l4d_loot_hunter_rifle_max", "0", "Max die number for a hunter to drop an auto rifle.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_AUTOSHOT_MIN] = CreateConVar("l4d_loot_hunter_autoshot_min", "0", "Min die number for a hunter to drop an auto shotgun.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_AUTOSHOT_MAX] = CreateConVar("l4d_loot_hunter_autoshot_max", "0", "Max die number for a hunter to drop an auto shotgun.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_SNIPER_MIN] = CreateConVar("l4d_loot_hunter_sniper_min", "0", "Min die number for a hunter to drop a sniper rifle.", CVAR_FLAGS, true, 0.0);
	CVarHunterLoot[LOOT_SNIPER_MAX] = CreateConVar("l4d_loot_hunter_sniper_max", "0", "Max die number for a hunter to drop a sniper rifle.", CVAR_FLAGS, true, 0.0);

	CVarSmokerLoot[LOOT_DIENUMBER] = CreateConVar("l4d_loot_smoker_dienumber", "3", "Which die (1, 2, 4, or 4) is used when rolling for the smoker", CVAR_FLAGS, true, 1.0, true, 4.0);
	...
	CVarSmokerLoot[LOOT_ITEM_COUNT] = CreateConVar("l4d_loot_smoker_item_count", "1", "How many items are rolled for when the smoker dies.", CVAR_FLAGS, true, 0.0);	

	CVarSmokerLoot[LOOT_KIT_MIN] = CreateConVar("l4d_loot_smoker_kit_min", "0", "Min die number for a smoker to drop a kit.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_KIT_MAX] = CreateConVar("l4d_loot_smoker_kit_max", "0", "Max die number for a smoker to drop a kit.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_PILLS_MIN] = CreateConVar("l4d_loot_smoker_pills_min",	"10", "Min die number for a smoker to drop pills.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_PILLS_MAX] = CreateConVar("l4d_loot_smoker_pills_max",	"14", "Max die number for a smoker to drop pills.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_MOLLY_MIN] = CreateConVar("l4d_loot_smoker_molly_min",	"2", "Min die number for a smoker to drop a molitov.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_MOLLY_MAX] = CreateConVar("l4d_loot_smoker_molly_max",	"4", "Max die number for a smoker to drop a molitov.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_PIPE_MIN] = CreateConVar("l4d_loot_smoker_pipe_min", "5", "Min die number for a smoker to drop a pipe bomb.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_PIPE_MAX] = CreateConVar("l4d_loot_smoker_pipe_max", "8", "Max die number for a smoker to drop a pipe bomb.", CVAR_FLAGS, true, 0.0);

	CVarSmokerLoot[LOOT_PANIC_MIN] = CreateConVar("l4d_loot_smoker_panic_min",	"0", "Min die number for a smoker to cause a zombie panic event.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_PANIC_MAX] = CreateConVar("l4d_loot_smoker_panic_max",	"0", "Max die number for a smoker to cause a zombie panic event.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_TANK_MIN] = CreateConVar("l4d_loot_smoker_tankspawn_min",	"0", "Min die number for a smoker to cause a tank to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_TANK_MAX] = CreateConVar("l4d_loot_smoker_tankspawn_max",	"0", "Max die number for a smoker to cause a tank to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_WITCH_MIN] = CreateConVar("l4d_loot_smoker_witchspawn_min", "0", "Min die number for a smoker to cause a witch to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_WITCH_MAX] = CreateConVar("l4d_loot_smoker_witchspawn_max", "0", "Max die number for a smoker to cause a witch to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_COMMON_MIN] = CreateConVar("l4d_loot_smoker_common_min", "0", "Min die number for a smoker to cause common infected to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_COMMON_MAX] = CreateConVar("l4d_loot_smoker_common_max", "0", "Max die number for a smoker to cause common infected to spawn nearby.", CVAR_FLAGS, true, 0.0);
	...
	CVarSmokerLoot[LOOT_PISTOL_MAX] = CreateConVar("l4d_loot_smoker_pistol_max", "21", 	"Max die number for a smoker to drop a pistol.", CVAR_FLAGS, true, 0.0);
	...
	CVarSmokerLoot[LOOT_SMG_MAX] = CreateConVar("l4d_loot_smoker_smg_max", "23", "Max die number for a smoker to drop a small machine gun.", CVAR_FLAGS, true, 0.0);
	...
	CVarSmokerLoot[LOOT_SHOT_MAX] = CreateConVar("l4d_loot_smoker_shotgun_max", "24", "Max die number for a smoker to drop a shotgun.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_RIFLE_MIN] = CreateConVar("l4d_loot_smoker_rifle_min",	"25", "Min die number for a smoker to drop an auto rifle.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_RIFLE_MAX] = CreateConVar("l4d_loot_smoker_rifle_max",	"25", "Max die number for a smoker to drop an auto rifle.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_AUTOSHOT_MIN] = CreateConVar("l4d_loot_smoker_autoshot_min", "26", "Min die number for a smoker to drop an auto shotgun.", CVAR_FLAGS, true, 0.0);
	CVarSmokerLoot[LOOT_AUTOSHOT_MAX] = CreateConVar("l4d_loot_smoker_autoshot_max", "26", "Max die number for a smoker to drop an auto shotgun.", CVAR_FLAGS, true, 0.0);
	...
	CVarSmokerLoot[LOOT_SNIPER_MAX] = CreateConVar("l4d_loot_smoker_sniper_max", "27", "Max die number for a smoker to drop a sniper rifle.", CVAR_FLAGS, true, 0.0);

	CVarBoomerLoot[LOOT_DIENUMBER] = CreateConVar("l4d_loot_boomer_dienumber", "1", "Which die (1, 2, 4, or 4) is used when rolling for the boomer", CVAR_FLAGS, true, 1.0, true, 4.0);
	...
	CVarBoomerLoot[LOOT_ITEM_COUNT] = CreateConVar("l4d_loot_boomer_item_count", "1", "How many items are rolled for when the boomer dies.", CVAR_FLAGS, true, 0.0);	

	CVarBoomerLoot[LOOT_KIT_MIN] = CreateConVar("l4d_loot_boomer_kit_min", "0", "Min die number for a boomer to drop a kit.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_KIT_MAX] = CreateConVar("l4d_loot_boomer_kit_max", "0", "Max die number for a boomer to drop a kit.", CVAR_FLAGS, true, 0.0);
	...
	CVarBoomerLoot[LOOT_PILLS_MAX] = CreateConVar("l4d_loot_boomer_pills_max",	"3", "Max die number for a boomer to drop pills.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_MOLLY_MIN] = CreateConVar("l4d_loot_boomer_molly_min",	"4", "Min die number for a boomer to drop a molitov.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_MOLLY_MAX] = CreateConVar("l4d_loot_boomer_molly_max",	"6", "Max die number for a boomer to drop a molitov.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_PIPE_MIN] = CreateConVar("l4d_loot_boomer_pipe_min", "0", "Min die number for a boomer to drop a pipe bomb.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_PIPE_MAX] = CreateConVar("l4d_loot_boomer_pipe_max", "0", "Max die number for a boomer to drop a pipe bomb.", CVAR_FLAGS, true, 0.0);

	CVarBoomerLoot[LOOT_PANIC_MIN] = CreateConVar("l4d_loot_boomer_panic_min",	"0", "Min die number for a boomer to cause a zombie panic event.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_PANIC_MAX] = CreateConVar("l4d_loot_boomer_panic_max",	"0", "Max die number for a boomer to cause a zombie panic event.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_TANK_MIN] = CreateConVar("l4d_loot_boomer_tankspawn_min",	"0", "Min die number for a boomer to cause a tank to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_TANK_MAX] = CreateConVar("l4d_loot_boomer_tankspawn_max",	"0", "Max die number for a boomer to cause a tank to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_WITCH_MIN] = CreateConVar("l4d_loot_boomer_witchspawn_min", "0", "Min die number for a boomer to cause a witch to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_WITCH_MAX] = CreateConVar("l4d_loot_boomer_witchspawn_max", "0", "Max die number for a boomer to cause a witch to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_COMMON_MIN] = CreateConVar("l4d_loot_boomer_common_min", "0", "Min die number for a boomer to cause common infected to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_COMMON_MAX] = CreateConVar("l4d_loot_boomer_common_max", "0", "Max die number for a boomer to cause common infected to spawn nearby.", CVAR_FLAGS, true, 0.0);

	CVarBoomerLoot[LOOT_PISTOL_MIN] = CreateConVar("l4d_loot_boomer_pistol_min", "0", 	"Min die number for a boomer to drop a pistol.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_PISTOL_MAX] = CreateConVar("l4d_loot_boomer_pistol_max", "0", 	"Max die number for a boomer to drop a pistol.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_SMG_MIN] = CreateConVar("l4d_loot_boomer_smg_min", "0", "Min die number for a boomer to drop a small machine gun.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_SMG_MAX] = CreateConVar("l4d_loot_boomer_smg_max", "0", "Max die number for a boomer to drop a small machine gun.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_SHOT_MIN] = CreateConVar("l4d_loot_boomer_shotgun_min", "0", "Min die number for a boomer to drop a shotgun.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_SHOT_MAX] = CreateConVar("l4d_loot_boomer_shotgun_max", "0", "Max die number for a boomer to drop a shotgun.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_RIFLE_MIN] = CreateConVar("l4d_loot_boomer_rifle_min",	"0", "Min die number for a boomer to drop an auto rifle.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_RIFLE_MAX] = CreateConVar("l4d_loot_boomer_rifle_max",	"0", "Max die number for a boomer to drop an auto rifle.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_AUTOSHOT_MIN] = CreateConVar("l4d_loot_boomer_autoshot_min", "0", "Min die number for a boomer to drop an auto shotgun.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_AUTOSHOT_MAX] = CreateConVar("l4d_loot_boomer_autoshot_max", "0", "Max die number for a boomer to drop an auto shotgun.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_SNIPER_MIN] = CreateConVar("l4d_loot_boomer_sniper_min", "0", "Min die number for a boomer to drop a sniper rifle.", CVAR_FLAGS, true, 0.0);
	CVarBoomerLoot[LOOT_SNIPER_MAX] = CreateConVar("l4d_loot_boomer_sniper_max", "0", "Max die number for a boomer to drop a sniper rifle.", CVAR_FLAGS, true, 0.0);	

	CVarTankLoot[LOOT_DIENUMBER] = CreateConVar("l4d_loot_tank_dienumber", "2", "Which die (1, 2, 4, or 4) is used when rolling for the tank", CVAR_FLAGS, true, 1.0, true, 4.0);
	...
	CVarTankLoot[LOOT_ITEM_COUNT] = CreateConVar("l4d_loot_tank_item_count", "4", "How many items are rolled for when the tank dies.", CVAR_FLAGS, true, 0.0);	
	...
	CVarTankLoot[LOOT_KIT_MAX] = CreateConVar("l4d_loot_tank_kit_max", "5", "Max die number for a tank to drop a kit.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_PILLS_MIN] = CreateConVar("l4d_loot_tank_pills_min",	"6", "Min die number for a tank to drop pills.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_PILLS_MAX] = CreateConVar("l4d_loot_tank_pills_max",	"8", "Max die number for a tank to drop pills.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_MOLLY_MIN] = CreateConVar("l4d_loot_tank_molly_min",	"9", "Min die number for a tank to drop a molitov.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_MOLLY_MAX] = CreateConVar("l4d_loot_tank_molly_max",	"10", "Max die number for a tank to drop a molitov.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_PIPE_MIN] = CreateConVar("l4d_loot_tank_pipe_min", "11", "Min die number for a tank to drop a pipe bomb.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_PIPE_MAX] = CreateConVar("l4d_loot_tank_pipe_max", "12", "Max die number for a tank to drop a pipe bomb.", CVAR_FLAGS, true, 0.0);

	CVarTankLoot[LOOT_PANIC_MIN] = CreateConVar("l4d_loot_tank_panic_min",	"13", "Min die number for a tank to cause a zombie panic event.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_PANIC_MAX] = CreateConVar("l4d_loot_tank_panic_max",	"14", "Max die number for a tank to cause a zombie panic event.", CVAR_FLAGS, true, 0.0);
	...
	CVarTankLoot[LOOT_WITCH_MIN] = CreateConVar("l4d_loot_tank_witchspawn_min", "0", "Min die number for a tank to cause a witch to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_WITCH_MAX] = CreateConVar("l4d_loot_tank_witchspawn_max", "0", "Max die number for a tank to cause a witch to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_COMMON_MIN] = CreateConVar("l4d_loot_tank_common_min", "0", "Min die number for a tank to cause common infected to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_COMMON_MAX] = CreateConVar("l4d_loot_tank_common_max", "0", "Max die number for a tank to cause common infected to spawn nearby.", CVAR_FLAGS, true, 0.0);

	CVarTankLoot[LOOT_PISTOL_MIN] = CreateConVar("l4d_loot_tank_pistol_min", "0", 	"Min die number for a tank to drop a pistol.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_PISTOL_MAX] = CreateConVar("l4d_loot_tank_pistol_max", "0", 	"Max die number for a tank to drop a pistol.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_SMG_MIN] = CreateConVar("l4d_loot_tank_smg_min", "0", "Min die number for a tank to drop a small machine gun.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_SMG_MAX] = CreateConVar("l4d_loot_tank_smg_max", "0", "Max die number for a tank to drop a small machine gun.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_SHOT_MIN] = CreateConVar("l4d_loot_tank_shotgun_min", "0", "Min die number for a tank to drop a shotgun.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_SHOT_MAX] = CreateConVar("l4d_loot_tank_shotgun_max", "0", "Max die number for a tank to drop a shotgun.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_RIFLE_MIN] = CreateConVar("l4d_loot_tank_rifle_min",	"15", "Min die number for a tank to drop an auto rifle.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_RIFLE_MAX] = CreateConVar("l4d_loot_tank_rifle_max",	"16", "Max die number for a tank to drop an auto rifle.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_AUTOSHOT_MIN] = CreateConVar("l4d_loot_tank_autoshot_min", "17", "Min die number for a tank to drop an auto shotgun.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_AUTOSHOT_MAX] = CreateConVar("l4d_loot_tank_autoshot_max", "18", "Max die number for a tank to drop an auto shotgun.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_SNIPER_MIN] = CreateConVar("l4d_loot_tank_sniper_min", "19", "Min die number for a tank to drop a sniper rifle.", CVAR_FLAGS, true, 0.0);
	CVarTankLoot[LOOT_SNIPER_MAX] = CreateConVar("l4d_loot_tank_sniper_max", "20", "Max die number for a tank to drop a sniper rifle.", CVAR_FLAGS, true, 0.0);
	
	/*
	CVarWitchLoot[LOOT_DIENUMBER] = CreateConVar("l4d_loot_witch_dienumber", "2", "Which die (1, 2, 4, or 4) is used when rolling for the witch", CVAR_FLAGS, true, 1.0, true, 4.0);
	...
	CVarWitchLoot[LOOT_KIT_MAX] = CreateConVar("l4d_loot_witch_kit_max", "5", "Max die number for a witch to drop a kit.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_PILLS_MIN] = CreateConVar("l4d_loot_witch_pills_min",	"6", "Min die number for a witch to drop pills.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_PILLS_MAX] = CreateConVar("l4d_loot_witch_pills_max",	"8", "Max die number for a witch to drop pills.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_MOLLY_MIN] = CreateConVar("l4d_loot_witch_molly_min",	"9", "Min die number for a witch to drop a molitov.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_MOLLY_MAX] = CreateConVar("l4d_loot_witch_molly_max",	"10", "Max die number for a witch to drop a molitov.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_PIPE_MIN] = CreateConVar("l4d_loot_witch_pipe_min", "11", "Min die number for a witch to drop a pipe bomb.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_PIPE_MAX] = CreateConVar("l4d_loot_witch_pipe_max", "12", "Max die number for a witch to drop a pipe bomb.", CVAR_FLAGS, true, 0.0);

	CVarWitchLoot[LOOT_PANIC_MIN] = CreateConVar("l4d_loot_witch_panic_min",	"13", "Min die number for a witch to cause a zombie panic event.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_PANIC_MAX] = CreateConVar("l4d_loot_witch_panic_max",	"14", "Max die number for a witch to cause a zombie panic event.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_witch_MIN] = CreateConVar("l4d_loot_witch_witchspawn_min",	"0", "Min die number for a witch to cause a witch to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_witch_MAX] = CreateConVar("l4d_loot_witch_witchspawn_max",	"0", "Max die number for a witch to cause a witch to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_WITCH_MIN] = CreateConVar("l4d_loot_witch_witchspawn_min", "0", "Min die number for a witch to cause a witch to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_WITCH_MAX] = CreateConVar("l4d_loot_witch_witchspawn_max", "0", "Max die number for a witch to cause a witch to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_COMMON_MIN] = CreateConVar("l4d_loot_witch_common_min", "0", "Min die number for a witch to cause common infected to spawn nearby.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_COMMON_MAX] = CreateConVar("l4d_loot_witch_common_max", "0", "Max die number for a witch to cause common infected to spawn nearby.", CVAR_FLAGS, true, 0.0);

	CVarWitchLoot[LOOT_PISTOL_MIN] = CreateConVar("l4d_loot_witch_pistol_min", "0", 	"Min die number for a witch to drop a pistol.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_PISTOL_MAX] = CreateConVar("l4d_loot_witch_pistol_max", "0", 	"Max die number for a witch to drop a pistol.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_SMG_MIN] = CreateConVar("l4d_loot_witch_smg_min", "0", "Min die number for a witch to drop a small machine gun.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_SMG_MAX] = CreateConVar("l4d_loot_witch_smg_max", "0", "Max die number for a witch to drop a small machine gun.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_SHOT_MIN] = CreateConVar("l4d_loot_witch_shotgun_min", "0", "Min die number for a witch to drop a shotgun.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_SHOT_MAX] = CreateConVar("l4d_loot_witch_shotgun_max", "0", "Max die number for a witch to drop a shotgun.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_RIFLE_MIN] = CreateConVar("l4d_loot_witch_rifle_min",	"15", "Min die number for a witch to drop an auto rifle.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_RIFLE_MAX] = CreateConVar("l4d_loot_witch_rifle_max",	"16", "Max die number for a witch to drop an auto rifle.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_AUTOSHOT_MIN] = CreateConVar("l4d_loot_witch_autoshot_min", "17", "Min die number for a witch to drop an auto shotgun.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_AUTOSHOT_MAX] = CreateConVar("l4d_loot_witch_autoshot_max", "18", "Max die number for a witch to drop an auto shotgun.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_SNIPER_MIN] = CreateConVar("l4d_loot_witch_sniper_min", "19", "Min die number for a witch to drop a sniper rifle.", CVAR_FLAGS, true, 0.0);
	CVarWitchLoot[LOOT_SNIPER_MAX] = CreateConVar("l4d_loot_witch_sniper_max", "20", "Max die number for a witch to drop a sniper rifle.", CVAR_FLAGS, true, 0.0);
	*/
...
void PrintSettings(int diceSettings[31])
{
...
public void Loot_EnableDisable(ConVar hVariable, const char[] strOldValue, const char[] strNewValue)
{
    // Change the enabled flag to the one the convar holds.
    if (GetConVarInt(CVarIsEnabled) == 1) 
	{
...
void SpawnItemFromDieResult(int client, int diceSettings[31], int dieResult, bool sim = false)
{
	if (dieResult != 0)
	{
