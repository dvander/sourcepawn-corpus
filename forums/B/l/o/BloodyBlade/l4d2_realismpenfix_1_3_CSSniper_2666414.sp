...
public void OnPluginStart()
{
	...
	ConVar cvarSniperLimit = CreateConVar("sm_realismpenfix_sniperlimit", "0.0", "Maximum number of enemies one sniper bullet can kill (0 disables feature)", CVAR_FLAGS);
