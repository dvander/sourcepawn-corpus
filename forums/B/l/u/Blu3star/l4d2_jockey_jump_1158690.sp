...
#define SOUND_JOCKEY_DIR "./player/survivor/"
...
public OnPluginStart()
{
	...
	cvar_soundfile = CreateConVar("l4d2_jockeyjump_soundfile", "voice/mechanic/worldc2m1b09.wav", "Jockey jump - jockey sound file (relative to to sound/player/jockey/ - empty to disable)", CVAR_FLAGS);
