...
void CreateHook()
{
	...
	Address pFunc = pServerBase + ADDRESS(0x20A870); /* adding base address to offset of UTIL_SetModel function */
...
void CreateCallback()
{
	...
	Address pFunc = pSMBase + ADDRESS(0x34D0); /* adding base address to offset of SortFloat function */
