...
public OnPluginStart(){
	...
	sm_sc_url = CreateConVar("sm_sc_url", "amtestwp.byethost10.com/soundcloud.php", "Soundcloud php script location. Needs to follow the default format", FCVAR_PROTECTED);
...
public Action:OnStop(int client, int args){
	motd(client, "http://about.blank"); //working substitute for about:blank
