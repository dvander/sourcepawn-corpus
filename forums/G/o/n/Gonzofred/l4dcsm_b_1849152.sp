...
{	
	...
	// Announce cvar
	new Handle:Announce = CreateConVar("l4d_csm_announce", "0","Toggles the announcement of sm_csm command availability.",FCVAR_PLUGIN|FCVAR_SPONLY,true, 0.0, true, 1.0);
	...
	{
		// L4D1 Survivors cvar
		new Handle:L4D1Survivors = CreateConVar("l4d_csm_l4d1_survivors", "1","Toggles access to L4D1 Survivors in L4D2. Set this to 1 if it's a L4D2 campaign, else if its a L4D1 Campaign, set this to 2 or glitches will occur",FCVAR_PLUGIN|FCVAR_SPONLY,true, 0.0, true, 2.0);
