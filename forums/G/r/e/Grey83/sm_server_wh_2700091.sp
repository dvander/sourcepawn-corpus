...
public void OnPluginStart()
{
	...
	ConVar cvar;
	cvar = CreateConVar("sm_swh_mode", "7", "Show marks: 0 - don't show, 1 - to the Spec, 2 - to the dead allies, 4 - to the dead enemies", _, true, _, true, 7.0);
...
{
	return (iMode & 1) && !iTeam[client] || (!IsPlayerAlive(client)
