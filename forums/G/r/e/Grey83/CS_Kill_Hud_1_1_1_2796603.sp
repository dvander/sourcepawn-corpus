...
static const char
	PLUGIN_VERSION[] = "1.1.1 (rewritten by Grey83)",
...
public Action Event_PlayerDeathInfo(Event event, const char[] name, bool dontBroadcast)
{
	...
	if(GetClientTeam(victim) == 3) g_player_killspecial[attacker]++; // attacker kill +1
