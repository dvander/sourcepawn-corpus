...
public Plugin:myinfo =
{
	...
	url 			= "https://forums.alliedmods.net/showthread.php?p=2287730"
}
...
stock GetClipSize(iClient)
{
	...
	if (StrEqual(sPlayerWeapon, "tool_flare_gun") || StrEqual(sPlayerWeapon, "tool_barricade") || StrContains(sPlayerWeapon, "exp_") == 0 || StrEqual(sPlayerWeapon, "bow_deerhunter"))
		...
		return 2;
	else if (StrEqual(sPlayerWeapon, "fa_500a") || StrEqual(sPlayerWeapon, "fa_superx3") || StrEqual(sPlayerWeapon, "fa_sako85"))
		return 5;
		...
		return 8;
	else if (StrEqual(sPlayerWeapon, "fa_1022") || StrEqual(sPlayerWeapon, "fa_jae700") || StrEqual(sPlayerWeapon, "fa_mkiii") || StrEqual(sPlayerWeapon, "fa_sks"))
		return 10;
