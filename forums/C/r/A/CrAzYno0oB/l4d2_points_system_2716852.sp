...
int PluginSettings[plugin_settings];
...
int PluginSprites[plugin_sprites];
...
int PlayerData[MAXPLAYERS][player_data];
...
int ItemCosts[item_costs];

void initItemCosts()
{
	ItemCosts[CostP220] = CreateConVar("l4d2_points_pistol", "4", "How many points the p220 pistol costs");
	ItemCosts[CostMagnum] = CreateConVar("l4d2_points_magnum", "6", "How many points the magnum pistol costs");
	ItemCosts[CostUzi] = CreateConVar("l4d2_points_smg", "7", "How many points the smg costs");
	ItemCosts[CostSilenced] = CreateConVar("l4d2_points_silenced", "7", "How many points the silenced smg costs");
	ItemCosts[CostMP5] = CreateConVar("l4d2_points_mp5", "7", "How many points the mp5 smg costs");
	ItemCosts[CostM16] = CreateConVar("l4d2_points_m16", "12", "How many points the m16 rifle costs");
	ItemCosts[CostAK47] = CreateConVar("l4d2_points_ak47", "12", "How many points the ak47 rifle costs");
	ItemCosts[CostSCAR] = CreateConVar("l4d2_points_scar", "12", "How many points the scar-l rifle costs");
	ItemCosts[CostSG552] = CreateConVar("l4d2_points_sg552", "12", "How many points the sg552 rifle costs");
	ItemCosts[CostMilitary] = CreateConVar("l4d2_points_military", "14", "How many points the military sniper rifle costs");
	ItemCosts[CostAWP] = CreateConVar("l4d2_points_awp", "15", "How many points the awp sniper rifle costs");
	ItemCosts[CostScout] = CreateConVar("l4d2_points_scout", "10", "How many points the scout sniper rifle costs");
	ItemCosts[CostHunting] = CreateConVar("l4d2_points_hunting", "10", "How many points the hunting rifle costs");
	ItemCosts[CostAuto] = CreateConVar("l4d2_points_auto", "10", "How many points the autoshotgun costs");
	ItemCosts[CostSPAS] = CreateConVar("l4d2_points_spas", "10", "How many points the spas shotgun costs");
	...
	ItemCosts[CostGrenade] = CreateConVar("l4d2_points_grenade", "15", "How many points the grenade launcher costs");
	ItemCosts[CostM60] = CreateConVar("l4d2_points_m60", "50", "How many points the m60 rifle costs");
	ItemCosts[CostGasCan] = CreateConVar("l4d2_points_gascan", "5", "How many points the gas can costs");
	ItemCosts[CostOxygen] = CreateConVar("l4d2_points_oxygen", "2", "How many points the oxgen tank costs");
	ItemCosts[CostPropane] = CreateConVar("l4d2_points_propane", "2", "How many points the propane tank costs");
	ItemCosts[CostGnome] = CreateConVar("l4d2_points_gnome", "8", "How many points the gnome costs");
	ItemCosts[CostCola] = CreateConVar("l4d2_points_cola", "8", "How many points cola bottles costs");
	ItemCosts[CostFireworks] = CreateConVar("l4d2_points_fireworks", "2", "How many points the fireworks crate costs");
	...
	ItemCosts[CostElectricguitar] = CreateConVar("l4d2_points_electricguitar", "4", "How many points the electric guitar costs");
	ItemCosts[CostFireaxe] = CreateConVar("l4d2_points_fireaxe", "4", "How many points the fire axe costs");
	ItemCosts[CostFryingpan] = CreateConVar("l4d2_points_fryingpan", "4", "How many points the frying pan costs");
	ItemCosts[CostGolfclub] = CreateConVar("l4d2_points_golfclub", "6", "How many points the golf club costs");
	ItemCosts[CostKatana] = CreateConVar("l4d2_points_katana", "6", "How many points the katana costs");
	ItemCosts[CostKnife] = CreateConVar("l4d2_points_knife", "6", "How many points the knife costs");
	ItemCosts[CostMachete] = CreateConVar("l4d2_points_machete", "6", "How many points the machete costs");
	ItemCosts[CostShield] = CreateConVar("l4d2_points_shield", "6", "How many points the shield costs");
	ItemCosts[CostTonfa] = CreateConVar("l4d2_points_tonfa", "4", "How many points the nightstick costs");
	ItemCosts[CostChainsaw] = CreateConVar("l4d2_points_chainsaw", "10", "How many points the chainsaw costs");
	ItemCosts[CostPipe] = CreateConVar("l4d2_points_pipe", "8", "How many points the pipe bomb costs");
	ItemCosts[CostMolotov] = CreateConVar("l4d2_points_molotov", "8", "How many points the molotov costs");
	ItemCosts[CostBile] = CreateConVar("l4d2_points_bile", "8", "How many points the bile jar costs");
	ItemCosts[CostHealthKit] = CreateConVar("l4d2_points_medkit", "20", "How many points the health kit costs");
	ItemCosts[CostDefib] = CreateConVar("l4d2_points_defib", "20", "How many points the defib costs");
	ItemCosts[CostAdren] = CreateConVar("l4d2_points_adrenaline", "10", "How many points the adrenaline costs");
	ItemCosts[CostPills] = CreateConVar("l4d2_points_pills", "10", "How many points the pills costs");
	...
	ItemCosts[CostHeal] = CreateConVar("l4d2_points_survivor_heal", "25", "How many points a complete heal costs");
	ItemCosts[CostAmmo] = CreateConVar("l4d2_points_refill", "8", "How many points an ammo refill costs");

	ItemCosts[CostSuicide] = CreateConVar("l4d2_points_suicide", "4", "How many points does suicide cost");
	ItemCosts[CostHunter] = CreateConVar("l4d2_points_hunter", "4", "How many points does a hunter cost");
	ItemCosts[CostJockey] = CreateConVar("l4d2_points_jockey", "6", "How many points does a jockey cost");
	ItemCosts[CostSmoker] = CreateConVar("l4d2_points_smoker", "4", "How many points does a smoker cost");
	ItemCosts[CostCharger] = CreateConVar("l4d2_points_charger", "6", "How many points does a charger cost");
	ItemCosts[CostBoomer] = CreateConVar("l4d2_points_boomer", "5", "How many points does a boomer cost");
	ItemCosts[CostSpitter] = CreateConVar("l4d2_points_spitter", "6", "How many points does a spitter cost");
	ItemCosts[CostInfectedHeal] = CreateConVar("l4d2_points_infected_heal", "6", "How many points does healing yourself as an infected cost");
	ItemCosts[CostWitch] = CreateConVar("l4d2_points_witch", "20", "How many points does a witch cost");
	ItemCosts[CostTank] = CreateConVar("l4d2_points_tank", "30", "How many points does a tank cost");
	ItemCosts[CostTankHealMultiplier] = CreateConVar("l4d2_points_tank_heal_mult", "3", "How much l4d2_points_infected_heal should be multiplied for tank players");
	ItemCosts[CostHorde] = CreateConVar("l4d2_points_horde", "15", "How many points does a horde cost");
	ItemCosts[CostMob] = CreateConVar("l4d2_points_mob", "10", "How many points does a mob cost");
	ItemCosts[CostUncommonMob] = CreateConVar("l4d2_points_umob", "12", "How many points does an uncommon mob cost");
	return;
}
...
int CategoriesEnabled[categories_enabled];
...
int PointRewards[point_rewards];
...
void initPointRewards()
{
	...
	PointRewards[SurvRewardHeadShots] = CreateConVar("l4d2_points_headshots_value", "4", "How many points does killing a certain amount of infected with headshots earn");
	PointRewards[SurvKillInfec] = CreateConVar("l4d2_points_sikill", "1", "How many points does killing a special infected earn");
	PointRewards[SurvKillTank] = CreateConVar("l4d2_points_tankkill", "2", "How many points does killing a tank earn");
	PointRewards[SurvKillWitch] = CreateConVar("l4d2_points_witchkill", "4", "How many points does killing a witch earn");
	PointRewards[SurvCrownWitch] = CreateConVar("l4d2_points_witchcrown", "2", "How many points does crowning a witch earn");
	PointRewards[SurvTeamHeal] = CreateConVar("l4d2_points_heal", "5", "How many points does healing a team mate earn");
	PointRewards[SurvTeamHealFarm] = CreateConVar("l4d2_points_heal_warning", "1", "How many points does healing a team mate who did not need healing earn");
	PointRewards[SurvTeamProtect] = CreateConVar("l4d2_points_protect", "1", "How many points does protecting a team mate earn");
	PointRewards[SurvTeamRevive] = CreateConVar("l4d2_points_revive", "3", "How many points does reviving a team mate earn");
	...
	PointRewards[SurvTankSolo] = CreateConVar("l4d2_points_tanksolo", "8", "How many points does killing a tank single-handedly earn");
	...
	PointRewards[InfecImpactSurv] = CreateConVar("l4d2_points_impact", "1", "How many points does impacting a survivor earn");
	PointRewards[InfecRideSurv] = CreateConVar("l4d2_points_ride", "2", "How many points does riding a survivor earn");
	PointRewards[InfecBoomSurv] = CreateConVar("l4d2_points_boom", "1", "How many points does booming a survivor earn");
...
void BuildMeleeMenu(int client)
{
	...
	for(int i; i < MAX_MELEE_LENGTH; i++)
	{
		...
		else if(i == 2 && GetConVarInt(ItemCosts[CostBaseballbat]) < 0)
		{
			continue;
		}
		...
		else if(i == 8 && GetConVarInt(ItemCosts[CostGolfclub]) < 0)
		{
			continue;
		}
		...
		else if(i == 10 && GetConVarInt(ItemCosts[CostFryingpan]) < 0)
		{
			continue;
		}
...
void BuildMiscMenu(int client)
{
	...
	if(!StrEqual(MapName, "c6m3_port", false) && GetConVarInt(ItemCosts[CostGasCan]) > -1)
	{
