...
// ---- New Flamethrower
#define FT_DESIRED_INDEX 		678
#define	FT_CLASSNAME 			"tf_weapon_flamethrower"
#define	FT_BASE_INDEX			208
#define	FT_SLOT				0
#define	FT_QUALITY				5
#define	FT_LEVEL				100
#define	FT_ATTRIBUTES			"254 ; 4.0 ; 174 ; 100.0 ; 203 ; 1"
#define	FT_AMMO				200
...
/* OnAllPluginsLoaded()
**
** When the all the plugins are loaded.
** -------------------------------------------------------------------------- */
public OnAllPluginsLoaded()
{
	if(!LibraryExists("tf2items_giveweapon")) SetFailState("Unabled to find plugin: TF2 Give Weapon");
	 ...
	 * @noreturn
	 */
	TF2Items_CreateWeapon(FT_DESIRED_INDEX, FT_CLASSNAME, FT_BASE_INDEX, FT_SLOT, FT_QUALITY, FT_LEVEL, FT_ATTRIBUTES, FT_AMMO,"",true);
...
public Action:OnPlayerInventory(Handle:hEvent, String:strEventName[], bool:bDontBroadcast)
{
	...
	TF2Items_GiveWeapon(iClient, FT_DESIRED_INDEX);
}
