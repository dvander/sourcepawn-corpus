...
public OnPluginStart()
{
	...
	hCvarBlackWhite		=	CreateConVar("ghostmode_blackwhite",	"0",	"Ghostmode is in black & white or not", FCVAR_PLUGIN, true, 0.0, true, 1.0);
...
//	SetEntProp(client, Prop_Send, "m_nSolidType", SOLID_NONE);
	...
	/* If enabled turn the screen black & white to signify we're dead */
	if (GetConVarBool(hCvarBlackWhite))
	{
