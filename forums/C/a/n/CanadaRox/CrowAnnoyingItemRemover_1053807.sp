...
{
	hClearMedkits = CreateConVar("l4d2_annoy_medkits", "1", "Remove medkits",FCVAR_NOTIFY | FCVAR_PLUGIN);
	hClearAmmo = CreateConVar("l4d2_annoy_ammo", "1", "Remove ammo upgrades",FCVAR_NOTIFY | FCVAR_PLUGIN);
	hClearChainSaws = CreateConVar("l4d2_annoy_chainsaw", "0", "Remove Chainsaws",FCVAR_NOTIFY | FCVAR_PLUGIN);
	hSafeRoomKits = CreateConVar("l4d2_annoy_saferoom", "0", "Keeps safe room first aid kits", FCVAR_NOTIFY | FCVAR_PLUGIN);
	hClearDefibs = CreateConVar("l4d2_annoy_defibs", "1", "Remove defibs",FCVAR_NOTIFY | FCVAR_PLUGIN);
	hClearWhump = CreateConVar("l4d2_annoy_launcher", "0", "Remove gernade launchers",FCVAR_NOTIFY | FCVAR_PLUGIN);
	hModEnabled = CreateConVar("l4d2_annoy_enable", "0", "Enable or disable Crow's Annoying Item Remover", FCVAR_NOTIFY | FCVAR_PLUGIN);
	hReplacePills = CreateConVar("l4d2_annoy_pill_replace", "1", "Replaces removed medkits with pills(Requires annoy_medkits 1)", FCVAR_NOTIFY | FCVAR_PLUGIN);
	hClearFire = CreateConVar("l4d2_annoy_limit_moly", "1", "Limit Moly's to director spawned only", FCVAR_NOTIFY | FCVAR_PLUGIN);
	hClearBile = CreateConVar("l4d2_annoy_limit_bile", "1", "Limit Bile Bombs to director spawned only", FCVAR_NOTIFY | FCVAR_PLUGIN);
	hClearPipe = CreateConVar("l4d2_annoy_limit_pipe", "1", "Limit Pips to director spawned only", FCVAR_NOTIFY | FCVAR_PLUGIN);
	hLimitThrows = CreateConVar("l4d2_annoy_limit_throws", "1", "Enable the limiting of throwable items to director spawned only", FCVAR_NOTIFY | FCVAR_PLUGIN);
	CreateConVar("l4d2_annoy",VERSION,"Crow's Annoying Item Remover Version",FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
