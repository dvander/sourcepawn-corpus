...
public void OnPluginStart()
{
	...
	g_cvarStrangeLevel = CreateConVar("sm_tidychat_strange_level", "1", "0/1 Tidy strange level up messages");
...
public Action UserMsg_SayText2(UserMsg msg_id, BfRead msg, const int[] players, int playersNum, bool reliable, bool init)
{
	if(g_cvarEnabled.BoolValue)
	{
		...
		if(g_engine == Engine_TF2)
		{
			...
			if(g_cvarStrangeLevel.BoolValue && strcmp(message, "#TF_HUD_Event_KillEater_Leveled_Chat") == 0)
			{
				return Plugin_Handled;
			}
		}
