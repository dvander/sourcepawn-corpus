...
public OnPluginStart()
{
	...
	if (game == GAME_CSTRIKE)
	{
		...
		RegAdminCmd("sm_cash",		Command_Cash,	ADMFLAG_UNBAN,		"Change target's cash");
	...
	RegAdminCmd("sm_bury",		Command_Bury,		ADMFLAG_CHEATS,		"Bury target");
	RegAdminCmd("sm_unbury",	Command_Unbury,		ADMFLAG_CHEATS,		"Unbury target");
	RegAdminCmd("sm_hp",		Command_HP,			ADMFLAG_CHEATS,		"Set target's health points");
	RegAdminCmd("sm_armour",	Command_Armour,		ADMFLAG_CHEATS,		"Set target's armour");
	RegAdminCmd("sm_give",		Command_Give,		ADMFLAG_CHEATS,		"Give item to target");
	RegAdminCmd("sm_speed",		Command_Speed,		ADMFLAG_CHEATS,		"Set target's speed");
	RegAdminCmd("sm_frags",		Command_Frags,		ADMFLAG_CHEATS,		"Change target's frags");
	RegAdminCmd("sm_deaths",	Command_Deaths,		ADMFLAG_CHEATS,		"Change target's deaths");
	...
	RegAdminCmd("sm_getloc",	Command_Location,	ADMFLAG_CHEATS,		"Print location");
	RegAdminCmd("sm_saveloc",	Command_SaveLoc,	ADMFLAG_CHEATS,		"Save location");
	RegAdminCmd("sm_teleport",	Command_Teleport,	ADMFLAG_CHEATS,		"Teleport target");
	RegAdminCmd("sm_blink",		Command_Blink,		ADMFLAG_CHEATS,		"Aimed teleport");
	RegAdminCmd("sm_god",		Command_God,		ADMFLAG_CHEATS,		"Set target's godmode state");
	RegAdminCmd("sm_rr",		Command_RR,			ADMFLAG_CHEATS,	"Restart round");
	RegAdminCmd("sm_extend",	Command_Extend,		ADMFLAG_CHEATS,	"Extend map");
	...
	RegAdminCmd("sm_exch",		Command_Exchange,	ADMFLAG_UNBAN,		"Exchange targets in teams");
	RegAdminCmd("sm_lexch",		Command_LExchange,	ADMFLAG_UNBAN,		"Exchange targets in teams later");
