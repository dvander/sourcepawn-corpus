...
public OnPluginStart()
{
	...
	g_hChat = CreateConVar("sm_aia_chat", "1", "Show Advanced Infinite Ammo changes in chat - 1 = Show chat to everyone - 0 = Show chat to only the person activating the command");
	...
	g_cvFriendlyInfiniteAmmo = CreateConVar(
		"sm_aia_friendly",
		"1", "Automatically give infinite ammo for friendly players. 0 = disabled | 1 = enabled",
...
GiveInfiniteAmmo(client, iWeapon)
{
	...
	switch(iWeaponIndex)
	{
		...
		case 9,10,11,12,13,16,17,18,19,20,22,23,24,36,45,61,127,130,160,161,
			...
			964,965,971,973,974,996,997,1006,1007,1103:
		{
		...
		case 21,39,40,42,56,58,159,208,215,222,305,1079,311,351,433,659,740,741,798,799,
			807,812,833,863,887,896,905,914,963,972,1002,1005,1092,1105,1121:
		{
