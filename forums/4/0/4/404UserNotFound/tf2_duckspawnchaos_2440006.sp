 ...
 * vim: set ts=4 :
 * =============================================================================
 * [TF2] Spawn Bonus Ducks CHAOS EDITION
 * Allows anyone to spawn bonus ducks.
 *
 * [TF2] Spawn Bonus Ducks CHAOS EDITION (C)2016 404: User Not Found (UNF Gaming).
 * All rights reserved.
 *
...
#define PLUGIN_VERSION "1.1: CHAOS"

float g_fPosition[3];

public Plugin myinfo = {
	name			= "[TF2] Spawn Bonus Ducks: CHAOS EDITION",
	author			= "404: User Not Found",
	description		= "Allows anyone to spawn bonus ducks.",
...
{
	CreateConVar("sm_spawnbonusducks_version", PLUGIN_VERSION, "[TF2] Spawn Bonus Ducks CHAOS EDITION version", FCVAR_SPONLY|FCVAR_NOTIFY|FCVAR_DONTRECORD);
	
	RegConsoleCmd("sm_quack", Command_Quack, "Usage: sm_quack <target> <# of ducks> <is quackston? (0/1 = no/yes)> (will spawn a set amount ducks where the target is standing)");
	RegConsoleCmd("sm_aimquack", Command_AimQuack, "Usage: sm_quack <target> <# of ducks> <is quackston? (0/1 = no/yes)> (will spawn a set amount ducks where you are aiming)");
	RegConsoleCmd("sm_unquack", Command_UnQuack, "Usage: sm_unqauck");
