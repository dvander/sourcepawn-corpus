...
public void OnPluginStart()
{
	...
	Uleczenie = CreateConVar("vip_ilosc_uleczen", "2", "Iloז uleczeס VIP'a.", FCVAR_NOTIFY);
	Leczenie_HP = CreateConVar("vip_hp_uleczenie", "10", "Iloז HP po ile ma leczyז.", FCVAR_NOTIFY);
	Reklama = CreateConVar("vip_reklama", "1", "Czy ma byז w³¹czona reklama kto zrobi³ VIP'a co 2min? Za w³¹czon¹ dziekuje :)", FCVAR_NOTIFY, true, 0.0, true, 1.0);
