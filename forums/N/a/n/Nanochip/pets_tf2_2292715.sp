...
new Handle:cPetType;
new Handle:cPetName;
new Handle:cPetColor;
new Handle:cPetHappiness;
new Handle:cPetSkin;
...
new Handle:MoodEffects = INVALID_HANDLE;
...
public OnPluginStart() 
{
	...
	CreateConVar("pets_version", "1.185", "- Do Not Touch!", FCVAR_PLUGIN|FCVAR_NOTIFY|FCVAR_REPLICATED)
...
KillPet(client, bool:force=false)
{
