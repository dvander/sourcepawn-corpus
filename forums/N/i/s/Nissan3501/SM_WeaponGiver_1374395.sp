...
public Action:ConsoleCmd(client, args)
{
	...
	SetMenuTitle(menu, "[SM] WeaponGiver");
	AddMenuItem(menu, "Pistols", "Пистолеты");
	AddMenuItem(menu, "Shotguns", "Дробовики");
	AddMenuItem(menu, "Sub-Machineguns", "Пистолеты-пулемёты");
	AddMenuItem(menu, "Rifles", "Винтовки");
	AddMenuItem(menu, "Machineguns", "Пулемёты");
	AddMenuItem(menu, "Misc Items", "Прочее");
...
public MenuHandler1(Handle:menu, MenuAction:action, client, param2)
{
	if (action == MenuAction_Select)
	{
		...
		if(strcmp(info, "Pistols") == 0)
		{
			...
			SetMenuTitle(menupistol, "[SM] WeaponGiver- Пистолеты");
		...
		if(strcmp(info, "Shotguns") == 0)
        {
			...
			SetMenuTitle(menushotgun, "[SM] WeaponGiver- Дробовики");
		...
		if(strcmp(info, "Sub-Machineguns") == 0)
		{
			...
			SetMenuTitle(menusmg, "[SM] WeaponGiver- П-Пулемёты");
		...
		if(strcmp(info, "Rifles") == 0)
		{
			...
			SetMenuTitle(menurifle, "[SM] WeaponGiver- Винтовки");
		...
		if(strcmp(info, "Machineguns") == 0)
		{
			...
			SetMenuTitle(menumg, "[SM] WeaponGiver- Пулемёты");
			AddMenuItem(menumg, "Пулемёт", "Machinegun");
		...
		if(strcmp(info, "Misc Items") == 0)
		{
			...
			SetMenuTitle(menumisc, "[SM] WeaponGiver- Прочее");
			AddMenuItem(menumisc, "Нож", "Knife");
			AddMenuItem(menumisc, "Граната", "Grenade");
			AddMenuItem(menumisc, "Ослепляющая граната", "Flashbang");
			AddMenuItem(menumisc, "Дымовая граната", "Smoke Grenade");
			AddMenuItem(menumisc, "Броня", "Kevlar");
			AddMenuItem(menumisc, "Броня + Шлем", "Kevlar + Helmet");
			AddMenuItem(menumisc, "Бомба", "C4 Bomb");
