...
public Action Command_Menu(int client, int args)
{
	...
	{
		ReplyToCommand(client, "You must be alive to use this!");
		return Plugin_Handled;
	}
...
public Action CreateEmote(int client, const char[] anim1, const char[] anim2, const char[] soundName, bool isLooped)
{
	...
	{
		ReplyToCommand(client, "You must be on the ground to use this!");
		return Plugin_Handled;
	}

	if (g_bEmoteCooldown[client])
	{
		ReplyToCommand(client, "Emotes are on a cooldown!");
		return Plugin_Handled;
	}

	if (StrEqual(anim1, ""))
	{
		ReplyToCommand(client, "Invalid Command");
		return Plugin_Handled;
	}
...
public Action Menu_Dance(int client)
{
	...
	menu.AddItem("9", "Blow kiss");
	menu.AddItem("10", "Boogie");
	menu.AddItem("11", "Come To Me");
	menu.AddItem("12", "Capoeira");
	menu.AddItem("13", "Calculated");
	menu.AddItem("14", "Celebration");
	menu.AddItem("15", "Flapper");
	menu.AddItem("16", "Confused");
	menu.AddItem("17", "Chicken");
	menu.AddItem("18", "Chug");
	menu.AddItem("19", "Waterworks");
	menu.AddItem("20", "Boneless");
	menu.AddItem("21", "Shoot");
	menu.AddItem("22", "Shake It Up");
	menu.AddItem("23", "Disco Fever");
	menu.AddItem("24", "The Worm");
	menu.AddItem("25", "Take The L");
	menu.AddItem("26", "BreakDance");
	menu.AddItem("27", "Pump");
	menu.AddItem("28", "Ride The Pony");
	menu.AddItem("29", "Dab");
	menu.AddItem("30", "Disco Fever 2");
	menu.AddItem("31", "Band of the fort"); 
	menu.AddItem("32", "Shake It Up 2"); //
	menu.AddItem("33", "Eanster Bloc");
	menu.AddItem("34", "Dream Feet"); 
	menu.AddItem("35", "Facepalm");
	menu.AddItem("36", "On the Hook");
	menu.AddItem("37", "Flex");
	menu.AddItem("38", "Floss");
	menu.AddItem("39", "Finger Guns 2");
	menu.AddItem("40", "Flippn Sexy");
	menu.AddItem("41", "Fresh");
	menu.AddItem("42", "Grefg");
	menu.AddItem("43", "Golf Clap");
	menu.AddItem("44", "Rock!");
	menu.AddItem("45", "Hand Signals");
	menu.AddItem("46", "Click!");
	menu.AddItem("47", "Shuffle");
	menu.AddItem("48", "Hip Hop");
	menu.AddItem("49", "Hot Stuff");
	menu.AddItem("50", "Hula Hop");
	menu.AddItem("51", "Breaking Point");
	menu.AddItem("52", "Infinite Dab");
	menu.AddItem("53", "True Love");
	menu.AddItem("54", "Intensity");
	menu.AddItem("55", "Irish Jig");
	menu.AddItem("56", "Korean Eagle");
	menu.AddItem("57", "Kpop");
	menu.AddItem("58", "Kung-Fu Salute");
	menu.AddItem("59", "Laugh");
	menu.AddItem("60", "Living Large");
	menu.AddItem("61", "Luchador");
	menu.AddItem("62", "Maracas");
	menu.AddItem("63", "Make it Rain");
	menu.AddItem("64", "No hoy");
	menu.AddItem("65", "Pop Lock");
	menu.AddItem("66", "Pop Rock");
	menu.AddItem("67", "Paper");
	menu.AddItem("68", "Rock");
	menu.AddItem("69", "Scissors");
	menu.AddItem("70", "Robot");
	menu.AddItem("71", "Salt");
	menu.AddItem("72", "Saltue");
	menu.AddItem("73", "420");
	menu.AddItem("74", "Snap");
	menu.AddItem("75", "Stage Bow");
	menu.AddItem("76", "T-Rex");
	menu.AddItem("77", "Electro Swing");
	menu.AddItem("78", "Thumbs Down");
	menu.AddItem("79", "Thumbs Up");
	menu.AddItem("80", "Twist");
	menu.AddItem("81", "Ware House");
	menu.AddItem("82", "Wiggle");
	menu.AddItem("83", "Salute 2");
	menu.AddItem("84", "Yeet");
	menu.AddItem("85", "You're Awesome");
