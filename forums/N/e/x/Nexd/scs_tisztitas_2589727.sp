...
public void OnPluginStart()
{
	...
	g_cvarChangeClass = CreateConVar("sm_tidychat_class", "0", "0/1 Tidy class change messages");
	g_cvarTeam = CreateConVar("sm_tidychat_team", "1", "0/1 Tidy team join messages");
	g_cvarArenaResize = CreateConVar("sm_tidychat_arena_resize", "0", "0/1 Tidy arena team resize messages");
	g_cvarArenaMaxStreak = CreateConVar("sm_tidychat_arena_maxstreak", "0", "0/1 Tidy (arena) team scramble messages");
