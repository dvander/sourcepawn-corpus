...
{ 
	"!r", "!br", "!wr", "!usp", "!glock", "!scout", "!admin", "!menu", "!tpto", "!cp", "!hud", "!lj", "!ljbeam", "!top", "!stop", "!start", "!pause", "!resume", "!b", "!style", "!admin", "!spec", "!timer", "!restart", "stage", "!bonusstart", "!hide", "!block", "!rank", "!mtop", "!btop", "!mbtop", "!points", "!ranks", "!speclist", "!specfar", "!georank", "!credits", "!autobhop"
}
