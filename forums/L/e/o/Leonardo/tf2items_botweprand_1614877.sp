...
#define DEFINED_MAX_ITEMS_PER_CLASS	64
...
new TFHoliday:g_nHoliday = TFHoliday_None;
#endif
...
#else
				Format(sMemoryItems[iClient], DEFINED_MAX_ITEMS_PER_CLASS*DEFINED_MAX_ITEMS_STRING_L-1, "%i,%i,%i,%i,-1,-1,-1", GetRandomItem(iClass, TF2ItemSlot_Primary), GetRandomItem(iClass, TF2ItemSlot_Secondary), GetRandomItem(iClass, TF2ItemSlot_Melee), GetRandomItem(iClass, TF2ItemSlot_PDA1));
#endif
			}
			else
...
#else
	Format(sMemoryItems[iClient], DEFINED_MAX_ITEMS_PER_CLASS*DEFINED_MAX_ITEMS_STRING_L-1, "%i,%i,%i,%i,-1,-1,-1", iDefIndex[TF2ItemSlot_Primary], iDefIndex[TF2ItemSlot_Secondary], iDefIndex[TF2ItemSlot_Melee], iDefIndex[TF2ItemSlot_PDA1]);
#endif
...
GetRandomItem(&TFClassType:iClass, iSlot)
{
	...
	if(!(iSlot!=TF2ItemSlot_PDA1 || iSlot==TF2ItemSlot_PDA1 && iClass==TFClass_Spy)) return -1;
