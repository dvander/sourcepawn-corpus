...
new const Float:g_fMinS[3] = {-10.0, -10.0, -10.0};
...
public Plugin:myinfo = {
	...
	author = "meng",
	version = VERSION,
	description = "Throwing knives for CSGO",
...
public APLRes:AskPluginLoad2(Handle:myself, bool:late, String:error[], err_max) {
	...
	RegPluginLibrary("csgo_throwingknives");
	return APLRes_Success;
}

public OnPluginStart() {

	CreateConVar("sm_csgo_throwingknives", VERSION, NAME, FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
	...
	g_CVarKnives = CreateConVar("sm_throwingknives_count", "3", "Amount of knives players spawn with.");
...
ThrowKnife(client)
{
	...
	if ((entity != -1) && DispatchSpawn(entity)) {
		CreateTimer(1.5, RemoveGrenade, entity);
		...
		PrintToChat(client, "%f %f %f", fAng[0], fAng[1], fAng[2]);
...
public Action:RemoveGrenade(Handle:Timer, any:entity)
{
