...
#define PLUGIN_VERSION 		"2.15.1fork"
...
2.15fork (16-Feb-2023)
	- Fix issues when used with the "l4d2_RealismFLashlight" plugin: glare may still appear when torch is disabled.
