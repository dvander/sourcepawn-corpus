...
// ====================================================================================================
Change Log:
1.0.3 (05-November-2022)
    - Fix my stupid mistake.(Iciaria)

1.0.2 (29-October-2022)
    - Fix the problem that survivors can't be saved when they suffocate in the water.
...
#define PLUGIN_AUTHOR                 "Mart & Psyk0tik & Iciaria"
...
//
//------------Damage caused by suffocation in water-----------||
//
    int attacker = event.GetInt("attacker");
    int type = event.GetInt("type");
    if ( (dmg_health == 3 ||dmg_health == 4 ||dmg_health == 5) && attacker == 0 && type == 16384 )
	return;
