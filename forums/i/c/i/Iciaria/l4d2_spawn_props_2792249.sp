...
void SaveRoutingPath(int client, int type)
{
	...
	if(!Exists)
	{
		...
		file.WriteLine("	");
		file.WriteLine("	\"OnMapSpawn\" \"easy_route_blocker
                                                                           isable\"");
		file.WriteLine("	\"OnMapSpawn\" \"easy_route_blocker
                                                                           isableCollision\"");
		file.WriteLine("	\"OnMapSpawn\" \"medium_route_blocker
                                                                             isable\"");
		file.WriteLine("	\"OnMapSpawn\" \"medium_route_blocker
                                                                             isableCollision\"");
		file.WriteLine("	\"OnMapSpawn\" \"hard_route_blocker
                                                                           isable\"");
		file.WriteLine("	\"OnMapSpawn\" \"hard_route_blocker
                                                                           isableCollision\"");
		file.WriteLine("}");
		...
		file.WriteLine("	\"classname\" \"logic_relay\"");
		file.WriteLine("	\"OnTrigger\" \"easy_route_blocker
nable\"");
		file.WriteLine("	\"OnTrigger\" \"easy_route_blocker
nableCollision\"");
		file.WriteLine("}");
		...
		file.WriteLine("	\"spawnflags\" \"0\"");
		file.WriteLine("	\"classname\" \"logic_relay\"");
		file.WriteLine("	\"OnTrigger\" \"medium_route_blocker
nable\"");
		file.WriteLine("	\"OnTrigger\" \"medium_route_blocker
nableCollision\"");
		file.WriteLine("}");
		...
		file.WriteLine("	\"spawnflags\" \"0\"");
		file.WriteLine("	\"classname\" \"logic_relay\"");
		file.WriteLine("	\"OnTrigger\" \"hard_route_blocker
nable\"");
		file.WriteLine("	\"OnTrigger\" \"hard_route_blocker
nableCollision\"");
		file.WriteLine("}");
