...
public void OnPluginStart()
{
	...
	if (g_bIsSequel)
	{
		...
		hTempCvar = CreateConVar("sm_"...PLUGIN_NAME_TECH..."_dual_drop", "1", "Toggle whether players should drop their extra pistol upon death.", FCVAR_NONE, true, 0.0, true, 1.0);
