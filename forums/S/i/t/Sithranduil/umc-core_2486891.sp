...
UMC_BuildOptionsError:BuildMapVoteItems(Handle:voteManager, Handle:result, Handle:okv, 
                                        ...
                                        bool:dontChange, String:cat[255], bool:ignoreDupes=false, 
                                        ...
                                        bool:exclude=true)
{
    ...
    do
    {
        ...
        if(!StrEqual(cat, catName) || StrEqual(cat, ""))
        	continue;
...
bool:GetRandomMap(Handle:kv, String:buffer[], size)
{
    ...
    DEBUG_MESSAGE("Preparing mapcycle for random map selection of %s.", catName)
    //Return failure if...
...
public Action:Handle_TieredVoteTimer(Handle:timer, Handle:pack)
{
    ...
    new String:cat[255]="";
    ReadPackString(pack, cat, sizeof(cat));
    DEBUG_MESSAGE("SEND TO TIMER : %i %i %s", vM, tieredKV, cat)
    //Log a message
