...
public OnPluginStart()
{
	...
	CreateConVar("sm_dod_fireworks", PLUGIN_VERSION, "", FCVAR_PLUGIN | FCVAR_REPLICATED | FCVAR_NOTIFY);
	g_hFireworksTimeout = CreateConVar("sm_fireworks_timeout","60.0", "Fireworks running seconds", FCVAR_PLUGIN);
	g_hFireworksSound = CreateConVar("sm_fireworks_sound","1", "Fireworks sounds (0/1)", FCVAR_PLUGIN);
	g_hFireworksRoundend = CreateConVar("sm_fireworks_roundend","1", "Fireworks at round end (0/1)", FCVAR_PLUGIN);
