...
public void OnPluginStart()
{
	...
	g_cvarMode = CreateConVar("sm_keeplasers_mode", "0", "0: Swap laser sights if you drop a gun which had them while picking up a int one\n1: Keep laser sights if you ever had them\n2: Always have laser sights.", FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);
...
public Action Event_PlayerUse(Event event, const char[] name, bool dontBroadcast)
{
	...
	if (strncmp(Item, "weapon", 6) == 0 && isLaserWeapon(Item))
	{
...
bool isLaserWeapon(char[] Weapon)
{
