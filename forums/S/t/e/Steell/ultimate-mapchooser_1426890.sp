...
// Update nomination display cvar to optionally hide nominations which dont suit current player limits.
//
//TESTING:
                        ...
                        bool:ignoreTimeLimits=false)
{
    ...
    AddArrayToMenu(menu, map_vote, map_vote_display);
                       ...
                       const item_info[][2], VoteHandler:callback, Handle:clientArray)
{
    ...
    for (new i = 0; i < num_items; i++)
    {
        ...
        if (FindValueInArray(removedItems, item) == -1)
        {
            ...
            //LogMessage("DEBUG: Adding %s into the runoff vote.");
