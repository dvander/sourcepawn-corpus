...
//Modified by Steell to make autoupdating optional.
...
{				
	...
	//Added by Steell
	cvarAutoUpdate = CreateConVar("hale_autoupdate", "1", "Enables/disbales auto updating of VS Saxton Hale Mod.", FCVAR_PLUGIN, true, 0.0, true, 1.0);
...
{
    //Added by Steell
    if (!GetConVarBool(cvarAutoUpdate))
        return;
