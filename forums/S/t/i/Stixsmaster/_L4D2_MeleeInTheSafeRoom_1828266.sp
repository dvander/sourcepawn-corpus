...
public OnPluginStart()
{
	...
	g_hWeaponKitchen			= CreateConVar( "l4d2_MITSR_Kitchen",		"1", "Number of kitchens to spawn (l4d2_MITSR_Random must be 0)", FCVAR_PLUGIN );
	g_hWeaponPot			= CreateConVar( "l4d2_MITSR_Pot",		"1", "Number of pots to spawn (l4d2_MITSR_Random must be 0)", FCVAR_PLUGIN );
