...
public OnMapStart()
{
	...
	if( GetConVarInt(Logging) > 0 )
	{
		...
		if( !FileExists( LogFileLoc ) )
		{
			...
			LogMessage( "%s %t", LogFile, "Sound_File Not Found" );
			BuildPath( Path_SM,Path, sizeof( Path ), LogFileLoc );
			LogMessage( "%s has been created!", Path );
			
			new Handle:Sound_File = OpenFile( Path, "a" );
			WriteFileLine( Sound_File,"[%s] %t", Time, "Log Started" );
...
public OnPluginStart()
{
	...
	SoundFile	=	CreateConVar( "cd_sound_file",	"buttons/blip1.wav","Sound Sound_File location to be played on a connect/disconnect under the sounds directory (Def =buttons/blip1.wav)" );
	Logging		=	CreateConVar( "cd_loggin",	"1",	"turns on and off logging of connects and disconnect to a log Sound_File 1= on  2 = on only log annoucers 0 = off (Def 1)" );
	LogFile		=	CreateConVar( "cd_logfile",	"data/cd_logs.log", "location of the log Sound_File relative to the sourcemod folder" );
}
public OnClientPostAdminCheck( client ){
	...
	decl String:gIp[36], String:gAuth[21], String:gCountry[3];
	...
	GetClientAuthId( client, AuthId_Steam3, gAuth, sizeof( gAuth ) );
	...
	new Handle:Sound_File = OpenFile( LogFileLoc, "a" );
	if( Sound_File == INVALID_HANDLE && Log > 0 )
	{
		LogError( "%t", "Sound_File Not Created" );
		return;
	}
				...
				case 0:
				{
					switch( Log )
					{
						...
						case 1:
						{
							...
							WriteFileLine( Sound_File,"[%s] %s[%s] connected", Time, gName, gAuth );
						}
						case 2: WriteFileLine( Sound_File,"[%s] %s[%s] connected", Time, gName, gAuth );
					}
				}
				case 1: 
				{
					switch( Log )
					{
						...
						case 1:
						{
							...
							WriteFileLine( Sound_File,"[%s] %s(%s)[%s] connected", Time, gName, gCountry, gAuth );
						}
						case 2:	WriteFileLine( Sound_File,"[%s] %s(%s)[%s] connected", Time, gName, gCountry, gAuth );
					}
				}
			}	
		}
				...
				case 0: 
				{
					switch( Log )
					{
						...
						case 1: 
						{
							...
							WriteFileLine( Sound_File,"[%s] %s[%s] connected", Time, gName, gIp );
						}
						case 2: WriteFileLine( Sound_File,"[%s] %s[%s] connected", Time, gName, gIp );
					}					
				}
				case 1: 
				{
					switch( Log )
					{
						...
						case 1:
						{
							...
							WriteFileLine( Sound_File,"[%s] %s(%s)[%s] connected", Time, gName, gCountry, gIp );
						}
						case 2:	WriteFileLine( Sound_File,"[%s] %s(%s)[%s] connected", Time, gName, gCountry, gIp );
					}
				}
			}	
		}
				...
				case 0: 
				{
					switch( Log )
					{
						...
						case 1:
						{
							...
							WriteFileLine( Sound_File,"[%s] %s[%s][%s] connected", Time, gName, gAuth, gIp );
						}
						case 2:	WriteFileLine( Sound_File,"[%s] %s[%s][%s] connected", Time, gName, gAuth, gIp );
					}
				}
				case 1: 
				{
					switch( Log )
					{
						...
						case 1:
						{
							...
							WriteFileLine( Sound_File,"[%s] %s(%s)[%s][%s] connected", Time, gName, gCountry, gAuth, gIp );
						}
						case 2:	WriteFileLine( Sound_File,"[%s] %s(%s)[%s][%s] connected", Time, gName, gCountry, gAuth, gIp );
					}						
				}
			}
		}
				...
				case 0:
				{
					switch( Log )
					{
						...
						case 1:
						{
							...
							WriteFileLine( Sound_File,"[%s] %s[%s] disconnected", Time, gName, gAuth );
						}
						case 2: WriteFileLine( Sound_File,"[%s] %s[%s] disconnected", Time, gName, gAuth );
					}
				}
				case 1: 
				{
					switch( Log )
					{
						...
						case 1:
						{
							...
							WriteFileLine( Sound_File,"[%s] %s(%s)[%s] disconnected", Time, gName, gCountry, gAuth );
						}
						case 2:	WriteFileLine( Sound_File,"[%s] %s(%s)[%s] disconnected", Time, gName, gCountry, gAuth );
					}
				}
			}	
		}
				...
				case 0: 
				{
					switch( Log )
					{
						...
						case 1: 
						{
							...
							WriteFileLine( Sound_File,"[%s] %s[%s] disconnected", Time, gName, gIp );
						}
						case 2: WriteFileLine( Sound_File,"[%s] %s[%s] disconnected", Time, gName, gIp );
					}					
				}
				case 1: 
				{
					switch( Log )
					{
						...
						case 1:
						{
							...
							WriteFileLine( Sound_File,"[%s] %s(%s)[%s] disconnected", Time, gName, gCountry, gIp );
						}
						case 2:	WriteFileLine( Sound_File,"[%s] %s(%s)[%s] disconnected", Time, gName, gCountry, gIp );
					}
				}
			}	
		}
				...
				case 0: 
				{
					switch( Log )
					{
						...
						case 1:
						{
							...
							WriteFileLine( Sound_File,"[%s] %s[%s][%s] disconnected", Time, gName, gAuth, gIp );
						}
						case 2:	WriteFileLine( Sound_File,"[%s] %s[%s][%s] disconnected", Time, gName, gAuth, gIp );
					}
				}
				case 1: 
				{
					switch( Log )
					{
						...
						case 1:
						{
							...
							WriteFileLine( Sound_File,"[%s] %s(%s)[%s][%s] disconnected", Time, gName, gCountry, gAuth, gIp );
						}
						case 2:	WriteFileLine( Sound_File,"[%s] %s(%s)[%s][%s] disconnected", Time, gName, gCountry, gAuth, gIp );
					}						
				}
			}
		}
