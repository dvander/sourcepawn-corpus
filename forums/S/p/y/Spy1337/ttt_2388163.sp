...
public void OnPluginStart()
{
	...
	g_iConfig[i_requiredPlayers] = Config_LoadInt("ttt_required_player", 1, "The amount of players required to start the game.");
	...
	g_iConfig[i_rulesClosePunishment] = Config_LoadInt("ttt_rules_close_punishment", 1, "The punishment for abusing the rules menu by closing it with another menu. 0 = Kick, Anything Else = Do Nothing");
