...
public OnPluginStart()
{
	...
	CreateTimer(30.0, RoundStartDelay); //der lange delay muss sein, damit dieses plugin, nachdem es geladen wurde, noch rechtzeitig vom aufrufenden Plugin ent- und geladen werden kann.
}
