...
public OnPluginStart()
{
	...
	hSpawnWeights[SI_TANK] = CreateConVar("l4d2_ais_tank_weight", "10", "[-1 = Director spawns tanks] The weight for a tank spawning", FCVAR_PLUGIN, true, -1.0);
	...
	hSpawnLimits[SI_BOOMER] = CreateConVar("l4d2_ais_boomer_limit", "4", "The max amount of boomers present at once", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	...
	hSpawnLimits[SI_SMOKER] = CreateConVar("l4d2_ais_smoker_limit", "4", "The max amount of smokers present at once", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	...
	hSpawnLimits[SI_CHARGER] = CreateConVar("l4d2_ais_charger_limit", "4", "The max amount of chargers present at once", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_JOCKEY] = CreateConVar("l4d2_ais_jockey_limit", "4", "The max amount of jockeys present at once", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_SPITTER] = CreateConVar("l4d2_ais_spitter_limit", "4", "The max amount of spitters present at once", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	...
	hWitchLimit = CreateConVar("l4d2_ais_witch_limit", "6", "[-1 = Director spawns witches] The max amount of witches present at once (independant of l4d2_ais_limit).", FCVAR_PLUGIN, true, -1.0, true, 100.0);
	...
	hSILimit = CreateConVar("l4d2_ais_limit", "4", "The max amount of special infected at once", FCVAR_PLUGIN, true, 1.0, true, float(MAX_INFECTED));
