...
public Action Cmd_Tauntem_List(int client, int args)
{
	...
	PrintToConsole(client, "-1157: Kazotsky Kick");
	PrintToConsole(client, "-1162: Mannrobics");
	PrintToConsole(client, "-1168: The Carlton");
	PrintToConsole(client, "-30570: Pool Party Taunt");
	PrintToConsole(client, "-30572: The Boston Breakdance");
	PrintToConsole(client, "-30609: The Killer Solo");
	PrintToConsole(client, "-30614: Most Wanted");
	PrintToConsole(client, "-30615: The Boxtrot");
	PrintToConsole(client, "-30616: Proletariat Showoff");
	PrintToConsole(client, "-30618: Bucking Bronco");
	PrintToConsole(client, "-30621: Burstchester");
	PrintToConsole(client, "-30671: Bad Pipes");
	PrintToConsole(client, "-30672: Zoomin Broom");
	PrintToConsole(client, "-30673: Soldier Requiem");
	PrintToConsole(client, "-30761: Fubar Fanfare");
	PrintToConsole(client, "-30762: Disco Fever");
	PrintToConsole(client, "-30763: Balloonibouncer");
