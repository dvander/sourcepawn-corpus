...
public OnPluginStart() 
{
	...
	// commands
	RegAdminCmd("+grab", Command_Grab, ADMFLAG_CUSTOM1);
	RegAdminCmd("-grab", Command_UnGrab2, ADMFLAG_CUSTOM1);
	RegAdminCmd("+throw", Command_Throw, ADMFLAG_CUSTOM1);
	RegAdminCmd("-throw", Command_UnThrow, ADMFLAG_CUSTOM1);
	
	RegAadminCmd("invprev", Command_MoveFar, ADMFLAG_CUSTOM1);
	RegAdminCmd("invnext", Command_MoveNear, ADMFLAG_CUSTOM1);
}
