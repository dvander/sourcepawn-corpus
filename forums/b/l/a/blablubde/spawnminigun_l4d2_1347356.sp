/*
spawnminigun_l4d2.smx or spawnminigun_l4d2.sp
...
Versions:
	2.0 (spawnminigun_l4d2.smx) [author: Drakexz]
		Reworked the plugin. 
...
public Action:MiniGunRotate(client, args)
{
	...
	if(!StrEqual(Classname, "prop_minigun_l4d1"))
	{
...
public Action:SpawnMiniGunL4D1(client, args)
{
	...
	new index = CreateEntityByName ( "prop_minigun_l4d1");
