...
public OnMapStart()
{
	...
	if (GetConVarInt(DebugEvent) == 1)	
        ...
        CreateTimer(3.0, CheckGameMode, TIMER_FLAG_NO_MAPCHANGE);
}
...
public Action:CheckGameMode(Handle:timer)
{
       ...
       if (StrEqual(gamemode, "coop") || StrEqual(gamemode, "mutation7") || StrEqual(gamemode, "mutation3") || StrEqual(gamemode, "mutation9"))
       {
...
public OnCVGameModeChange(Handle:convar, const String:oldValue[], const String:newValue[])
{
	...
	if (strcmp(oldValue, newValue) != 0 && (l4d_gamemode() == 1 || l4d_gamemode() == 2 || l4d_gamemode() == 3 || l4d_gamemode() == 4 || l4d_gamemode() == 5 || l4d_gamemode() == 6 || l4d_gamemode() == 7 || l4d_gamemode() == 8))
	{
		HookEvent("round_end", Event_RoundEnd);
		HookEvent("finale_win", Event_FinalWin);
		HookEvent("mission_lost", Event_FinalLost);
