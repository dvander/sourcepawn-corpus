...
{
    if(StrEqual(sArgs, "!wskins", false) || StrEqual(sArgs, "!wskin", false) || StrEqual(sArgs, "!ws", false) || StrEqual(sArgs, "!skin", false) || StrEqual(sArgs, "!skins", false) || StrEqual(sArgs, "!paints", false))
	{
