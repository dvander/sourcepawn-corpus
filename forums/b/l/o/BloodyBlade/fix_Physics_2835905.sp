...
bool g_bCvarBarrowFix = false, g_bAllowHook = false;
float g_fCvarTimer = 0.0, vOrigin[3], vAngeles[3];
char sTemp[64];
...
public void OnPluginStart()
{
	...
	g_hCvarBarrowFix = CreateConVar("physics_barrow", "0", "WheelBarrow Fix: 1: Enable, 0: Disable", CVAR_FLAGS, true, 0.0, true, 1.0);
	g_hCvarTimer = CreateConVar("physics_timer", "0.01", "Time interval when the fix is triggered after oxygentank/fireworkcrate/propanetank created, 0.0: Disable Physics Fix", CVAR_FLAGS, true, 0.0, true, 2.0);
