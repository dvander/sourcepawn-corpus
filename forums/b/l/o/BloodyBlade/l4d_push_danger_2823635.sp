...
public void OnPluginStart()
{
	...
	CreateConVar("l4d_push_danger_version",				PLUGIN_VERSION,		  "Push Away From Danger plugin version.", CVAR_FLAGS|FCVAR_DONTRECORD);
	...
	g_hCvarDamageTypes.AddChangeHook(ConVarChanged_Cvars);
...
//				PrintToChatAll("%d %d",fake,g_iCvarTypes);
			...
			if((g_iCvarDamageTypes == 1 && (damagetype == 263168 || damagetype == 265216) && (g_bLeft4Dead2 && strcmp(classname, "insect_swarm") == 0)) 
			|| (g_iCvarDamageTypes == 2 && ((damagetype & DMG_BURN) && (strcmp(classname, "inferno") == 0)))
			|| (g_iCvarDamageTypes == 3 && (((damagetype == 263168 || damagetype == 265216) && (g_bLeft4Dead2 && strcmp(classname, "insect_swarm") == 0)) || (damagetype & DMG_BURN && strcmp(classname, "inferno") == 0))))
			{
