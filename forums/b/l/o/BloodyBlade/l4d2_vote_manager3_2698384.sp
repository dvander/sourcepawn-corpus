...
*/
public Action VotePass(UserMsg msg_id, Handle bf, const players[], int playersNum, bool reliable, bool init)
{
...
byte	team
*/
public Action VoteFail(UserMsg msg_id, Handle bf, const players[], int playersNum, bool reliable, bool init)
{
