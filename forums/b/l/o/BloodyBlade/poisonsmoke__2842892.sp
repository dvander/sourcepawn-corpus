...
ConVar g_hCVDamage, g_hCVSeconds, g_hCVColorT, g_hCVColorCT, g_hCVTeam;
...
Action Timer_CheckDamage(Handle timer, any entityref)
{
	...
	{
		if(IsClientInGame(i) && IsPlayerAlive(i) && ((iGrenadeTeam == CS_TEAM_T && GetClientTeam(i) > 1) || (iGrenadeTeam != CS_TEAM_T && GetClientTeam(i) != iGrenadeTeam)))
		{
