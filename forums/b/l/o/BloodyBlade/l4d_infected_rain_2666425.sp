...
ConVar l4d_rain_enable,              l4d_spawn_enable; 
ConVar l4d_rain_mininterval,         l4d_rain_maxinterval,           l4d_rain_duration,             l4d_rain_intervual;
ConVar l4d_rain_chance_tankdead,     l4d_rain_chance_witchdead,      l4d_rain_chance_witch_harasser;
ConVar l4d_spawn_chance_tankrock,    l4d_spawn_mincount_tankrock,    l4d_spawn_maxcount_tankrock ;
ConVar l4d_spawn_chance_spitteracid, l4d_spawn_mincount_spitteracid, l4d_spawn_maxcount_spitteracid;
ConVar l4d_spawn_chance_boomervomit, l4d_spawn_chance_boomerdead,    l4d_spawn_mincount_boomerdead, l4d_spawn_maxcount_boomerdead;
ConVar l4d_spawn_chance_spitterdead, l4d_spawn_mincount_spitterdead, l4d_spawn_maxcount_spitterdead;
ConVar l4d_spawn_chance_tankdead,    l4d_spawn_mincount_tankdead,    l4d_spawn_maxcount_tankdead;
...
{
	l4d_rain_enable                = CreateConVar("l4d_rain_enable", "1", "{0,1}"); 
	l4d_spawn_enable               = CreateConVar("l4d_spawn_enable", "1", "{0,1}"); 
	
	l4d_rain_mininterval           = CreateConVar("l4d_rain_mininterval", "150", "[200, maxinterval]seconds"); 
	l4d_rain_maxinterval           = CreateConVar("l4d_rain_maxinterval", "300", "[200, 600]seconds");	
	l4d_rain_duration              = CreateConVar("l4d_rain_duration", "15.0", "");	
	l4d_rain_intervual             = CreateConVar("l4d_rain_intervual", "0.3", "");	
	
	l4d_rain_chance_tankdead       = CreateConVar("l4d_rain_chance_tankdead", "50", "0 - 100%"); 
	l4d_rain_chance_witchdead      = CreateConVar("l4d_rain_chance_witchdead", "50", ""); 	
	l4d_rain_chance_witch_harasser = CreateConVar("l4d_rain_chance_witch_harasser", "20", ""); 	
	
	l4d_spawn_chance_tankrock      = CreateConVar("l4d_spawn_chance_tankrock", "60", "");
	l4d_spawn_mincount_tankrock    = CreateConVar("l4d_spawn_mincount_tankrock", "5", "");
	l4d_spawn_maxcount_tankrock    = CreateConVar("l4d_spawn_maxcount_tankrock", "12", "");
	
	l4d_spawn_chance_spitteracid   = CreateConVar("l4d_spawn_chance_spitteracid", "80", "");
	l4d_spawn_mincount_spitteracid = CreateConVar("l4d_spawn_mincount_spitteracid", "8", "");
	l4d_spawn_maxcount_spitteracid = CreateConVar("l4d_spawn_maxcount_spitteracid", "16", "");
	
	l4d_spawn_chance_boomervomit   = CreateConVar("l4d_spawn_chance_boomervomit", "70", ""); 
	
	l4d_spawn_chance_boomerdead    = CreateConVar("l4d_spawn_chance_boomerdead", "70", "");
	l4d_spawn_mincount_boomerdead  = CreateConVar("l4d_spawn_mincount_boomerdead", "5", "");	
	l4d_spawn_maxcount_boomerdead  = CreateConVar("l4d_spawn_maxcount_boomerdead", "10", "");

	l4d_spawn_chance_spitterdead   = CreateConVar("l4d_spawn_chance_spitterdead", "30", "");
	l4d_spawn_mincount_spitterdead = CreateConVar("l4d_spawn_mincount_spitterdead", "3", "");	
	l4d_spawn_maxcount_spitterdead = CreateConVar("l4d_spawn_maxcount_spitterdead", "8", "");
		
	l4d_spawn_chance_tankdead      = CreateConVar("l4d_spawn_chance_tankdead", "50", "");
	l4d_spawn_mincount_tankdead    = CreateConVar("l4d_spawn_mincount_tankdead", "6", "");	
	l4d_spawn_maxcount_tankdead    = CreateConVar("l4d_spawn_maxcount_tankdead", "15", "");
