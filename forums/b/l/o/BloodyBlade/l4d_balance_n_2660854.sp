...
public void OnPluginStart()
{
	...
	l4d_balance_reaction_time = CreateConVar("l4d_balance_reaction_time", "10", "reaction time of balance system [10, 60]seconds"); 
	
	l4d_balance_difficulty_min = 	CreateConVar("l4d_balance_difficulty_min", "10", "min difficulty,  if intensity less than this value, the balance will start, infected will accumulate[0, 100]");
