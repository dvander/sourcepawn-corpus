...
public void OnPluginStart()
{
	...
	CreateConVar("sm_digestion_boomer_healmaxhp", "300", "Boomer max health", _, true, 0.0, true, 65535.0);
	...
	CreateConVar("sm_digestion_charger_healmaxhp", "1950", "Charger max health", _, true, 0.0, true, 65535.0);
