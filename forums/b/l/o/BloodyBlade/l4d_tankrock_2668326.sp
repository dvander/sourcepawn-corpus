...
{
	l4d_rock_fire = CreateConVar("l4d_rock_fire", "1", "0:disable , 1:burning tank throws burning rock, 2:always throw burning rock");
	l4d_rock_explosive_burning = CreateConVar("l4d_rock_explosive_chance_burning", "30.0", "burning rock explode chance [0.0, 100.0]");
	l4d_rock_explosive_normal = CreateConVar("l4d_rock_explosive_chance_normal", "20.0", "normal rock explode chance [0.0, 100.0]");
	l4d_rock_explosive_damage = CreateConVar("l4d_rock_explosive_damage", "20.0", "[0.0, 100.0]");
	l4d_rock_explosive_radius = CreateConVar("l4d_rock_explosive_radius", "150.0", "[0.0, 500.0]");
	l4d_rock_explosive_pushforce = CreateConVar("l4d_rock_explosive_pushforce", "700.0", "[0.0, 2000.0]");
