...
new numtanks;
new numwitches;
new tankonfire[MAXPLAYERS+1];
new istank[MAXPLAYERS+1];
new buyitem[MAXPLAYERS+1];
new canspawn;
new burntimeleft[MAXPLAYERS+1];
new sburntimeleft[MAXPLAYERS+1];
new hasincendiary[MAXPLAYERS+1];
new hassuperburn[MAXPLAYERS+1];
...
new Handle:pointshurtcount[MAXPLAYERS+1];               
