...
{
	CvarEnabled = CreateConVar("sm_nonades_enabled", "1", "Enables and disables DoD:S NoNades.",FCVAR_PLUGIN|FCVAR_REPLICATED)
	CvarFilter = CreateConVar("sm_nonades_filter", "63", "Filters specific granades.",FCVAR_PLUGIN|FCVAR_REPLICATED)
	CvarVersion = CreateConVar("sm_nonades_version", PLUGIN_VERSION,"DoD:S NoNades Version", FCVAR_PLUGIN|FCVAR_NOTIFY|FCVAR_REPLICATED);
