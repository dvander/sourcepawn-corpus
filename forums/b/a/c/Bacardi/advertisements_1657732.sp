...
public Action:Timer_DisplayAds(Handle:timer) {
	if (GetConVarBool(g_hEnabled)) {
		decl AdminFlag:fFlagList[16], String:sBuffer[256], String:sFlags[17], String:sText[256], String:sType[6];
...
SayText(to, const String:message[]) {
	new Handle:hBf = StartMessageOne("SayText", to);
