...
public OnPluginStart()
{
    ...
    g_hCvarSaferoom = CreateConVar(     "sm_safeitemkill_saferooms",    "3",    "Saferooms to empty. Flags: 1 = end saferoom, 2 = start saferoom (3 = kill items from both).", FCVAR_PLUGIN, true, 0.0, false);
    g_hCvarItems = CreateConVar(        "sm_safeitemkill_items",        "1",    "Types to rmove. Flags: 1 = health items, 2 = weapons, 4 = all other usable items (add them up).", FCVAR_PLUGIN, true, 0.0, false);
