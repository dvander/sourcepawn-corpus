...
Handle:MenuZoning(client)
{
	...
	{
		AddMenuItem(menuZoning, "up", "Monter");
		AddMenuItem(menuZoning, "down", "Descendre");
		AddMenuItem(menuZoning, "leftX", "Deplacer X gauche");
		AddMenuItem(menuZoning, "rightX", "Deplacer X droite");
		AddMenuItem(menuZoning, "leftY", "Deplacer Y gauche");
		AddMenuItem(menuZoning, "rightY", "Deplacer Y droite");
		AddMenuItem(menuZoning, "taille", "Modifier la taille");
		AddMenuItem(menuZoning, "inter+", "Ajouter une intervalle", ITEMDRAW_DISABLED);
		AddMenuItem(menuZoning, "inter-", "Enlever une intervalle", ITEMDRAW_DISABLED);
		AddMenuItem(menuZoning, "coord", "Coordonnées");
		AddMenuItem(menuZoning, "delete", "Supprimer");
	}
...
Handle:MenuZoningTaille(client)
{
	...
	else
	{
		...
		SetMenuTitle(menuZoningTaille, "Taille du zoning :");
		AddMenuItem(menuZoningTaille, "up", "Grandir");
		AddMenuItem(menuZoningTaille, "down", "Rétrécir");
		AddMenuItem(menuZoningTaille, "x+", "Grandir X");
		AddMenuItem(menuZoningTaille, "x-", "Rétrécir X");
		AddMenuItem(menuZoningTaille, "y+", "Grandir Y");
		AddMenuItem(menuZoningTaille, "y-", "Rétrécir Y");
		AddMenuItem(menuZoningTaille, "", "Retour pour déplacer.", ITEMDRAW_DISABLED);
