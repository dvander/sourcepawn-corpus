...
public OnPluginStart()
{
	...
	Copycfg(1, "/cfg/sourcemod/example.cfg", 1, "example_cvar2", "75", "Integer test cvar.", FCVAR_PLUGIN, true, 50.0, true, 100.0)
	Copycfg(1, "/cfg/sourcemod/example.cfg", 2, "example_cvar3", "7.0", "Float test cvar.", FCVAR_PLUGIN, true, 5.0, true, 10.0)
