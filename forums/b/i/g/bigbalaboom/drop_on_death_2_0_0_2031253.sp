...
public Action:Event_PlayerHurt(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if (GetConVarBool(g_Cvar_DropAll) && IsClientInGame(client) && GetClientHealth(client) <= 0)
	{
	...
	if (GetConVarBool(g_Cvar_DropAll) && GetConVarBool(g_Cvar_DropArmor) && IsClientInGame(client) && GetClientHealth(client) <= 0 && armor > GetConVarInt(g_Cvar_ArmorMin))
	{
