...
public Native_GetClientSquad(Handle:plugin, numParams)
{
   new iClient = GetNativeCell(1);
   return _:GetClientSquad(iClient);
}
...
{
   CreateNative("GetClientSquad", Native_GetClientSquad);
   return true;
}
