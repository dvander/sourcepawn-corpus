...
public Plugin:myinfo = 
{
	...
	name = "TF2/Beta Full Infinite Ammo",
...

{
	...
	hWaitingForPlayers = CreateConVar("sm_fia_waitingforplayers", "0", "Enable/Disable '1/0' Infinite Ammo on round win");
...
{	
	...
	{
		g_roundwin = false;	
		if (GetConVarBool(hRoundWin) && !GetConVarBool(hAll))
