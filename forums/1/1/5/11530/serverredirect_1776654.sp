...
Versions:
	...
	(11530: Since I edited 1.2 I assume this is 1.2.1)
	1.2.1
...
public OnPluginStart()
{
    ...
    g_varAllowBots = CreateConVar("sm_redirect_allowbots", "0", "sm_redirect_allowbots - Whether to count bots in the list", 0, true, 0.0, true, 1.0);
