...
{	
	...
	pluginIgnoreTeam = CreateConVar("sm_uberspawneignoreteam", "2", "2:ignore red , 3:ignore blue , 0:ignore nothing.", FCVAR_NONE , true, 0.0, true, 3.0);
...
public Action:OnPlayerSpawn(Handle:event, const String:name[], bool:dontBroadcast) {
	...
	if (clientId == WORLD || GetClientTeam(clientId) == GetConVarInt(pluginIgnoreTeam))
		return Plugin_Continue;
