	...
	if(g_enable)
	{
		...
		if(client != attacker && Client_IsIngame(client) && Client_IsIngame(attacker))
		{
			if(Client_IsValid(client) && Client_IsValid(attacker))
			{
				...
				{
					SetOverlay(attacker, "overlays/killmessages/kill_headshot");
				...
				else
				{
					...
					{
						SetOverlay(attacker, "overlays/killmessages/kill_grenade");
					}
					else if (strcmp(weapon, "knife") == 0)
					{
						SetOverlay(attacker, "overlays/killmessages/kill_knife");
					...
					else
					{
						switch(g_PlayerKills[attacker])
						{
							case 1:
							{
								SetOverlay(attacker, "overlays/killmessages/kill_1");
								EmitSoundToClient(attacker, "vox/gotit.mp3");
							}
							case 2:
							{
								SetOverlay(attacker, "overlays/killmessages/kill_2");
								EmitSoundToClient(attacker, "vox/doublekill.mp3");
							}
							case 3:
							{
								SetOverlay(attacker, "overlays/killmessages/kill_3");
								EmitSoundToClient(attacker, "vox/triplekill.mp3");
							}
							case 4:
							{
								SetOverlay(attacker, "overlays/killmessages/kill_4");
...
public OnMapStart()
{
	...
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_1.vmt");
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_1.vtf");
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_2.vmt");
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_2.vtf");
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_3.vmt");
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_3.vtf");
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_4.vmt");
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_4.vtf");
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_grenade.vmt");
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_grenade.vtf");
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_headshot.vmt");
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_headshot.vtf");
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_knife.vmt");
	AddFileToDownloadsTable("materials/overlays/killmessages/kill_knife.vtf");
	PrecacheDecal("materials/overlays/killmessages/kill_1.vtf", true);
	PrecacheDecal("materials/overlays/killmessages/kill_2.vtf", true);
	PrecacheDecal("materials/overlays/killmessages/kill_3.vtf", true);
	PrecacheDecal("materials/overlays/killmessages/kill_4.vtf", true);
	PrecacheDecal("materials/overlays/killmessages/kill_grenade.vtf", true);
	PrecacheDecal("materials/overlays/killmessages/kill_headshot.vtf", true);
	PrecacheDecal("materials/overlays/killmessages/kill_knife.vtf", true);
