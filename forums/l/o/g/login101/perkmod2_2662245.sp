...
CreateConvars()
{
	...
	g_hBot_Sur1 = CreateConVar(
		...
		"1,2,3" ,
		"Bot preferences for Survivor 1 perks: 1 = 숨겨진 힘, 2 = 더블 탭, 3 = 재빠른 손" ,
		FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY );

	g_hBot_Sur2 = CreateConVar(
		"l4d_perkmod_bot_survivor2" ,
		"1,2,3" ,
		"Bot preferences for Survivor 2 perks: 1 = 추가 체력, 2 = 강력한 정신, 3 = 도움의 손길, 4 = martial artist" ,
		FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY );

	g_hBot_Sur3 = CreateConVar(
		"l4d_perkmod_bot_survivor3" ,
		"1,2" ,
		"Bot preferences for Survivor 2 perks: 1 = pack rat, 2 = 끈질긴 생명력" ,
		FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY );
	...
	g_hSur1_default = CreateConVar(
		...
		"1" ,
		"Default selected perk for Survivor, Primary: 1 = 숨겨진 힘, 2 = 더블 탭, 3 = 재빠른 손, 4 = 수류탄 지원가" ,
		FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY );
	...
	g_hSur2_default = CreateConVar(
		...
		"1" ,
		"Default selected perk for Survivor, Secondary: 1 = 추가 체력, 2 = 강력한 정신, 3 = 도움의 손길, 4 = martial artist" ,
		FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY );
	...
	g_hSur3_default = CreateConVar(
		...
		"1" ,
		"Default selected perk for Survivor, Secondary: 1 = 탄창 추가, 2 = 약쟁이, 3 = 끈질긴 생명력" ,
		FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY );
...
{
	new Handle:menu = CreatePanel();
	SetPanelTitle(menu, "여름여름해 - Main Menu");
	DrawPanelText(menu,"3개 능력을 선택 하시오");
	...
	Format(st_display,64,"생존자 - 1번능력 (%s)",st_perk);
	if (g_iSur1_enable==1)
	...
	Format(st_display,64,"생존자 - 2번능력 (%s)", st_perk);
	if (g_iSur2_enable==1)
		DrawPanelItem(menu,st_display);
	else
		DrawPanelItem(menu,"disabled", ITEMDRAW_NOTEXT);
	...
	Format(st_display,64,"생존자 - 3번능력 (%s)", st_perk);
	if (g_iSur3_enable==1)
		DrawPanelItem(menu,st_display);
	else
		DrawPanelItem(menu,"disabled", ITEMDRAW_NOTEXT);
...
public Handle:Menu_ShowChoices (iCid)
{
	...
	if (iPerk == 1
		...
		|| g_iStopping_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iStopping_enable_vs==1		&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"숨겨진 힘 (+%i%% %t)", RoundToNearest(g_flStopping_dmgmult*100), "BonusDamageText" );
	else if (iPerk == 2
		&& (g_iDT_enable==1		&&	g_iL4D_GameMode==0
		|| g_iDT_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iDT_enable_vs==1	&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"더블 탭 (%t, %t, %t)", "DoubleTapDescriptionPanel", "SleighOfHandDescriptionPanel", "DoubleTapRestrictionWarning" ) ;
	else if (iPerk == 3
		&& (g_iSoH_enable==1		&&	g_iL4D_GameMode==0
		|| g_iSoH_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iSoH_enable_vs==1	&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"재빠른 손 (%t +%i%%)", "SleighOfHandDescriptionPanel", RoundToNearest(100 * ((1/g_flSoH_rate)-1) ) ) ;
	else if (iPerk == 4
		&& (g_iPyro_enable==1		&&	g_iL4D_GameMode==0
		|| g_iPyro_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iPyro_enable_vs==1		&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"수류탄 지원가 (%t)", "PyroDescriptionPanel");
	else
		Format(st_perk,128,"%t", "NotSet");

	if (g_iSur1_enable==1)
	{
		DrawPanelItem(menu,"생존자, 1번능력:");
	...
	if (iPerk == 1
		...
		|| g_iUnbreak_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iUnbreak_enable_vs==1	&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"추가 체력 (+%i %t)", g_iUnbreak_hp, "UnbreakableHint");
	else if (iPerk == 2
		&& (g_iSpirit_enable==1		&&	g_iL4D_GameMode==0
		|| g_iSpirit_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iSpirit_enable_vs==1	&&	g_iL4D_GameMode==2))
	{
		...
		if (g_iL4D_GameMode==2)
			...
			iTime=g_iSpirit_cd;
		Format(st_perk,128,"강력한 정신 (%t: %i min)", "SpiritDescriptionPanel", iTime/60 );
	}
	else if (iPerk == 3
		&& (g_iHelpHand_enable==1		&&	g_iL4D_GameMode==0
		|| g_iHelpHand_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iHelpHand_enable_vs==1		&&	g_iL4D_GameMode==2))
	{
		...
		if (g_iL4D_GameMode==2)
			...
			iBuff=g_iHelpHand_buff;
		if (g_iHelpHand_convar==1)
			Format(st_perk,128,"도움의 손길 (%t +%i)", "HelpingHandDescriptionPanel2", iBuff);
		else
			Format(st_perk,128,"도움의 손길 (%t +%i)", "HelpingHandDescriptionPanel", iBuff);
	}
	else if (iPerk == 4
		&& (g_iMA_enable==1		&&	g_iL4D_GameMode==0
		|| g_iMA_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iMA_enable_vs==1	&&	g_iL4D_GameMode==2))
	{
		if (g_iMA_maxpenalty < 6)
			Format(st_perk,128,"MartialArtist (%t)", "MartialArtistDescriptionPanel");
		else
			Format(st_perk,128,"MartialArtist (%t)", "MartialArtistDescriptionPanel_noreduc");
	}
	else
		Format(st_perk,128,"%t", "NotSet");
	...
	if (iPerk == 1
		...
		|| g_iPack_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iPack_enable_vs==1		&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"탄창 추가 (%t +%i%%)", "PackRatDescriptionPanel", RoundToNearest(g_flPack_ammomult*100) );
	else if (iPerk == 2
		&& (g_iChem_enable==1		&&	g_iL4D_GameMode==0
		|| g_iChem_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iChem_enable_vs==1		&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"약쟁이 (%t +%i)", "ChemReliantDescriptionPanel", g_iChem_buff);
	else if (iPerk == 3
		&& (g_iHard_enable==1			&&	g_iL4D_GameMode==0
		|| g_iHard_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iHard_enable_vs==1		&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"끈질긴 생명력 (+%i%% %t)", RoundToNearest(g_flHard_hpmult*100), "HardToKillDescriptionPanel" );
	else if (iPerk == 4
		&& (g_iExtreme_enable==1		&&	g_iL4D_GameMode==0
		|| g_iExtreme_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iExtreme_enable_vs==1	&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"질주 본능 (+%i%% %t)", RoundToNearest(g_flExtreme_rate*100-100), "MartialArtistDescriptionPanelCoop" );
	else if (iPerk == 5
		&& (g_iLittle_enable==1		&&	g_iL4D_GameMode==0
		|| g_iLittle_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iLittle_enable_vs==1	&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"야구 선수 (%t)", "LittleLeaguerDescriptionPanel" );
	else
		Format(st_perk,128,"%t", "NotSet");

	if (g_iSur2_enable==1)
	{
		DrawPanelItem(menu,"생존자, 3번능력:");
		DrawPanelText(menu,st_perk);
	}
...
{
	new Handle:menu=CreatePanel();
	SetPanelTitle(menu,"여름여름해: 이번라운드 너의 능력");
	decl String:st_perk[128];
...
{
	new Handle:menu = CreatePanel();
	SetPanelTitle(menu, "여름여름해 - 생존자: 1번능력");
	decl String:st_display[MAXPLAYERS+1];
	...
	else
	{
		...
		{
			case 1: st_current="(선택됨)";
			default: st_current="";
		}
		Format(st_display,64,"숨겨진 힘 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		switch (g_iSur1[client])
		{
			case 2: st_current="(선택됨)";
			default: st_current="";
		}
		Format(st_display,64,"더블 탭 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		switch (g_iSur1[client])
		{
			case 3: st_current="(선택됨)";
			default: st_current="";
		}
		Format(st_display,64,"재빠른 손 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		switch (g_iSur1[client])
		{
			case 4: st_current="(선택됨)";
			default: st_current="";
		}
		Format(st_display,64,"수류탄 지원가 %s",st_current);
		DrawPanelItem(menu,st_display);
...
{
	new Handle:menu = CreatePanel();
	SetPanelTitle(menu, "여름여름해 - 생존자: 2번능력");
	decl String:st_display[MAXPLAYERS+1];
	decl String:st_current[10];
	...
	else
	{
		...
		Format(st_display,64,"추가 체력 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"강력한 정신 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"도움의 손길 %s",st_current);
		DrawPanelItem(menu,st_display);
		...
		else
		{
			...
			Format(st_display,64,"근접 마스터 %s",st_current);
			DrawPanelItem(menu,st_display);
...
{
	new Handle:menu = CreatePanel();
	SetPanelTitle(menu, "여름여름해 - 생존자: 3번능력");
	decl String:st_display[MAXPLAYERS+1];
	decl String:st_current[10];
	...
	else
	{
		...
		Format(st_display,64,"탄창 추가 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"약쟁이 %s",st_current);
		DrawPanelItem(menu,st_display);
		if (g_iChem_buff > 0)
		{
	...
	else
	{
		...
		Format(st_display,64,"끈질긴 생명력 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"질주 본능 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"야구 선수 %s",st_current);
		DrawPanelItem(menu,st_display);
...
{
	new Handle:menu = CreatePanel();
	SetPanelTitle(menu, "여름여름해 - Boomer");
...
{
	new Handle:menu = CreatePanel();
	SetPanelTitle(menu, "여름여름해 - Smoker");
	decl String:st_display[MAXPLAYERS+1];
	decl String:st_current[10];
...
{
	new Handle:menu = CreatePanel();
	SetPanelTitle(menu, "여름여름해 - Hunter");
	decl String:st_display[MAXPLAYERS+1];
	decl String:st_current[10];
...
{
	new Handle:menu = CreatePanel();
	SetPanelTitle(menu, "여름여름해 - Jockey");
	decl String:st_display[MAXPLAYERS+1];
	decl String:st_current[10];
...
{
	new Handle:menu = CreatePanel();
	SetPanelTitle(menu, "여름여름해 - Spitter");
	decl String:st_display[MAXPLAYERS+1];
	decl String:st_current[10];
...
{
	new Handle:menu = CreatePanel();
	SetPanelTitle(menu, "여름여름해 - Charger");
	decl String:st_display[MAXPLAYERS+1];
	decl String:st_current[10];
