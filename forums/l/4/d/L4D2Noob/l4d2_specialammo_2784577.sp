...
public OnPluginStart()
{
	...
	CreateConVar("l4d2_specialammo_version", PLUGIN_VERSION, " The version of L4D Special Ammo running ", FCVAR_NONE | FCVAR_SPONLY | FCVAR_NOTIFY | FCVAR_DONTRECORD);
	SpecialAmmoAmount = CreateConVar("l4d2_specialammo_amount", "100", " How much special ammo a player gets. (default 50) ", FCVAR_NONE | FCVAR_NOTIFY);
	KillCountLimitSetting = CreateConVar("l4d2_specialammo_killcountsetting", "50", " How much Infected a Player has to shoot to win special ammo. (default 120) ", FCVAR_NONE | FCVAR_NOTIFY);
	DumDumForce = CreateConVar("l4d2_specialammo_dumdumforce", "75.0", " How powerful the DumDum Kickback is. (default 75.0) ", FCVAR_NONE | FCVAR_NOTIFY);
