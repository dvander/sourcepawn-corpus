...
public Plugin myinfo = 
{
	...
	author = "King", 
	description = "Устанавливает радужную ауру на игроке", 
	version = "1.0.1", 
	url = "https://ip-gamers.net/topic/1966-l4d2rainbow-light-glow-and-body-raduzhnaja-aura-na-igroke-raduga-v-l4d2/"
};
...
public APLRes AskPluginLoad2(Handle myself, bool late, char[] error, int err_max)
{
	...
	{
		strcopy(error, err_max, "Плагин работает только в L4D(2)");
...
{
	g_hRainbowTime = CreateConVar("rainbow_time", "3.0", "Длительность изменения цвета ауры");
	
	HookEvent("player_death", Event_PlayerDeath);
	HookEvent("round_end", Event_RE);
	
	RegAdminCmd("sm_arco", Command_Rainbow, ADMFLAG_ROOT, "Включает радужную ауру");
	RegAdminCmd("sm_arcoff", Command_RainbowOff, ADMFLAG_ROOT, "Выключает радужную ауру");
