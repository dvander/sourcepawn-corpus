...
public void OnPluginStart()
{
	...
	l4d2_helicopter_speed = CreateConVar("l4d2_helicopter_speed", "500.0", "Flight speed [100.0, 500.0]");
	l4d2_helicopter_gun_accuracy = CreateConVar("l4d2_helicopter_gun_accuracy", "1.0", "Machine gun accuracy [0.0, 1.0]");
	l4d2_helicopter_gun_damage = CreateConVar("l4d2_helicopter_gun_damage", "200", "Machine gun bullet damage [1.0, 200.0]");
