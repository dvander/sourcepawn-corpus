...
public void OnPluginStart()
{
	...
	hCvar_BasicTankHP = CreateConVar("director_basic_tankhp", "6000.0", "Basic amount of HP for the Tank.", FCVAR_NOTIFY, true, 0.0, true, 65535.0);
	...
	hCvar_TankSurvivorMultipler = CreateConVar("director_survivor_multipler", "0", "Multiply Tank's HP if there are more than 4 survivors or start from one survivor.\n0 = Start multiplying from one.\n1 = Start multiplying from 4.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
