...
/*==================================================================================================
	...
	L4D2CS also includes a voting system in which people can vote for their favorite campaign/map
	...
	Change Log
		v4.0 (Jan 2, 2017)		- Added 13 more custom campaigns bringing the total to 241 maps
		v3.0 (July 31, 2016)	- Added 18 more custom campaigns bringing the total to 228 maps
		v2.5 (Feb 24, 2016)		- Added 10 more custom campaigns bringing the total to 210 maps
...
#define NUMBER_OF_CAMPAIGNS			241		/* CHANGE TO MATCH THE TOTAL NUMBER OF CAMPAIGNS */
...
#define WAIT_TIME_BEFORE_SWITCH_COOP			65.0
...
new g_iMaxCoopFinaleFailures = 5;	//Amount of times Survivors can fail before L4D2CS switches in coop
...
new Float:g_fNextMapAdInterval = 600.0;						//Interval for L4D2CS next map advertisement
...
/*======================================================================================
##################            L 4 D 2 C S   M A P   S T R I N G S            ###########
========================================================================================
###                                                                                  ###
...
{	
	...
	Format(g_strCampaignFirstMap[18], 32, "l4d2_diescraper1_apartment_36");
	...
	Format(g_strCampaignFirstMap[47], 32, "l4d2_deadflagblues01_city");
	Format(g_strCampaignFirstMap[48], 32, "l4d2_scream01_yards");
	Format(g_strCampaignFirstMap[49], 32, "saltwell_1_d");
	...
	Format(g_strCampaignFirstMap[68], 32, "wth_1");
	...
	Format(g_strCampaignFirstMap[109], 32, "alejki");
	Format(g_strCampaignFirstMap[110], 32, "tunel");
	Format(g_strCampaignFirstMap[111], 32, "bha01");
	...
	Format(g_strCampaignFirstMap[127], 32, "l4d_grave_city");
	Format(g_strCampaignFirstMap[128], 32, "l4d2_scream01_yards");
	Format(g_strCampaignFirstMap[129], 32, "l4d_cc1");
	...
	Format(g_strCampaignFirstMap[152], 32, "l4d_dbd2dc_anna_is_gone");
	...
	Format(g_strCampaignFirstMap[182], 32, "l4d_apocalypse01");
	...
	Format(g_strCampaignFirstMap[198], 32, "l4d2_vanillaghosthouse");
	...
	Format(g_strCampaignFirstMap[204], 32, "l4d2_auburn");
	Format(g_strCampaignFirstMap[205], 32, "a_lor_11");
	Format(g_strCampaignFirstMap[206], 32, "awaystadium_c1");
	Format(g_strCampaignFirstMap[207], 32, "re1m1");
	Format(g_strCampaignFirstMap[208], 32, "l4d_sh01_oldsh");
	Format(g_strCampaignFirstMap[209], 32, "village_beta408");
	Format(g_strCampaignFirstMap[210], 32, "Dead_Series1");
	Format(g_strCampaignFirstMap[211], 32, "versus_1");
	Format(g_strCampaignFirstMap[212], 32, "l4d2_airport01_greenhouse");
	Format(g_strCampaignFirstMap[213], 32, "1BM");
	Format(g_strCampaignFirstMap[214], 32, "Bus_Depot");
	Format(g_strCampaignFirstMap[215], 32, "re2a1");
	Format(g_strCampaignFirstMap[216], 32, "re2b1");
	Format(g_strCampaignFirstMap[217], 32, "umb_underground1");
	Format(g_strCampaignFirstMap[218], 32, "checkpoint_to_saferoom");
	Format(g_strCampaignFirstMap[219], 32, "l4d_draxmap0");
	Format(g_strCampaignFirstMap[220], 32, "l4d_thewoods2_01");
	Format(g_strCampaignFirstMap[221], 32, "l4d_priston01");
	Format(g_strCampaignFirstMap[222], 32, "1-cheyenne");
	Format(g_strCampaignFirstMap[223], 32, "ch_map1_city");
	Format(g_strCampaignFirstMap[224], 32, "l4d_brain4dead01_suburbs_b2");
	Format(g_strCampaignFirstMap[225], 32, "l4d_noway_streets01");
	Format(g_strCampaignFirstMap[226], 32, "l4d_forest01_orchard");
	Format(g_strCampaignFirstMap[227], 32, "zombie_caribbean");
	Format(g_strCampaignFirstMap[228], 32, "oot_forest");
	Format(g_strCampaignFirstMap[229], 32, "l4d_ilogiccity_01");
	Format(g_strCampaignFirstMap[230], 32, "l4d2_camp_dead");
	Format(g_strCampaignFirstMap[231], 32, "l4d_vs_ds1");
	Format(g_strCampaignFirstMap[232], 32, "gunk_misty");
	Format(g_strCampaignFirstMap[233], 32, "ddntr1_01urban");
	Format(g_strCampaignFirstMap[234], 32, "campanar_coop_vseft01_subsystem");
	Format(g_strCampaignFirstMap[235], 32, "eft01_subsystem");
	Format(g_strCampaignFirstMap[236], 32, "l4d_cardiff");
	Format(g_strCampaignFirstMap[237], 32, "re3m1");
	Format(g_strCampaignFirstMap[238], 32, "qe2_ep1");
	Format(g_strCampaignFirstMap[239], 32, "l4d_thewoods2_1");
	Format(g_strCampaignFirstMap[240], 32, "l4d_hopedb_gorge01cr");
	...
	Format(g_strCampaignLastMap[18], 32, "l4d2_diescraper4_top_36");
	...
	Format(g_strCampaignLastMap[47], 32, "l4d2_deadflagblues05_station");
	Format(g_strCampaignLastMap[48], 32, "l4d2_scream05_finale");
	Format(g_strCampaignLastMap[49], 32, "saltwell_5_d");
	...
	Format(g_strCampaignLastMap[68], 32, "wth_5");
	...
	Format(g_strCampaignLastMap[109], 32, "baza2");
	Format(g_strCampaignLastMap[110], 32, "domki");
	Format(g_strCampaignLastMap[111], 32, "rombu05");
	...
	Format(g_strCampaignLastMap[127], 32, "l4d_grave_station");
	Format(g_strCampaignLastMap[128], 32, "l4d2_scream05_finale");
	Format(g_strCampaignLastMap[129], 32, "l4d_cc5");
	...
	Format(g_strCampaignLastMap[152], 32, "l4d_dbd2_new_dawn");
	...
	Format(g_strCampaignLastMap[182], 32, "l4d_apocalypse05");
	...
	Format(g_strCampaignLastMap[198], 32, "l4d2_vanillaghosthouse");
	...
	Format(g_strCampaignLastMap[204], 32, "l4d2_auburn_3new");
	Format(g_strCampaignLastMap[205], 32, "a_lor_41");
	Format(g_strCampaignLastMap[205], 32, "a_lor_42");
	Format(g_strCampaignLastMap[205], 32, "a_lor_43");
	Format(g_strCampaignLastMap[206], 32, "hotarubi_map3");
	Format(g_strCampaignLastMap[207], 32, "re1m5");
	Format(g_strCampaignLastMap[208], 32, "l4d_sh12_theend");
	Format(g_strCampaignLastMap[208], 32, "l4d_sh_theend2");
	Format(g_strCampaignLastMap[208], 32, "l4d_sh_theend3");
	Format(g_strCampaignLastMap[208], 32, "l4d_sh_theend4");
	Format(g_strCampaignLastMap[209], 32, "final_beta408");
	Format(g_strCampaignLastMap[210], 32, "Dead_Series4");
	Format(g_strCampaignLastMap[211], 32, "versus_5");
	Format(g_strCampaignLastMap[212], 32, "l4d2_airport05_runway");
	Format(g_strCampaignLastMap[213], 32, "1BM-7");
	Format(g_strCampaignLastMap[214], 32, "EngineRoom");
	Format(g_strCampaignLastMap[215], 32, "re2a4");
	Format(g_strCampaignLastMap[216], 32, "re2b4");
	Format(g_strCampaignLastMap[217], 32, "umb_arklay");
	Format(g_strCampaignLastMap[218], 32, "checkpoint_to_saferoom3");
	Format(g_strCampaignLastMap[219], 32, "l4d_draxmap4");
	Format(g_strCampaignLastMap[220], 32, "l4d_thewoods_03b");
	Format(g_strCampaignLastMap[221], 32, "l4d_spacend05");
	Format(g_strCampaignLastMap[222], 32, "5-despegando");
	Format(g_strCampaignLastMap[223], 32, "ch_map3_greatwall");
	Format(g_strCampaignLastMap[224], 32, "l4d_mortuary03");
	Format(g_strCampaignLastMap[225], 32, "l4d_noway_market03");
	Format(g_strCampaignLastMap[226], 32, "l4d_forest03_dam");
	Format(g_strCampaignLastMap[227], 32, "zombie_caribbean");
	Format(g_strCampaignLastMap[228], 32, "oot_boss");
	Format(g_strCampaignLastMap[229], 32, "l4d_ilogiccity_04");
	Format(g_strCampaignLastMap[230], 32, "l4d2_death_pit_finale");
	Format(g_strCampaignLastMap[231], 32, "l4d_vs_ds6");
	Format(g_strCampaignLastMap[232], 32, "gunk_wicked_dead");
	Format(g_strCampaignLastMap[233], 32, "ddntr1_04finale");
	Format(g_strCampaignLastMap[234], 32, "cullera_coop_vs");
	Format(g_strCampaignLastMap[235], 32, "eft02_cntower");
	Format(g_strCampaignLastMap[236], 32, "l4d_cardiff_4");
	Format(g_strCampaignLastMap[237], 32, "re3m8");
	Format(g_strCampaignLastMap[238], 32, "qe2_ep5");
	Format(g_strCampaignLastMap[239], 32, "l4d_thewoods2_5");
	Format(g_strCampaignLastMap[240], 32, "l4d_mic_finaleecr");
	...
	Format(g_strCampaignName[4], 32, "Night Terror 2013");
	...
	Format(g_strCampaignName[18], 32, "Diescraper Redux 3.6");
	Format(g_strCampaignName[19], 32, "Left 4 Mario");
	Format(g_strCampaignName[20], 32, "Ft. Noesis L4D2");
	Format(g_strCampaignName[21], 32, "Overkill v1");
	...
	Format(g_strCampaignName[36], 32, "You Are Doomed");
	...
	Format(g_strCampaignName[47], 32, "Dead Flag Blues 2");
	Format(g_strCampaignName[48], 32, "Die Screaming II");
	Format(g_strCampaignName[49], 32, "Salt Hell Park");
	...
	Format(g_strCampaignName[60], 32, "Starship Troopers In The Undead Zone");
	...
	Format(g_strCampaignName[68], 32, "Welcome To Hell");
	...
	Format(g_strCampaignName[109], 32, "Crash Course APOCALYPSE 2");
	Format(g_strCampaignName[110], 32, "Death Toll APOCALYPSE 2");
	Format(g_strCampaignName[111], 32, "Blood Harvest APOCALYPSE 2");
	...
	Format(g_strCampaignName[116], 32, "Dnieper v1.0");
	...
	Format(g_strCampaignName[128], 32, "Die Screaming II");
	Format(g_strCampaignName[129], 32, "Cold Case 2017");
	...
	Format(g_strCampaignName[145], 32, "Dead St 16");
	...
	Format(g_strCampaignName[152], 32, "Dead Before Dawn Too");
	...
	Format(g_strCampaignName[182], 32, "Apocalypse 2");
	Format(g_strCampaignName[183], 32, "Fatal Freight");
	Format(g_strCampaignName[184], 32, "Stargate SG-4 v4");
	...
	Format(g_strCampaignName[198], 32, "Vanilla Ghost House");
	...
	Format(g_strCampaignName[204], 32, "Project Auburn 2");
	Format(g_strCampaignName[205], 32, "Left or Right Beta");
	Format(g_strCampaignName[206], 32, "Away Stadium");
	Format(g_strCampaignName[207], 32, "Resident Evil 1");
	Format(g_strCampaignName[208], 32, "Silent Hill 2");
	Format(g_strCampaignName[209], 32, "Death Trip v5");
	Format(g_strCampaignName[210], 32, "DeadSeries");
	Format(g_strCampaignName[211], 32, "Firetower Trail 2.65");
	Format(g_strCampaignName[212], 32, "Dead Air Modified 6.0");
	Format(g_strCampaignName[213], 32, "The Punisher");
	Format(g_strCampaignName[214], 32, "Die Trying L4D2");
	Format(g_strCampaignName[215], 32, "Resident Evil 2 ... Side A");
	Format(g_strCampaignName[216], 32, "Resident Evil 2 ... Side B");
	Format(g_strCampaignName[217], 32, "umbrella");
	Format(g_strCampaignName[218], 32, "No More Ceda L4D2");
	Format(g_strCampaignName[219], 32, "Death Stop L4D2");
	Format(g_strCampaignName[220], 32, "The Ultimate Woods");
	Format(g_strCampaignName[221], 32, "Whispers In The Dark");
	Format(g_strCampaignName[222], 32, "Left4SGC BETA 1.0");
	Format(g_strCampaignName[223], 32, "True FangShi");
	Format(g_strCampaignName[224], 32, "The Mortuary");
	Format(g_strCampaignName[225], 32, "No Way Out v3.0");
	Format(g_strCampaignName[226], 32, "Dam It: Buried by the Flood");
	Format(g_strCampaignName[227], 32, "Zombies of the Caribbean");
	Format(g_strCampaignName[228], 32, "Kokiri Forest");
	Format(g_strCampaignName[229], 32, "Ilogic City of the Dead 2");
	Format(g_strCampaignName[230], 32, "Death Island");
	Format(g_strCampaignName[231], 32, "Hellstorm 2");
	Format(g_strCampaignName[232], 32, "Gunk");
	Format(g_strCampaignName[233], 32, "Deadenator");
	Format(g_strCampaignName[234], 32, "Last Summer v5");
	Format(g_strCampaignName[235], 32, "Escape From Toronto: Revisited Lite");
	Format(g_strCampaignName[236], 32, "Rural Tour");
	Format(g_strCampaignName[237], 32, "Resident Evil 3");
	Format(g_strCampaignName[238], 32, "Questionable Ethics: Alpha test");
	Format(g_strCampaignName[239], 32, "The Woods 2");
	Format(g_strCampaignName[240], 32, "Field of the Dead Ext TLM Ver");
...
{
	name = "L4D2 Campaign Switcher (L4D2CS)",
...
public OnPluginStart()
{
	...
	CreateConVar("l4d2cs_version", PLUGIN_VERSION, "Version of L4D2 Campaign Switcher (L4D2CS) on this server", FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
	g_hCVar_VotingEnabled = CreateConVar("l4d2cs_voting_system_enabled", "1", "Enables players to vote for the next map or campaign (0 = DISABLED, 1 = ENABLED)", 0, true, 0.0, true, 1.0);
	g_hCVar_VoteWinnerSoundEnabled = CreateConVar("l4d2cs_voting_sound_enabled", "1", "Determines if a sound plays when a new map is winning the vote (0 = DISABLED, 1 = ENABLED)", 0, true, 0.0, true, 1.0);
	g_hCVar_VotingAdMode = CreateConVar("l4d2cs_voting_ad_mode", "1", "Sets how to advertise voting at the start of the map (0 = DISABLED, 1 = HINT TEXT, 2 = CHAT TEXT, 3 = OPEN VOTE MENU)\n * Note: This is only displayed once during a finale or scavenge map *", 0, true, 0.0, true, 3.0);
	g_hCVar_VotingAdDelayTime = CreateConVar("l4d2cs_voting_ad_delay_time", "5.0", "Time, in seconds, to wait after survivors leave the start area to advertise voting as defined in l4d2cs_voting_ad_mode\n * Note: If the server is up, changing this in the .cfg file takes two map changes before the change takes place *", 0, true, 0.1, false);
	g_hCVar_NextMapAdMode = CreateConVar("l4d2cs_next_map_ad_mode", "1", "Sets how the next campaign/map is advertised during a finale or scavenge map (0 = DISABLED, 1 = HINT TEXT, 2 = CHAT TEXT)", 0, true, 0.0, true, 2.0);
	g_hCVar_NextMapAdInterval = CreateConVar("l4d2cs_next_map_ad_interval", "600.0", "The time, in seconds, between advertisements for the next campaign/map on finales and scavenge maps", 0, true, 60.0, false);
	g_hCVar_MaxFinaleFailures = CreateConVar("l4d2cs_max_coop_finale_failures", "0", "The amount of times the survivors can fail a finale in Coop before it switches to the next campaign (0 = INFINITE FAILURES)", 0, true, 0.0, false);
...
public CVarChange_Voting(Handle:hCVar, const String:strOldValue[], const String:strNewValue[])
{
	...
	if (StringToInt(strNewValue) == 1)
	{
		...
		PrintToServer("[L4D2CS] ConVar changed: Voting System ENABLED");
		PrintToChatAll("[L4D2CS] ConVar changed: Voting System ENABLED");
	}
	else
	{
		g_bVotingEnabled = false;
		PrintToServer("[L4D2CS] ConVar changed: Voting System DISABLED");
		PrintToChatAll("[L4D2CS] ConVar changed: Voting System DISABLED");
	}
}
...
public CVarChange_NewVoteWinnerSound(Handle:hCVar, const String:strOldValue[], const String:strNewValue[])
{
	...
	if (StringToInt(strNewValue) == 1)
	{
		...
		PrintToServer("[L4D2CS] ConVar changed: New vote winner sound ENABLED");
		PrintToChatAll("[L4D2CS] ConVar changed: New vote winner sound ENABLED");
	}
	else
	{
		g_bVoteWinnerSoundEnabled = false;
		PrintToServer("[L4D2CS] ConVar changed: New vote winner sound DISABLED");
		PrintToChatAll("[L4D2CS] ConVar changed: New vote winner sound DISABLED");
	}
}
...
public CVarChange_VotingAdMode(Handle:hCVar, const String:strOldValue[], const String:strNewValue[])
{
	...
	switch(StringToInt(strNewValue))
	{
		case 0:
		{
			...
			PrintToServer("[L4D2CS] ConVar changed: Voting display mode: DISABLED");
			PrintToChatAll("[L4D2CS] ConVar changed: Voting display mode: DISABLED");
		}
		case 1:
		{
			g_iVotingAdDisplayMode = DISPLAY_MODE_HINT;
			PrintToServer("[L4D2CS] ConVar changed: Voting display mode: HINT TEXT");
			PrintToChatAll("[L4D2CS] ConVar changed: Voting display mode: HINT TEXT");
		}
		case 2:
		{
			g_iVotingAdDisplayMode = DISPLAY_MODE_CHAT;
			PrintToServer("[L4D2CS] ConVar changed: Voting display mode: CHAT TEXT");
			PrintToChatAll("[L4D2CS] ConVar changed: Voting display mode: CHAT TEXT");
		}
		case 3:
		{
			g_iVotingAdDisplayMode = DISPLAY_MODE_MENU;
			PrintToServer("[L4D2CS] ConVar changed: Voting display mode: OPEN VOTE MENU");
			PrintToChatAll("[L4D2CS] ConVar changed: Voting display mode: OPEN VOTE MENU");
		}
	}
}
...
public CVarChange_VotingAdDelayTime(Handle:hCVar, const String:strOldValue[], const String:strNewValue[])
{
	...
	if (fDelayTime > 0.1)
	{
		...
		PrintToServer("[L4D2CS] ConVar changed: Voting advertisement delay time changed to %f", fDelayTime);
		PrintToChatAll("[L4D2CS] ConVar changed: Voting advertisement delay time changed to %f", fDelayTime);
	}
	else
	{
		g_fVotingAdDelayTime = 0.1;
		PrintToServer("[L4D2CS] ConVar changed: Voting advertisement delay time changed to 0.1");
		PrintToChatAll("[L4D2CS] ConVar changed: Voting advertisement delay time changed to 0.1");
	}
}

//Callback function for how L4D2CS and the next map is advertised to the players during a finale
public CVarChange_NewMapAdMode(Handle:hCVar, const String:strOldValue[], const String:strNewValue[])
{
	...
	switch(StringToInt(strNewValue))
	{
		case 0:
		{
			...
			PrintToServer("[L4D2CS] ConVar changed: Next map advertisement display mode: DISABLED");
			PrintToChatAll("[L4D2CS] ConVar changed: Next map advertisement display mode: DISABLED");
		}
		case 1:
		{
			g_iNextMapAdDisplayMode = DISPLAY_MODE_HINT;
			PrintToServer("[L4D2CS] ConVar changed: Next map advertisement display mode: HINT TEXT");
			PrintToChatAll("[L4D2CS] ConVar changed: Next map advertisement display mode: HINT TEXT");
		}
		case 2:
		{
			g_iNextMapAdDisplayMode = DISPLAY_MODE_CHAT;
			PrintToServer("[L4D2CS] ConVar changed: Next map advertisement display mode: CHAT TEXT");
			PrintToChatAll("[L4D2CS] ConVar changed: Next map advertisement display mode: CHAT TEXT");
		}
	}
}

//Callback function for the interval that controls the timer that advertises L4D2CS and the next map
public CVarChange_NewMapAdInterval(Handle:hCVar, const String:strOldValue[], const String:strNewValue[])
{
	...
	if (fDelayTime > 60.0)
	{
		...
		PrintToServer("[L4D2CS] ConVar changed: Next map advertisement interval changed to %f", fDelayTime);
		PrintToChatAll("[L4D2CS] ConVar changed: Next map advertisement interval changed to %f", fDelayTime);
	}
	else
	{
		g_fNextMapAdInterval = 60.0;
		PrintToServer("[L4D2CS] ConVar changed: Next map advertisement interval changed to 60.0");
		PrintToChatAll("[L4D2CS] ConVar changed: Next map advertisement interval changed to 60.0");
	}
}

//Callback function for the amount of times the survivors can fail a coop finale map before L4D2CS switches
public CVarChange_MaxFinaleFailures(Handle:hCVar, const String:strOldValue[], const String:strNewValue[])
{
	...
	if (iMaxFailures > 0)
	{
		...
		PrintToServer("[L4D2CS] ConVar changed: Max Coop finale failures changed to %f", iMaxFailures);
		PrintToChatAll("[L4D2CS] ConVar changed: Max Coop finale failures changed to %f", iMaxFailures);
	}
	else
	{
		g_iMaxCoopFinaleFailures = 0;
		PrintToServer("[L4D2CS] ConVar changed: Max Coop finale failures changed to 0");
		PrintToChatAll("[L4D2CS] ConVar changed: Max Coop finale failures changed to 0");
	}
}
/*======================================================================================
#################                     E V E N T S                      #################
...
public OnMapStart()
{
	...
	Format(strFileName, sizeof(strFileName), "L4D2_Campaign_Switcher_%s", PLUGIN_VERSION);
	...
	for(new iMapIndex = 0; iMapIndex < NUMBER_OF_CAMPAIGNS; iMapIndex++)
	{
		if(StrEqual(strCurrentMap, g_strCampaignLastMap[iMapIndex]) == true)
		{
			...
			if(g_bVotingEnabled == true && g_iWinningMapVotes > 0 && g_iWinningMapIndex >= 0)
			{
				...
				{
					PrintToChatAll("\x04[L4D2CS] \x03Switching campaign to the vote winner: \x04%s", g_strCampaignName[g_iWinningMapIndex]);
			...
			{
				PrintToChatAll("\x04[L4D2CS] \x03Switching campaign to \x04%s", g_strCampaignName[iMapIndex + 1]);
...
ChangeScavengeMap()
{
	...
	if(g_bVotingEnabled == true && g_iWinningMapVotes > 0 && g_iWinningMapIndex >= 0)
	{
		...
		{
			PrintToChatAll("\x04[L4D2CS] \x03Switching map to the vote winner: \x04%s", g_strScavengeMapName[g_iWinningMapIndex]);
	...
	for(new iMapIndex = 0; iMapIndex < NUMBER_OF_SCAVENGE_MAPS; iMapIndex++)
	{
		if(StrEqual(strCurrentMap, g_strScavengeMap[iMapIndex]) == true)
		{
			...
			{
				PrintToChatAll("\x04[L4D2CS] \x03Switching map to \x04%s", g_strScavengeMapName[iMapIndex + 1]);
...
DisplayNextMapToAll()
{
	...
	if(g_iWinningMapIndex >= 0)
	{
		...
		else if(g_iNextMapAdDisplayMode == DISPLAY_MODE_CHAT)
		{
			...
			if(g_iGameMode == GAMEMODE_SCAVENGE)
				PrintToChatAll("\x04[L4D2CS] \x01The next map is: \x04%s. \x01Type \x03!mapvote \x01to vote.", g_strScavengeMapName[g_iWinningMapIndex]);
			else
				PrintToChatAll("\x04[L4D2CS] \x01The next campaign is: \x04%s. \x01Type \x03!mapvote \x01to vote.", g_strCampaignName[g_iWinningMapIndex]);
		}
	}
	else
	{
			...
			for(new iMapIndex = 0; iMapIndex < NUMBER_OF_SCAVENGE_MAPS; iMapIndex++)
			{
				if(StrEqual(strCurrentMap, g_strScavengeMap[iMapIndex]) == true)
				{
					...
					if(g_iNextMapAdDisplayMode == DISPLAY_MODE_HINT)
						...
						PrintToChatAll("\x03[L4D2CS] \x01The next map is: \x04%s. \x01Type \x03!mapvote \x01to vote.", g_strScavengeMapName[iMapIndex + 1]);
				}
			}
		}
		else
		{
			...
			if(StrEqual(strCurrentMap, g_strCampaignLastMap[LastCM]) == true)
			{
				...
				if(g_iNextMapAdDisplayMode == DISPLAY_MODE_HINT)
					...
					PrintToChatAll("\x03[L4D2CS] \x01The next campaign is: \x04%s. \x01Type \x05!mapvote \x01to vote.", g_strCampaignName[0]);
			}
			else
			{
				//Go through all maps and to find which map index it is on, and then switch to the next map
				for(new iMapIndex = 0; iMapIndex < NUMBER_OF_CAMPAIGNS; iMapIndex++)
				{
					if(StrEqual(strCurrentMap, g_strCampaignLastMap[iMapIndex]) == true)
					{
						...
						if(g_iNextMapAdDisplayMode == DISPLAY_MODE_HINT)
							...
							PrintToChatAll("\x03[L4D2CS] \x01The next campaign is: \x04%s. \x01Type \x05!mapvote \x01to vote.", g_strCampaignName[iMapIndex + 1]);
					}
				}
			}
		}
...
public Action:MapVote(iClient, args)
{
	...
	{
		PrintToChat(iClient, "\x03[L4D2CS] \x04Voting has been disabled on this server.");
		return;
	}
	
	if(OnFinaleOrScavengeMap() == false)
	{
		PrintToChat(iClient, "\x03[L4D2CS] \x04Voting is only enabled on a Scavenge or finale map.");
		return;
	}
...
public Action:DisplayCurrentVotes(iClient, args)
{
	...
	{
		if(g_iGameMode == GAMEMODE_SCAVENGE)
			PrintToChat(iClient, "\x04[L4D2CS] \x03Currently winning the vote: \x04%s", g_strScavengeMapName[g_iWinningMapIndex]);
		else
			PrintToChat(iClient, "\x04[L4D2CS] \x03Currently winning the vote: \x04%s", g_strCampaignName[g_iWinningMapIndex]);
	}
	else
		PrintToChat(iClient, "\x04[L4D2CS] \x03No one has voted yet.");
	...
	for(new iClient = 1;iClient <= MaxClients; iClient++)
	{
		if(g_bClientShownVoteAd[iClient] == false && g_bClientVoted[iClient] == false && IsClientInGame(iClient) == true && IsFakeClient(iClient) == false)
		{
			switch(g_iVotingAdDisplayMode)
			{
				...
				case DISPLAY_MODE_CHAT: PrintToChat(iClient, "\x03[L4D2CS] \x01To vote for the next map, type: \x04!mapvote\n           \x01To see all the votes, type: \x04!mapvotes");
			}
...
SetTheCurrentVoteWinner()
{
	...
	if(g_iWinningMapIndex > -1 && iOldWinningMapIndex != g_iWinningMapIndex)
	{
		...
		if(g_iGameMode == GAMEMODE_SCAVENGE)
			PrintToChatAll("\x03[L4D2CS] \x04%s \x03is now winning the vote.", g_strScavengeMapName[g_iWinningMapIndex]);
		else
			PrintToChatAll("\x03[L4D2CS] \x04%s \x03is now winning the vote.", g_strCampaignName[g_iWinningMapIndex]);
	}
}
