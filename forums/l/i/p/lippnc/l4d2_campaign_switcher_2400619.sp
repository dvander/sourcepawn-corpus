...
/*==================================================================================================
	...
	Change Log
		v3.0 (Sept 22, 2016)	- Added 12 more custom campaigns bringing the total to 222 maps
...
#define NUMBER_OF_CAMPAIGNS			222		/* CHANGE TO MATCH THE TOTAL NUMBER OF CAMPAIGNS */
...
{	
	...
	Format(g_strCampaignFirstMap[207], 32, "1_arklay_mansion");
	...
	Format(g_strCampaignLastMap[125], 32, "reactor_02_core");
	...
	Format(g_strCampaignLastMap[207], 32, "6_arklay_finale");
	...
	Format(g_strCampaignName[129], 32, "Cold Case");
...
public OnPluginStart()
{
	...
	g_hCVar_VotingEnabled = CreateConVar("l4d2cs_voting_system_enabled", "1", "Enables players to vote for the next map or campaign [0 = DISABLED, 1 = ENABLED], true, 0.0, true, 1.0");
	g_hCVar_VoteWinnerSoundEnabled = CreateConVar("l4d2cs_voting_sound_enabled", "1", "Determines if a sound plays when a new map is winning the vote [0 = DISABLED, 1 = ENABLED], true, 0.0, true, 1.0");
	g_hCVar_VotingAdMode = CreateConVar("l4d2cs_voting_ad_mode", "1", "Sets how to advertise voting at the start of the map [0 = DISABLED, 1 = HINT TEXT, 2 = CHAT TEXT, 3 = OPEN VOTE MENU]\n * Note: This is only displayed once during a finale or scavenge map *, true, 0.0, true, 3.0");
	...
	g_hCVar_NextMapAdMode = CreateConVar("l4d2cs_next_map_ad_mode", "1", "Sets how the next campaign/map is advertised during a finale or scavenge map [0 = DISABLED, 1 = HINT TEXT, 2 = CHAT TEXT], true, 0.0, true, 2.0");
	g_hCVar_NextMapAdInterval = CreateConVar("l4d2cs_next_map_ad_interval", "600.0", "The time, in seconds, between advertisements for the next campaign/map on finales and scavenge maps, true, 60.0, false");
	g_hCVar_MaxFinaleFailures = CreateConVar("l4d2cs_max_coop_finale_failures", "0", "The amount of times the survivors can fail a finale in Coop before it switches to the next campaign [0 = INFINITE FAILURES], FCVAR_PLUGIN, true, 0.0, false");
