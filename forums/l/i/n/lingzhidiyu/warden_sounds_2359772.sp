...
warden_RemovedMessage() {
	...
	PrintToChatAll(" \x0BVodja zapora je \x02umrl, \x0Bce ni izbran nov bo cez 20 sekund freeday");
	PrintToChatAll(" \x0BVodja zapora je \x02umrl, \x0Bce ni izbran nov bo cez 20 sekund freeday");
}

warden_UnWardenMessage() {
	EmitSoundToAllAny("sourcemod/warden/uwarden.mp3");
	PrintToChatAll(" \x0BVodja zapora se je \x02upokojil");
	PrintToChatAll(" \x0BVodja zapora se je \x02upokojil");
}