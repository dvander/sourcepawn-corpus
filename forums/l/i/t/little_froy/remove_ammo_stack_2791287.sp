...
void next_frame_ammo_stack(int ref)
{
...
void next_frame_prop_dynamic(int ref)
{
    int entity = EntRefToEntIndex(ref);
    if(entity != -1)
    {
...
void OnSpawnPost_ammo_stack(int entity)
{
    RequestFrame(next_frame_ammo_stack, EntIndexToEntRef(entity));
}

void OnSpawnPost_prop_dynamic(int entity)
{
...
public void OnEntityCreated(int entity, const char[] classname)
{
    ...
    {
        SDKHook(entity, SDKHook_SpawnPost, OnSpawnPost_ammo_stack);
    }
    else if(strcmp(classname, "prop_dynamic") == 0)
    {
        SDKHook(entity, SDKHook_SpawnPost, OnSpawnPost_prop_dynamic);
    }
}
...
{
    CreateConVar("remove_ammo_stack_version", PLUGIN_VERSION, "version of Remove Ammo Stack", FCVAR_NOTIFY | FCVAR_DONTRECORD);
