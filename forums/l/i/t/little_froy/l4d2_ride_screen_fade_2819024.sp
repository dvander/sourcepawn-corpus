...
#define PLUGIN_VERSION                "1.0.0 modded by little_froy"
...
public void OnPluginStart()
{
    ...
    g_hCvar_Enabled         = CreateConVar("l4d2_ride_screen_fade_enable", "1", "Enable/Disable the plugin.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_Color           = CreateConVar("l4d2_ride_screen_fade_color", "20 0 0", "Fade color.\nUse \"random\" for random colors.\nUse three values between 0-255 separated by spaces (\"<0-255> <0-255> <0-255>\").", CVAR_FLAGS);
    g_hCvar_Alpha           = CreateConVar("l4d2_ride_screen_fade_alpha", "245", "Fade alpha transparency.\n0 = Invisible, 255 = Fully Visible.", CVAR_FLAGS, true, 0.0, true, 255.0);
    g_hCvar_FadeOutDuration = CreateConVar("l4d2_ride_screen_fade_out_duration", "0.5", "Fade out (start) duration in seconds.", CVAR_FLAGS, true, 0.0);
    g_hCvar_FadeInDuration  = CreateConVar("l4d2_ride_screen_fade_in_duration", "0.5", "Fade in (end) duration in seconds.", CVAR_FLAGS, true, 0.0);
    g_hCvar_Block           = CreateConVar("l4d2_ride_screen_fade_block", "1", "Block other fade effects applied to the client while on plugin fade.\nExample: Red screen when take damage.\n0 = Disable, 1 = Enable.", CVAR_FLAGS, true, 0.0, true, 1.0);
    ...
    // Admin Commands
    RegAdminCmd("sm_ridefade", CmdRideFade, ADMFLAG_ROOT, "Add a fade effect on self (no args) or specified targets. Example: self -> sm_ridefade / target -> sm_ridefade @humans.");
    RegAdminCmd("sm_print_cvars_l4d2_ride_screen_fade", CmdPrintCvars, ADMFLAG_ROOT, "Print the plugin related cvars and their respective values to the console.");
}
...
{
    RequestFrame(next_frame, event.GetInt("victim"));
}
