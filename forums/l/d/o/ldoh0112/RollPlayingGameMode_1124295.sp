...
public OnPluginStart()
{
	...
	LvUpExp21 = CreateConVar("sm_LvUpExp21","3550","Required EXP to be Level 21", FCVAR_PLUGIN)
	LvUpExp22 = CreateConVar("sm_LvUpExp22","3900","Required EXP to be Level 22", FCVAR_PLUGIN)
	LvUpExp23 = CreateConVar("sm_LvUpExp23","4300","Required EXP to be Level 23", FCVAR_PLUGIN)
	LvUpExp24 = CreateConVar("sm_LvUpExp24","4750","Required EXP to be Level 24", FCVAR_PLUGIN)
	LvUpExp25 = CreateConVar("sm_LvUpExp25","5250","Required EXP to be Level 25", FCVAR_PLUGIN)
	LvUpExp26 = CreateConVar("sm_LvUpExp26","5800","Required EXP to be Level 26", FCVAR_PLUGIN)
	LvUpExp27 = CreateConVar("sm_LvUpExp27","7400","Required EXP to be Level 27", FCVAR_PLUGIN)
	LvUpExp28 = CreateConVar("sm_LvUpExp28","8050","Required EXP to be Level 28", FCVAR_PLUGIN)
	LvUpExp29 = CreateConVar("sm_LvUpExp29","8750","Required EXP to be Level 29", FCVAR_PLUGIN)
	LvUpExp30 = CreateConVar("sm_LvUpExp30","9500","Required EXP to be Level 30", FCVAR_PLUGIN)
