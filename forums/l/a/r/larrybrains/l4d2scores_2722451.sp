...
PrepareAllSDKCalls()
{
	...
	if(!PrepSDKCall_SetFromConf(gConf, SDKConf_Signature, "RestartScenarioFromVote"))
	{
	...
	if(!PrepSDKCall_SetFromConf(gConf, SDKConf_Signature, "SwapTeams"))
	{
	...
	if(!PrepSDKCall_SetFromConf(gConf, SDKConf_Signature, "AreTeamsFlipped"))
	{
