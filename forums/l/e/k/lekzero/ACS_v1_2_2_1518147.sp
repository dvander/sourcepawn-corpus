...
#define NUMBER_OF_SCAVENGE_MAPS		14		/* CHANGE TO MATCH THE TOTAL NUMBER OF SCAVENGE MAPS */
...
{	
	...
	Format(g_strScavengeMap[13], 32, "c11m4_terminal");
	...
	Format(g_strScavengeMapName[13], 32, "The Terminal");
}
