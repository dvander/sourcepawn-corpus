...
#define PLUGIN_VERSION		"3.04" //August 28, 2011
...
public Action:Event_PlayerHurt(Handle:event, const String:name[], bool:dontBroadcast)
{
	new client = GetClientOfUserId(GetEventInt(event, "userid"));
	new weapon = GetEventInt(event, "weaponid");
	if (weapon == TF_WEAPON_SNIPERRIFLE && TF2_IsPlayerInCondition(client, TFCond_Jarated))		//used to be TF2_GetPlayerConditionFlags(client) & TF_CONDFLAG_JARATED
	{
...
{
	new client = GetClientOfUserId(GetEventInt(event, "userid"));
	CreateTimer(0.1, Timer_LockerWeaponReset, any:GetClientUserId(client));
}
...
//The Diamondback
	...
	SetTrieString(g_hItemInfoTrie, "525_attribs", "296 ; 1 ; 1 ; 0.85 ; 15 ; 0");
	SetTrieValue(g_hItemInfoTrie, "525_ammo", 20);
...
//The Machina
	...
	SetTrieString(g_hItemInfoTrie, "526_attribs", "308 ; 1 ; 297 ; 1 ; 304 ; 1.15 ; 305 ; 1");
	SetTrieValue(g_hItemInfoTrie, "526_ammo", 20);
...
//The Widowmaker
	...
	SetTrieString(g_hItemInfoTrie, "527_attribs", "298 ; 60 ; 301 ; 1 ; 307 ; 1 ; 303 ; -1 ; 299 ; 100");
	SetTrieValue(g_hItemInfoTrie, "527_ammo", -1);
...
//The Short Circuit
	...
	SetTrieString(g_hItemInfoTrie, "528_attribs", "298 ; 35 ; 300 ; 1 ; 301 ; 1 ; 307 ; 1 ; 303 ; -1 ; 15 ; 0");
	SetTrieValue(g_hItemInfoTrie, "528_ammo", -1);
...
//	SetTrieValue(g_hItemInfoTrie, "19010_index", 18);
//	SetTrieValue(g_hItemInfoTrie, "19010_slot", 0);
//	SetTrieValue(g_hItemInfoTrie, "19010_quality", 6);
//	SetTrieValue(g_hItemInfoTrie, "19010_level", 25);
//	SetTrieString(g_hItemInfoTrie, "19010_attribs", "111 ; -10 ; 225 ; 0.75");
//	SetTrieValue(g_hItemInfoTrie, "19010_ammo", -1);

//Pocket Shotgun
	SetTrieString(g_hItemInfoTrie, "19010_classname", "tf_weapon_shotgun_soldier");
	SetTrieValue(g_hItemInfoTrie, "19010_index", 10);
	SetTrieValue(g_hItemInfoTrie, "19010_slot", 1);
	SetTrieValue(g_hItemInfoTrie, "19010_quality", 4);
	SetTrieValue(g_hItemInfoTrie, "19010_level", 10);
	SetTrieString(g_hItemInfoTrie, "19010_attribs", "233 ; 1.20 ; 234 ; 1.3");
	SetTrieValue(g_hItemInfoTrie, "19010_ammo", 32);
...
stock RemovePlayerBooties(client)
{
	...
	while((edict = FindEntityByClassname2(edict, "tf_wearable")) != -1)
	{
		...
		{
			new idx = GetEntProp(edict, Prop_Send, "m_iItemDefinitionIndex");
			if (idx == 405 && GetEntPropEnt(edict, Prop_Send, "m_hOwnerEntity") == client && !GetEntProp(edict, Prop_Send, "m_bDisguiseWearable"))
			{
				RemoveEdict(edict);
			}
		}
...
//			g_bIsPlayerTarged[client] = true;
			...
			pChargeTiming[client] = CreateTimer(chargetime, Timer_TargeReset, any:GetClientUserId(client));
		}
	}
...
DoResetChargeTimer(client, bool:end)
{
	...
	if (end) pChargeTiming[client] = CreateTimer(12.0, Timer_TargeCharged, any:GetClientUserId(client));
}
