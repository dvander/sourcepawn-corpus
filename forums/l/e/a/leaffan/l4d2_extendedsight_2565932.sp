...
public OnPluginStart()
{
	...
	PluginCvarMode = CreateConVar("l4d2_extendedsight_mode", "0", "When to reward Survivors with Extended Sight? 1 - when Tank is killed, 2 - when Witch is killed, 3 - when Tank or Witch is killed, 4 - active all the time, 0 - disabled", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 4.0);
	PluginCvarNotify = CreateConVar("l4d2_extendedsight_notify", "0", "Notify players when they gain Extended Sight? 0 - disable, 1 - hintbox, 2 - chat", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 2.0);
	PluginCvarDuration = CreateConVar("l4d2_extendedsight_duration", "30", "How long should the Extended Sight last?", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 10.0);
	PluginCvarGlow = CreateConVar("l4d2_extendedsight_glowcolor", "255 75 75", "Glow color, use RGB, seperate values with spaces", FCVAR_PLUGIN|FCVAR_NOTIFY);
	PluginCvarGlowMode = CreateConVar("l4d2_extendedsight_glowmode", "0", "Glow mode. 0 - persistent glow, 1 - fading glow", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	PluginCvarGlowFadeInterval = CreateConVar("l4d2_extendedsight_glowfadeinterval", "3", "Interval between each glow fade", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 1.5, true, 10.0);
	...
	PluginCvarModesOff = CreateConVar("l4d2_extendedsight_modes_off", "", "Plugin will be disabled on these game modes. Empty = None", FCVAR_PLUGIN|FCVAR_NOTIFY);
