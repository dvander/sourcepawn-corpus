...
void initPluginSettings()
{
	...
	PluginSettings.hStartPoints   = CreateConVar("l4d2_points_start", "30", "Points to start each round/map with.");
...
void initItemCosts()
{
	...
	ItemCosts.CostHealthKit          = CreateConVar("l4d2_points_medkit", "50", "How many points the health kit costs");
	...
	ItemCosts.CostHeal               = CreateConVar("l4d2_points_survivor_heal", "65", "How many points a complete heal costs");
	...
	ItemCosts.CostAK47               = CreateConVar("l4d2_points_ak47", "20", "How many points the ak47 rifle costs");
	ItemCosts.CostSG552              = CreateConVar("l4d2_points_sg552", "25", "How many points the sg552 rifle costs");
	ItemCosts.CostM60                = CreateConVar("l4d2_points_m60", "50", "How many points the m60 rifle costs");

	// Snipers
	ItemCosts.CostHunting            = CreateConVar("l4d2_points_hunting", "30", "How many points the hunting rifle costs");
	ItemCosts.CostScout              = CreateConVar("l4d2_points_scout", "20", "How many points the scout sniper rifle costs");
	ItemCosts.CostMilitary           = CreateConVar("l4d2_points_military", "25", "How many points the military sniper rifle costs");
	ItemCosts.CostAWP                = CreateConVar("l4d2_points_awp", "35", "How many points the awp sniper rifle costs");

	// Shotguns
	ItemCosts.CostChrome             = CreateConVar("l4d2_points_chrome", "15", "How many points the chrome shotgun costs");
	ItemCosts.CostPump               = CreateConVar("l4d2_points_pump", "15", "How many points the pump shotgun costs");
	ItemCosts.CostSPAS               = CreateConVar("l4d2_points_spas", "20", "How many points the spas shotgun costs");
	ItemCosts.CostAuto               = CreateConVar("l4d2_points_auto", "19", "How many points the autoshotgun costs");

	// Throwables
	ItemCosts.CostMolotov            = CreateConVar("l4d2_points_molotov", "13", "How many points the molotov costs");
	ItemCosts.CostPipe               = CreateConVar("l4d2_points_pipe", "13", "How many points the pipe bomb costs");
	ItemCosts.CostBile               = CreateConVar("l4d2_points_bile", "13", "How many points the bile jar costs");

	// Misc
	ItemCosts.CostChainsaw           = CreateConVar("l4d2_points_chainsaw", "15", "How many points the chainsaw costs");
	ItemCosts.CostGrenade            = CreateConVar("l4d2_points_grenade", "50", "How many points the grenade launcher costs");
	ItemCosts.CostGnome              = CreateConVar("l4d2_points_gnome", "8", "How many points the gnome costs");
	ItemCosts.CostCola               = CreateConVar("l4d2_points_cola", "15", "How many points cola bottles costs");
	ItemCosts.CostGasCan             = CreateConVar("l4d2_points_gascan", "15", "How many points the gas can costs");
	ItemCosts.CostPropane            = CreateConVar("l4d2_points_propane", "11", "How many points the propane tank costs");
	ItemCosts.CostFireworks          = CreateConVar("l4d2_points_fireworks", "15", "How many points the fireworks crate costs");
	ItemCosts.CostOxygen             = CreateConVar("l4d2_points_oxygen", "8", "How many points the oxgen tank costs");
	
	// Upgrades
	ItemCosts.CostExplosivePack      = CreateConVar("l4d2_points_explosive_ammo_pack", "20", "How many points the explosive ammo pack costs");
	ItemCosts.CostFirePack           = CreateConVar("l4d2_points_incendiary_ammo_pack", "20", "How many points the incendiary ammo pack costs");
	ItemCosts.CostAmmo               = CreateConVar("l4d2_points_refill", "8", "How many points an ammo refill costs");
	ItemCosts.CostExplosiveAmmo      = CreateConVar("l4d2_points_explosive_ammo", "15", "How many points the explosive ammo costs");
	ItemCosts.CostFireAmmo           = CreateConVar("l4d2_points_incendiary_ammo", "15", "How many points the incendiary ammo costs");
	ItemCosts.CostLaserSight         = CreateConVar("l4d2_points_laser", "25", "How many points the laser sight costs");

	// Melee
	ItemCosts.CostBaseballbat        = CreateConVar("l4d2_points_baseballbat", "10", "How many points the baseball bat costs");
	ItemCosts.CostCricketbat         = CreateConVar("l4d2_points_cricketbat", "10", "How many points the cricket bat costs");
	ItemCosts.CostCrowbar            = CreateConVar("l4d2_points_crowbar", "10", "How many points the crowbar costs");
	ItemCosts.CostElectricguitar     = CreateConVar("l4d2_points_electricguitar", "10", "How many points the electric guitar costs");
	ItemCosts.CostFireaxe            = CreateConVar("l4d2_points_fireaxe", "15", "How many points the fire axe costs");
	ItemCosts.CostFryingpan          = CreateConVar("l4d2_points_fryingpan", "10", "How many points the frying pan costs");
	ItemCosts.CostGolfclub           = CreateConVar("l4d2_points_golfclub", "10", "How many points the golf club costs");
	ItemCosts.CostKatana             = CreateConVar("l4d2_points_katana", "20", "How many points the katana costs");
	ItemCosts.CostMachete            = CreateConVar("l4d2_points_machete", "15", "How many points the machete costs");
	ItemCosts.CostTonfa              = CreateConVar("l4d2_points_tonfa", "10", "How many points the nightstick costs");
	ItemCosts.CostHuntingknife       = CreateConVar("l4d2_points_hunting_knife", "10", "How many points the hunting knife costs");
	ItemCosts.CostRiotshield         = CreateConVar("l4d2_points_riotshield", "10", "How many points the riotshield costs");
	ItemCosts.CostShovel             = CreateConVar("l4d2_points_shovel", "10", "How many points the shovel costs");
	ItemCosts.CostPitchfork          = CreateConVar("l4d2_points_pitchfork", "10", "How many points the pitchfork costs");

	// Infected
	ItemCosts.CostSuicide            = CreateConVar("l4d2_points_suicide", "7", "How many points does suicide cost");
...
public Action Reminder(Handle hTimer, int userid)
{
	...
	{
		PrintToChat(iClientIndex, "%s !buy'daki puanınız: %d. Bilgi: Steam grubu üyeleri her 10 dakika da bir 30 puan alır!", MSGTAG, PlayerData[iClientIndex].iPlayerPoints);
		PrintToChat(iClientIndex, "%s !buy'daki puanınız: %d. CEZA BİLGİSİ!: Puanı ölü iken kullanmaya çalışırsanız puanınız kesilecektir!", MSGTAG, PlayerData[iClientIndex].iPlayerPoints);	
		PrintHintText(iClientIndex, "[PS] !buy'daki puanınız: %d. Bilgi: Steam grubu üyeleri her 10 dakika da bir 30 puan alır!", PlayerData[iClientIndex].iPlayerPoints);
		PrintCenterText(iClientIndex, "[PS] !buy'daki puanınız: %d. Bilgi: Steam grubu üyeleri her 10 dakika da bir 30 puan alır!", PlayerData[iClientIndex].iPlayerPoints);
	}
}
...
public Action RewardMembers(Handle hTimer)
{
	for(int i = 1; i <= MaxClients; i++)
	{
		if(0 < i <= MaxClients && IsClientConnected(i) && !IsFakeClient(i))
		{
			...
			{
				PlayerData[i].iPlayerPoints += 30;
				SaveData(i);
				PrintToChat(i, "%s Steam grubu üyesi olduğunuz için \x03 30 \x01 puan kazandınız!", MSGTAG);
			}
			else
			{
				PrintToChat(i, "%s Steam grubumuza katılarak her 10 dakikada bir \x03 30\x01puan kazanabilirsiniz!\x04 'H' tuşuna basın \x01ve topluluğumuzun bir parçası olun!", MSGTAG);
			}
		}
	}
}
	...
	if(IsModEnabled() && iNumArguments == 0)
	{
		if(IsClientPlaying(iClientIndex))
		{
			...
			if(!CheckCommandAccess(iClientIndex, "sm_perks", ADMFLAG_CUSTOM1, true))
				ReplyToCommand(iClientIndex, "%s\x03 Açıklama:\x04 'H' tuşuna basın\x03 ve bir dahaki sefere puanlarınızı kaydetmek için Steam grubumuza katılın!\x04 (Üye olmayanlar her haritada 30 puan ile başlar.)", MSGTAG);
		}
	}
	return Plugin_Handled;
}
	...
	if(args == 2)
	{
		...
		else
		{
			for (int i = 0; i < target_count; i++)
			{
				...
				PrintToChat(targetclient, "%s %N'den %d, puan aldınız!", MSGTAG, amount, client);
			}
			return Plugin_Handled;
		}
	}
	...
	if(args == 2)
	{
		...
		else
		{
			...
			for (int i = 0; i < target_count; i++)
			{
				...
				PrintToChat(targetclient, "%s %N, puanlarınızı '%d' olarak ayarladı!", MSGTAG, client, amount);
			}
			return Plugin_Handled;
		}
	}
