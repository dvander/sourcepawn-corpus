...
public OnPluginStart()
{
	...
	AutoExecConfig(true, "AdvancedInfiniteAmmo.cfg");
}
...
GiveInfiniteAmmo(client, iWeapon)
{
	...
	switch(GetEntProp(iWeapon, Prop_Send, "m_iItemDefinitionIndex"))
	{
		...
		case 9,10,11,12,13,16,17,18,19,20,22,23,24,36,45,61,127,130,160,161,
			...
			294,308,412,414,415,425,449,460,513,658,661,669,773,797,800,
			806,808,809,886,888,889,895,897,898,904,906,907,913,915,916,
			962,964,965,971,973,974,996,997,1006,1007:
		{
		...
		case 21,39,40,42,56,58,159,208,215,305,311,351,433,659,740,741,798,799,
		...
		case 44, 648:
		{
			...
			//if(!CheckCommandAccess(client, "sm_aia_adminflag", ADMFLAG_GENERIC)) return;
			SetAmmo(client, iWeapon);
		}
...
stock SetAmmo(client, iWeapon, iAmmo = 499)
{
