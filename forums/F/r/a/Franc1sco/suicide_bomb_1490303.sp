...
public OnPluginStart()
{
	...
	// Commands
	RegAdminCmd("sm_bomb", Bomb_Menu, ADMFLAG_GENERIC); // Open the Bomb Menu
	RegAdminCmd("sm_detonate", Command_Detonate, ADMFLAG_GENERIC); // Detonate the Bomb
	RegAdminCmd("sm_boom", Command_Detonate, ADMFLAG_GENERIC); // Detonate the Bomb
