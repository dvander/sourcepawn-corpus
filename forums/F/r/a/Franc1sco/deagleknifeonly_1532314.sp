...
{
	CreateConVar("sm_OnlyDeagleKnife", PLUGIN_VERSION, "version", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);
...
public Action:OnWeaponCanUse(client, weapon)
{
  ...
  if (StrEqual(sClassname, "weapon_deagle") || StrEqual(sClassname, "weapon_knife"))
  {
