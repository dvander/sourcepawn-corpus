...
public OnPluginStart()
{
	...
	g_Earn = CreateConVar("sm_huntermode_earning", "2", "value that divide the seconds survived and the result is the credits that are given to the player");
...
public CreditsCallback(accountId, any:pack)
{
	...
	PrintToChat(client, "\x04[Store]\x01 You have successfully earned %i cash for survive %i seconds this round.", iPTG, Survived[client]);
}
