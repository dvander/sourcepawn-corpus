...
#define PLUGIN_VERSION "1.37BETA"
...
stock bool:CheckToChangeMapDoors()
{
	...
	if (!FileExists(s))
	{
		if (strncmp(currentmap, "vsh_partyisland", 15, false) == 0) checkdoors = false;
		else if (strncmp(currentmap, "arena_nucleus", 13, false) == 0) checkdoors = false;
		else if (strncmp(currentmap, "arena_grid_walls", 16, false) == 0) checkdoors = false;
