...
public OnMapStart()
{
	CreateTimer(4.9, Timer_RespawnAnnotations, _, TIMER_FLAG_NO_MAPCHANGE|TIMER_REPEAT);
	g_AnnotationCount=0;
}
...
public Action:Command_Annotate(client, args)
{
	...
	decl String:args1[256]; decl String:annotations[2][256];
	new Float:timefloat;
	GetCmdArgString(args1, sizeof(args1));
	ExplodeString(args1, ",, ", annotations, 2, 256);
