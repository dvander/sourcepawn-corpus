...
#define PLUGIN_VERSION "2.1y"
#define SOUND_THUNDER "ambient/explosions/explode_9.wav"
#define SOUND_THUNDER2 "ambient/halloween/thunder_04.wav"
#define SOUND_THUNDER3 "ambient/thunder2.wav"

public Plugin:myinfo =
{
	name = "Admin Smite",
	author = "Hipster, Bacardi mess this",
	description = "Slay players with a lightning bolt effect, dissolve ragdoll",
...
PerformSmite(client, target)
{
	...
	EmitAmbientSound(SOUND_THUNDER2, startpos, client, SNDLEVEL_RAIDSIREN);
	EmitAmbientSound(SOUND_THUNDER3, startpos, client, SNDLEVEL_RAIDSIREN);
