...
public GotDatabase(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	...
	/* Create table in database
		...
		PRIMARY KEY ( `steamid` ))
	*/
	if(!SQL_FastQuery(hDatabase, "CREATE TABLE IF NOT EXISTS `stb2` (`steamid` VARCHAR( 20 ) NOT NULL , `unixtime` INT NOT NULL , `duration` INT NOT NULL , `date` DATETIME NOT NULL, PRIMARY KEY ( `steamid` ))"))
	{
...
public T_SaveSteamID(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	...
	decl String:entersql[300], String:auth[25], timestamp, duration; entersql[0] = '\0', auth[0] = '\0';
