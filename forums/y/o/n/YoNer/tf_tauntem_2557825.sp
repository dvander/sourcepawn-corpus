...
#define PLUGIN_VERSION "1.0.0.3y"

public Plugin:myinfo =
{
	name = "[TF2] Taunt 'em",
	author = "FlaminSarge edited by Xven and YoNer",
...
public OnPluginStart()
{
	...
	PrecacheModel("models/player/items/taunts/engys_new_chair/engys_new_chair_articlulated.mdl", true);
	...
	PrecacheModel("models/workshop/player/items/all_class/taunt_burstchester/taunt_burstchester_demo.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/taunt_burstchester/taunt_burstchester_engineer.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/taunt_burstchester/taunt_burstchester_heavy.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/taunt_burstchester/taunt_burstchester_spy.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/taunt_burstchester/taunt_burstchester_medic.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/taunt_burstchester/taunt_burstchester_pyro.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/taunt_burstchester/taunt_burstchester_soldier.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/taunt_burstchester/taunt_burstchester_scout.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/taunt_burstchester/taunt_burstchester_sniper.mdl",true);
	PrecacheModel("models/workshop/player/items/demo/taunt_scotsmans_stagger/taunt_scotsmans_stagger.mdl",true);
	PrecacheModel("models/workshop/player/items/sniper/taunt_didgeridrongo/taunt_didgeridrongo.mdl",true);
	PrecacheModel("models/workshop/player/items/sniper/taunt_most_wanted/taunt_most_wanted.mdl",true);
	PrecacheModel("models/workshop/player/items/soldier/taunt_maggots_condolence/taunt_maggots_condolence.mdl",true);
	PrecacheModel("models/workshop/player/items/spy/taunt_spy_boxtrot/taunt_spy_boxtrot.mdl",true);
	PrecacheModel("models/workshop/player/items/soldier/fumblers_fanfare/fumblers_fanfare.mdl",true);
	PrecacheModel("models/workshop/player/items/demo/bagpipes/bagpipes.mdl",true);
	PrecacheModel("models/workshop/player/items/engineer/bucking_bronco/bucking_bronco.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/secondrate_sorcery/secondrate_sorcery_demo.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/secondrate_sorcery/secondrate_sorcery_engineer.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/secondrate_sorcery/secondrate_sorcery_heavy.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/secondrate_sorcery/secondrate_sorcery_spy.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/secondrate_sorcery/secondrate_sorcery_medic.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/secondrate_sorcery/secondrate_sorcery_pyro.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/secondrate_sorcery/secondrate_sorcery_soldier.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/secondrate_sorcery/secondrate_sorcery_scout.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/secondrate_sorcery/secondrate_sorcery_sniper.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/zoomin_broom/zoomin_broom_demo.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/zoomin_broom/zoomin_broom_engineer.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/zoomin_broom/zoomin_broom_heavy.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/zoomin_broom/zoomin_broom_spy.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/zoomin_broom/zoomin_broom_medic.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/zoomin_broom/zoomin_broom_pyro.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/zoomin_broom/zoomin_broom_soldier.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/zoomin_broom/zoomin_broom_scout.mdl",true);
	PrecacheModel("models/workshop/player/items/all_class/zoomin_broom/zoomin_broom_sniper.mdl",true);
	PrecacheModel("models/workshop/player/items/pyro/spring_rider/spring_rider.mdl", true);
	PrecacheModel("models/player/items/heavy/heavy_table_flip_prop.mdl",true);
	PrecacheModel("models/player/items/heavy/heavy_table_flip_joule_prop.mdl",true);
	PrecacheModel("models/player/items/heavy/brutal_guitar.mdl",true); 
...
public Action:Tauntme_Menu(client)
{
	...
	switch(class)
	{
		...
		case TFClass_Heavy:
		{
			AddMenuItem(menu, "30616", "(Heavy)The Proletariat Posedown");
		...
		case TFClass_Pyro:
		{
			...
			AddMenuItem(menu, "30876", "(Pyro)Headcase");
		}
		case TFClass_Spy:
		{
			AddMenuItem(menu, "1108", "(Spy)Buy A Life Taunt");
			AddMenuItem(menu, "30615","(Spy)The Box Trot");
...
public Action:Cmd_Tauntem_List(client, args)
{
	...
	PrintToConsole(client, "-1157: The Kazotsky Kick");
	PrintToConsole(client, "-30570: Pool Party Taunt");
	PrintToConsole(client, "-30572: The Boston Breakdance Taunt");
	PrintToConsole(client, "-30609: The Killer Solo Taunt");
	PrintToConsole(client, "-30614: Most Wanted Taunt");
	PrintToConsole(client, "-30616: The Proletariat Posedown Taunt");
	PrintToConsole(client, "-30615: The Box Trot Taunt");
	PrintToConsole(client, "-1157: The Kazotsky Kick Taunt");
	PrintToConsole(client, "-30621: The Burstchester Taunt");
	PrintToConsole(client, "-30673: Requiem Taunt");
	PrintToConsole(client, "-30672: Zooming Broom Taunt");
	PrintToConsole(client, "-1162: Mannrobics Taunt");
	PrintToConsole(client, "-30671: Bad Pipes Taunt");
	PrintToConsole(client, "-30618: Bucking Bronco Taunt");
	PrintToConsole(client, "-30762: Disco Fever Taunt");
	PrintToConsole(client, "-30763: Balloonibouncer Taunt");
	PrintToConsole(client, "-30761: The Fubar Fanfare Taunt");
	PrintToConsole(client, "-1168: The Carlton Taunt");
	PrintToConsole(client, "-1172: The Victory Lap Taunt");
	PrintToConsole(client, "-30816: The Second Rate Sorcery Taunt");
	PrintToConsole(client, "-1174: The Table Tantrum taunt");
	PrintToConsole(client, "-30840: The Scotsmann's Stagger Taunt");
	PrintToConsole(client, "-30839: The Didgeridrongo Taunt");
	PrintToConsole(client, "-30843: Russian Arms Race Taunt");
	PrintToConsole(client, "-30844: Soviet Strongarm Taunt");
	PrintToConsole(client, "-30842: Dueling Banjo Taunt");
	PrintToConsole(client, "-30845: Jumping Jack Taunt");
	PrintToConsole(client, "-30876: Headcase taunt");
	PrintToConsole(client, "-1182: Yeti Punch Taunt");
	PrintToConsole(client, "-1183: Yeti Smash Taunt");
