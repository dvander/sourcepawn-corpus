...
public Plugin:myinfo =
{
	...
	author      = "Tsunami, and Erreur500, Sounds fix from Phaiz  by YoNer",
...
public Event_PlayerClass(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if(!(GetConVarBool(g_hImmunity) && IsImmune(iClient)) && !IsDuelRestrictionClass(iClient) && IsFull(iTeam, iClass))
	{
...
public Event_PlayerSpawn(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if(!(GetConVarBool(g_hImmunity) && IsImmune(iClient)) && !IsDuelRestrictionClass(iClient) && IsFull(iTeam, (g_iClass[iClient] = _:TF2_GetPlayerClass(iClient))))
	{
		ShowVGUIPanel(iClient, iTeam == TF_TEAM_BLU ? "class_blue" : "class_red");
