...
#define PLUGIN_VERSION "2.4beta4"
...
/* Annonce */
#define MSG_VERSION			"{olive}United RPG Version {green}%s"
...
#define MSG_WELCOME3		"{blue}!jointeam1: {green}加入旁观者阵营"
...
#define	MSG_BIND_JOB1		"\x04小键盘7\x05:子弹製造术 \x04小键盘8\x05:卫星炮术"
#define	MSG_BIND_JOB2		"\x04小键盘7\x05:加速衝刺术 \x04小键盘8\x05:无限子弹术"
...
#define MSG_EXP_SURVIVOR_GOT_INCAPPED	"{lightgreen}作為 {olive}幸存者 {lightgreen}的你倒下扣除{green}%d{olive}EXP, {green}%d{olive}$"
#define MSG_EXP_SURVIVOR_GOT_KILLED		"{lightgreen}作為 {olive}幸存者 {lightgreen}的你死亡扣除{green}%d{olive}EXP, {green}%d{olive}$"
...
#define MSG_INVALID_ARG				"{green}参数无效!{olive}请输入一个大於零的正数!"
/* Need Job & Skill */
...
#define MSG_NEED_SKILL_3		"你没有学习子弹製造术!"
#define MSG_NEED_SKILL_4		"你没有学习加速衝刺术!"
...
#define MSG_SKILL_HL_ANNOUNCE			"{olive}[技能] 啟动了{green}Lv.%d{blue}的治疗术!"
#define MSG_SKILL_HL_ENABLED			"{olive}[技能] {green}治疗术{blue}啟动中!"
#define MSG_SKILL_HL_END				"{olive}[技能] {green}治疗术{blue}结束了!"
#define MSG_SKILL_AM_ANNOUNCE			"{olive}[技能] 使用了{green}Lv.%d{blue}的子弹製造技术製造了{green}%d发{blue}子弹!"
#define MSG_SKILL_AM_NOGUN				"{olive}[技能] {green}你没有枪械!"
#define MSG_SKILL_SC_ANNOUNCE			"{olive}[技能] 啟动了{green}Lv.%d{blue}的{olive}卫星炮术{blue}!"
...
#define MSG_SKILL_SP_ANNOUNCE			"{olive}[技能] 啟动了{green}Lv.%d{blue}的{olive}加速衝刺术{blue}!"
#define MSG_SKILL_SP_ENABLED			"{olive}[技能] {green}加速衝刺术{blue}啟动中!"
#define MSG_SKILL_SP_END				"{olive}[技能] {green}加速衝刺术{blue}结束了!"
#define MSG_SKILL_IA_ANNOUNCE			"{olive}[技能] 啟动了{green}Lv.%d{blue}的{olive}无限子弹术{blue}!"
#define MSG_SKILL_IA_ENABLED			"{olive}[技能] {green}无限子弹术{blue}啟动中!"
#define MSG_SKILL_IA_END				"{olive}[技能] {green}无限子弹术{blue}结束了!"
#define MSG_SKILL_BS_ANNOUNCE			"{olive}[技能] 啟动了{green}Lv.%d{blue}的{green}无敌术{blue},已进入无敌状态!"
#define MSG_SKILL_BS_ENABLED			"{olive}[技能] {green}无敌术{blue}啟动中!"
...
#define MSG_SKILL_HB_ANNOUNCE			"{olive}[技能] 啟动了{green}Lv.%d{blue}的{olive}治疗光球术{blue}!"
#define MSG_SKILL_HB_ENABLED			"{olive}[技能] {green}治疗光球术{blue}啟动中!"
#define MSG_SKILL_HB_END				"{olive}[技能] {green}治疗光球术{blue}结束了! 你总共治疗了队友{green}%d{olive}HP, 你获得{green}%d{olive}Exp{blue}, {green}%d{olive}$"
#define MSG_SKILL_DR_ANNOUNCE			"{olive}[技能] 消耗了自身的{green}%dHP{blue}去啟动{green}Lv.%d{blue}的{olive}反伤术{blue}!"
#define MSG_SKILL_DR_ENABLED			"{olive}[技能] {green}反伤术{blue}啟动中!"
#define MSG_SKILL_DR_NEED_HP			"{olive}[技能] {green}你的血量不足够用来发动反伤术!"
#define MSG_SKILL_DR_END				"{olive}[技能] {green}反伤术{blue}失效了!"
#define MSG_SKILL_MS_ANNOUNCE			"{olive}[技能] 啟动了{green}Lv.%d{blue}的{olive}近战嗜血术{blue}!"
#define MSG_SKILL_MS_ENABLED			"{olive}[技能] {green}近战嗜血术{blue}啟动中!"
#define MSG_SKILL_MS_END				"{olive}[技能] {green}近战嗜血术{blue}结束了!"
#define MSG_SKILL_FB_ANNOUNCE			"{olive}[技能] 啟动了{green}Lv.%d{blue}的{olive}火球术{blue}!"
#define MSG_SKILL_IB_ANNOUNCE			"{olive}[技能] 啟动了{green}Lv.%d{blue}的{olive}冰球术{blue}!"
#define MSG_SKILL_CL_ANNOUNCE			"{olive}[技能] 啟动了{green}Lv.%d{blue}的{olive}连锁闪电术{blue}!"
...
/* Status */
#define MSG_ADD_STATUS_STR			"{lightgreen}[属性] {olive}力量{lightgreen}变為{green}%d{lightgreen}, {olive}伤害{lightgreen}增加:{green}%.2f%%"
#define MSG_ADD_STATUS_AGI			"{lightgreen}[属性] {olive}敏捷{lightgreen}变為{green}%d{lightgreen}, {olive}移动速度{lightgreen}增加:{green}%.2f%%"
#define MSG_ADD_STATUS_HEALTH		"{lightgreen}[属性] {olive}生命{lightgreen}变為{green}%d{lightgreen}, {olive}生命值上限{lightgreen}增加:{green}%.2f%%"
#define MSG_ADD_STATUS_ENDURANCE	"{lightgreen}[属性] {olive}耐力{lightgreen}变為{green}%d{lightgreen}, {olive}伤害{lightgreen}减少:{green}%.2f%%"
#define MSG_ADD_STATUS_INTELLIGENCE	"{lightgreen}[属性] {olive}智力{lightgreen}变為{green}%d{lightgreen}, {olive}MP上限{lightgreen}增加至{green}%d{lightgreen}, 每秒恢复{green}%d{lightgreen}MP\n{lightgreen}[属性] 死亡扣取的经验值和金钱减少!"
#define MSG_ADD_STATUS_MAX			"属性点增加已到达上限 %d!"
/* Learn Skills */
#define MSG_ADD_SKILL_TT_NEED			"目标传送术和选择传送术必须达到满级才能学习此技能!"
#define MSG_ADD_SKILL_HL				"{olive}[技能] {green}治疗术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_HL_LEVEL_MAX		"{olive}[技能] {green}治疗术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_EQ				"{olive}[技能] {green}强化甦醒术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_EQ_LEVEL_MAX		"{olive}[技能] {green}强化甦醒术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_AM				"{olive}[技能] {green}子弹製造术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_AM_LEVEL_MAX		"{olive}[技能] {green}子弹製造术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_SC				"{olive}[技能] {green}卫星炮术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_SC_LEVEL_MAX		"{olive}[技能] {green}卫星炮术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_EE				"{olive}[被动技能] {green}攻防强化术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_EE_LEVEL_MAX		"{olive}[技能] {green}攻防强化术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_SP				"{olive}[技能] {green}加速衝刺术{lightgreen}等级变為 {green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_SP_LEVEL_MAX		"{olive}[技能] {green}加速衝刺术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_IA				"{olive}[技能] {green}无限子弹术{lightgreen}等级变為 {green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_IA_LEVEL_MAX		"{olive}[技能] {green}无限子弹术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_BS				"{olive}[技能] {green}无敌术{lightgreen}等级变為 {green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_BS_LEVEL_MAX		"{olive}[技能] {green}无敌术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_DR				"{olive}[技能] {green}反伤术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_DR_LEVEL_MAX		"{olive}[技能] {green}反伤术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_MS				"{olive}[技能] {green}近战嗜血术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_MS_LEVEL_MAX		"{olive}[技能] {green}近战嗜血术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_FS				"{olive}[被动技能] {green}射速已加强术{lightgreen}等级变為 {green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_FS_LEVEL_MAX		"{olive}[被动技能] {green}射速加强术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_TS				"{olive}[技能] {green}选择传送术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_TS_LEVEL_MAX		"{olive}[技能] {green}选择传送术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_AT				"{olive}[技能] {green}目标传送术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_AT_LEVEL_MAX		"{olive}[技能] {green}目标传送术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_TT				"{olive}[技能] {green}心灵传送术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_TT_LEVEL_MAX		"{olive}[技能] {green}心灵传送术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_HB				"{olive}[技能] {green}治疗光球术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_HB_LEVEL_MAX		"{olive}[技能] {green}治疗光球术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_FB				"{olive}[技能] {green}火球术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_FB_LEVEL_MAX		"{olive}[技能] {green}火球术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_IB				"{olive}[技能] {green}冰球术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_IB_LEVEL_MAX		"{olive}[技能] {green}冰球术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_CL				"{olive}[技能] {green}连锁闪电术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_CL_LEVEL_MAX		"{olive}[技能] {green}连锁闪电术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_RG				"{olive}[被动技能] {green}再生术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_RG_LEVEL_MAX		"{olive}[被动技能] {green}再生术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_SI				"{olive}[被动] {green}超级特感术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_SI_LEVEL_MAX		"{olive}[被动] {green}超级特感术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_IS				"{olive}[技能] {green}召唤术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
#define MSG_ADD_SKILL_IS_LEVEL_MAX		"{olive}[技能] {green}召唤术{lightgreen}等级已达上限!"
#define MSG_ADD_SKILL_HSP				"{olive}[技能] {green}飞扑爆击术{lightgreen}等级变為{green}Lv.%d{lightgreen}"
...
#define MSG_BUYSUCC				"{olive}购买成功! {lightgreen}支出: {green}%d${lightgreen} 剩餘金钱: {green}%d$"
#define MSG_BUYFAIL				"{olive}购买失败! {lightgreen}需要: {green}%d${lightgreen} 现有金钱: {green}%d$"
#define MSG_RecycleSUCC			"{olive}彩票回收成功! {lightgreen}获得: {green}%i${lightgreen}(税:{green}%i{lightgreen}) 剩餘金钱: {green}%d$"
#define MSG_ROBOT_UPGRADE_MAX	"{lightgreen}此项Robot升级已达最高等级!"
/* 对抗奖励系统 */
#define MSG_VERSUS_SCORE_CHANGE_TEAM_SECONDLEFT	"{lightgreen}转换队伍时间剩餘{green}%d{lightgreen}秒!"
...
/* 密码系统 */
#define MSG_PASSWORD_NOTACTIVATED			"{olive}[密码] {blue}你的密码尚未啟动! 请打[/rpgpw 密码]设置并啟动密码!\n注意: 密码请不要用数字0开头，会被略去的!"
...
#define MSG_ENTERPASSWORD_ACTIVATED			"{olive}[密码] {blue}你的密码已成功啟动! 你的密码為{green}%s"
...
/* 伤害显示 */
#define MSG_DAMAGEDISPLAY			"扣掉 %d HP"
#define MSG_DAMAGEDISPLAY_DEAD		"扣掉 %d HP (击杀!)"
#define MSG_DAMAGEDISPLAY_HEADSHOT	"扣掉 %d HP (爆头!)"
#define MSG_TANK_HEALTH_REMAIN		"魔王坦克(第%d型态 控制者: %N) 生命值: %d HP (累积伤害: %d HP)"
/* Witch尖叫引来尸群 */
...
#define MSG_PLAYER_JOIN_TEAM1			"{green}%N{blue}加入旁观者阵营!"
...
/* 其他 */
#define MSG_VersusMarkerReached		"%s带领大家完成了{green}%d%%{default}路程!"
...
public OnPluginStart()
{
	...
	{
		PrintToServer("[United RPG] 找不到玩家记录档: %s, 将重新建立!", SavePath);
	...
	{
		PrintToServer("[United RPG] 找不到排名记录档: %s, 将重新建立!", RankPath);
...
RegisterCvars()
{
	...
	ZombieKilledExp					= CreateConVar("rpg_GainExp_Kill_Zombie",				"5",	"击杀普通丧尸获得的经验值", CVAR_FLAGS, true, 0.0);
	...
	HealTeammateExp					= CreateConVar("rpg_GainExp_Survivor_Heal_Teammate",	"250",	"帮队友治疗获得的经验值", CVAR_FLAGS, true, 0.0);
	...
	ReanimateTeammateCash			= CreateConVar("rpg_GainCash_Reanimate_Teammate",		"50",	"电击器复活队友获得的金钱", CVAR_FLAGS, true, 0.0);
	...
	/* 感染者金钱 */
	SurvivorKilledCash				= CreateConVar("rpg_GainCash_Kill_Survivor",			"80",	"感染者成功杀死幸存者获得的金钱", CVAR_FLAGS, true, 0.0);
	...
	LvUpCash	= CreateConVar("rpg_LvUp_Cash",		"2500",	"升级获得的金钱", CVAR_FLAGS, true, 0.0);
	LvUpExpRate	= CreateConVar("rpg_LvUp_Exp_Rate",	"500",	"升级Exp系数: 升级经验=升级系Exp数*(当前等级+1)", CVAR_FLAGS, true, 1.0);
	NewLifeLv	= CreateConVar("rpg_NewLife_Lv",	"150",	"转生所需等级", CVAR_FLAGS, true, 1.0);

	/*  关於属性技能点 */
	Cost_Healing			= CreateConVar("rpg_MPCost_Healing",			"5000",		"使用治疗术所需MP", CVAR_FLAGS, true, 0.0);
	Cost_AmmoMaking			= CreateConVar("rpg_MPCost_MakingAmmo",			"8000",		"使用製造子弹术所需MP", CVAR_FLAGS, true, 0.0);
	Cost_SatelliteCannon	= CreateConVar("rpg_MPCost_SatelliteCannon",	"10000",	"使用卫星炮术所需MP", CVAR_FLAGS, true, 0.0);
	Cost_Sprint				= CreateConVar("rpg_MPCost_Sprint",				"8000",		"使用加速衝刺术所需MP", CVAR_FLAGS, true, 0.0);
	...
	CfgNormalItemCost[1]	= CreateConVar("rpg_ShopCost_Normal_Items_01","150","燃烧瓶的价钱", CVAR_FLAGS, true, 0.0);
	CfgNormalItemCost[2]	= CreateConVar("rpg_ShopCost_Normal_Items_02","150","土製炸弹的价钱", CVAR_FLAGS, true, 0.0);
	CfgNormalItemCost[3]	= CreateConVar("rpg_ShopCost_Normal_Items_03","100","胆汁的价钱", CVAR_FLAGS, true, 0.0);
	CfgNormalItemCost[4]	= CreateConVar("rpg_ShopCost_Normal_Items_04","1000","药包的价钱", CVAR_FLAGS, true, 0.0);
	CfgNormalItemCost[5]	= CreateConVar("rpg_ShopCost_Normal_Items_05","500","药丸的价钱", CVAR_FLAGS, true, 0.0);
	...
	CfgNormalItemCost[8]	= CreateConVar("rpg_ShopCost_Normal_Items_08","800","高爆子弹盒的价钱", CVAR_FLAGS, true, 0.0);
	CfgNormalItemCost[9]	= CreateConVar("rpg_ShopCost_Normal_Items_09","600","燃烧子弹盒的价钱", CVAR_FLAGS, true, 0.0);

	/* Selected Guns Cost*/
	CfgSelectedGunCost[0]	= CreateConVar("rpg_ShopCost_Selected_Guns_00","600","MP5衝锋鎗的价钱", CVAR_FLAGS, true, 0.0);
	CfgSelectedGunCost[1]	= CreateConVar("rpg_ShopCost_Selected_Guns_01","600","Scout轻型狙击枪的价钱", CVAR_FLAGS, true, 0.0);
	CfgSelectedGunCost[2]	= CreateConVar("rpg_ShopCost_Selected_Guns_02","600","Awp重型狙击枪的价钱", CVAR_FLAGS, true, 0.0);
	CfgSelectedGunCost[3]	= CreateConVar("rpg_ShopCost_Selected_Guns_03","600","Sg552突击步枪的价钱", CVAR_FLAGS, true, 0.0);
	CfgSelectedGunCost[4]	= CreateConVar("rpg_ShopCost_Selected_Guns_04","800","M60重型机枪的价钱", CVAR_FLAGS, true, 0.0);
	CfgSelectedGunCost[5]	= CreateConVar("rpg_ShopCost_Selected_Guns_05","1500","榴弹发射器的价钱", CVAR_FLAGS, true, 0.0);
	CfgSelectedGunCost[6]	= CreateConVar("rpg_ShopCost_Selected_Guns_06","600","AK47的价钱", CVAR_FLAGS, true, 0.0);
	CfgSelectedGunCost[7]	= CreateConVar("rpg_ShopCost_Selected_Guns_07","800","战斗散弹鎗的价钱", CVAR_FLAGS, true, 0.0);
	...
	CfgMeleeCost[4]		= CreateConVar("rpg_ShopCost_Selected_Melees_04","700","斧头的价钱", CVAR_FLAGS, true, 0.0);
	CfgMeleeCost[5]		= CreateConVar("rpg_ShopCost_Selected_Melees_05","933","平底锅的价钱", CVAR_FLAGS, true, 0.0);
	CfgMeleeCost[6]		= CreateConVar("rpg_ShopCost_Selected_Melees_06","933","高尔夫球棍的价钱", CVAR_FLAGS, true, 0.0);
	CfgMeleeCost[7]		= CreateConVar("rpg_ShopCost_Selected_Melees_07","875","武士刀的价钱", CVAR_FLAGS, true, 0.0);
	CfgMeleeCost[8]		= CreateConVar("rpg_ShopCost_Selected_Melees_08","666","CS小刀的价钱", CVAR_FLAGS, true, 0.0);
	CfgMeleeCost[9]		= CreateConVar("rpg_ShopCost_Selected_Melees_09","625","开山刀的价钱", CVAR_FLAGS, true, 0.0);
	CfgMeleeCost[10]	= CreateConVar("rpg_ShopCost_Selected_Melees_10","933","盾牌的价钱", CVAR_FLAGS, true, 0.0);
	CfgMeleeCost[11]	= CreateConVar("rpg_ShopCost_Selected_Melees_11","667","警棍的价钱", CVAR_FLAGS, true, 0.0);
	...
	GiveAnnonce					= CreateConVar("rpg_AdminGiveAnnonce", 				"1",	"是否显示管理给予玩家经验值/LV等信息 0-不显示 1-显示", CVAR_FLAGS, true, 0.0, true, 1.0);
	CleanSaveFileDays			= CreateConVar("rpg_CleanSaveDays", 				"30",	"清除多少天未上线非admin玩家的存档 0-不清除", CVAR_FLAGS, true, 0.0);
	VersusScoreEnable			= CreateConVar("rpg_VersusScore_Enable", 			"1",	"啟动对抗奖励系统(完场后根据双方分数给予经验和钱)(0:OFF 1:ON)", CVAR_FLAGS, true, 0.0, true, 1.0);
	VersusScoreMultipler		= CreateConVar("rpg_VersusScore_Multipler",		 	"5", 	"对抗奖励系统获得的经验值系数(经验值=积分差距*系数*关卡贡献时间)", CVAR_FLAGS, true, 1.0);
	VersusScoreChangeTeamTime	= CreateConVar("rpg_VersusScore_Change_Team_Time",	"120",	"对抗第一回合多少秒内可转队(只有当对抗奖励系统啟动)", CVAR_FLAGS, true, 1.0);
	BotHP						= CreateConVar("rpg_BotHPMultipler", 				"5",	"电脑的生命值加强倍数", CVAR_FLAGS, true, 1.0);
	WitchBalanceLv				= CreateConVar("rpg_WitchBalanceLv",				"100",	"幸存者每完成四分一路程差多少等级增加一隻Witch", CVAR_FLAGS, true, 1.0);

	/* Enable/Disable */
	sm_lastboss_basic_number		= CreateConVar("rpg_LastBoss_Basic_Number",				"3",	"魔王坦克基本数量", CVAR_FLAGS, true, 1.0);
	sm_lastboss_lv_add_enable		= CreateConVar("rpg_LastBoss_LvBalance_Enable",			"1",	"是否根据双方队伍等级差距增加魔王坦克数量.(0:OFF 1:ON)", CVAR_FLAGS, true, 0.0, true, 1.0);
	sm_lastboss_lv_add_difference	= CreateConVar("rpg_LastBoss_LvBalance_LvDifference",	"200",	"差多少等级增加一隻魔王坦克", CVAR_FLAGS, true, 1.0);
	sm_lastboss_enable_announce		= CreateConVar("rpg_LastBoss_Enable_Announce",			"1",	"魔王坦克出现时提示.(0:OFF 1:ON)", CVAR_FLAGS, true, 0.0, true, 1.0);
	...
	sm_lastboss_enable_jump		= CreateConVar("rpg_LastBoss_Enable_Jump",		"0",	"魔王坦克能使用疯狂跳跃(0:OFF 1:ON)", CVAR_FLAGS, true, 0.0, true, 1.0);
	...
	sm_lastboss_enable_abyss	= CreateConVar("rpg_LastBoss_Enable_Abyss",		"2",	"魔王坦克能使用深渊召唤(0:OFF 1:ON(Forth form only) 2:ON(All forms))", CVAR_FLAGS, true, 0.0, true, 2.0);
	sm_lastboss_enable_warp		= CreateConVar("rpg_LastBoss_Enable_Warp",		"1",	"魔王坦克能使用致命镜像(0:OFF 1:ON)", CVAR_FLAGS, true, 0.0, true, 1.0);

	/* Health */
	sm_lastboss_health_max	  	= CreateConVar("rpg_LastBoss_Health_1",	"60000",	"魔王坦克第一型态HP",    CVAR_FLAGS, true, 4.0, true, 65535.0);
	sm_lastboss_health_second	= CreateConVar("rpg_LastBoss_Health_2",	"50000",	"魔王坦克第二型态HP", CVAR_FLAGS, true, 3.0, true, 65534.0);
	sm_lastboss_health_third  	= CreateConVar("rpg_LastBoss_Health_3",	"30000",	"魔王坦克第三型态HP",  CVAR_FLAGS, true, 2.0, true, 65533.0);
	sm_lastboss_health_forth 	= CreateConVar("rpg_LastBoss_Health_4",	"20000",	"魔王坦克第四型态HP",  CVAR_FLAGS, true, 1.0, true, 65532.0);

	/* Speed */
	sm_lastboss_speed_first		= CreateConVar("rpg_LastBoss_Speed_1",		"1.0",	"魔王坦克第一型态的速度",  CVAR_FLAGS, true, 0.1);
	sm_lastboss_speed_second		= CreateConVar("rpg_LastBoss_Speed_2",	"1.4",	"魔王坦克第二型态的速度", CVAR_FLAGS, true, 0.1);
	sm_lastboss_speed_third		= CreateConVar("rpg_LastBoss_Speed_3",		"1.2",	"魔王坦克第三型态的速度",  CVAR_FLAGS, true, 0.1);
	sm_lastboss_speed_forth		= CreateConVar("rpg_LastBoss_Speed_4",		"1.6",	"魔王坦克第四型态的速度",  CVAR_FLAGS, true, 0.1);
	...
	/* 追踪石头 */
	w_pushforce_mode 			= CreateConVar("rpg_TankPower_PushForce_Mode",				"3", 	"追踪石头爆风模式 0:disable, 1:mode one, 2:mode two, 3: both", CVAR_FLAGS, true, 0.0, true, 3.0);
	w_pushforce_vlimit 			= CreateConVar("rpg_TankPower_PushForce_Vlimit",			"300",	"速度上限", CVAR_FLAGS, true, 1.0);
	w_pushforce_factor 			= CreateConVar("rpg_TankPower_PushForce_Factor",			"0.8",	"追踪石头爆风系数", CVAR_FLAGS, true, 0.1);
	w_pushforce_tankfactor 		= CreateConVar("rpg_TankPower_PushForce_TankFactor",		"0.1",	"Tank的追踪石头爆风系数", CVAR_FLAGS, true, 0.1);
	w_pushforce_survivorfactor	= CreateConVar("rpg_TankPower_PushForce_SurvivorFactor",	"0.5",	"幸存者的追踪石头爆风系数", CVAR_FLAGS, true, 0.1);

	w_damage_rock		= CreateConVar("rpg_Tankpower_RockConfig_Damage",		"200", "追踪石头的爆炸伤害", CVAR_FLAGS, true, 1.0);
	w_radius_rock		= CreateConVar("rpg_Tankpower_RockConfig_Radius",		"500", "追踪石头的爆炸距离", CVAR_FLAGS, true, 1.0);
	w_pushforce_rock	= CreateConVar("rpg_Tankpower_RockConfig_PushForce",	"800", "追踪石头的爆风力度", CVAR_FLAGS, true, 1.0);
	...
	tankpower_rock_health		= CreateConVar("rpg_Tankpower_RockConfig_RockHealth",			"800", "石头生命值, 0:default");
}
RegisterCmds()
{
	/* RPG主选单 */
	...
	RegConsoleCmd("sm_si",			UseSuperInfected);
	RegConsoleCmd("sm_is",			UseInfectedSummon);
	...
	/* 物品背包 */
	RegConsoleCmd("bag",		Menu_Beibaoxi);
	/* 购物商店 */
...
HookEvents()
{
	...
	//HookEvent("infected_death", Event_IK);
			...
			if(HealingBallTimer[Client] != INVALID_HANDLE)
			{
				if (IsValidClient(Client) && !IsFakeClient(Client))
				{
					if(HealingBallExp[Client] > 0)
					{
						...
						CPrintToChat(Client, MSG_SKILL_HB_END, HealingBallExp[Client]*500/GetConVarInt(LvUpExpRate), HealingBallExp[Client], HealingBallExp[Client]/10);
...
public OnClientConnected(Client)
{
	...
	if(!IsFakeClient(Client))
	{
		...
		for(new i=1; i<=MaxClients; i++)
		{
			if(IsClientInGame(i) && i != Client && !IsFakeClient(i))	CPrintToChat(i, MSG_PLAYER_CONNECT, Client);
		}
...
public Action:ResetPassword(Client, args)
{
	...
	if(StrEqual(Password[Client], "", true)){
		CPrintToChat(Client, MSG_PASSWORD_NOTACTIVATED);
		CPrintToChat(Client, MSG_PASSWORD_EXPLAIN);
	} else
	{
		decl String:arg[PasswordLength];
	...
	while (statsChecked < statsEntries)
	{
		...
		if (!StrEqual(lastConnStr, "Failed", false)) //"%j:0-%Y" 000:0-0000
		{
			...
			if (daysSinceVisit > delDays-1 && delDays != 0)
			{
				...
				{
					KvGotoNextKey(RPGSave);
					PrintToServer("[United RPG] 略过删除 %s 的存档! (原因: 等级 >= 50 或 已转生)", section);
				}
				else
				{
...
ClientSaveToFileLoad(Client)
{
	...
	if(JD[Client] > 0)
	{
		...
		if(JD[Client] == 1)//工程师
		{
			AmmoMakingLv[Client]			=	KvGetNum(RPGSave, "AMLv", 0);//子弹製造术等级
		...
		} else if(JD[Client] == 2)//士兵
		{
			...
			SprintLv[Client]				=	KvGetNum(RPGSave, "SprLv", 0);//加速衝刺术等级
...
public Action:AFKTurnClientToSurvivors(client, args)
{
	...
	else CPrintToChat(client, MSG_VERSUS_SCORE_CHANGE_TEAM_TIMESUP);
	return Plugin_Handled;
}
...
public Action:Event_PlayerFirstSpawn(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	if(!IsFakeClient(target))
	{
		...
		if(IsPasswordConfirm[target])	CPrintToChat(target, MSG_PlayerInfo, Lv[target], Cash[target], Str[target], Agi[target], Health[target], Endurance[target], Intelligence[target]);
...
public Action:Event_PlayerSpawn(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	if(!IsFakeClient(target))
	{
		...
		robot[target]=0;
	} else if(IsFakeClient(target) && GetEntProp(target, Prop_Send, "m_zombieClass") != CLASS_TANK)
	{
		SetEntProp(target, Prop_Data, "m_iMaxHealth", RoundToNearest(GetEntProp(target, Prop_Data, "m_iMaxHealth")*GetConVarFloat(BotHP)));
		SetEntProp(target, Prop_Data, "m_iHealth", RoundToNearest(GetEntProp(target, Prop_Data, "m_iHealth")*GetConVarFloat(BotHP)));
	}
	return Plugin_Continue;
}
...
public Action:Event_PlayerChangename(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	KvGoBack(RPGSave);
	CPrintToChat(target, MESSAGE_CHANGENAME);
	LogToFileEx(LogPath, "%s在游戏内改名為%s!", oldname, newname);
	return Plugin_Continue;
}
/******************************************************
...
public Action:TankSpawn(Handle:timer, any:userid) 
{
	...
	if (!IsTank[client])
	{
		...
		if (isNew)
		{
			...
			PrintToServer("[United RPG] 第%d只魔王坦克(控制者:%s)出现!", TanksSpawned, NameInfo(client, simple));
			...
			if (TanksSpawned == 1)
			{
				...
				{
					CPrintToChatAll(MESSAGE_SPAWN);
					CPrintToChatAll(MESSAGE_SPAWN2);
				}
				...
				if(GetConVarInt(sm_lastboss_lv_add_enable) == 1)
				{
					...
					if(addedtankno >= 1)
					{
						...
						PrintToServer("[United RPG] 幸存者阵营总等级(%d)多於特殊感染者阵营(%d), 增加%d只魔王变身坦克!",SurvivorTeamLv,InfectedTeamLv,addedtankno);
						PrintHintTextToAll(MSG_TANK_ADD_LV_DIFFERENCE,SurvivorTeamLv,InfectedTeamLv,addedtankno);
					}else PrintToServer("[United RPG] 幸存者阵营总等级(%d), 特殊感染者阵营(%d)",SurvivorTeamLv,InfectedTeamLv);
				}
		...
		} else // new tank
		{
			...
			TanksFrustrated--;
			IsSuperInfectedEnable[client] = false;
			PrintToServer("[United RPG] 魔王坦克(接管者:%s)因转手出现!", NameInfo(client, simple));
		}
	} // unique tank
	else
	{
...
public Action:CheckAdditionalTanks(Handle:timer, any:client)
{
	...
	} else
	{
		...
		if (TanksDissapears == 1)
		{
			...
			CPrintToChatAll("{green}[TANK] {blue}Tank神奇地消失了, 新的tank黎紧!");
		} else
		if (TanksDissapears > 1)
		{
			CPrintToChatAll("{green}[TANK] {blue} %d Tanks神奇地消失了, 新的tanks黎紧!!", TanksDissapears);
		}
	...
	if (GetClientOfUserId(Client_id) == Client) {	// if not, then it is somehow a different player
		...
		if (IsClientInGame(Client)) {		// if the client disconnected during the timer - stop.
			switch (team) {
				...
				{
					for(new i=1; i<=MaxClients; i++)
						if(IsClientInGame(i) && i != Client && !IsFakeClient(i)) CPrintToChat(i, MSG_PLAYER_JOIN_TEAM1, Client);
				}
				case TEAM_SURVIVORS:
				{
					for(new i=1; i<=MaxClients; i++)
						if(IsClientInGame(i) && i != Client && !IsFakeClient(i)) CPrintToChat(i, MSG_PLAYER_JOIN_TEAM2, Client);
				}
				case TEAM_INFECTED:
				{
					for(new i=1; i<=MaxClients; i++)
						if(IsClientInGame(i) && i != Client && !IsFakeClient(i)) CPrintToChat(i, MSG_PLAYER_JOIN_TEAM3, Client);
				}
			}
		}
	}
...
public Action:TeamChangeTimerFunction(Handle:timer)
{
	...
	if(IsRoundStarted && !IsZeroInGame)
	{
		...
		{
			CPrintToChatAll(MSG_VERSUS_SCORE_CHANGE_TEAM_SECONDLEFT, TeamChangeSecondLeft);
			PrintToServer("[United RPG] 转换队伍时间剩餘%d秒!",TeamChangeSecondLeft);
		} else if(TeamChangeSecondLeft == 0)
		{
			SetConVarInt(FindConVar("vs_max_team_switches"), 0, true, true);
			CPrintToChatAll(MSG_VERSUS_SCORE_CHANGE_TEAM_TIMESUP);
			PrintToServer("[United RPG] 转换队伍时间够了!");
			if(TeamChangeTimer != INVALID_HANDLE)
			{
				KillTimer(TeamChangeTimer);
				TeamChangeTimer = INVALID_HANDLE;
				...
				if(GetConVarInt(VersusScoreEnable) == 1)
				{
					...
					for (new i = 1; i <= MaxClients; i++)
					{
						if(IsClientInGame(i))
						{
							...
							{
								CPrintToChat(i, MSG_VERSUS_SCORE_TEAM_A_SRORE, Round1SurvivorScore);
							} else if(GetClientTeam(i) == TEAM_INFECTED && !IsFakeClient(i))
							{
								CPrintToChat(i, MSG_VERSUS_SCORE_TEAM_B_SRORE, Round1SurvivorScore);
							} else if(!IsFakeClient(i)){
								CPrintToChat(i, MSG_VERSUS_SCORE_TEAM_SPECTATORS_SRORE, Round1SurvivorScore, 0);
							}
						}
					}
					CPrintToChatAll(MSG_VERSUS_SCORE_EXPLAIN, GetConVarInt(VersusScoreMultipler));
					PrintToServer("[United RPG] 第1队幸存者获得%d积分! (总分為%d)", Round1SurvivorScore, GetTeamRoundScore(SurvivorLogicalTeam));
				...
				if(GetConVarInt(VersusScoreEnable) == 1)
				{
					...
					for (new i = 1; i <= MaxClients; i++)
					{
						if(IsClientInGame(i))
						{
							if(GetClientTeam(i) == TEAM_SURVIVORS && !IsFakeClient(i))
							{
								CPrintToChat(i, MSG_VERSUS_SCORE_TEAM_SRORE, Round2SurvivorScore, Round1SurvivorScore);
							} else if(GetClientTeam(i) == TEAM_INFECTED && !IsFakeClient(i))
							{
								CPrintToChat(i, MSG_VERSUS_SCORE_TEAM_SRORE, Round1SurvivorScore, Round2SurvivorScore);
							} else if(!IsFakeClient(i)){
								CPrintToChat(i, MSG_VERSUS_SCORE_TEAM_SPECTATORS_SRORE, Round1SurvivorScore, Round2SurvivorScore);
							}
						}
					}
					PrintToServer("[United RPG] 第2队幸存者获得%d积分! (总分為%d)", Round2SurvivorScore, GetTeamRoundScore(SurvivorLogicalTeam));
					LogToFileEx(LogPath, "--- Round1SurvivorScore = %d, Round2SurvivorScore = %d ---", Round1SurvivorScore, Round2SurvivorScore);
					//比较2队积分进行经验值和金钱分配
						...
						for (new i = 1; i <= MaxClients; i++)
						{
							if(IsClientInGame(i))
							{
								if(GetClientTeam(i) == TEAM_INFECTED && !IsFakeClient(i))
								{
									...
									CPrintToChat(i, MSG_VERSUS_SCORE_TEAM_WIN, PlayRatio*100.0, RewardEXP, RewardCash);
									EXP[i] += RewardEXP;
									Cash[i] += RewardCash;
								}
								else if(GetClientTeam(i) == TEAM_SURVIVORS)	CPrintToChat(i, MSG_VERSUS_SCORE_TEAM_LOSS);
							}
						}
					}
					else if(Round2SurvivorScore > Round1SurvivorScore)
					{
						for (new i = 1; i <= MaxClients; i++)
						{
							if(IsClientInGame(i))
							{
								...
								else if(GetClientTeam(i) == TEAM_INFECTED)	CPrintToChat(i, MSG_VERSUS_SCORE_TEAM_LOSS);
							}
						}
					}
					else CPrintToChatAll(MSG_VERSUS_SCORE_TEAM_DRAW);
				}
...
public Action:Event_PlayerUse(Handle:hEvent, const String:name[], bool:dontBroadcast)
{
	...
	for(new i = 1; i <= MaxClients; i++)
	{
		...
		{
			PrintHintText(i, "%N尝试拿下你的Robot!", Client);
			PrintHintText(Client, "你尝试拿下%N的Robot",i);
			Release(i);
			AddRobot(i);
 		}
	}
	...
	if(IsClientInGame(target))
	{
		...
		if(EXP[target] >= GetConVarInt(LvUpExpRate)*(Lv[target]+1))
		{
			...
			for (new i = 1; i <= MaxClients; i++)
			{
				...
				{
					if(!IsFakeClient(i))	CPrintToChat(i,"{green}%N{olive}已升级至{green}%d{olive}!", target, Lv[target]);
				}
			}
...
String:NameInfo(Client, mode)
{
	...
	if(StrEqual(Password[Client], "", true))
	{
		if(mode == colored)
		{
			...
			{
				if(GetClientTeam(Client) == TEAM_SURVIVORS)	Format(NameInfoString, sizeof(NameInfoString), "{green}[未啟动密码系统]{blue}%N{default}", Client);
				else if(GetClientTeam(Client) == TEAM_INFECTED)	Format(NameInfoString, sizeof(NameInfoString), "{green}[未啟动密码系统]{red}%N{default}", Client);
				else	Format(NameInfoString, sizeof(NameInfoString), "{green}[未啟动密码系统]{default}%N", Client);
			}
		}
		else if(mode == simple) Format(NameInfoString, sizeof(NameInfoString), "[未啟动密码系统]%N", Client);
	} else if(!IsPasswordConfirm[Client])
	{
		if(mode == colored)
		{
			if(IsClientInGame(Client))
			{
				...
				else	Format(NameInfoString, sizeof(NameInfoString), "{green}[未输入密码登入]{default}%N", Client);
			}
		}
		else if(mode == simple) Format(NameInfoString, sizeof(NameInfoString), "[未输入密码登入]%N", Client);
	} else
	{
		decl String:job[32];
		...
		if(mode == colored)
		{
			if(IsClientInGame(Client))
			{
				...
				else	Format(NameInfoString, sizeof(NameInfoString), "{green}[Lv.%d %s]{default}%N", Lv[Client], job, Client);
			}
		}
		else if(mode == simple) Format(NameInfoString, sizeof(NameInfoString), "[Lv.%d %s]%N", Lv[Client], job, Client);
	}
...
public Action:Command_Say(Client, args)
{
	...
	{
		if (mode == 0) CPrintToChatAll("{blue}%N{default}: %s", Client, sText);
...
public Action:Command_SayTeam(Client, args)
{
	...
	if (IsClientInGame(Client) && GetClientTeam(Client) == TEAM_SURVIVORS) LogToFileEx(LogPath, "[队频][幸存者]%s: %s", NameInfo(Client, simple), sText);
	else if (IsClientInGame(Client) && GetClientTeam(Client) == TEAM_INFECTED) LogToFileEx(LogPath, "[队频][特殊感染者]%s: %s", NameInfo(Client, simple), sText);
	else if (IsClientInGame(Client) && GetClientTeam(Client) == TEAM_SPECTATORS) LogToFileEx(LogPath, "[队频][旁观者]%s: %s", NameInfo(Client, simple), sText);
	return Plugin_Handled;
}
...
public Action:Event_TankFrustrated(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	for(new i = 1; i <= MaxClients; i++)
	{
		if(IsClientInGame(i)){
			if(GetClientTeam(i) == TEAM_SURVIVORS && !IsFakeClient(i))
			{
				...
				EXP[i] += GetEXP;
				Cash[i] += GetCash;
				CPrintToChat(i, MSG_EXP_FRUSTRATED_TANK, DamageToTank[i][client], GetEXP, GetCash);
				DamageToTank[i][client] = 0;
			}
		}
	}
	...
	PrintToServer("[United RPG] 魔王坦克(控制者:%N)转手!", NameInfo(client, simple));
...
public Action:Event_VersusMarkerReached(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	PrintToServer("[United RPG] %s带领大家完成了%d%%路程", NameInfo(client, simple), marker);
	CPrintToChatAll(MSG_VersusMarkerReached, NameInfo(client, colored), marker);
	if(GetConVarInt(WitchBalanceLv) > 0)
	{
		...
		{
			PrintToServer("[United RPG] 幸存者阵营总等级(%d)多於特殊感染者阵营(%d), 增加%d隻Witch!",SurvivorTeamLv, InfectedTeamLv, AdditionalWitchNo);
			PrintHintTextToAll(MSG_WitchAdd,SurvivorTeamLv, InfectedTeamLv, AdditionalWitchNo);
		}
		...
		if(GetClientTeam(victim) == TEAM_INFECTED)
		{
			...
			if(!IsFakeClient(victim))
			{
				...
				if(IsValidClient(attacker))
				{
					if(GetClientTeam(attacker) == TEAM_SURVIVORS)	//玩家特殊感染者给幸存者杀死
					{
						...
						CPrintToChat(victim, MSG_EXP_INFECTED_GOT_KILLED, RoundToNearest((Lv[victim]*5 - Intelligence[victim])*GetConVarFloat(InfectedGotKilledExpFactor)), RoundToNearest(Lv[victim]*GetConVarFloat(InfectedGotKilledCashFactor)));
					}
				}
			}
			if(IsValidClient(attacker))
						...
						switch (iClass)
						{
							case 1: //smoker
							{
								...
								if(IsSuperInfectedEnable[victim])
								{
									...
									CPrintToChat(attacker, MSG_EXP_KILL_SI_SMOKER, EXPGain, CashGain);
								} else CPrintToChat(attacker, MSG_EXP_KILL_SMOKER, EXPGain, CashGain);
							...
							case 2: //boomer
							{
								...
								if(IsSuperInfectedEnable[victim])
								{
									EXPGain = RoundToNearest(EXPGain*GetConVarFloat(SuperInfectedExpFactor));
									CashGain = RoundToNearest(CashGain*GetConVarFloat(SuperInfectedCashFactor));
									CPrintToChat(attacker, MSG_EXP_KILL_SI_BOOMER, EXPGain, CashGain);
								} else CPrintToChat(attacker, MSG_EXP_KILL_BOOMER, EXPGain, CashGain);
								EXP[attacker] += EXPGain;
								Cash[attacker] += CashGain;
							}
							case 3: //hunter
							{
								...
								if(IsSuperInfectedEnable[victim])
								{
									EXPGain = RoundToNearest(EXPGain*GetConVarFloat(SuperInfectedExpFactor));
									CashGain = RoundToNearest(CashGain*GetConVarFloat(SuperInfectedCashFactor));
									CPrintToChat(attacker, MSG_EXP_KILL_SI_HUNTER, EXPGain, CashGain);
								} else CPrintToChat(attacker, MSG_EXP_KILL_HUNTER, EXPGain, CashGain);
								EXP[attacker] += EXPGain;
								Cash[attacker] += CashGain;
							}
							case 4: //spitter
							{
								...
								if(IsSuperInfectedEnable[victim])
								{
									EXPGain = RoundToNearest(EXPGain*GetConVarFloat(SuperInfectedExpFactor));
									CashGain = RoundToNearest(CashGain*GetConVarFloat(SuperInfectedCashFactor));
									CPrintToChat(attacker, MSG_EXP_KILL_SI_SPITTER, EXPGain, CashGain);
								} else CPrintToChat(attacker, MSG_EXP_KILL_SPITTER, EXPGain, CashGain);
								EXP[attacker] += EXPGain;
								Cash[attacker] += CashGain;
							}
							case 5: //jockey
							{
								...
								if(IsSuperInfectedEnable[victim])
								{
									EXPGain = RoundToNearest(EXPGain*GetConVarFloat(SuperInfectedExpFactor));
									CashGain = RoundToNearest(CashGain*GetConVarFloat(SuperInfectedCashFactor));
									CPrintToChat(attacker, MSG_EXP_KILL_SI_JOCKEY, EXPGain, CashGain);
								} else CPrintToChat(attacker, MSG_EXP_KILL_JOCKEY, EXPGain, CashGain);
								EXP[attacker] += EXPGain;
								Cash[attacker] += CashGain;
							}
							case 6: //charger
							{
								...
								if(IsSuperInfectedEnable[victim])
								{
									EXPGain = RoundToNearest(EXPGain*GetConVarFloat(SuperInfectedExpFactor));
									CashGain = RoundToNearest(CashGain*GetConVarFloat(SuperInfectedCashFactor));
									CPrintToChat(attacker, MSG_EXP_KILL_SI_CHARGER, EXPGain, CashGain);
								} else CPrintToChat(attacker, MSG_EXP_KILL_CHARGER, EXPGain, CashGain);
								EXP[attacker] += EXPGain;
								Cash[attacker] += CashGain;
							}
						}
			...
			if(iClass == CLASS_TANK)
			{
				...
				if (IsFrustrated[victim])
				{
					...
					IsTank[victim] = false;
					PrintToServer("[United RPG] 魔王坦克(控制者:%s)因转手而死亡!", NameInfo(victim, simple));
				...
				} else
				{
							...
							if(GetClientTeam(i) == TEAM_SURVIVORS && !IsFakeClient(i))
							{
								...
								{								    
									...
									{		    	                                
										...
										{		    			                                
											Baoshu[i]++;      		            		            	        			                                
											CPrintToChatAll("{green}【公告】玩家%N获得了肾上腺素!", i);							    			                                
											PrintHintText(i, "【提示】腺上激素已放进你的背包!");	                                
										}		                                
										case 2:        		                                
										{		    			                                
											Baoliao[i]++;      		            		            	        			                                
											CPrintToChatAll("{green}【公告】玩家%N获得了医疗包!", i);							    			                                
											PrintHintText(i, "【提示】医疗包已放进你的背包!");		                                
										}		                                
										case 3:        	                                
										{		    		                                
											Baojia[i]++;      		            		            	        			                                
											CPrintToChatAll("{green}【公告】玩家%N获得了弹药夹!", i);							    			                                
											PrintHintText(i, "【提示】弹药夹已放进你的背包!");		                                
										}		                                
										case 4:        		                                
										{		    			                                
											Baozhan[i]++;      		            		            	        			                                
											CPrintToChatAll("{green}【公告】玩家%N获得了棒球棍!", i);							    		                                
											PrintHintText(i, "【提示】棒球棍已放进你的背包!");	                                
										}		                                
										case 5:        		                                
										{		    			                                
											Baoxie[i]++;      		            		            	        			                                
											CPrintToChatAll("{green}【公告】玩家%N获得了AK47步枪!", i);							    			                                
											PrintHintText(i, "【提示】AK47步枪已放进你的背包!");		                                
										}	                                
										case 6:        		                                
										{		    			                                
											Baodian[i]++;      		            		            	        			                                
											CPrintToChatAll("{green}【公告】玩家%N获得了电击器!", i);							    			                                
											PrintHintText(i, "【提示】电击器已放进你的背包!");		                                
										}	                                								
									}								
								}								
								if(Lv[i] >= 100)						        
								{							        
									...
									{							    								        
										...
										{        									        
											...
											{							    								    										        
												Lis[i]++;                                   								    									        
												CPrintToChatAll("{green}【公告】玩家%N获得英雄的力量!!!", i);																	    								        
											}                            						    							    								        
											case 2:                                  								        
											{                                                              							    								    									        
												Lis[i]+=2; 								    								        
												CPrintToChatAll("{green}【公告】玩家%N获得亡灵的力量!!!", i);	                                							        
											}    																		        
										}					    						        
									}				        
								}
								EXP[i] += GetEXP;
								Cash[i] += GetCash;
								CPrintToChat(i, MSG_EXP_KILL_TANK, DamageToTank[i][victim], GetEXP, GetCash);
								DamageToTank[i][victim] = 0;
								if(IsPlayerAlive(i))
								{
									EXP[i] += GetConVarInt(TankSurvivedExp);
									Cash[i] += GetConVarInt(TankSurvivedCash);
									CPrintToChat(i, MSG_EXP_KILL_TANK_ALL, GetConVarInt(TankSurvivedExp), GetConVarInt(TankSurvivedCash));
								}
							}
						}
					}
					...
					PrintToServer("[United RPG] 魔王坦克(控制者:%s)死亡!", NameInfo(victim, simple));
				}
			}
		} else if(GetClientTeam(victim) == TEAM_SURVIVORS)
		{
			...
			if(IsValidClient(attacker))
			{
				if(GetClientTeam(attacker) == TEAM_INFECTED && !IsFakeClient(attacker))	//玩家特殊感染者杀死幸存者
				{
					...
					CPrintToChat(attacker, MSG_EXP_SURVIVOR_KILLED, GetConVarInt(SurvivorKilledExp), GetConVarInt(SurvivorKilledCash));
...
public Action:SummonKilledCountFunction(Handle:timer, any:client)
{
	...
	if (IsValidClient(client))
	{
		...
		{
			CPrintToChat(client, MSG_SKILL_IS_KILLED, SummonKilledCount[client]);
		}
		SummonKilledCount[client]=0;
	}
	return Plugin_Handled;
...
public Action:SummonDisappearedCountFunction(Handle:timer, any:client)
{
	...
	if (IsValidClient(client))
	{
		...
		{
			CPrintToChat(client, MSG_SKILL_IS_DISAPPEAR, SummonDisappearedCount[client]);
		}
		SummonDisappearedCount[client]=0;
	}
	return Plugin_Handled;
...
public Action:Event_ReviveSuccess(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	if (IsValidClient(Reviver))
	{
		...
		if(Reviver != Subject && GetClientTeam(Reviver) == TEAM_SURVIVORS && !IsFakeClient(Reviver))
		{
			...
			if (JD[Reviver]==4)
			{
				EXP[Reviver] += GetConVarInt(ReviveTeammateExp)+Job4_ExtraReward[Reviver];
				Cash[Reviver] += GetConVarInt(ReviveTeammateCash)+Job4_ExtraReward[Reviver];
		...
		if(GetEventBool(event, "lastlife"))
		{
			...
			PrintHintTextToAll("%s (\x04%s\x01)已进入频死状态(黑白画面)", targetName, charName);
			PrintToChatAll("%s (\x04%s\x01)已进入频死状态(黑白画面)", targetName, charName);
		}
	}
	return Plugin_Continue;
}
...
public Action:Event_DefibrillatorUsed(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	if (IsValidClient(UserID))
	{
		if(GetClientTeam(UserID) == TEAM_SURVIVORS && !IsFakeClient(UserID))
		{
			...
			if (JD[UserID]==4)
			{
				EXP[UserID] += GetConVarInt(ReanimateTeammateExp)+Job4_ExtraReward[UserID];
				Cash[UserID] += GetConVarInt(ReanimateTeammateCash)+Job4_ExtraReward[UserID];
...
public Action:Event_IncapacitateEXP(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	if (IsValidClient(attacker))
	{
		if (GetClientTeam(attacker) == TEAM_INFECTED && !IsFakeClient(attacker))
		{
			...
			CPrintToChat(attacker, MSG_EXP_SURVIVOR_INCAPACITATED, GetConVarInt(SurvivorIncappedExp), GetConVarInt(SurvivorIncappedCash));
		}
	} else
	{
		new attackerentid = GetEventInt(event, "attackerentid");
	...
	if(!IsFakeClient(victim) && GetClientTeam(victim) == TEAM_SURVIVORS  && !StrEqual(WeaponUsed,"summon_attack"))
	{
		...
		CPrintToChat(victim, MSG_EXP_SURVIVOR_GOT_INCAPPED, RoundToNearest((Lv[victim]*5 - Intelligence[victim])*GetConVarFloat(SurvivorGotIncappedExpFactor)), RoundToNearest(Lv[victim]*GetConVarFloat(SurvivorGotIncappedCashFactor)));
...
public Action:Event_SmokerGrabbed(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	if (IsValidClient(attacker))
	{
		if (GetClientTeam(attacker) != TEAM_SURVIVORS && !IsFakeClient(attacker))
		{
			...
			CPrintToChat(attacker, MSG_SMOKER_GRABBED, GetConVarInt(SmokerGrabbedExp), GetConVarInt(SmokerGrabbedCash));
		}
	}
	return Plugin_Continue;
}
...
public Action:Event_HunterPounced(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	if (IsValidClient(attacker))
	{
		if (GetClientTeam(attacker) != TEAM_SURVIVORS && !IsFakeClient(attacker))
		{
			...
			CPrintToChat(attacker, MSG_HUNTER_POUNCED, gameScoreDmg, GetConVarInt(HunterPouncedExp) + gameScoreDmg*GetConVarInt(HunterPouncedAddExp), GetConVarInt(HunterPouncedCash) + gameScoreDmg*GetConVarInt(HunterPouncedAddCash));
...
public Action:Event_BoomerAttackEXP(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	if (IsValidClient(attacker))
	{
		if (GetClientTeam(attacker) != TEAM_SURVIVORS && !IsFakeClient(attacker))
		{
			...
			CPrintToChat(attacker, MSG_BOOMER_VOMIT, GetConVarInt(BoomerVomitExp), GetConVarInt(BoomerVomitCash));
		}
	}
	return Plugin_Continue;
}
...
public Action:Event_ChargerPummel(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	if (IsValidClient(attacker))
	{
		if (GetClientTeam(attacker) != TEAM_SURVIVORS && !IsFakeClient(attacker))
		{
			...
			CPrintToChat(attacker, MSG_CHARGER_GRABBED, GetConVarInt(ChargerGrabbedExp), GetConVarInt(ChargerGrabbedCash));
		}
	}
	return Plugin_Continue;
}
...
public Action:Event_ChargerImpact(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	if (IsValidClient(attacker))
	{
		if (GetClientTeam(attacker) == TEAM_INFECTED && !IsFakeClient(attacker))
		{
			...
			CPrintToChat(attacker, MSG_CHARGER_IMPACT, GetConVarInt(ChargerImpactExp), GetConVarInt(ChargerImpactCash));
		}
	}
	return Plugin_Continue;
}
...
public Action:Event_JockeyRide(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	if (IsValidClient(attacker))
	{
		if (!IsFakeClient(attacker))
		{
			...
			CPrintToChat(attacker, MSG_JOCKEY_RIDE, GetConVarInt(JockeyRideExp), GetConVarInt(JockeyRideCash));
		}
	}
...
public Action:Event_WitchHarasserSet(Handle: event, const String: name[], bool: dontBroadcast)
{
	...
	if (IsValidClient(userid))	CPrintToChatAll(MSG_WITCH_HARASSERSET_SET_PANIC, userid);
	TriggerPanicEvent();
	return Plugin_Continue;
}
/* Witch死亡 */
public Action:Event_WitchKilled(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	for(new i=1;i<=MaxClients;i++)
	{
		if(GetEntPropEnt(witchid, Prop_Data, "m_hOwnerEntity") == i && GetClientTeam(i) == TEAM_INFECTED)
		{
			...
			CPrintToChat(i, MSG_SKILL_IS_WITCH_KILLED);
			break;
		}
	}
	...
	if (IsValidClient(killer))	CPrintToChatAll(MSG_WITCH_KILLED_PANIC, killer);
	TriggerPanicEvent();
	return Plugin_Continue;
}
/* 玩家受伤 */
public Action:Event_PlayerHurt(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	//CPrintToChatAll("Damage: %d, HP: %d/%d", GetEventInt(event, "dmg_health"), GetEntProp(victim, Prop_Data, "m_iHealth"), GetEventInt(event, "health"));
			...
			if(GetClientTeam(attacker) == TEAM_INFECTED && GetClientTeam(victim) == TEAM_SURVIVORS)
			{
				...
				} else if(GetEntProp(attacker, Prop_Send, "m_zombieClass") == CLASS_TANK)
				{
					if(StrEqual(WeaponUsed,"tank_claw"))// Tank爪击/投石幸存者
					{
						...
						CPrintToChat(attacker, MSG_TANK_CLAW, GetConVarInt(TankClawExp), GetConVarInt(TankClawCash));
					} else if(strcmp(WeaponUsed,"tank_rock") == 0)
					{
						EXP[attacker] += GetConVarInt(TankRockExp);
						Cash[attacker] += GetConVarInt(TankRockCash);
						CPrintToChat(attacker, MSG_TANK_ROCK, GetConVarInt(TankRockExp), GetConVarInt(TankRockCash));
					}
				} else //其他特感的攻击
				{
					if(!StrEqual(WeaponUsed,"summon_attack"))
		...
		if (!IsFakeClient(victim))
		{
			...
			if(GetClientTeam(victim) == TEAM_INFECTED && !IsSteelSkin)
			{
				if(HPRegenerationLv[victim]>0)
				{
					...
					if(HPRegenTimer[victim] != INVALID_HANDLE)
					{
						CPrintToChat(victim, MSG_SKILL_RG_STOP);
						KillTimer(HPRegenTimer[victim]);
						HPRegenTimer[victim] = INVALID_HANDLE;
					}
					...
					if(!IsVictimDead)
					{
						...
						if(GetClientTeam(victim) == TEAM_INFECTED)
						{
							if(GetEntProp(victim, Prop_Send, "m_zombieClass") == CLASS_TANK)
							{
								...
								PrintHintText(attacker, MSG_TANK_HEALTH_REMAIN, form_prev[victim], victim, GetEventInt(event, "health"), DamageToTank[attacker][victim]);
							}
						}
					} else
					{
...
public Action:HurtCountFunction(Handle:timer, any:attacker)
{
	...
	if (IsValidClient(attacker))
	{
		if (HurtCount[attacker] > 0)
		{
			...
			CPrintToChat(attacker, MSG_ANY_SI_ATTACK_SURVIVOR, HurtCount[attacker], GetConVarInt(InfectedAttackExp)*HurtCount[attacker], GetConVarInt(InfectedAttackCash)*HurtCount[attacker]);
		}
...
public Action:SpitCountFunction(Handle:timer, any:attacker)
{
	...
	if (IsValidClient(attacker))
	{
		if (SpitCount[attacker] > 0)
		{
			...
			CPrintToChat(attacker, MSG_SPITTER_SPIT, SpitCount[attacker], GetConVarInt(SpitterSpitExp)*SpitCount[attacker], GetConVarInt(SpitterSpitCash)*SpitCount[attacker]);
		}
...
public Action:SummonHurtCountFunction(Handle:timer, any:attacker)
{
	...
	if (IsValidClient(attacker))
	{
		if (SummonHurtCount[attacker] > 0)
		{
			...
			CPrintToChat(attacker, MSG_ANY_IS_ATTACK_SURVIVOR, SummonHurtCount[attacker], GetConVarInt(SummonInfectedAttackExp)*SummonHurtCount[attacker], GetConVarInt(SummonInfectedAttackCash)*SummonHurtCount[attacker]);
		}
	...
	if (IsValidClient(Client))
	{
		if (!IsFakeClient(Client))
		{
			...
			} else if ( (HP < MaxHP) && (MaxHP < (HPRegen + HP)) )
			{
				...
				CPrintToChat(Client, MSG_SKILL_RG_FULLHP);
				KillTimer(timer);
				HPRegenTimer[Client] = INVALID_HANDLE;
			}
		}
...
public Action:DamageStopFunction(Handle:timer, any:Client)
{
	...
	if(IsValidClient(Client))
	{
		...
		{
			CPrintToChat(Client, MSG_SKILL_RG_START);
...
public Action:HealingFunction(Client)
{
	...
	CPrintToChat(Client, MSG_SKILL_HL_ANNOUNCE, HealingLv[Client]);
...
public Action:AmmoMakingFunction(Client)
{
	...
	if(gun1 != -1 || (gun2 != -1 && StrContains(gun2ClassName, "melee") < 0))
	{
		...
		if(AddedAmmo > 0)	CPrintToChat(Client, MSG_SKILL_AM_ANNOUNCE, AmmoMakingLv[Client], AddedAmmo);
		else CPrintToChat(Client, MSG_SKILL_AM_ANNOUNCE, AmmoMakingLv[Client], AmmoMakingEffect[Client]);

		PrintToServer("[United RPG] %s使用子弹製造术!", NameInfo(Client, simple));
	}else CPrintToChat(Client, MSG_SKILL_AM_NOGUN);
...
public Action:SprintFunction(Client)
{
	...
	CPrintToChat(Client, MSG_SKILL_SP_ANNOUNCE, SprintLv[Client]);

	PrintToServer("[United RPG] %s啟动加速衝刺术!", NameInfo(Client, simple));
	return Plugin_Handled;
}
...
public Action:InfiniteAmmoFunction(Client)
{
	...
	CPrintToChat(Client, MSG_SKILL_IA_ANNOUNCE, InfiniteAmmoLv[Client]);

	PrintToServer("[United RPG] %s啟动无限子弹术!", NameInfo(Client, simple));
...
public Action:BioShieldFunction(Client)
{
	...
	if(HP > MaxHP*BioShieldSideEffect[Client])
	{
		...
		CPrintToChat(Client, MSG_SKILL_BS_ANNOUNCE, BioShieldLv[Client]);

		PrintToServer("[United RPG] %s啟动无敌术!", NameInfo(Client, simple));
	}
...
public Action:DamageReflectFunction(Client)
{
	...
	if(HP > MaxHP*DamageReflectSideEffect[Client])
	{
		...
		CPrintToChat(Client, MSG_SKILL_DR_ANNOUNCE, RoundToNearest(MaxHP*DamageReflectSideEffect[Client]),DamageReflectLv[Client]);

		PrintToServer("[United RPG] %s啟动了反伤术!", NameInfo(Client, simple));
	}
...
public Action:MeleeSpeedFunction(Client)
{
	...
	CPrintToChat(Client, MSG_SKILL_MS_ANNOUNCE, MeleeSpeedLv[Client]);

	PrintToServer("[United RPG] %s啟动近战嗜血术!", NameInfo(Client, simple));
...
public Action:SatelliteCannonFunction(Client)
{
	...
	CPrintToChat(Client, MSG_SKILL_SC_ANNOUNCE, SatelliteCannonLv[Client]);

	PrintToServer("[United RPG] %s啟动了卫星炮术!", NameInfo(Client, simple));
...
public Action:AppointTeleport(Client)
{
	...
	{
		CPrintToChat(Client, "{olive}目标不可达!");
		return Plugin_Handled;
	}*/
	...
	CPrintToChat(Client, MSG_SKILL_AT_ANNOUNCE);

	PrintToServer("[United RPG] %s使用心灵传输到了他想起去的地方!", NameInfo(Client, simple));
...
public Action:TeleportTeam(Client)
{
	...
	if (mode==1)
	{
		...
		CPrintToChat(Client, MSG_SKILL_TT_ANNOUNCE);

		PrintToServer("[United RPG] %s使用心灵传输使所有队友回到他身边!", NameInfo(Client, simple));
	}
...
public TeleportTeammate_Handler(Handle:menu, MenuAction:action, Client, param2)
{
	if (action == MenuAction_Select)
	{
		...
		CPrintToChat(Client, MSG_SKILL_TT_ANNOUNCE_2, target);
...
public Action:HealingBallFunction(Client)
{
	...
	CPrintToChat(Client, MSG_SKILL_HB_ANNOUNCE, HealingBallLv[Client]);

	PrintToServer("[United RPG] %s啟动了治疗光球术!", NameInfo(Client, simple));
...
public Action:FireBallFunction(Client)
{
	...
	CPrintToChat(Client, MSG_SKILL_FB_ANNOUNCE, FireBallLv[Client]);

	PrintToServer("[United RPG] %s啟动了火球术!", NameInfo(Client, simple));
...
public Action:IceBallFunction(Client)
{
	...
	CPrintToChat(Client, MSG_SKILL_IB_ANNOUNCE, IceBallLv[Client]);

	PrintToServer("[United RPG] %s啟动了冰球术!", NameInfo(Client, simple));
...
public Action:ChainLightningFunction(Client)
{
	...
	CPrintToChat(Client, MSG_SKILL_CL_ANNOUNCE, ChainLightningLv[Client]);

	PrintToServer("[United RPG] %s啟动了连锁闪电术!", NameInfo(Client, simple));
...
public Action:UseSuperInfected(Client, args)
{
	...
	else CPrintToChat(Client, MSG_SKILL_USE_INFECTED_ONLY);
	return Plugin_Handled;
}
...
public Action:SuperInfectedFunction(Client)
{
	...
	if(iClass == CLASS_TANK)
	{
		CPrintToChat(Client, MSG_SKILL_SI_CANNOT_TANK);
	} else if(IsPlayerGhost(Client) || !IsPlayerAlive(Client))
	{
		CPrintToChat(Client, MSG_SKILL_SI_CANNOT_GHOST);
	} else if(IsSuperInfectedEnable[Client])
	{
		CPrintToChat(Client, MSG_SKILL_SI_ALREADY);
	} else if(SuperInfectedLv[Client] == 0)
	{
		CPrintToChat(Client, MSG_NEED_SKILL_12);
	} else if(GetConVarInt(Cost_SuperInfected) > MP[Client])
	{
		PrintHintText(Client, MSG_SKILL_LACK_MP, GetConVarInt(Cost_SuperInfected), MP[Client]);
	} else
	{
		...
		CPrintToChat(Client, MSG_SKILL_SI_ANNOUNCE, bossname[iClass], SuperInfectedDuration[Client]);
		PrintToServer("[United RPG] %s已变成超级%s!", NameInfo(Client, simple), bossname[iClass]);
	}
...
public Action:SuperInfectedLifeTimerFunction(Handle:timer, any:Client)
{
	...
	if(IsValidClient(Client))
	{
		...
		{
			CPrintToChat(Client, MSG_SKILL_SI_STOP);
			IsSuperInfectedEnable[Client] = false;
...
public Action:MenuFunc_InfectedSummon(Client)
{
	...
	Format(line, sizeof(line), "防核CEDA人员(%d MP)", GetConVarInt(Cost_InfectedSummon[1]));
	DrawPanelItem(menu, line);
	...
	DrawPanelItem(menu, line);
	Format(line, sizeof(line), "赛车手Jimmy Gibbs Jr.(%d MP)", GetConVarInt(Cost_InfectedSummon[5]));
	DrawPanelItem(menu, line);
	Format(line, sizeof(line), "Fallen Survivor(只能召唤一次)(%d MP)", GetConVarInt(Cost_InfectedSummon[6]));
	DrawPanelItem(menu, line);
...
public MenuHandler_InfectedSummon(Handle:menu, MenuAction:action, client, itemNum)
{
	if (action == MenuAction_Select)
	{
		...
		{
			CPrintToChat(client, MSG_SKILL_IS_CANNOT_GHOST);
		}
		else if(InfectedSummonCount[client] < InfectedSummonMax[client])
		{
			...
			else PrintHintText(client, MSG_SKILL_LACK_MP, mpcost, MP[client]);
		}
		else CPrintToChat(client, MSG_SKILL_IS_COUNT_MAX, InfectedSummonMax[client]);
		MenuFunc_InfectedSummon(client);
	}
}
public SpawnUncommonInf(Client, type, Float:location[3])
{
	...
	else if(type == 7)
	{
		...
		CPrintToChat(Client, MSG_SKILL_IS_WITCH_ANNOUNCE);
		PrintToServer("[United RPG] %s召唤了Witch!", NameInfo(Client, simple));
	}
...
public Action:Event_HealSuccess(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	if (GetConVarInt(HealTeammateExp) > 0 && Client != HealSucTarget)
	{
		if (JD[Client]==4)
		{
			EXP[Client] += GetConVarInt(HealTeammateExp)+Job4_ExtraReward[Client];
			Cash[Client] += GetConVarInt(HealTeammateCash)+Job4_ExtraReward[Client];
...
public Action:MenuFunc_UseSkill(Client)
{
	...
	if(GetClientTeam(Client) == TEAM_SURVIVORS)
	{
		...
		if(JD[Client] == 1)
		{
			Format(line, sizeof(line), "[工程师]子弹製造术 (Lv.%d / MP:%d)", AmmoMakingLv[Client], GetConVarInt(Cost_AmmoMaking));
			DrawPanelItem(menu, line);
			Format(line, sizeof(line), "[工程师]卫星炮术 (Lv.%d / MP:%d)", SatelliteCannonLv[Client], GetConVarInt(Cost_SatelliteCannon));
			DrawPanelItem(menu, line);
		}
		else if(JD[Client] == 3)
		{
		...
		{
			Format(line, sizeof(line), "[士兵]加速衝刺术 (Lv.%d / MP:%d)", SprintLv[Client], GetConVarInt(Cost_Sprint));
			DrawPanelItem(menu, line);
		...
		{
			Format(line, sizeof(line), "[心灵医师]选择传送术 (Lv.%d / MP:%d)", TeleportToSelectLv[Client], GetConVarInt(Cost_TeleportToSelect));
			DrawPanelItem(menu, line);
			Format(line, sizeof(line), "[心灵医师]目标传送术 (Lv.%d / MP:%d)", AppointTeleportLv[Client], GetConVarInt(Cost_AppointTeleport));
			DrawPanelItem(menu, line);		
			if(GetConVarInt(TeleportTeam_Mode)==1)
			{
				Format(line, sizeof(line), "[心灵医师]心灵传送术 (Lv.%d / MP:%d)", TeleportTeamLv[Client], MaxMP[Client]);
				DrawPanelItem(menu, line);
			}
			else
			{
			...
			{
				Format(line, sizeof(line), "[心灵医师]额外的电击器 (剩餘:%d个)", defibrillator[Client]);
				DrawPanelItem(menu, line);
			}
		...
		{
			Format(line, sizeof(line), "[魔法师]火球术 (Lv.%d / MP:%d)", FireBallLv[Client], GetConVarInt(Cost_FireBall));
			DrawPanelItem(menu, line);
			Format(line, sizeof(line), "[魔法师]冰球术 (Lv.%d / MP:%d)", IceBallLv[Client], GetConVarInt(Cost_IceBall));
			DrawPanelItem(menu, line);
			Format(line, sizeof(line), "[魔法师]连锁闪电术 (Lv.%d / MP:%d)", ChainLightningLv[Client], GetConVarInt(Cost_ChainLightning));
			DrawPanelItem(menu, line);
		}
	} else if(GetClientTeam(Client) == TEAM_INFECTED)
	{
		Format(line, sizeof(line), "[通用]特级特感术 (Lv.%d / MP:%d)", SuperInfectedLv[Client], GetConVarInt(Cost_SuperInfected));
		DrawPanelItem(menu, line);
		Format(line, sizeof(line), "[通用]召唤术 (Lv.%d)", InfectedSummonLv[Client]);
		DrawPanelItem(menu, line);
	}
	DrawPanelItem(menu, "Exit", ITEMDRAW_DISABLED);
...
public Action:MenuFunc_RPG(Client)
{
	...
	else if(Lis[Client] == 2)	Format(LIZSA, sizeof(LIZSA), "亡灵");
	
	decl String:line[256];
	Format(line, sizeof(line),
	"亡灵RPG选单 等级:Lv.%d 金钱:$%d 职业:%s \n经验值:%d/%d MP:%d/%d 大过:%d次 转生:%d次\n属性: 力量:%d 敏捷:%d 生命:%d 耐力:%d 智力:%d \n═══════♡力量属性:%s ♡═══════",
	...
	DrawPanelItem(menu, "♡赌场|商店♡");
	DrawPanelItem(menu, "♡伺服器排名♡");
	DrawPanelItem(menu, "♡密码|插件讯息♡");
	DrawPanelItem(menu, "♡亡灵战术背包♡");
	DrawPanelItem(menu, "♡强化枪械♡");
	DrawPanelItem(menu, "♡领取基础补给♡");
...
public RPG_MenuHandler(Handle:menu, MenuAction:action, Client, param)
{
	if (action == MenuAction_Select) {
		switch (param)
		{
			...
			case 6: MenuFunc_Beibaoxi(Client);		//亡灵战术背包
			case 7: MenuFunc_Qianghua(Client);		//强化枪械
			case 8: MenuFunc_Bugei(Client);		//基础补给
		}
	}
}
...
{   
	...
	Format(line, sizeof(line), "说明: 强化可以让自身枪械攻击力提高!");    
...
public BuyUpCgl(Client)
{
	if (Qgl[Client] >= 100)
	{
		CPrintToChat(Client,"{green}【提示】你的强化成功率不用升级!");
	}else{
		if(Cash[Client] >= 300){
			Cash[Client] -= 300;
			Qgl[Client] += 10;
			CPrintToChat(Client,"{green}【强化】恭喜你成功提升了强化成功率,目前强化成功率为%d%",Qgl[Client]);
			CPrintToChatAll("{green}【强化】恭喜%N成功提升强化成功率!",Client);
		}else{
			CPrintToChat(Client,"{green}【提示】提升失败,你的金钱不足!");
		}
	}
...
{   
	...
	{  
		...
		{	            
			...
			Shilv[Client] ++;		
			Qgl[Client] -= 10;
			CPrintToChat(Client, "{green}【强化】你成功强化枪械!");      
			CPrintToChatAll("{green}【强化】恭喜 %N 成功强化枪械!",Client);
		}		
		...
		{			    
			CPrintToChat(Client, "【提示】你的升级率目前0无法强化!"); 			        
		}
	} else CPrintToChat(Client, "【提示】你没有强化石无法进行强化或者强化已经达到上限!");
...
public LQIHUANB(Client)
{
	if(Lv[Client] <= 20)
	{
		...
		CPrintToChatAll("\x05【系统】玩家%N领取了开局补给基础装备:M16+棒球棍", Client);
		PrintHintText(Client, "【提示】你领取了开局补给装备!");
	}
}	
...
{   if(Lv[Client] <= 30)
	{
		...
		CPrintToChatAll("\x05【系统】玩家%N领取了开局补给基础装备:激光AK47+武士刀", Client);
		PrintHintText(Client, "【提示】你领取了开局补给装备!");
	}
}
...
public Action:MenuFunc_AddStatus(Client)
{
	new Handle:menu = CreatePanel();
	decl String:line[256];
	Format(line, sizeof(line), "属性点剩餘: %d", StatusPoint[Client]);
	SetPanelTitle(menu, line);
...
{
	MenuFunc_Beibaoxi(Client);
	return Plugin_Handled;
}
public Action:MenuFunc_Beibaoxi(Client)
{   
	new Handle:menu = CreatePanel();
	   
	decl String:line[1024];   
	Format(line, sizeof(line), "═══物品背包[K按键]═══");   
	SetPanelTitle(menu, line);    
	Format(line, sizeof(line), "腺上激素: %d支", Baoshu[Client]);  
	DrawPanelItem(menu, line);  
	Format(line, sizeof(line), "医疗包: %d个", Baoliao[Client]);  
	DrawPanelItem(menu, line);	
	Format(line, sizeof(line), "电击器: %d个", Baodian[Client]);  
	DrawPanelItem(menu, line);
	Format(line, sizeof(line), "棒球棍: %d个", Baozhan[Client]);  
	DrawPanelItem(menu, line);	
	Format(line, sizeof(line), "弹药夹: %d组", Baojia[Client]);  
	DrawPanelItem(menu, line);	
	Format(line, sizeof(line), "AK47步枪: %d支", Baoxie[Client]);    
	DrawPanelItem(menu, line);    
	DrawPanelItem(menu, "返回RPG选单");   
...
{   
	...
	{    
		...
		{        
			Baodian[Client]--;         
			CheatCommand(Client, "give", "defibrillator");         
			CPrintToChat(Client, "{green}【背包】你拿出了电击器!");
		} else CPrintToChat(Client, "{green}【背包】你的背包没有电击器!");	
	} else CPrintToChat(Client, "{green}【背包】死亡状态下无法使用!");
	MenuFunc_Beibaoxi(Client);
}
public AANPC(Client)
{   
	...
	{    
		...
		{        
			...
			CPrintToChat(Client, "{green}【背包】你拿出了肾上腺素!");
		} else CPrintToChat(Client, "{green}【背包】你的背包没有肾上腺素!");	
	} else CPrintToChat(Client, "{green}【背包】死亡状态下无法使用!");
	MenuFunc_Beibaoxi(Client);
}	
public BBNPC(Client)
{    
	...
	{	    
		...
		{	        
			...
			CPrintToChat(Client, "{green}【背包】你拿出了医疗包!");
		} else CPrintToChat(Client, "{green}【背包】你的背包没有医疗包!");	
	} else CPrintToChat(Client, "{green}【背包】死亡状态下无法使用!");
	MenuFunc_Beibaoxi(Client);
}
public CCNPC(Client)
{    
	...
	{	    
		...
		{	        
			...
			CPrintToChat(Client, "{green}【背包】你拿出了棒球棍!");
		} else CPrintToChat(Client, "{green}【背包】你的背包没有棒球棍!");	
	} else CPrintToChat(Client, "{green}【背包】死亡状态下无法使用!");
	MenuFunc_Beibaoxi(Client);
}
public DDNPC(Client)
{   
	...
	{	    
		...
		{	        
			...
			CPrintToChat(Client, "{green}【背包】你拿出了弹药夹!");
		} else CPrintToChat(Client, "{green}【背包】你的背包没有弹药夹!");	
	} else CPrintToChat(Client, "{green}【背包】死亡状态下无法使用!");
	MenuFunc_Beibaoxi(Client);
}
public EENPC(Client)
{    
	...
	{	    
		...
		{	        
			Baoxie[Client]--;           
			CheatCommand(Client, "give", "rifle_ak47");           
			CPrintToChat(Client, "{green}【背包】你拿出了AK47步枪!");
		} else CPrintToChat(Client, "{green}【背包】你的背包没有AK47步枪!");	
	} else CPrintToChat(Client, "{green}【背包】死亡状态下无法使用!");
	MenuFunc_Beibaoxi(Client);
}
...
public Action:MenuFunc_SurvivorSkill(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "幸存者技能 - 技能点剩餘: %d", SkillPoint[Client]);
	SetPanelTitle(menu, line);

	Format(line, sizeof(line), "[通用]治疗术 (目前等级: %d/%d 发动指令: !hl)", HealingLv[Client], LvLimit_Healing);
	DrawPanelItem(menu, line);
	Format(line, sizeof(line), "[通用]强化甦醒术 (目前等级: %d/%d 被动技能)", EndranceQualityLv[Client], LvLimit_EndranceQuality);
	DrawPanelItem(menu, line);
	if(JD[Client] == 1)
	{
		Format(line, sizeof(line), "[工程师]子弹製造术 (目前等级: %d/%d 发动指令: !am)", AmmoMakingLv[Client], LvLimit_AmmoMaking);
		DrawPanelItem(menu, line);
		Format(line, sizeof(line), "[工程师]射速加强术 (目前等级: %d/%d 发动指令: !fs)", FireSpeedLv[Client], LvLimit_FireSpeed);
		DrawPanelItem(menu, line);
		Format(line, sizeof(line), "[工程师]卫星炮术 (目前等级: %d/%d 发动指令: !sc)", SatelliteCannonLv[Client], LvLimit_SatelliteCannon);
		DrawPanelItem(menu, line);
	} else if(JD[Client] == 2)
	{
		Format(line, sizeof(line), "[士兵]攻防强化术 (目前等级: %d/%d 被动技能)", EnergyEnhanceLv[Client], LvLimit_EnergyEnhance);
		DrawPanelItem(menu, line);
		Format(line, sizeof(line), "[士兵]加速衝刺术 (目前等级: %d/%d 发动指令: !sp)", SprintLv[Client], LvLimit_Sprint);
		DrawPanelItem(menu, line);
		Format(line, sizeof(line), "[士兵]无限子弹术 (目前等级: %d/%d 发动指令: !ia)", InfiniteAmmoLv[Client], LvLimit_InfiniteAmmo);
		DrawPanelItem(menu, line);
	} else if(JD[Client] == 3)
	{
		Format(line, sizeof(line), "[生物专家]无敌术 (目前等级: %d/%d 发动指令: !bs)", BioShieldLv[Client], LvLimit_BioShield);
		DrawPanelItem(menu, line);
		Format(line, sizeof(line), "[生物专家]反伤术 (目前等级: %d/%d 发动指令: !dr)", DamageReflectLv[Client], LvLimit_DamageReflect);
		DrawPanelItem(menu, line);
		Format(line, sizeof(line), "[生物专家]近战嗜血术 (目前等级: %d/%d 发动指令: !ms)", MeleeSpeedLv[Client], LvLimit_MeleeSpeed);
		DrawPanelItem(menu, line);
	} else if(JD[Client] == 4)
	{
		Format(line, sizeof(line), "[心灵医师]选择传送术 (目前等级: %d/%d 发动指令: !ts)", TeleportToSelectLv[Client], LvLimit_TeleportToSelect);
		DrawPanelItem(menu, line);
		Format(line, sizeof(line), "[心灵医师]目标传送术 (目前等级: %d/%d 发动指令: !at)", AppointTeleportLv[Client], LvLimit_AppointTeleport);
		DrawPanelItem(menu, line);
		Format(line, sizeof(line), "[心灵医师]心灵传送术 (目前等级: %d/%d 发动指令: !tt)", TeleportTeamLv[Client], LvLimit_TeleportTeam);
		DrawPanelItem(menu, line);
		Format(line, sizeof(line), "[心灵医师]治疗光球术 (需转生 目前等级: %d/%d 发动指令: !hb)", HealingBallLv[Client], LvLimit_HealingBall);
		DrawPanelItem(menu, line);
	} else if(JD[Client] == 5)
	{
		Format(line, sizeof(line), "[魔法师]火球术 (目前等级: %d/%d 发动指令: !fb)", FireBallLv[Client], LvLimit_FireBall);
		DrawPanelItem(menu, line);
		Format(line, sizeof(line), "[魔法师]冰球术 (目前等级: %d/%d 发动指令: !ib)", IceBallLv[Client], LvLimit_IceBall);
		DrawPanelItem(menu, line);
		Format(line, sizeof(line), "[魔法师]连锁闪电术 (目前等级: %d/%d 发动指令: !cl)", ChainLightningLv[Client], LvLimit_ChainLightning);
		DrawPanelItem(menu, line);
	}
	DrawPanelItem(menu, "Exit", ITEMDRAW_DISABLED);
...
public Action:MenuFunc_AddHealing(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习治疗术 目前等级: %d/%d 发动指令: !hl - 技能点剩餘: %d", HealingLv[Client], LvLimit_Healing, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddEndranceQuality(Client)
{
	...
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习强化甦醒术 目前等级: %d/%d 被动技能 - 技能点剩餘: %d", EndranceQualityLv[Client], LvLimit_EndranceQuality, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddAmmoMaking(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习子弹製造术 目前等级: %d/%d 发动指令: !am - 技能点剩餘: %d", AmmoMakingLv[Client], LvLimit_AmmoMaking, SkillPoint[Client]);
	SetPanelTitle(menu, line);

	Format(line, sizeof(line), "技能说明: 製造一定数量子弹");
	DrawPanelText(menu, line);
	Format(line, sizeof(line), "製造数量: %d", AmmoMakingEffect[Client]);
	DrawPanelText(menu, line);
	DrawPanelItem(menu, "学习");
	DrawPanelItem(menu, "返回");
...
public Action:MenuFunc_AddFireSpeed(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习射速加强术 目前等级: %d/%d 发动指令: !fs - 技能点剩餘: %d", FireSpeedLv[Client], LvLimit_FireSpeed, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddSatelliteCannon(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习卫星炮术 目前等级: %d/%d 发动指令: !sc - 技能点剩餘: %d", SatelliteCannonLv[Client], LvLimit_SatelliteCannon, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddEnergyEnhance(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习攻防强化术 目前等级: %d/%d 被动 - 技能点剩餘: %d", EnergyEnhanceLv[Client], LvLimit_EnergyEnhance, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddSprint(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习加速衝刺术 目前等级: %d/%d 发动指令: !sp - 技能点剩餘: %d", SprintLv[Client], LvLimit_Sprint, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddInfiniteAmmo(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习无限子弹术 目前等级: %d/%d 发动指令: !ia - 技能点剩餘: %d", InfiniteAmmoLv[Client], LvLimit_InfiniteAmmo, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddBioShield(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习无敌术 目前等级: %d/%d 发动指令: !bs - 技能点剩餘: %d", BioShieldLv[Client], LvLimit_BioShield, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddDamageReflect(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习反伤术 目前等级: %d/%d 发动指令: !dr - 技能点剩餘: %d", DamageReflectLv[Client], LvLimit_DamageReflect, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddMeleeSpeed(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习近战嗜血术 目前等级: %d/%d 发动指令: !ms - 技能点剩餘: %d", MeleeSpeedLv[Client], LvLimit_MeleeSpeed, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddTeleportToSelect(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习选择传送术 目前等级: %d/%d 发动指令: !ts - 技能点剩餘: %d", TeleportToSelectLv[Client], LvLimit_TeleportToSelect, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddAppointTeleport(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习目标传送术 目前等级: %d/%d 发动指令: !at - 技能点剩餘: %d", AppointTeleportLv[Client], LvLimit_AppointTeleport, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddTeleportTeam(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习心灵传送术 目前等级: %d/%d 发动指令: !tt - 技能点剩餘: %d", TeleportTeamLv[Client], LvLimit_TeleportTeam, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddHealingBall(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习治疗光球术 需转生 目前等级: %d/%d 发动指令: !hb - 技能点剩餘: %d", HealingBallLv[Client], LvLimit_HealingBall, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddFireBall(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习火球术 目前等级: %d/%d 发动指令: !fb - 技能点剩餘: %d", FireBallLv[Client], LvLimit_FireBall, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddIceBall(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习冰球术 目前等级: %d/%d 发动指令: !ib - 技能点剩餘: %d", IceBallLv[Client], LvLimit_IceBall, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddChainLightning(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习连锁闪电术 目前等级: %d/%d 发动指令: !cl - 技能点剩餘: %d", ChainLightningLv[Client], LvLimit_ChainLightning, SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_InfectedSkill(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "特殊感染者技能 - 技能点剩餘: %d", SkillPoint[Client]);
	SetPanelTitle(menu, line);
...
public Action:MenuFunc_AddHPRegeneration(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习再生术 目前等级: %d/%d 被动技能 - 技能点剩餘: %d", HPRegenerationLv[Client], LvLimit_HPRegeneration, SkillPoint[Client]);
	SetPanelTitle(menu, line);
	...
	if(action == MenuAction_Select)
	{
		if(param == 1)
		{
			...
			else if(HPRegenerationLv[Client] < LvLimit_HPRegeneration)
			{
				...
				CPrintToChat(Client, MSG_ADD_SKILL_RG, HPRegenerationLv[Client]);
			}
			else CPrintToChat(Client, MSG_ADD_SKILL_RG_LEVEL_MAX);
...
public Action:MenuFunc_AddSuperInfected(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习超级特感术 目前等级: %d/%d 指令: !si - 技能点剩餘: %d", SuperInfectedLv[Client], LvLimit_SuperInfected, SkillPoint[Client]);
	SetPanelTitle(menu, line);
	...
	if(action == MenuAction_Select)
	{
		if(param == 1)
		{
			...
			else if(SuperInfectedLv[Client] < LvLimit_SuperInfected)
			{
				...
				CPrintToChat(Client, MSG_ADD_SKILL_SI, SuperInfectedLv[Client]);
			}
			else CPrintToChat(Client, MSG_ADD_SKILL_SI_LEVEL_MAX);
...
public Action:MenuFunc_AddInfectedSummon(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "学习召唤术 目前等级: %d/%d 指令: !is - 技能点剩餘: %d", InfectedSummonLv[Client], LvLimit_InfectedSummon, SkillPoint[Client]);
	SetPanelTitle(menu, line);
	...
	if(action == MenuAction_Select)
	{
		if(param == 1)
		{
			...
			else if(InfectedSummonLv[Client] < LvLimit_InfectedSummon)
			{
				...
				CPrintToChat(Client, MSG_ADD_SKILL_IS, InfectedSummonLv[Client]);
			}
			else CPrintToChat(Client, MSG_ADD_SKILL_IS_LEVEL_MAX);
...
public Action:MenuFunc_AddSuperPounce(Client)
{
	decl String:line[256];
	new Handle:menu = CreatePanel();
	Format(line, sizeof(line), "飞扑爆击术 目前等级: %d/%d 被动技能 - 技能点剩餘: %d", SuperPounceLv[Client], LvLimit_SuperPounce, SkillPoint[Client]);
	SetPanelTitle(menu, line);
	...
	if(action == MenuAction_Select)
	{
		if(param == 1)
		{
			...
			else if(SuperPounceLv[Client] < LvLimit_SuperPounce)
			{
				...
				CPrintToChat(Client, MSG_ADD_SKILL_HSP, SuperPounceLv[Client]);
			}
			else CPrintToChat(Client, MSG_ADD_SKILL_HSP_LEVEL_MAX);
...
ClinetResetStatus(Client, Mode)
{
	if(Mode == NewLife)
	{
		...
		Cash[Client] += Lv[Client]*GetConVarInt(LvUpCash);
	}
...
public Action:MenuFunc_NewLife(Client)
{
	...
	{
		CPrintToChat(Client, MSG_NL_NEED_LV, GetConVarInt(NewLifeLv));
		return Plugin_Handled;
	}
	else
		{
...
stock ChooseJob(Client, Jobid)
{
	...
	else
	{
		...
		else if (Jobid==5)//魔法师
		{
			...
			} else CPrintToChat(Client, MSG_ZZ_FAIL_NEED_NEWLIFE);
		}
	}
}
...
public Action:MenuFunc_Buy(Client)
{
	...
	AddMenuItem(menu, "option6", "亡灵宝盒");
	AddMenuItem(menu, "option7", "A芯片[NEW]");
...
public MenuHandler_Buy(Handle:menu, MenuAction:action, Client, itemNum)
{
	if (action == MenuAction_Select ) {
		switch (itemNum)
		{
			case 0: MenuFunc_SurvivorBuy(Client);
			case 1: MenuFunc_InfectedShop(Client);
...
public EQBBX(Client)
{
    if(Cash[Client] >= 3000)
    {
        Cash[Client] -= 3000;
        Shitou[Client]++;
        CPrintToChat(Client, "\x05【提示】你购买了强化石!");	CPrintToChatAll("\x05【提示】玩家 %N 通过强化石商店购买了一块强化石!", Client);
    } else CPrintToChat(Client, "\x05【提示】购买失败,金钱不足!");	 
}
	    ...
	    if(AXP[Client]>0)
	    {
            ...
            switch (diceNum)
		    {
			    case 1:
				{
                    ...
                    CPrintToChatAll("\x05【公告】玩家%N使用A芯片获得了一把榴弹发射器!", Client);
                }
				case 2: 
			    {
                    CheatCommand(Client, "give", "shotgun_chrome");
                    CPrintToChatAll("\x05【公告】玩家%N使用A芯片获得了一把2代散弹!", Client);
                }
                case 3: 
			    {
                    CheatCommand(Client, "give", "defibrillator");
                    CPrintToChatAll("\x05【公告】玩家%N使用A芯片获得了一个电震动器!", Client);
                }	
                case 4: 
			    {
                    Cash[Client] += 3000000;
                    CPrintToChatAll("\x05【公告】玩家%N使用A芯片获得了3000000$!", Client);
                }
                case 5: 
			    {
                    CheatCommand(Client, "give", "first_aid_kit");
                    CPrintToChatAll("\x05【公告】玩家%N使用A芯片获得了一个医药包!", Client);
                }
                case 6: 
			    {
                    CheatCommand(Client, "give", "pistol_magnum");
                    CPrintToChatAll("\x05【公告】玩家%N使用A芯片获得一把沙漠之鹰!", Client);
                }
                case 7: 
			    {
                    CheatCommand(Client, "give", "pain_pills");
                    CPrintToChatAll("\x05【公告】玩家%N使用A芯片获得了止痛药1个!", Client);
                }	
                case 8: 
			    {
                    CheatCommand(Client, "give", "adrenaline");
                    CPrintToChatAll("\x05【公告】玩家%N使用A芯片获得了肾上腺素针一支!", Client);
                }
                case 9: 
			    {
                    CheatCommand(Client, "give", "rifle_ak47");
                    CPrintToChatAll("\x05【公告】玩家%N使用A芯片获得了AK47!", Client);
                }
                case 10: 
			    {
                    CheatCommand(Client, "give", "rifle_m60");
                    CPrintToChatAll("\x05【公告】玩家%N使用A芯片获得了M60机枪!", Client);
                }
		    }
	    } else PrintHintText(Client, "【提示】你没有A芯片!");
    } else CPrintToChat(Client, "\x05【提示】所需金钱不够, 无法购买!");	
    return Plugin_Handled;
}
public GOUMAIA(Client)
{
    if(Cash[Client] >= 10000)
    {
        Cash[Client] -= 10000;
        AXP[Client]++;
        CPrintToChat(Client, "\x05【提示】你购买了A芯片!");
    } else CPrintToChat(Client, "\x05【提示】购买失败,金钱不足!");	 
}
...
{   
	...
	decl String:line[1024];   
	Format(line, sizeof(line), "═══亡灵宝盒 (拥有: %d个)═══", WLBH[Client]);   
	SetPanelTitle(menu, line);    
	    ...
	    if(WLBH[Client]>0)
	    {
            ...
            switch (diceNum)
		    {
			    case 1:
				{
                    ...
                    CPrintToChatAll("\x05【公告】玩家%N打开亡灵宝盒获得了Tank一只!", Client);
                }
				case 2: 
			    {
                    CheatCommand(Client, "z_spawn", "witch auto");
                    CPrintToChatAll("\x05【公告】玩家%N打开亡灵宝盒获得Witch妹子!", Client);
                }
                case 3: 
			    {
                    CheatCommand(Client, "director_force_panic_event", "");
                    CPrintToChatAll("\x05【公告】玩家%N打开亡灵宝盒获得了一群丧尸!", Client);
                }	
                case 4: 
			    {
                    Cash[Client] += 1000;
                    CPrintToChatAll("\x05【公告】玩家%N打开亡灵宝盒获得了1000$!", Client);
                }
                case 5: 
			    {
                    CheatCommand(Client, "give", "first_aid_kit");
                    CPrintToChatAll("\x05【公告】玩家%N打开亡灵宝盒获得了一个医药包!", Client);
                }
                case 6: 
			    {
                    CheatCommand(Client, "give", "weapon_fireworkcrate");
                    CPrintToChatAll("\x05【公告】玩家%N打开亡灵宝盒获得一盒烟花!", Client);
                }
                case 7: 
			    {
                    CheatCommand(Client, "give", "molotov");
                    CPrintToChatAll("\x05【公告】玩家%N打开亡灵宝盒获得了燃烧瓶1个!", Client);
                }	
                case 8: 
			    {
                    CheatCommand(Client, "give", "baseball_bat");
                    CPrintToChatAll("\x05【公告】玩家%N打开亡灵宝盒获得了棒球棍!", Client);
                }
                case 9: 
			    {
                    CheatCommand(Client, "give", "rifle_ak47");
                    CPrintToChatAll("\x05【公告】玩家%N打开亡灵宝盒获得了AK47!", Client);
                }
                case 10: 
			    {
                    CheatCommand(Client, "give", "rifle_m60");
                    CPrintToChatAll("\x05【公告】玩家%N打开亡灵宝盒获得了M60机枪!", Client);
                }
		    }
	    } else PrintHintText(Client, "【提示】你没有奇迹宝盒!");
    } else CPrintToChat(Client, "\x05【提示】所需金钱不够, 无法开启!");	
    return Plugin_Handled;
}
public GOUMAI(Client)
{
    if(Cash[Client] >= 2000)
    {
        Cash[Client] -= 2000;
        WLBH[Client]++;
        CPrintToChat(Client, "\x05【提示】你购买了亡灵宝盒!");
    } else CPrintToChat(Client, "\x05【提示】购买失败,金钱不足!");	 
}
...
public Action:MenuFunc_SurvivorBuy(Client)
{
	new Handle:menu = CreateMenu(MenuHandler_SurvivorBuy);
	SetMenuTitle(menu, "金钱: %d $", Cash[Client]);

	AddMenuItem(menu, "option1", "投掷品，药物和子弹盒");
	AddMenuItem(menu, "option2", "特选枪械商店");
	AddMenuItem(menu, "option3", "近武商店");
	AddMenuItem(menu, "option4", "Robot商店");
...
public Action:Menu_NormalItemShop(Client,args)
{
	...
	{
		CPrintToChat(Client, "{green}商店己关闭!");
	}
	return Plugin_Handled;
}
...
static String:GunName[SELECTEDGUNMAX][]={ "MP5衝锋鎗","Scout轻型狙击枪",
"Awp重型狙击枪","Sg552突击步枪","M60机枪","榴弹发射器", "AK47", "战斗散弹鎗"};
...
static String:MeleeName[SELECTEDMELEEMAX][]={ "棒球棍", "板球棍", "铁撬", "电结他",
"斧头", "平底锅", "高尔夫球棍", "武士刀", "CS小刀", "开山刀", "盾牌", "警棍", "电锯"};
...
public Action:MenuFunc_RobotShop(Client)
{
	...
	for(new i=0; i<WEAPONCOUNT; i++)
	{
		Format(line, sizeof(line), "[%s]Robot($%d)", WeaponName[i], GetConVarInt(CfgRobotCost[i])*(RobotCount[Client]+1));
		Format(option, sizeof(option), "option%d", i+1);
		AddMenuItem(menu, option, line);
	}
...
public Action:Menu_InfectedShop(Client,args)
{
	...
	{
		MenuFunc_InfectedShop(Client);
	}
	else if(!IsFakeClient(Client))
	{
		CPrintToChat(Client, "{blue}只限特殊感染者选择!");
	}
	return Plugin_Handled;
}
public Action:MenuFunc_InfectedShop(Client)
{
	new Handle:menu = CreateMenu(MenuHandler_InfectedShop);
	SetMenuTitle(menu, "金钱: %d $", Cash[Client]);

	decl String:line[256];
	Format(line, sizeof(line), "暂时没有东西买!");
...
{
	if (action == MenuAction_Select) {
		if(itemNum == 1) MenuFunc_Buy(Client);
	} else if (action == MenuAction_End) CloseHandle(menu);
}
/* 特殊商店 */
public Action:MenuFunc_SpecialShop(Client)
{
	...
	Format(line, sizeof(line), "消除一次大过 ($%d)", GetConVarInt(RemoveKTCost));
	DrawPanelItem(menu, line);
...
public Action:Menu_Casino_OpenMouth(Client,args)
{
	...
	else CPrintToChat(Client, "{green}你没钱了!");
	return Plugin_Handled;
}
...
public MenuHandler_Casino_OpenMouth(Handle:menu, MenuAction:action, Client, itemNum)
{
	if (action == MenuAction_Select) {
		...
		if(luck == 1)
		{
			CPrintToChat(Client,"{green}赢了! 你获得{lightgreen}%d$",Cash[Client]*(itemNum+1)/10);
			Cash[Client]+=Cash[Client]*(itemNum+1)/10;
		}
		else
		{
			CPrintToChat(Client,"{green}输了! 你损失{lightgreen}%d$",Cash[Client]*(itemNum+1)/10);
			Cash[Client]-=Cash[Client]*(itemNum+1)/10;
		}
	} else if (action == MenuAction_End) CloseHandle(menu);
}
...
public Action:MenuFunc_Lottery(Client)
{
	...
	DrawPanelItem(menu, line);
	Format(line, sizeof(line), "使用(剩餘%d个)", Lottery[Client]);
	DrawPanelItem(menu, line);
...
public Action:UseLotteryFunc(Client)
{
	...
	if(!IsPlayerAlive(Client))
	{
		CPrintToChat(Client, "{green}对不起! {blue}死亡状态下无法使用彩票功能!");
		return Plugin_Handled;
	}
	...
	if(AdminDiceNum[Client]>0 || Lottery[Client]>0)
	{
		...
		switch (diceNum)
		{
			case 1: //给予战术散弹鎗
			{
				...
				CPrintToChatAll("{green}[彩票] %s 获得{green}%d{default}把战术散弹鎗!", NameInfo(Client, colored), Num);
				PrintToServer("[彩票] %s 获得%d把战术散弹鎗!", NameInfo(Client, simple), Num);
			}
			case 2: //冰冻玩家
			{
				new duration = GetRandomInt(10, 30);
				ServerCommand("sm_freeze \"%N\" \"%d\"", Client, duration);
				CPrintToChatAll("{green}[彩票] %s 被冰冻{green}%d{default}秒!", NameInfo(Client, colored), duration);
			...
			case 7: // 召唤Jimmy
			{
				...
				CPrintToChatAll("{green}[彩票] %d{default}个赛车手{green}Jimmy{default}听说 %s 荣获F1冠军, 特来围观!", Num, NameInfo(Client, colored));
				PrintToServer("[彩票] %d个赛车手Jimmy听说 %s 荣获F1冠军, 特来围观!", Num, NameInfo(Client, simple));
			}
			case 8: // 中毒
			{
			...
			case 11: // 尸群事件
			{
				...
				CPrintToChatAll("{green}[彩票] %s 因很久没洗澡而发出的气味在他的周围引来了一群丧尸!", NameInfo(Client, colored));
				PrintToServer("[彩票] %s 因很久没洗澡而发出的气味在他的周围引来了一群丧尸!", NameInfo(Client, simple));
			}
			case 12: // TANK
			{
				CheatCommand(Client, "z_spawn", "tank auto");
			...
			{
				CheatCommand(Client, "director_force_panic_event", "");
				CPrintToChatAll("{green}[彩票] %s 这位大帅哥, 為大家引来了一群丧尸!", NameInfo(Client, colored));
				PrintToServer("[彩票] %s 这位大帅哥, 為大家引来了一群丧尸!", NameInfo(Client, simple));
			}
			case 15: // 萤光
			{
...
public Action:LotteryInfiniteAmmo(Handle:timer)
{
	...
	{
		SetConVarInt(FindConVar("sv_infinite_ammo"), 0);
		CPrintToChatAll("{green}[彩票] {blue}无限子弹结束了!");
	}
	return Plugin_Handled;
}
public Action:LotteryWeakenCommonsHp(Handle:timer)
{
	if(GetConVarInt(FindConVar("z_health"))!=oldCommonHp)
	{
		...
		CPrintToChatAll("{green}[彩票] {blue}普感生命值回复全满!");
		LotteryWeakenCommonsHpTimer = INVALID_HANDLE;
	}
	return Plugin_Handled;
}
public Action:LotteryGodMode(Handle:timer)
{
	...
	{
		SetConVarInt(FindConVar("god"), 0);
		CPrintToChatAll("{green}[彩票] {blue}无敌门事件结束了!");
	}
	return Plugin_Handled;
}
...
public Action:MenuFunc_PasswordInfo(Client)
{
	...
	else if(StrEqual(Password[Client], "", true))	Format(line, sizeof(line), "密码资讯 密码状态: 未啟动");
	else if(!IsPasswordConfirm[Client])	Format(line, sizeof(line), "密码资讯 密码状态: 未输入");

	SetPanelTitle(menu, line);

	Format(line, sizeof(line), "说明: 啟动密码系统后别人便不能用你的名字读取你的记录");
	DrawPanelText(menu, line);
	Format(line, sizeof(line), "输入/啟动密码指令: /rpgpw 密码");
	DrawPanelText(menu, line);
...
public Action:MenuFunc_RPGInfo(Client)
{
	...
	PrintToChat(Client, "\x04插件名称: \x05United RPG Version %s", PLUGIN_VERSION);
	PrintToChat(Client, "\x04恋水晶之冰囧QQ: \x05mcpan@foxmail.com");
	PrintToChat(Client, "\x04Max Chu Msn: \x05olympic.chu@mensa.org.hk");
	PrintToChat(Client, "\x05插件有什麼BUG/建议欢迎大家提出来");
	PrintToChat(Client, "\x03════════════════");
	return Plugin_Handled;
}
/* 队伍资讯 */
...
{	
	...
	decl String:line[128];
	Format(line, sizeof(line), "队伍资讯 - 总共玩家数: %d/%d 幸存者: %d/%d 特殊感染者: %d/%d 旁观者: %d", ServerPlayer, ServerMaxPlayer, SurvivorPlayer, SurvivorMaxPlayer, InfectedPlayer, InfectedMaxPlayer, SpectatorPlayer);
	...
	AddMenuItem(menu, "option2", line);
	Format(line, sizeof(line), "旁观者阵营(总等级: %d, 玩家数: %d):", SpectatorLv, SpectatorPlayer);
	AddMenuItem(menu, "option3", line);
...
{	
	...
	new Handle:TeamPanel = CreatePanel();
	decl String:line[128];
	Format(line, sizeof(line), "旁观者阵营(总等级: %d, 总玩家数: %d):", SpectatorLv, SpectatorPlayer);
	SetPanelTitle(TeamPanel, line);
	new count = 1;
	for (new i = 1; i <= MaxClients; i++)
	{
...
public Action:BindMsg(Client)
{
	...
	if(JD[Client] == 1) PrintToChat(Client, MSG_BIND_JOB1);
	else if(JD[Client] == 2) PrintToChat(Client, MSG_BIND_JOB2);
	else if(JD[Client] == 3) PrintToChat(Client, MSG_BIND_JOB3);
	else if(JD[Client] == 4)
	{
		PrintToChat(Client, MSG_BIND_JOB4);
		PrintToChat(Client, MSG_BIND_JOB4_1);
	}
	else if(JD[Client] == 5) PrintToChat(Client, MSG_BIND_JOB5);
	return Plugin_Handled;
}
...
AddRobot(Client)
{
	...
	for(new i=0; i<WEAPONCOUNT; i++)
	{
		...
		{
			CPrintToChatAll("{green}%N{lightgreen}啟动了[%s]Robot!", Client, WeaponName[i]);
			PrintToServer("[United RPG] %s啟动了[%s]Robot!", NameInfo(Client, simple), WeaponName[i]);
		}
	}
...
Do(Client, Float:currenttime, Float:duration)
{
	if(robot[Client]>0)
	{
		...
		else
		{
			...
			{
				Release(Client);
				CPrintToChat(Client, "{blue}你的Robot已用尽能量了!");
			...
			{
				Release(Client);
				CPrintToChatAll("{green} %N {lightgreen}关闭了Robot", Client);
				return;
			}
...
public SetPrameter(client, form_next)
{
	...
	else if(form_next == FORMTWO)
	{
		if(GetConVarInt(sm_lastboss_enable_announce))
		{
			CPrintToChatAll(MESSAGE_SECOND, client);
			CPrintToChatAll(MESSAGE_SECOND2);
		}
	...
	else if(form_next == FORMTHREE)
	{
		if(GetConVarInt(sm_lastboss_enable_announce))
		{
			CPrintToChatAll(MESSAGE_THIRD, client);
			CPrintToChatAll(MESSAGE_THIRD2);
		}
	...
	else if(form_next == FORMFOUR)
	{
		if(GetConVarInt(sm_lastboss_enable_announce))
		{
			CPrintToChatAll(MESSAGE_FORTH, client);
			CPrintToChatAll(MESSAGE_FORTH2);
			CPrintToChatAll(MESSAGE_FORTH3);
		}
	...
	if(ent>0 && IsValidEntity(ent) && IsValidEdict(ent))
	{
		...
		if( StrEqual(g_classname, "grenade_launcher_projectile", true)  || StrEqual(g_classname, "molotov_projectile", true) || StrEqual(g_classname, "tank_rock", true))
		{
			...
			if(enemy>0)
			{
				...
				//CPrintToChatAll("1 %f %f %f", posmissile[0], posmissile[1], posmissile[2]);
				...
				//CPrintToChatAll("%f %f %f", tracevec[0], tracevec[1], tracevec[2]);
				...
				//CPrintToChatAll("%N %d", enemy, gteam);
			} else
			{
...
GetEnemy(Float:pos[3], Float:vec[3], gteam)
{
	...
	for(new client = 1; client <= MaxClients; client++)
	{
		if(IsClientInGame(client) && IsPlayerAlive(client) && GetClientTeam(client)==gteam )
		{
			...
			t=GetAngle(vec, pos2);
			//CPrintToChatAll("%N %f", client, 360.0*t/3.1415926/2.0);
			if(t<=min)
			{
				min=t;
				s=client;
		...
		for(new i=1;i<=MaxClients;i++)
		{
			if(IsClientInGame(i)){
				if(GetEntPropEnt(entity, Prop_Data, "m_hOwnerEntity") == i && GetClientTeam(i) == TEAM_INFECTED)
				{
					InfectedSummonCount[i] -= 1;
					SetEntPropEnt(entity, Prop_Data, "m_hOwnerEntity", 0);
					CPrintToChat(i, MSG_SKILL_IS_WITCH_DISAPPEAR);
					break;
				}
			}
		}
...
public Action:GetObserverTargetInfo(Client)
{
	...
	PrintCenterText(Client, "正在观察: %s  误杀:%d次 转生:%d次", NameInfo(target, simple), KTCount[target], NewLifeCount[target]);
	return Plugin_Handled;
}
...
public Action:TestFunction(Client, args)
{
	...
	{
		TR_GetEndPosition(hitpos, trace);
		PrintToChatAll("Distance = %.2f", GetVectorDistance(clientPos, hitpos));
	}
	CloseHandle(trace);*/
