...
public void OnPluginStart() {
	...
	g_hMapNameLang = CreateConVar("a2s_info_mapname_language", "en", "What language is used in the generated PhraseFile to replace the TranslatedText of en? (Please Delete All A2S_Edit PhraseFile After Change This Cvar to Regenerate)", CVAR_FLAGS);
