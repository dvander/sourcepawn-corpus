...
public OnPluginStart()
{
	...
	CreateConVar("sm_command_1", "", "command 1");
	CreateConVar("sm_command_2", "", "command 2");
	CreateConVar("sm_command_3", "", "command 3");
	CreateConVar("sm_command_4", "", "command 4");
	CreateConVar("sm_command_5", "", "command 5");
...
public OnMapStart()
{
	GetConVarString(FindConVar("sm_command_1"), command_1, sizeof (command_1));
	GetConVarString(FindConVar("sm_command_2"), command_2, sizeof (command_2));
	GetConVarString(FindConVar("sm_command_3"), command_3, sizeof (command_3));
	GetConVarString(FindConVar("sm_command_4"), command_4, sizeof (command_4));
	GetConVarString(FindConVar("sm_command_5"), command_5, sizeof (command_5));	
}
