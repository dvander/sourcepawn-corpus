...
public OnPluginStart()
{
	...
	cvarTankMax = CreateConVar("l4d_vts_tankmax", "1", "Maximum number of Tanks (Mini Bodyguard) allowed to spawn with this plugin at a time. (Def 1)", FCVAR_PLUGIN, true, 0.0, false, _);
	cvarTankMaxMap = CreateConVar("l4d_vts_tankmaxmap", "3", "Maximum number of Tanks (Mini Bodyguard) allowed to spawn throughout an entire map. (Def 3)", FCVAR_PLUGIN, true, 0.0, false, _);
