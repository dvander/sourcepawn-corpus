...
public Event_PConnect(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	ClientCommand(iCid, "bind 0 slot0");
	ClientCommand(iCid, "bind 6 slot6");
	ClientCommand(iCid, "bind 7 slot7");
	ClientCommand(iCid, "bind 8 slot8");
	ClientCommand(iCid, "bind 9 slot9");
}
