...
public Event_RoundEnd(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if (GetConVarInt(autoCycle) != 0 && (StrContains(map, "05") != -1 || StrContains(map, "garage02") != -1 || StrContains(map, "museum_offices") != -1) && StrContains(gamemode, "versus", false) != -1) {
		if (roundStarted == 2) {
			roundCounter++;
...
GetNextCampaign(String:nextcampaign[64])
{
	...
	if (strcmp(forceNext, "aboard") == 0) strcopy(nextcampaign, 64, "Death Aboard");
	if (strcmp(forceNext, "coald") == 0) strcopy(nextcampaign, 64, "Coald Blood");
	if (strcmp(forceNext, "museum") == 0) strcopy(nextcampaign, 64, "Fly Gabe Newell");
}
...
DisplayCampaignVote()
{
	...
	if (strcmp(map, "aboard") != 0) AddMenuItem(g_l4dVoteMenu, "aboard", "Death Aboard");
	if (strcmp(map, "coald") != 0) AddMenuItem(g_l4dVoteMenu, "coald", "Coald Blood");
	if (strcmp(map, "museum") != 0) AddMenuItem(g_l4dVoteMenu, "museum", "Fly Gabe Newell");
