...
public void OnPluginStart()
{
	...
	SplashDamageEasy = CreateConVar("l4d_splash_damage_dmg_easy", "10.0", " Amount of damage the Boomer Explosion deals in easy difficulty", CVAR_FLAGS);
	SplashDamageNormal = CreateConVar("l4d_splash_damage_dmg_normal", "20.0", " Amount of damage the Boomer Explosion deals in normal difficulty", CVAR_FLAGS);
	SplashDamageHard = CreateConVar("l4d_splash_damage_dmg_hard", "30.0", " Amount of damage the Boomer Explosion deals in hard difficulty", CVAR_FLAGS);
	SplashDamageExpert = CreateConVar("l4d_splash_damage_dmg_expert", "40.0", " Amount of damage the Boomer Explosion deals in expert difficulty", CVAR_FLAGS);
