...
public void OnMapStart()
{
	...
	CreateTimer(5.0,SetEvents,TIMER_FLAG_NO_MAPCHANGE);
}
...
public void MissionLost(Handle event, const char[] name, bool dontBroadcast)
{
	CreateTimer(15.0,SetEvents,TIMER_FLAG_NO_MAPCHANGE);
}
public Action SetEvents(Handle hTimer)
{
