...
{
	name = "[L4D & L4D2] Pipe Bomb Freezing",
...
public void OnPluginStart()
{
	...
	l4d_freeze = CreateConVar("l4d_freeze", "1", "0 = enable, 1 = disable plugin.", CVAR_FLAGS);
	l4d_freeze_time = CreateConVar("l4d_freeze_time", "10.0", "freeze time.", CVAR_FLAGS);
	l4d_freeze_speed = CreateConVar("l4d_freeze_speed", "0.5", "slow down(0 = freeze)", CVAR_FLAGS);
