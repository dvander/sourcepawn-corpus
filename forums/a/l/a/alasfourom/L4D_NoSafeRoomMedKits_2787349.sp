...
public void OnPluginStart()
{
	...
	g_Cvar_NoKitsChange = CreateConVar("l4d_no_saferoom_medkits_change", "weapon_pain_pills_spawn", "You Can Replace Med-Kits With Either [weapon_adrenaline_spawn] Or [weapon_pain_pills_spawn] While [Empty For No Items]", FCVAR_NOTIFY);
...
public void OnMapStart()
{
	if (g_bLeft4Dead && g_Cvar_NoKitsEnable.BoolValue)
	{
		...
		if (StrContains(GameInfo, GameMode) != -1) CreateTimer(1.0, Timer_StartFiltering, _, TIMER_FLAG_NO_MAPCHANGE);
		else return;
	}
}
