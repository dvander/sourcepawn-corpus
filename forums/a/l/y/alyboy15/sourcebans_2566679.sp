...
new const String:Prefix[] = "[Project Nemesys] ";
...
stock PrepareBan(client, target, time, String:reason[], size)
{
	...
	if (CreateBan(client, target, time, reason))
	{
		...
		PrintToChatAll ( "\x01★ \x04[SourceBans]\x01 \x07ADMIN\x04 %L\x01 ia dat \x04BAN\x01 jucatorului\x04 %L\x01 !", client, target, time, reason );
