/*
	...
	//Medic: and the sm_resize@aim command
	//Medic: as a seperate plugin
*/
...
new String:g_sParticleRed[64], String:g_sParticleBlu[64], String:g_sNotify[8];
...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_warp", Command_Warp, ADMFLAG_CUSTOM1 ); 
...
CreateClientParticle(client)
{
	if(g_bParticle && g_bParticlesAllowed)
	{
		...
		Format(particle, sizeof(particle), team == 2 ? g_sParticleRed : g_sParticleBlu);
