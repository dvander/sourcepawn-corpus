...
Handle g_Cvar_PluginEnable = INVALID_HANDLE;
Handle g_Cvar_PluginTimer = INVALID_HANDLE;
Handle g_Cvar_MessageLines = INVALID_HANDLE;
Handle g_Cvar_PanelLines = INVALID_HANDLE;
Handle g_Cvar_MsgType = INVALID_HANDLE;

public Plugin myinfo =
{
	name = "Simple Welcome Message",
	author = "Zuko, B3none",
	description = "Display simple welcome message.",
	version = "1.2",
...
public Action Timer_Welcome(Handle timer, int client)
{
	...
	{
		int msgbits = GetConVarInt(g_Cvar_MsgType);
		if (msgbits & CHAT)
		{
...
void ChatMessagesDisplay(int client)
{
	if (IsClientConnected(client) && IsClientInGame(client))
	{
		switch(GetConVarInt(g_Cvar_MessageLines))
		{
			case 0:
			{
				PrintToChat(client, "%T", "WelcomeMsg1", LANG_SERVER, client);
			}
			case 1:
			{
				PrintToChat(client, "%T", "WelcomeMsg1", LANG_SERVER, client);
				PrintToChat(client, "%T", "WelcomeMsg2", LANG_SERVER);
			}
			case 2:
			{
				PrintToChat(client, "%T", "WelcomeMsg1", LANG_SERVER, client);
				PrintToChat(client, "%T", "WelcomeMsg2", LANG_SERVER);
				PrintToChat(client, "%T", "WelcomeMsg3", LANG_SERVER);
			}
			case 3:
			{
				PrintToChat(client, "%T", "WelcomeMsg1", LANG_SERVER, client);
				PrintToChat(client, "%T", "WelcomeMsg2", LANG_SERVER);
				PrintToChat(client, "%T", "WelcomeMsg3", LANG_SERVER);
				PrintToChat(client, "%T", "WelcomeMsg4", LANG_SERVER);
			}
			case 4:
			{
				PrintToChat(client, "%T", "WelcomeMsg1", LANG_SERVER, client);
				...
				PrintToChat(client, "%T", "WelcomeMsg3", LANG_SERVER);
				PrintToChat(client, "%T", "WelcomeMsg4", LANG_SERVER);
				PrintToChat(client, "%T", "WelcomeMsg5", LANG_SERVER);
			}
			case 5:
			{
				PrintToChat(client, "%T", "WelcomeMsg1", LANG_SERVER, client);
				...
				PrintToChat(client, "%T", "WelcomeMsg4", LANG_SERVER);
				PrintToChat(client, "%T", "WelcomeMsg5", LANG_SERVER);
				PrintToChat(client, "%T", "WelcomeMsg6", LANG_SERVER);
			}
			case 6:
			{
				PrintToChat(client, "%T", "WelcomeMsg1", LANG_SERVER, client);
				...
				PrintToChat(client, "%T", "WelcomeMsg5", LANG_SERVER);
				PrintToChat(client, "%T", "WelcomeMsg6", LANG_SERVER);
				PrintToChat(client, "%T", "WelcomeMsg7", LANG_SERVER);
			}
			case 7:
			{
				PrintToChat(client, "%T", "WelcomeMsg1", LANG_SERVER, client);
				...
				PrintToChat(client, "%T", "WelcomeMsg6", LANG_SERVER);
				PrintToChat(client, "%T", "WelcomeMsg7", LANG_SERVER);
				PrintToChat(client, "%T", "WelcomeMsg8", LANG_SERVER);
			}
		}
	}
}

void PanelMessageDisplay(int client) 
{
	char message1[255];
	char message2[255];
	char message3[255];
...
void HintMessageDisplay(int client)
{
