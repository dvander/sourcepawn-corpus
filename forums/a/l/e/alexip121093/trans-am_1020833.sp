...
cvar_speed = CreateConVar("sm_trans_fast", "10", "speed up time  s", FCVAR_PLUGIN, true, 1.0, true, 4.0);
cvar_slow = CreateConVar("sm_trans_slow", "30", "slow down time s", FCVAR_PLUGIN, true, 1.0, true, 4.0);
cvar_fastspeed = CreateConVar("sm_trans_fastspeed", "3", "speed(trans-arm start)", FCVAR_PLUGIN, true, 1.0, true, 4.0);
cvar_slowspeed = CreateConVar("sm_trans_slowspeed", "0.3", "speed(trans-arm end)", FCVAR_PLUGIN, true, 1.0, true, 4.0);
cvar_health = CreateConVar("sm_trans_health", "80", "health after trans-arm", FCVAR_PLUGIN, true, 1.0, true, 4.0);
