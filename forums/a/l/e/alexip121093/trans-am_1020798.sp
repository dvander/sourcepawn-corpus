...
PrintToChatAll("\x01[rank]buy \x03[%s] have started Trans-Arm ,speed & HP up\x03",clientName);
trans1[client] = true;
return;
}
...
PrintToChatAll("\x01[rank]buy \x03[%s]have been recovered\x03",clientName);
trans[client] = false;
}
