...
showscoreCVAR  = CreateConVar("l4d2_teampanel_Autoshowafterscore", "1", "auto show the panel when player see the score board", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 1.0);
