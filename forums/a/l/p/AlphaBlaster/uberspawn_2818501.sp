...
{	
	...
	//		SetFailState("This plugin only supports TF2C.");
	//	}
	...
	pluginDuration = CreateConVar("sm_uberspawnduration", "5.0", "Duration in seconds for the ubercharge.", FCVAR_NONE, true, 0.0);
	pluginNotify = CreateConVar("sm_uberspawnnotify", "0", "Notifies the client who connects that the server is running Uberspawn and that they will be protected.", FCVAR_NONE, true, 0.0, true, 1.0);
