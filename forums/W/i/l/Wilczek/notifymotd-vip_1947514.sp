...
public OnPluginStart()
{
	...
	VipURL = CreateConVar("sm_vip_url","http://yourdomain.com/r_vip.html","Set this to the URL of your routing VIP.");
...
{
	new String:VIP1URL[128];
	GetConVarString(VipURL, VIP1URL, sizeof(VIP1URL));
	
	ShowMOTDPanel(client, "VIP Panel", VIP1URL, MOTDPANEL_TYPE_URL);
	return Plugin_Handled;
}
