...
public Plugin myinfo = 
{
    ...
    author = "luki1412, DarthNinja - Edited by Whai",
...
public void PowerPlay(int client, bool enabled)
{
	...
	if (enabled)
	{
		...
		TF2_AddCondition(client, TFCond_SpeedBuffAlly, g_Duration, client);
		TF2_AddCondition(client, TFCond_UberBulletResist, g_Duration, client);
		TF2_AddCondition(client, TFCond_UberBlastResist, g_Duration, client);
		TF2_AddCondition(client, TFCond_UberFireResist, g_Duration, client);
		TF2_AddCondition(client, TFCond_CritDemoCharge, g_Duration, client);
		TF2_AddCondition(client, TFCond_InHealRadius, g_Duration, client);
		TF2_AddCondition(client, TFCond_Healing, g_Duration, client);
		TF2_AddCondition(client, TFCond_Overhealed, g_Duration, client);
		TF2_AddCondition(client, TFCond_HalloweenQuickHeal, g_Duration, client);
		TF2_AddCondition(client, TFCond_RuneHaste);
		TF2_SetPlayerPowerPlay(client, true);
		TF2_AddCondition(client, TFCond_MegaHeal, g_Duration, client);
	...
	else
	{
		...
		TF2_RemoveCondition(client, TFCond_Healing);
		TF2_RemoveCondition(client, TFCond_Overhealed);
