...
public Action:Afficher_Menu_Bhop(client, args)
{
	if (GetClientTeam(client) == 3)
	{
		...
		SetMenuTitle(menu, "Free Days");
		AddMenuItem(menu, "option1", "FreeDay", 0);
		AddMenuItem(menu, "option2", "Panda FreeDay", 0);
		AddMenuItem(menu, "option3", "Zombie FreeDay", 0);
	...
	if (action == MenuAction:4)
	{
		switch (itemNum)
		{
			case 0:
			{
				...
				FakeClientCommand(client, "say @[WARDEN] FreeDay");
			}
			case 1:
			{
				FakeClientCommand(client, "say /open");
				FakeClientCommand(client, "say @[WARDEN] Panda FreeDay");
			}
			case 2:
			{
				FakeClientCommand(client, "say /open");
				FakeClientCommand(client, "say @[WARDEN] Zombie FreeDay");
			}
			default:
			{
			}
