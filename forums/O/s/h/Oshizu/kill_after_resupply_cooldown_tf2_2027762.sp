...
{
	name = "[TF2] Kill After Resupply Cooldown",
	author = "Oshizu / Sena™ ¦",
	description = "Gives you ability to set cooldown for kills after players resupply.",
	version = "1.0",
...
{
	HookEvent("post_inventory_application", Inventory, EventHookMode_Post)
	CantKill_cooldown_cvar = CreateConVar("sm_karc_cooldown", "5.0", "How much seconds after player spawns / resupply should be able to kill again?", FCVAR_PLUGIN|FCVAR_REPLICATED)
