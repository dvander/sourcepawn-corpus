...
Handle:cvar_type[MAX];
Handle:cvar_time[MAX];
Handle:cvar_arch_demos;
Handle:cvar_arch_replays;
Handle:cvar_enable;
Handle:cvar_logtype;
Handle:cvar_demopath;
Handle:cvar_logging;
Handle:g_warpath;
Handle:g_logsdir;
Handle:g_backuproundprefix;
...
public OnPluginStart()
{
	...
	cvar_type[SML] = CreateConVar("sm_srvcln_smlogs", "1", desc, FCVAR_PLUGIN, true, 0.0, true, 1.0);
	...
	cvar_arch_replays = CreateConVar("sm_srvcln_replays_archives", "0", desc, FCVAR_PLUGIN, true, 0.0, true, 1.0);
	...
	cvar_demopath = CreateConVar("sm_srvcln_demos_path", "./demos", desc, FCVAR_PLUGIN);
	...
	cvar_arch_demos = CreateConVar("sm_srvcln_demos_archives", "0", desc, FCVAR_PLUGIN, true, 0.0, true, 1.0);
	
	FormatEx(desc, sizeof(desc), "%t", "srvcln_smlogs_type");
	cvar_logtype = CreateConVar("sm_srvcln_smlogs_type", "2", desc, FCVAR_PLUGIN, true, 0.0, true, 2.0);
