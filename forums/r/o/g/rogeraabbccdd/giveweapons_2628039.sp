...
new const String:g_weapons[MAX_WEAPONS][] = {
	...
	"weapon_scar20", "weapon_sg556", "weapon_smokegrenade", "weapon_ssg08", "weapon_taser", "weapon_tec9", "weapon_ump45", "weapon_xm1014", "weapon_awp", 
	"weapon_m4a1_silencer", "weapon_cz75a", "weapon_usp_silencer", "weapon_revolver", "weapon_healthshot", "weapon_tagrenade", "weapon_mp5sd",
	"weapon_fists", "weapon_breachcharge", "weapon_tablet", "weapon_melee", "weapon_axe", "weapon_hammer", "weapon_spanner", "weapon_firebomb", 
	"weapon_diversion", "weapon_fraggrenade", 
};
