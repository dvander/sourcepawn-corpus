...
public void OnPluginStart()
{
	...
	cv_HidePlayers = CreateConVar("sm_csgoagents_hideplayers", "1", "Hide players when thirdperson view active.\nDisable: 0\nEnemies: 1\nAll: 2", _, true, 0.0, true, 2.0);
...
{
	if(cv_PreviewDuration.BoolValue && cv_HidePlayers.IntValue > 0 && client != agent && IsPlayerAlive(client) && g_hTimer[agent] != INVALID_HANDLE)
	{
