...
public OnPluginStart()
{
	...
	RegConsoleCmd("ftz_ignore_chat", Command_IgnoreChat, "Usage: ftz_ignore <#userid|name>\nToggles target ignore status on Chat.");
	RegConsoleCmd("ftz_ignore_voice", Command_IgnoreVoice, "Usage: ftz_ignore <#userid|name>\nToggles target ignore status on Voice.");
	RegConsoleCmd("sm_ignore_c", Command_IgnoreChat, "Usage: ftz_ignore <#userid|name>\nToggles target ignore status on Chat.");
	RegConsoleCmd("sm_ignore_v", Command_IgnoreVoice, "Usage: ftz_ignore <#userid|name>\nToggles target ignore status on Voice.");
