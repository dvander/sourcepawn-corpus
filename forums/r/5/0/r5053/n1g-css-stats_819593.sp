...
createdbplayer()
{
	...
	len += Format(query[len], sizeof(query)-len, " `hostage_rescued` int(11) NOT NULL , `KW_awp` int(11) NOT NULL , `KW_sg550` int(11) NOT NULL , PRIMARY KEY (`NAME`));");
...
createdbplayersqllite()
{
	...
	len += Format(query[len], sizeof(query)-len, " `hostage_rescued` INTEGER, `KW_awp` INTEGER, `KW_sg550` INTEGER);");
