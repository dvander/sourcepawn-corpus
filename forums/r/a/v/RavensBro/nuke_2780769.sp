...
public void OnPluginStart()
{
    ...
    RegAdminCmd("sm_nuke", Command_Nuke, ADMFLAG_ROOT, "Place a nuke at your curson");
...
public Plugin myinfo = 
{
	...
	author = "Pelipoika, edit by RavensBro",
...
{
	float Position[3];
	if (IsValidClient(client) && (IsClientInGame(client) && (IsPlayerAlive(client) && (!SetTeleportEndPoint(client, Position)))))
	if (client==0)
	{
...
public Action Timer_NukeHitsHere(Handle timer, DataPack pack)
{
	...
	DispatchKeyValueFloat(iBomb, "damage", 9999.0);
	DispatchKeyValueFloat(iBomb, "radius", 1000.0);
	DispatchKeyValue(iBomb, "spawnflags", "4");
