...
{
	CreateConVar("sm_rftd_version", PLUGIN_VERSION, "Rise from the Dead: Version", 0|FCVAR_SPONLY|FCVAR_CHEAT|FCVAR_NOTIFY|FCVAR_DONTRECORD);
...
{
    if(IsValidEntity(entity) && IsValidEntity(entity))
...
{
    new tf_zombie;
    if(IsValidEntity(entity) && IsValidEntity(tf_zombie))
	{
