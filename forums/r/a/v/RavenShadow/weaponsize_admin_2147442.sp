...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_weaponsize", WeaponSize, ADMFLAG_KICK);
	RegAdminCmd("sm_ws", WeaponSize, ADMFLAG_KICK);
	RegAdminCmd("sm_weaponsizer", WeaponSizer, ADMFLAG_BAN);
	RegAdminCmd("sm_resetsize", ResetSize, ADMFLAG_BAN);
