...
public OnPluginStart(){
  ...
  g_enableConVar = CreateConVar("sm_damage_report_enable", "1", "Damage report enable", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);
...
DisplayDamageReport(in_victim, String:damageDone[512] ,String:damageDoneLong[512] ,String:damageTaken[512], String:damageTakenLong[512], totalDmgDone, totalDmgTaken) {
	if (GetConVarBool(g_enableConVar)==true) {
