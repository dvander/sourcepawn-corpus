...
public void OnPluginStart() {
    ...
    g_hMessageFormat = CreateConVar("sm_damageprint_format", "--> ({GREEN}{DMG_TO} {NORMAL}dmg / {GREEN}{HITS_TO} {NORMAL}hits) to ({LIGHT_RED}{DMG_FROM} {NORMAL}dmg / {LIGHT_RED}{HITS_FROM} {NORMAL}hits) from {GREEN}{NAME} {NORMAL}({HEALTH} HP)", "Format of the damage output string. Avaliable tags are in the default, color tags such as {LIGHT_RED} and {GREEN} also work.");
    g_ExcludeBots = CreateConVar("sm_damageprint_exclude_bots", "1", "Whether to exclude bots in damage reports");

    AutoExecConfig();
    RegConsoleCmd("sm_whyyyyyyyyyyyyy", Command_Damage, "Displays damage done");
