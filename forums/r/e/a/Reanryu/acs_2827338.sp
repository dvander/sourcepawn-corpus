...
#define TIME_TO_WAIT 60.0
#define WAIT_TIME_BEFORE_SWITCH_COOP			60.0
#define WAIT_TIME_BEFORE_SWITCH_VERSUS			60.0
#define WAIT_TIME_BEFORE_SWITCH_SCAVENGE		60.0
#define WAIT_TIME_BEFORE_SWITCH_SURVIVAL		60.0
