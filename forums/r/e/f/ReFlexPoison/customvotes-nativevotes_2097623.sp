...
public Vote_Map(iVote, iVoter, iMap)
{
	...
	new Handle:hMenu = NativeVotes_Create(VoteHandler_Map, NativeVotesType_Custom_YesNo, NATIVEVOTES_ACTIONS_DEFAULT | MenuAction_Select);
...
public Vote_List(iVote, iVoter, iOption)
{
	...
	new Handle:hMenu = NativeVotes_Create(VoteHandler_List, NativeVotesType_Custom_YesNo, NATIVEVOTES_ACTIONS_DEFAULT | MenuAction_Select);
...
public Vote_Simple(iVote, iVoter)
{
	...
	new Handle:hMenu = NativeVotes_Create(VoteHandler_Simple, NativeVotesType_Custom_YesNo, NATIVEVOTES_ACTIONS_DEFAULT | MenuAction_Select);
