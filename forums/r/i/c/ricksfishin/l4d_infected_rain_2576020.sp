...
{
	l4d_rain_enable                = CreateConVar("l4d_rain_enable", "1", "{0,1}",                             FCVAR_SPONLY); 
	l4d_spawn_enable               = CreateConVar("l4d_spawn_enable", "1", "{0,1}",                            FCVAR_SPONLY); 
	
	l4d_rain_mininterval           = CreateConVar("l4d_rain_mininterval", "120", "[200, maxinterval]seconds ", FCVAR_SPONLY); 
	l4d_rain_maxinterval           = CreateConVar("l4d_rain_maxinterval", "240", "[200, 600]seconds ",         FCVAR_SPONLY);	
	l4d_rain_duration              = CreateConVar("l4d_rain_duration", "2.0", "",                             FCVAR_SPONLY);	
	l4d_rain_intervual             = CreateConVar("l4d_rain_intervual", "0.1", "",                             FCVAR_SPONLY);	
	
	l4d_rain_chance_tankdead       = CreateConVar("l4d_rain_chance_tankdead", "30", "0 - 100%",                FCVAR_SPONLY); 
	l4d_rain_chance_witchdead      = CreateConVar("l4d_rain_chance_witchdead", "20", " ",                      FCVAR_SPONLY); 	
	l4d_rain_chance_witch_harasser = CreateConVar("l4d_rain_chance_witch_harasser", "20", "",                  FCVAR_SPONLY); 	
	
	l4d_spawn_chance_tankrock      = CreateConVar("l4d_spawn_chance_tankrock", "20", "",                       FCVAR_SPONLY);
	l4d_spawn_mincount_tankrock    = CreateConVar("l4d_spawn_mincount_tankrock", "3", "",                      FCVAR_SPONLY);
	l4d_spawn_maxcount_tankrock    = CreateConVar("l4d_spawn_maxcount_tankrock", "5", "",                     FCVAR_SPONLY);
	
	l4d_spawn_chance_spitteracid   = CreateConVar("l4d_spawn_chance_spitteracid", "30", "",                    FCVAR_SPONLY);
	l4d_spawn_mincount_spitteracid = CreateConVar("l4d_spawn_mincount_spitteracid", "8", "",                   FCVAR_SPONLY);
	l4d_spawn_maxcount_spitteracid = CreateConVar("l4d_spawn_maxcount_spitteracid", "16", "",                  FCVAR_SPONLY);
	
	l4d_spawn_chance_boomervomit   = CreateConVar("l4d_spawn_chance_boomervomit", "30", "",                    FCVAR_SPONLY); 
	
	l4d_spawn_chance_boomerdead    = CreateConVar("l4d_spawn_chance_boomerdead", "30", "",                     FCVAR_SPONLY);
	l4d_spawn_mincount_boomerdead  = CreateConVar("l4d_spawn_mincount_boomerdead", "5", "",                    FCVAR_SPONLY);	
	l4d_spawn_maxcount_boomerdead  = CreateConVar("l4d_spawn_maxcount_boomerdead", "10", "",                   FCVAR_SPONLY);

	l4d_spawn_chance_spitterdead   = CreateConVar("l4d_spawn_chance_spitterdead", "30", "",                    FCVAR_SPONLY);
	l4d_spawn_mincount_spitterdead = CreateConVar("l4d_spawn_mincount_spitterdead", "3", "",                   FCVAR_SPONLY);	
	l4d_spawn_maxcount_spitterdead = CreateConVar("l4d_spawn_maxcount_spitterdead", "8", "",                   FCVAR_SPONLY);
		
	l4d_spawn_chance_tankdead      = CreateConVar("l4d_spawn_chance_tankdead", "30", "",                       FCVAR_SPONLY);
	l4d_spawn_mincount_tankdead    = CreateConVar("l4d_spawn_mincount_tankdead", "6", "",                      FCVAR_SPONLY);	
	l4d_spawn_maxcount_tankdead    = CreateConVar("l4d_spawn_maxcount_tankdead", "12", "",                     FCVAR_SPONLY);
