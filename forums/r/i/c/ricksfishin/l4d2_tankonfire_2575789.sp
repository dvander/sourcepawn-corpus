...
public OnPluginStart()
{
	...
	h_cvarBoostEnabled = CreateConVar("l4d2_tankfire_boost_enable", "1", "0 turns speed boost off, 1 turns it on.", FCVAR_SPONLY, true, 0.0, true, 1.0);
	h_cvarSpeedBoost = CreateConVar("l4d2_tankfire_boost_amount", "1.9", "Multiplier for tank speed while on fire.", FCVAR_SPONLY, true, 0.5, true, 2.0);
	h_cvarWarningEnabled = CreateConVar("l4d2_tankfire_warning_enable", "1", "1 prints a warning to the screen when the tank is lit. 0 does not.", FCVAR_SPONLY, true, 0.0, true, 1.0);
	h_cvarFireDamage = CreateConVar("l4d2_tankfire_damage_amount", "0", "Amount of fire damage the tank deals upon punching.", FCVAR_SPONLY, true, 0.0, true, 15.0);
