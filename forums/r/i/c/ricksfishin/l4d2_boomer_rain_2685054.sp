...
public OnPluginStart() 
{
	...
	CVarExplosion = CreateConVar("sm_Boomer_rain_explosive", "1", "Should the survivors get biled and stumbled?", FCVAR_NOTIFY);
	CVarSplatRadius = CreateConVar("z_exploding_splat_radius", "200", "Splat Radius from Boomers?", FCVAR_NOTIFY);
	CreateConVar("sm_Boomer_rain_version", PLUGIN_VERSION, "Boomer Rain Version", FCVAR_NOTIFY|FCVAR_DONTRECORD);
