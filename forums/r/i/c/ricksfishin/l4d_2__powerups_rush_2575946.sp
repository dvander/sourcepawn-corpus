...
public OnPluginStart()
{
	...
	CreateConVar("l4d_powerups_rush_version", PLUGIN_VERSION,
		"The version of the PowerUps plugin.", FCVAR_NONE|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);
	powerups_plugin_on = CreateConVar(
		"l4d_powerups_plugin_on",
		"1",
		"Is the Plugin active? (1 = ON  0 = OFF)",
		FCVAR_NONE|FCVAR_SPONLY, true, 0.0, true, 1.0);
	...
	powerups_broadcast_type = CreateConVar(
		...
		FCVAR_NONE|FCVAR_SPONLY, true, 0.0, true, 2.0);
	...
	powerups_duration = CreateConVar(
		...
		FCVAR_NONE|FCVAR_NOTIFY, true, 1.0);
	...
	g_h_reload_rate = CreateConVar(
		...
		FCVAR_NONE|FCVAR_NOTIFY, true, 0.2, true, 0.9);
	...
	g_h_melee_rate = CreateConVar(
		...
		FCVAR_NONE|FCVAR_NOTIFY, true, 0.3, true, 0.9);
