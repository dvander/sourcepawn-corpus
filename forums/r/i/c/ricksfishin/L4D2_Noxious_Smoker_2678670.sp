...
public OnPluginStart()
{
	...
	cvarMethaneBlastInnerRange = CreateConVar("l4d_nsm_methaneblastinnerrange", "200.0", "Range the inner blast radius will extend from Methane Blast. (Def 200.0)", FCVAR_NOTIFY);
	cvarMethaneBlastOuterRange = CreateConVar("l4d_nsm_methaneblastouterrange", "300.0", "Range the outer blast radius will extend from Methane Blast. (Def 300.0)", FCVAR_NOTIFY);
