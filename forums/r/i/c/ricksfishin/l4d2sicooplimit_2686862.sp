...
{
	CreateConVar("l4d_si_limit_bypass_version", PLUGIN_VERSION, "Version of L4D2 SI Coop Limit Removal", FCVAR_NOTIFY)
...
public Action:Command_SpawnSI(client, args)
{
	...
	CheatCommand(anyclient, "z_spawn_old", infected, parameter);
