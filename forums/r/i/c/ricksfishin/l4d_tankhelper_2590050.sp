...
new Handle:l4d_tank_throw_witch      ;
...
public OnPluginStart()
{
	...
	l4d_tank_throw_hunter 	= CreateConVar("l4d_tank_throw_hunter", "2.0", 	"weight of hunter[0.0, 100.0]", FCVAR_NOTIFY);
	...
	HookConVarChange(l4d_tank_throw_witch, ConVarChange)
	GetConVar();
	gamestart=true;
}
public OnMapStart()
...
GetConVar()
{
	...
	throw_all[4]=throw_all[3]+GetConVarFloat(l4d_tank_throw_witch );
...
CreateSI(thetank)
{
	...
	if(r<throw_all[0])
	{
		CheatCommand(thetank, "z_spawn_old", "hunter"); 
	}
	else if(r<throw_all[1])
	{
		CheatCommand(thetank, "z_spawn_old", "smoker"); 
	}
	else if(r<throw_all[2])
	{
		CheatCommand(thetank, "z_spawn_old", "boomer"); 
	}
	else if(r<throw_all[3])
	{
		CheatCommand(thetank, "z_spawn_old", "tank"); 
		istank=true;
	}
	else if(r<throw_all[4])
	{
		CheatCommand(thetank, "z_spawn_old", "witch"); 
		istank=true;
	}
