...
public OnPluginStart()
{
	...
	cvarMoodSwingHPMax= CreateConVar("l4d_pwm_moodswinghpmax", "1500", "Maximum HP for the Witch. (Def 2000)");
	...
	cvarNightmareClawType = CreateConVar("l4d_pwm_nightmareclawtype", "1", "Type of Nightmare Claw: 1 = Survivor is set to B&W, 2 = Survivor is killed.", FCVAR_NOTIFY, true, 1.0, true, 2.0);
	...
	cvarShamefulCloakVisibility = CreateConVar("l4d_pwm_shamefulcloakvisibility", "0", "Modifies the visibility of the Witch while using Shameful Cloak. (0-255) (Def 0)", FCVAR_NOTIFY, true, 0.0, true, 255.0);
	...
	// ======================================
	cvarSorrowfulRemorse = CreateConVar("l4d_pwm_sorrowfulremorse", "1", "Enables Sorrowful Remorse ability: When a Witch is killed, she leaves behind a Medkit and Defib as repetance for her actions. (Def 0)");
	...
	AutoExecConfig(true, "plugin.L4D2PsychoticWitch");
