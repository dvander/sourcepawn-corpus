...
#define PLUGIN_NAME             "[TF2] Dodgeball Extra"
#define PLUGIN_AUTHOR           "Damizean, Modified by RuiFungYip"
...
new Handle:g_CreateRocketMode;             //Mode of rocket team selection
...
new             g_iRocketCount;
new g_iRocketLastTeam;				// Team of the last rocket.If none, it's a random team.
new g_iRocketTeam;                  //Team of the next rocket
...
g_CreateRocketMode = CreateConVar("tf_dodgeball_mode", "1", "Rocket Team Mode. 0 - switch team of rockets on kill. 1 - alternate team of rockets. 2 - random rocket team.", _, true, 0.0, true, 2.0);
...
switch (g_CreateRocketMode) //Regular mode, switches rocket teams on kill
{
case 0: {g_iRocketTeam = g_iLastDeadTeam;} //Regular mode, switches rocket teams on kill
case 1: {if (g_iRocketLastTeam == _:TFTeam_Red)//Alternating mode, alternates rockets between teams.
{
g_iRocketTeam = _:TFTeam_Blue;
}//Alternating mode, alternates rockets between teams.
}
case 2: {g_iRocketTeam = GetURandomIntRange(_:TFTeam_Red, _:TFTeam_Blue);} //Random mode, rocket team is random.
}
if (GetGameTime() >= g_fNextSpawnTime)
{
if (g_iRocketTeam == _:TFTeam_Red)
{
...
g_iRocketLastTeam = _:TFTeam_Red;
}
}
else
{
...
g_iRocketLastTeam = _:TFTeam_Blue;
}
}
}
