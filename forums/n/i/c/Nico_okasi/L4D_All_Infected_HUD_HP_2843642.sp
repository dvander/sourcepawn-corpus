...
public void OnPluginStart()
{
    ...
    g_CvarWitch      = CreateConVar("xi_hp_witch",      "0",   "Witch HP korsinmi (0/1)",           FCVAR_NONE, true, 0.0, true, 1.0);
    g_CvarTank       = CreateConVar("xi_hp_tank",       "0",   "Tank HP korsinmi (0/1)",            FCVAR_NONE, true, 0.0, true, 1.0);
...
public void Event_PlayerHurt(Event event, const char[] name, bool dontBroadcast)
{
    ...
    {
        int zc = GetEntProp(victim, Prop_Send, "m_zombieClass");
        if (zc == g_TankClass && !g_CvarTank.BoolValue)
            return;
    }
