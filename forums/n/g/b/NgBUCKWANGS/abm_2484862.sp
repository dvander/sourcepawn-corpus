...
Handle g_hTrackerHandle = INVALID_HANDLE; // that one timer that's always ticking
...
StartTracking() {
	...
	if (g_hTrackerHandle == INVALID_HANDLE) {
		g_hTrackerHandle = CreateTimer(
