...
public OnPluginStart()
{
	...
	g_hVersion				= CreateConVar( "l4d2_MITSR_Version",		VERSION, "The version of Melee In The Saferoom", FCVAR_PLUGIN ); 
	AutoExecConfig( true, "[L4D2]MeleeInTheSaferoom" );
	
	if( GetConVarFloat( g_hVersion ) != StringToFloat( VERSION ) )
		DeleteFile( "cfg/sourcemod/[L4D2]MeleeInTheSaferoom.cfg" );
