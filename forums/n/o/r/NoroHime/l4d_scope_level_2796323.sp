 ...
 *	v2.4 (12-April-2023)
 *		- new command sm_zoomout to allow user run key binding script to using modern game feature: hold to open scope, release to cancel the scope
 */
...
public void OnPluginStart() {
	...
	RegConsoleCmd("sm_zoomout", CommandZoomOut, "sm_zoomout //cancel the scope");
...
Action CommandZoomOut(int client, int args) {

	if (IsSurvivor(client) && (bIsScoping[client] || bIsFakeScoping[client]))
