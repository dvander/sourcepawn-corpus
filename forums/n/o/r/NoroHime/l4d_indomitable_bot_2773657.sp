...
public void OnPluginStart() {
	...
	cBoostRate =			CreateConVar(PLUGIN_NAME ... "_boost_rate", "2.0",			"rate of boost weapon speed", FCVAR_NOTIFY);
	...
	cResDamageRate =		CreateConVar(PLUGIN_NAME ... "_res_damage_rate", "0.1",		"multiplier of resistance damage 0.1=90% resistanced 0=disable", FCVAR_NOTIFY);
	...
	cResDamageSources =		CreateConVar(PLUGIN_NAME ... "_res_damage_sources", "15",	"which sources of receive damage will be resistance\n1=common zomobie 2=special infected 4=survivor bot 8=survivor human 16=others -1=All 31=All", FCVAR_NOTIFY);
	...
	cBlockControl =			CreateConVar(PLUGIN_NAME ... "_block_control", "-1",		"prevent be control from: 1=charger 2=hunter 4=smoker 8=jockey -1=All 15=All\nadd numbers together you want, require 'Left 4 Dhooks Direct'", FCVAR_NOTIFY);
	cBlockLedgegrab =		CreateConVar(PLUGIN_NAME ... "_block_ledgegrab", "-1",		"auto revive from ledge grabbed -1=dont revive 0=instantly 1.0=revive after 1.0 seconds, require 'Left 4 Dhooks Direct'", FCVAR_NOTIFY);
