...
DropSlot(client, slot, bool:drop
	=false, receiver=0)
{
	if(l4d2)DropSlot_l4d2(client, slot, drop
		, receiver);
	else DropSlot_l4d1(client, slot, drop
		,receiver);
}
...
DropSlot_l4d2(client, slot, bool:drop
	=false, receiver=0)
{
...
DropSlot_l4d1(client, slot,  bool:drop
	=false, receiver=0)
{
