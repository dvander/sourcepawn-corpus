...
public void OnPluginStart() {
	...
	cFailure =	CreateConVar(PLUGIN_NAME ... "_failure", "1",	"query failed actions 1=dump to console 2=make public chat 4=wipe old data 8=retry once(if send fail)", FCVAR_NOTIFY);
