...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_fakeitem", Command_FakeItem, ADMFLAG_ROOT);
	RegAdminCmd("sm_fakeachievement", Command_FakeAchievement, ADMFLAG_ROOT);
	RegAdminCmd("sm_fakelose", Command_FakeLose, ADMFLAG_ROOT);
	RegAdminCmd("sm_vo", Command_Voice, ADMFLAG_ROOT);
	RegAdminCmd("sm_voice", Command_Voice, ADMFLAG_ROOT);
