	...
	switch(action)
	{
		...
		case MenuAction_Select:
		{
			...
			else if (StrEqual(choice, "yes", false))
			{
				...
				else if(StrEqual(item[param1], "z_spawn_old mob", false))
				{
					ucommonleft += GetConVarInt(FindConVar("z_common_limit"));
				}	
				else if(StrEqual(item[param1], "z_spawn_old tank auto", false))
				{
				...
				else if(StrEqual(item[param1], "z_spawn_old witch auto", false) || StrEqual(item[param1], "z_spawn_old witch_bride auto", false))
				{
				...
				else if(StrContains(item[param1], "z_spawn_old", false) != -1 && StrContains(item[param1], "mob", false) == -1)
				{
