...
new Handle:g_DamageResistancearmor1;
new Handle:g_DamageResistancearmor2;
new Handle:g_DamageResistancearmor3;
new Handle:g_DamageResistancearmor4;
...
{ 
    ...
    g_DamageResistancearmor1 = CreateConVar("sm_armor1_damage_resis", "20", "Amount of damage armor will absorb");
    g_DamageResistancearmor2 = CreateConVar("sm_armor2_damage_resis", "30", "Amount of damage armor will absorb");
    g_DamageResistancearmor3 = CreateConVar("sm_armor3_damage_resis", "60", "Amount of damage armor will absorb");
    g_DamageResistancearmor4 = CreateConVar("sm_armor4_damage_resis", "80", "Amount of damage armor will absorb");
...
{     
	...
	{ 
            ...
            pourcent = GetConVarFloat(g_DamageResistancearmor1) / 100;
	...
	{ 
			...
			//Get the % of absorbation
            pourcent = GetConVarFloat(g_DamageResistancearmor2) / 100;
	...
	{ 
			...
			//Get the % of absorbation
            pourcent = GetConVarFloat(g_DamageResistancearmor3) / 100;
	...
	{ 
			...
			//Get the % of absorbation
            pourcent = GetConVarFloat(g_DamageResistancearmor4) / 100;
