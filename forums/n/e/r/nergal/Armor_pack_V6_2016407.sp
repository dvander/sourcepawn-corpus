...
{ 
	...
	g_armorHP2 = CreateConVar("sm_hp_armor2", "75", "How much HP should have armor 2 ?");
	...
	g_name_armor1 = CreateConVar("sm_name_armor1", "Kevlar Armor", "What should be the name of armor 1 ?");
	...
	g_killbeforearmor = CreateConVar("sm_kills_before_first_armor", "00", "How much kill(s) should do the player before buying is first armor ?");
	
	g_DamageResistance = CreateConVar("sm_armor_damage_resis", "30", "Amount of damage armor will absorb");
