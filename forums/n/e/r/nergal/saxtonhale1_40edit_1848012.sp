...
#define MarioModel "models/player/supermario/mario_v5.mdl"
#define MarioModelPrefix "models/player/supermario/mario_v5"
#define HitlerModel "models/player/hitler/hitlerv5.mdl"
#define HitlerModelPrefix "models/player/hitler/hitlerv5"
#define KinkyModel "models/mbison/mbison_01.mdl"
#define KinkyModelPrefix "models/mbison/mbison_01"
#define PostalModel "models/player/postal/postal_v3.mdl"
#define PostalModelPrefix "models/player/postal/postal_v3"
#define BalrogModel "models/player/balrog/balrog.mdl"
#define BalrogModelPrefix "models/player/balrog/balrog"
#define BruteModel "models/player/brute/brute_v5.mdl"
#define BruteModelPrefix "models/player/brute/brute_v5"
...
#define HaleKSpree "saxton_hale/k3" //1-7
...
#define WhipModel "models/weapons/c_models/c_riding_crop/c_riding_crop.mdl"
...
#define VagTheme "saxton_hale/engie.mp3"
#define HHHTheme "ui/holiday/gamestartup_halloween.mp3"
#define CBSTheme "saxton_hale/realman2.mp3"
#define MarioTheme "saxton_hale/mariotheme.mp3"
#define KinkyTheme "saxton_hale/guroaz.mp3"
#define BalrogTheme "balrog/theme2.mp3"
#define BruteTheme "brute/brutesong.mp3"
#define CBSJump1 "vo/sniper_specialcompleted02.wav"
#define MarioStart "supermario/mariostart.mp3"
#define MarioJump "supermario/mariojump"
#define MarioWin "supermario/mariowin1.wav"
#define MarioRage "supermario/mariorage.wav"
#define MarioLast "supermario/letsgo.wav"
#define MarioStab "supermario/mariostab.mp3"
#define MarioDead "supermario/mariodead.mp3"
#define HitlerStart "hitler/intro"
#define HitlerRage "hitler/stab1.wav"
#define HitlerSpree "hitler/spree"
#define HitlerStab "hitler/stab"
#define HitlerFail "hitler/dead"
#define HitlerLast "hitler/lastman"
#define HitlerWin "hitler/win"
#define HitlerDemo "hitler/demokill" //1-2
#define HitlerEngie "hitler/engineerkill" //1-2
#define HitlerHeavy "hitler/heavykill" //1-2
#define HitlerMedic "hitler/medickill" //1-4
#define HitlerPyro "hitler/pyrokill" //1-2
#define HitlerScout "hitler/scoutkill" //1-3
#define HitlerSniper "hitler/sniperkill.wav"
#define HitlerSoldier "hitler/soldierkill" //1-3
#define HitlerSpy "hitler/spykill" //1-2
#define KinkyStart "kinky/kinky-start"
#define KinkyWin "kinky/win"
#define KinkyDeath "kinky/kinkydeath.wav"
#define KinkyRage "kinky/rage"
#define KinkyLast "kinky/lastguy"
#define KinkyStab "kinky/stab"
#define KinkySpree "kinky/spree"
#define PostalDead "postaldude/dead" //1-9
#define PostalIntro "postaldude/intro" //1-7
#define PostalLast "postaldude/lastguy" //1-4
#define PostalRage "postaldude/rage" //1-2
#define PostalSpree "postaldude/spree" //1-8
#define PostalStab "postaldude/stab" //1-4
#define PostalWin "postaldude/win" //1-9
#define BalrogIntro "balrog/balrogintro.wav"
#define Balrog1 "vo/heavy_domination"
#define Balrog2 "vo/heavy_meleeing"
#define BalrogStab "vo/heavy_painsevere"
#define BalrogWin "vo/heavy_award"
#define BalrogLose "vo/heavy_paincrticialdeath"
#define BalrogRage "vo/heavy_battlecry"
#define BalrogSpree "vo/heavy_yell"
#define BruteFail "brute/dead"
#define BruteHit "brute/hit"
#define BruteSpawn "brute/intro"
#define BruteKill "brute/kill"
#define BruteLast "brute/lastguy"
#define BruteRage "brute/rage"
#define BruteSpree "brute/spree"
#define BruteStab "brute/stab"
#define BruteWin "brute/win"
#define BruteScare "brute/terror.wav"
//===New responces===//
#define HaleJump "saxton_hale/jump"			//1-6
#define HaleRageSound "saxton_hale/saxton_hale_responce_rage"			//1-4
#define HaleKillMedic "saxton_hale/kill_med" //1-4
#define HaleKillSniper "saxton_hale/kill_sni" //1-6
#define HaleKillSoldier "saxton_hale/kill_sold" //1-7
#define HaleWin "saxton_hale/shw"			//1-8
#define HaleLastMan "saxton_hale/opr"	//1-10
#define HaleFail "saxton_hale/shl"			//1-9
//===1.40 responces===//
#define HaleStart "saxton_hale/urs"	//1-5
#define HaleKillDemo  "saxton_hale/kill_demo" //1-4
#define HaleKillEngie  "saxton_hale/kill_eng" //1-8
#define HaleKillHeavy  "saxton_hale/kill_heavy" //1-4
#define HaleKillScout  "saxton_hale/kill_scout" //1-4
#define HaleKillSpy  "saxton_hale/kill_spy" //1-7
#define HaleKillPyro  "saxton_hale/kill_pyro" //1-4
#define HaleSappinMahSentry  "saxton_hale/destroy_building" //1-8
#define HaleStubbed "saxton_hale/sh_backstabbed"	//1-7
...
public OnPluginStart()
{
	...
	cvarRageDist  = CreateConVar("hale_rage_dist", "1000.0", "Distance to stun in Hale's rage. Vagineer and CBS are /3 (/2 for sentries)", FCVAR_PLUGIN, true, 0.0);
	...
	cvarCircuitStun = CreateConVar("hale_circuit_stun", "1", "0 to disable Short Circuit stun, >0 to make it stun Hale for x seconds", FCVAR_PLUGIN, true, 0.0);
	...
	cvarEnableEurekaEffect = CreateConVar("hale_enable_eureka", "1", "1- allow Eureka Effect, else disallow", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	cvarForceHaleTeam = CreateConVar("hale_force_team", "3", "0- Use plugin logic, 1- random team, 2- red, 3- blue", FCVAR_PLUGIN, true, 0.0, true, 3.0);
...
//	RegConsoleCmd("haleme", SkipHalePanelCmd);
	...
	RegAdminCmd("hale_select", Command_HaleSelect, ADMFLAG_VOTE, "hale_select <target> - Select a player to be next boss");
	RegAdminCmd("hale_special", Command_MakeNextSpecial, ADMFLAG_RESERVATION, "Call a special to next round.");
	RegAdminCmd("hale_addpoints", Command_Points, ADMFLAG_VOTE, "hale_addpoints <target> <points> - Add queue points to user.");
	RegAdminCmd("hale_point_enable", Command_Point_Enable, ADMFLAG_ROOT, "Enable CP. Only with hale_point_type = 0");
	RegAdminCmd("hale_point_disable", Command_Point_Disable, ADMFLAG_ROOT, "Disable CP. Only with hale_point_type = 0");
	RegAdminCmd("hale_stop_music", Command_StopMusic, ADMFLAG_VOTE, "Stop any currently playing Boss music.");
...
public AddToDownload()
{
	...
	for (i = 0; i < sizeof(extensions); i++)
	{
		...
		if (bSpecials)
		{
			...
			Format(s, PLATFORM_MAX_PATH, "%s%s", MarioModelPrefix, extensions[i]);
			AddFileToDownloadsTable(s);
			
			Format(s, PLATFORM_MAX_PATH, "%s%s", HitlerModelPrefix, extensions[i]);
			AddFileToDownloadsTable(s);
			
			Format(s, PLATFORM_MAX_PATH, "%s%s", KinkyModelPrefix, extensions[i]);
			AddFileToDownloadsTable(s);
			
			Format(s, PLATFORM_MAX_PATH, "%s%s", PostalModelPrefix, extensions[i]);
			AddFileToDownloadsTable(s);
			
			Format(s, PLATFORM_MAX_PATH, "%s%s", BalrogModelPrefix, extensions[i]);
			AddFileToDownloadsTable(s);
			
			Format(s, PLATFORM_MAX_PATH, "%s%s", BruteModelPrefix, extensions[i]);
			AddFileToDownloadsTable(s);
		}
	}
	...
	if (bSpecials)
	{
		...
		PrecacheModel(MarioModel, true);
		PrecacheModel(HitlerModel, true);
		PrecacheModel(KinkyModel, true);
		PrecacheModel(PostalModel, true);
		PrecacheModel(BalrogModel, true);
		PrecacheModel(BruteModel, true);
	}
	...
	if (bSpecials)
	{
		...
		PrecacheSound("vo/medic_yes01.wav", true);
		PrecacheSound("vo/soldier_no03.wav", true);
		PrecacheSound(VagineerLastA, true);
		PrecacheSound(KinkyDeath, true);
		PrecacheSound(MarioJump, true);
		...
		PrecacheSound(HitlerSniper, true);
		PrecacheSound(VagTheme, true);
		PrecacheSound(HHHTheme, true);
		PrecacheSound(CBSTheme, true);
		PrecacheSound(KinkyTheme, true);
		PrecacheSound(BalrogTheme, true);
		PrecacheSound(BalrogIntro, true);
		PrecacheSound(BruteTheme, true);
		PrecacheSound(BruteScare, true);
		PrecacheSound(MarioStart, true);
		PrecacheSound(MarioTheme, true);
		PrecacheSound(MarioRage, true);
		PrecacheSound(MarioWin, true);
		PrecacheSound(MarioLast, true);
		PrecacheSound(MarioStab, true);
		PrecacheSound(MarioDead, true);
		PrecacheSound(HitlerRage, true);
		Format(s, PLATFORM_MAX_PATH, "sound/%s", HitlerRage);
		PrecacheSound(HitlerStab, true);
		Format(s, PLATFORM_MAX_PATH, "sound/%s", HitlerStab);
		AddFileToDownloadsTable("sound/saxton_hale/realman2.mp3");
		...
		for (i = 1; i <= 9; i++)
		{
			...
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleFail, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalDead, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalWin, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
		}
		for (i = 1; i <= 6; i++)
		{
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleSappinMahSentry, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleJump, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillSniper, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", BalrogRage, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
		}
		for (i = 1; i <= 7; i++)
		{
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKSpree, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillSoldier, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillSpy, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleStubbed, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalIntro, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
		}
		for (i = 1; i <= 8; i++)
		{
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillEngie, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleWin, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalSpree, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", Balrog2, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
		}
		for (i = 1; i <= 10; i++)
		{
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleLastMan, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
		}
		for (i = 1; i <= 12; i++)
		{
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleStart, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
		}
		for (i = 1; i <= 15; i++)
		{
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BalrogSpree, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
		}
		for (i = 1; i <= 16; i++)
		{
			Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", BalrogWin, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
		}
		for (i = 1; i <= 18; i++)
		{
			Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", Balrog1, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
		}
		for (i = 10; i <= 25; i++)
	...
	{	
		if (i <= 2)
		{
			if (bSpecials)
			{
				...
				Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
				AddFileToDownloadsTable(s);
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", KinkyRage, i);
				PrecacheSound(s, true);
				Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", KinkyStab, i);
				PrecacheSound(s, true);
				Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerWin, i);
				PrecacheSound(s, true);
				Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerStart, i);
				PrecacheSound(s, true);
				Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerDemo, i);
				PrecacheSound(s, true);
				Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerEngie, i);
				PrecacheSound(s, true);
				Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerHeavy, i);
				PrecacheSound(s, true);
				Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerPyro, i);
				PrecacheSound(s, true);
				Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerSpy, i);
				PrecacheSound(s, true);
				Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalRage, i);
				PrecacheSound(s, true);
				Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteFail, i);
				PrecacheSound(s, true);
				Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteLast, i);
				PrecacheSound(s, true);
				Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			}
		}
		if (i <= 3)
		{
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerLast, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerFail, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerSpree, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", KinkyLast, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", KinkySpree, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerScout, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerSoldier, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", BalrogLose, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", BalrogStab, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteHit, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteKill, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteRage, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteStab, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteWin, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
		}
		if (i <= 4)
		{
			...
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			AddFileToDownloadsTable(s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillDemo, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillHeavy, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillMedic, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillPyro, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillScout, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", KinkyStart, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", KinkyWin, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerMedic, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalLast, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalStab, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteSpawn, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
		}
		if (bSpecials)
		{
			...
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
			AddFileToDownloadsTable(s);
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteSpree, i);
			PrecacheSound(s, true);
			Format(s, PLATFORM_MAX_PATH, "sound/%s", s);
		}
	}
	...
	PrecacheSound("supermario/mariojump1.wav", true);
	PrecacheSound("supermario/mariojump2.wav", true);
...
public Action:Timer_Announce(Handle:hTimer)
{
	...
	if (Announce > 1.0 && Enabled2)
	{
		switch (announcecount)
		{
			case 1:
			{
				CPrintToChatAll("{olive}[VSH]{default} Assyrian's Custom Hale Server Group: {olive}http://steamcommunity.com/groups/acvsh{default}");
			}
			case 3:
			{
...
stock bool:CheckNextSpecial()
{
	...
	{
		Incoming = GetRandomInt(0, 11);
		if (Special != VSHSpecial_Hale && !GetRandomInt(0, 2)) Incoming = VSHSpecial_Hale;
		else
		{
			switch (Incoming)
			{
				...
				case 4: Incoming = VSHSpecial_CBS;
				case 5: Incoming = VSHSpecial_Mario;
				case 6: Incoming = VSHSpecial_Hitler;
				case 7: Incoming = VSHSpecial_Kinky;
				case 8: Incoming = VSHSpecial_Postal;
				case 9: Incoming = VSHSpecial_Balrog;
				case 3: Incoming = VSHSpecial_Brute;
				default: Incoming = VSHSpecial_Hale;
			}
			if (IsDecemberHoliday() && !GetRandomInt(0, 5)) Incoming = VSHSpecial_CBS;
		}
	}
	Special = Incoming;
	Incoming = VSHSpecial_None;
...
public Action:event_round_start(Handle:event, const String:name[], bool:dontBroadcast)
{
	if (!GetConVarBool(cvarEnabled))
	{
		...
		{
			Steam_SetGameDescription("Assyrian's VSH");
		}
#endif
		Enabled2 = false;
	}
	...
	while ((ent = FindEntityByClassname2(ent, "item_healthkit_medium")) != -1)
	{
		GetEntPropVector(ent, Prop_Send, "m_vecOrigin", pos);
		AcceptEntityInput(ent, "Kill");
		new ent2 = CreateEntityByName("item_healthkit_small");
		TeleportEntity(ent2, pos, NULL_VECTOR, NULL_VECTOR);
		DispatchSpawn(ent2);
		foundHealth = true;
	}
...
public Action:event_round_end(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if (GetEventInt(event, "team") == HaleTeam)
	{
		switch (Special)
		{
			...
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleWin, GetRandomInt(1, 8));
			...
			case VSHSpecial_Mario:
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", MarioWin);
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, _, NULL_VECTOR, false, 0.0);
				EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, _, NULL_VECTOR, false, 0.0);
			}
			case VSHSpecial_Hitler:
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerWin, GetRandomInt(1, 2));
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, _, NULL_VECTOR, false, 0.0);
				EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, _, NULL_VECTOR, false, 0.0);
			}
			case VSHSpecial_Kinky:
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", KinkyWin, GetRandomInt(1, 4));
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, _, NULL_VECTOR, false, 0.0);
				EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, _, NULL_VECTOR, false, 0.0);
			}
			case VSHSpecial_Postal:
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalWin, GetRandomInt(1, 9));
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, _, NULL_VECTOR, false, 0.0);
				EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, _, NULL_VECTOR, false, 0.0);
			}
			case VSHSpecial_Balrog:
			{
				Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", BalrogWin, GetRandomInt(1, 16));
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, _, NULL_VECTOR, false, 0.0);
				EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, _, NULL_VECTOR, false, 0.0);
			}
			case VSHSpecial_Brute:
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteWin, GetRandomInt(1, 3));
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, _, NULL_VECTOR, false, 0.0);
				EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, _, NULL_VECTOR, false, 0.0);
			}
		}
	...
	if (IsValidClient(Hale))
	{
		...
		if (IsPlayerAlive(Hale))
		{
			...
			switch (Special)
			{
				...
				case VSHSpecial_Mario:		strcopy(translation, sizeof(translation), "vsh_mario_is_alive");
				case VSHSpecial_Hitler:		strcopy(translation, sizeof(translation), "vsh_hitler_is_alive");
				case VSHSpecial_Kinky:		strcopy(translation, sizeof(translation), "vsh_kinky_is_alive");
				case VSHSpecial_Postal:		strcopy(translation, sizeof(translation), "vsh_postal_is_alive");
				case VSHSpecial_Balrog:		strcopy(translation, sizeof(translation), "vsh_balrog_is_alive");
				case VSHSpecial_Brute:		strcopy(translation, sizeof(translation), "vsh_brute_is_alive");
				case VSHSpecial_Hale:		strcopy(translation, sizeof(translation), "vsh_hale_is_alive");
			}
...
public Action:StartResponceTimer(Handle:hTimer)
{
	...
	switch (Special)
	{
		...
		case VSHSpecial_Mario: Format(s, PLATFORM_MAX_PATH, "supermario/mariostart.mp3");
		case VSHSpecial_Hitler:
		{
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerStart, GetRandomInt(1, 2));
		...
		case VSHSpecial_Kinky:	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", KinkyStart, GetRandomInt(1, 4));
		case VSHSpecial_Postal:	
		{
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalIntro, GetRandomInt(1, 7));
			EmitSoundToAll(s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, pos, NULL_VECTOR, false, 0.0);
			EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, pos, NULL_VECTOR, false, 0.0);
		}
		case VSHSpecial_Balrog:	
		{
			Format(s, PLATFORM_MAX_PATH, BalrogIntro);
			EmitSoundToAll(s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, pos, NULL_VECTOR, false, 0.0);
			EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, pos, NULL_VECTOR, false, 0.0);
		}
		case VSHSpecial_Brute:	
		{
			Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteSpawn, GetRandomInt(1, 4));
			EmitSoundToAll(s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, pos, NULL_VECTOR, false, 0.0);
			EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, pos, NULL_VECTOR, false, 0.0);
		}
		case VSHSpecial_Hale:
		{
			Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleStart, GetRandomInt(1, 12));
			EmitSoundToAll(s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, pos, NULL_VECTOR, false, 0.0);
			EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, pos, NULL_VECTOR, false, 0.0);
		}
	}
...
public Action:Timer_MusicPlay(Handle:timer)
{
	...
	else
	{
		switch (Special)
		{
			case VSHSpecial_Vagineer:
			{
				strcopy(sound, sizeof(sound), VagTheme);
				time = 226.6;
			}
			case VSHSpecial_CBS:
			{
			...
			case VSHSpecial_Mario:
			{
				strcopy(sound, sizeof(sound), MarioTheme);
				time = 83.3;
			}
			case VSHSpecial_Kinky:
			{
				strcopy(sound, sizeof(sound), KinkyTheme);
				time = 200.0;
			}
			case VSHSpecial_Balrog:
			{
				strcopy(sound, sizeof(sound), BalrogTheme);
				time = 95.0;
			}
			case VSHSpecial_Brute:
			{
				strcopy(sound, sizeof(sound), BruteTheme);
				time = 100.0;
			}
		}
	}
...
public Action:MessageTimer(Handle:hTimer, any:client)
{
	...
	switch (Special)
	{
		...
		case VSHSpecial_Mario: strcopy(translation, sizeof(translation), "vsh_start_mario");
		case VSHSpecial_Hitler: strcopy(translation, sizeof(translation), "vsh_start_hitler");
		case VSHSpecial_Kinky: strcopy(translation, sizeof(translation), "vsh_start_kinky");
		case VSHSpecial_Postal: strcopy(translation, sizeof(translation), "vsh_start_postal");
		case VSHSpecial_Balrog: strcopy(translation, sizeof(translation), "vsh_start_balrog");
		case VSHSpecial_Brute: strcopy(translation, sizeof(translation), "vsh_start_brute");
		case VSHSpecial_Hale: strcopy(translation, sizeof(translation), "vsh_start_hale");
	}
...
//			SetEntProp(Hale, Prop_Send, "m_nSkin", GetClientTeam(Hale)-2);
		...
		case VSHSpecial_Mario:
			SetVariantString(MarioModel);
		case VSHSpecial_Hitler:
			SetVariantString(HitlerModel);
		case VSHSpecial_Kinky:
			SetVariantString(KinkyModel);
		case VSHSpecial_Postal:
			SetVariantString(PostalModel);
		case VSHSpecial_Balrog:
			SetVariantString(BalrogModel);
		case VSHSpecial_Brute:
			SetVariantString(BruteModel);
		case VSHSpecial_Hale:
		{
...
EquipSaxton(client)
{
	...
	switch (Special)
	{
		case VSHSpecial_Vagineer:
		{
			SaxtonWeapon = SpawnWeapon(client, "tf_weapon_wrench", 169, 100, 5, "68 ; 2.0 ; 2 ; 2.769 ; 259 ; 1.0 ; 150 ; 1.0 ; 252 ; 0.80 ; 269 ; 1");
			SetEntProp(SaxtonWeapon, Prop_Send, "m_iWorldModelIndex", -1);
			SetEntPropEnt(client, Prop_Send, "m_hActiveWeapon", SaxtonWeapon);
		}
		case VSHSpecial_HHH:
		{
			SaxtonWeapon = SpawnWeapon(client, "tf_weapon_sword", 266, 100, 5, "68 ; 2.0 ; 2 ; 2.769 ; 259 ; 1.0 ; 252 ; 0.60 ; 269 ; 1");
			SetEntProp(SaxtonWeapon, Prop_Send, "m_iWorldModelIndex", -1);
			SetEntPropEnt(client, Prop_Send, "m_hActiveWeapon", SaxtonWeapon);
			HaleCharge = -500;
		}
		case VSHSpecial_CBS:
		{
			SaxtonWeapon = SpawnWeapon(client, "tf_weapon_club", 171, 100, 5, "68 ; 2.0 ; 2 ; 2.769 ; 259 ; 1.0 ; 252 ; 0.80 ; 269 ; 1");
			SetEntPropEnt(client, Prop_Send, "m_hActiveWeapon", SaxtonWeapon);
			SetEntProp(client, Prop_Send, "m_nBody", 0);
		}
		case VSHSpecial_Mario:
		{
			SaxtonWeapon = SpawnWeapon(client, "tf_weapon_wrench", 5, 100, 5, "68 ; 2.0 ; 2 ; 2.769 ; 259 ; 1.0 ; 326 ; 1.5 ; 252 ; 0.80 ; 269 ; 1");
			SetEntPropEnt(client, Prop_Send, "m_hActiveWeapon", SaxtonWeapon);
		}
		case VSHSpecial_Hitler:
		{
			SaxtonWeapon = SpawnWeapon(client, "tf_weapon_bonesaw", 5, 100, 5, "68 ; 2.0 ; 2 ; 2.769 ; 259 ; 1.0 ; 252 ; 0.80 ; 269 ; 1");
			SetEntPropEnt(client, Prop_Send, "m_hActiveWeapon", SaxtonWeapon);
			SetEntProp(client, Prop_Send, "m_nBody", 0);
		}
		case VSHSpecial_Kinky:
		{
			SaxtonWeapon = SpawnWeapon(client, "tf_weapon_shovel", 447, 69, 5, "68 ; 2.0 ; 2 ; 2.769 ; 259 ; 1.0 ; 252 ; 0.80 ; 269 ; 1");
			SetEntPropEnt(client, Prop_Send, "m_hActiveWeapon", SaxtonWeapon);
			SetEntProp(client, Prop_Send, "m_nBody", 0);
		}
		case VSHSpecial_Postal:
		{
			SaxtonWeapon = SpawnWeapon(client, "tf_weapon_shovel", 6, 100, 5, "68 ; 2.0 ; 2 ; 2.769 ; 259 ; 1.0 ; 252 ; 0.80 ; 269 ; 1");
			SetEntPropEnt(client, Prop_Send, "m_hActiveWeapon", SaxtonWeapon);
			SetEntProp(client, Prop_Send, "m_nBody", 0);
		}
		case VSHSpecial_Balrog:
		{
			SaxtonWeapon = SpawnWeapon(client, "tf_weapon_fists", 5, 100, 5, "68 ; 2.0 ; 2 ; 2.769 ; 259 ; 1.0 ; 269 ; 1");
			SetEntPropEnt(client, Prop_Send, "m_hActiveWeapon", SaxtonWeapon);
			SetEntProp(client, Prop_Send, "m_nBody", 0);
		}
		case VSHSpecial_Brute:
		{
			SaxtonWeapon = SpawnWeapon(client, "tf_weapon_sword", 38, 100, 5, "68 ; 2.0 ; 2 ; 5.384 ; 5 ; 4 ; 259 ; 1.0 ; 61 ; 2.0");
			SetEntPropEnt(client, Prop_Send, "m_hActiveWeapon", SaxtonWeapon);
			SetEntProp(client, Prop_Send, "m_nBody", 0);
		}
		case VSHSpecial_Hale:
		{
			...
			Format(attribs, sizeof(attribs), "68 ; 2.0 ; 2 ; 2.769 ; 259 ; 1.0 ; 252 ; 0.6 ; 269 ; 1 ; 214 ; %d", GetRandomInt(9999, 99999));
...
public Action:MakeHale(Handle:hTimer)
{
	...
	switch (Special)
	{
		...
		case VSHSpecial_Mario:
			TF2_SetPlayerClass(Hale, TFClass_Engineer, _, false);
		case VSHSpecial_Hitler:
			TF2_SetPlayerClass(Hale, TFClass_Medic, _, false);
		case VSHSpecial_Kinky:
			TF2_SetPlayerClass(Hale, TFClass_Soldier, _, false);
		case VSHSpecial_Postal:
			TF2_SetPlayerClass(Hale, TFClass_Sniper, _, false);
		case VSHSpecial_Balrog:
			TF2_SetPlayerClass(Hale, TFClass_Heavy, _, false);
		case VSHSpecial_Brute:
			TF2_SetPlayerClass(Hale, TFClass_DemoMan, _, false);
	}
	if (GetClientTeam(Hale) != HaleTeam)
...
//	if (hItem != INVALID_HANDLE) return Plugin_Continue;
	switch (iItemDefinitionIndex)
	{
		...
		case 349:
		{
			new Handle:hItemOverride = PrepareItemHandle(hItem, _, _, "208 ; 1");
			if (hItemOverride != INVALID_HANDLE)
			{
				hItem = hItemOverride;
				return Plugin_Changed;
...
//			new Handle:hItemOverride = PrepareItemHandle(hItem, _, _, "116 ; 4.0", true);
		...
		case 730:
		{
			new Handle:hItemOverride = PrepareItemHandle(hItem, _, _, "6 ; 0.01 ; 241 ; 1.3 ; 424 ; 1.5 ; 411 ; 5.0 ; 207 ; 1.50 ; 206 ; 2.0", true);
			if (hItemOverride != INVALID_HANDLE)
			{
				hItem = hItemOverride;
				return Plugin_Changed;
		...
		case 305:
		{
			new Handle:hItemOverride = PrepareItemHandle(hItem, _, _, "17 ; 0.1 ; 2 ; 1.5"); // ; 266 ; 1.0");
			if (hItemOverride != INVALID_HANDLE)
			{
				hItem = hItemOverride;
				return Plugin_Changed;
...
//		}
		case 43, 239:
		{
			new Handle:hItemOverride = PrepareItemHandle(hItem, _, 239, "107 ; 2.0 ; 1 ; 0.5 ; 128 ; 1 ; 191 ; -20", true);
			if (hItemOverride != INVALID_HANDLE)
			{
				hItem = hItemOverride;
				return Plugin_Changed;
		...
		case 415:
		{
			new Handle:hItemOverride = PrepareItemHandle(hItem, _, _, "265 ; 99999.0 ; 178 ; 0.6 ; 2 ; 1.66 ; 3 ; 0.5", true);
			if (hItemOverride != INVALID_HANDLE)
			{
				hItem = hItemOverride;
				return Plugin_Changed;
...
//	SetEntityRenderColor(client, 255, 255, 255, 255);
	...
	if (weapon > MaxClients && IsValidEdict(weapon))
	{
		...
		switch (index)
		{
			...
			{
				TF2_RemoveWeaponSlot(client, TFWeaponSlot_Primary);
				weapon = SpawnWeapon(client, "tf_weapon_shotgun_primary", 415, 10, 6, "4 ; 0.5 ; 2 ; 1.3 ; 265 ; 999999");
			}
			case 237:
			{
				TF2_RemoveWeaponSlot(client, TFWeaponSlot_Primary);
			...
			{
				TF2_RemoveWeaponSlot(client, TFWeaponSlot_Primary);
				weapon = SpawnWeapon(client, "tf_weapon_syringegun_medic", 412, 1, 10, "4 ; 1.25 ; 2 ; 1.5 ; 298 ; 2 ; 224 ; 1.50 ; 125 ; 15");
			}
			case 525:
			{
				TF2_RemoveWeaponSlot(client, TFWeaponSlot_Primary);
				weapon = SpawnWeapon(client, "tf_weapon_revolver", 24, 1, 10, "51 ; 1.0");
			}
		}
	}
	...
	if (weapon > MaxClients && IsValidEdict(weapon))
	{
		...
		switch (index)
		{
			...
			{
				TF2_RemoveWeaponSlot(client, TFWeaponSlot_Secondary);
				weapon = SpawnWeapon(client, "tf_weapon_pipebomblauncher", 20, 1, 0, "78 ; 1.50");
				SetAmmo(client, 1, 36);
			}
			case 311, 425:
			{
				TF2_RemoveWeaponSlot(client, TFWeaponSlot_Secondary);
				weapon = SpawnWeapon(client, "tf_weapon_pipebomblauncher", 20, 5, 10, "280 ; 3 ; 6 ; 0.65 ; 289 ; 1");
			}
			case 23:
			{
				TF2_RemoveWeaponSlot(client, TFWeaponSlot_Secondary);
				weapon = SpawnWeapon(client, "tf_weapon_handgun_scout_secondary", 17, 5, 10, "280 ; 5 ; 6 ; 0.80 ; 2 ; 0.44 ; 4 ; 4.167 ; 78 ; 5.55 ; 137 ; 6.0");
				SetAmmo(client, 1, 200);
			}
			case 735, 736:
			{
				TF2_RemoveWeaponSlot(client, TFWeaponSlot_Secondary);
				weapon = SpawnWeapon(client, "tf_weapon_handgun_scout_secondary", 17, 5, 10, "280 ; 5 ; 6 ; 0.80 ; 2 ; 0.44 ; 4 ; 4.167 ; 78 ; 2.084 ; 137 ; 6.0");
				SetAmmo(client, 1, 100);
			}
			case 810, 831:
			{
				TF2_RemoveWeaponSlot(client, TFWeaponSlot_Secondary);
				weapon = SpawnWeapon(client, "tf_weapon_handgun_scout_secondary", 17, 5, 10, "280 ; 5 ; 6 ; 0.80 ; 2 ; 0.66 ; 4 ; 4.167 ; 78 ; 2.084 ; 137 ; 6.0");
				SetAmmo(client, 1, 150);
			}
			case 39, 351, 595, 740:
			{
				if (GetEntProp(weapon, Prop_Send, "m_iEntityQuality") != 10)
				{
					TF2_RemoveWeaponSlot(client, TFWeaponSlot_Secondary);
					weapon = SpawnWeapon(client, "tf_weapon_flaregun", 740, 5, 10, "25 ; 0.5 ; 207 ; 1.33 ; 416 ; 3 ; 58 ; 6.0");
					weapon = SpawnWeapon(client, "tf_weapon_shotgun_pyro", 12, 1, 10, "4 ; 1.33 ; 1 ; 0.88 ; 6 ; 0.80 ; 97 ; 0.4 ; 106 ; 0.4 ; 45 ; 0.6");
					SetAmmo(client, 1, 100);
				}
			}
		}
	...
	if (IsValidEntity(FindPlayerBack(client, { 133 , 444 }, 2)))
	{
		weapon = SpawnWeapon(client, "tf_weapon_shotgun_soldier", 10, 1, 10, "4 ; 1.33 ; 2 ; 0.88 ; 6 ; 0.80 ; 97 ; 0.4 ; 106 ; 0.4 ; 45 ; 0.6 ; 265 ; 9999");
		SetAmmo(client, 1, 150);
	}
	if (IsValidEntity(FindPlayerBack(client, { 405 , 608 }, 2)))
	{
		weapon = SpawnWeapon(client, "tf_weapon_grenadelauncher", 19, 10, 10, "4 ; 1.5 ; 104 ; 0.80 ; 97 ; 1.10");
		SetAmmo(client, 0, 50);
	}
	...
	if (TF2_GetPlayerClass(client) == TFClass_Medic)
	{
		...
		{
			TF2_RemoveWeaponSlot(client, TFWeaponSlot_Secondary);
			weapon = SpawnWeapon(client, "tf_weapon_medigun", 663, 5, 10, "10 ; 1.25 ; 178 ; 0.75 ; 11 ; 0.5 ; 14 ; 1.0");	//200 ; 1 for area of effect healing	// ; 178 ; 0.75 ; 128 ; 1.0 Faster switch-to
	...
	if (Enabled)
	{
		...
		if (attacker == Hale) /* || (attacker == Companion)*/
		{
			if (Special == VSHSpecial_Hale)
			{
				...
				{
					decl String:s[PLATFORM_MAX_PATH];
					Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleSappinMahSentry, GetRandomInt(1, 6));
...
public Action:event_changeclass(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if (client == Hale)
	{
		switch(Special)
		{
			case VSHSpecial_Hale: if (TF2_GetPlayerClass(client) != TFClass_Soldier)
				TF2_SetPlayerClass(client, TFClass_Soldier, _, false);
			case VSHSpecial_Vagineer: if (TF2_GetPlayerClass(client) != TFClass_Engineer)
				TF2_SetPlayerClass(client, TFClass_Engineer, _, false);
			case VSHSpecial_HHH: if (TF2_GetPlayerClass(client) != TFClass_DemoMan)
				TF2_SetPlayerClass(client, TFClass_DemoMan, _, false);
			case VSHSpecial_CBS: if (TF2_GetPlayerClass(client) != TFClass_Sniper)
				TF2_SetPlayerClass(client, TFClass_Sniper, _, false);
			case VSHSpecial_Mario: if (TF2_GetPlayerClass(client) != TFClass_Engineer)
				TF2_SetPlayerClass(client, TFClass_Engineer, _, false);
			case VSHSpecial_Hitler: if (TF2_GetPlayerClass(client) != TFClass_Medic)
				TF2_SetPlayerClass(client, TFClass_Medic, _, false);
			case VSHSpecial_Kinky: if (TF2_GetPlayerClass(client) != TFClass_Soldier)
				TF2_SetPlayerClass(client, TFClass_Soldier, _, false);
			case VSHSpecial_Postal: if (TF2_GetPlayerClass(client) != TFClass_Sniper)
				TF2_SetPlayerClass(client, TFClass_Sniper, _, false);
			case VSHSpecial_Balrog: if (TF2_GetPlayerClass(client) != TFClass_Heavy)
				TF2_SetPlayerClass(client, TFClass_Heavy, _, false);
			case VSHSpecial_Brute: if (TF2_GetPlayerClass(client) != TFClass_DemoMan)
				TF2_SetPlayerClass(client, TFClass_DemoMan, _, false);
		}
	}
	return Plugin_Continue;
...
public Action:Command_GetHP(client)
{
	...
	if (client == Hale)
	{
		switch (Special)
		{
			...
			case VSHSpecial_Mario:
				PrintCenterTextAll("%t", "vsh_mario_show_hp", HaleHealth, HaleHealthMax);
			case VSHSpecial_Hitler:
				PrintCenterTextAll("%t", "vsh_hitler_show_hp", HaleHealth, HaleHealthMax);
			case VSHSpecial_Kinky:
				PrintCenterTextAll("%t", "vsh_kinky_show_hp", HaleHealth, HaleHealthMax);
			case VSHSpecial_Postal:
				PrintCenterTextAll("%t", "vsh_postal_show_hp", HaleHealth, HaleHealthMax);
			case VSHSpecial_Balrog:
				PrintCenterTextAll("%t", "vsh_balrog_show_hp", HaleHealth, HaleHealthMax);
			case VSHSpecial_Brute:
				PrintCenterTextAll("%t", "vsh_brute_show_hp", HaleHealth, HaleHealthMax);
			case VSHSpecial_Hale:
	...
	if (RoundFloat(HPTime) <= 0)
	{
		...
		switch (Special)
		{
			...
			case VSHSpecial_Mario:
			{
				PrintCenterTextAll("%t", "vsh_mario_hp", HaleHealth, HaleHealthMax);
				CPrintToChatAll("{olive}[VSH]{default} %t", "vsh_mario_hp", HaleHealth, HaleHealthMax);
			}
			case VSHSpecial_Hitler:
			{
				PrintCenterTextAll("%t", "vsh_hitler_hp", HaleHealth, HaleHealthMax);
				CPrintToChatAll("{olive}[VSH]{default} %t", "vsh_hitler_hp", HaleHealth, HaleHealthMax);
			}
			case VSHSpecial_Kinky:
			{
				PrintCenterTextAll("%t", "vsh_kinky_hp", HaleHealth, HaleHealthMax);
				CPrintToChatAll("{olive}[VSH]{default} %t", "vsh_kinky_hp", HaleHealth, HaleHealthMax);
			}
			case VSHSpecial_Postal:
			{
				PrintCenterTextAll("%t", "vsh_postal_hp", HaleHealth, HaleHealthMax);
				CPrintToChatAll("{olive}[VSH]{default} %t", "vsh_postal_hp", HaleHealth, HaleHealthMax);
			}
			case VSHSpecial_Balrog:
			{
				PrintCenterTextAll("%t", "vsh_balrog_hp", HaleHealth, HaleHealthMax);
				CPrintToChatAll("{olive}[VSH]{default} %t", "vsh_balrog_hp", HaleHealth, HaleHealthMax);
			}
			case VSHSpecial_Brute:
			{
				PrintCenterTextAll("%t", "vsh_brute_hp", HaleHealth, HaleHealthMax);
				CPrintToChatAll("{olive}[VSH]{default} %t", "vsh_brute_hp", HaleHealth, HaleHealthMax);
			}
			case VSHSpecial_Hale:
			{
		...
		HaleHealthLast = HaleHealth;
		HPTime = (healthcheckused < 3 ? 5.0 : 5.0);
	}
	else if (RedAlivePlayers == 1)
		CPrintToChat(client, "{olive}[VSH]{default} %t", "vsh_already_see");
	else
		CPrintToChat(client, "{olive}[VSH]{default} %t", "vsh_wait_hp", RoundFloat(HPTime), HaleHealthLast);
	return Plugin_Continue;
}
public Action:Command_MakeNextSpecial(client, args)
{
	...
	if (args < 1)
	{
		ReplyToCommand(client, "[VSH] Usage: hale_special <hale, vagineer, hhh, christian, mario, hitler, kinky, postal, balrog, brute>");
		return Plugin_Handled;
	}
	...
	else if (StrContains(arg, "cbs", false) != -1)
	{
		Incoming = VSHSpecial_CBS;
		name = "the Christian Brutal Sniper";
	}
	else if (StrContains(arg, "mario", false) != -1)
	{
		Incoming = VSHSpecial_Mario;
		name = "Super Mario";
	}
	else if (StrContains(arg, "hitler", false) != -1)
	{
		Incoming = VSHSpecial_Hitler;
		name = "Hitler Medic";
	}
	else if (StrContains(arg, "kinky", false) != -1)
	{
		Incoming = VSHSpecial_Kinky;
		name = "Kap'n Kinky";
	}
	else if (StrContains(arg, "postal", false) != -1)
	{
		Incoming = VSHSpecial_Postal;
		name = "Postal Dude";
	}
	else if (StrContains(arg, "balrog", false) != -1)
	{
		Incoming = VSHSpecial_Balrog;
		name = "Balrog";
	}
	else if (StrContains(arg, "brute", false) != -1)
	{
		Incoming = VSHSpecial_Brute;
		name = "The Brute";
	}
	else
	{
...
{
	if (!IsValidClient(client)) return;
	StopSound(client, SNDCHAN_AUTO, VagTheme);
	StopSound(client, SNDCHAN_AUTO, HHHTheme);
	StopSound(client, SNDCHAN_AUTO, CBSTheme);
	StopSound(client, SNDCHAN_AUTO, MarioTheme);
	StopSound(client, SNDCHAN_AUTO, KinkyTheme);
	StopSound(client, SNDCHAN_AUTO, BalrogTheme);
	StopSound(client, SNDCHAN_AUTO, BruteTheme);
}
...
{
	if (Enabled && client == Hale && Special == VSHSpecial_HHH)
	{
...
//			}
			...
			{
				decl String:classname[64];		//slightly longer check but makes sure that any weapon that can backstab will not crit (e.g. Saxxy)
			...
			switch (index)
			{
				case 305, 56, 16, 203, 58, 17, 812, 833, 36, 444: addthecrit = true;
				case 22, 23, 160, 209, 294, 449, 773:
				{
					addthecrit = true;
				}
				case 21, 208, 40, 215, 594, 659, 741, 740, 12:
				{
					addthecrit = true;
					if (class == TFClass_Pyro && cond == TFCond_HalloweenCritCandy) cond = TFCond_Buffed;
				}
				case 656:
				{
					addthecrit = true;
			...
			if (Special != VSHSpecial_HHH && index != 56 && weapon == GetPlayerWeaponSlot(client, TFWeaponSlot_Primary))
			{
...
//	SetEntProp(Hale, Prop_Send, "m_iHealth", HaleHealth);
	...
	{
		HaleCharge += 5;
		if (Special == VSHSpecial_HHH || Special == VSHSpecial_Brute)
	...
	else
	{
		...
		if ((ang[0] < -10.0) && (HaleCharge > 1))
		{
			...
			else if (Special != VSHSpecial_HHH)
			{
				...
				HaleCharge=-120;
				if (Special == VSHSpecial_Hale || Special == VSHSpecial_Vagineer || Special == VSHSpecial_CBS || Special == VSHSpecial_Mario || Special == VSHSpecial_Hitler || Special == VSHSpecial_Kinky || Special == VSHSpecial_Postal || Special == VSHSpecial_Balrog || Special == VSHSpecial_Brute)
				{
					decl String:s[PLATFORM_MAX_PATH];
					GetEntPropVector(Hale, Prop_Send, "m_vecOrigin", pos);
					if (Special == VSHSpecial_Hale && GetRandomInt(0, 1))
						Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleJump, GetRandomInt(1, 6));
					else if (Special == VSHSpecial_Vagineer)
						Format(s, PLATFORM_MAX_PATH, "%s%i.wav", VagineerJump, GetRandomInt(1, 2));
					else if (Special == VSHSpecial_CBS)
						strcopy(s, PLATFORM_MAX_PATH, CBSJump1);
					else if (Special == VSHSpecial_Mario)
						Format(s, PLATFORM_MAX_PATH, "%s%i.wav", MarioJump, GetRandomInt(1, 2));
					else if (Special == VSHSpecial_Hitler)
						strcopy(s, PLATFORM_MAX_PATH, "vo/medic_yes01.wav");
					else if (Special == VSHSpecial_Kinky)
						strcopy(s, PLATFORM_MAX_PATH, "vo/soldier_no03.wav");
	...
	if (WeighDownTimer >= 0.0 && buttons & IN_DUCK)
	{
		decl Float:ang[3];
		GetClientEyeAngles(Hale, ang);
		if ((ang[0] > 60.0))
		{
			...
			CreateTimer(1.0, Timer_GravityCat, Hale, TIMER_FLAG_NO_MAPCHANGE);
...
public Action:DoTaunt(client, const String:command[], argc)
{
	...
	if (HaleRage/RageDMG >= 1)
	{
		...
		switch (Special)
		{
			...
			case VSHSpecial_Kinky: dist = RageDist/(1.1);
			case VSHSpecial_Hitler: dist = RageDist/(1.8);
			case VSHSpecial_Balrog: dist = RageDist/(1.3);
		...
		switch (Special)
		{
			...
			case VSHSpecial_CBS:
			{
				...
				EmitSoundToAll(s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, _, pos, NULL_VECTOR, false, 0.0);
				TF2_RemoveWeaponSlot(client, TFWeaponSlot_Primary);
				SetEntPropEnt(client, Prop_Send, "m_hActiveWeapon", SpawnWeapon(client, "tf_weapon_grenadelauncher", 19, 100, 5, "2 ; 1.80 ; 97 ; 0.5 ; 37 ; 0.0"));
				SetAmmo(client, 0, ((RedAlivePlayers >= CBS_MAX_ARROWS) ? CBS_MAX_ARROWS : RedAlivePlayers));
				CreateTimer(0.6, UseRage, dist);
				CreateTimer(0.1, UseBowRage);
			}
			case VSHSpecial_Mario:
			{
				Format(s, PLATFORM_MAX_PATH, "%s", MarioRage);
				EmitSoundToAll(s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, _, pos, NULL_VECTOR, false, 0.0);
				TF2_RemoveWeaponSlot(client, TFWeaponSlot_Secondary);
				SetEntPropEnt(client, Prop_Send, "m_hActiveWeapon", SpawnWeapon(client, "tf_weapon_flaregun", 740, 100, 5, "416 ; 3 ; 6 ; 0.40 ; 25 ; 0.0"));
				SetAmmo(client, 1, ((RedAlivePlayers >= 12) ? 12 : RedAlivePlayers));
				CreateTimer(0.6, UseRage, dist);
			}
			case VSHSpecial_Hitler:
			{
				Format(s, PLATFORM_MAX_PATH, "%s", HitlerRage);
				EmitSoundToAll(s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, _, pos, NULL_VECTOR, false, 0.0);
				TF2_RemoveWeaponSlot(client, TFWeaponSlot_Primary);
				SetEntPropEnt(client, Prop_Send, "m_hActiveWeapon", SpawnWeapon(client, "tf_weapon_flamethrower", 40, 100, 5, "2 ; 1.1 ; 37 ; 0.0 ; 171 ; 0.01 ; 1008 ; 1"));
				SetAmmo(client, 0, ((RedAlivePlayers >= 150) ? 150 : RedAlivePlayers));
				CreateTimer(0.6, UseRage, dist);
			}
			case VSHSpecial_Kinky:
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", KinkyRage, GetRandomInt(1, 2));
				EmitSoundToAll(s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, _, pos, NULL_VECTOR, false, 0.0);
				TF2_AddCondition(Hale, TFCond_Buffed, 90.0);
				UberRageCount = 0.0;
			...
			case VSHSpecial_Postal:
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalRage, GetRandomInt(1, 2));
				EmitSoundToAll(s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, _, pos, NULL_VECTOR, false, 0.0);
				TF2_RemoveWeaponSlot(client, TFWeaponSlot_Secondary);
				SetEntPropEnt(client, Prop_Send, "m_hActiveWeapon", SpawnWeapon(client, "tf_weapon_shotgun_hwg", 11, 100, 5, "1 ; 0.68 ; 97 ; 0.6 ; 25 ; 0.0"));
				SetAmmo(client, 1, ((RedAlivePlayers >= 1) ? 1 : RedAlivePlayers));
				CreateTimer(0.6, UseRage, dist);
				CreateTimer(0.1, UseBowRage);
			}
			case VSHSpecial_Balrog:
			{
				Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", BalrogRage, GetRandomInt(1, 6));
				EmitSoundToAll(s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, _, pos, NULL_VECTOR, false, 0.0);
				TF2_AddCondition(client, TFCond_SpeedBuffAlly, 90.0);
				UberRageCount = 0.0;
			...
			case VSHSpecial_Brute:
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteRage, GetRandomInt(1, 3));
				Format(s, PLATFORM_MAX_PATH, "%s", BruteScare);
				EmitSoundToAll(s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, _, pos, NULL_VECTOR, false, 0.0);
				CreateTimer(0.6, UseRage, dist);
			}
			case VSHSpecial_Hale:
...
public Action:UseRage(Handle:hTimer, any:dist)
{
	...
	if (!GetEntProp(Hale, Prop_Send, "m_bIsReadyToHighFive") && !IsValidEntity(GetEntPropEnt(Hale, Prop_Send, "m_hHighFivePartner"))) TF2_RemoveCondition(Hale, TFCond_Taunting);
	GetEntPropVector(Hale, Prop_Send, "m_vecOrigin", pos);
	for (i = 1; i <= MaxClients; i++)
	{
...
//		TF2_StunPlayer(Hale, 0.0, _, TF_STUNFLAG_NOSOUNDOREFFECT);
	...
	else if (UberRageCount >= 100)
	{
		...
		TF2_RemoveCondition(Hale, TFCond_Buffed);
		TF2_RemoveCondition(Hale, TFCond_SpeedBuffAlly);
		return Plugin_Stop;
	}
...
public Action:event_player_death(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if (client == Hale && VSHRoundState == 1)
	{
		switch (Special)
		{
			...
			case VSHSpecial_Hale:
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleFail, GetRandomInt(1, 9));
			...
			case VSHSpecial_Mario:
			{
				Format(s, PLATFORM_MAX_PATH, "supermario/mariodead.mp3");
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, client, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, client, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				CreateTimer(0.1, Timer_ChangeRagdoll, any:GetEventInt(event, "userid"));
			}
			case VSHSpecial_Hitler:
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerFail, GetRandomInt(1, 3));
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, client, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, client, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				CreateTimer(0.1, Timer_ChangeRagdoll, any:GetEventInt(event, "userid"));
			}
			case VSHSpecial_Kinky:
			{
				Format(s, PLATFORM_MAX_PATH, KinkyDeath);
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, client, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, client, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				CreateTimer(0.1, Timer_ChangeRagdoll, any:GetEventInt(event, "userid"));
			}
			case VSHSpecial_Postal:
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalDead, GetRandomInt(1, 9));
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, client, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, client, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				CreateTimer(0.1, Timer_ChangeRagdoll, any:GetEventInt(event, "userid"));
			}
			case VSHSpecial_Balrog:
			{
				Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", BalrogLose, GetRandomInt(1, 3));
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, client, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, client, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				CreateTimer(0.1, Timer_ChangeRagdoll, any:GetEventInt(event, "userid"));
			}
			case VSHSpecial_Brute:
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteFail, GetRandomInt(1, 2));
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, client, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, client, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				CreateTimer(0.1, Timer_ChangeRagdoll, any:GetEventInt(event, "userid"));
			}
	...
	if (attacker == Hale && VSHRoundState == 1)
	{
		...
		switch (Special)
		{
			case VSHSpecial_Hale:
			{
				...
				if (!GetRandomInt(0, 2) && RedAlivePlayers != 1)
				{
					...
					switch (playerclass)
					{
						case TFClass_Scout:	 	Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillScout, GetRandomInt(1, 4));
						case TFClass_Soldier:	Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillSoldier, GetRandomInt(1, 7));
						case TFClass_Pyro:	 	Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillPyro, GetRandomInt(1, 4));
						case TFClass_DemoMan:	Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillDemo, GetRandomInt(1, 4));
						case TFClass_Heavy:	 	Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillHeavy, GetRandomInt(1, 4));
						case TFClass_Medic:	 	Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillMedic, GetRandomInt(1, 4));
						case TFClass_Sniper:	Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillSniper, GetRandomInt(1, 6));
						case TFClass_Spy:	Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillSpy, GetRandomInt(1, 7));
						case TFClass_Engineer:	Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKillEngie, GetRandomInt(1, 8));
					}
					if (!StrEqual(s, ""))
					{
			...
			case VSHSpecial_CBS:
			{
				...
				if (weapon == GetPlayerWeaponSlot(Hale, TFWeaponSlot_Melee))
				{
					...
					new clubindex, wepswitch = GetRandomInt(0, 6);
					switch (wepswitch)
					{
					...
					weapon = SpawnWeapon(Hale, "tf_weapon_club", clubindex, 100, 5, "68 ; 2.0 ; 2 ; 2.769 ; 259 ; 1.0");
			...
			case VSHSpecial_Hitler:
			{
				...
				if (!GetRandomInt(0, 2) && RedAlivePlayers != 1)
				{
					...
					switch (playerclass)
					{
						case TFClass_Scout:	 	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerScout, GetRandomInt(1, 3));
						case TFClass_Soldier:	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerSoldier, GetRandomInt(1, 3));
						case TFClass_Pyro:	 	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerPyro, GetRandomInt(1, 2));
						case TFClass_DemoMan:	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerDemo, GetRandomInt(1, 2));
						case TFClass_Heavy:	 	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerHeavy, GetRandomInt(1, 2));
						case TFClass_Medic:	 	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerMedic, GetRandomInt(1, 4));
						case TFClass_Sniper:	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerSniper);
						case TFClass_Spy:		Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerSpy, GetRandomInt(1, 2));
						case TFClass_Engineer:	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerEngie, GetRandomInt(1, 2));
					}
					if (!StrEqual(s, ""))
					{
						EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, attacker, NULL_VECTOR, NULL_VECTOR, false, 0.0);
			...
			case VSHSpecial_Postal:
			{
				if (customkill != TF_CUSTOM_BOOTS_STOMP) SetEventString(event, "weapon", "shovel");
				if (!GetRandomInt(0, 1) && RedAlivePlayers != 1)
				{
					strcopy(s, PLATFORM_MAX_PATH, "");
					new TFClassType:playerclass = TF2_GetPlayerClass(client);
					switch (playerclass)
					{
						case TFClass_Scout:	 	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalSpree, GetRandomInt(1, 8));
						case TFClass_Soldier:	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalSpree, GetRandomInt(1, 8));
						case TFClass_Pyro:	 	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalSpree, GetRandomInt(1, 8));
						case TFClass_DemoMan:	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalSpree, GetRandomInt(1, 8));
						case TFClass_Heavy:	 	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalSpree, GetRandomInt(1, 8));
						case TFClass_Medic:	 	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalSpree, GetRandomInt(1, 8));
						case TFClass_Sniper:	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalSpree, GetRandomInt(1, 8));
						case TFClass_Spy:		Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalSpree, GetRandomInt(1, 8));
						case TFClass_Engineer:	Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalSpree, GetRandomInt(1, 8));
					}
					if (!StrEqual(s, ""))
					{
						EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, attacker, NULL_VECTOR, NULL_VECTOR, false, 0.0);
			...
			case VSHSpecial_Balrog:
			{
				Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", Balrog2, GetRandomInt(1, 8));
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, attacker, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				EmitSoundToAll(s, _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, attacker, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				...
				if (!GetRandomInt(0, 1) && RedAlivePlayers != 1)
				{
					...
					switch (playerclass)
					{
						case TFClass_Scout:	 	Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", Balrog1, GetRandomInt(1, 18));
						case TFClass_Soldier:	Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", Balrog1, GetRandomInt(1, 18));
						case TFClass_Pyro:	 	Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", Balrog1, GetRandomInt(1, 18));
						case TFClass_DemoMan:	Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", Balrog1, GetRandomInt(1, 18));
						case TFClass_Heavy:	 	Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", Balrog1, GetRandomInt(1, 18));
						case TFClass_Medic:	 	Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", Balrog1, GetRandomInt(1, 18));
						case TFClass_Sniper:	Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", Balrog1, GetRandomInt(1, 18));
						case TFClass_Spy:		Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", Balrog1, GetRandomInt(1, 18));
						case TFClass_Engineer:	Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", Balrog1, GetRandomInt(1, 18));
					}
					if (!StrEqual(s, ""))
					{
						EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, attacker, NULL_VECTOR, NULL_VECTOR, false, 0.0);
			...
			case VSHSpecial_Brute:
			{
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteHit, GetRandomInt(1, 3));
				EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, attacker, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				EmitSoundToAll(s, _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, attacker, NULL_VECTOR, NULL_VECTOR, false, 0.0);
			}
		}
		if (KSpreeTimer > 0)
			...
			KSpreeCount = 1;
		if (KSpreeCount == 2 && RedAlivePlayers != 1)
		{
			switch (Special)
			{
				case VSHSpecial_Hale:
				{
					Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleKSpree, GetRandomInt(1, 7));
				...
				case VSHSpecial_Hitler:
				{
					Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerSpree, GetRandomInt(1, 3));
					EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, _, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				}
				case VSHSpecial_Kinky:
				{
					Format(s, PLATFORM_MAX_PATH, "%s%i.wav", KinkySpree, GetRandomInt(1, 3));
					EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, _, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				}
				case VSHSpecial_Postal:
				{
					Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalSpree, GetRandomInt(1, 8));
					EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, _, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				}
				case VSHSpecial_Balrog:
				{
					Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BalrogSpree, GetRandomInt(1, 15));
					EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, _, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				}
				case VSHSpecial_Brute:
				{
					Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteSpree, GetRandomInt(1, 5));
					EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, _, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, _, NULL_VECTOR, NULL_VECTOR, false, 0.0);
				}
			}
			EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, NULL_VECTOR, NULL_VECTOR, false, 0.0);
...
public Action:Timer_ChangeRagdoll(Handle:timer, any:userid)
{
	...
	if (IsValidEntity(ragdoll))
	{
		switch (Special)
		{
			...
			case VSHSpecial_Mario:		SetEntityModel(ragdoll, MarioModel);
			case VSHSpecial_Hitler:		SetEntityModel(ragdoll, HitlerModel);
			case VSHSpecial_Kinky:		SetEntityModel(ragdoll, KinkyModel);
			case VSHSpecial_Postal:		SetEntityModel(ragdoll, PostalModel);
			case VSHSpecial_Balrog:		SetEntityModel(ragdoll, BalrogModel);
			case VSHSpecial_Brute:		SetEntityModel(ragdoll, BruteModel);
		}
	}
}
	...
	else if (RedAlivePlayers == 1 && IsValidClient(Hale) && VSHRoundState == 1)
	{
		...
		if (Special != VSHSpecial_HHH)
		{
			if (Special == VSHSpecial_CBS)
			{
				...
				strcopy(s, PLATFORM_MAX_PATH, MarioLast);
			else if (Special == VSHSpecial_Hitler)
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", HitlerLast, GetRandomInt(1, 3));
			else if (Special == VSHSpecial_Kinky)
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", KinkyLast, GetRandomInt(1, 3));
			else if (Special == VSHSpecial_Postal)
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalLast, GetRandomInt(1, 4));
			else if (Special == VSHSpecial_Balrog)
				Format(s, PLATFORM_MAX_PATH, "vo/medic_yes01.wav");
			else if (Special == VSHSpecial_Brute)
				Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteLast, GetRandomInt(1, 2));
			else
				Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleLastMan, GetRandomInt(1, 10));
...
public Action:OnTakeDamage(client, &attacker, &inflictor, &Float:damage, &damagetype, &weapon, Float:damageForce[3], Float:damagePosition[3], damagecustom)
{
	...
	if ((attacker == Hale) && IsValidClient(client) && (client != Hale) && !TF2_IsPlayerInCondition(client, TFCond_Bonked) && !TF2_IsPlayerInCondition(client, TFCond_Ubercharged))
	{
		...
		if (damage <= 160.0 && !(Special == VSHSpecial_CBS && inflictor != attacker))
		{
			damage *= 3;
			return Plugin_Changed;
		}
		...
		if (attacker <= MaxClients)
		{
			...
			if (inflictor == attacker || inflictor == weapon)
			{
				if (!IsValidEntity(weapon) && (damagetype & DMG_CRUSH) == DMG_CRUSH && damage == 1000.0)	//THIS IS A TELEFRAG
				{
					...
					damage = (HaleHealth > 33000 ? 15.0 : float(GetEntProp(Hale, Prop_Send, "m_iHealth"))+90.0);
					new teleowner = FindTeleOwner(attacker);
					if (IsValidClient(teleowner) && teleowner != attacker)
					{
						Damage[teleowner] += RoundFloat(9001.0 * 3 / 5);
						PrintCenterText(teleowner, "TELEFRAG! YOU ARE MLG PRO");
					}
					PrintCenterText(attacker, "TELEFRAG! YOU ARE MLG PRO.");
					PrintCenterText(client, "D E A D.......");
					return Plugin_Changed;
				}
				switch (wepindex)
				{
					...
					case 14, 201, 230, 402, 526, 664, 752, 792, 801, 851, 881, 890, 899, 908:
					{
						...
						{
							case 14, 201, 402, 526, 664, 792, 801, 851, 881, 890, 899, 908:
							{
								if (VSHRoundState != 2)
								{
									...
									if (GlowTimer > 20.0) GlowTimer = 20.0;
								}
							}
						}
						...
						if (!(damagetype & DMG_CRIT))
						{
							...
							if (Special == VSHSpecial_HHH || Special == VSHSpecial_Brute || meleeindex != 232)
							{
...
/*				if ( IsValidEdict( weapon ) && GetEdictClassname( weapon, wepclassname, sizeof( wepclassname ) ) && strcmp( wepclassname, "tf_weapon_stickbomb", false ) == 0 )
				...
				if (bIsBackstab)
				{
					...
					if (GetClientCloakIndex(attacker) == 59)
					{
						SetEntPropFloat(attacker, Prop_Send, "m_flNextAttack", GetGameTime() + 0.7);
						SetEntPropFloat(attacker, Prop_Send, "m_flStealthNextChangeTime", GetGameTime() + 0.7);
					}
					PrintCenterText(attacker, "You tickled him!");
					PrintCenterText(client, "You were just tickled!");
					...
					{
						decl String:s[PLATFORM_MAX_PATH];
						Format(s, PLATFORM_MAX_PATH, "%s%i.mp3", HaleStubbed, GetRandomInt(1, 7));
					...
					{
						EmitSoundToAll("supermario/mariostab.mp3", _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, NULL_VECTOR, NULL_VECTOR, false, 0.0);
						EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, "supermario/mariostab.mp3", _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, NULL_VECTOR, NULL_VECTOR, false, 0.0);
					}
					else if (Special == VSHSpecial_Hitler)
					{
						decl String:s[PLATFORM_MAX_PATH];
						Format(s, PLATFORM_MAX_PATH, "hitler/stab%d.wav", GetRandomInt(1, 4));
						EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, NULL_VECTOR, NULL_VECTOR, false, 0.0);
						EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, NULL_VECTOR, NULL_VECTOR, false, 0.0);
					}
					else if (Special == VSHSpecial_Kinky)
					{
						decl String:s[PLATFORM_MAX_PATH];
						Format(s, PLATFORM_MAX_PATH, "%s%i.wav", KinkyStab, GetRandomInt(1, 2));
						EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, NULL_VECTOR, NULL_VECTOR, false, 0.0);
						EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, NULL_VECTOR, NULL_VECTOR, false, 0.0);
					}
					else if (Special == VSHSpecial_Postal)
					{
						decl String:s[PLATFORM_MAX_PATH];
						Format(s, PLATFORM_MAX_PATH, "%s%i.wav", PostalStab, GetRandomInt(1, 4));
						EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, NULL_VECTOR, NULL_VECTOR, false, 0.0);
						EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, NULL_VECTOR, NULL_VECTOR, false, 0.0);
					}
					else if (Special == VSHSpecial_Balrog)
					{
						decl String:s[PLATFORM_MAX_PATH];
						Format(s, PLATFORM_MAX_PATH, "%s0%i.wav", BalrogStab, GetRandomInt(1, 3));
						EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, NULL_VECTOR, NULL_VECTOR, false, 0.0);
						EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, NULL_VECTOR, NULL_VECTOR, false, 0.0);
					}
					else if (Special == VSHSpecial_Brute)
					{
						decl String:s[PLATFORM_MAX_PATH];
						Format(s, PLATFORM_MAX_PATH, "%s%i.wav", BruteStab, GetRandomInt(1, 3));
						EmitSoundToAll(s, _, SNDCHAN_VOICE, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, NULL_VECTOR, NULL_VECTOR, false, 0.0);
						EmitSoundToAllExcept(SOUNDEXCEPT_VOICE, s, _, SNDCHAN_ITEM, SNDLEVEL_TRAFFIC, SND_NOFLAGS, SNDVOL_NORMAL, 100, Hale, NULL_VECTOR, NULL_VECTOR, false, 0.0);
					}
					if (Stabbed < 5)
...
public Action:HintPanel(client)
{
	...
	switch (Special)
	{
		...
		case VSHSpecial_Mario:
			Format(s, 512, "%t", "vsh_help_mario");
		case VSHSpecial_Hitler:
			Format(s, 512, "%t", "vsh_help_hitler");
		case VSHSpecial_Kinky:
			Format(s, 512, "%t", "vsh_help_kinky");
		case VSHSpecial_Postal:
			Format(s, 512, "%t", "vsh_help_postal");
		case VSHSpecial_Balrog:
			Format(s, 512, "%t", "vsh_help_balrog");
		case VSHSpecial_Brute:
			Format(s, 512, "%t", "vsh_help_brute");
	}
	DrawPanelText(panel, s);
...
public Action:HalePanel(client, args)
{
	...
	decl String:s[256];
	SetGlobalTransTarget(client);
	Format(s, 256, "%t", "vsh_menu_1");
	SetPanelTitle(panel, s);
	Format(s, 256, "%t", "vsh_menu_2");
	DrawPanelItem(panel, s);
	Format(s, 256, "%t", "vsh_menu_3");
	DrawPanelItem(panel, s);
	Format(s, 256, "%t", "vsh_menu_7");
	DrawPanelItem(panel, s);
	Format(s, 256, "%t", "vsh_menu_4");
	DrawPanelItem(panel, s);
	Format(s, 256, "%t", "vsh_menu_5");
	DrawPanelItem(panel, s);
	Format(s, 256, "%t", "vsh_menu_8");
	DrawPanelItem(panel, s);
	Format(s, 256, "%t", "vsh_menu_9");
	DrawPanelItem(panel, s);
	Format(s, 256, "%t", "vsh_menu_9a");
	DrawPanelItem(panel, s);
/*	if (ACH_Enabled)
	{
		Format(s, 256, "%t", "vsh_menu_10");
		DrawPanelItem(panel, s);
		Format(s, 256, "%t", "vsh_menu_11");
		DrawPanelItem(panel, s);
	}*/
	Format(s, 256, "%t", "vsh_menu_exit");
	DrawPanelItem(panel, s);
