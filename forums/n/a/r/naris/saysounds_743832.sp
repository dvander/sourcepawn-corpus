...
public Plugin:myinfo = 
{
	...
	author = "Hell Phoenix, -=|JFH|=-Naris, [RiCK] Stokes, LAMDACORE, Uberman, gH0sTy, Woody",
...
public OnPluginStart(){
	CreateConVar("sm_saysounds_hybrid_version", PLUGIN_VERSION, "Say Sounds Version", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
...
Send_Sound(client, const String:filelocation[], const String:name[])
{
	...
	KvGetString(listfile,"duration",timebuf[0],sizeof(timebuf[]));
