    ...
    if (!gTargetOverride)
    {
        ...
        if (victim > 0)
        {
            ...
            if (client > 0)
            {
                ...
                NadeHurtPlayer(victim, client, damage, "tf2nade_drone");
...
{ 
    ...
    if (!special || type >= FragNade)
    {
        ...
        for (new j=1;j<=MaxClients;j++)
        {
            if(PlayersInRange[j]>0.0)
            {
                NadeHurtPlayer(j, client, damage, "tf2nade_frag",
                               true, false, center, 3.0);
            }
        }
        ...
        switch (type)
        {
            case ConcNade:
            {
                ...
                for (new j=1;j<=MaxClients;j++)
                {
                    if(PlayersInRange[j]>0.0)
                    {
                        ...
                        NadeHurtPlayer(j, client, damage, "tf2nade_conc"); 
                    }
                }
            }
            case BearTrap:
            {
                ...
                for (new j=1;j<=MaxClients;j++)
                {
                    if(PlayersInRange[j]>0.0)
                    {
                        ...
                        NadeHurtPlayer(j, client, damage, "tf2nade_trap"); 
                    }
                }
            }
            case NailNade:
            ...
            case MirvNade:
            {
                ...
                for (new j=1;j<=MaxClients;j++)
                {
                    if(PlayersInRange[j]>0.0)
                    {
                        NadeHurtPlayer(j, client, damage, "tf2nade_mirv",
                                       true, false, center);
                    }
                }
            ...
            case NapalmNade:
            {
                ...
                for (new j=1;j<=MaxClients;j++)
                {
                    if(PlayersInRange[j]>0.0)
                    {
                        ...
                        if (damage>=health)
                        {
                            hurt = NadeHurtPlayer(j, client, health-1, "tf2nade_napalm",
                                                  true, true, center, 2.0);
                        }
                        else
                        {
                            hurt = NadeHurtPlayer(j, client, damage, "tf2nade_napalm",
                                                  true, true, center, 2.0);
                        }
            ...
            case HallucNade:
            {
                ...
                for (new j=1;j<=MaxClients;j++)
                {
                    if(PlayersInRange[j]>0.0)
                    {
                        ...
                        NadeHurtPlayer(j, client, damage, "tf2nade_halluc"); 
                    }
                }
            }
            case EmpNade:
...
public Action:SoldierNadeThink(Handle:timer, any:pack)
{
        ...
        GetClientOfUserId(userid) == client)
    {
        ...
        for (new j=1;j<=MaxClients;j++)
        {
            if (PlayersInRange[j]>0.0)
            {
                NadeHurtPlayer(j, client, damage, "tf2nade_nail",
                               false, false, center);
            }
        }
        return Plugin_Continue;
...
bool:NadeHurtPlayer(client, attacker, damage, const String:weapon[],
                    bool:explosion=false, bool:napalm=false,
                    Float:pos[3] = NULL_VECTOR,
                    Float:knockbackmult = 4.0)
{
