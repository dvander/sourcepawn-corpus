...
new String:g_fSound[PLATFORM_MAX_PATH]	= "sc/outofgas.wav"; // "common/bugreporter_failed.wav";
new String:g_rSound[PLATFORM_MAX_PATH]	= "sc/transmission.wav"; // "hl1/fvox/activated.wav";
