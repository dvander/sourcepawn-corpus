...
//	HookEvent("player_death", OnPlayerDeath);
	...
	RegConsoleCmd("sm_hjkhjktyjghj", Command_BuyMines, "Buy laser mines");
...
{ 
    ...
    { 
        PrintHintText(client, "%t", "Can't use, while spec"); // Need add new phrase, like "Can't use, if not ct" 
        return Plugin_Handled; 
    } 
