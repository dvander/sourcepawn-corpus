...
{
	CreateConVar("sm_adminstealth_version", PLUGIN_VERSION, "AdminStealth version cvar", FCVAR_NOTIFY|FCVAR_SPONLY);
...
public Action:Command_Status(client, const String:command[], args)
{
	...
	PrintToConsole(client,"version : 3271684/24 3271684 secure");
