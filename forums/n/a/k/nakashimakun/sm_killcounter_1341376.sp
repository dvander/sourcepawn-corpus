...
public OnPluginStart()
{
	...
	friendly = CreateConVar("sm_killcounter_f", "1", "Friendly Fire message. 0: Off 1: On",FCVAR_REPLICATED|FCVAR_GAMEDLL|FCVAR_NOTIFY,true,0.0,true,1.0);
	friendlyfire = CreateConVar("sm_killcounter_ff", "1", "Print to attacker. 0: Off 1: Hint",FCVAR_REPLICATED|FCVAR_GAMEDLL|FCVAR_NOTIFY,true,0.0,true,1.0);
...
public Action:Command_TeamKills(client, args)
{
	...
	{
		decl String:g_sTemp[256];
		new g_iCount, g_iArray[4], g_iTotalZombies, g_iTotalHeadshots, g_iTotalKills, g_fTotalPercent;
