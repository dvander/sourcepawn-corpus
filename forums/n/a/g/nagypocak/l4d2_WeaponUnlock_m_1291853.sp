...
static PrecacheWeaponModels()
{
	...
	CheckModelPreCache("models/w_models/weapons/w_knife_t.mdl");
	CheckModelPreCache("models/weapons/melee/w_riotshield.mdl");
	CheckModelPreCache("models/weapons/melee/w_golfclub.mdl");
	...
	CheckModelPreCache("models/v_models/v_knife_t.mdl");
	CheckModelPreCache("models/weapons/melee/v_riotshield.mdl");
	CheckModelPreCache("models/weapons/melee/v_golfclub.mdl");
}
...
public Action:InitHiddenWeaponsDelayed(Handle:timer, any:client)
{
	...
	PreCacheGun("weapon_hunting_knife");
