...
static String:g_szWeapons[MAX_BUYWEAPONS][5][ ] = 
{
	...
	{"weapon_glock", "Glock", "1", "400", ""},
	{"weapon_usp", "USP Compact", "1", "500", ""},
	{"weapon_p228", "228 Compact", "1", "600", ""},
	{"weapon_deagle", "Night Hawk Deagle", "1", "650", ""},
	...
	{"weapon_scout", "Schmidt Scout", "2", "2750", ""},
	{"weapon_sg552", "Krieg 552", "2", "3500", "2"},
	{"weapon_awp", "Magnum Sniper Rifle", "2", "4750", ""},
	{"weapon_g3sg1", "G3SG1 AutoSniper D3/AU-1", "2", "5000", "2"},
	{"weapon_famas", "Clarion Famas", "2", "2250", "3"},
	{"weapon_m4a1", "Maverick M4A1 Carbine", "2", "3100", "3"},
	{"weapon_aug", "Bullpup AUG", "2", "3500", "3"},
	{"weapon_sg550", "Krieg 550 Commando", "2", "4200", "3"},
	{"weapon_m3", "M3 12 Gauge Super", "2", "1700", ""},
	{"weapon_xm1014", "YG1265 Auto Shotgun", "2", "3000", ""},
	{"weapon_mac10", "Ingram Mac-10", "2", "1400", "2"},
	{"weapon_tmp", "TMP Schmidt Machine Pistol", "2", "1250", "3"},
	{"weapon_mp5navy", "MP5 Navy", "2", "1500", ""},
	{"weapon_ump45", "KM UMP45", "2", "1700", ""},
	{"weapon_p90", "ES C90", "2", "2350", ""},
	{"weapon_m249", "M249 SAW", "2", "5750", ""}
...
public OnPluginStart()
{
	...
	g_hAdminBuyFlags = CreateConVar("sm_buy_adminflags", "s", "Admin Flag(s) to allow changing cash. o=CustomFlag_1 p=CustomFlag_2 etc.", FCVAR_PLUGIN|FCVAR_SPONLY);
...
public Action:eventBuy(p_iClient, p_szArgs)
{
	...
	if(iBuyEnabled != 0)
	{
		...
		if (strlen(szAdminFlags) > 0)
		{
			...
			if (GetUserFlagBits(p_iClient) & ReadFlagString(szAdminFlags) <= 0 && !(GetUserFlagBits(p_iClient) & ADMFLAG_ROOT))
			{
