...
{
	CreateConVar("sm_dod_ammo_version", PLUGIN_VERSION, "DOD:S Ammo Settings", FCVAR_DONTRECORD|FCVAR_PLUGIN|FCVAR_NOTIFY);
	g_hEnabled  = CreateConVar("sm_dod_ammo_enabled", "1", "Enable/disable DOD:S Ammo Settings", FCVAR_PLUGIN, true, 0.0, true, 1.0);
