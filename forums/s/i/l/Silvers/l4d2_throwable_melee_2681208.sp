...
ConVar g_hCvarAllow, g_hCvarMPGameMode, g_hCvarModes, g_hCvarModesOff, g_hCvarModesTog, g_hCvarReturn, g_hCvarSpeed, g_hCvarSpeedMax, g_hCvarSpeedTime, g_hCvarSpin, g_hCvarTypes;
int g_iCvarReturn, g_iCvarSpeed, g_iCvarSpeedMax, g_iCvarSpin, g_iCvarTypes;
...
public void OnPluginStart()
{
	...
	// Cvars
	// ====================================================================================================
	g_hCvarAllow =		CreateConVar(	"l4d2_throwable_allow",			"1",				"0=Plugin off, 1=Plugin on.", CVAR_FLAGS );
	...
	g_hCvarSpeedTime =	CreateConVar(	"l4d2_throwable_speed_time",	"1.0",				"0.0=Off, instant throw. Max time to get max speed. The longer players hold Zoom/Scope (MMB - middle mouse button) the faster they throw.", CVAR_FLAGS);
	g_hCvarSpin =		CreateConVar(	"l4d2_throwable_spin",			"3",				"0=Off. 1=Spin top over. 2=Spin sideways. 3=Both randomly selected. Requires gamedata.", CVAR_FLAGS);
	g_hCvarTypes =		CreateConVar(	"l4d2_throwable_types",			"32767",			"Which melee weapons can be thrown: 1=Baseball Bat, 2=Cricket Bat, 4=Crowbar, 8=Frying Pan, 16=Guitar, 32=Fireaxe, 64=Golfclub, 128=Katana, 256=Knife, 512=Machete, 1024=Tonfa, 2048=Riot Shield, 4096=Generic, 8192=Pitchfork, 16384=Shovel, 32767=All. Add numbers together.", CVAR_FLAGS);
...
void CreateMelee(int client)
{
	...
	int type;
	if( g_hMeleeTypes.GetValue(script, type) == false ) return;
