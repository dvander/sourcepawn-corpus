 ...
 *
 * Version: $Id: dm_basics.sp 413 2007-07-25 04:15:38Z dvander $
 */
...
public OnPluginStart()
{
	...
	cssdm_use_nextmap = CreateConVar("cssdm_use_nextmap", "1", "Sets whether CS:S DM should use the value of sm_nextmap for forcing mapchanges");
...
public Action:Timer_ChangeMap(Handle:timer)
{
	...
	GetConVarString(sm_nextmap, smnextmap, sizeof(smnextmap));
	...
	if (GetConVarInt(cssdm_use_nextmap) && nextmapvalid)
	{
		ServerCommand("changelevel %s", smnextmap);
	}
	else
	{
