...
public Plugin:myinfo =
{
	...
	author = "<eVa>Dog &7 Modified by Tak(Chaosxk)",
...
public OnPluginStart()
{
	...
	g_Dmg = CreateConVar("sm_rocketme_damage", "1000.0", "Specify the amount of damage done.", FCVAR_PLUGIN)
	...
	if (IsClientInGame(client))
	{
		...
		{	
			...
			if (IsBonusRound)
			{
				...
				SetEntProp(g_ent, Prop_Data, "m_iMagnitude", GetConVarInt(g_Dmg));
				SetEntPropEnt(g_ent, Prop_Data, "m_hOwnerEntity", client)
