...
public OnMapStart()
{
	...
	AddFileToDownloadsTable("materials/cable/cable.vmt");
	AddFileToDownloadsTable("materials/cable/cable.vtf");
...
public Action:RoundStart(Handle:Event2, const String:Name[], bool:Broadcast)
{
...
public Action:RoundEnd(Handle:Event2, const String:Name[], bool:Broadcast)
{
	ClearUndo();
	return Plugin_Continue;
}
