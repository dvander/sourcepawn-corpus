/**
 * Auto-Alltalk
 * Modified version of VictorOfSweden's plugin
 *
...
{
	name = "Auto-Alltalk",
	author = "Black Hawk/sneaK",
	description = "Automatically toggles sv_alltalk. Based on a plugin by ferret, modified version of VictorOfSweden.",
	version = "1.0.5",
	url = "http://www.gamewithpure.org/"
};
...
public OnPluginStart(){
	/* Load phrases */
	LoadTranslations("autoalltalk.phrases");
	...
	/* Limit mode settings */
	g_cvar_limit = CreateConVar("sm_spa_atlimit", "16", "Number of players needed to toggle alltalk (0 = turn off).", FCVAR_PLUGIN|FCVAR_DONTRECORD, true, 0.0, true, MAXPLAYERS);
	...
	/* Round end settings */
	g_cvar_roundend = CreateConVar("sm_spa_atroundend", "1", "Turn toggling of alltalk at round end on/off (1/0).", FCVAR_PLUGIN|FCVAR_DONTRECORD, true, 0.0, true, 1.0);
