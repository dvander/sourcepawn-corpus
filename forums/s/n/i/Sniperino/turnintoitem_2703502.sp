...
{
	name = "Turn into items CS:GO (normal version)", 
...
void openSuit(int client)
{
	...
	Format(text, sizeof(text), "Radio");
	menu.AddItem("suit1", text);
	Format(text, sizeof(text), "Couch");
	menu.AddItem("suit2", text);
	Format(text, sizeof(text), "Bar-Stool");
	menu.AddItem("suit3", text);
	Format(text, sizeof(text), "Wagon");
	menu.AddItem("suit4", text);
	if(g_cSUITvip.IntValue > 0)
	{
		if(IsClientVIP(client))
		{
			Format(text, sizeof(text), "Bed");
			menu.AddItem("suit5", text);
			Format(text, sizeof(text), "Metal Crate");
			menu.AddItem("suit6", text);
			Format(text, sizeof(text), "BookCase");
			menu.AddItem("suit7", text);
			Format(text, sizeof(text), "MailBox");
			...
			if (IsValidClient(client) && IsPlayerAlive(client))
			{
				...
				if (StrEqual(szItem, "suit1"))
				{
					if (i_suitusage[client] < g_cSUITusage.IntValue)
					{
						if (i_suit[client] == 0)
						{
							CPrintToChat(client, " \x04[HNS] \x01%t", "hns_radio");
							i_suitusage[client]++;
				...
				else if (StrEqual(szItem, "suit2"))
				{
					if (i_suitusage[client] < g_cSUITusage.IntValue)
					{
						if (i_suit[client] == 0)
						{
							CPrintToChat(client, " \x04[HNS] \x01%t", "hns_couch");
							i_suitusage[client]++;
				...
				else if (StrEqual(szItem, "suit3"))
				{
					if (i_suitusage[client] < g_cSUITusage.IntValue)
					{
						if (i_suit[client] == 0)
						{
							CPrintToChat(client, " \x04[HNS] \x01%t", "hns_barstool");
							i_suitusage[client]++;
				...
				else if (StrEqual(szItem, "suit4"))
				{
					if (i_suitusage[client] < g_cSUITusage.IntValue)
					{
						if (i_suit[client] == 0)
						{
							CPrintToChat(client, " \x04[HNS] \x01%t", "hns_wagon");
							i_suitusage[client]++;
				...
				else if (StrEqual(szItem, "suit5"))
				{
					if (i_suitusage[client] < g_cSUITusage.IntValue)
					{
						if (i_suit[client] == 0)
						{
							CPrintToChat(client, " \x04[HNS] \x01%t", "hns_bed");
							i_suitusage[client]++;
				...
				else if (StrEqual(szItem, "suit6"))
				{
					if (i_suitusage[client] < g_cSUITusage.IntValue)
					{
						if (i_suit[client] == 0)
						{
							CPrintToChat(client, " \x04[HNS] \x01%t", "hns_metalcrate");
							i_suitusage[client]++;
				...
				else if (StrEqual(szItem, "suit7"))
				{
					if (i_suitusage[client] < g_cSUITusage.IntValue)
					{
						if (i_suit[client] == 0)
						{
							CPrintToChat(client, " \x04[HNS] \x01%t", "hns_bookcase");
							i_suitusage[client]++;
				...
				else if (StrEqual(szItem, "suit8"))
				{
					if (i_suitusage[client] < g_cSUITusage.IntValue)
					{
						if (i_suit[client] == 0)
						{
							CPrintToChat(client, " \x04[HNS] \x01%t", "hns_mailbox");
							i_suitusage[client]++;
