...
public OnConfigsExecuted()
{
    ...
    PrecacheModel("models/player/knifelemon/bighead/ct_gign.mdl");

    PrecacheModel("models/player/knifelemon/bighead/t_phoenix.mdl");
    
    PrecacheModel("models/player/techknow/zp/z2.mdl");
