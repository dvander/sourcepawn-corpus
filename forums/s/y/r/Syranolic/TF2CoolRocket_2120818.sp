...
new const String:PLUGIN_VERSION[60] = "1.1.2";
...
public OnPluginStart(){
	...
	g_cvarLifeTime = CreateConVar("TF2CoolRocket_lifetime", "100", "Rocket's life time in think count (0 to disable).");
...
public RocketThinkHook(entity){
	...
	if( lifeTime > 0 && ++g_iRocketLifeTimeMeters[entity] >= lifeTime )
		return;
