...
public UberShopinitMenusHandlers()
{
	...
	RegConsoleCmd("sm_uuhelp", Disp_Help)
	...
	RegAdminCmd("sm_resetuu", ReloadCfgFiles, ADMFLAG_GENERIC)	
	RegConsoleCmd("sm_uu", Disp_Help)
	...
	RegConsoleCmd("sm_qbuy", Menu_QuickBuyUpgrade2)
