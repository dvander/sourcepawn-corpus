...
#define PLUGIN_VERSION "SaveChat_Ver_2.0"
...
public Action:Command_Command(client, args)
{
	...
	Format(msg, sizeof(msg), "[%s] (%s) %-35N [COMMAND]: %s %s",
		time,
		steamID,
		client,
		cmd,
