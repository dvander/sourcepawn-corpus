...
public OnPluginStart()
{
	...
	RegConsoleCmd("sm_location", Command_Location, "Gets a players location")
	RegConsoleCmd("sm_locations", Command_Locations, "Gets everyones location")
...
public Action:Command_Locations(client, args)
{
	...
	{
		if(client==0) // g_LocationInMenu 0/1 egal
		{
			PrintToServer("Player locations list:")
		}
		else // g_LocationInMenu 0, bei 1 nicht im Spiel zu sehen
		{
