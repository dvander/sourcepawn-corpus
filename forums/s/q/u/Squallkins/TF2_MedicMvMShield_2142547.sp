...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_shield", Command_Shield, ADMFLAG_BAN, "Turns on the Medic's shield effect from MvM. Usage: sm_shield");
	RegAdminCmd("sm_shield2", Command_Shield2, ADMFLAG_BAN, "Turns on the Medic's advanced shield effect from MvM. Usage: sm_shield2");
}
