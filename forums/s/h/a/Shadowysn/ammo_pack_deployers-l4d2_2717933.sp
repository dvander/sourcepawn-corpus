...
public void OnPluginStart()
{
	...
	apdLowAmmo = CreateConVar("apd-l4d2_low_ammo", "1", "Enable/Disable Low Ammo Check", FCVAR_SPONLY|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	apdTankSpawns = CreateConVar("apd-l4d2_tank_spawns", "1", "Enable/Disable Tank Spawns Check", FCVAR_SPONLY|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	apdWitchSpawns = CreateConVar("apd-l4d2_witch_spawns", "1", "Enable/Disable Witch Spawns Check", FCVAR_SPONLY|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	apdMobSpawns = CreateConVar("apd-l4d2_mob_spawns", "1", "Enable/Disable Mob Spawns Check", FCVAR_SPONLY|FCVAR_NOTIFY, true, 0.0, true, 1.0);
