...
public Plugin myinfo = 
{
	...
	author = "shanapu",
	description = "Give Credits for FrozDark shop on TouchDown",
	version = "1.0",
...
public Action Touchdown_OnPlayerTouchDown(int client)
{
	...
	Shop_SetClientCredits(client, Shop_GetClientCredits(client) + gc_iCreditsTouchdown.IntValue);
...
public Action Touchdown_OnPlayerKillBall(int ballholder, int attacker)
{
	...
	Shop_SetClientCredits(attacker, Shop_GetClientCredits(attacker) + gc_iCreditsKillBallHolder.IntValue);
