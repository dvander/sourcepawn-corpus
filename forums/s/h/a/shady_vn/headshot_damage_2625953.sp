...
{
	l4d2_dmg_headshot_awm = CreateConVar("l4d2_dmg_headshot_awm","100.0", "Dmg headshot awm");
	l4d2_dmg_headshot_military = CreateConVar("l4d2_dmg_headshot_awm","100.0", "Dmg headshot sung nham 30 vien");
	l4d2_dmg_headshot_hunting_rifle = CreateConVar("l4d2_dmg_headshot_awm","100.0", "Dmg headshot cua sung nham hunting");
	l4d2_dmg_headshot_scout = CreateConVar("l4d2_dmg_headshot_awm","100.0", "Dmg headshot cua sung nham scout");
...
public Action:OnTakeDamage_SI(int victim, int &attacker, int &inflictor, float &damage, int &damagetype, int &ammotype, int hitbox, int hitgroup)
{
	...
	if(hitgroup == 1) /// neu la headshot thi doi damage sung nham
	{
		...
		if(StrEqual(nameweapon,"weapon_sniper_scout"))
		{
			damage = GetConVarFloat(l4d2_dmg_headshot_scout);
		}
		if(StrEqual(nameweapon,"weapon_hunting_rifle"))
		{
			damage = GetConVarFloat(l4d2_dmg_headshot_hunting_rifle);
		}
		if(StrEqual(nameweapon,"weapon_sniper_military"))
		{
