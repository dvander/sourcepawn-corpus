...
public OnMapStart()
{
	...
	Format(tewin_snd5, sizeof(tewin_snd5), "sound/misc/twinnar5.mp3");
	Format(tewin_snd6, sizeof(tewin_snd6), "sound/misc/twinnar6.mp3");
	Format(tewin_snd7, sizeof(tewin_snd7), "sound/misc/twinnar7.mp3");
	Format(tewin_snd8, sizeof(tewin_snd8), "sound/misc/twinnar8.mp3");
	Format(tewin_snd9, sizeof(tewin_snd9), "sound/misc/twinnar9.mp3");
	Format(tewin_snd10, sizeof(tewin_snd10), "sound/misc/twinnar10.mp3");
	...
	Format(ctwin_snd4, sizeof(ctwin_snd4), "sound/misc/ctwinnar4.mp3");
	Format(ctwin_snd5, sizeof(ctwin_snd5), "sound/misc/ctwinnar5.mp3");
	Format(ctwin_snd6, sizeof(ctwin_snd6), "sound/misc/ctwinnar6.mp3");
	Format(ctwin_snd7, sizeof(ctwin_snd7), "sound/misc/ctwinnar7.mp3");
	Format(ctwin_snd8, sizeof(ctwin_snd8), "sound/misc/ctwinnar8.mp3");
	Format(ctwin_snd9, sizeof(ctwin_snd9), "sound/misc/ctwinnar9.mp3");
	Format(ctwin_snd10, sizeof(ctwin_snd10), "sound/misc/ctwinnar10.mp3");

	if(FileExists(tewin_snd1) && FileExists(tewin_snd2) && FileExists(tewin_snd3) && FileExists(tewin_snd4)&&FileExists(tewin_snd5)&&FileExists(tewin_snd6)&&FileExists(tewin_snd7)&&FileExists(tewin_snd8)&&FileExists(tewin_snd9)&&FileExists(tewin_snd10)&&FileExists(ctwin_snd1) && FileExists(ctwin_snd2) &&FileExists(ctwin_snd3) &&FileExists(ctwin_snd4) && FileExists(ctwin_snd5) &&FileExists(ctwin_snd6) &&FileExists(ctwin_snd7) &&FileExists(ctwin_snd8) &&FileExists(ctwin_snd9) &&FileExists(ctwin_snd10)) {
		...
		PrecacheSound("misc/ctwinnar.mp3", true);
		...
		PrecacheSound("misc/ctwinnar7.mp3", true);
		PrecacheSound("misc/ctwinnar8.mp3", true);
		PrecacheSound("misc/ctwinnar9.mp3", true);
		PrecacheSound("misc/ctwinnar10.mp3", true);
		...
		PrecacheSound("misc/twinnar6.mp3", true);
		PrecacheSound("misc/twinnar7.mp3", true);
		PrecacheSound("misc/twinnar8.mp3", true);
		PrecacheSound("misc/twinnar9.mp3", true);
		PrecacheSound("misc/twinnar10.mp3", true);
	}
	else {
	...
	if(g_bEnabled) {
		if(ev_winner == 2) {
			if(rnd_sound == 1) {
				...
				EmitSoundToAll("misc/twinnar6.mp3");
			}
			else if(rnd_sound == 7) {
				EmitSoundToAll("misc/twinnar7.mp3");
			}
			else if(rnd_sound == 8) {
				EmitSoundToAll("misc/twinnar8.mp3");
			}
			else if(rnd_sound == 9) {
				EmitSoundToAll("misc/twinnar9.mp3");
			}
			else if(rnd_sound == 10) {
				EmitSoundToAll("misc/twinnar10.mp3");
			}
			else {
			...
			if(rnd_sound == 1) {
				EmitSoundToAll("misc/ctwinnar.mp3");
			}
			else if(rnd_sound == 2) {
				...
				EmitSoundToAll("misc/ctwinnar7.mp3");
			}
			else if(rnd_sound == 8) {
				EmitSoundToAll("misc/ctwinnar8.mp3");
			}
			else if(rnd_sound == 9) {
				EmitSoundToAll("misc/ctwinnar9.mp3");
			}
			else if(rnd_sound == 10) {
				EmitSoundToAll("misc/ctwinnar10.mp3");
			}
			else {
				LogError("Ramdom Sound CVar Error.");
			}
