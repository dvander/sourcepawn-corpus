...
#define MAX_HACKCVAR 33	/* !!!!!! If you add Cvars you need to change this number to reflect how many there are! !!!!!! */
...
public OnPluginStart()
{
	...
	RegConsoleCmd("groundlist", BlockCrash, "Do not use this command.");
	RegConsoleCmd("soundlist", BlockCrash, "Do not use this command.");
	RegConsoleCmd("report_touchlinks", BlockCrash, "Do not use this command.");
	RegConsoleCmd("report_entities", BlockCrash, "Do not use this command.");
	RegConsoleCmd("physics_report_active", BlockCrash, "Do not use this command.");
	RegConsoleCmd("listmodels", BlockCrash, "Do not use this command.");
