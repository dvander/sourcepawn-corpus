...
public OnPluginStart()
{
	...
	hSProt		= CreateConVar("sm_adv_spawn_protection", "8.0","Spawn protection time (0 to disable)", FCVAR_PLUGIN, true, 0.0);	
	...
	hAdmVision	= CreateConVar("sm_adv_admin_vision",	"1", 	"Enable admin vision (for: 1 - admins, 2 - fake clients, 4 - all, when sv_alltalk 1, 8 - all)", FCVAR_PLUGIN, true, 0.0, true, 15.0);
