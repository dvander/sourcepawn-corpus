...
public OnPluginStart() {
	...
	UpgradeAllowed[0] = CreateConVar("surup_allow_kevlar_body_armor", "0", "Give the Kevlar Body Armor upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[1] = 8;
	UpgradeShortInfo[1] = "UPGRADE_1_SHORT";
	UpgradeLongInfo[1] = "UPGRADE_1_LONG"; 
	UpgradeAllowed[1] = CreateConVar("surup_allow_raincoat", "0", "Give the Raincoat upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[2] = 11;
	UpgradeShortInfo[2] = "UPGRADE_2_SHORT";
	UpgradeLongInfo[2] = "UPGRADE_2_LONG";
	UpgradeAllowed[2] = CreateConVar("surup_allow_climbing_chalk", "2", "Give the Climbing Chalk upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[3] = 12;
	UpgradeShortInfo[3] = "UPGRADE_3_SHORT";
	UpgradeLongInfo[3] = "UPGRADE_3_LONG";
	UpgradeAllowed[3] = CreateConVar("surup_allow_second_wind", "2", "Give the Second Wind upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[4] = 13;
	UpgradeShortInfo[4] = "UPGRADE_4_SHORT";
	UpgradeLongInfo[4] = "UPGRADE_4_LONG";
	UpgradeAllowed[4] = CreateConVar("surup_allow_goggles", "0", "Give the Goggles upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[5] = 16;
	UpgradeShortInfo[5] = "UPGRADE_5_SHORT";
	UpgradeLongInfo[5] = "UPGRADE_5_LONG";
	UpgradeAllowed[5] = CreateConVar("surup_allow_hot_meal", "1", "Give the Hot Meal upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[6] = 17;
	UpgradeShortInfo[6] = "UPGRADE_6_SHORT";
	UpgradeLongInfo[6] = "UPGRADE_6_LONG";
	UpgradeAllowed[6] = CreateConVar("surup_allow_laser_sight", "0", "Give the Laser Sight upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[7] = 19;
	UpgradeShortInfo[7] = "UPGRADE_7_SHORT";
	UpgradeLongInfo[7] = "UPGRADE_7_LONG";
	UpgradeAllowed[7] = CreateConVar("surup_allow_combat_sling", "0", "Give the Combat Sling upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[8] = 20;
	UpgradeShortInfo[8] = "UPGRADE_8_SHORT";
	UpgradeLongInfo[8] = "UPGRADE_8_LONG";
	UpgradeAllowed[8] = CreateConVar("surup_allow_large_clip", "2", "Give the Large Clip upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[9] = 21;
	UpgradeShortInfo[9] = "UPGRADE_9_SHORT";
	UpgradeLongInfo[9] = "UPGRADE_9_LONG";
	UpgradeAllowed[9] = CreateConVar("surup_allow_hollow_point_ammo", "0", "Give the Hollow Point Ammo upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[10] = 26;
	UpgradeShortInfo[10] = "UPGRADE_10_SHORT";
	UpgradeLongInfo[10] = "UPGRADE_10_LONG";
	UpgradeAllowed[10] = CreateConVar("surup_allow_knife", "0", "Give the Knife upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[11] = 27;
	UpgradeShortInfo[11] = "UPGRADE_11_SHORT";
	UpgradeLongInfo[11] = "UPGRADE_11_LONG";
	UpgradeAllowed[11] = CreateConVar("surup_allow_smelling_salts", "2", "Give the Smelling Salts upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[12] = 28;
	UpgradeShortInfo[12] = "UPGRADE_12_SHORT";
	UpgradeLongInfo[12] = "UPGRADE_12_LONG";
	UpgradeAllowed[12] = CreateConVar("surup_allow_ointment", "0", "Give the Ointment upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[13] = 29;
	UpgradeShortInfo[13] = "UPGRADE_13_SHORT";
	UpgradeLongInfo[13] = "UPGRADE_13_LONG";
	UpgradeAllowed[13] = CreateConVar("surup_allow_reloader", "2", "Give the Reloader upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[14] = 30;
	UpgradeShortInfo[14] = "UPGRADE_14_SHORT";
	UpgradeLongInfo[14] = "UPGRADE_14_LONG";
	UpgradeAllowed[14] = CreateConVar("surup_allow_incendiary_ammo", "0", "Give the Incendiary Ammo upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	IndexToUpgrade[15] = 30;
	UpgradeShortInfo[15] = "UPGRADE_15_SHORT";
	UpgradeLongInfo[15] = "UPGRADE_15_LONG";
	UpgradeAllowed[15] = CreateConVar("surup_allow_adrenaline", "0", "Give the Adrenaline upgrade? (0=No,1=Yes,2=At Spawn)", CVAR_FLAGS, true, 0.0, true, 2.0);
	
	UpgradeSpecialAmmoName[0] = "LABEL_HOLLOWPOINT";
	UpgradeSpecialAmmoName[1] = "LABEL_INCENDIARY";
	
	UpgradesSpawnAll = CreateConVar("surup_upgrades_spawn_all", "0", "How many random upgrades to give survivors when they spawn.", CVAR_FLAGS, true, 0.0, true, CVAR_MAX_UPGRADES);
	#if BOOL_UPGRADE_WITCH
	UpgradesWitchCr0wned = CreateConVar("surup_upgrades_witch_cr0wned", "0", "How many random upgrades to give the survivor who cr0wned (headshot-killed) a witch. (0=Disabled)", CVAR_FLAGS, true, 0.0, true, CVAR_MAX_UPGRADES);
	UpgradesWitchKiller = CreateConVar("surup_upgrades_witch_killer", "0", "How many random upgrades to give the survivor who personally killed the witch. (0=Disabled)", CVAR_FLAGS, true, 0.0, true, CVAR_MAX_UPGRADES);
	UpgradesWitchAll = CreateConVar("surup_upgrades_witch_all", "0", "How many random upgrades to give survivors when their team kills the witch. (0=Disabled)", CVAR_FLAGS, true, 0.0, true, CVAR_MAX_UPGRADES);
	#endif
	#if BOOL_UPGRADE_TANK
	UpgradesTankSpawn = CreateConVar("surup_upgrades_tank_spawn", "0", "How many random upgrades to give survivors when a tank spawns. (0=Disabled)", CVAR_FLAGS, true, 0.0, true, CVAR_MAX_UPGRADES);
	UpgradesTankKiller = CreateConVar("surup_upgrades_tank_killer", "0", "How many random upgrades to give the survivor who personally killed the tank. (0=Disabled)", CVAR_FLAGS, true, 0.0, true, CVAR_MAX_UPGRADES);
	UpgradesTankAll = CreateConVar("surup_upgrades_tank_all", "0", "How many random upgrades to give survivors when their team kills the tank. (0=Disabled)", CVAR_FLAGS, true, 0.0, true, CVAR_MAX_UPGRADES);
	#endif
	#if BOOL_UPGRADE_HEAL
	UpgradesHealPlayer = CreateConVar("surup_upgrades_heal_person", "0", "How many random upgrades to give a survivor who heals another player. (0=Disabled)", CVAR_FLAGS, true, 0.0, true, CVAR_MAX_UPGRADES);
	UpgradesHealSelf = CreateConVar("surup_upgrades_heal_self", "0", "How many random upgrades to give a survivor who healed himself. (0=Disabled)", CVAR_FLAGS, true, 0.0, true, CVAR_MAX_UPGRADES);
	UpgradesHealAmount = CreateConVar("surup_upgrades_heal_amount", "0", "The minimum amount of health to heal to give an upgrade", CVAR_FLAGS, true, 0.0, true, 100.0);
	#endif
	#if BOOL_UPGRADE_KILLS
	UpgradesKillCount = CreateConVar("surup_upgrades_kill_count", "0", "How many infected a survivor must kill before receiving upgrades? (0=Disabled)", CVAR_FLAGS, true, 0.0);
	UpgradesKillAmount = CreateConVar("surup_upgrades_kill_amount", "0", "How many random upgrades to give survivors when they kill surup_upgrades_kill_count infected, or multiplier of SpecialAmmo giving for surup_upgrades_kill_award 1 (0=Disabled)", CVAR_FLAGS, true, 0.0, true, CVAR_MAX_UPGRADES);
	UpgradesKillAward = CreateConVar("surup_upgrades_kill_award", "0", "What upgrades to give the player by kills? 0=Random Upgrades, 1=SpecialAmmo only, Add SpecialAmmo if already has both SpecialAmmos, 2=SpecialAmmo, give Random if has both SpecialAmmos", CVAR_FLAGS, true, 0.0, true, 2.0);
	#endif
	#if BOOL_UPGRADE_SAFEROOM
	UpgradesReachSaferoom = CreateConVar("surup_upgrades_reach_saferoom", "0", "How many random upgrades to give survivors when they reach a saferoom? (0=Disabled)", CVAR_FLAGS, true, 0.0, true, CVAR_MAX_UPGRADES);
	#endif
	UpgradeSpecialAmmoCount = CreateConVar("surup_upgrade_specialammo_count", "0", "How many bullets of Incendiary/HollowPoint ammo to give per giveupgrade? (0=unlimited)", CVAR_FLAGS, true, 0.0);
	UpgradeSpecialAmmoMinusSG = CreateConVar("surup_upgrade_specialammo_minussg", "0", "How many bullets (whole number) out of the SpecialAmmo reserve do you deduct when shooting shotgun bullets?", CVAR_FLAGS, true, 1.0);
	#if BOOL_SHOW_SPECIALAMMO
	UpgradeSpecialAmmoShow = CreateConVar("surup_upgrade_specialammo_show", "3", "Show SpecialAmmo remaining? (0=No, 1=CenterText above crosshair, 2=HintText, 3=ChatText-not recommended)", CVAR_FLAGS, true, 0.0, true, 3.0);
	#endif
	#if BOOL_SHOW_AMMOPANEL
	...
	#endif
	#if BOOL_ALLOW_INCENDIARY
	UpgradeIncendiaryIgniteTankNoVS = CreateConVar("surup_upgrade_incendiary_ignitetank_nonvs", "0", "Incendiary Ammo upgrade: Does it light the tank on fire on Campaign/Survival? (0=No, 1=Yes)", CVAR_FLAGS, true, 0.0, true, 1.0);
	...
	UpgradeIncendiaryIgniteSpecNoVS = CreateConVar("surup_upgrade_incendiary_ignitespecial_nonvs", "0", "Incendiary Ammo upgrade: Does it light up special infected on Campaign/Survival? (0=No, 1=Yes)", CVAR_FLAGS, true, 0.0, true, 1.0);
	...
	#endif
	UpgradeAdrenalineMult = CreateConVar("surup_upgrade_adrenaline_multiplier", "0", "Adrenaline upgrade: By how much should the player's speed be multiplied by? Put a value below 0 to reduce speed", CVAR_FLAGS, true, 0.0);
	UpgradeReloaderSpeed = CreateConVar("surup_upgrade_reloader_speed", "0.4", "Reloader upgrade: How long should reloads take in seconds?", CVAR_FLAGS, true, 0.0, true, 1.0);
	UpgradeReloaderShotgunSpeed = CreateConVar("surup_upgrade_reloader_shotgunspeed", "0.4", "Reloader upgrade: How long should shotgun reloads take in seconds?", CVAR_FLAGS, true, 0.0, true, 1.0);
	#if BOOL_DONT_RETAIN_UPGRADES
	ResetOnMissionLost = CreateConVar("surup_reset_on_missionlost", "1", "Reset all upgrades and don't/re-give initial upgrades on failing a mission? (0=No, 1=Re-give Initial, 2=Lose All Upgrades)", CVAR_FLAGS, true, 0.0, true, 2.0);
	ResetOnMapChange = CreateConVar("surup_reset_on_mapchange", "1", "Reset all upgrades and re-give initial upgrades on map change (Proceeding to next mission)", CVAR_FLAGS, true, 0.0, true, 1.0);
	ResetOnDeath = CreateConVar("surup_reset_on_death", "1", "Reset all upgrades when the player dies? (0=No, 1=Re-give Initial, 2=Yes, DON'T re-give initial on saferoom)", CVAR_FLAGS, true, 0.0, true, 2.0);
	#endif
	LaserDefaultState = CreateConVar("surup_laser_default_state", "0", "Default state of lasers when given to players. (1=On, 0=Off)", CVAR_FLAGS, true, 0.0, true, 1.0);
	...
	VersusAnnounceToAll = CreateConVar("surup_versus_announce_to_all", "0", "Whether we announce to all players, including infected, the names of the upgrades, in versus (1=Yes, 0=No)", CVAR_FLAGS, true, 0.0, true, 1.0);
	PluginVerbosity = CreateConVar("surup_verbosity", "0", "How much text output about upgrades players see (0=None, 3=Max, Default 2).", CVAR_FLAGS, true, 0.0, true, 3.0);
	...
	EnableSv = CreateConVar("surup_enable_sv", "0", "Enable/Disable Survivor Upgrades in Survival (0=Disable,1=Enable)", CVAR_FLAGS, true, 0.0, true, 1.0);
