...
#define VMT_PATH "materials/nse/nse2.vmt"
#define VTF_PATH "materials/nse/nse2.vtf"
...
public void InitPrecache()
{
	...
	PrecacheModel("materials/nse/nse2.vtf");
}

public Action Command_Toggle(int client, int args)
{
	CreateOverlayRepeat(client);
    PrintToChat(client, "[GamersAU] \x02 All aboard the NoScope Express! Choo Choo!");
}	
public Action Command_Remove(int client, int args)
{
	CreateOverlayRemove(client);
	PrintToChat(client, "[GamersAU] \x02 NoScopeExpress has been removed, This makes me sad.");
}
...
{
	SetClientOverlay(client, "nse/nse2");
