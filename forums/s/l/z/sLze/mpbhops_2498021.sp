...
** Compatible with: Counter-Strike Source (Now with CS:GO support)
** Thanks to Ian (Juan) Cammarata & #sourcemod
** Updated for bhop_monster_jam by unbiased george
** Fixed for CS:GO & fixed some compiler issues by sLze
**======================================*/
...
public OnMapEnd() { //DF 2012 Jan 20 - I don't know what the fuck is going on here, but I'm too afraid to touch it. It's likely just cruft that should be removed.
	g_bMapEnding = true
	SetConVarBool(g_hCvar_Enable,GetConVarBool(g_hCvar_Enable))
	g_bMapEnding = true
}
