...
BarfBagged_OnIt (iAtt)
{
		...
		&& GetClientTeam(iAtt) == 3)
	{
		...
		if (g_iSlimed==4) PrintHintText(iAtt,"嘔吐發射! %t", "BarfBaggedMobHint");
	}
	return 0;
}
		...
		&& g_iInf4[iAtt]==1)
	{
		...
		if (iDmgOrig<iMinBound)
		{
			...
			if (iHP>iMinBound)
			{
				...
				PrintHintText(iAtt,"泰山壓頂: %i %t!", iMinBound-iDmgOrig, "BonusDamageText");
			...
			else
			{
				...
				if (flHPBuff>0)
				{
					...
					if (iDmgAdd>=iHP)
					{
						...
						if (iHPBuff<iDmgAdd) iDmgAdd=iHPBuff;
						SetEntDataFloat(iVic,g_iHPBuffO, flHPBuff-iDmgAdd ,true);
						PrintHintText(iAtt,"泰山壓頂: %i bonus damage!", iDmgCount+iDmgAdd);
					...
					else
					{
						...
						SetEntProp(iVic,Prop_Data,"m_iHealth", iHP-iDmgAdd );
						PrintHintText(iAtt,"泰山壓頂: %i bonus damage!", iDmgAdd);
						return 1;
					}
				}
...
public Handle:Menu_Top (iCid)
{
	...
	Format(st_display,64,"倖存者 - 天賦一 (%s)",st_perk);
	if (g_iSur1_enable==1)
	...
	Format(st_display,64,"倖存者 - 天賦二 (%s)", st_perk);
	if (g_iSur2_enable==1)
		DrawPanelItem(menu,st_display);
	else
		DrawPanelItem(menu,"disabled", ITEMDRAW_NOTEXT);
	...
	Format(st_display,64,"倖存者 - 天賦三 (%s)", st_perk);
	if (g_iSur3_enable==1)
		DrawPanelItem(menu,st_display);
	else
		DrawPanelItem(menu,"disabled", ITEMDRAW_NOTEXT);
...
public Handle:Menu_ShowChoices (iCid)
{
	...
	if (iPerk == 1
		...
		|| g_iStopping_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iStopping_enable_vs==1		&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"阻擋之力 (+%i%% %t)", RoundToNearest(g_flStopping_dmgmult*100), "BonusDamageText" );
	else if (iPerk == 2
		&& (g_iDT_enable==1		&&	g_iL4D_GameMode==0
		|| g_iDT_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iDT_enable_vs==1	&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"致命雙擊 (%t, %t, %t)", "DoubleTapDescriptionPanel", "SleighOfHandDescriptionPanel", "DoubleTapRestrictionWarning" ) ;
	else if (iPerk == 3
		&& (g_iSoH_enable==1		&&	g_iL4D_GameMode==0
		|| g_iSoH_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iSoH_enable_vs==1	&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"詭異手法(%t +%i%%)", "SleighOfHandDescriptionPanel", RoundToNearest(100 * ((1/g_flSoH_rate)-1) ) ) ;
	else if (iPerk == 4
		&& (g_iPyro_enable==1		&&	g_iL4D_GameMode==0
		|| g_iPyro_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iPyro_enable_vs==1		&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"煙火專家 (%t)", "PyroDescriptionPanel");
	else
		Format(st_perk,128,"%t", "NotSet");

	if (g_iSur1_enable==1)
	{
		DrawPanelItem(menu,"倖存者，第一天賦:");
	...
	if (iPerk == 1
		...
		|| g_iUnbreak_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iUnbreak_enable_vs==1	&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"堅不可摧 (+%i %t)", g_iUnbreak_hp, "UnbreakableHint");
	else if (iPerk == 2
		&& (g_iSpirit_enable==1		&&	g_iL4D_GameMode==0
		|| g_iSpirit_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iSpirit_enable_vs==1	&&	g_iL4D_GameMode==2))
	{
		...
		if (g_iL4D_GameMode==2)
			...
			iTime=g_iSpirit_cd;
		Format(st_perk,128,"團隊精神 (%t: %i min)", "SpiritDescriptionPanel", iTime/60 );
	}
	else if (iPerk == 3
		&& (g_iHelpHand_enable==1		&&	g_iL4D_GameMode==0
		|| g_iHelpHand_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iHelpHand_enable_vs==1		&&	g_iL4D_GameMode==2))
	{
		...
		if (g_iL4D_GameMode==2)
			...
			iBuff=g_iHelpHand_buff;
		if (g_iHelpHand_convar==1)
			Format(st_perk,128,"一臂之力 (%t +%i)", "HelpingHandDescriptionPanel2", iBuff);
		else
			Format(st_perk,128,"一臂之力 (%t +%i)", "HelpingHandDescriptionPanel", iBuff);
	}
	else if (iPerk == 4
		&& (g_iMA_enable==1		&&	g_iL4D_GameMode==0
		|| g_iMA_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iMA_enable_vs==1	&&	g_iL4D_GameMode==2))
	{
		if (g_iMA_maxpenalty < 6)
			Format(st_perk,128,"武林高手 (%t)", "MartialArtistDescriptionPanel");
		else
			Format(st_perk,128,"武林高手 (%t)", "MartialArtistDescriptionPanel_noreduc");
	}
	else
		Format(st_perk,128,"%t", "NotSet");
	...
	if (iPerk == 1
		...
		|| g_iPack_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iPack_enable_vs==1		&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"軍火走私 (%t +%i%%)", "PackRatDescriptionPanel", RoundToNearest(g_flPack_ammomult*100) );
	else if (iPerk == 2
		&& (g_iChem_enable==1		&&	g_iL4D_GameMode==0
		|| g_iChem_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iChem_enable_vs==1		&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"藥物上癮 (%t +%i)", "ChemReliantDescriptionPanel", g_iChem_buff);
	else if (iPerk == 3
		&& (g_iHard_enable==1			&&	g_iL4D_GameMode==0
		|| g_iHard_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iHard_enable_vs==1		&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"苟延殘喘 (+%i%% %t)", RoundToNearest(g_flHard_hpmult*100), "HardToKillDescriptionPanel" );
	else if (iPerk == 4
		&& (g_iExtreme_enable==1		&&	g_iL4D_GameMode==0
		|| g_iExtreme_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iExtreme_enable_vs==1	&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"逆境求生 (+%i%% %t)", RoundToNearest(g_flExtreme_rate*100-100), "MartialArtistDescriptionPanelCoop" );
	else if (iPerk == 5
		&& (g_iLittle_enable==1		&&	g_iL4D_GameMode==0
		|| g_iLittle_enable_sur==1	&&	g_iL4D_GameMode==1
		|| g_iLittle_enable_vs==1	&&	g_iL4D_GameMode==2))
		Format(st_perk,128,"聯盟打者 (%t)", "LittleLeaguerDescriptionPanel" );
	else
		Format(st_perk,128,"%t", "NotSet");

	if (g_iSur2_enable==1)
	{
		DrawPanelItem(menu,"倖存者，第三天賦:");
		DrawPanelText(menu,st_perk);
	}
...
public Handle:Menu_Sur1Perk (client)
{
	...
	else
	{
		...
		{
			case 1: st_current="(目前)";
			default: st_current="";
		}
		Format(st_display,64,"阻擋之力 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		switch (g_iSur1[client])
		{
			case 2: st_current="(目前)";
			default: st_current="";
		}
		Format(st_display,64,"致命雙擊 Tap %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		switch (g_iSur1[client])
		{
			case 3: st_current="(目前)";
			default: st_current="";
		}
		Format(st_display,64,"詭異手法 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		switch (g_iSur1[client])
		{
			case 4: st_current="(目前)";
			default: st_current="";
		}
		Format(st_display,64,"煙火專家 %s",st_current);
		DrawPanelItem(menu,st_display);
...
public Handle:Menu_Sur2Perk (client)
{
	...
	else
	{
		...
		Format(st_display,64,"堅不可摧 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"團隊精神 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"一臂之力 %s",st_current);
		DrawPanelItem(menu,st_display);
		...
		else
		{
			...
			Format(st_display,64,"武林高手 %s",st_current);
			DrawPanelItem(menu,st_display);
...
public Handle:Menu_Sur3Perk (client)
{
	...
	else
	{
		...
		Format(st_display,64,"軍火走私 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"藥物上癮 %s",st_current);
		DrawPanelItem(menu,st_display);
		if (g_iChem_buff > 0)
		{
	...
	else
	{
		...
		Format(st_display,64,"苟延殘喘 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"逆境求生 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"聯盟打者 %s",st_current);
		DrawPanelItem(menu,st_display);
...
public Handle:Menu_Inf1Perk (client)
{
	...
	else
	{
		...
		Format(st_display,64,"嘔吐發射 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"好狗運 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"噁心死神 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"動暈症 %s",st_current);
		DrawPanelItem(menu,st_display);
...
{
	new Handle:menu = CreatePanel();
	SetPanelTitle(menu, "tPoncho's 天賦系統 - Tank");
	decl String:st_display[MAXPLAYERS+1];
	decl String:st_current[10];
	...
	else
	{
		...
		Format(st_display,64,"腎上腺體 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"穩如泰山 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"加速代謝 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"狂暴怒吼 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		switch (g_iInf2[client])
		{
			case 5: st_current="(目前)";
			default: st_current="";
		}
		Format(st_display,64,"雙倍麻煩 %s",st_current);
		DrawPanelItem(menu,st_display);
...
public Handle:Menu_Inf3Perk (client)
{
	...
	else
	{
		...
		Format(st_display,64,"舌頭榨汁機 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"若即若離 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"哈一根啦! %s",st_current);
		DrawPanelItem(menu,st_display);
...
public Handle:Menu_Inf4Perk (client)
{
	...
	else
	{
		...
		Format(st_display,64,"泰山壓頂 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"專業殺手 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"嗜血蝗蟲 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"快感惡魔 %s",st_current);
		DrawPanelItem(menu,st_display);
...
public Handle:Menu_Inf5Perk (client)
{
	...
	else
	{
		...
		Format(st_display,64,"風行電掣 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"騎士血統 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"青蛙肢 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"飆風惡靈 %s",st_current);
		DrawPanelItem(menu,st_display);
...
public Handle:Menu_Inf6Perk (client)
{
	...
	else
	{
		...
		Format(st_display,64,"雙子鬼火 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"黏性配方 %s",st_current);
		DrawPanelItem(menu,st_display);
...
public Handle:Menu_Inf7Perk (client)
{
	...
	else
	{
		...
		Format(st_display,64,"猛牛襲擊 %s",st_current);
		DrawPanelItem(menu,st_display);
	...
	else
	{
		...
		Format(st_display,64,"子彈列車 %s",st_current);
		DrawPanelItem(menu,st_display);
