...
public Menu_Group(Handle:menu, MenuAction:action, param1, param2)
{
	...
	if (action == MenuAction_Select)
	{
		...
		if(StrEqual(info,"none"))
		{
			...
			{
				KvSetString(playermodelskv, "AnyTeam", "");
				KvSetString(playermodelskv, "AnyTeamGroup", "");
			}
...
public Menu_Model(Handle:menu, MenuAction:action, param1, param2)
{
	...
	if (action == MenuAction_Select)
	{
		...
		if (GetClientTeam(param1) == 0)
		{
			KvSetString(playermodelskv, "AnyTeam", info);
			KvSetString(playermodelskv, "AnyTeamGroup", group);
		}
		else if (GetClientTeam(param1) == 2)
		{
...
public Event_PlayerTeam(Handle:event, const String:name[], bool:dontBroadcast)
{
	if( GetConVarBool(g_autodisplay) )
	{
		...
		if((team == 0 || team == 2 || team == 3) && IsClientInGame(client))
...
public Event_PlayerSpawn(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	{
		KvGetString(playermodelskv, "AnyTeam", model, sizeof(model), "");
	}
