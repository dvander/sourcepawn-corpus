...
public PlayerSpawnEvent(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if (client > 0)
	{
		GetClientAbsOrigin(client, old_loc[client])
	}
}
...
public Action:Timer_Beam(Handle:timer, any:client)
{
	...
	if (team == 2)
		...
		TE_SetupBeamPoints(old_loc[client], new_loc[client], g_BeamSprite, g_HaloSprite, 0, 0, 10.0, 20.0, 10.0, 5, 0.0, NoColor, 30)
