...
// Yes/No mapvote for player limits doesn't set vote arrays.
// Make replies to all commands with no arguments
// Natives
...
//
//TEST:
//  Round Counter in arena mode for TF2
...
public OnPluginStart()
{
    ...
    /*cvar_nomination_tiered = CreateConVar(
    ...
    cvar_nomination_timelimits = CreateConVar(
...
public Native_InitiateNormalVote(Handle:plugin, numParams)
{
    ...
    {
        //Initialize the menu.
        new Handle:menu = CreateMenu(Handle_NormalVoteMenu);       //SET
