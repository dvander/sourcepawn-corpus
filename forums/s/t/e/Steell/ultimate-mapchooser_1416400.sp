...
/*
2.0.2 (2/15/11)
Fixed (another) obscure bug with Runoff Votes, this time preventing map from changing.
...
// Remove a client's nomination when they disconnect
// Make replies to all commands with no arguments
// Event_TFRestartRound should reset the round counter
//      -Also look at the events mapchooser hooks and see if they can be implemented
// Natives
//      -Replicated mapchoosers, and add special UMC ones
