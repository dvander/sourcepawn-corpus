...
RunTests()
{
    ...
    new Function:f1 = Func1;
    new Function:f1c = Func1;
    new Function:f2 = Func2;
    
    if (f1 == f1c)
        LogMessage("TEST: functions f1 and f1c are equal.");
    if (f1 != f2)
        LogMessage("Test: functions f1 and f2 are not equal.");
