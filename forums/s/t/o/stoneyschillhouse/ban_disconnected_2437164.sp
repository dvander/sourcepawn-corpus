...
public OnPluginStart() {
	CreateConVar("ban_disconnected_ver", PLUGIN_VERSION, "", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED);
...
DisplayBanTargetMenu(client) {
	...
	SetMenuTitle(menu, "Spieler Auswahl");
...
DisplayBanTimeMenu(client, const String:state_[]) {
	...
	SetMenuTitle(menu, "Ban Zeit Auswahl");
	SetMenuExitBackButton(menu, true);
	AddMenuItemWithState(menu, state_, "0", "Permanent");
	AddMenuItemWithState(menu, state_, "10", "10 Minuten");
	AddMenuItemWithState(menu, state_, "30", "30 Minuten");
	AddMenuItemWithState(menu, state_, "60", "1 Stunde");
	AddMenuItemWithState(menu, state_, "240", "4 Stunden");
	AddMenuItemWithState(menu, state_, "1440", "1 Tag");
	AddMenuItemWithState(menu, state_, "10080", "1 Woche");
	AddMenuItemWithState(menu, state_, "20160", "2 Wochen");
	AddMenuItemWithState(menu, state_, "30240", "3 Wochen");
	AddMenuItemWithState(menu, state_, "43200", "1 Monat");
	AddMenuItemWithState(menu, state_, "129600", "3 Monate");
	DisplayMenu(menu, client, MENU_TIME_FOREVER);
}
...
DisplayBanReasonMenu(client, const String:state_[]) {
	...
	SetMenuTitle(menu, "Ban Grund Auswahl");
	SetMenuExitBackButton(menu, true);
	AddMenuItemWithState(menu, state_, "KDR", "KDR missachtet / mit KDR gegangen");
	AddMenuItemWithState(menu, state_, "TA/TK", "TA/TK");
	AddMenuItemWithState(menu, state_, "Rassismus", "Rassismus");
	AddMenuItemWithState(menu, state_, "Admin disrepect", "Admin disrepect");
	AddMenuItemWithState(menu, state_, "Verstoss gegen die Serverregeln", "Verstoss gegen die Serverregeln");
