...
public OnPluginStart()
{
    ...
    // Create enable var
    RPGDrop_EnableCvar = CreateConVar("l4d_rpg_enable",                    "1",  "RPG dropping - Enables or disables it",                     FCVAR_PLUGIN);
    ...
    switch(Reward) 
    {
        case 0: { 
			...
			for (new i = 1; i <= MaxClients; i++)
			{
				...
				if (GetClientTeam(i) == 2)
				{
					PrintHintText(i,"Grab 1 rifle, a gift from a killed special infected.");
				}
			} //end for Schleife++
                }
                case 2: {
			...
			for (new i = 1; i <= MaxClients; i++)
			{
				...
				if (GetClientTeam(i) == 2)
				{
					PrintHintText(i,"Grab 1 Hunting Rifle, a gift from a killed special infected.");
				}
			} //end for Schleife++
                }
            }
		...
		for (new i = 1; i <= MaxClients; i++)
			{
				...
				if (GetClientTeam(i) == 2)
				{
					PrintHintText(i,"Grab 1 FIRST-AID Kit, a gift from a killed special infected.");
				}
			} //end for Schleife++
        }
        case 2: {
		...
		for (new i = 1; i <= MaxClients; i++)
			{
				...
				if (GetClientTeam(i) == 2)
				{
					PrintHintText(i,"Grab 1 PILLS, a gift from a killed special infected.");
				}
			} //end for Schleife++
        }
        case 3: {
		...
		for (new i = 1; i <= MaxClients; i++)
			{
				...
				if (GetClientTeam(i) == 2)
				{
					PrintHintText(i,"Grab 1 Molotov, a gift from a killed special infected.");
				}
			} //end for Schleife++
		...
		for (new i = 1; i <= MaxClients; i++)
			{
				...
				if (GetClientTeam(i) == 2)
				{
					PrintHintText(i,"Grab 1 Pipe Bomb, a gift from a killed special infected.");
				}
			} //end for Schleife++
        }
    }
