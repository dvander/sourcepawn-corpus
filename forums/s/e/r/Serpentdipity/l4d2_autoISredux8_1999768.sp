...
public OnPluginStart()
{
	...
	hSILimit = CreateConVar("l4d2_ais_limit", "8", "The max amount of special infected at once", FCVAR_PLUGIN, true, 1.0, true, float(MAX_INFECTED));
	...
	//hSpawnTimeFunction = CreateConVar("l4d2_ais_time_function", "2", "The spawn time function [0=LINEAR|1=EXPONENTIAL|2=LOGARITHMIC]", FCVAR_PLUGIN, true, 0.0, true 2.0);
	hSpawnTimeMin = CreateConVar("l4d2_ais_time_min", "3.0", "The minimum auto spawn time (seconds) for infected", FCVAR_PLUGIN, true, 0.0);
	hSpawnTimeMax = CreateConVar("l4d2_ais_time_max", "5.0", "The maximum auto spawn time (seconds) for infected", FCVAR_PLUGIN, true, 1.0);
...
SetCvars()
{
	if (Enabled)
	{
		...
		SetConVarInt(FindConVar("z_boomer_limit"), 8);
		SetConVarInt(FindConVar("z_hunter_limit"), 8);
		SetConVarInt(FindConVar("z_smoker_limit"), 8);
		SetConVarInt(FindConVar("z_charger_limit"), 8);
		SetConVarInt(FindConVar("z_spitter_limit"), 8);
		SetConVarInt(FindConVar("z_jockey_limit"), 8);
		SetConVarInt(FindConVar("survival_max_boomers"), 8);
		SetConVarInt(FindConVar("survival_max_hunters"), 8);
		SetConVarInt(FindConVar("survival_max_smokers"), 8);
		SetConVarInt(FindConVar("survival_max_chargers"), 8);
		SetConVarInt(FindConVar("survival_max_spitters"), 8);
		SetConVarInt(FindConVar("survival_max_jockeys"), 8);	
		SetConVarInt(FindConVar("survival_max_specials"), 8);
		SetBossesCvar();
