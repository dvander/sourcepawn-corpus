...
public OnPluginStart()
{
	...
	//Base Intervals
	ASDCSIinterval = CreateConVar("ASDCSIinterval","2", "How many ticks(unmodified seconds) till another SI spawns", FCVAR_PLUGIN, true, 0.0);
	...
	ASDCWitchinterval = CreateConVar("ASDCwitchinterval","45", "How many ticks(unmodified seconds) till another witch spawns", FCVAR_PLUGIN, true, 0.0);
	...
	ASDCmob = CreateConVar("ASDCmob", "9", "Number of CI per person in a Mega CI zombie wave.", FCVAR_PLUGIN, true, 0.0);
