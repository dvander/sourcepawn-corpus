...
{
	Format(web, sizeof(web), "http://95.141.35.112/mirrors/websc/webshortcuts2.php?web=%s;franug_is_pro;%s", title,web);
}

stock FixMotdCSGO_fullsize(String:web[512])
{
	Format(web, sizeof(web), "http://95.141.35.112/mirrors/websc/webshortcuts_f.html?web=%s", web);
}
