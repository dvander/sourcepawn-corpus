...
public void OnPluginStart() 
{
	...
	//Client commands
	RegConsoleCmd("sm_dadawarden", Command_BecomeWarden, "Allows the player taking the charge over prisoners");
	RegConsoleCmd("sm_dadaunwarden", Command_ExitWarden, "Allows the player to retire from the position");
	RegConsoleCmd("sm_dadavetowarden", Command_VoteWarden, "Allows the player to vote to retire Warden");
	...
	gc_bPlugin = AutoExecConfig_CreateConVar("sm_warden_enable", "0", "0 - disabled, 1 - enable this MyJailbreak SourceMod plugin", _, true,  0.0, true, 1.0);
