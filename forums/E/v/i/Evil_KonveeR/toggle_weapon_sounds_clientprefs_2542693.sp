...
#define PLUGIN_VERSION 	"1.0.3 fix m_iWeaponID"
...
PrepareMenu(client)
{
	...
	SetMenuTitle(menu, "Звуки выстрелов -> ");
	...
	switch(action)
	{
		...
		case MenuAction_Select:
		{
			...
			if( GetMenuItem(menu, param2, info, sizeof(info)) )
			{
				...
				CGOPrintToChat(param1, "{GREEN}[{BLUE}WeaponS{GREEN}] {OLIVE}Звуки выстрелов {RED}%s.", g_bStopSound[param1] ? "Выкл" : "Вкл");
				CheckHooks();
				PrepareMenu(param1);
			}
		}
