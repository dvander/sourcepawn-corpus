...
#define MSGTAG "{orange}[{lightgreen}PS{orange}]\x01"
...
new g_SendTarget[MAXPLAYERS+1] = {-1, ...};
...
void initPluginSettings(){
	...
	PluginSettings[hVersion] = CreateConVar("em_points_sys_version", PLUGIN_VERSION, "Version of Points System on this server.", 0|FCVAR_NOTIFY|FCVAR_DONTRECORD|FCVAR_REPLICATED);
	PluginSettings[hStartPoints] = CreateConVar("l4d2_points_start", "10", "Points to start each round/map with.", 0);
	PluginSettings[hNotifications] = CreateConVar("l4d2_points_notify", "1", "Show messages when points are earned?", 0);
	PluginSettings[hEnabled] = CreateConVar("l4d2_points_enable", "1", "Enable Point System?", 0);
	PluginSettings[hModes] = CreateConVar("l4d2_points_modes", "coop,realism,versus,teamversus", "Which game modes to use Point System", 0);
	PluginSettings[hResetPoints] = CreateConVar("l4d2_points_reset_mapchange", "versus", "Which game modes to reset point count on round end and round start", 0);
	PluginSettings[hTankLimit] = CreateConVar("l4d2_points_tank_limit", "2", "How many tanks to be allowed spawned per team", 0);
	PluginSettings[hWitchLimit] = CreateConVar("l4d2_points_witch_limit", "3", "How many witchs' to be allwed spawned per team", 0);
	PluginSettings[hSpawnAttempts] = CreateConVar("l4d2_points_spawn_tries", "2", "How many times to attempt respawning when buying an special infected", 0);
	PluginSettings[hKillSpreeNum] = CreateConVar("l4d2_points_cikills", "25", "How many kills you need to earn a killing spree bounty", 0);
	PluginSettings[hHeadShotNum] = CreateConVar("l4d2_points_headshots", "20", "How many kills you need to earn a head hunter bonus", 0);
	return;
}
...
enum item_costs{
	...
	Handle:CostRespawn,
	Handle:CostExtinguisher,
}
new ItemCosts[item_costs];

void initItemCosts(){
	ItemCosts[CostPistol] = CreateConVar("l4d2_points_pistol", "1", "How many points the pistol costs", 0);
	ItemCosts[CostMagnum] = CreateConVar("l4d2_points_magnum", "2", "How many points the magnum costs", 0);
	ItemCosts[CostSMG] = CreateConVar("l4d2_points_smg", "5", "How many points the smg costs", 0);
	ItemCosts[CostSilencedSMG] = CreateConVar("l4d2_points_ssmg", "7", "How many points the silenced smg costs", 0);
	ItemCosts[CostMP5] = CreateConVar("l4d2_points_mp5", "10", "How many points the mp5 costs", 0);
	ItemCosts[CostM16] = CreateConVar("l4d2_points_m16", "12", "How many points the m16 costs", 0);
	ItemCosts[CostAK47] = CreateConVar("l4d2_points_ak", "12", "How many points the ak47 costs", 0);
	ItemCosts[CostSCAR] = CreateConVar("l4d2_points_scar", "12", "How many points the scar costs", 0);
	ItemCosts[CostSG552] = CreateConVar("l4d2_points_sg", "12", "How many points the sg552 costs", 0);
	ItemCosts[CostMilitary] = CreateConVar("l4d2_points_military_sniper", "14", "How many points the military sniper costs", 0);
	ItemCosts[CostAWP] = CreateConVar("l4d2_points_awp", "40", "How many points the awp costs", 0);
	ItemCosts[CostScout] = CreateConVar("l4d2_points_scout", "20", "How many points the scout sniper costs", 0);
	ItemCosts[CostHunting] = CreateConVar("l4d2_points_hunting_rifle", "10", "How many points the hunting rifle costs", 0);
	ItemCosts[CostAuto] = CreateConVar("l4d2_points_autoshotgun", "10", "How many points the autoshotgun costs", 0);
	ItemCosts[CostSPAS] = CreateConVar("l4d2_points_spas", "10", "How many points the spas shotgun costs", 0);
	ItemCosts[CostChrome] = CreateConVar("l4d2_points_chrome", "7", "How many points the chrome shotgun costs", 0);
	ItemCosts[CostPump] = CreateConVar("l4d2_points_pump", "7", "How many points the pump shotgun costs", 0);
	ItemCosts[CostLauncher] = CreateConVar("l4d2_points_grenade", "50", "How many points the grenade launcher costs", 0);
	ItemCosts[CostM60] = CreateConVar("l4d2_points_m60", "50", "How many points the m60 costs", 0);
	ItemCosts[CostGasCan] = CreateConVar("l4d2_points_gascan", "50", "How many points the gas can costs", 0);
	ItemCosts[CostOxygen] = CreateConVar("l4d2_points_oxygen", "10", "How many points the oxgen tank costs", 0);
	ItemCosts[CostPropane] = CreateConVar("l4d2_points_propane", "10", "How many points the propane tank costs", 0);
	ItemCosts[CostGnome] = CreateConVar("l4d2_points_gnome", "16", "How many points the gnome costs", 0);
	ItemCosts[CostCola] = CreateConVar("l4d2_points_cola", "80", "How many points cola bottles costs", 0);
	ItemCosts[CostFireworks] = CreateConVar("l4d2_points_fireworks", "10", "How many points the fireworks crate costs", 0);
	ItemCosts[CostBat] = CreateConVar("l4d2_points_bat", "4", "How many points the baseball bat costs", 0);
	ItemCosts[CostMachete] = CreateConVar("l4d2_points_machete", "10", "How many points the machete costs", 0);
	ItemCosts[CostKatana] = CreateConVar("l4d2_points_katana", "10", "How many points the katana costs", 0);
	ItemCosts[CostKnife] = CreateConVar("l4d2_points_knife", "25", "How many points the knife costs", 0);
	ItemCosts[CostShield] = CreateConVar("l4d2_points_shield", "6", "How many points the shield costs", 0);
	ItemCosts[CostTonfa] = CreateConVar("l4d2_points_tonfa", "4", "How many points the tonfa costs", 0);
	ItemCosts[CostFireAxe] = CreateConVar("l4d2_points_fireaxe", "10", "How many points the fireaxe costs", 0);
	ItemCosts[CostGuitar] = CreateConVar("l4d2_points_guitar", "4", "How many points the guitar costs", 0);
	ItemCosts[CostPan] = CreateConVar("l4d2_points_pan", "4", "How many points the frying pan costs", 0);
	ItemCosts[CostCricketBat] = CreateConVar("l4d2_points_cricketbat", "4", "How many points the cricket bat costs", 0);
	ItemCosts[CostCrowBar] = CreateConVar("l4d2_points_crowbar", "4", "How many points the crowbar costs", 0);
	ItemCosts[CostClub] = CreateConVar("l4d2_points_golfclub", "6", "How many points the golf club costs", 0);
	ItemCosts[CostChainSaw] = CreateConVar("l4d2_points_chainsaw", "10", "How many points the chainsaw costs", 0);
	ItemCosts[CostPipe] = CreateConVar("l4d2_points_pipe", "8", "How many points the pipe bomb costs", 0);
	ItemCosts[CostMolotov] = CreateConVar("l4d2_points_molotov", "10", "How many points the molotov costs", 0);
	ItemCosts[CostBile] = CreateConVar("l4d2_points_bile", "8", "How many points the bile jar costs", 0);
	ItemCosts[CostHealthKit] = CreateConVar("l4d2_points_kit", "15", "How many points the health kit costs", 0);
	ItemCosts[CostDefib] = CreateConVar("l4d2_points_defib", "20", "How many points the defib costs", 0);
	ItemCosts[CostAdren] = CreateConVar("l4d2_points_adrenaline", "8", "How many points the adrenaline costs", 0);
	ItemCosts[CostPills] = CreateConVar("l4d2_points_pills", "8", "How many points the pills costs", 0);
	ItemCosts[CostExplosiveAmmo] = CreateConVar("l4d2_points_explosive_ammo", "30", "How many points the explosive ammo costs", 0);
	ItemCosts[CostFireAmmo] = CreateConVar("l4d2_points_incendiary_ammo", "10", "How many points the incendiary ammo costs", 0);
	ItemCosts[CostExplosivePack] = CreateConVar("l4d2_points_explosive_ammo_pack", "45", "How many points the explosive ammo pack costs", 0);
	ItemCosts[CostFirePack] = CreateConVar("l4d2_points_incendiary_ammo_pack", "15", "How many points the incendiary ammo pack costs", 0);
	ItemCosts[CostLaserSight] = CreateConVar("l4d2_points_laser", "1", "How many points the laser sight costs", 0);
	ItemCosts[CostHeal] = CreateConVar("l4d2_points_survivor_heal", "25", "How many points a complete heal costs", 0);
	ItemCosts[CostAmmo] = CreateConVar("l4d2_points_refill", "8", "How many points an ammo refill costs", 0);

	ItemCosts[CostSuicide] = CreateConVar("l4d2_points_suicide", "10", "How many points does suicide cost", 0);
	ItemCosts[CostHunter] = CreateConVar("l4d2_points_hunter", "15", "How many points does a hunter cost", 0);
	ItemCosts[CostJockey] = CreateConVar("l4d2_points_jockey", "6", "How many points does a jockey cost", 0);
	ItemCosts[CostSmoker] = CreateConVar("l4d2_points_smoker", "6", "How many points does a smoker cost", 0);
	ItemCosts[CostCharger] = CreateConVar("l4d2_points_charger", "15", "How many points does a charger cost", 0);
	ItemCosts[CostBoomer] = CreateConVar("l4d2_points_boomer", "5", "How many points does a boomer cost", 0);
	ItemCosts[CostSpitter] = CreateConVar("l4d2_points_spitter", "6", "How many points does a spitter cost", 0);
	ItemCosts[CostInfectedHeal] = CreateConVar("l4d2_points_infected_heal", "6", "How many points does healing yourself as an infected cost", 0);
	ItemCosts[CostWitch] = CreateConVar("l4d2_points_witch", "35", "How many points does a witch cost", 0);
	ItemCosts[CostTank] = CreateConVar("l4d2_points_tank", "70", "How many points does a tank cost", 0);
	ItemCosts[CostTankHealMultiplier] = CreateConVar("l4d2_points_tank_heal_mult", "3", "How much l4d2_points_infected_heal should be multiplied for tank players", 0);
	ItemCosts[CostHorde] = CreateConVar("l4d2_points_horde", "15", "How many points does a horde cost", 0);
	ItemCosts[CostMob] = CreateConVar("l4d2_points_mob", "10", "How many points does a mob cost", 0);
	ItemCosts[CostUncommonMob] = CreateConVar("l4d2_points_umob", "12", "How many points does an uncommon mob cost", 0);
	
	ItemCosts[CostRespawn] = CreateConVar("l4d2_points_respawn", "25", "How many points does an respawn cost", 0);
	ItemCosts[CostExtinguisher] = CreateConVar("l4d2_points_extinguisher", "10", "How many points does an extinguisher cost", 0);
	return;
}
...
void initCategoriesEnabled(){
	CategoriesEnabled[CategoryRifles] = CreateConVar("l4d2_points_cat_rifles", "1", "Enable rifles catergory", 0);
	CategoriesEnabled[CategorySMG] = CreateConVar("l4d2_points_cat_smg", "1", "Enable smg catergory", 0);
	CategoriesEnabled[CategorySnipers] = CreateConVar("l4d2_points_cat_snipers", "1", "Enable snipers catergory", 0);
	CategoriesEnabled[CategoryShotguns] = CreateConVar("l4d2_points_cat_shotguns", "1", "Enable shotguns catergory", 0);
	CategoriesEnabled[CategoryHealth] = CreateConVar("l4d2_points_cat_health", "1", "Enable health catergory", 0);
	CategoriesEnabled[CategorySpecial] = CreateConVar("l4d2_points_cat_special", "1", "Enable special catergory", 0);
	CategoriesEnabled[CategoryUpgrades] = CreateConVar("l4d2_points_cat_upgrades", "1", "Enable upgrades catergory", 0);
	CategoriesEnabled[CategoryThrowables] = CreateConVar("l4d2_points_cat_throwables", "1", "Enable throwables catergory", 0);
	CategoriesEnabled[CategoryMisc] = CreateConVar("l4d2_points_cat_misc", "1", "Enable misc catergory", 0);
	CategoriesEnabled[CategoryMelee] = CreateConVar("l4d2_points_cat_melee", "1", "Enable melee catergory", 0);
	CategoriesEnabled[CategoryWeapons] = CreateConVar("l4d2_points_cat_weapons", "1", "Enable weapons catergory", 0);
	return;
}
...
void initPointRewards(){
	PointRewards[SurvRewardKillSpree] = CreateConVar("l4d2_points_cikill_value", "2", "How many points does killing a certain amount of infected earn", 0);
	PointRewards[SurvRewardHeadShots] = CreateConVar("l4d2_points_headshots_value", "4", "How many points does killing a certain amount of infected with headshots earn", 0);
	PointRewards[SurvKillInfec] = CreateConVar("l4d2_points_sikill", "1", "How many points does killing a special infected earn", 0);
	PointRewards[SurvKillTank] = CreateConVar("l4d2_points_tankkill", "2", "How many points does killing a tank earn", 0);
	PointRewards[SurvKillWitch] = CreateConVar("l4d2_points_witchkill", "4", "How many points does killing a witch earn", 0);
	PointRewards[SurvCrownWitch] = CreateConVar("l4d2_points_witchcrown", "10", "How many points does crowning a witch earn", 0);
	PointRewards[SurvTeamHeal] = CreateConVar("l4d2_points_heal", "5", "How many points does healing a team mate earn", 0);
	PointRewards[SurvTeamHealFarm] = CreateConVar("l4d2_points_heal_warning", "1", "How many points does healing a team mate who did not need healing earn", 0);
	PointRewards[SurvTeamProtect] = CreateConVar("l4d2_points_protect", "1", "How many points does protecting a team mate earn", 0);
	PointRewards[SurvTeamRevive] = CreateConVar("l4d2_points_revive", "3", "How many points does reviving a team mate earn", 0);
	PointRewards[SurvTeamLedge] = CreateConVar("l4d2_points_ledge", "1", "How many points does reviving a hanging team mate earn", 0);
	PointRewards[SurvTeamDefib] = CreateConVar("l4d2_points_defib_action", "5", "How many points does defibbing a team mate earn", 0);
	PointRewards[SurvBurnTank] = CreateConVar("l4d2_points_tankburn", "2", "How many points does burning a tank earn", 0);
	PointRewards[SurvTankSolo] = CreateConVar("l4d2_points_tanksolo", "8", "How many points does killing a tank single-handedly earn", 0);
	PointRewards[SurvBurnWitch] = CreateConVar("l4d2_points_witchburn", "1", "How many points does burning a witch earn", 0);
	PointRewards[SurvBileTank] = CreateConVar("l4d2_points_bile_tank", "2", "How many points does biling a tank earn", 0);
	PointRewards[InfecChokeSurv] = CreateConVar("l4d2_points_smoke", "2", "How many points does smoking a survivor earn", 0);
	PointRewards[InfecPounceSurv] = CreateConVar("l4d2_points_pounce", "1", "How many points does pouncing a survivor earn", 0);
	PointRewards[InfecChargeSurv] = CreateConVar("l4d2_points_charge", "1", "How many points does charging a survivor earn", 0);
	PointRewards[InfecImpactSurv] = CreateConVar("l4d2_points_impact", "1", "How many points does impacting a survivor earn", 0);
	PointRewards[InfecRideSurv] = CreateConVar("l4d2_points_ride", "2", "How many points does riding a survivor earn", 0);
	PointRewards[InfecBoomSurv] = CreateConVar("l4d2_points_boom", "1", "How many points does booming a survivor earn", 0);
	PointRewards[InfecIncapSurv] = CreateConVar("l4d2_points_incap", "3", "How many points does incapping a survivor earn", 0);
	PointRewards[InfecHurtSurv] = CreateConVar("l4d2_points_damage", "2", "How many points does doing damage earn", 0);
	PointRewards[InfecKillSurv] = CreateConVar("l4d2_points_kill", "5", "How many points does killing a survivor earn", 0);
	return;
}
...
void registerAdminCommands(){
	RegAdminCmd("sm_listmodules", ListModules, ADMFLAG_ROOT, "List modules currently loaded to Points System");
	RegAdminCmd("sm_listmelee", ListMelee, ADMFLAG_ROOT, "List melee weapons available on this map");
	RegAdminCmd("sm_heal", Command_Heal, ADMFLAG_ROOT, "sm_heal <target>");
	RegAdminCmd("sm_respawnbuy", Command_RespawnBuy, ADMFLAG_ROOT, "respawn you");
...
void registerConsoleCommands(){
	...
	RegConsoleCmd("sm_send", Command_SendPoints, "sm_send");
	return;
}
...
public void OnPluginStart(){
	...
	AutoExecConfig(true, "l4d2_points_system_respawn_extinguisher");
...
void addPoints(int iClientIndex, int iPoints, const char[] sMessage){
	if(!IsClientBot(iClientIndex)){
		...
		if(GetConVarBool(PluginSettings[hNotifications])){
			CPrintToChat(iClientIndex, "%s %T", MSGTAG, sMessage, iClientIndex, iPoints);
			return;
		}
	}
	return;
...
public Action ListMelee(int iClientIndex, int iNumArguments){
	if(iNumArguments == 0){
		for(int iCount = 0; iCount < MAX_MELEE_LENGTH; iCount++)
			if(strlen(validmelee[iCount]) > 0) CReplyToCommand(iClientIndex, validmelee[iCount]);
	}
	return;
}
...
public Action ListModules(int iClientIndex, int iNumArguments){
	if(iNumArguments == 0){
		CReplyToCommand(iClientIndex, "%s %T", MSGTAG, "Modules", iClientIndex);
		...
		for(int iModule = 0; iModule < iNumModules; iModule++){
			...
			if(strlen(sModuleName) > 0)
				CReplyToCommand(iClientIndex, sModuleName);
		}
	}
...
public Action ShowPoints(int iClientIndex, int iNumArguments){
	if(IsModEnabled() && iNumArguments == 0){
		if(IsClientPlaying(iClientIndex))
			CReplyToCommand(iClientIndex, "%s %T", MSGTAG, "Your Points", iClientIndex, PlayerData[iClientIndex][iPlayerPoints]);
			ShowPointsMenu(iClientIndex);
	}
	return Plugin_Handled;
}
...
bool IsItemEnabled(int iClientIndex, int iCost){
	if(iClientIndex > 0){
		if(iCost >= 0)
			...
			CReplyToCommand(iClientIndex, "%s %T", MSGTAG, "Item Disabled", iClientIndex);
			return false;
		}
	}
	return false;
...
bool HasEnoughPoints(int iClientIndex, int iCost){
	if(iClientIndex > 0){
		if(PlayerData[iClientIndex][iPlayerPoints] >= iCost)
			...
			CReplyToCommand(iClientIndex, "%s %T", MSGTAG, "Insufficient Funds", iClientIndex);
			return false;
		}
	}
	return false;
...
void extinguishEntity(int iClientIndex, int iCost){
	if(iClientIndex > 0 && !IsClientBot(iClientIndex)){
		if(IsClientInfected(iClientIndex)){
			ExtinguishEntity(iClientIndex);
			removePoints(iClientIndex, iCost);
		}
	}
	return;
...
public Action Command_Heal(client, args)
{
	...
	{
		CReplyToCommand(client, "%s%T", MSGTAG, "Usage sm_heal", client);
		return Plugin_Handled;
	}
}
...
public Action Command_Points(client, args)
{
	...
	{
		CReplyToCommand(client, "%s %T", MSGTAG, "Usage sm_givepoints", client);
		return Plugin_Handled;
	}
}

public Action:Command_SendPoints(client, args)
{
	if (client > 0 || GetClientTeam(client) > 1)
	{
		BuildSendMenu(client);
	}
}

public TeamPanelHandler(Handle:menu, MenuAction:action, param1, param2){return;}

BuildSendMenu(client)
{
	new Handle:menu = CreateMenu(MenuHandler_Send);
	decl String:title[40];
	new String:name[MAX_NAME_LENGTH];
	new String:uid[12];
	new String:menuItem[32];
	if (GetClientTeam(client)==2 )
	{
		for(new i=1;i<=MaxClients;i++)
		{
			if (IsClientInGame(i) && i!=client && GetClientTeam(i)==2 && IsPlayerAlive(i) && !IsFakeClient(i))
			{			
	...
	if (GetClientTeam(client)==3 )
	{
		for(new i=1;i<=MaxClients;i++)
		{
			if (IsClientInGame(i) && i!=client && GetClientTeam(i)==3 && !IsFakeClient(i))
			{			
				Format(uid,sizeof(uid),"%i",GetClientUserId(i));
				if (GetClientName(i,name,sizeof(name)))
				{
	...
	Format(title, sizeof(title), "%d Puntos", PlayerData[client][iPlayerPoints]);
...
BuildInfected(client)
{
    decl String:title[40], String:boomer[40], String:spitter[40], String:smoker[40], String:hunter[40], String:charger[40], String:jockey[40], String:tank[40], String:extinguisher[40], String:witch[40], String:witch_bride[40], String:heal[40], String:suicide[40], String:horde[40], String:mob[40], String:umob[40];
	new Handle:menu = CreateMenu(BuyInfectedMenu);
	if(GetConVarInt(ItemCosts[CostInfectedHeal]) > -1)
	{
		Format(heal, sizeof(heal), "%T", "Heal", client);
		AddMenuItem(menu, "heal", heal);
	}
	if(GetConVarInt(ItemCosts[CostExtinguisher]) > -1)
	{
		Format(extinguisher, sizeof(extinguisher), "%T", "Extinguisher", client);
		AddMenuItem(menu, "extinguisher", extinguisher);
	}
...
{
	new Handle:TeamPanel = CreatePanel(GetMenuStyleHandle(MenuStyle_Default));
	new String:name[MAX_NAME_LENGTH];
	new String:menuItem[32];
	if (GetClientTeam(client)==2 )
	{
		for(new i=1;i<=MaxClients;i++)
		{
			...
			{				
				if (GetClientName(i,name,sizeof(name)))
				{
					Format(menuItem,sizeof(menuItem),"%i ➥ %s", PlayerData[i][iPlayerPoints], name );
					DrawPanelText(TeamPanel, menuItem);
				}
			}		
		}
	}
	...
	if (GetClientMenu(client) == MenuSource_RawPanel || GetClientMenu(client) == MenuSource_None)
	{	
...
public Action Command_SPoints(client, args)
{
	...
	{
		CReplyToCommand(client, "%s %T", MSGTAG, "Usage sm_setpoints", client, MSGTAG);
		return Plugin_Handled;
	}
}
...
BuildBuyMenu(client)
{
	if(GetClientTeam(client) == 2)
	{
		...
		if(GetConVarInt(CategoriesEnabled[CategorySpecial]) == 1)
		{
			Format(localizedText, sizeof(localizedText), "%T", "Special", client);
			AddMenuItem(menu, "g_SpecialMenu", localizedText);
		}
	...
	{
	    char localizedText[40], title[40];
		new Handle:menu = CreateMenu(InfectedMenu);
		
		Format(localizedText, sizeof(localizedText), "%T", "Infected", client);
		AddMenuItem(menu, "g_Infected", localizedText);
			
		Format(localizedText, sizeof(localizedText), "%T", "ShowPoints", client);
		AddMenuItem(menu, "g_Show", localizedText);
		
		Format(localizedText, sizeof(localizedText), "%T", "SendPoints", client);
		AddMenuItem(menu, "g_Send", localizedText);
...
public TopMenu(Handle:menu, MenuAction:action, param1, param2)
{
	switch(action)
	{
		...
		case MenuAction_Select:
		{
			...
			else if(StrEqual(menu1, "g_SpecialMenu"))
			{
...
public MenuHandler_Send(Handle:menu, MenuAction:action, param1, param2)
{
	switch(action)
	{
		case MenuAction_End:
		...
		case MenuAction_Select:
		{
			...
			if (!found)
			{
				PrintToChat(param1, "%s Error, seleccion no encontrado!", MSGTAG );
				
				BuildSendMenu(param1);
				return;
			}
			g_SendTarget[param1] = GetClientOfUserId(StringToInt(info));

			if (g_SendTarget[param1] == 0)
			{
				PrintToChat(param1, "%s Jugador no disponible", MSGTAG);
				
				BuildSendMenu(param1);
				return;
			}
			DisplayConfirmMenuSend(param1);
		}	
	}
}
...
DisplayConfirmMenuSend(param1)
{
	decl String:title[40], String:pnts1[40], String:pnts5[40], String:pnts10[40], String:pnts15[40], String:pntsall[40];
	new Handle:menu = CreateMenu(MenuHandler_SendPoints);
	
	AddMenuItem(menu, "1", pnts1);
	AddMenuItem(menu, "5", pnts5);
	AddMenuItem(menu, "10", pnts10);
	AddMenuItem(menu, "15", pnts15);
	AddMenuItem(menu, "", pntsall);
	
	Format(title, sizeof(title), "%d Puntos", PlayerData[param1][iPlayerPoints]);
...
public MenuHandler_SendPoints(Handle:menu, MenuAction:action, param1, param2)
{
	switch(action)
	{
		case MenuAction_End:
		...
		case MenuAction_Select:
		{
		    decl String:item1[56];
			GetMenuItem(menu, param2, item1, sizeof(item1));
			new target = g_SendTarget[param1];
			
			int PlayerPoints = PlayerData[param1][iPlayerPoints];
			
			new amount = StringToInt(item1);
			if ( PlayerData[param1][iPlayerPoints] < amount ) 
			{
				PrintToChat(param1, "%s No tienes suficientes puntos!", MSGTAG);
			}
			else if ( PlayerData[param1][iPlayerPoints] == 0 ) 
			{
				PrintToChat(param1, "%s No tienes suficientes puntos!", MSGTAG);
			}
			...
			switch (param2)
			{
				case 0,1,2,3: 
				{
					addPoints(target, amount, "Received");
					removePoints(param1, amount);
				}
				case 4: 
				{
					addPoints(target, PlayerPoints, "Received");
					removePoints(param1, PlayerPoints);
				}
			}
			...
			if (GetClientTeam(param1) == 2)
			{
				for (new i=1; i<=MaxClients; i++)
				{
					if (IsClientInGame(i))
					{
						...
						{
							if (!IsFakeClient(i)) //CPrintToChat(i, "%s", buffer );
							{
								CPrintToChat(i, "%s {olive}%N {default}envia {green}%i {default}puntos a {olive}%N{green}. L{lightgreen}e Quedan {green}(%i) {lightgreen}pts.", MSGTAG , param1, amount, target, PlayerData[param1][iPlayerPoints] );
							}
						}
					}
				}
				...
				for (new i=1; i<=MaxClients; i++)
				{
					if (IsClientInGame(i))
					{
						if (GetClientTeam(i) == 3)
						{
							if (!IsFakeClient(i)) //CPrintToChat(i, "%s", buffer );
							{
								CPrintToChat(i, "%s %N envia %i puntos a %N. Le Quedan (%i) pts.", MSGTAG , param1, amount, target, PlayerData[param1][iPlayerPoints] );
							}
						}
					}
				}
...
{
	decl String:title[40];
	decl String:respawn[40];
	new Handle:menu = CreateMenu(MenuHandler_Special);
	if(GetConVarInt(ItemCosts[CostRespawn]) > -1)
	{
		Format(respawn, sizeof(respawn), "%T", "Respawn", client);
...
public MenuHandler_Special(Handle:menu, MenuAction:action, param1, param2)
{
	switch(action)
	{
		case MenuAction_End:
		...
		case MenuAction_Select:
		{
			new String:item1[56];
			GetMenuItem(menu, param2, item1, sizeof(item1));
			if(StrEqual(item1, "respawn", false))
			{
				strcopy(PlayerData[param1][sItemName], 64, "sm_respawnbuy");
				PlayerData[param1][iItemCost] = GetConVarInt(ItemCosts[CostRespawn]);
			}
			DisplayConfirmMenuSpecial(param1);
		}
	}
}
...
public InfectedMenu(Handle:hMenu, MenuAction:action, iClientIndex, iPosition)
{
	...
	case MenuAction_Select:
		{
			new String:menu1[56];
			GetMenuItem(hMenu, iPosition, menu1, sizeof(menu1));
			if(StrEqual(menu1, "g_Infected"))
			{
				BuildInfected(iClientIndex);
			}
			else if(StrEqual(menu1, "g_HealthMenu"))
			{
				ShowPointsMenu(iClientIndex);
			...
			{
				BuildSendMenu(iClientIndex);
			}
			else {
				// Menu extension
				Action result;	// We dont care about the result
				Call_StartForward(Forward_BuyMenuSelect);
				Call_PushCell(iClientIndex);	// Client ID
				Call_PushCell(hMenu);	// The menu handle
				Call_PushCell(iPosition);	// Item Index
				Call_Finish(result);
			}
		}
	}
...
public BuyInfectedMenu(Handle:hMenu, MenuAction:action, iClientIndex, iPosition)
{
	switch(action)
	{
	case MenuAction_End:
	...
	case MenuAction_Select:
		{
			...
			else if (StrEqual(sItem, "extinguisher", false))
			{
				strcopy(PlayerData[iClientIndex][sItemName], 64, "extinguisher");
				PlayerData[iClientIndex][iItemCost] = GetConVarInt(ItemCosts[CostExtinguisher]);
			}
...
{
	decl String:yes[40], String:no[40], String:title[40];
	new Handle:menu = CreateMenu(MenuHandler_ConfirmSpecial);
	Format(yes, sizeof(yes),"%T", "Yes", param1);
	AddMenuItem(menu, "yes", yes);
	Format(no, sizeof(no),"%T", "No", param1);
	AddMenuItem(menu, "no", no);
...
public MenuHandler_ConfirmSpecial(Handle:menu, MenuAction:action, param1, param2)
{
	switch(action)
	{
		case MenuAction_End:
...
public reloadAmmo(int iClientIndex, int iCost, const String:sItem[]){
	...
	if(IsCarryingWeapon(iClientIndex)){
		...
		CPrintToChat(iClientIndex, "%s %T", MSGTAG, "Primary Warning", iClientIndex);
	return;
}
	...
	switch(action)
	{
		...
		case MenuAction_Select:
		{
			...
			else if(StrEqual(choice, "yes", false))
			{
				...
				if(StrEqual(PlayerData[param1][sItemName], "extinguisher", false))
				{
					extinguishEntity(param1, PlayerData[param1][iItemCost]);
					return;
				}
				...
				else if(StrEqual(PlayerData[param1][sItemName], "z_spawn_old tank auto", false))
				{
					...
					{
						CPrintToChat(param1,  "%T", "Tank Limit", param1);
						return;
					}
				...
				else if(StrEqual(PlayerData[param1][sItemName], "z_spawn_old witch auto", false) || StrEqual(PlayerData[param1][sItemName], "z_spawn_old witch_bride auto", false))
				{
					...
					{
						CPrintToChat(param1,  "%T", "Witch Limit", param1);
						return;
					}
				...
				else if(StrContains(PlayerData[param1][sItemName], "z_spawn_old", false) != -1 && StrContains(PlayerData[param1][sItemName], "mob", false) == -1)
				{
					...
					{
						CPrintToChat(param1, "%s %T", MSGTAG, "Spawn Failed", param1);
					}
...
public Action Command_RespawnBuy(int client, int args)
{
    if (GetClientTeam(client) == 2 && !IsPlayerAlive(client))
	{
		...
		SetCommandFlags( "give", Flags|FCVAR_CHEAT );
  	 	...
  	 	if ( bCanTeleport )
			vPerformTeleport( client, vPos );
	}
	else if (IsPlayerAlive(client))
	{
		int returnpoints = GetConVarInt(ItemCosts[CostRespawn]);
		addPoints(client, returnpoints, "Alive");
	}
}
...
void vPerformTeleport( int client, float vCoordinates[3] )
{
	vCoordinates[2] += 40.0;
	TeleportEntity(client, vCoordinates, NULL_VECTOR, NULL_VECTOR );
	CPrintToChatAll("{green}[{lightgreen}PS{green}] {olive}%N {default}has {lightgreen}Respawned {green}!", client );
	//EmitSoundToAll(HUNTER, SNDCHAN_WEAPON, SNDLEVEL_SCREAMING);
}
