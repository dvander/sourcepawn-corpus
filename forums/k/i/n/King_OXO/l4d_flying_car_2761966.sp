...
#define MODEL_CAR3			"models/props_vehicles/cara_95sedan.mdl"
...
public void OnPluginStart()
{
	...
	l4d_flying_car_ignite = CreateConVar("l4d_flying_car_ignite", "0", "Ignite car on leaving? 0:disable, 1:enable", 0, true, 0.0, true, 1.0);
	l4d_flying_car_model = CreateConVar("l4d_flying_car_model", "2", "Car model (1:taxi, 2:sedan, 3:police car)", 0, true, 1.0, true, 3.0);
