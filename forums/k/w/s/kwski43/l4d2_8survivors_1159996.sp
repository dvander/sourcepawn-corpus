...
public OnPluginStart()
{
	...
	cvarPluginMode = CreateConVar("l4d2_8survivors_mode", "2", "Eight Survivors Mode: 0-disable plugin, 1-new survivors first, 2-old survivors first", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY, true, 0.0, true, 2.0);
