...
{
	cvarPluginVersion = CreateConVar("l4d2_itemgiver_version", PLUGIN_VERSION, "Start Round Items Giver Version", FCVAR_NOTIFY);
...
public GivePrimWeaponItemToAllL4D()
{
	...
	for (new client = 1; client <= GetMaxClients()+1; client++)
	{
