...
public OnPluginStart()
{
	...
	PluginCvarMode = CreateConVar("l4d2_extendedsight_mode", "3", "When to reward Survivors with Extended Sight? 1 - when Tank is killed, 2 - when Witch is killed, 3 - when Tank or Witch is killed, 4 - active all the time, 0 - disabled", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 4.0);
	PluginCvarNotify = CreateConVar("l4d2_extendedsight_notify", "1", "Notify players when they gain Extended Sight? 0 - disable, 1 - hintbox, 2 - chat", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 2.0);
	...
	PluginCvarGlowMode = CreateConVar("l4d2_extendedsight_glowmode", "1", "Glow mode. 0 - persistent glow, 1 - fading glow", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 1.0);
