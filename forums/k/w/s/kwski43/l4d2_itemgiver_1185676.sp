...
public OnPluginStart()
{
	...
	if (GetConVarInt(cvarPluginEnable))
	{
		...
		RegAdminCmd("sm_giveitems", Command_GiveItemsL4D, ADMFLAG_KICK, "Gives items to survivors with 2s delays between each.");
	...
	cvarHealth = CreateConVar("l4d2_ig_give_health", "0", "What Health item should We give to survivors? 0-disable, 1-medkit, 2-defib, 3-explosive bullets pack, 4-fire bullets pack",FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 4.0);
	...
	cvarUpgrade = CreateConVar("l4d2_ig_give_upgrade", "1", "What Upgrade should We give to survivors? 0-disable, 1-laser, 2-explosive bullets, 3-fire bullets",FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 3.0);
