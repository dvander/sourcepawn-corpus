...
void initPluginSettings()
{
	...
	ModuleSettings.hEnabled = CreateConVar("ps_bess_enable", "1", "Enable BESS Module", 0, true, 0.0, true, 1.0);
...
void populateItemMap()
{
	...
	hItemMap.SetString("hunting_knife", "give hunting knife", true);
	hItemMap.SetString("knife", "give hunting knife", true);
	hItemMap.SetString("riotshield", "give riotshield", true);
	hItemMap.SetString("shovel", "give shovel", true);
	hItemMap.SetString("pitchfork", "give pitchfork", true);
...
void populatePriceMap()
{
	...
	hPriceMap.SetValue("sil", FindConVar("l4d2_points_silenced").IntValue, true);
	...
	hPriceMap.SetValue("hunting_knife", FindConVar("l4d2_points_hunting_knife").IntValue, true);
	hPriceMap.SetValue("knife", FindConVar("l4d2_points_hunting_knife").IntValue, true);
	hPriceMap.SetValue("riotshield", FindConVar("l4d2_points_riotshield").IntValue, true);
	hPriceMap.SetValue("shovel", FindConVar("l4d2_points_shovel").IntValue, true);
	hPriceMap.SetValue("pitchfork", FindConVar("l4d2_points_pitchfork").IntValue, true);
...
public Action Cmd_Buy(int iClientIndex, int iNumArgs)
{
	...
	char sPlayerInput[50]; sPlayerInput[0] = '\0';
	char sPurchaseCmd[100]; sPurchaseCmd[0] = '\0';
	GetCmdArg(1, sPlayerInput, sizeof(sPlayerInput));

	if(hItemMap.GetString(sPlayerInput, sPurchaseCmd, sizeof(sPurchaseCmd)))
	{ // If an entry exists
		int iRequiredTeam = 0;
		...
		{
			char sMapName[100]; sMapName[0] = '\0';
		...
		{ // If not a special case
			...
			{
				if(StrEqual(sPlayerInput, "kill", false))
