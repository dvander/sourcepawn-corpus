...
public Action:OnClientSayCommand(client, const String:command[], const String:sArgs[]) {
	...
	if (detectionMethod == 1) {
		...
		if (StrEqual(msg, 		"WWW.LMAOBOX.NET - BEST FREE TF2 HACK!", 	false) == false && 
			StrEqual(msg, 		"GET GOOD, GET LMAOBOX", 					false) == false &&
			StrEqual(msg, 		"GET GOOD. GET LMAOBOX.", 					false) == false && 			
			StrEqual(msg, 		"WWW.LMAOBOX.NET - BEST TF2 HACKS!", 		false) == false &&
			StrEqual(msg, 		"GET GOOD, GET LMAOBoX!", 					false) == false &&
			StrEqual(msg, 		"WWW.LMAOBoX.NET - BEST FREE TF2 HACK!", 	false) == false &&
			StrEqual(msg, 		"WWW.LMAOBOX.NET - THE BEST TF2 HACK!", 	false) == false &&
