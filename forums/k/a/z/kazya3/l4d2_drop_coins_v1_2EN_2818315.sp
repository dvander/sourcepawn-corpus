...
public OnPluginStart(){
	Coin_Drop_Switch		= CreateConVar("L4D2_Coin_Drop_Switch", 		"1", 			"Enable drop coins when player dead",				FCVAR_NOTIFY, true, 0.0, true, 1.0);
	Coin_Drop_Num			= CreateConVar("L4D2_Coin_Drop_Num", 			"10", 			"Number of dropped coins",							FCVAR_NOTIFY, true, 0.0, true, 999.0);
	Coin_Drop_Model_Case	= CreateConVar("L4D2_Coin_Drop_Model_Case", 	"3", 			"Coin model, 0:coin 1:goldBar 2:money 3:random",	FCVAR_NOTIFY, true, 0.0, true, 3.0);
	Coin_Drop_Model_Alpha	= CreateConVar("L4D2_Coin_Drop_Model_Alpha", 	"255", 			"Coin model Alpha",									FCVAR_NOTIFY, true, 0.0, true, 255.0);
	Coin_Drop_Clear_Time	= CreateConVar("L4D2_Coin_Drop_Clear_Time", 	"10", 			"Clear coin time (Seconds)",						FCVAR_NOTIFY, true, 0.0, true, 999.0);
	Coin_Glow_Switch		= CreateConVar("L4D2_Coin_Glow_Switch", 		"0", 			"Enable coin glowing",								FCVAR_NOTIFY, true, 0.0, true, 1.0);
	Coin_Glow_Color			= CreateConVar("L4D2_Coin_Glow_Color", 			"255 170 0", 	"Coin glowing colors (RGB)",					 	FCVAR_NOTIFY);
	Coin_Glow_Range			= CreateConVar("L4D2_Coin_Glow_Range", 			"2000", 		"Coin glowing range",								FCVAR_NOTIFY, true, 0.0, true, 9999.0);
	Weapon_Drop_Glow_Switch	= CreateConVar("L4D2_Weapon_Drop_Glow_Switch", 	"1", 			"Enable dropped weapons glowing when player dead",	FCVAR_NOTIFY, true, 0.0, true, 1.0);
	Weapon_Drop_Glow_Color	= CreateConVar("L4D2_Weapon_Drop_Glow_Color", 	"255 170 0", 	"Weapons glowing colors (RGB)",					 	FCVAR_NOTIFY);
	Weapon_Drop_Glow_Range	= CreateConVar("L4D2_Weapon_Drop_Glow_Range", 	"2000", 		"Weapons glowing range",						 	FCVAR_NOTIFY, true, 0.0, true, 9999.0);
	// SDKHOOK
