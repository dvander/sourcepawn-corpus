...
public OnPluginStart(){
	...
	Coin_Drop_Num			= CreateConVar("L4D2_Coin_Drop_Num", 			"10", 			"死亡后掉落多少金币",							FCVAR_NOTIFY, true, 0.0, true, 999.0);
	...
	Weapon_Drop_Glow_Switch	= CreateConVar("L4D2_Weapon_Drop_Glow_Switch", 	"1", 			"死亡掉落的武器是否发光描边",					 FCVAR_NOTIFY, true, 0.0, true, 1.0);
