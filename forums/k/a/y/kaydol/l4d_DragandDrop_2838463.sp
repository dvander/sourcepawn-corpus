...
bool bL4D2 = false, bDadOn = false, bHooked = false, bDadDrag = false, bDadPounce = false, bDadIncap = false, bDadPummel = false, bDadJockey = false, bDadIncapGrenade = false, bDadPistols = false, bDadBots = false;
...
void ConVarsChanged(ConVar cvar, const char[] OldValue, const char[] NewValue)
{
	...
	bDadPummel = sm_dad_pummel.BoolValue;
	bDadJockey = sm_dad_jockey.BoolValue;
