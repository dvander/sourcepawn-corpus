...
{
	name = "SM Crits chance with sniper rifle control",
	author = "pRED* & Wazz",
	description = "Change critical hit % and control with sniper rifle body shots count",
...
public Action:TF2_CalcIsAttackCritical(client, weapon, String:weaponname[], &bool:result)
{
	...
	if ((!GetConVarBool(sniperBodyShots)) && StrEqual(weaponname, "tf_weapon_sniperrifle", false))
	{
		return Plugin_Continue;
	}
