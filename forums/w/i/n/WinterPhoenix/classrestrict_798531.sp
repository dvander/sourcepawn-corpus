...
public OnPluginStart() {
	...
	g_hOverride		 = CreateConVar("sm_classrestrict_override",	  "0",	"Enable/disable admin overriding class limit (without bumping non-immune players).");
...
bool:Override() {
	return GetConVarBool(g_hOverride);
}
