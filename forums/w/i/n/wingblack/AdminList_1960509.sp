...
public OnPluginStart()
{
	...
	AdminListFlag           = CreateConVar("adminlist_flagbits", "2", "Admins flag constants to show only one type of admins");
				...
				case 1:
				{
					...
					for(new i = 1 ; i <= GetMaxClients();i++)
					{
						if(IsClientInGame(i))
						{
							...
							if((AdminID != INVALID_ADMIN_ID) && (GetUserFlagBits(i) & GetConVarInt(AdminListFlag) ) )
							{
