...
public OnPluginStart()
{
	...
	g_hCVWarmupEnable = CreateConVar("sm_antirush_enable_at_warmup", "0", "Should antirush be active at warmup", FCVAR_PLUGIN, true, 0.0, true, 1.0);
...
{
	if(!GetConVarBool(g_hCVEnable) || (g_bIsRushAllowed && !g_hCVShowFencesWhenAllowed))
	{
		g_hShowFencesTimer = INVALID_HANDLE;
		return Plugin_Stop;
	}
