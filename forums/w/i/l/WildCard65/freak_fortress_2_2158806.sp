	...
	for(new i=0; i<=length; i++)
	{
		...
		switch(buffer[0])
		{
			case '(':
			{
				...
				Debug("Found a parentheses");
			}
			case ')':
			{
				valueReady=true;
				mustClose=true;
				Debug("We got a parentheses to close!");
			}
			case '\0':
			{
				valueReady=true;
			...
			case '-':
			{
				...
				canAdd=true;
				Debug("Subtracting found!");
			}
			case '*':
			{
				_operator[parentheses]=3;
				canAdd=true;
				Debug("Multiplying found!");
			}
			case '/':
			{
				_operator[parentheses]=4;
				canAdd=true;
				Debug("Dividing found!");
			}
			case '^':
			{
			...
			if(usePlayers)
			{
				...
				switch(_operator[parentheses])
				{
					case 1:
					{
						...
						Debug("Adding %d to %f", playing, sum[parentheses]);
					}
					case 2:
					{
						sum[parentheses]-=playing;
						Debug("Subtracting %d from %f", playing, sum[parentheses]);
					}
					case 3:
					{
						sum[parentheses]*=playing;
						Debug("Multiplying %f by %d", sum[parentheses], playing);
					}
					case 4:
					{
						if(playing==0)
						...
						sum[parentheses]/=playing;
						Debug("Dividing %f by %d", sum[parentheses], playing);
					}
					case 5:
					{
						sum[parentheses]=Pow(sum[parentheses], Float:playing);
						Debug("Raising %f by %d", sum[parentheses], playing);
					}
					default:
					{
						parentheses=1;
						Debug("Invalid operator found!");
			...
			if(value[0]!='\0' && canAdd)
			{
				...
				switch(_operator[parentheses])
				{
					case 1:
					{
						...
						Debug("Adding %f to %f", StringToFloat(value), sum[parentheses]);
					}
					case 2:
					{
						sum[parentheses]-=StringToFloat(value);
						strcopy(value, sizeof(value), "");
						Debug("Subtracting %d from %f", StringToFloat(value), sum[parentheses]);
					}
					case 3:
					{
						sum[parentheses]*=StringToFloat(value);
						strcopy(value, sizeof(value), "");
						Debug("Multiplying %f by %f", sum[parentheses], StringToFloat(value));
					}
					case 4:
					{
						...
						sum[parentheses]/=StringToFloat(value);
						strcopy(value, sizeof(value), "");
						Debug("Dividing %f by %f", sum[parentheses], StringToFloat(value));
					}
					case 5:
					{
						sum[parentheses]=Pow(sum[parentheses], StringToFloat(value));
						strcopy(value, sizeof(value), "");
						Debug("Raising %f by %f", sum[parentheses], StringToFloat(value));
					}
					default:
					{
						parentheses=1;
		...
		if(mustClose)
		{
			...
			Debug("Setting %f to sum[%d] which is from sum[%d]", sum[parentheses], parentheses, parentheses+1);
		}
	}
	Debug("Total sum is: %f", sum[0]);
...
public http://www.disc-ff.com/viewtopic.php?f=56&t=4711#p43685Native_Debug(Handle:plugin, numParams)
{
