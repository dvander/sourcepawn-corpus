...
public OnClientPostAdminCheck(client)
{
	...
	CreateTimer(10.0, AnnounceConnect, client);
}
...
public DisplayRankMenu(client)
{
	...
	if (CurrentGamemodeID == GAMEMODE_VERSUS && !IsGamemode("teamversus") ||
...
public DisplayAboutPanel(client)
{
	...
	Format(Value, sizeof(Value), "Author: %s", PLUGIN_AUTHOR);
	DrawPanelText(panel, Value);
