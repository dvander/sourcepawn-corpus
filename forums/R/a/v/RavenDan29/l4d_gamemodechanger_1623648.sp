...
Handle:BuildCampaginMenu(bool:adminMode)
{
	...
	{
		AddMenuItem(campaginMenu, "Dead Center", "Dead Center");
		AddMenuItem(campaginMenu, "Dark Carnival", "Dark Carnival");
		AddMenuItem(campaginMenu, "Swamp Fever", "Swamp Fever");
		AddMenuItem(campaginMenu, "Hard Rain", "Hard Rain");
		AddMenuItem(campaginMenu, "The Parish", "The Parish");
...
Handle:BuildMapMenu(bool:adminMode)
{
	...
	{
		if(strcmp(g_campagin, "Dead Center", false) == 0)
		{
		...
		else if(strcmp(g_campagin, "Dark Carnival", false) == 0)
		{
		...
		else if(strcmp(g_campagin, "Swamp Fever", false) == 0)
		{
		...
		else if(strcmp(g_campagin, "Hard Rain", false) == 0)
		{
		...
		else if(strcmp(g_campagin, "The Parish", false) == 0)
		{
		...
		{		
			AddMenuItem(mapMenu, "C9m1_alleys", "Alleys");
			AddMenuItem(mapMenu, "C9m2_lots", "Lots");
		}
		else if(strcmp(g_campagin, "Death Toll", false) == 0)
		{		
		...
		else if(strcmp(g_campagin, "Cold Stream", false) == 0)
		{
			...
			AddMenuItem(mapMenu, "C13m4_cutthroatcreek", "Cut Throat Creek");
		}
