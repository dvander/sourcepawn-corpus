...
*/
public Action VotePass(UserMsg msg_id, BfRead bf, const int[] players, int playersNum, bool reliable, bool init)
{
...
byte    team
*/
public Action VoteFail(UserMsg msg_id, BfRead bf, const int[] players, int playersNum, bool reliable, bool init)
{
