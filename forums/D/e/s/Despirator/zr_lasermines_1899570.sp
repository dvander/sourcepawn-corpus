...
public OnPluginStart()
{
	...
	h_damage = CreateConVar("zr_lasermines_damage", "3", "The damage to deal to a player by the laser", FCVAR_PLUGIN, true, 1.0, true, 100000.0);
	h_explode_damage = CreateConVar("zr_lasermines_explode_damage", "0", "The damage to deal to a player when a laser mine breaks", FCVAR_PLUGIN, true, 0.0, true, 100000.0);
	h_explode_radius = CreateConVar("zr_lasermines_explode_radius", "0", "The radius of the explosion", FCVAR_PLUGIN, true, 1.0, true, 100000.0);
	h_health = CreateConVar("zr_lasermines_health", "0", "The laser mines health. 0 = never breaked", FCVAR_PLUGIN, true, 0.0, true, 100000.0);
	h_activate_time = CreateConVar("zr_lasermines_activatetime", "3", "The delay of laser mines' activation", FCVAR_PLUGIN, true, 0.0, true, 10.0);
	h_use_buy_mode = CreateConVar("zr_lasermines_buymode", "0", "Enables buy mode. In this mode you will have to buy mines", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	...
	h_color = CreateConVar("zr_lasermines_color", "0 255 0", "The laser's color. Set by RGB", FCVAR_PLUGIN);
	h_allow_pickup = CreateConVar("zr_lasermines_allow_pickup", "0", "Allow players to pickup their planted lasermines", FCVAR_PLUGIN);
