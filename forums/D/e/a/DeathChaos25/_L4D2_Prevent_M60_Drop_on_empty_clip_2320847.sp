...
{
	name = "[L4D2] Prevent M60 Drop on empty clip", 
	author = "DeathChaos25", 
	description = "Prevents M60s from getting auto deleted when they run empty as well as fixing other various bugs", 
	version = "1.0", 
	...
	if (buttons & IN_ATTACK)
	{
		...
		if (StrEqual(s_Weapon, "weapon_rifle_m60"))
		{
			...
			if (clip <= 1)
			{
				...
				//AcceptEntityInput(M60, "Use", client);
			}
		}
	}
