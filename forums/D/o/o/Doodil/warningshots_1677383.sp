...
public OnPluginStart()
{
	...
	W_Amount = CreateConVar("sm_warningshots_amount","3","amount of ct's that recieve a warningshot weapon at the beginning of the round");
...
public Event_RoundStart(Handle:event,const String:name[],bool:dontBroadcast)
{
	...
	new weaponAmount =GetConVarInt(W_Amount);
