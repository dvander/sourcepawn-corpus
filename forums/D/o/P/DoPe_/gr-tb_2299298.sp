...
#define VERSION "1.1.1.82 csgo fixed"
...
public Plugin:myinfo =
{
    ...
    author = "Razor2142, Copyright(c) // fix by DoPe^",
    version = VERSION,
...
{
    CreateConVar("grtb_version", VERSION, "version", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);
