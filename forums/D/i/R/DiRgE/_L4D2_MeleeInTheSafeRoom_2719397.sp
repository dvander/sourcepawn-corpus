...
Handle g_hWeaponPitchfork;
Handle g_hWeaponShovel;
...
public void OnPluginStart()
{
	...
	CreateConVar( "l4d2_MITSR_Version",		VERSION, "The version of Melee In The Saferoom", 0 );
	g_hEnabled				= CreateConVar( "l4d2_MITSR_Enabled",		"1", "Should the plugin be enabled", 0 );
	g_hWeaponRandom			= CreateConVar( "l4d2_MITSR_Random",		"1", "Spawn Random Weapons (1) or custom list (0)", 0 );
	g_hWeaponRandomAmount	= CreateConVar( "l4d2_MITSR_Amount",		"4", "Number of weapons to spawn if l4d2_MITSR_Random is 1", 0 );
	g_hWeaponBaseballBat 	= CreateConVar( "l4d2_MITSR_BaseballBat",	"1", "Number of baseball bats to spawn (l4d2_MITSR_Random must be 0)", 0 );
	g_hWeaponCricketBat 	= CreateConVar( "l4d2_MITSR_CricketBat", 	"1", "Number of cricket bats to spawn (l4d2_MITSR_Random must be 0)", 0 );
	g_hWeaponCrowbar 		= CreateConVar( "l4d2_MITSR_Crowbar", 	"1", "Number of crowbars to spawn (l4d2_MITSR_Random must be 0)", 0 );
	g_hWeaponElecGuitar		= CreateConVar( "l4d2_MITSR_ElecGuitar",	"1", "Number of electric guitars to spawn (l4d2_MITSR_Random must be 0)", 0 );
	g_hWeaponFireAxe		= CreateConVar( "l4d2_MITSR_FireAxe",		"1", "Number of fireaxes to spawn (l4d2_MITSR_Random must be 0)", 0 );
	g_hWeaponFryingPan		= CreateConVar( "l4d2_MITSR_FryingPan",	"1", "Number of frying pans to spawn (l4d2_MITSR_Random must be 0)", 0 );
	g_hWeaponGolfClub		= CreateConVar( "l4d2_MITSR_GolfClub",	"1", "Number of golf clubs to spawn (l4d2_MITSR_Random must be 0)", 0 );
	g_hWeaponKnife			= CreateConVar( "l4d2_MITSR_Knife",		"1", "Number of knifes to spawn (l4d2_MITSR_Random must be 0)", 0 );
	g_hWeaponKatana			= CreateConVar( "l4d2_MITSR_Katana",		"1", "Number of katanas to spawn (l4d2_MITSR_Random must be 0)", 0 );
	g_hWeaponPitchfork		= CreateConVar( "l4d2_MITSR_Pitchfork",		"1", "Number of pitchfork to spawn (l4d2_MITSR_Random must be 0)", 0 );
	g_hWeaponShovel			= CreateConVar( "l4d2_MITSR_Shovel",		"1", "Number of shovels to spawn (l4d2_MITSR_Random must be 0)", 0 );
	g_hWeaponMachete		= CreateConVar( "l4d2_MITSR_Machete",		"1", "Number of machetes to spawn (l4d2_MITSR_Random must be 0)", 0 );
	g_hWeaponRiotShield		= CreateConVar( "l4d2_MITSR_RiotShield",	"1", "Number of riot shields to spawn (l4d2_MITSR_Random must be 0)", 0 );
	g_hWeaponTonfa			= CreateConVar( "l4d2_MITSR_Tonfa",		"1", "Number of tonfas to spawn (l4d2_MITSR_Random must be 0)", 0 );
...
stock void SpawnCustomList( float Position[3], float Angle[3] )
{
	...
	{
		for( int i = 0; i < GetConVarInt( g_hWeaponBaseballBat ); i++ )
		{
	...
	{
		for( int i = 0; i < GetConVarInt( g_hWeaponCricketBat ); i++ )
		{
	...
	{
		for( int i = 0; i < GetConVarInt( g_hWeaponCrowbar ); i++ )
		{
	...
	{
		for( int i = 0; i < GetConVarInt( g_hWeaponElecGuitar ); i++ )
		{
	...
	{
		for( int i = 0; i < GetConVarInt( g_hWeaponFireAxe ); i++ )
		{
	...
	{
		for( int i = 0; i < GetConVarInt( g_hWeaponFryingPan ); i++ )
		{
	...
	{
		for( int i = 0; i < GetConVarInt( g_hWeaponGolfClub ); i++ )
		{
	...
	{
		for( int i = 0; i < GetConVarInt( g_hWeaponKnife ); i++ )
		{
	...
	{
		for ( int i = 0; i < GetConVarInt( g_hWeaponKatana ); i++ )
		{
	...
	{
		for ( int i = 0; i < GetConVarInt( g_hWeaponPitchfork ); i++ )
		{
	...
	{
		for ( int i = 0; i < GetConVarInt( g_hWeaponShovel ); i++ )
		{
	...
	{
		for ( int i = 0; i < GetConVarInt( g_hWeaponMachete ); i++ )
		{
	...
	{
		for ( int i = 0; i < GetConVarInt( g_hWeaponRiotShield ); i++ )
		{
	...
	{
		for ( int i = 0; i < GetConVarInt( g_hWeaponTonfa ); i++ )
		{
...
stock void SpawnMelee( const char Class[32], float Position[3], float Angle[3] )
{
	float SpawnPosition[3];
	float SpawnAngle[3];
	...
	char MeleeSpawn = CreateEntityByName( "weapon_melee" );
...
{
	char MeleeStringTable = FindStringTable( "MeleeWeapons" );
...
stock void GetScriptName( const char Class[32], char ScriptName[32] )
{
	for ( int i = 0; i < g_iMeleeClassCount; i++ )
	{
