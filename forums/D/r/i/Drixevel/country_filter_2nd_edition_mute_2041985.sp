/**
	...
	Edited to add mute by Jack of Designs.
*/
...
new Handle:cf_muteorban = INVALID_HANDLE;
new bool:g_muteorban = false;
...
public OnPluginStart()
{
	...
	cf_muteorban = CreateConVar("cf_muteorban", "0", "0 = mute, 1 = ban", FCVAR_NONE, true, 0.0, true, 1.0);
	g_muteorban = GetConVarBool(cf_muteorban);
	HookConVarChange(cf_muteorban, ConVarChanged);
...
public ConVarChanged(Handle:convar, const String:oldValue[], const String:newValue[])
{
	...
	if(convar == cf_muteorban)
	{
		g_muteorban = StringToInt(newValue) == 1 ? true:false;
	}
