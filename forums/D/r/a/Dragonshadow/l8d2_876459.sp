...
public OnPluginStart()
{
	...
	sm_l8d_difficulty = CreateConVar("sm_l8d_difficulty", "Normal", "L8D Difficulty Level (Easy, Normal, Hard, Impossible)", FCVAR_PLUGIN|FCVAR_REPLICATED|FCVAR_NOTIFY);
	sm_l8d_doubleitems = CreateConVar("sm_l8d_doubleitems", "1", "L8D Double Item Count", FCVAR_PLUGIN|FCVAR_REPLICATED|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	sm_l8d_nobots = CreateConVar("sm_l8d_nobots", "0", "L8D only spawns bots for human replacement", FCVAR_PLUGIN|FCVAR_REPLICATED|FCVAR_NOTIFY, true, 0.0, true, 1.0);
...
//	new bool:bnoBots = (GetConVarInt(sm_l8d_nobots) == 1);
	new bool:bnoBots = GetConVarBool(sm_l8d_nobots);
