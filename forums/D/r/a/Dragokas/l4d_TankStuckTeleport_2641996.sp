...
public void OnPluginStart()
{
	...
	g_hCvarIdlerPunish = CreateConVar(		"l4d_TankAntiStuck_idler_punish",			"1",		"Punish the player who doesn't move by teleporting nearest tant to him? (0 - No / 1 - Yes)", CVAR_FLAGS );
