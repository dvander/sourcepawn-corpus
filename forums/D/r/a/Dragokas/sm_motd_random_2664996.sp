...
public void OnPluginStart()
{
	...
	g_hCvarURL = CreateConVar(		"sm_motd_random_picture_address",	"http://your-site.com/folder/picture{}.jpg",	"Web-address of pictures. {} will be replaced by number (1 ... N)", CVAR_FLAGS );
	g_hCvarCount = CreateConVar(	"sm_motd_random_count",				"10",											"Total count of pictures on FTP", CVAR_FLAGS );
