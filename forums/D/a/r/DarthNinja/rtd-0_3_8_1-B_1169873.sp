...
#define PLUGIN_VERSION 			"0.3.8.1-B"
...
public OnPluginStart()
{
	...
	c_Admin		= CreateConVar("sm_rtd_admin",	   "",			"The access flag if you want to make rtd admin only: 'a,b,c,z'");
	
	//New Effect Timers
	t_gGodmode		= CreateConVar("sm_rtd_timer_godmode",     "20.0",     "Godmode timer");
...
public Action:Command_rtd(client, args)
{
	...
	return Plugin_Handled;
	//Changed from plugin_contuinue --spam
}
