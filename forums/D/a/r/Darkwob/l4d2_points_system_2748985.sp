...
void initPluginSettings()
{
	...
	PluginSettings.hModes         = CreateConVar("l4d2_points_modes", "coop,realism,survival", "Which game modes to use Point System");
	...
	PluginSettings.hKillSpreeNum  = CreateConVar("l4d2_points_cikills", "25", "How many kills you need to earn a killing spree bounty");
	PluginSettings.hHeadShotNum   = CreateConVar("l4d2_points_headshots", "20", "How many headshot kills you need to earn a head hunter bonus");
	return;
}

enum struct plugin_sprites
{
	int BeamSprite;
	int HaloSprite;
}

plugin_sprites PluginSprites;
...
player_data PlayerData[MAXPLAYERS];

void initPlayerData(int iClientIndex)
{
...
enum struct item_costs
{
	...
	Handle CostMachete;
	Handle CostTonfa;
	Handle CostHuntingknife;
	Handle CostRiotshield;
    Handle CostShovel;
    Handle CostPitchfork;
...
{
	// Health Items
	ItemCosts.CostPills              = CreateConVar("l4d2_points_pills", "5", "How many points the pills costs");
	ItemCosts.CostHealthKit          = CreateConVar("l4d2_points_medkit", "15", "How many points the health kit costs");
	ItemCosts.CostDefib              = CreateConVar("l4d2_points_defib", "20", "How many points the defib costs");
	ItemCosts.CostAdren              = CreateConVar("l4d2_points_adrenaline", "7", "How many points the adrenaline costs");
	ItemCosts.CostHeal               = CreateConVar("l4d2_points_survivor_heal", "20", "How many points a complete heal costs");

	// Secondary Pistols
	ItemCosts.CostP220               = CreateConVar("l4d2_points_pistol", "4", "How many points the p220 pistol costs");
	ItemCosts.CostMagnum             = CreateConVar("l4d2_points_magnum", "7", "How many points the magnum pistol costs");

	// SMGs
	ItemCosts.CostUzi                = CreateConVar("l4d2_points_smg", "6", "How many points the smg costs");
	ItemCosts.CostSilenced           = CreateConVar("l4d2_points_silenced", "7", "How many points the silenced smg costs");
	ItemCosts.CostMP5                = CreateConVar("l4d2_points_mp5", "8", "How many points the mp5 smg costs");

	// Rifles
	ItemCosts.CostM16                = CreateConVar("l4d2_points_m16", "12", "How many points the m16 rifle costs");
	ItemCosts.CostSCAR               = CreateConVar("l4d2_points_scar", "13", "How many points the scar-l rifle costs");
	ItemCosts.CostAK47               = CreateConVar("l4d2_points_ak47", "14", "How many points the ak47 rifle costs");
	ItemCosts.CostSG552              = CreateConVar("l4d2_points_sg552", "15", "How many points the sg552 rifle costs");
	ItemCosts.CostM60                = CreateConVar("l4d2_points_m60", "25", "How many points the m60 rifle costs");

	// Snipers
	ItemCosts.CostHunting            = CreateConVar("l4d2_points_hunting", "10", "How many points the hunting rifle costs");
	ItemCosts.CostScout              = CreateConVar("l4d2_points_scout", "13", "How many points the scout sniper rifle costs");
	ItemCosts.CostMilitary           = CreateConVar("l4d2_points_military", "12", "How many points the military sniper rifle costs");
	ItemCosts.CostAWP                = CreateConVar("l4d2_points_awp", "15", "How many points the awp sniper rifle costs");

	// Shotguns
	ItemCosts.CostChrome             = CreateConVar("l4d2_points_chrome", "7", "How many points the chrome shotgun costs");
	ItemCosts.CostPump               = CreateConVar("l4d2_points_pump", "7", "How many points the pump shotgun costs");
	ItemCosts.CostSPAS               = CreateConVar("l4d2_points_spas", "14", "How many points the spas shotgun costs");
	ItemCosts.CostAuto               = CreateConVar("l4d2_points_auto", "12", "How many points the autoshotgun costs");

	// Throwables
	ItemCosts.CostMolotov            = CreateConVar("l4d2_points_molotov", "6", "How many points the molotov costs");
	ItemCosts.CostPipe               = CreateConVar("l4d2_points_pipe", "6", "How many points the pipe bomb costs");
	ItemCosts.CostBile               = CreateConVar("l4d2_points_bile", "7", "How many points the bile jar costs");

	// Misc
	ItemCosts.CostChainsaw           = CreateConVar("l4d2_points_chainsaw", "15", "How many points the chainsaw costs");
	ItemCosts.CostGrenade            = CreateConVar("l4d2_points_grenade", "25", "How many points the grenade launcher costs");
	ItemCosts.CostGnome              = CreateConVar("l4d2_points_gnome", "10", "How many points the gnome costs");
	ItemCosts.CostCola               = CreateConVar("l4d2_points_cola", "10", "How many points cola bottles costs");
	ItemCosts.CostGasCan             = CreateConVar("l4d2_points_gascan", "5", "How many points the gas can costs");
	ItemCosts.CostPropane            = CreateConVar("l4d2_points_propane", "5", "How many points the propane tank costs");
	ItemCosts.CostFireworks          = CreateConVar("l4d2_points_fireworks", "5", "How many points the fireworks crate costs");
	ItemCosts.CostOxygen             = CreateConVar("l4d2_points_oxygen", "5", "How many points the oxgen tank costs");

	// Upgrades
	ItemCosts.CostExplosivePack      = CreateConVar("l4d2_points_explosive_ammo_pack", "15", "How many points the explosive ammo pack costs");
	ItemCosts.CostFirePack           = CreateConVar("l4d2_points_incendiary_ammo_pack", "15", "How many points the incendiary ammo pack costs");
	ItemCosts.CostAmmo               = CreateConVar("l4d2_points_refill", "20", "How many points an ammo refill costs");
	ItemCosts.CostExplosiveAmmo      = CreateConVar("l4d2_points_explosive_ammo", "10", "How many points the explosive ammo costs");
	ItemCosts.CostFireAmmo           = CreateConVar("l4d2_points_incendiary_ammo", "10", "How many points the incendiary ammo costs");
	ItemCosts.CostLaserSight         = CreateConVar("l4d2_points_laser", "10", "How many points the laser sight costs");

	// Melee
	ItemCosts.CostBaseballbat        = CreateConVar("l4d2_points_baseballbat", "4", "How many points the baseball bat costs");
	ItemCosts.CostCricketbat         = CreateConVar("l4d2_points_cricketbat", "4", "How many points the cricket bat costs");
	ItemCosts.CostCrowbar            = CreateConVar("l4d2_points_crowbar", "4", "How many points the crowbar costs");
	ItemCosts.CostElectricguitar     = CreateConVar("l4d2_points_electricguitar", "6", "How many points the electric guitar costs");
	ItemCosts.CostFireaxe            = CreateConVar("l4d2_points_fireaxe", "8", "How many points the fire axe costs");
	ItemCosts.CostFryingpan          = CreateConVar("l4d2_points_fryingpan", "5", "How many points the frying pan costs");
	ItemCosts.CostGolfclub           = CreateConVar("l4d2_points_golfclub", "5", "How many points the golf club costs");
	ItemCosts.CostKatana             = CreateConVar("l4d2_points_katana", "8", "How many points the katana costs");
	ItemCosts.CostMachete            = CreateConVar("l4d2_points_machete", "8", "How many points the machete costs");
	ItemCosts.CostTonfa              = CreateConVar("l4d2_points_tonfa", "6", "How many points the nightstick costs");
	ItemCosts.CostHuntingknife       = CreateConVar("l4d2_points_hunting_knife", "7", "How many points the hunting knife costs");
	ItemCosts.CostRiotshield         = CreateConVar("l4d2_points_riotshield", "6", "How many points the riotshield costs");
	ItemCosts.CostShovel             = CreateConVar("l4d2_points_shovel", "7", "How many points the shovel costs");
	ItemCosts.CostPitchfork          = CreateConVar("l4d2_points_pitchfork", "7", "How many points the pitchfork costs");

	// Infected
	ItemCosts.CostSuicide            = CreateConVar("l4d2_points_suicide", "20", "How many points does suicide cost");
	ItemCosts.CostBoomer             = CreateConVar("l4d2_points_boomer", "15", "How many points does a boomer cost");
	ItemCosts.CostSmoker             = CreateConVar("l4d2_points_smoker", "20", "How many points does a smoker cost");
	ItemCosts.CostHunter             = CreateConVar("l4d2_points_hunter", "25", "How many points does a hunter cost");
	ItemCosts.CostSpitter            = CreateConVar("l4d2_points_spitter", "10", "How many points does a spitter cost");
	ItemCosts.CostJockey             = CreateConVar("l4d2_points_jockey", "25", "How many points does a jockey cost");
	ItemCosts.CostCharger            = CreateConVar("l4d2_points_charger", "30", "How many points does a charger cost");
	ItemCosts.CostWitch              = CreateConVar("l4d2_points_witch", "40", "How many points does a witch cost");
	ItemCosts.CostTank               = CreateConVar("l4d2_points_tank", "60", "How many points does a tank cost");
	ItemCosts.CostHorde              = CreateConVar("l4d2_points_horde", "40", "How many points does a horde cost");
	ItemCosts.CostMob                = CreateConVar("l4d2_points_mob", "35", "How many points does a mob cost");
	ItemCosts.CostUncommonMob        = CreateConVar("l4d2_points_umob", "30", "How many points does an uncommon mob cost");
	ItemCosts.CostInfectedHeal       = CreateConVar("l4d2_points_infected_heal", "25", "How many points does healing yourself as an infected cost");
	ItemCosts.CostTankHealMultiplier = CreateConVar("l4d2_points_tank_heal_mult", "2", "How much l4d2_points_infected_heal should be multiplied for tank players");

	return;
}

enum struct categories_enabled
{
...
{
	PointRewards.SurvRewardKillSpree = CreateConVar("l4d2_points_cikill_value", "2", "How many points does killing a certain amount of infected earn");
	PointRewards.SurvRewardHeadShots = CreateConVar("l4d2_points_headshots_value", "2", "How many points does killing a certain amount of infected with headshots earn");
	PointRewards.SurvKillInfec       = CreateConVar("l4d2_points_sikill", "1", "How many points does killing a special infected earn");
	PointRewards.SurvKillTank        = CreateConVar("l4d2_points_tankkill", "5", "How many points does killing a tank earn");
	PointRewards.SurvKillWitch       = CreateConVar("l4d2_points_witchkill", "5", "How many points does killing a witch earn");
	PointRewards.SurvCrownWitch      = CreateConVar("l4d2_points_witchcrown", "10", "How many points does crowning a witch earn");
	PointRewards.SurvTeamHeal        = CreateConVar("l4d2_points_heal", "5", "How many points does healing a team mate earn");
	...
	PointRewards.SurvTeamProtect     = CreateConVar("l4d2_points_protect", "1", "How many points does protecting a team mate earn");
	PointRewards.SurvTeamRevive      = CreateConVar("l4d2_points_revive", "2", "How many points does reviving a team mate earn");
	PointRewards.SurvTeamLedge       = CreateConVar("l4d2_points_ledge", "1", "How many points does reviving a hanging team mate earn");
	PointRewards.SurvTeamDefib       = CreateConVar("l4d2_points_defib_action", "5", "How many points does defibbing a team mate earn");
	PointRewards.SurvBurnTank        = CreateConVar("l4d2_points_tankburn", "2", "How many points does burning a tank earn");
	PointRewards.SurvTankSolo        = CreateConVar("l4d2_points_tanksolo", "15", "How many points does killing a tank single-handedly earn");
	PointRewards.SurvBurnWitch       = CreateConVar("l4d2_points_witchburn", "1", "How many points does burning a witch earn");
	...
	PointRewards.InfecPounceSurv     = CreateConVar("l4d2_points_pounce", "1", "How many points does pouncing a survivor earn");
	...
	PointRewards.InfecRideSurv       = CreateConVar("l4d2_points_ride", "1", "How many points does riding a survivor earn");
	PointRewards.InfecBoomSurv       = CreateConVar("l4d2_points_boom", "2", "How many points does booming a survivor earn");
	PointRewards.InfecIncapSurv      = CreateConVar("l4d2_points_incap", "5", "How many points does incapping a survivor earn");
	PointRewards.InfecHurtSurv       = CreateConVar("l4d2_points_damage", "2", "How many points does doing damage earn");
	PointRewards.InfecKillSurv       = CreateConVar("l4d2_points_kill", "8", "How many points does killing a survivor earn");
	return;
}
...
void SaveData(int iClientIndex)
{
...
void LoadData(int iClientIndex)
{
	if(0 < iClientIndex <= MaxClients && IsClientConnected(iClientIndex) && CheckCommandAccess(iClientIndex, "sm_perks", ADMFLAG_CUSTOM1, true))
	{
...
{ // change name
	char sGameMode[40]; sGameMode[0] = '\0';
	char sEnabledModes[64]; sEnabledModes[0] = '\0';
...
stock int DispatchAndRemove(const char[] sGun)
{
...
public int Native_PS_RegisterModule(Handle hPlugin, int iNumArguments)
{
	int iNumModules = GetArraySize(ModulesArray);
...
public int Native_PS_UnregisterModule(Handle hPlugin, int iNumArguments)
{
	int iNumModules = GetArraySize(ModulesArray);
...
{
	return view_as<int>(PluginSettings.fVersion);
}
...
void resetAllPlayers(int iClientIndex)
{ // Check if 0
	if(MaxClients >= iClientIndex)
	{
		resetClientData(iClientIndex);
...
public Action Event_TankDeath(Handle hEvent, const char[] sEventName, bool bDontBroadcast)
{
	...
	if(IsModEnabled() && !IsClientBot(iAttackerIndex))
	{
		if(IsClientSurvivor(iAttackerIndex))
		{
			...
			if(iTankSoloReward > 0)
			{ // If solo kill reward is enabled
...
public Action Event_Shock(Handle hEvent, const char[] sEventName, bool bDontBroadcast)
{ // Defib
	int iClientIndex = getClientIndex(hEvent);
	if(IsModEnabled() && !IsClientBot(iClientIndex))
	{
...
{
	char sVictimName[30]; sVictimName[0] = '\0';
...
public Action Command_RBuy(int iClientIndex, int iNumArguments)
{
	if(iClientIndex > 0 && iNumArguments == 0)
	{
		...
		{
			if(CheckPurchase(iClientIndex, PlayerData[iClientIndex].iItemCost))
...
void BuildBuyMenu(int client)
{
	...
	{
		char title[40], weapons[40], upgrades[40], health[40];
		Menu menu = CreateMenu(TopMenu);
	...
	{
		char title[40], boomer[40], spitter[40], smoker[40], hunter[40], charger[40], jockey[40], tank[40], witch[40], witch_bride[40], heal[40], suicide[40], horde[40], mob[40], umob[40];
		Menu menu = CreateMenu(InfectedMenu);
...
{
	char melee[40], rifles[40], shotguns[40], smg[40], snipers[40], misc[40], title[40], throwables[40];
...
{
	char container[40], title[40];
	Menu menu = CreateMenu(MenuHandler_Melee);
	for(int i; i < MAX_MELEE_LENGTH; i++)
	{
		...
		else if(i == 10 && GetConVarInt(ItemCosts.CostHuntingknife) < 0)
		{
			continue;
		}
		else if(i == 11 && GetConVarInt(ItemCosts.CostRiotshield) < 0)
		{
			continue;
		}
		else if(i == 12 && GetConVarInt(ItemCosts.CostShovel) < 0)
		{
			continue;
		}
		else if(i == 13 && GetConVarInt(ItemCosts.CostPitchfork) < 0)
		{
			continue;
		}
...
{
	char hunting_rifle[40], title[40], sniper_military[40], sniper_scout[40], sniper_awp[40];
	Menu menu = CreateMenu(MenuHandler_Snipers);
...
{
	char rifle[40], title[40], rifle_desert[40], rifle_ak47[40], rifle_sg552[40], rifle_m60[40];
	Menu menu = CreateMenu(MenuHandler_Rifles);
...
void BuildShotgunMenu(int client)
{
	...
	Menu menu = CreateMenu(MenuHandler_Shotguns);
...
{
	char smg[40], title[40], smg_silenced[40], smg_mp5[40];
	Menu menu = CreateMenu(MenuHandler_SMG);
...
void BuildHealthMenu(int client)
{
	...
	Menu menu = CreateMenu(MenuHandler_Health);
...
{
	char molotov[40], pipe_bomb[40], vomitjar[40], title[40];
	Menu menu = CreateMenu(MenuHandler_Throwables);
...
{
	char grenade_launcher[40], fireworkcrate[40], gascan[40], oxygentank[40], propanetank[40], pistol[40], pistol_magnum[40], title[40];
	char gnome[40], cola_bottles[40], chainsaw[40];
	Menu menu = CreateMenu(MenuHandler_Misc);
...
{
	char upgradepack_explosive[40], upgradepack_incendiary[40], title[40];
	char laser_sight[40], explosive_ammo[40], incendiary_ammo[40], ammo[40];
	Menu menu = CreateMenu(MenuHandler_Upgrades);
...
public int MenuHandler_Melee(Menu menu, MenuAction action, int param1, int param2)
{
	switch(action)
	{
		...
		case MenuAction_Select:
		{
			...
			{
				strcopy(PlayerData[param1].sItemName, 64, "give hunting knife");
				PlayerData[param1].iItemCost = GetConVarInt(ItemCosts.CostHuntingknife);
			}
			...
			else if(StrEqual(item1, "shovel", false))
			{
				strcopy(PlayerData[param1].sItemName, 64, "give shovel");
				PlayerData[param1].iItemCost = GetConVarInt(ItemCosts.CostShovel);
			}
			else if(StrEqual(item1, "pitchfork", false))
			{
				strcopy(PlayerData[param1].sItemName, 64, "give pitchfork");
				PlayerData[param1].iItemCost = GetConVarInt(ItemCosts.CostPitchfork);
			}
...
public int InfectedMenu(Menu hMenu, MenuAction action, int iClientIndex, int iPosition)
{
	switch(action)
	{
		case MenuAction_End:
...
{
	char yes[40], no[40], title[40];
	Menu menu = CreateMenu(MenuHandler_ConfirmMelee);
...
{
	char yes[40], no[40], title[40];
	Menu menu = CreateMenu(MenuHandler_ConfirmSMG);
	Format(yes, sizeof(yes),"%T", "Yes", LANG_SERVER);
	AddMenuItem(menu, "yes", yes);
	Format(no, sizeof(no),"%T", "No", LANG_SERVER);
	AddMenuItem(menu, "no", no);
...
{
	char yes[40], no[40], title[40];
	Menu menu = CreateMenu(MenuHandler_ConfirmRifles);
	Format(yes, sizeof(yes),"%T", "Yes", LANG_SERVER);
	AddMenuItem(menu, "yes", yes);
	Format(no, sizeof(no),"%T", "No", LANG_SERVER);
	AddMenuItem(menu, "no", no);
...
{
	char yes[40], no[40], title[40];
	Menu menu = CreateMenu(MenuHandler_ConfirmSniper);
	Format(yes, sizeof(yes),"%T", "Yes", LANG_SERVER);
	AddMenuItem(menu, "yes", yes);
	Format(no, sizeof(no),"%T", "No", LANG_SERVER);
	AddMenuItem(menu, "no", no);
...
{
	char yes[40], no[40], title[40];
	Menu menu = CreateMenu(MenuHandler_ConfirmShotguns);
	Format(yes, sizeof(yes),"%T", "Yes", LANG_SERVER);
	AddMenuItem(menu, "yes", yes);
	Format(no, sizeof(no),"%T", "No", LANG_SERVER);
	AddMenuItem(menu, "no", no);
...
{
	char yes[40], no[40], title[40];
	Menu menu = CreateMenu(MenuHandler_ConfirmThrow);
	Format(yes, sizeof(yes),"%T", "Yes", LANG_SERVER);
	AddMenuItem(menu, "yes", yes);
	Format(no, sizeof(no),"%T", "No", LANG_SERVER);
	AddMenuItem(menu, "no", no);
...
{
	char yes[40], no[40], title[40];
	Menu menu = CreateMenu(MenuHandler_ConfirmMisc);
	Format(yes, sizeof(yes),"%T", "Yes", LANG_SERVER);
	AddMenuItem(menu, "yes", yes);
	Format(no, sizeof(no),"%T", "No", LANG_SERVER);
	AddMenuItem(menu, "no", no);
...
{
	char yes[40], no[40], title[40];
	Menu menu = CreateMenu(MenuHandler_ConfirmHealth);
	Format(yes, sizeof(yes),"%T", "Yes", LANG_SERVER);
	AddMenuItem(menu, "yes", yes);
	Format(no, sizeof(no),"%T", "No", LANG_SERVER);
	AddMenuItem(menu, "no", no);
...
{
	char yes[40], no[40], title[40];
	Menu menu = CreateMenu(MenuHandler_ConfirmUpgrades);
	Format(yes, sizeof(yes),"%T", "Yes", LANG_SERVER);
	AddMenuItem(menu, "yes", yes);
	Format(no, sizeof(no),"%T", "No", LANG_SERVER);
	AddMenuItem(menu, "no", no);
...
{
	char yes[40], no[40], title[40];
	Menu menu = CreateMenu(MenuHandler_ConfirmI);
	Format(yes, sizeof(yes),"%T", "Yes", LANG_SERVER);
	AddMenuItem(menu, "yes", yes);
	Format(no, sizeof(no),"%T", "No", LANG_SERVER);
	AddMenuItem(menu, "no", no);
...
public bool IsCarryingWeapon(int iClientIndex)
{
...
public void reloadAmmo(int iClientIndex, int iCost, const char[] sItem)
{
	...
	if(IsCarryingWeapon(iClientIndex))
	{
		...
		else if(StrEqual(sWeapon, "weapon_grenade_launcher", false))
		{
			...
			int uOffset = FindDataMapInfo(iClientIndex, "m_iAmmo");
		...
		case MenuAction_Select:
		{
			...
			else if(StrEqual(choice, "yes", false))
			{
				...
				else if(StrContains(PlayerData[param1].sItemName, "z_spawn_old", false) != -1 && StrContains(PlayerData[param1].sItemName, "mob", false) == -1)
				{
					...
					bool[] resetAlive = new bool[MaxClients + 1];
					...
					int maxretry = GetConVarInt(PluginSettings.hSpawnAttempts);
...
stock void SetPlayerLifeState(int client, bool lifestate)
{
