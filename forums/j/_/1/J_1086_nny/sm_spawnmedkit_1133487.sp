...
public Action:Command_SpawnMedKit(client, args)
{
	...
	PrintToChat(client, "\x03sm_rs_spawnitem weapon_first_aid_kit %f %f %f %f %f %f %f", VecDirection[0], VecDirection[1], VecDirection[2], VecOrigin[0], VecOrigin[1], VecOrigin[2], VecAngles[1]);
