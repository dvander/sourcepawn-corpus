...
public OnPluginStart()
{
	...
	h_HunterLimit = CreateConVar("l4d_infectedbots_hunter_limit", "4", "Sets the limit for hunters spawned by the plugin", FCVAR_PLUGIN|FCVAR_NOTIFY);
	...
	h_InfectedSpawnTime = CreateConVar("l4d_infectedbots_spawn_time", "30.0", "Sets spawn time for special infected spawned by the plugin in seconds", FCVAR_PLUGIN|FCVAR_NOTIFY);
	...
	h_JoinableTeams = CreateConVar("l4d_infectedbots_infected_team_joinable", "0", "If 1, players can join the infected team in coop/survival", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	...
	h_JoinableTeamsAnnounce = CreateConVar("l4d_infectedbots_jointeams_announce", "0", "If 1, clients will be announced to about joining the infected team", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	...
	AutoExecConfig(true, "l4d1infectedbots");
