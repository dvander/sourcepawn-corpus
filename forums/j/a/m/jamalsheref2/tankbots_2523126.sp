...
{
	g_TankPlayers		= CreateConVar("sm_tank_count","4","How many tanks you would like active at any point.");
	f_TimePeriod		= CreateConVar("sm_time_count","20","How long to wait after a player dies to check tank count.");
...
public Action:spawnTank(Handle:timer, any:client) { ExecCheatCommand(client, "z_spawn_old", "tank auto"); }
