...
public OnPluginStart()
{
	...
	h_InfectedSpawnTime = CreateConVar("l4d_infectedbots_spawn_time", "22", "Sets spawn time for special infected spawned by the plugin in seconds", FCVAR_PLUGIN|FCVAR_NOTIFY);
