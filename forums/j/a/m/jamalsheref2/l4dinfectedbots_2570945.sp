...
{
h_HunterLimit = CreateConVar("l4d_infectedbots_hunter_limit", "3", "Sets the limit for hunters spawned by the plugin", FCVAR_PLUGIN|FCVAR_SPONLY);
}
...
h_InfectedSpawnTimeMin = CreateConVar("l4d_infectedbots_spawn_time_min", "30", "Sets the minimum spawn time for special infected spawned by the plugin in seconds", FCVAR_PLUGIN|FCVAR_SPONLY);
...
h_idletime_b4slay = CreateConVar("l4d_infectedbots_lifespan", "999", "Amount of seconds before a special infected bot is kicked", FCVAR_PLUGIN|FCVAR_SPONLY);
h_InitialSpawn = CreateConVar("l4d_infectedbots_initial_spawn_timer", "2", "The spawn timer in seconds used when infected bots are spawned for the first time in a map", FCVAR_PLUGIN|FCVAR_SPONLY);
