 ...
 * Changelog:
  * v1.0c
 *  o Fixed Knife Bug (to Hunting Knife; works with Melee in the Saferoom)
 * v1.0
...
BuildMeleeMenu(client)
{
	...
	decl String:electric_guitar[40], String:golfclub[40], String:katana[40], String:frying_pan[40], String:huntingknife[40];
	...
	if (GetConVarInt(AllowAllMeleeWeapons) == 0)
	{
		if ((StrEqual(MapName, "c1m1_hotel", false)) || (StrEqual(MapName, "c1m2_streets", false)) || (StrEqual(MapName, "c1m3_mall", false)) || (StrEqual(MapName, "c1m4_atrium", false)))
		{
			...
			Format(huntingknife, sizeof(huntingknife),"%T", "Knife", LANG_SERVER)
			AddMenuItem(menu, "huntingknife", huntingknife)
...
BuildMeleeGiveMenu(client)
{
	...
	decl String:frying_pan[40], String:katana[40], String:machete[40], String:tonfa[40], String:huntingknife[40], String:golfclub[40], String:title[40]
