...
#define MODEL_COFFEH     "models/props_unique/spawn_apartment/coffeeammo.mdl"
#define MODEL_COFFEEAMMO    "models/props_unique/spawn_apartment/coffeeammo.mdl"
#define MODEL_IRONDOOR      "models/props_downtown/metal_door_112.mdl"
...
public OnPluginStart()
{
    ...
    RegConsoleCmd( "leftfortdead_spawncoffeeammo", SpawnCoffeeAmmo, "spawn an ammo stack", FCVAR_PLUGIN );
    RegConsoleCmd( "leftfortdead_spawnbreakabledoor",  SpawnIronDoor, "spawn a reinforced iron door", FCVAR_PLUGIN );
...
// spawn an ammo stack
//---------------------------------------------------------
public Action:SpawnCoffeeAmmo( client, args )
{
    if ( !IsAccessGranted( client ) )
    {
        return Plugin_Handled;
    ...
    {
        index = CreateEntity( client, "weapon_ammo_spawn", "ammo stack", MODEL_COFFEH );
    }
    else
    {
