...
#define MODEL_AMMOCRATE     "models/props/de_prodigy/ammo_can_02.mdl"
#define MODEL_COFFEECRATE    "models/props/de_prodigy/ammo_can_02.mdl"
...
public OnPluginStart()
{
    ...
    RegConsoleCmd( "leftfortdead_spawnammocrate", SpawnAmmoCrate, "spawn an ammo crate", FCVAR_PLUGIN );
...
// spawn an ammo stack
//---------------------------------------------------------
public Action:SpawnAmmoCrate( client, args )
{
    if ( !IsAccessGranted( client ) )
    {
        return Plugin_Handled;
    ...
    {
        index = CreateEntity( client, "weapon_ammo_spawn", "ammo stack", MODEL_AMMOCRATE );
    }
    else
    {
        index = CreateEntity( client, "weapon_ammo_spawn", "ammo stack", MODEL_COFFEECRATE );
    }
