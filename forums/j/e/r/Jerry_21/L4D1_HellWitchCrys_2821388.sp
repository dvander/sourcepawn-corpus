...
#define g_sBoomerMob	"player/boomer/vomit/boomer_vomit_01.wav"
#define g_sBoomerMob2	"player/boomer/vomit/boomer_vomit_02.wav"
#define g_sBoomerMob3	"player/boomer/vomit/boomer_vomit_04.wav"
#define g_sBoomerMob4	"player/boomer/vomit/boomer_vomit_09.wav"

#define g_sTankCall	    "player/tank/voice/attack/hulk_attack_1.wav"
#define g_sTankCall2	"player/tank/voice/attack/hulk_attack_2.wav"
#define g_sTankCall3	"player/tank/voice/attack/hulk_attack_4.wav"
#define g_sTankCallp3	"player/tank/voice/attack/hulk_attack_5.wav"
#define g_sTankCall4	"player/tank/voice/attack/hulk_attack_6.wav"

#define g_sHunterMob	"player/hunter/voice/alert/hunter_alert_01.wav"
#define g_sHunterMob2	"player/hunter/voice/alert/hunter_alert_03.wav"
#define g_sHunterMob3	"player/hunter/voice/pain/hunter_pain_10.wav"
#define g_sHunterMob4	"player/hunter/voice/idle/hunter_stalk_04.wav"

#define g_sNothing		"npc/infected/alert/alert/alert13.wav"
#define g_sNothing2		"npc/witch/voice/retreat/horrified_4.wav"

#define g_sMobCall		"npc/infected/idle/mumbling/mumbling07.wav"
#define g_sMobCall2		"npc/mega_mob/mega_mob_incoming.wav"
#define g_sMobCall3		"npc/infected/action/ignite/ignite09.wav"

#define g_sWitchDeath	"npc/witch/voice/die/female_death_1.wav"
#define g_sWitchDeath2	"npc/witch/voice/retreat/horrified_2.wav"
...
#define g_sSmokerMob3        "player/smoker/voice/alert/smoker_alert_03.wav"
#define g_sSmokerMob4        "player/smoker/voice/pain/smoker_pain_04.wav"
...
new bool:g_bDevilWitch = false;//should be false PARA COLA DE WITCH///////////////
...
{	
	...
	#if ENABLE_AUTOEXEC
	AutoExecConfig(true, "HellWitchCrys");
	#endif
...
public Action:eWitchStartled(Handle:hEvent, const String:strName[], bool:bDontBroadcast)
{
	...
	if(IsClientInGame(iWitchiClient) && GetClientTeam(iWitchiClient) == 2 && IsPlayerAlive(iWitchiClient))
	{
		...
		Format(sValues, sizeof(sValues), "La Witch Demoniaca Va Contra %N", iWitchiClient);
		DispatchKeyValue(iEntity, "hint_caption", sValues);
	...
	SetEntProp(iWitch, Prop_Data, "m_iMaxHealth", 2000);//Set max and
	SetEntProp(iWitch, Prop_Data, "m_iHealth", 1500);
...
public Action:DevilScreamDelay(Handle:hTimer, any:iWitch)
{
	...
	//SetConVarInt(FindConVar("z_witch_speed"), 3000);    //DEJAR ACTIVO SI QUIERES MAS VELOCIDAD DE LA WITCH
}

/*public Action:WitchSpeedReset(Handle:hTimer)          //DEJAR ACTIVO SI QUIERES MAS VELOCIDAD DE LA WITCH
{
	SetConVarInt(FindConVar("z_witch_speed"), 300);    //DEJAR ACTIVO SI QUIERES MAS VELOCIDAD DE LA WITCH
}*/
...
public Action:MobCall(Handle:hTimer, any:iWitchKiller)
{
	...
	switch(GetRandomInt(1, 7))
	{
		case 1:
		{
			if(g_bMobCall)
			{
				ClientCheatCommand(iClient, "z_spawn", "mob auto");
			...
			//PrintToChatAll("\x05La Witch Ha Invocado Una Oleada!\x03");
			//PrintCenterTextAll("La Witch Ha Invocado Una Oleada");
			PrintHintTextToAll("La Witch Ha Invocado Una Oleada");
		}
		case 2:
		{
			if(g_iTankMobCount > 0)
			{
				for(new x = 1; x <= g_iTankMobCount; x++)
					ClientCheatCommand(iClient, "z_spawn", "tank auto");
				...
				//PrintToChatAll("\x05La Witch Ha Invocado A Tank!\x03");
			    //PrintCenterTextAll("La Witch Ha Invocado A Tank!");
				PrintHintTextToAll("La Witch Ha Invocado A Tank!");
			}
		}
		case 3:
		{
			if(g_iHunterMobCount > 0)	
			{
				for(new x = 1; x <= g_iHunterMobCount; x++)
					ClientCheatCommand(iClient,"z_spawn", "hunter auto");
                ...
                //PrintToChatAll("\x05La Witch Ha Invocado A Hunters!\x03");
			    //PrintCenterTextAll("La Witch Ha Invocado A Hunters!");
				PrintHintTextToAll("La Witch Ha Invocado A Hunters!");				
			}
		}
		case 4:
		{
			if(g_iBoomerMobCount > 0)	
			{
				for(new x = 1; x <= g_iBoomerMobCount; x++)
					ClientCheatCommand(iClient, "z_spawn", "boomer auto");
                ...
                //PrintToChatAll("\x05La Witch Ha Invocado A Boomers!\x03");
			    //PrintCenterTextAll("La Witch Ha Invocado A Boomers!");
				PrintHintTextToAll("La Witch Ha Invocado A Boomers!");						
			}
		}
		case 5:
		{
			if(g_iSmokerMobCount > 0)
			{
				for(new x = 1; x <= g_iSmokerMobCount; x++)
					ClientCheatCommand(iClient, "z_spawn", "smoker auto");
				...
				//PrintToChatAll("\x05La Witch Ha Invocado A Smokers!\x03");
			    //PrintCenterTextAll("La Witch Ha Invocado A Smokers!");
				PrintHintTextToAll("La Witch Ha Invocado A Smokers!");	
			}
		}
		case 6:
		{	
			...
			//PrintToChatAll("\x05La Witch No Ha Invocado A Infectados Por Muerte Instantanea!\x03");
			//PrintCenterTextAll("La Witch No Ha Invocado A Infectados Por Muerte Instantanea!");
			PrintHintTextToAll("La Witch No Ha Invocado A Infectados Por Muerte Instantanea!");
		}
		case 7:
		{
			EmitSoundToAllClients(g_sNothing, SOUND_FROM_PLAYER, SNDCHAN_AUTO, 100, SND_NOFLAGS, 1.0, 100);
			
			//PrintToChatAll("\x05La Witch Puede Invocar A Mods Especiales!\x03");
			//PrintCenterTextAll("La Witch Puede Invocar A Mods Especiales!");
			PrintHintTextToAll("La Witch Puede Invocar A Mods Especiales!");
		}
	}
