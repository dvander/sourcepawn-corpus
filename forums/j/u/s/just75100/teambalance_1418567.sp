...
static const String:ctModels[4][] = {"models/player/csp_player_shared.mdl", "models/player/csp_player_shared.mdll", "models/player/csp_player_shared.mdl", "models/player/ct_gign.mdl"};
static const String:tModels[4][] = {"models/player/t_leet.mdl", "models/player/t_leet.mdl", "models/player/t_leet.mdl", "models/player/t_leet.mdl"};
