...
{
    TF2Items_CreateWeapon( BATTLE_RIFLE_ID, "tf_weapon_sword", 132, 2, 9, 10, "15 ; 0 ; 125 ; -25 ; 219 ; 1.0 ; 292 ; 6.0", -1, _, true );
}
...
public OnPostInventoryApplicationAndPlayerSpawn( Handle:hEvent, const String:strEventName[], bool:bDontBroadcast )
{
    ...
    TF2_SetPlayerClass( iClient, TFClass_demoman, _, true );
