...
public Action Timer_GiveHat(Handle timer, any data)
{
	...
	{
		int rnd = GetRandomInt(0,8);
		switch (rnd)
		{
			case 1:
			{
				CreateHat(client, 30792, 10, 6);
			}	
			case 2:
			{
				CreateHat(client, 30792, 10, 6);
		...
		int rnd2 = GetRandomInt(0,8);
		switch (rnd2)
		{
			case 1:
			{
				CreateHat(client, 30814, 10, 6);
			}
			case 2:
			{
				CreateHat(client, 30814, 10, 6);
		...
		int rnd3 = GetRandomInt(0,8);
		switch (rnd3)
		{
			case 1:
			{
				CreateHat(client, 30817, 10, 6);
			}
			case 2:
			{
				CreateHat(client, 30817, 10, 6);
