...
public OnPluginStart()
{
	...
	l4d_selfhelp_reset_hp = CreateConVar("l4d_selfhelp_reset_hp", "1", "0: disables resetting HP after repelling the attacker");
 ...
 HelpOther(client, helper)
{
	...
	if (GetConVarBool(l4d_selfhelp_reset_hp))
	{
