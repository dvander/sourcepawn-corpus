...
#define  RALLYRACE_VERSION			"1.0.0.5"
...
{
	visible = true; // make driver visible, if set to false, this forward is useless, default is invisible
	return Plugin_Changed;
}

public Action:RCM_CanExitVehicle(car, player, &bool:canexit)
{
	canexit = true; // don't let player press "E" to exit the car
	return Plugin_Changed;
}
...
stock GetRandomCar()
{
	return GetRandomInt(0,g_Total_Car-1);
}
