...
#define ADMIN_BURY	ADMFLAG_SLAY
#define ADMIN_UNBURY	ADMFLAG_SLAY
#define ADMIN_RESPAWN	ADMFLAG_SLAY
#define ADMIN_DISARM	ADMFLAG_SLAY
#define ADMIN_HP	ADMFLAG_SLAY
#define ADMIN_ARMOUR	ADMFLAG_GENERIC
#define ADMIN_WEAPON	ADMFLAG_SLAY
#define ADMIN_GOD	ADMFLAG_RCON
#define ADMIN_SPEED	ADMFLAG_SLAY
#define ADMIN_NV	ADMFLAG_GENERIC
#define ADMIN_DEFUSER	ADMFLAG_GENERIC
#define ADMIN_HELMET	ADMFLAG_GENERIC
#define ADMIN_TEAM	ADMFLAG_SLAY
#define ADMIN_EXTEND	ADMFLAG_CHANGEMAP
#define ADMIN_SEEALL	ADMFLAG_CHAT
#define ADMIN_NAME	ADMFLAG_RCON
#define ADMIN_CASH	ADMFLAG_SLAY
...
public OnPluginStart()
{
	...
	if (StrEqual(modname,"cstrike",false)) mod = CSTRIKE
        ...
        LoadTranslations("common.phrases");
	RegAdminCmd("sm_saveloc", Save_Loc, ADMFLAG_RCON, "saves location");
	RegAdminCmd("sm_teleport", Teleport_User, ADMFLAG_RCON, "sm_teleport <#userid|name>");
