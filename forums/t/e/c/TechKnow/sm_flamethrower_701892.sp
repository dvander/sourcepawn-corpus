			...
			if (IsPlayerAlive(client))
			{
				if (flameAmount[client] > 0)
				{
					...
					{						
						...
						DispatchKeyValue(client, "targetname", tName)
	                                        ...
	                                        EmitAmbientSound("weapons/rpg/rocketfire1.wav", vec, client, SNDLEVEL_NORMAL);
				...
				else
				{
					PrintToChat(client, "[SM] Flamethrower out of fuel")
	                                ...
	                                new Float:vec[3];
	                                GetClientEyePosition(client, vec);
	                                EmitAmbientSound("weapons/ar2/ar2_empty.wav", vec, client, SNDLEVEL_NORMAL);
