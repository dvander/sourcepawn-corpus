...
public OnPluginStart() {
	...
	pack_version = CreateConVar("l4d_backpack_version", PLUGIN_VERSION, "Backpack plugin version.", FCVAR_PLUGIN|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
...
public Action:Timer_WelcomeMessage(Handle:timer, any:client) {
	...
	PrintHintText(client, "[SM] Players can carry more items in there Back Pack....To use Type !pack");
	}
}
