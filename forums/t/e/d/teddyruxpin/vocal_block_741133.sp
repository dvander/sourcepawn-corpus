...
public OnPluginStart()
{
	...
	cVocalLimit = CreateConVar("sm_vocalize_guard_vlimit", "10", "Max Vocalize Spam Calls Allowed [0 = NO LIMIT]", FCVAR_PLUGIN, true, 0.0);
	...
	cBanTime = CreateConVar("sm_vocalize_guard_bantime", "5", "Duration of Ban [0 = KICKS PLAYER]", FCVAR_PLUGIN, true, 0.0);
