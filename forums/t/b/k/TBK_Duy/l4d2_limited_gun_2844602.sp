...
public void OnPluginStart() {
	...
	cAmmoMin =			CreateConVar(PLUGIN_NAME ... "_ammo_min", "0.5",		"min percent of reserved ammo,\n-1=fixed scale use *_max", FCVAR_NOTIFY);
...
void ApplyCvars() {
	...
	if (!bIsReserveControlExists) {
		...
		iReserveAmmoMax[L4D2WeaponId_Pumpshotgun] = iReserveAmmoMax[L4D2WeaponId_ShotgunChrome] = cAmmoShotgunMax.IntValue;
		...
		iReserveAmmoMax[L4D2WeaponId_SniperAWP] = iReserveAmmoMax[L4D2WeaponId_SniperScout] = iReserveAmmoMax[L4D2WeaponId_SniperMilitary] = cAmmoSniperMax.IntValue;
