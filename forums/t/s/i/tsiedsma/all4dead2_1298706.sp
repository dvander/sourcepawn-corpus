...
public Action:Menu_CreateWeaponMenu(client, args) {
	...
	AddMenuItem(menu, "S6", "Spawn an SG552 Rifle");
	AddMenuItem(menu, "S6", "Spawn an AWP Sniper Rifle");
	AddMenuItem(menu, "S6", "Spawn a Scout Sniper Rifle");
	AddMenuItem(menu, "S6", "Spawn a MP5 SMG");
	DisplayMenu(menu, client, MENU_DISPLAY_TIME);
	return Plugin_Handled;
}
