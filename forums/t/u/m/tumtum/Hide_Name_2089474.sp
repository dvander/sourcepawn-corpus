...
{	
	...
	g_hHideAll = CreateConVar("sm_hidename_hide_all", "0", "If enabled, players will have their name changes hidden from chat, regardless of other settings provided by this plugin. (0 = Disabled, 1 = Enabled)", FCVAR_NONE, true, 0.0, true, 1.0);
