...
public OnPluginStart()
{
	...
	AllowSpawnProtect = true;
}

public Event_RoundStart(Handle:event,const String:name[],bool:dontBroadcast)
{
	CreateTimer(GetConVarFloat(cvarProtectTime), timer_ResetAllowSpawnProtect);
}
...
public Action:timer_ResetAllowSpawnProtect(Handle:timer)
{
	AllowSpawnProtect = false;
}

public Event_PlayerSpawn(Handle:event,const String:name[],bool:dontBroadcast)
{
	if (GetConVarFloat(cvarSpawnProtect) && AllowSpawnProtect)
	{
