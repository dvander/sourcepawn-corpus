...
#define PLUGIN_VERSION				"1.0.0a" // Added admin check for /me command
...
{
	if(!CheckCommandAccess(author, "allow_cmd_me", ADMFLAG_GENERIC))
	{
		PrintToChat(author, "You do not have access to that command");
		return Plugin_Stop; // maybe return Plugin_Handled or Continue
	}
