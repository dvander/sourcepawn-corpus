...
#define UPDATE_URL "http://dl.dropbox.com/u/3266762/AmmoFromDead.txt"
...
public PlaySound(client)
{
	switch(SOUND_PLAY)
	{
		...
		case 2:
		{
			EmitSoundToAll(SOUND_FILE, client, _, _, _, 0.2); // Play sound to all players within range
		}
	}
}
