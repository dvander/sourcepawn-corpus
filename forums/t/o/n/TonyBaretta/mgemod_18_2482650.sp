...
public int TF2Items_OnGiveNamedItem_Post(int client, char[] classname, int index, int level, int quality, int entity)
{
    switch (index)
    {    
		case 59, 46, 163, 1145, 29, 211, 35, 411, 663, 796, 805, 885, 894, 903, 912, 961, 970, 998, 15008, 15010, 15025, 15039, 15050, 415, 589: CreateTimer(0.1, Timer_RemoveEntity, EntIndexToEntRef(entity));
	}
}
