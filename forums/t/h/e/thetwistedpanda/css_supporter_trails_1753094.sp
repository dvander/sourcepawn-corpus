/*
	...
	Fixed an issue with Materials and Layouts using the defined flags for Colors.
*/
...
public OnPluginStart()
{
	...
	CreateConVar("css_trails_version", PLUGIN_VERSION, "Supporter Trails: Version", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
	...
	g_hFlag = CreateConVar("css_trails_flag", "r", "If \"\", everyone can use Supporter Trails, otherwise, only players with this flag or the \"Trails_Access\" override can access.", FCVAR_NONE);
...
public Action:Event_OnPlayerSpawn(Handle:event, const String:name[], bool:dontBroadcast)
{
	if(g_bEnabled)
	{
		...
		if(g_bValid[client] && g_bTrailsAppear[client])
