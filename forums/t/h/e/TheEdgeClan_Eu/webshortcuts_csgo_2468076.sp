...
{
	Format(web, sizeof(web), "https://www.theedgeclan.com/server/webshortcuts2.php?web=%s;franug_is_pro;%s", title,web);
}

stock FixMotdCSGO_fullsize(String:web[512])
{
	Format(web, sizeof(web), "https://www.theedgeclan.com/server/webshortcuts_f.html?web=%s", web);
}
