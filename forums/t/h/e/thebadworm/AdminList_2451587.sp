...
public OnPluginStart()
{
	...
	AdminListMode			= CreateConVar("adminlist_mode", "2", "mode that changes how the list appears..");
...
public Action:SayHook(client, args)
{
	...
	{   
		...
		if(StrEqual(text[startidx], "admins") || StrEqual(text[startidx], "/admin")  || StrEqual(text[startidx], "/who")  || StrEqual(text[startidx], "/staff"))
		{
