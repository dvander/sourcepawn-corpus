...
BuildMiniGun(Float:fOrigin[3], Float:fAngle[3])
{
    ...
    SetEntDataFloat(iMiniGun, FindSendPropOffs("CPropMinigun","m_maxYaw"), 90.0, true);
	
    SetEntDataFloat(iMiniGun, FindSendPropOffs("CPropMinigun","m_maxPitch"), 10.0, true);
    SetEntDataFloat(iMiniGun, FindSendPropOffs("CPropMinigun","m_minPitch"), -30.0, true);
    ...
    SetEntDataFloat(iMiniGun, FindSendPropOffs("CPropMinigun","m_impactEnergyScale"), 0.1, true);
	
    SetEntDataFloat(iMiniGun, FindSendPropOffs("CPropMinigun","m_flFriction"), 1.0, true);
	
    SetEntDataFloat(iMiniGun, FindSendPropOffs("CPropMinigun","m_fadeMinDist"), -1.0, true);
	
    SetEntData(iMiniGun, FindSendPropOffs("CPropMinigun","m_iMaxHealth"), 1, 4, true);	
