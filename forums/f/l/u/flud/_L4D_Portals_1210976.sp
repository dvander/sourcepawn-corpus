...
public OnPluginStart()
{
	...
	cv_PortalMDL = CreateConVar("sm_portals_model","models/props_equipment/phone_booth.mdl", "Portal model", FCVAR_PLUGIN|FCVAR_NOTIFY);

	cv_sndPortalGO = CreateConVar("sm_portals_soundgo","ambient/atmosphere/hole_hit4.wav", "Sound when someone teleported", FCVAR_PLUGIN|FCVAR_NOTIFY);
	...
	cv_sndPortalFX = CreateConVar("sm_portals_soundfx","UI/helpful_event_1.wav", "Sound if teleport used", FCVAR_PLUGIN|FCVAR_NOTIFY);
