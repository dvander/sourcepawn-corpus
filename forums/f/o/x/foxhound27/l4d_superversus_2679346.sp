...
void SpawnCheck()
{
	...
	if (iSurvivor > iSurvivorMax) PrintConsoleToAll("[SV] Kicking %d bot(s)", iSurvivor - iSurvivorMax);
	if (iSurvivor < iSurvivorLim) PrintConsoleToAll("[SV] Spawning %d bot(s)", iSurvivorLim - iSurvivor);
