...
<!-- saved from url=(0079)https://raw.github.com/foobarhl/sourcemod/master/scripting/quakesounds_hl2dm.sp -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css"></style></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">#include &lt;sourcemod&gt;
#include &lt;sdktools&gt;
#include &lt;clientprefs&gt;
#include &lt;sdkhooks&gt;
