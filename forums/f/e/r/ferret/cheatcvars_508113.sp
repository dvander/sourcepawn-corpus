/**
 * cheatcvars.sp
 * Lets you enable individual cheat cvars through addons/sourcemod/configs/cheatcvars.txt
...
public Plugin:myinfo = 
{
	...
	description = "Enables cheat vars without sv_cheats",
	version = "1.0.0.0",
...
public OnConfigsExecuted()
{
	...
	BuildPath(Path_SM, path, sizeof(path), "configs/cheatcvars.txt");
