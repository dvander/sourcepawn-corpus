...
CountPlayers()
{
	...
	{
		if (IsClientConnected(i) && IsClientInGame(i) && (GetClientTeam(i)==2 || GetClientTeam(i)==1))
		{
			PlayerCount++;
		}
	}
	...
	if (Enabled)
	{
		...
		switch (PlayerCount)
		{
			case 0:
			{
			   ...
			   SetConVarInt(FindConVar("mt_health_regular_coop"), 8000);
			   ...
			   SetConVarInt(FindConVar("mt_count_escapestart_coop"), 1);
			   SetConVarInt(FindConVar("mt_health_escapestart_coop"), 8000);
			   
			   SetConVarFloat(FindConVar("director_pain_pill_density"), 6.48);
			   
			   SetConVarInt(FindConVar("director_threat_clear_radius"), 500); //DIMINUIR
			   
			   SetConVarFloat(FindConVar("z_wandering_density"), 0.03); //AUMENTAR
			   SetConVarInt(FindConVar("director_num_reserved_wanderers"), 5); //AUMENTAR
			   SetConVarInt(FindConVar("z_reserved_wanderers"), 5); //AUMENTAR
			   
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold"), 0.3); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_hard"), 0.5); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_expert"), 0.8); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_threshold"), 0.9); //DIMINUIR			   
			   SetConVarFloat(FindConVar("director_intensity_threshold"), 0.9); //DIMINUIR
			   SetConVarFloat(FindConVar("intensity_factor"), 0.25); //AUMENTAR
			   
			   SetConVarInt(FindConVar("director_relax_min_interval"), 30); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_interval"), 45); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_flow_travel"), 3000); //DIMINUIR			   
			}
			case 1:
			{
			   SILimit = 4;
			   ...
			   SetConVarFloat(FindConVar("director_pain_pill_density"), 6.48); //6.48
			...
			case 5:
			{
			   ...
			   SpawnLimits[SI_BOOMER] = 2;
			   SpawnLimits[SI_HUNTER] = 1;
			   SpawnLimits[SI_SMOKER] = 1;
			   SpawnLimits[SI_CHARGER] = 1;
			   SpawnLimits[SI_JOCKEY] = 1;
			   SpawnLimits[SI_SPITTER] = 2;
			   WitchLimit = 2;
			   WitchPeriod = 400.0;
			   ...
			   SetConVarInt(FindConVar("z_mega_mob_spawn_min_interval"), 420);
			   SetConVarInt(FindConVar("z_mega_mob_spawn_max_interval"), 900);
			   SetConVarInt(FindConVar("z_mega_mob_size"), 62);
			   ...
			   SetConVarFloat(FindConVar("director_pain_pill_density"), 12.96); //6.48
			   SetConVarFloat(FindConVar("director_defibrillator_density"), 7.48); //6.48
			   
			   SetConVarInt(FindConVar("director_threat_clear_radius"), 400); //DIMINUIR
			   
			   SetConVarFloat(FindConVar("z_wandering_density"), 0.04); //AUMENTAR
			   SetConVarInt(FindConVar("director_num_reserved_wanderers"), 10); //AUMENTAR
			   SetConVarInt(FindConVar("z_reserved_wanderers"), 10); //AUMENTAR
			   
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold"), 0.27); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_hard"), 0.47); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_expert"), 0.77); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_threshold"), 0.87); //DIMINUIR			   
			   SetConVarFloat(FindConVar("director_intensity_threshold"), 0.87); //DIMINUIR
			   SetConVarFloat(FindConVar("intensity_factor"), 0.30); //AUMENTAR
			   
			   SetConVarInt(FindConVar("director_relax_min_interval"), 30); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_interval"), 40); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_flow_travel"), 2750); //DIMINUIR
			...
			case 6:
			{
			   ...
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_hard"), 90);
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_expert"), 90);
			   SetConVarInt(FindConVar("z_mega_mob_spawn_min_interval"), 320);
			   SetConVarInt(FindConVar("z_mega_mob_spawn_max_interval"), 800);
			   SetConVarInt(FindConVar("z_mega_mob_size"), 62);
			   ...
			   SetConVarFloat(FindConVar("director_pain_pill_density"), 19.48); //6.48
			   
			   SetConVarInt(FindConVar("director_threat_clear_radius"), 300); //DIMINUIR
			   
			   SetConVarFloat(FindConVar("z_wandering_density"), 0.05); //AUMENTAR
			   SetConVarInt(FindConVar("director_num_reserved_wanderers"), 15); //AUMENTAR
			   SetConVarInt(FindConVar("z_reserved_wanderers"), 15); //AUMENTAR
			   
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold"), 0.24); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_hard"), 0.44); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_expert"), 0.74); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_threshold"), 0.84); //DIMINUIR			   
			   SetConVarFloat(FindConVar("director_intensity_threshold"), 0.84); //DIMINUIR
			   SetConVarFloat(FindConVar("intensity_factor"), 0.35); //AUMENTAR
			   
			   SetConVarInt(FindConVar("director_relax_min_interval"), 25); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_interval"), 40); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_flow_travel"), 2500); //DIMINUIR
			}
			case 7:
			{
			   SILimit = 10;
			   ...
			   SpawnLimits[SI_BOOMER] = 3;
			   SpawnLimits[SI_HUNTER] = 2;
			   SpawnLimits[SI_SMOKER] = 2;
			   SpawnLimits[SI_CHARGER] = 2;
			   SpawnLimits[SI_JOCKEY] = 2;
			   SpawnLimits[SI_SPITTER] = 2;
			   WitchLimit = 3;
			   WitchPeriod = 350.0;
			   ...
			   SetConVarInt(FindConVar("z_mob_spawn_min_interval_expert"), 90);
			   SetConVarInt(FindConVar("z_mega_mob_spawn_min_interval"), 320);
			   SetConVarInt(FindConVar("z_mega_mob_spawn_max_interval"), 700);
			   SetConVarInt(FindConVar("z_mega_mob_size"), 62);
			   ...
			   SetConVarFloat(FindConVar("director_pain_pill_density"), 25.48); //6.48
			   
			   SetConVarInt(FindConVar("director_threat_clear_radius"), 200); //DIMINUIR
			   
			   SetConVarFloat(FindConVar("z_wandering_density"), 0.06); //AUMENTAR
			   SetConVarInt(FindConVar("director_num_reserved_wanderers"), 20); //AUMENTAR
			   SetConVarInt(FindConVar("z_reserved_wanderers"), 20); //AUMENTAR
			   
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold"), 0.21); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_hard"), 0.41); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_expert"), 0.71); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_threshold"), 0.81); //DIMINUIR			   
			   SetConVarFloat(FindConVar("director_intensity_threshold"), 0.81); //DIMINUIR
			   SetConVarFloat(FindConVar("intensity_factor"), 0.40); //AUMENTAR
			   
			   SetConVarInt(FindConVar("director_relax_min_interval"), 25); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_interval"), 35); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_flow_travel"), 2250); //DIMINUIR
			}
			case 8:
			{
			   SILimit = 12;
			   ...
			   SpawnLimits[SI_BOOMER] = 3;
			   SpawnLimits[SI_HUNTER] = 3;
			   SpawnLimits[SI_SMOKER] = 2;
			   SpawnLimits[SI_CHARGER] = 2;
			   SpawnLimits[SI_JOCKEY] = 2;
			   SpawnLimits[SI_SPITTER] = 3;
			   WitchLimit = -3;
			   WitchPeriod = 300.0;
			   ...
			   SetConVarInt(FindConVar("mt_count_regular_coop"), 3);
			   SetConVarInt(FindConVar("mt_health_regular_coop"), 8000);
			   ...
			   SetConVarFloat(FindConVar("director_pain_pill_density"), 32.48); //6.48
			   
			   SetConVarInt(FindConVar("director_threat_clear_radius"), 100); //DIMINUIR
			   
			   SetConVarFloat(FindConVar("z_wandering_density"), 0.07); //AUMENTAR
			   SetConVarInt(FindConVar("director_num_reserved_wanderers"), 25); //AUMENTAR
			   SetConVarInt(FindConVar("z_reserved_wanderers"), 25); //AUMENTAR
			   
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold"), 0.18); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_hard"), 0.38); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_expert"), 0.68); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_threshold"), 0.78); //DIMINUIR			   
			   SetConVarFloat(FindConVar("director_intensity_threshold"), 0.78); //DIMINUIR
			   SetConVarFloat(FindConVar("intensity_factor"), 0.45); //AUMENTAR
			   
			   SetConVarInt(FindConVar("director_relax_min_interval"), 20); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_interval"), 35); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_flow_travel"), 2000); //DIMINUIR
			}
			case 9:
			{
			   SILimit = 14;
			   ...
			   SpawnLimits[SI_BOOMER] = 3;
			   SpawnLimits[SI_HUNTER] = 3;
			   SpawnLimits[SI_SMOKER] = 3;
			   SpawnLimits[SI_CHARGER] = 3;
			   SpawnLimits[SI_JOCKEY] = 3;
			   SpawnLimits[SI_SPITTER] = 3;
			   WitchLimit = 3;
			   WitchPeriod = 300.0;
			   ...
			   SetConVarFloat(FindConVar("director_pain_pill_density"), 38.48); //6.48
			   
			   SetConVarInt(FindConVar("director_threat_clear_radius"), 100); //DIMINUIR
			   
			   SetConVarFloat(FindConVar("z_wandering_density"), 0.1); //AUMENTAR
			   SetConVarInt(FindConVar("director_num_reserved_wanderers"), 30); //AUMENTAR
			   SetConVarInt(FindConVar("z_reserved_wanderers"), 30); //AUMENTAR
			   
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold"), 0.15); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_hard"), 0.35); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_expert"), 0.65); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_threshold"), 0.75); //DIMINUIR			   
			   SetConVarFloat(FindConVar("director_intensity_threshold"), 0.75); //DIMINUIR
			   SetConVarFloat(FindConVar("intensity_factor"), 0.50); //AUMENTAR
			   
			   SetConVarInt(FindConVar("director_relax_min_interval"), 20); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_interval"), 30); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_flow_travel"), 1750); //DIMINUIR
			}
			case 10:
			{
			   SILimit = 14;
			   ...
			   SetConVarInt(FindConVar("mt_count_finalestart2_coop"), 3);
			   SetConVarInt(FindConVar("mt_health_finalestart2_coop"), 12000);
			   SetConVarInt(FindConVar("mt_count_escapestart_coop"), 2);
			   SetConVarInt(FindConVar("mt_health_escapestart_coop"), 12000);
			   
			   SetConVarFloat(FindConVar("director_pain_pill_density"), 44.48); //6.48
			   ...
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold"), 0.12); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_hard"), 0.32); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_expert"), 0.62); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_threshold"), 0.72); //DIMINUIR			   
			   SetConVarFloat(FindConVar("director_intensity_threshold"), 0.72); //DIMINUIR
			   SetConVarFloat(FindConVar("intensity_factor"), 0.55); //AUMENTAR
			   
			   SetConVarInt(FindConVar("director_relax_min_interval"), 15); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_interval"), 30); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_flow_travel"), 1500); //DIMINUIR
			}
			case 11:
			{
			   SILimit = 14;
			   ...
			   SetConVarInt(FindConVar("mt_count_regular_coop"), 3);
			   SetConVarInt(FindConVar("mt_health_regular_coop"), 14000);
			   SetConVarInt(FindConVar("mt_count_finalestart_coop"), 3);
			   SetConVarInt(FindConVar("mt_health_finale_coop"), 14000);
			   SetConVarInt(FindConVar("mt_count_finale_coop"), 2);
			   SetConVarInt(FindConVar("mt_health_finalestart_coop"), 14000);
			   SetConVarInt(FindConVar("mt_count_finalestart2_coop"), 3);
			   SetConVarInt(FindConVar("mt_health_finalestart2_coop"), 14000);
			   SetConVarInt(FindConVar("mt_count_escapestart_coop"), 2);
			   SetConVarInt(FindConVar("mt_health_escapestart_coop"), 14000);
			   
			   SetConVarFloat(FindConVar("director_pain_pill_density"), 50.48); //6.48
			   ...
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold"), 0.09); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_hard"), 0.29); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_expert"), 0.59); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_threshold"), 0.69); //DIMINUIR			   
			   SetConVarFloat(FindConVar("director_intensity_threshold"), 0.69); //DIMINUIR
			   SetConVarFloat(FindConVar("intensity_factor"), 0.60); //AUMENTAR
			   
			   SetConVarInt(FindConVar("director_relax_min_interval"), 15); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_interval"), 25); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_flow_travel"), 1250); //DIMINUIR
			}
			case 12:
			{
			   SILimit = 14;
			   ...
			   SetConVarInt(FindConVar("mt_count_finale_coop"), 2);
			   SetConVarInt(FindConVar("mt_health_finalestart_coop"), 16000);
			   SetConVarInt(FindConVar("mt_count_finalestart2_coop"), 3);
			   SetConVarInt(FindConVar("mt_health_finalestart2_coop"), 16000);
			   SetConVarInt(FindConVar("mt_count_escapestart_coop"), 2);
			   SetConVarInt(FindConVar("mt_health_escapestart_coop"), 16000);
			   
			   SetConVarFloat(FindConVar("director_pain_pill_density"), 56.48); //6.48
			   ...
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold"), 0.06); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_hard"), 0.26); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_expert"), 0.56); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_threshold"), 0.66); //DIMINUIR			   
			   SetConVarFloat(FindConVar("director_intensity_threshold"), 0.66); //DIMINUIR
			   SetConVarFloat(FindConVar("intensity_factor"), 0.65); //AUMENTAR
			   
			   SetConVarInt(FindConVar("director_relax_min_interval"), 10); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_interval"), 25); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_flow_travel"), 1000); //DIMINUIR
			}
			case 13:
			{
			   SILimit = 14;
			   ...
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold"), 0.03); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_hard"), 0.23); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_expert"), 0.53); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_threshold"), 0.63); //DIMINUIR			   
			   SetConVarFloat(FindConVar("director_intensity_threshold"), 0.63); //DIMINUIR
			   SetConVarFloat(FindConVar("intensity_factor"), 0.70); //AUMENTAR
			   
			   SetConVarInt(FindConVar("director_relax_min_interval"), 10); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_interval"), 20); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_flow_travel"), 750); //DIMINUIR
			}
			case 14:
			{
			   SILimit = 14;
			   ...
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold"), 0.03); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_hard"), 0.20); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_expert"), 0.50); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_threshold"), 0.60); //DIMINUIR			   
			   SetConVarFloat(FindConVar("director_intensity_threshold"), 0.60); //DIMINUIR
			   SetConVarFloat(FindConVar("intensity_factor"), 0.75); //AUMENTAR
			   
			   SetConVarInt(FindConVar("director_relax_min_interval"), 10); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_interval"), 15); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_flow_travel"), 500); //DIMINUIR
			}
			case 15:
			{
			   SILimit = 14;
			   ...
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold"), 0.03); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_hard"), 0.15); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_expert"), 0.45); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_threshold"), 0.55); //DIMINUIR			   
			   SetConVarFloat(FindConVar("director_intensity_threshold"), 0.55); //DIMINUIR
			   SetConVarFloat(FindConVar("intensity_factor"), 0.80); //AUMENTAR
			   
			   SetConVarInt(FindConVar("director_relax_min_interval"), 7); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_interval"), 10); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_flow_travel"), 250); //DIMINUIR
			}
			case 16:
			{
			   SILimit = 14;
			   ...
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold"), 0.03); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_hard"), 0.10); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_allow_wanderers_threshold_expert"), 0.40); //DIMINUIR
			   SetConVarFloat(FindConVar("director_intensity_relax_threshold"), 0.50); //DIMINUIR			   
			   SetConVarFloat(FindConVar("director_intensity_threshold"), 0.50); //DIMINUIR
			   SetConVarFloat(FindConVar("intensity_factor"), 0.85); //AUMENTAR
			   
			   SetConVarInt(FindConVar("director_relax_min_interval"), 5); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_interval"), 7); //DIMINUIR
			   SetConVarInt(FindConVar("director_relax_max_flow_travel"), 250); //DIMINUIR
			}
