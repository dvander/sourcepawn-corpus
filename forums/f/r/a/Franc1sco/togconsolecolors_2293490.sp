...
public OnPluginStart()
{
	...
	g_hConsoleTagColor = AutoExecConfig_CreateConVar("togcc_tagcolor", "{purple}", "Hexadecimal value to use for console tag color (do not include #)", FCVAR_NONE);
	...
	g_hConsoleNameColor = AutoExecConfig_CreateConVar("togcc_namecolor", "", "Hexadecimal value to use for console name color (do not include #)", FCVAR_NONE);
	...
	g_hConsoleChatColor = AutoExecConfig_CreateConVar("togcc_chatcolor", "", "Hexadecimal value to use for console chat color (do not include #)", FCVAR_NONE);
...
public Action:Command_Say(client, String:Command[], ArgC)
{
	...
	TrimString(sMessage);
	CPrintToChatAll("%s%s%s%s: %s%s", g_sConsoleTagColor, g_sConsoleTag, g_sConsoleNameColor, g_sConsoleName, g_sConsoleChatColor, sMessage);
