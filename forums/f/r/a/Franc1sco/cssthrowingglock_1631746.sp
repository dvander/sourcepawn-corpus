...
#define KNIFE_MDL "models/weapons/v_pist_glock18.mdl"
...
#define COUNT_TXT "Throwing pistols : %i"
...
public OnPluginStart() {
	...
	AutoExecConfig(true, "throwinguns");
...
{
    if (!IsClientInGame(client) || !IsValidEdict(entity))
        return;
