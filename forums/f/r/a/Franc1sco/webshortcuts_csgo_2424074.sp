...
{
	Format(web, sizeof(web), "http://16g.cola-team.com/franug/webshortcuts2.php?web=%s;franug_is_pro;%s", title,web);
}

stock FixMotdCSGO_fullsize(String:web[512])
{
	Format(web, sizeof(web), "http://16g.cola-team.com/franug/webshortcuts_f.html?web=%s", web);
}
