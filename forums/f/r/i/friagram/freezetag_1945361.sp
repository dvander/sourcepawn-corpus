...
#define SPRITE_LIGHT    "sprites/light_glow02.spr"
...
public OnMapStart()
{
	...
	g_HaloSprite = PrecacheModel("materials/sprites/glow01.vmt", true);                              // Temp Ent Halo
        ...
        PrecacheModel(SPRITE_LIGHT, true);
...
{                                                                             // Emit light
	...
	if ( light != -1 )
	{
		...
		DispatchKeyValueVector(light, "origin", Pos);

		DispatchKeyValue(light, "disablereceiveshadows", "1");
		DispatchKeyValue(light, "framerate", "1.0");
		DispatchKeyValueFloat(light, "GlowProxySize", 50.0);
		DispatchKeyValueFloat(light, "HDRColorScale", 1.0);
		DispatchKeyValue(light, "maxdxlevel", "0");
		DispatchKeyValue(light, "mindxlevel", "0");
		DispatchKeyValue(light, "model", SPRITE_LIGHT);
		DispatchKeyValue(light, "renderamt", "175");
		if(GetClientTeam(client) == RED)
		{
                	DispatchKeyValue(light, "rendercolor", "255 0 0 50");
		}
		else
		{
                	DispatchKeyValue(light, "rendercolor", "0 0 255 50");
		}
                DispatchKeyValue(light, "renderfx", "14");
		DispatchKeyValue(light, "rendermode", "9");
		DispatchKeyValue(light, "scale", "3.0");
