// removed medigun chargemeter code
// removed superfluous dropflag function
// changed entity spawning code
...
{                                                                             // Emit light
	...
	if ( light != -1 )
	{
		decl Float:Pos[3];
		GetClientAbsOrigin(client, Pos);
		Pos[2] += PARTICLEZ;                                          // Move light to gonadal region
...
/*
createIceLight(client, parent, time)                                          // env_sprite causes too many ents created
{                                                                             // Emit light
