...
public OnPluginStart()
{
	...
	cvarMinHealth = CreateConVar("sm_hpregeneration_minhealth", "1", "Min health to regenerate to, based on the control mode (Def 1)", FCVAR_PLUGIN, true, 1.0, false, _);
...
public Action:RegenTick(Handle:timer, any:client)
{
	...
	if (Mode)
	{
		...
		{	
			if (clientHp > GetConVarInt(cvarMinHealth))
			{
