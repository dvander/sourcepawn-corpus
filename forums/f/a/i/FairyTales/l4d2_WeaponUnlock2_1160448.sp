...
public OnPluginStart()
{
	...
	h_M60Enabled = CreateConVar("l4d2_wu_m60", "1", "Enable M60 Machine Gun?", FCVAR_PLUGIN)
...
//	h_BatterUp = CreateConVar("l4d2_wu_bat", "1", "Spawn baseball bats for survivors?", FCVAR_PLUGIN)
//	h_GolfUp = CreateConVar("l4d2_wu_golf", "1", "Spawn Golf Club for survivors?", FCVAR_PLUGIN)
...
//				case RIFLE_DESERT: if ((GetConVarInt(h_SG552Enabled) == 1) && (GetRandomInt(1, 5) == 1)) WeaponSpawn_IDMod[i] = RIFLE_SG552;
				case RIFLE_DESERT: if ((GetConVarInt(h_M60Enabled) == 1) && (GetRandomInt(1, 5) == 1)) WeaponSpawn_IDMod[i] = RIFLE_M60;
...
//				case RIFLE: if ((GetConVarInt(h_SG552Enabled) == 1) && (GetRandomInt(1, 5) == 1)) WeaponSpawn_IDMod[i] = RIFLE_SG552;
				case RIFLE: if ((GetConVarInt(h_M60Enabled) == 1) && (GetRandomInt(1, 5) == 1)) WeaponSpawn_IDMod[i] = RIFLE_M60;
			...
			switch(WeaponSpawn_ID[i])
			{
				...
				case RIFLE_AK47:
					if (GetConVarInt(h_SG552Enabled) == 1)
					{
						...
						{
							case 4: WeaponSpawn_IDMod[i] = RIFLE;
							case 3: WeaponSpawn_IDMod[i] = RIFLE_DESERT;
							case 2: WeaponSpawn_IDMod[i] = RIFLE_SG552;
							case 1: WeaponSpawn_IDMod[i] = RIFLE_M60;
						}
					}
					else
					{
				...
				case SNIPER_MILITARY: if ((GetConVarInt(h_AWPEnabled) == 1) && (GetRandomInt(1, 2) == 1)) WeaponSpawn_IDMod[i] = SNIPER_AWP;
				case RIFLE_DESERT:
					if (GetConVarInt(h_M60Enabled) == 1)
					{
						switch(GetRandomInt(1, 5))
						{
							case 4: WeaponSpawn_IDMod[i] = RIFLE;
				...
				case RIFLE:
					if (GetConVarInt(h_M60Enabled) == 1)
					{
						switch(GetRandomInt(1, 5))
						{
							case 4: WeaponSpawn_IDMod[i] = RIFLE_AK47;
							case 3: WeaponSpawn_IDMod[i] = RIFLE_DESERT;
							case 2: WeaponSpawn_IDMod[i] = RIFLE_SG552;
							case 1: WeaponSpawn_IDMod[i] = RIFLE_M60;
						}
				...
				for (new x = 0; x < sizeof(WeaponSpawn_ID); x++)
				{
					...
					(weaponID != WeaponSpawn_ID[x]))
					{
						...
						switch(WeaponSpawn_ID[x])
						{
							...
							case VOMITJAR: SetEntityModel(index, "models/w_models/weapons/w_eq_bile_flask.mdl");
...
{	
	...
	switch(WeaponSpawn_IDMod[source])
	{
		...
		case RIFLE_M60: SetEntityModel(index, "models/w_models/weapons/w_m60.mdl");
