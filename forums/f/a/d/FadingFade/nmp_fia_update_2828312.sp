...
stock GetWeaponClipSize( iEntity )
{
	...
	if( hItemsData == INVALID_HANDLE )
	{
		if(
			...
			|| StrEqual( szClassname, "fa_sako85_ironsights")
			|| StrEqual( szClassname, "fa_superx3" )
		)
			return 5;
		else if(
			StrEqual( szClassname, "fa_sw686" )
			|| StrEqual( szClassname, "fa_500a" )
		)
			return 6;
			...
			|| StrEqual( szClassname, "fa_sks_nobayo")
		)
			return 10;
		else if(
			...
			StrEqual( szClassname, "fa_1022_25mag" )
		)
			return 25;
		else if(
			StrEqual( szClassname, "fa_cz858" )
			|| StrEqual( szClassname, "fa_m16a4" )
			|| StrEqual( szClassname, "fa_m16a4_carryhandle")
			...
			return 100;
		else if( StrEqual( szClassname, "me_abrasivesaw" ) )
			return 80;
	}
	else
	{
