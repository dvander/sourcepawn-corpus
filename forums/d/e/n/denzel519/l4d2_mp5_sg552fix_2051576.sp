...
{
	name = "[L4D2] mp5 Reload Fix",
	author = "C64",
	description = "Fixes the reload time of mp5",
...
public OnPluginStart()
{
	...
	CreateConVar("l4d2_mp5fix_version", PLUGIN_VERSION, "Installed version of mp5 Reload Fix on this server", FCVAR_PLUGIN|FCVAR_NOTIFY|FCVAR_DONTRECORD|FCVAR_REPLICATED);
...
public Action:Event_ReloadStart(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if(StrContains(classname, "mp5", false) > -1)
	{
