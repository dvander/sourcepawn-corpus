...
public OnPluginStart()
{
	//+++++ Cvars +++++
	//Versionnumber
	CreateConVar("epiclite_version", PLUGIN_VERSION, "Epiclite version", CVAR_FLAGS)
...
Description(client)
{
	PrintToConsole(client, "Epiclite adds:")
	PrintToConsole(client, "- Round statistics like killed zombies")
