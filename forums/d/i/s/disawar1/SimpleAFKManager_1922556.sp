#define PLUGIN_VERSION "1.1 coop"
...
static	 Handle:g_hAutoKick, Handle:g_hKickT, Handle:g_hAdmin, Handle:g_hSlay, Float:g_fCvarKickT, g_iCvarAdmFlag, Handle:g_hTimer[MAXPLAYERS+1];
...
public OnPluginStart()
{
	...
	g_hSlay	= CreateConVar("sam_force_slay", "0", _, _, true, 0.0, true, 1.0);
...
public Action:SAM_t_ActionKick(Handle:timer, any:client)
{
	...
	if (GetConVarBool(g_hSlay)){

		PrintToChat(client, "You away from keyboard for %.1f sec", g_fCvarKickT);
