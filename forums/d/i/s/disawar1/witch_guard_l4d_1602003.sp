...
new Handle:l4d_witch_plugin_enable; 
new Handle:l4d_witch_guard_enable; 
...
public OnPluginStart()
{
	...
	l4d_witch_plugin_enable = CreateConVar("l4d_witch_plugin_enable", "1", "0=Off, 1=Plugin on.", FCVAR_PLUGIN);
	l4d_witch_guard_enable = CreateConVar("l4d_witch_guard_enable", "1", "0=Off, 1=Enable witch put down.", FCVAR_PLUGIN);
...
{ 
	if (GetConVarBool(l4d_witch_plugin_enable)==0)
	return  Plugin_Continue;
...
{ 
	new dummy = CreateEntityByName("pipe_bomb_projectile");	 
...
{
	if (GetConVarBool(l4d_witch_guard_enable)==0)
	return;
