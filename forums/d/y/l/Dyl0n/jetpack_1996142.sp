...
{ 
    ...
    RegAdminCmd("sm_jp", OnToggleJetpack, ADMFLAG_RESERVATION, "Toggles jetpack on/off");
    RegAdminCmd("sm_jetpack", OnToggleJetpack, ADMFLAG_RESERVATION, "Toggles jetpack on/off");
