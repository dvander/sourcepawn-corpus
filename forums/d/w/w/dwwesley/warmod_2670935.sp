...
public void OnPluginStart()
{
	...
	RegAdminCmd("knives", KnifeOn3, ADMFLAG_CUSTOM1, "Remove all weapons except knife and lo3");
...
public Action Lo3Timer(Handle timer)
{
	ServerCommand("mp_unpause_match 1");
	ServerCommand("mp_restartgame 1");
	PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 %t", CHAT_PREFIX, "partida iniciando em 3");
	LiveOn2 = true;
	ServerCommand("mp_teamname_1 %s", g_ct_name);
	ServerCommand("mp_teamname_2 %s", g_t_name);
	g_t_pause_count = 0;
...
static void LiveText() {
	if (LiveOn2) {
		...
		LiveOn1 = true;
		ServerCommand("mp_restartgame 1");
		PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 %t", CHAT_PREFIX, "partida iniciando em 2");
	} else if (LiveOn1) {
		LiveOn1 = false;
		LiveOn3Text = true;
		ServerCommand("mp_restartgame 3");
		PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 %t", CHAT_PREFIX, "partida iniciando em 1");
	} else if(LiveOn3Text) {
		LiveOn3Text = false;
		PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 %t", CHAT_PREFIX, "Valendo");
		PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 %t", CHAT_PREFIX, "Boa sorte");
		PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 %t \x03WarMod [BFG]", CHAT_PREFIX, "Powered By SMOKINGRED®");
		...
		KnifeOn1 = true;
		ServerCommand("mp_restartgame 1");
		PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 %t", CHAT_PREFIX, "Faca em 2");
	} else if(KnifeOn1) {
		KnifeOn1 = false;
		KnifeOn3Text = true;
		ServerCommand("mp_restartgame 3");
		PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 %t", CHAT_PREFIX, "Faca em 1");
	} else if(KnifeOn3Text) {
		KnifeOn3Text = false;
		if (GetConVarBool(wm_knife_zeus)) {
			PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 \x02%t", CHAT_PREFIX, "Zeus");
			PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 \x02%t", CHAT_PREFIX, "FACA");
			PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 %t", CHAT_PREFIX, "Boa sorte");
			PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 %t \x03WarMod [BFG]", CHAT_PREFIX, "Powered By SMOKINGRED®");
		} else {
			PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 \x02%t", CHAT_PREFIX, "FACA");
...
stock bool KnifeOn3Override()
{
	...
	{
		ServerCommand("mp_restartgame 1");
		PrintToChatAll("\x01 \x09[\x04%s\x09]\x01 %t", CHAT_PREFIX, "Faca em 3");
		KnifeOn2 = true;
