...
#define MODEL_PRESENT "models/effects/props_halloween/pumpkin_loot.mdl"
...
stock BuildSentry(iBuilder, Float:fOrigin[3], Float:fAngle[3], iLevel=1)
{
	...
	if (IsValidEdict(iSentry)) {
		...
		SetEntDataEnt2(iSentry, FindSendPropOffs("CObjectSentrygun","m_nSeentInKickQueue(param1)) {
			DisplayGiveEffectTargetMenu(param1, GetMenuSelectionPosition());
		}
	}
}
