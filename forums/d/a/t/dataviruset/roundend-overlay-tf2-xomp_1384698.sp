...
#define PLUGIN_VERSION	 "1.02-xomp"
...
{
	RegConsoleCmd("sm_overlay1", Command_Overlay1);
	RegConsoleCmd("sm_overlay2", Command_Overlay2);
...
public Action:Command_Overlay1(client, args)
{
	decl String:overlaypath[PLATFORM_MAX_PATH];
	GetConVarString(sm_roundend_overlay_red, overlaypath, sizeof(overlaypath));
...
public Action:Command_Overlay2(client, args)
{
	decl String:overlaypath[PLATFORM_MAX_PATH];
	GetConVarString(sm_roundend_overlay_blue, overlaypath, sizeof(overlaypath));
	ShowOverlayToClient(client, overlaypath);
