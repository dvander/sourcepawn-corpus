...
public OnPluginStart(){
	...
	cvarsoundwarn = CreateConVar("sm_sound_warn","40","Number of sounds to warn person at",FCVAR_PLUGIN);
	cvarsoundlimit = CreateConVar("sm_sound_limit","50","Maximum sounds per person",FCVAR_PLUGIN);
