...
public void OnPluginStart()
{
	...
	RegAdminCmd("sm_stealth", Command_Stealth, ADMFLAG_BAN);
	RegAdminCmd("sm_spec", Command_Stealth, ADMFLAG_BAN);
...
public Action Command_Stealth(int client, int args)
{
	...
	if (speclist_stealth[client] == false)
		ReplyToCommand(client, "\x01[\x02SpecList\x01] Zostaniesz teraz pokazany na speclist.");
