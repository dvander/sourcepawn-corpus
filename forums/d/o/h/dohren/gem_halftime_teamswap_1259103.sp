...
//********************
//mod by Dohren
//extra time in round start, the players understand the swap :)
  if (g_roundCount == 11){
...
//  new CTScore, TScore;
  ...
  //my mod else
  //*************************************************************************************
  else if ((g_roundCount>=11) && StrEqual("maxrounds", g_HalfTimeType)) { 
  //************************************************************************************
  ...
  if(doSwap && (halftime == false)) {
    ...
    //**************************
    //new code
    ServerCommand("mp_restartgame 5");  //reset the scores
    ServerCommand("mp_maxrounds 10");  //if not set, the second half is 20 rounds, because in the server.cfg: mp_maxrounds 20
    //**************************
