...
public OnPluginStart()
{
	...
	RegAdminCmd("rtf_reload_rules", Command_ReloadRules, ADMFLAG_RCON, "Reload the rules and Recreate the menus.");
...
//Returns the correct map for CSGO
 ...
 stock ClearTargetInfo(iClient)
 {
	 g_szTargetName[iClient][0] = '\0';
	 g_szTargetAuthID[iClient][0] = '\0';
	 g_szTargetIP[iClient][0] = '\0';
	 g_szCategory[iClient][0] = '\0';
	 g_szReason[iClient][0] = '\0';
	 g_szSafeDescription[iClient][0] = '\0';
 }
