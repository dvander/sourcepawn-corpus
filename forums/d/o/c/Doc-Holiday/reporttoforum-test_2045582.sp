...
new const String:PLUGIN_VERSION[] = "1.1.6g";
...
public CreateReportThread(iClient)
{
	...
	LogMessage("Create Thread: %s", szSQLQuery);
...
public FindCorrectThread(iClient)
{
	...
	LogMessage("Get Thread ID: %s", szSQLQuery);
...
public CreateThreadPost(iClient)
{
	...
	LogMessage("Insert Post Message: %s", szSQLQuery);
...
public GetPostId(iClient)
{
	...
	LogMessage("Select Post ID: %s", szSQLQuery);
...
public SetPostId(iClient)
{
	...
	LogMessage("Update Thread Count: %s", szSQLQuery);
...
public GetCurrentForumPostData(iClient)
{
	...
	LogMessage("Get User Post Count: %s", szSQLQuery);
...
public UpdateForumPostCount(iClient, iPostCount, iThreadCount)
{
	...
	LogMessage("Set User Post Count: %s", szSQLQuery);
...
public GetUserPostInfo(iClient)
{
	...
	LogMessage("Get Forum Post Count: %s", szSQLQuery);
...
public UpdateUserPostCount(iClient, iPostCount)
{
	...
	LogMessage("Set Forum Post Count: %s", szSQLQuery);
