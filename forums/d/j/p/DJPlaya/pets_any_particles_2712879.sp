...
stock CreateParticle(char[] particle, float pos[3])
{
...
stock CreateLoopingParticle(ent, char[] particleType)
{
...
SetPetAnim(client, const char[] anim)
{
	SetVariantString(anim);
	AcceptEntityInput(pet[client], "SetAnimation");
}

SetPetParticle(client, char[] particle)
{
