...
public OnPluginStart()
{
	...
	h_CvarMessageType = CreateConVar("l4d_incapped_message_type", "1", "Message type (0 - disable, 1 - chat, 2 - hint)", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 2.0)
...
public SetPlayerWeaponModel(i_Client)
{
	decl i_Viewmodel, i_Weapon, String:s_ClassName[32]
...
public Action:VomitjarThink(Handle:h_Timer, any:i_Ent)
{
	...
	{
		decl Float:f_EntOrigin[3], i_MaxEntities, String:s_ModelName[64], i_InfoEnt, Float:f_CvarDuration, i
