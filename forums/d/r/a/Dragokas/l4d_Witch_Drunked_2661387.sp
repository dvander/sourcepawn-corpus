...
public void OnPluginStart()
{
	...
	g_ConVarEnable = CreateConVar("l4d_witch_drunked_enabled", "1", "Enable plugin (1 - On / 0 - Off)", CVAR_FLAGS);
	g_ConVarChance = CreateConVar("l4d_witch_drunked_chance", "100", "Chance the drunked witch is appeared (1 to 100), 0 - to disable.", CVAR_FLAGS);
