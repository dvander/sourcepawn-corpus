...
public void OnPluginStart()
{
	...
	if( L4D2Version ) h_CoopInfectedPlayerFlashLight.AddChangeHook(ConVarChanged_Cvars);
...
void GetCvars()
{
	...
	if( L4D2Version ) g_bCoopInfectedPlayerFlashLight = h_CoopInfectedPlayerFlashLight.BoolValue;
}
