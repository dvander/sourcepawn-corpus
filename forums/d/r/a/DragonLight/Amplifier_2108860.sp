...
//Also added new convar in to make it donator only, amplifier_donor (def. 0) 0 = All can use /amp command, 1 = Only people with admin reserved flag can use.
#pragma semicolon 1
...
new Handle:cvarDonor = INVALID_HANDLE;
...
public OnPluginStart()
{
	...
	cvarDonor = CreateConVar("amplifier_donor", "0", "Allow amp to be used by donators or all players.", FCVAR_PLUGIN, true, 0.0, true, 1.0);
