...
new Handle:sm_l8d_gmode = INVALID_HANDLE;
new disallowBot=0;
...
public OnPluginStart()
{
	...
	sm_l8d_gmode = CreateConVar("sm_l8d_gmode", "coop", "L8D's Game-Mode", FCVAR_PLUGIN|FCVAR_REPLICATED|FCVAR_NOTIFY);
...
{
	new String:GoToDiff[64];
	GetConVarString(sm_l8d_gmode,GoToDiff,sizeof(GoToDiff));
	SetConVarString(FindConVar("mp_gamemode"), GoToDiff);
}
...
public Action:L8DEnable(client, args) 
{
	...
	SetConVarString(FindConVar("mp_gamemode"), "Coop"); // switches to co-op mode
