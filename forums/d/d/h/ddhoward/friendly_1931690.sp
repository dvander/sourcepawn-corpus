...
#define PLUGIN_VERSION "13.0413 (0105)"
...
public OnPluginStart()
{
	...
	for(new i=1; i<MAXPLAYERS+1; i++)
		ClientEnteringFriendly[i] = false;
	for(new i=1; i<MAXPLAYERS+1; i++)
		ClientIsSpawning[i] = false;
	for(new i=1; i<MAXPLAYERS+1; i++)
		ClientKilledOnSwitch[i] = false;
	CreateConVar("sm_friendly_version", PLUGIN_VERSION, "Plugin Version, DO NOT MODIFY.",  FCVAR_PLUGIN|FCVAR_NOTIFY);
