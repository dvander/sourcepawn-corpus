...
Changes since 13.0514
	Removed dummy cvar that served to only hook other convars onconfigsexecuted
	ADDED AFK CHECKER
		sm_friendly_afklimit
		sm_friendly_afkinterval
	fixed showactivity bug where it said it enabled friendly instead of disabling it
	changed update URL
To-do
