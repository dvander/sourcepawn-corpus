...
#define PLUGIN_VERSION "13.0416 (1522)"
//fixed compilation warning and more error log spam, thanks Wazman
...
public OnPluginStart()
{
	...
	sm_friendly_invuln = CreateConVar("sm_friendly_invuln", "2", "(0/1/2/3) 0 = Friendly players have full godmode. 1 = Buddha. 2 = Only invulnerable to other players. 3 = Invuln to other players AND himself.", FCVAR_PLUGIN|FCVAR_NOTIFY);
