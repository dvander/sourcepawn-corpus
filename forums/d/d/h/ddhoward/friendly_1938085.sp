...
Improvements to sapper/friendly logic
...
Changes to sm_friendly_invuln_* cvars
...
Changed sm_friendly_notarget_d description
Re-organized code
Fixed cosmetics and demoshields not adhering to alpha settings if the item was equipped after spawning
Added sm_friendly_alpha_w
sm_friendly_admin can now be activated regardless of any invuln cvar, still does NOT bypass full godmode
Added sm_friendly_killsentry_f sm_friendly_killdispenser_f sm_friendly_killtele_f
Added sm_friendly_stopcap and sm_friendly_stopintel
*/
#pragma semicolon 1
...
public Action:Object_Sapped(Handle:event, const String:name[], bool:dontBroadcast) {
	...
	if (ClientIsFriendly[spy] || (ClientIsFriendly[engie] && ((building == 0 && GetConVarBool(sm_friendly_invuln_d)) || (building == 1 && GetConVarBool(sm_friendly_invuln_t)) || (building == 2 && GetConVarBool(sm_friendly_invuln_s))))) {
