/* Changes since 13.0730
	Added sm_friendly_thirdperson
	Changed "i" to "client" where applicable
	Removed cvar_*'s being set to default values on startup, pointless
	Fixed an error that would occur if an admin enabled friendly on a dead player OR Friendly was enabled on any player in civilian mode
To-do
