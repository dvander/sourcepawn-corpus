/*
CHANGES MADE SINCE 13.0417 (0000)
sm_debugfriendly is now sm_friendly_debug
Added sm_friendly_admin
Removed claims of the plugin being able to block friendly engineers from building things
Updater support
Changing Version format from here on
Added prefix to all chat outputs
*/
#pragma semicolon 1
...
public OnPluginStart()
{
	...
	sm_friendly_update = CreateConVar("sm_friendly_update", "0", "(0/1/2) Updater compatibility. 0 = disabled, 1 = auto-download, 2 = auto-download and auto-install", FCVAR_PLUGIN);
