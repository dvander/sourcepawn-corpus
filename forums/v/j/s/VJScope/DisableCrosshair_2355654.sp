//I left the 'who cares' variables like RemoveRadar as they were. -VJScope
...
public Plugin:myinfo = 
{
    ...
    author = "Internet Bully (modified by VJScope)",
    description = "Turns off Crosshair on spawn",
	version     = "1.2",
...
{    
	if(StrContains(strGame, "csgo") != -1) SetEntProp(client, Prop_Send, "m_iHideHUD", GetEntProp(client, Prop_Send, "m_iHideHUD") | HIDE_CROSSHAIR_CSGO);
