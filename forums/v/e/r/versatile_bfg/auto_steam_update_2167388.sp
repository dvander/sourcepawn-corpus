...
#include <sourcemod>
#include <sdktools>
//changed this to work with steamworks - Versatile
//#include <steamtools>
#include <steamworks>
...
public OnPluginStart() {
	...
	//changed this to 0 so it wont autoupdate the plugin. As it will go back to steamtools if you do update it - Versatile
	updaterCvar = CreateConVar("auto_steam_update_auto_update", "0", "Enables automatic plugin updating (has no effect if Updater is not installed)");
