...
public OnPluginStart()
{
	...
	if(!StrEqual(ModName, "left4dead", false)&&!StrEqual(ModName, "left4dead2", false)) SetFailState("Use this in Left 4 Dead 1/2 only.");
...
public Action:CheckGameMode(Handle:timer)
{
        ...
        if (StrEqual(gamemode, "coop") || StrEqual(gamemode, "realism") || StrEqual(gamemode, "mutation3") || StrEqual(gamemode, "mutation9") || StrEqual(gamemode, "mutation7") || StrEqual(gamemode, "mutation2") || StrEqual(gamemode, "mutation5"))
        {
             hKVSettings=CreateKeyValues("ForceMissionChangerSettings");
