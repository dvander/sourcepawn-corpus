...
public Event_PlayerSpawn(Handle:event, const String:name[], bool:dontBroadcast){
  ...
  // Clear client logged damage
      g_DamageDone[][client]=0;
      g_DamageTaken[client][]=0;
      g_HitsDone[][client]=0;
      g_HitsTaken[client][]=0;
      g_KilledPlayer[][client]=0;
      g_HitboxDone[][client][]=0;
      g_HitboxTaken[client][][]=0;
