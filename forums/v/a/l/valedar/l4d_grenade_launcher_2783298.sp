...
{ 
	if(GetConVarInt(l4d_gl_clips)>1)
	{
		...
		{
			SDKUnhook(client, SDKHook_PreThink, GLPreThinkPostHook);
			SDKHook(client, SDKHook_PreThink, GLPreThinkPostHook);	
...
stock HaveGrenadeLauncher(client)
{
...
stock HoldGrenadeLauncher(client)
{
	new g=0;
	new String:weapon[32];
