...
public OnPluginStart()
{
	...
	g_hEnable				= CreateConVar("vb_enable",				"1",	"0 - Disable plugin, 1 - Enable plugin");
	g_hLog					= CreateConVar("vb_log",				"0",	"0 - Disable logging of blocked votes, 1 - Enable logging of blocked votes");
	g_hRespectLevels		= CreateConVar("vb_respectlevels",		"1",	"0 - Disable comparing immunity levels, 1 - Enable comparing immunity levels");
	g_hBlockCount			= CreateConVar("vb_blockcount",			"3",	"0 - Disable blocked vote limit for clients, n - Maximum number of blocked votes per client per map before they are kicked");
	g_hAdminImmunity		= CreateConVar("vb_adminimmunity",		"1",	"0 - Disable admin kick immunity, 1 - Enable admin kick immunity");
	g_hTankImmunity			= CreateConVar("vb_tankimmunity",		"0",	"0 - Disable kick immunity for tanks, 1 - Enable kick immunity for tanks");
	g_hSpectatorVote		= CreateConVar("vb_spectatorvote",		"b",	"0 - Allow this type of vote, x - Only clients that match one or more of these flags can call this vote");
	g_hKick					= CreateConVar("vb_kick",				"0",	"0 - Allow this type of vote, x - Only clients that match one or more of these flags can call this vote");
	g_hReturnToLobby		= CreateConVar("vb_returntolobby",		"b",	"0 - Allow this type of vote, x - Only clients that match one or more of these flags can call this vote");
	g_hChangeAlltalk		= CreateConVar("vb_changealltalk",		"b",	"0 - Allow this type of vote, x - Only clients that match one or more of these flags can call this vote");
	g_hRestartGame			= CreateConVar("vb_restartchapter",		"0",	"0 - Allow this type of vote, x - Only clients that match one or more of these flags can call this vote");
	g_hChangeMission		= CreateConVar("vb_changemission",		"0",	"0 - Allow this type of vote, x - Only clients that match one or more of these flags can call this vote");
	g_hChangeChapter		= CreateConVar("vb_changechapter",		"0",	"0 - Allow this type of vote, x - Only clients that match one or more of these flags can call this vote");
	g_hChangeDifficulty		= CreateConVar("vb_changedifficulty",	"0",	"0 - Allow this type of vote, x - Only clients that match one or more of these flags can call this vote");
