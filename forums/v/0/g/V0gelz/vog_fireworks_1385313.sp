/*****************************************************************************************
 *  vog_fireworks.sma     version 1.4.2                 Date: 02/01/2010
...
/*  To use this with gungame mod. Change this one  */
/*  line so it looks like:    #define use_gungame 1      */

#define use_gungame 1
...
public	SpritesShooter(Float:vec[3], client)
{
	...
	env_shooter(client, dir, 1.0, 0.1, dir, 1200.0, 1.0, 2.5, vec, "materials/sprites/flare1.vmt");
}
...
{
	EmitSoundToAll(sound,SOUND_FROM_WORLD,SNDCHAN_AUTO,SNDLEVEL_NORMAL,SND_NOFLAGS,1.0,SNDPITCH_NORMAL,-1,orig,NULL_VECTOR,true,0.0);
}
