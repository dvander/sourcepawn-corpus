...
bool isl4d2, g_bPluginOn, g_bPEnable, g_bAmChanged, g_bBlockChange;
...
{
	if (!g_bPluginOn || (g_bBlockChange && g_hStartOnly.BoolValue))
		return;
	...
	if (g_bAmChanged == false)
		CreateTimer(1.0, BlockChange_Timer, _, TIMER_FLAG_NO_MAPCHANGE);
...
public Action BlockChange_Timer(Handle timer)
{
	g_bBlockChange = true;
}
