...
{ 
    ...
    g_armor1 = CreateConVar("sm_price_armor1", "50", "What should the price of the 1 armor be ?");
    
    g_armor2 = CreateConVar("sm_price_armor2", "75", "What should the price of the 2 armor be ?");
    
    g_armor3 = CreateConVar("sm_price_armor3", "100", "What should the price of the 3 armor be ?");
    
    g_armor4 = CreateConVar("sm_price_armor4", "200", "What should the price of the 4 armor be ?");
    
    g_armorHP1 = CreateConVar("sm_hp_armor1", "100", "How much HP should have armor 1 ?");
    
    g_armorHP2 = CreateConVar("sm_hp_armor2", "200", "How much HP should have armor 2 ?");
    
    g_armorHP3 = CreateConVar("sm_hp_armor3", "400", "How much HP should have armor 3 ?");
    
    g_armorHP4 = CreateConVar("sm_hp_armor4", "600", "How much HP should have armor 4 ?");
