...
#define PLUGIN_AUTHOR "Rachnus, edited by Eyal282 for Updater integration"
...
public void OnPluginStart()
{
	...
	Handle hConf = LoadGameConfigFile(const_GameDataFile);
	...
	if(g_hPlayerMaxSpeed == INVALID_HANDLE)
	{
		if(!Updater_ForceUpdate())
			SetFailState("Could not DHook PlayerMaxSpeed");
