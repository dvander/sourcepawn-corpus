...
public void OnPluginStart()
{
	...
	cvar = CreateConVar("sm_allow_buytime", "300", "Set the time limit for acquiring new weapons after the start of the round, unit: seconds (range: 5-300 seconds)", _, true, 5.0, true, 300.0);
...
public void OnMapStart()
{
	...
	BuildPath(Path_SM, buffer, PLATFORM_MAX_PATH, "configs/NewWeapons.txt");
