...
#define SIG_InSameTeam_WINDOWS			"\\x55\\x8B\\xEC\\x8B\\x45\\x08\\x57\\x8B\\xF9\\x85\\xC0"
...
#define SIG_OnAudibleEvent_WINDOWS		"\\x55\\x8B\\xEC\\x83\\xEC\\x18\\x56\\x8B\\x75\\x0C\\x57\\x8B\\xF9\\x85\\xF6"
...
#define SIG_OnPlayerRadio_WINDOWS		"\\x55\\x8B\\xEC\\x83\\xEC\\x0C\\x57\\x8B\\xF9\\x8B\\x07\\x8B\\x80\\x0C\\x01\\x00\\x00"
...
#define SIG_OnPlayerDeath_WINDOWS		"\\x55\\x8B\\xEC\\x83\\xEC\\x28\\x57\\x8B\\xF9\\x8B\\x07"
...
#define SIG_SetBotEnemy_WINDOWS		"\\x55\\x8B\\xEC\\x56\\x8B\\xF1\\x57\\x8B\\x96\\x7C\\x3C\\x00\\x00"
...
public int ZR_OnClientInfected(int client, int attacker, bool motherInfect, bool respawnOverride, bool respawn)
{
	...
	CreateTimer(0.5, Timer_SetBotEnemies);
}
public Action Timer_SetBotEnemies(Handle timer)
{
	for (int i = 1; i <= MaxClients; i++)
	{
		if (IsClientInGame(i) && IsFakeClient(i))
		{
			int enemy = GetNearestEnemy(i);
			if (enemy != 0)
			{
				SDKCall(sdkSetBotEnemy, i, enemy);
			}
		}
	}
	return Plugin_Stop;
