...
public Action:OnPostWeaponEquip(client, iWeapon)
{
	...
	if(!GetEdictClassname(iWeapon, Classname, 64) || StrContains(Classname, "weapon_healthshot", false) != -1 || StrContains(Classname, "weapon_tagrenade", false) != -1 || StrContains(Classname, "weapon_knife", false) == 0 || (index > 42 && index < 50))
	{
		return;
	}
