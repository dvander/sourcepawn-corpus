...
public OnMapStart()
{
	...
	PrecacheMaterial("materials/sprites/blueglow2.vtf");
	PrecacheModel("materials/sprites/flare1.vmt",true);
	g_iLaserSprite = PrecacheModel("materials/sprites/laserbeam.vmt");
	g_iHaloSprite = PrecacheModel("materials/sprites/blueglow2.vmt");
...
public Action:Timer_OnFireIonCannon(Handle:timer, any:client)
{
	...
	if(iExplosion != -1)
	{
		...
		//DispatchKeyValue(iExplosion, "fireballsprite", "materials/sprites/blueglow2.vtf");
