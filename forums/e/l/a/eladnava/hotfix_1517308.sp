...
public OnMapStart() {
	...
	ServerCommand( "sm_wpnblock 1" );
	ServerCommand( "sm_wpnblock_clear" );
	ServerCommand( "sm_wpnblock_add 'tf_weapon_raygun'" );
	ServerCommand( "sm_wpnblock_add 'tf_weapon_particle_cannon'" );
}
