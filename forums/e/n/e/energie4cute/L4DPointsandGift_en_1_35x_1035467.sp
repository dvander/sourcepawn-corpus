...
public OnPluginStart()
{
	...
	pointsnumreminder = CreateConVar("points_advertising_remind","1","Reminds the players how to get their number keys to properly work. 1 for yes, 0 for no.",CVAR_FLAGS,true,0.0);
