...
{
	CreateConVar ("sm_giveitem_version", PLUGIN_VERSION, "Version",  FCVAR_SPONLY | FCVAR_REPLICATED | FCVAR_NOTIFY);
	hDebug = CreateConVar("sm_giveitem_textspew", "1", "Enable/Disable debugging text", 0, true, 0.0, true, 1.0);
