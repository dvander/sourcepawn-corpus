			...
			switch (class)
			{
				case TFClass_Scout:
				{
					...
					switch (rnd)
					{
						...
						case 2:
						{
							CreateWeapon(client, "tf_weapon_handgun_scout_primary", 220, 1);
						}
						case 3:
						{
							CreateWeapon(client, "tf_weapon_soda_popper", 448, 10);
						}
						case 4:
						{
				...
				case TFClass_Sniper:
				{
					...
					switch (rnd)
					{
						...
						case 2:
						{
							CreateWeapon(client, "tf_weapon_sniperrifle", 230, 1);
						}
						case 3:
						{
						...
						case 4:
						{
							CreateWeapon(client, "tf_weapon_sniperrifle", 526, 5);
						}
						case 5:
						{
							CreateWeapon(client, "tf_weapon_sniperrifle", 752, 1);
						}
						case 6:
						{
							CreateWeapon(client, "tf_weapon_sniperrifle_classic", 1098, 1);
						}
						case 7:
						{
							CreateWeapon(client, "tf_weapon_compound_bow", 1092, 10);
						}
						case 8:
						{
							CreateWeapon(client, "tf_weapon_sniperrifle", 851, 1);
						}
					}
				...
				case TFClass_Soldier:
				{
					...
					switch (rnd)
					{
						...
						case 5:
						{
							CreateWeapon(client, "tf_weapon_rocketlauncher", 513, 5);
						}
						case 6:
						{
					...
					switch (rnd2)
					{
						...
						case 3:
						{
							CreateWeapon(client, "tf_weapon_shotgun_soldier", 415, 10);
						}
					}
				...
				case TFClass_DemoMan:
				{
					...
					CreateWeapon(client, "tf_wearable_demoshield", 131, 20, true);
				...
				case TFClass_Heavy:
				{
					...
					switch (rnd)
					{
						...
						case 2:
						{
							CreateWeapon(client, "tf_weapon_minigun", 312, 5);
						}
						case 3:
						{
				...
				case TFClass_Pyro:
				{
					...
					switch (rnd2)
					{
						...
						case 6:
						{
							CreateWeapon(client, "tf_weapon_shotgun_pyro", 415, 10);
						}
					}
				...
				case TFClass_Engineer:
				{
					...
					switch (rnd)
					{
						...
						case 5:
						{
							CreateWeapon(client, "tf_weapon_shotgun_primary", 527, 5);
						}					
					}
