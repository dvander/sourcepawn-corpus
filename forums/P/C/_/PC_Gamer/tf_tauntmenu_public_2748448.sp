...
public Action:ShowMenu(client)
{
	...
	case TFClass_Engineer:
		{
			...
			AddMenuItem(menu, "31160", "(Engi) Texas Truckin");			
		}
	case TFClass_Heavy:
		{
			AddMenuItem(menu, "30843", "(Heavy) Russian Arms Race");
			AddMenuItem(menu, "30844", "(Heavy) Soviet Strongarm");
	...
	AddMenuItem(menu, "31162", "(Any) Fist Bump");	
