...
public Action:Event_item_found(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	new String:steam_id[64];
    GetClientAuthString(userid, steam_id, sizeof(steam_id));

	Format(query, sizeof(query), "INSERT INTO item_found (`STEAMID`,`ACTUALTIME`,`ONLINEPLAYERS`,`ITEM`) VALUES ('%s','%i','%i','%s')", steam_id, time, GetClientCount(true), item)
