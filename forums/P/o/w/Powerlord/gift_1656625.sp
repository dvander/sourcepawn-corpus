	...
	if (IsPlayerAlive(client))
	{
		if (gift[client] > 0)
		{
			...
			if ((bonus == 1) || (bonus == 2) || (bonus == 3))
			{
				...
				PrintToChat(client, "[VIP] : %t", "Health Gained", 15);
				gift[client]--;
			...
			else if ((bonus == 4) || (bonus == 5) || (bonus == 6))
			{
				...
				PrintToChat(client, "[VIP] : %t", "Armor Gained", 15);
				gift[client]--;
			...
			else if (bonus == 7)
			{
				...
				PrintToChat(client, "[VIP] : %t", "USP Gained");
				gift[client]--;
			...
			else if ((bonus == 8) || (bonus == 9) || (bonus == 10))
			{
				...
				PrintToChat(client, "[VIP] : %t", "Speed Gained");
				gift[client]--;
			...
			else if ((bonus == 11) || (bonus == 12))
			{
				...
				PrintToChat(client, "[VIP] : %t", "Grenade Pack Gained");
				gift[client]--;
			...
			else if ((bonus == 16))
			{
				...
				PrintToChat(client, "[VIP] : %t", "Speed Lost");
				gift[client]--;
			...
			else if ((bonus == 17))
			{
				...
				PrintToChat(client, "[VIP] : %t", "Armor Lost", 15);
				gift[client]--;
			...
			if ((bonus == 18))
			{
				...
				PrintToChat(client, "[VIP] : %t", "Health Lost", 15);
				gift[client]--;
			...
			else if (bonus == 19)
			{
				...
				PrintToChat(client, "[VIP] : %t", "Glock Gained");
				gift[client]--;
