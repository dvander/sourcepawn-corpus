...
#define SM_SKINCHOOSER_HL2DM_VERSION		"2.1"
...
{	
	...
	if(teamplay_off)
	{
		BuildPath(Path_SM, file, 255, "configs/skins_tdm.ini");
	...
	{
	BuildPath(Path_SM, file, 255, "configs/skins_dm.ini");
	FileToKeyValues(kv, file);		
