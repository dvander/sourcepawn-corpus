...
public OnPluginStart()
{
	...
	cv_neededkills_HE = CreateConVar("dm_bonus_needed_HE", "2", "Kills needed to recieve hegrenade, 0 = disable");
	cv_neededkills_flash = CreateConVar("dm_bonus_needed_flash", "5", "Kills needed to recieve flashbang, 0 = disable");
	cv_neededkills_smoke = CreateConVar("dm_bonus_needed_smoke", "1", "Kills needed to recieve smokegrenade, 0 = disable");
...
public Event_PlayerDeath(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if(attacker == victim || teamkill)
		return;
	
	if (healthamount != 0 || headshotamount != 0)
	{
