...
// Hopefully this works.
	...
	cv_factor = CreateConVar("bunnystopper_factor", "1.5", "Gravity factor to use", FCVAR_PLUGIN);
...
// temporarily to affect Bunnyhopping, but not normal crouch jumps.
	...
	new Float:factor = GetConVarFloat(cv_factor);
	SetEntityGravity(client, factor);
