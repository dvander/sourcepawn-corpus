...
public OnPluginStart()
{
	...
	hConVar_Enabled = CreateConVar("l4d_autopistols_enabled", "1", "[1/0 PLUGIN ENABLED/DISABLED]", FCVAR_PLUGIN | FCVAR_REPLICATED | FCVAR_NOTIFY );
	hConVar_Weapons = CreateConVar("l4d_autopistols_weapons", "weapon_pistol", "[ALLOWED WEAPONS] Use ';' to add more then one like: 'weapon_pistol;weapon_nuke;weapon_hunting_rifle'", FCVAR_PLUGIN | FCVAR_REPLICATED | FCVAR_NOTIFY );
