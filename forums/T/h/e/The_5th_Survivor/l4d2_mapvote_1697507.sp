...
public OnPluginStart()
{
	...
	RegConsoleCmd("sm_mapvote", Command_MapVote);
...
{
	new String:announce[] = "\x01[SM] To call a vote to change the map/campaign, type: \x04!mapvote\x01 in chat.";
...
Handle:BuildMapMenu(bool:adminMode)
{
	...
	else
	{
		if(strcmp(g_gameMode, "coop", false) == 0)
		{
			AddMenuItem(mapMenu, "l4d_hospital01_apartment", "No Mercy");
			...
			AddMenuItem(mapMenu, "l4d_river01_docks", "The Sacrifice");
			AddMenuItem(mapMenu, "getmeoutofhere", "Exit");
		}
		else if(strcmp(g_gameMode, "versus", false) == 0)
		{
			AddMenuItem(mapMenu, "l4d_vs_hospital01_apartment", "No Mercy");
			AddMenuItem(mapMenu, "l4d_garage01_alleys", "Crash Course");
