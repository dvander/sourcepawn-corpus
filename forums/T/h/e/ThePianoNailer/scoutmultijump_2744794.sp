...
public OnPluginStart()
{
	...
	CreateConVar("sm_scoutmultijump_version", PLUGIN_VERSION, "Scout Multi-Jump Version.", FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);
	g_hEnabled = CreateConVar("sm_smj_global_enabled", "0", "Enable/Disable Scout Multi-Jump", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	HookConVarChange(g_hEnabled, cvarEnabledTimer);
	g_hLimit = CreateConVar("sm_smj_global_limit", "0", "Amount of double jumps allowed. 0 = Unlimited.", 0);
