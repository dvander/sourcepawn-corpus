...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_ammo", Command_ammo, ADMFLAG_CUSTOM5, "Fully reloads ammo and clip on a per class basis");
	RegAdminCmd("sm_health", Command_health, ADMFLAG_CUSTOM5, "Restores 100 percent health on a per class basis");
	RegAdminCmd("sm_metal", Command_metal, ADMFLAG_CUSTOM5, "Gives Engineers 200 metal");
	RegAdminCmd("sm_uber", Command_uber, ADMFLAG_CUSTOM5, "Gives Medics an immediate ubercharge");
	RegAdminCmd("sm_giveammo", Command_GiveAmmo, ADMFLAG_CUSTOM5, "sm_giveammo <name>");
	RegAdminCmd("sm_givehealth", Command_GiveHealth, ADMFLAG_CUSTOM5, "sm_givehealth <name> [1-500]");
	RegAdminCmd("sm_givemetal", Command_GiveMetal, ADMFLAG_CUSTOM5, "sm_givemetal <name> [1-200]");
	RegAdminCmd("sm_giveuber", Command_GiveUber, ADMFLAG_CUSTOM5, "sm_giveuber <name> [1-100]");
