...
#define MDL_DISGUISE "models/items/medkit_medium.mdl"
...
//		HookEntityOutput("func_regenerate",  "OnStartTouch",    EntityOutput_StartTouch);
		...
		// 隠れボイス
		SOUND_HIDE_VOICE[0] = "vo/spy_laughevil01.wav";
		SOUND_HIDE_VOICE[1] = "vo/spy_laughevil01.wav";
		SOUND_HIDE_VOICE[2] = "vo/spy_laughevil01.wav";
		SOUND_HIDE_VOICE[3] = "vo/spy_laughevil01.wav";
		SOUND_HIDE_VOICE[4] = "vo/spy_laughevil01.wav";
		// 登場ボイス
		...
		// 隠れ開始ボイス
		SOUND_START_VOICE[0] = "vo/spy_painsevere05.wav";
		SOUND_START_VOICE[1] = "vo/spy_paincrticialdeath01.wav";
		SOUND_START_VOICE[2] = "vo/spy_paincrticialdeath02.wav";
		SOUND_START_VOICE[3] = "vo/spy_paincrticialdeath03.wav";
		SOUND_START_VOICE[4] = "vo/spy_painsevere04.wav";
