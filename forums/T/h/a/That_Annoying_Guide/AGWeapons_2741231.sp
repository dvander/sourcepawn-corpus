...
public Plugin myinfo = 
{
	...
	author = "PC Gamer, with code by luki1412 and manicogaming, edited by That Annoying Guide tpose fix code taken from showins givebotsloadouts plugin",
						...
						case 1:
							{
								...
								case 1:
									{
										CreateWeapon(client, "tf_weapon_fireaxe", 2, 5);
									}
								case 2:
									{
					...
					case 1:
						{
							...
							case 3:
								{
									CreateWeapon(client, "tf_weapon_revolver", 61, 9);
								}
							}
						}
					case 2:
