		...
		case TFClass_Spy:
			{
				...
				case 1:
					{
						CreateWeapon(client, "tf_weapon_sapper", 810, 0);
					}
				case 2:
					{
						int rnd6 = GetRandomUInt(1,4);
						switch (rnd6)
						{
							case 1:
							{
							...
							case 2:
							{
								CreateWeapon(client, "tf_weapon_sapper", 933, 0);
							}
							case 3:
							{
								CreateWeapon(client, "tf_weapon_sapper", 1080, 0);
							}
							case 4:
							{
								CreateWeapon(client, "tf_weapon_sapper", 1102, 0);
							}
						}
					}
				}
...
bool CreateWeapon(int client, char[] classname, int itemindex, int quality, int level = 0)
{
	...
	if (quality >1 && quality < 9)
	{
		...
		case 1:
			{
				SetEntData(weapon, FindSendPropInfo(entclass, "m_iEntityQuality"), 2);
			}
		case 2:
			{
		...
		case 3:
			{
				SetEntData(weapon, FindSendPropInfo(entclass, "m_iEntityQuality"), 4);
			}
		case 4:
			{
				SetEntData(weapon, FindSendPropInfo(entclass, "m_iEntityQuality"), 11);
