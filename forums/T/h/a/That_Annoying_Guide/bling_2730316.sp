...
{
	name = "Bling",
	author = "PC Gamer, with code by luki1412 and manicogaming edited by That Annyoing Guide",
			...
			case 8:
				{
					...
					case 3:
						{
							CreateWeapon(client, "tf_weapon_fists", 264, 6);
						}
					case 4:
						{
							CreateWeapon(client, "tf_weapon_fists", 423, 11);
						}
					case 5:
						{
							CreateWeapon(client, "tf_weapon_fists", 474, 6);
						}
					case 6:
						{
							CreateWeapon(client, "tf_weapon_fists", 880, 6);
						}
					case 7:
						{
							CreateWeapon(client, "tf_weapon_fists", 939, 6);
						}
					case 8:
						{
							CreateWeapon(client, "tf_weapon_fists", 954, 11);
						}
					case 9:
						{
							CreateWeapon(client, "tf_weapon_fists", 1013, 6);
						}
					case 10:
						{
							CreateWeapon(client, "tf_weapon_fists", 1071, 11);
						}
					case 11:
						{
							CreateWeapon(client, "tf_weapon_fists", 1123, 6);
						}
					case 12:
						{
							CreateWeapon(client, "tf_weapon_fists", 1127, 6);
						}
					case 13:
						{
							CreateWeapon(client, "tf_weapon_fists", 30758, 6);
						}
					}
				}
			}						
