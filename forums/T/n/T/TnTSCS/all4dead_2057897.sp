...
public Action:CommandSpawnInfected(client, args) { 
  ...
  if (IsValidInfectedType(type, client))
...
public IsValidInfectedType(const String:type[], client) {
  // TnTSCS: Added specific permission lookups for each infected type
  if ((StrEqual(type, "tank", false) && CheckCommandAccess(client, "allow_spawntank", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "witch", false) && CheckCommandAccess(client, "allow_spawnwitch", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "boomer", false) && CheckCommandAccess(client, "allow_spawnboomer", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "hunter", false) && CheckCommandAccess(client, "allow_spawnhunter", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "smoker", false) && CheckCommandAccess(client, "allow_spawnsmoker", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "common", false) && CheckCommandAccess(client, "allow_spawncommon", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "mob", false) && CheckCommandAccess(client, "allow_spawnmob", ADMFLAG_CHEATS)))
    return true;
  return false;
}
...
public Action:CommandSpawnWeapon(client, args) { 
  ...
  new String:type[16];	
  GetCmdArg(1, type, sizeof(type));
  if (IsValidItemType(type, client))
...
public IsValidItemType(const String:type[], client) {
  if ((StrEqual(type, "autoshotgun", false) && CheckCommandAccess(client, "allow_spawnautoshotgun", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "pistol", false) && CheckCommandAccess(client, "allow_spawnpistol", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "hunting_rifle", false) && CheckCommandAccess(client, "allow_spawnhunting_rifle", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "rifle", false) && CheckCommandAccess(client, "allow_spawnrifle", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "pumpshotgun", false) && CheckCommandAccess(client, "allow_spawnpumpshotgun", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "smg", false) && CheckCommandAccess(client, "allow_spawnsmg", ADMFLAG_CHEATS)))
    return true;
  if ((StrEqual(type, "first_aid_kit", false) && CheckCommandAccess(client, "allow_spawnfirst_aid_kit", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "oxygentank", false) && CheckCommandAccess(client, "allow_spawnoxygentank", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "gascan", false) && CheckCommandAccess(client, "allow_spawngascan", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "molotov", false) && CheckCommandAccess(client, "allow_spawnmolotov", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "pain_pills", false) && CheckCommandAccess(client, "allow_spawnpain_pills", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "pipe_bomb", false) && CheckCommandAccess(client, "allow_spawnpipe_bomb", ADMFLAG_CHEATS)) || 
	(StrEqual(type, "propanetank", false) && CheckCommandAccess(client, "allow_spawnpropanetank", ADMFLAG_CHEATS)))
    return true;  
  return false;
}
