...
public OnPluginStart()
{
	...
	HookConVarChange((CreateConVar("sm_zeusround_useupdater", "0", 
	...
	HookConVarChange((CreateConVar("sm_zeusround_saveweapons", "1", 
	...
	HookConVarChange((CreateConVar("sm_zeusround_cleanup", "1", 
	...
	HookConVarChange((CreateConVar("sm_zeusround_mode", "1", 
	...
	HookConVarChange((CreateConVar("sm_zeusround_lastround", "0", 
	...
	HookConVarChange((CreateConVar("sm_zeusround_countdown", "0", 
	...
	HookConVarChange((CreateConVar("sm_zeusround_bugfix", "0", 
...
public Event_PlayerSpawn(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if (!ClientHasWeapons[client] && !IsControllingBot[client])
	{
