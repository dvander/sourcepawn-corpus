...
// 1.3a TnT added CVar to control advertising of rush ability to players
...
public OnPluginStart()
{
	...
	g_hAdvertise = CreateConVar("sm_antirush_advertise", "0", "Display the player's ability to rush or not at the start of each round?", FCVAR_PLUGIN, true, 0.0, true, 1.0);
