...
public ProcessAmmo(entity, client)
{
	...
	if(WeaponSlot0 != -1 && ((weapontype == RIFLES && AllowAnyMixedAmmo) || ((weapontype == RIFLES || AllowMixedAmmo) && type == Weapon_GetPrimaryAmmoType(WeaponSlot0))))
	{
	...
	if(WeaponSlot1 != -1 && ((weapontype == PISTOLS && AllowAnyMixedAmmo) || ((weapontype == PISTOLS || AllowMixedAmmo) && type == Weapon_GetPrimaryAmmoType(WeaponSlot1))))
	{
		if(AllowAnyMixedAmmo)
		{
