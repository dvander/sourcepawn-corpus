...
public OnPluginStart()
{
	...
	AllowedDie = CreateConVar("sm_l4d_fmc_ifdie", "1", "Enables Force changelevel when all player die on final map in coop gamemodes (coop, realismcoop, last gnome on earth and bleed out)");
	...
	ChDelayCOOP = CreateConVar("sm_l4d_fmc_chdelaycoop", "0.0", "Delay before coop/coop realism/last gnome on earth mission change (float in sec).");
...
PluginInitialization()
{
	...
	if (GameMode == 1)
	{
		BuildPath(Path_SM, FMC_FileSettings, 128, "data/sm_l4dcoop_mapchanger.txt");
		PrintToServer("[FMC] Discovered Coop gamemode. Link to sm_l4dcoop_mapchanger.");
	}
	else if (GameMode == 2)
	{
	...
	{
		BuildPath(Path_SM, FMC_FileSettings, 128, "data/sm_l4dcoop_mapchanger.txt");
		PrintToServer("[FMC] Discovered Bleed Out gamemode. Link to sm_l4dcoop_mapchanger.");
	}
        else if (GameMode == 6)
	{
		BuildPath(Path_SM, FMC_FileSettings, 128, "data/sm_l4dvs_mapchanger.txt");
	...
	{
		BuildPath(Path_SM, FMC_FileSettings, 128, "data/sm_l4dcoop_mapchanger.txt");
		PrintToServer("[FMC] Discovered Coop Realism gamemode. Link to sm_l4dcoop_mapchanger.");
	}
        else if (GameMode == 8)
	{
		BuildPath(Path_SM, FMC_FileSettings, 128, "data/sm_l4dcoop_mapchanger.txt");
		PrintToServer("[FMC] Discovered Last Gnome On Earth gamemode. Link to sm_l4dcoop_mapchanger.");
	}
