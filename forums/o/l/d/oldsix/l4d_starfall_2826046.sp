...
{
	l4d_star_duration = CreateConVar("l4d_star_duration", "30", "starfall duration (s)");
	...
	l4d_star_fall_speed = CreateConVar("l4d_star_fall_speed", "200", "fall speed of rock");	
 	...
 	l4d_star_dead_tank =  CreateConVar("l4d_star_dead_tank", "10", "chance of meteor shower when tank die"); 
	l4d_star_dead_witch =  CreateConVar("l4d_star_dead_witch", "10", " chance of meteor shower when witch die"); 	
	l4d_star_witch_harasser =  CreateConVar("l4d_star_witch_harasser", "3", " chance of meteor shower when witch harasser"); 

	l4d_star_mininterval =  CreateConVar("l4d_star_mininterval", "200", "[200, maxinterval]seconds "); 
	l4d_star_maxinterval =  CreateConVar("l4d_star_maxinterval", "800", "[200, 600]seconds "); 	

	//AutoExecConfig(true, "l4d_starfall");

	RegAdminCmd("sm_starfall", sm_starfall, ADMFLAG_VOTE|ADMFLAG_BAN);
