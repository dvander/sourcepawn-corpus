...
new bool:ZeusFirstRoundEndForceGiveWeaponCT = false;
new bool:ZeusFirstRoundEndForceGiveWeaponTT = false;
...
{
	ZeusFirstRoundEndForceGiveWeaponCT = GetConVarBool(cvar);
}

public OnFirstRoundEndForceGiveWeaponTTChange(Handle:cvar, const String:oldVal[], const String:newVal[])
{
	ZeusFirstRoundEndForceGiveWeaponTT = GetConVarBool(cvar);
}
