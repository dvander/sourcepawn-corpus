...
*						- ZeusFirstRoundEndForceGiveWeaponCT	what weapon CT should start with (not in use from 0.0.2.9, may be in use later)
*						- ZeusFirstRoundEndForceGiveWeaponTT	what weapon TT should start with (not in use from 0.0.2.9, may be in use later)
...
*
*		0.0.2.8	*	Invalid release.
*
*		0.0.2.9 *	Removed ZeusFirstRoundEndForceGiveWeapon ConVars and replaced them by static original weapons, probably will be fixed in the official release.
*				*	Fixed a bug which gives the missing amount of cash to $10000 at the 3rd round no matter what.
*
*
*
* 	KNOWN ISSUES
...
public Event_PlayerSpawn(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if (g_TotalRoundsPlayed <= 2 && ZeusFirstRound && ZeusFirstRoundEndForceGive)
	{
		PlayersCash[client] = ZeusFirstRoundEndForceGiveCash;
