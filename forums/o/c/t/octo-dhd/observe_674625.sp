...
public OnPluginStart() {
	...
	RegAdminCmd("sm_observe", CommandObserve, ADMFLAG_CHAT, "Spectate a player when dead.");
	RegAdminCmd("sm_endobserve", CommandEndObserve, ADMFLAG_CHAT, "End spectating a player.");
