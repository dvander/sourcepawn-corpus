...
{
	RegConsoleCmd("sm_open", OnOpenCommand, "", 0);
	RegConsoleCmd("sm_close", OnCloseCommand, "", 0);
	return 0;
}
...
public Action:OnOpenCommand(client, args)
{
	...
	while (i < 2)
	{
		...
		while (var1 != -1)
		{
			AcceptEntityInput(iEnt, "Open", -1, -1, 0);
		}
		i++;
	}
	return Action:3;
...
public Action:OnCloseCommand(client, args)
{
	...
	while (i < 2)
	{
		...
		while (var1 != -1)
		{
			AcceptEntityInput(iEnt, "Close", -1, -1, 0);
		}
		i++;
	}
	return Action:3;
