 ...
 *
 * Version: $Id: dm_equipment.sp 407 2007-07-01 01:26:03Z dvander $
 */
...
public DM_OnClientSpawned(client)
{
	...
	{
		PrintToChat(client, "You are not allowed to have guns in spectator!");
	}
	else
	{
...
public Menu_EquipHandler(Handle:menu, MenuAction:action, param1, param2)
{
	...
	{
		PrintToChat(param1, "You are not allowed to have guns in spectator!");
		return 0;
	}
