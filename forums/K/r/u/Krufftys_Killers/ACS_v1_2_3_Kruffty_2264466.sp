...
// Version 1.2.3_Kruffty                                   //
// Compiled March 7 2015                                  //
...
/*==================================================================================================
	...
	Change Log
	    v1.2.3_Kruffty (March 7 2015)	- Added custom maps listing
...
#define NUMBER_OF_CAMPAIGNS					67	/* CHANGE TO MATCH THE TOTAL NUMBER OF CAMPAIGNS */
#define NUMBER_OF_SCAVENGE_MAPS				29	/* CHANGE TO MATCH THE TOTAL NUMBER OF SCAVENGE MAPS */
...
{	
	...
	Format(g_strCampaignFirstMap[13], 32, "l4d2_city17_01");
	Format(g_strCampaignFirstMap[14], 32, "l4d_deathaboard01_prison");
	Format(g_strCampaignFirstMap[15], 32, "l4d_ihm01_forest");
	Format(g_strCampaignFirstMap[16], 32, "l4d2_ravenholmwar_1");
	Format(g_strCampaignFirstMap[17], 32, "l4d2_diescraper1_apartment_35");	
	Format(g_strCampaignFirstMap[18], 32, "l4d2_7hours_later_01");
	Format(g_strCampaignFirstMap[19], 32, "damitdc1");
	Format(g_strCampaignFirstMap[20], 32, "l4d2_ff01_woods");
	Format(g_strCampaignFirstMap[21], 32, "deadbeat01_forest");
	Format(g_strCampaignFirstMap[22], 32, "pd_electionhell");
	Format(g_strCampaignFirstMap[23], 32, "4d_149_1");
	Format(g_strCampaignFirstMap[24], 32, "hf01_theforest");
	Format(g_strCampaignFirstMap[25], 32, "beldurra2_1");
	Format(g_strCampaignFirstMap[26], 32, "beldurra01_urbanbrawl");	
	Format(g_strCampaignFirstMap[27], 32, "bp_mapalpha1");
	Format(g_strCampaignFirstMap[28], 32, "AirCrash");
	Format(g_strCampaignFirstMap[29], 32, "l4d_Stranded01_chopper_down");
	Format(g_strCampaignFirstMap[30], 32, "srocchurch");
	Format(g_strCampaignFirstMap[31], 32, "BadHoodL1");
	Format(g_strCampaignFirstMap[32], 32, "the_hive_m1");
	Format(g_strCampaignFirstMap[33], 32, "orc001");
	Format(g_strCampaignFirstMap[34], 32, "rmstitanic_m1");
	Format(g_strCampaignFirstMap[35], 32, "x1m1_cliffs");
	Format(g_strCampaignFirstMap[36], 32, "l4d2_sbtd_01");
	Format(g_strCampaignFirstMap[37], 32, "l4d2_fallindeath01");
	Format(g_strCampaignFirstMap[38], 32, "dw_woods");
	Format(g_strCampaignFirstMap[39], 32, "Dead_Series1");
	Format(g_strCampaignFirstMap[40], 32, "hotel01_market1");
	Format(g_strCampaignFirstMap[41], 32, "death_sentence_1");
	Format(g_strCampaignFirstMap[42], 32, "l4d2_ic_2_1");
	Format(g_strCampaignFirstMap[43], 32, "l4d_MIC2_TrapmentD");
	Format(g_strCampaignFirstMap[44], 32, "uf1_boulevard");
	Format(g_strCampaignFirstMap[45], 32, "m1_village");
	Format(g_strCampaignFirstMap[46], 32, "lost01_club");
	Format(g_strCampaignFirstMap[47], 32, "bhm1_outskirts");
	Format(g_strCampaignFirstMap[48], 32, "l4d_zero01_base");
	Format(g_strCampaignFirstMap[49], 32, "cbm1_lake");
	Format(g_strCampaignFirstMap[50], 32, "c5m1_darkwaterfront");
	Format(g_strCampaignFirstMap[51], 32, "esc_jailbreak");
	Format(g_strCampaignFirstMap[52], 32, "youcallthatalanding");
	Format(g_strCampaignFirstMap[53], 32, "l4d2_deadcity01_riverside");
	Format(g_strCampaignFirstMap[54], 32, "gr-mapone-7");
	Format(g_strCampaignFirstMap[55], 32, "convoyturtorial-100");
	Format(g_strCampaignFirstMap[56], 32, "l4d_dbd2_citylights");
	Format(g_strCampaignFirstMap[57], 32, "l4d_viennacalling_city");
	Format(g_strCampaignFirstMap[58], 32, "srocchurch");
	Format(g_strCampaignFirstMap[59], 32, "l4d_viennacalling2_1");
	Format(g_strCampaignFirstMap[60], 32, "uf1_boulevard");
	Format(g_strCampaignFirstMap[61], 32, "l4d2_pasiri1");
	Format(g_strCampaignFirstMap[62], 32, "l4d2_roadtonowhere_route01");
	Format(g_strCampaignFirstMap[63], 32, "ulice");
	Format(g_strCampaignFirstMap[64], 32, "alejki");	
	Format(g_strCampaignFirstMap[65], 32, "tunel");
	Format(g_strCampaignFirstMap[66], 32, "Las");	
	...
	Format(g_strCampaignLastMap[13], 32, "l4d2_city17_05");
	Format(g_strCampaignLastMap[14], 32, "l4d_deathaboard05_light");
	Format(g_strCampaignLastMap[15], 32, "l4d_ihm05_lakeside");
	Format(g_strCampaignLastMap[16], 32, "l4d2_ravenholmwar_4");
	Format(g_strCampaignLastMap[17], 32, "l4d2_diescraper4_top_35");
	Format(g_strCampaignLastMap[18], 32, "l4d2_7hours_later_05");
	Format(g_strCampaignLastMap[19], 32, "damitdc4");
	Format(g_strCampaignLastMap[20], 32, "l4d2_ff05_station");
	Format(g_strCampaignLastMap[21], 32, "deadbeat04_park");
	Format(g_strCampaignLastMap[22], 32, "pd_electionhell_daylight");
	Format(g_strCampaignLastMap[23], 32, "l4d_149_5");
	Format(g_strCampaignLastMap[24], 32, "hf04_escape");
	Format(g_strCampaignLastMap[25], 32, "beldurra2_5");
	Format(g_strCampaignLastMap[26], 32, "beldurra03_riverside");	
	Format(g_strCampaignLastMap[27], 32, "bp_map_03");	
	Format(g_strCampaignLastMap[28], 32, "BombShelter");
	Format(g_strCampaignLastMap[29], 32, "l4d_Stranded05_park_final");
	Format(g_strCampaignLastMap[30], 32, "mnac");
	Format(g_strCampaignLastMap[31], 32, "BadHoodL3");	
	Format(g_strCampaignLastMap[32], 32, "the_hive_m5");
	Format(g_strCampaignLastMap[33], 32, "orc003");	
	Format(g_strCampaignLastMap[34], 32, "rmstitanic_m4");
	Format(g_strCampaignLastMap[35], 32, "x1m5_salvation");
	Format(g_strCampaignLastMap[36], 32, "l4d2_sbtd_03");
	Format(g_strCampaignLastMap[37], 32, "l4d2_fallindeath04");
	Format(g_strCampaignLastMap[38], 32, "dw_final");
	Format(g_strCampaignLastMap[39], 32, "Dead_Series4");
	Format(g_strCampaignLastMap[40], 32, "hotel05_rooftop1");
	Format(g_strCampaignLastMap[41], 32, "death_sentence_5");
	Format(g_strCampaignLastMap[42], 32, "l4d2_ic2_5");
	Format(g_strCampaignLastMap[43], 32, "l4d_mic2_Inter_Vention");
	Format(g_strCampaignLastMap[44], 32, "uf4_airfield");
	Format(g_strCampaignLastMap[45], 32, "m4_ruins");
	Format(g_strCampaignLastMap[46], 32, "lost02_2");
	Format(g_strCampaignLastMap[47], 32, "bhm4_base");
	Format(g_strCampaignLastMap[48], 32, "l4d_zero06_escape");
	Format(g_strCampaignLastMap[49], 32, "cbm3_bunker");
	Format(g_strCampaignLastMap[50], 32, "c5m5_darkbridge");
	Format(g_strCampaignLastMap[51], 32, "esc_fly_me_to_the_moon");
	Format(g_strCampaignLastMap[52], 32, "GoingUp");
	Format(g_strCampaignLastMap[53], 32, "l4d2_deadcity06_station");
	Format(g_strCampaignLastMap[54], 32, "gasrun");	
	Format(g_strCampaignLastMap[55], 32, "convoy");
	Format(g_strCampaignLastMap[56], 32, "l4d_dbd2_new_dawn");
	Format(g_strCampaignLastMap[57], 32, "l4d_viennacalling_donauturm");
	Format(g_strCampaignLastMap[58], 32, "mnac");
	Format(g_strCampaignLastMap[59], 32, "l4d_viennacalling2_finale");
	Format(g_strCampaignLastMap[60], 32, "uf4_airfield");
	Format(g_strCampaignLastMap[61], 32, "l4d2_pasiri4");
	Format(g_strCampaignLastMap[62], 32, "l4d2_roadtonowhere_route06");
	Format(g_strCampaignLastMap[63], 32, "dach");
	Format(g_strCampaignLastMap[64], 32, "baza2");
	Format(g_strCampaignLastMap[65], 32, "domki");
	Format(g_strCampaignLastMap[66], 32, "Lotnisko");
	...
	Format(g_strCampaignName[13], 32, "City 17");
	Format(g_strCampaignName[14], 32, "Death Aboard 2");
	Format(g_strCampaignName[15], 32, "I Hate Mountains");
	Format(g_strCampaignName[16], 32, "Ravenholm 2");
	Format(g_strCampaignName[17], 32, "Diescraper35");
	Format(g_strCampaignName[18], 32, "7HoursLaterII");
	Format(g_strCampaignName[19], 32, "damitdc");
	Format(g_strCampaignName[20], 32, "FatalFreight");
	Format(g_strCampaignName[21], 32, "DeadbeatEscape");
	Format(g_strCampaignName[22], 32, "ElectionHell");
	Format(g_strCampaignName[23], 32, "One4Nine");
	Format(g_strCampaignName[24], 32, "hauntedforest");	
	Format(g_strCampaignName[25], 32, "beldurra2");	
	Format(g_strCampaignName[26], 32, "Beldurra");
	Format(g_strCampaignName[27], 32, "Blight Path");
	Format(g_strCampaignName[28], 32, "heavencanwait2");
	Format(g_strCampaignName[29], 32, "Strandead");	
	Format(g_strCampaignName[30], 32, "warcelona");	
	Format(g_strCampaignName[31], 32, "BadNeighborhood");
	Format(g_strCampaignName[32], 32, "TheHive");
	Format(g_strCampaignName[33], 32, "OttawaRockCity");
	Format(g_strCampaignName[34], 32, "RMSTitanic");
	Format(g_strCampaignName[35], 32, "OpenRoadICSX");
	Format(g_strCampaignName[36], 32, "SBTDTWO");
	Format(g_strCampaignName[37], 32, "fallindeath");
	Format(g_strCampaignName[38], 32, "darkwood");
	Format(g_strCampaignName[39], 32, "DeadSeries");
	Format(g_strCampaignName[40], 32, "deadvacation2");
	Format(g_strCampaignName[41], 32, "deathSentence");
	Format(g_strCampaignName[42], 32, "IC2");
	Format(g_strCampaignName[43], 32, "MIC2");
	Format(g_strCampaignName[44], 32, "urbanflight");
	Format(g_strCampaignName[45], 32, "NapalmDeath");
	Format(g_strCampaignName[46], 32, "lost");
	Format(g_strCampaignName[47], 32, "behind");
	Format(g_strCampaignName[48], 32, "CJTAZ0");
	Format(g_strCampaignName[49], 32, "BloodProof");
	Format(g_strCampaignName[50], 32, "AcerDkPsh");
	Format(g_strCampaignName[51], 32, "Escansion");
	Format(g_strCampaignName[52], 32, "CapeMurder");
	Format(g_strCampaignName[53], 32, "DeadCity2");	
	Format(g_strCampaignName[54], 32, "Overkill");
	Format(g_strCampaignName[55], 32, "Convoy");
	Format(g_strCampaignName[56], 32, "dbd2");
	Format(g_strCampaignName[57], 32, "VC1ub5");
	Format(g_strCampaignName[58], 32, "warcelona");
	Format(g_strCampaignName[59], 32, "VC2xy6");
	Format(g_strCampaignName[60], 32, "urbanflight");
	Format(g_strCampaignName[61], 32, "Pasiri");
	Format(g_strCampaignName[62], 32, "RoadToNowhere2");
	Format(g_strCampaignName[63], 32, "nomercyapoc2");
	Format(g_strCampaignName[64], 32, "crashcourseapoc");
	Format(g_strCampaignName[65], 32, "deathtollapoc");
	Format(g_strCampaignName[66], 32, "BloodWoods");	
	...
	Format(g_strScavengeMap[13], 32, "l4d_sv_deathaboard_ship");
	Format(g_strScavengeMap[14], 32, "l4d_deathaboard05_light");
	Format(g_strScavengeMap[15], 32, "l4d2_ff01_woods");
	Format(g_strScavengeMap[16], 32, "l4d2_ff02_factory");
	Format(g_strScavengeMap[17], 32, "l4d2_ff03_highway");
	Format(g_strScavengeMap[18], 32, "pd_electionhell");
	Format(g_strScavengeMap[19], 32, "pd_electionhell_daylight");
	Format(g_strScavengeMap[20], 32, "l4d2_diescraper3_mid_35");
	Format(g_strScavengeMap[21], 32, "l4d2_diescraper4_top_35");
	Format(g_strScavengeMap[21], 32, "rmstitanic_s1");
	Format(g_strScavengeMap[22], 32, "x1m6_aftermath");	
	Format(g_strScavengeMap[23], 32, "uf4_airfield");
	Format(g_strScavengeMap[24], 32, "bhm4_base");
	Format(g_strScavengeMap[25], 32, "c5m1_darkwaterfront");
	Format(g_strScavengeMap[26], 32, "c5m2_darkpark");
	Format(g_strScavengeMap[27], 32, "c5m3_darkcemetery");
	Format(g_strScavengeMap[28], 32, "uf4_airfield");	
	...
	Format(g_strScavengeMapName[13], 32, "Ship Scavenge");
	Format(g_strScavengeMapName[14], 32, "Lighthouse Scavenge");
	Format(g_strScavengeMapName[15], 32, "Backlot");
	Format(g_strScavengeMapName[16], 32, "Flood Gate");	
	Format(g_strScavengeMapName[17], 32, "Depot");
	Format(g_strScavengeMapName[18], 32, "Election Hell Scavenge");
	Format(g_strScavengeMapName[19], 32, "Election Hell Scavenge Daylight");
	Format(g_strScavengeMapName[20], 32, "The Skymall");
	Format(g_strScavengeMapName[21], 32, "The top suites");	
	Format(g_strScavengeMapName[22], 32, "Boatdeck Scavenge");
	Format(g_strScavengeMapName[23], 32, "Airfield");
	Format(g_strScavengeMapName[24], 32, "Army Base");	
	Format(g_strScavengeMapName[25], 32, "The Dark Waterfront");
	Format(g_strScavengeMapName[26], 32, "The Dark Park");
	Format(g_strScavengeMapName[27], 32, "The Dark Cemetery");
	Format(g_strScavengeMapName[27], 32, "Airfield");
}
	...
	for(new iMapIndex = 0; iMapIndex < NUMBER_OF_CAMPAIGNS; iMapIndex++)
	{
		if(StrEqual(strCurrentMap, g_strCampaignLastMap[iMapIndex]) == true)
		{
			...
			if(g_bVotingEnabled == true && g_iWinningMapVotes > 0 && g_iWinningMapIndex >= 0)
			{
				...
				{
					PrintToChatAll("\x03[ACS] \x01Switching campaign to the winning vote: \x04%s", g_strCampaignName[g_iWinningMapIndex]);
			...
			{
				PrintToChatAll("\x03[ACS] \x01Switching campaign to: \x04%s", g_strCampaignName[iMapIndex + 1]);
...
DisplayNextMapToAll()
{
	...
	if(g_iWinningMapIndex >= 0)
	{
		...
		else if(g_iNextMapAdDisplayMode == DISPLAY_MODE_CHAT)
		{
			...
			if(g_iGameMode == GAMEMODE_SCAVENGE)
				PrintToChatAll("\x03[ACS] \x01The next map is: \x04%s. \x01Type \x05!mapvote \x01to vote.", g_strScavengeMapName[g_iWinningMapIndex]);
			else
				PrintToChatAll("\x03[ACS] \x01The next campaign is: \x04%s. \x01Type \x05!mapvote \x01to vote.", g_strCampaignName[g_iWinningMapIndex]);
		}
	}
	else
	{
		...
		if(g_iGameMode == GAMEMODE_SCAVENGE)
		{
			...
			if(StrEqual(strCurrentMap, g_strScavengeMap[LastSM]) == true)
			{
				...
				if(g_iNextMapAdDisplayMode == DISPLAY_MODE_HINT)
					...
					PrintToChatAll("\x03[ACS] \x01The next map is: \x04%s. \x01Type \x05!mapvote \x01to vote.", g_strScavengeMapName[0]);
			}
			else
			{
				//Go through all maps and to find which map index it is on, and then switch to the next map
				for(new iMapIndex = 0; iMapIndex < NUMBER_OF_SCAVENGE_MAPS; iMapIndex++)
				{
					...
					{	
						...
						if(g_iNextMapAdDisplayMode == DISPLAY_MODE_HINT)
							...
							PrintToChatAll("\x03[ACS] \x01The next map is: \x04%s. \x01Type \x05!mapvote \x01to vote.", g_strScavengeMapName[iMapIndex + 1]);
					}
				}
			}
		}
...
public Action:MapVote(iClient, args)
{
	...
	{
		PrintToChat(iClient, "\x03[ACS] \x01Voting has been disabled on this server.");
		return;
	}
	
	if(OnFinaleOrScavengeMap() == false)
	{
		PrintToChat(iClient, "\x03[ACS] \x01Voting is enabled only for scavenge maps or campaign finales.");
		return;
	}
...
public Action:DisplayCurrentVotes(iClient, args)
{
	...
	{
		if(g_iGameMode == GAMEMODE_SCAVENGE)
			PrintToChat(iClient, "\x03[ACS] \x01The current winning map: \x04%s", g_strScavengeMapName[g_iWinningMapIndex]);
		else
			PrintToChat(iClient, "\x03[ACS] \x01The current winning campaign: \x04%s", g_strCampaignName[g_iWinningMapIndex]);
	}
	else
		PrintToChat(iClient, "\x03[ACS] \x01Nobody has voted yet.");
...
SetTheCurrentVoteWinner()
{
	...
	if(g_iWinningMapIndex > -1 && iOldWinningMapIndex != g_iWinningMapIndex)
	{
		...
		if(g_iGameMode == GAMEMODE_SCAVENGE)
			PrintToChatAll("\x03[ACS] \x04%s \x01is now the winning map.", g_strScavengeMapName[g_iWinningMapIndex]);
		else
			PrintToChatAll("\x03[ACS] \x04%s \x01is now the winning campaign.", g_strCampaignName[g_iWinningMapIndex]);
	}
}
