...
public void OnEntityCreated(int entity, const char[] classname)
{
	if (entity != -1 && IsValidEntity(entity))
	{
		...
		else if (g_bAllowHook && g_fCvarTimer && (strcmp(classname, OXYGENTANK) == 0 || strcmp(classname, FIREWORKCRATE) == 0 || strcmp(classname, PROPANETANK) == 0 || strcmp(classname, GASCAN) == 0))
		{
...
public Action PF_t_RecreateThis(Handle timer, any entity)
{
	...
	if (strcmp(sTemp, OXYGENTANK_MODEL) == 0 || strcmp(sTemp, FIREWORKCRATE_MODEL) == 0 || strcmp(sTemp, PROPANETANK_MODEL) == 0 || strcmp(sTemp, GASCAN_MODEL) == 0)
	{
#if debug
