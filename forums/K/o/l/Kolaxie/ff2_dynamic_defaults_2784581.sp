...
public void DMM_ResetWeapon(int clientIdx) // also an exposed interface
{
	...
	int weapon = FF2_SpawnWeapon(clientIdx, weaponName, weaponIdx, 101, 5, weaponArgs, view_as<bool>(weaponVisibility));
...
public void DP_SetTempWeapon(int clientIdx, bool shouldRemove)
{
	...
	else
	{
		...
		int weapon = FF2_SpawnWeapon(clientIdx, weaponName, weaponIdx, 101, 5, weaponArgs, false);
