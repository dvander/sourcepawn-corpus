...
public OnPluginStart()
{
	...
	autohelp_ledge_duration = CreateConVar("autohelp_ledge_duration", "4", "AutoHelp duration for ledge grabs (setting higher than 4 will cause animation issues, higher than 5 will disable the animation)", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY);
