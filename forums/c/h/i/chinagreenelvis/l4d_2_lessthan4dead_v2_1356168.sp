...
public OnPluginStart() 
{
	...
	CommonsOnePlayer = CreateConVar("l4d_2_lessthan4dead_v2_commonsoneplayer", "15", "Number of common infected for one player", FCVAR_PLUGIN);
	...
	CommonsThreePlayers = CreateConVar("l4d_2_lessthan4dead_v2_commonsthreeplayers", "25", "Number of common infected for three players", FCVAR_PLUGIN);
	CommonsFourPlayers = CreateConVar("l4d_2_lessthan4dead_v2_commonsfourplayers", "30", "Number of common infected for four players", FCVAR_PLUGIN);
