...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_changemode_competitive", ChangeModeCompetitive, ADMFLAG_CHANGEMAP, "Sets the mode to competitive.");
	RegAdminCmd("sm_changemode_armsrace", ChangeModeArmsrace, ADMFLAG_CHANGEMAP, "Sets the mode to arms race.");
...
public Action:ChangeModeCompetitive(client, args)
{
	...
	SetConVarString(FindConVar("mapcyclefile"), "mapcycle_competitive.txt");
