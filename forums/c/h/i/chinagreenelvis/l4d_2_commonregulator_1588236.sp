...
new Handle:lt4d_z_commons = INVALID_HANDLE;
new Handle:lt4d_z_commons_background = INVALID_HANDLE;
new Handle:lt4d_z_megamob = INVALID_HANDLE;
new Handle:lt4d_z_mobmin = INVALID_HANDLE;
new Handle:lt4d_z_mobmax = INVALID_HANDLE;

public OnPluginStart() 
{
	lt4d_z = CreateConVar("lt4d_z", "1", "Allow common infected regulation? 1: Yes, 0: No", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY);
	lt4d_z_commons = CreateConVar("lt4d_z_commons", "30", "Common infected limit for four players", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY);
	lt4d_z_commons_background = CreateConVar("lt4d_z_commons_background", "20", "Background number of common infected for four players", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY);
	lt4d_z_megamob = CreateConVar("lt4d_z_megamob", "50", "Mega-mob size for four players", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY)
	lt4d_z_mobmin = CreateConVar("lt4d_z_mobmin", "10", "Minimum mob spawn size for four players", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY);
	lt4d_z_mobmax = CreateConVar("lt4d_z_mobmax", "30", "Maximum mob spawn size for four players", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY);
...
SetDifficulty()
{
	...
	new commonlimit = survivors * RoundToCeil(float((GetConVarInt(lt4d_z_commons)) / 4));
	new backgroundlimit = survivors * RoundToCeil(float((GetConVarInt(lt4d_z_commons_background)) / 4));
	new megamobsize = survivors * RoundToCeil(float((GetConVarInt(lt4d_z_megamob)) / 4));
	new mobminnotify = survivors * RoundToCeil(float((GetConVarInt(lt4d_z_mobmin)) / 4));
	new mobminsize = survivors * RoundToCeil(float((GetConVarInt(lt4d_z_mobmin)) / 4));
	new mobmaxsize = survivors * RoundToCeil(float((GetConVarInt(lt4d_z_mobmax)) / 4));
