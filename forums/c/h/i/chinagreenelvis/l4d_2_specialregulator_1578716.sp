...
{	
	specialregulator_announce = CreateConVar("specialregulator_announce", "1", "Announce special spawn activity in the server console? 0:no, 1:yes", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY);
