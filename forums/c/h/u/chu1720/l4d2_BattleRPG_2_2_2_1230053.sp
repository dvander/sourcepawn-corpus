...
new ClientJobLevel[MAXPLAYERS+1]
...
new Handle:TGiveTimedItems[MAXPLAYERS+1]
...
public OnPluginStart()
{
	...
	//RegAdminCmd("rpgkit_resetjob",CmdResetJob,ADMFLAG_KICK,"rpgkit_spy [#userid|name]")
	//RegAdminCmd("rpgkit_resetsave",CmdResetSave,ADMFLAG_KICK,"rpgkit_spy [#userid|name]")
...
CreateCvars()
{
	...
	CfgExpJockeyKilled = CreateConVar("rpgkit_cfg_exp_jockey_killed","210","EXP that Jockey gives", FCVAR_PLUGIN)
	CfgExpHunterKilled = CreateConVar("rpgkit_cfg_exp_hunter_killed","220", "EXP that Hunter gives", FCVAR_PLUGIN)
	CfgExpChargerKilled = CreateConVar("rpgkit_cfg_exp_charger_killed","240","EXP that Charger gives", FCVAR_PLUGIN)
	CfgExpSmokerKilled = CreateConVar("rpgkit_cfg_exp_smoker_killed","190","EXP that Smoker gives", FCVAR_PLUGIN)
	CfgExpSpitterKilled = CreateConVar("rpgkit_cfg_exp_spitter_killed","170","EXP that Spitter gives", FCVAR_PLUGIN)
	CfgExpBoomerKilled = CreateConVar("rpgkit_cfg_exp_boomer_killed","150","EXP that Boomer gives", FCVAR_PLUGIN)
	CfgExpWitchKilled = CreateConVar("rpgkit_cfg_exp_witch_killed","350","EXP that Witch gives", FCVAR_PLUGIN)
	...
	CfgJobReqLevel[8] = CreateConVar("rpgkit_cfg_job_reqlevel_8","35","ReqLevel of Pyrotechnical", FCVAR_PLUGIN)
	...
	CfgJobReqLevel[11] = CreateConVar("rpgkit_cfg_job_reqlevel_11","100","ReqLevel of Ninja", FCVAR_PLUGIN)
	CfgJobReqLevel[12] = CreateConVar("rpgkit_cfg_job_reqlevel_12","150","ReqLevel of General", FCVAR_PLUGIN)
	CfgJobReqLevel[13] = CreateConVar("rpgkit_cfg_job_reqlevel_13","200","ReqLevel of F**k Me IM FAMOUS", FCVAR_PLUGIN)
	...
	CfgJobCash[8] = CreateConVar("rpgkit_cfg_job_cash_8","9","Cash/Payout of Pyrotechnical", FCVAR_PLUGIN)
	...
	CfgJobCash[11] = CreateConVar("rpgkit_cfg_job_cash_11","15","Cash/Payout of Ninja", FCVAR_PLUGIN)
	CfgJobCash[12] = CreateConVar("rpgkit_cfg_job_cash_12","20","Cash/Payout of General", FCVAR_PLUGIN)
	CfgJobCash[13] = CreateConVar("rpgkit_cfg_job_cash_13","30","Cash/Payout of F**k Me IM FAMOUS", FCVAR_PLUGIN)
	...
	CfgJobHealthBasis[8] = CreateConVar("rpgkit_cfg_job_health_basis_8","180","Basis Health of Pyrotechnical", FCVAR_PLUGIN)
	...
	CfgJobHealthBasis[11] = CreateConVar("rpgkit_cfg_job_health_basis_11","250","Basis Health of Ninja", FCVAR_PLUGIN)
	CfgJobHealthBasis[12] = CreateConVar("rpgkit_cfg_job_health_basis_12","280","Basis Health of General", FCVAR_PLUGIN)
	CfgJobHealthBasis[13] = CreateConVar("rpgkit_cfg_job_health_basis_13","300","Basis Health of F**k Me IM FAMOUS", FCVAR_PLUGIN)
	...
	CfgJobHealthBonus[8] = CreateConVar("rpgkit_cfg_job_health_bonus_8","8","Bonus Health of Pyrotechnical", FCVAR_PLUGIN)
	...
	CfgJobHealthBonus[11] = CreateConVar("rpgkit_cfg_job_health_bonus_11","11","Bonus HP of Ninja", FCVAR_PLUGIN)
	CfgJobHealthBonus[12] = CreateConVar("rpgkit_cfg_job_health_bonus_12","12","Bonus HP of General", FCVAR_PLUGIN)
	CfgJobHealthBonus[13] = CreateConVar("rpgkit_cfg_job_health_bonus_13","13","Bonus HP of F**k Me IM FAMOUS", FCVAR_PLUGIN)
	...
	CfgJobAgility[8] = CreateConVar("rpgkit_cfg_job_agility_8","3","Agility of Pyrotechnical", FCVAR_PLUGIN)
	...
	CfgJobAgility[11] = CreateConVar("rpgkit_cfg_job_agility_11","5","Agility of Ninja", FCVAR_PLUGIN)
	CfgJobAgility[12] = CreateConVar("rpgkit_cfg_job_agility_12","6","Agility of General", FCVAR_PLUGIN)
	CfgJobAgility[13] = CreateConVar("rpgkit_cfg_job_agility_13","7","Agility of F**k Me IM FAMOUS", FCVAR_PLUGIN)
	...
	CfgJobStrength[8] = CreateConVar("rpgkit_cfg_job_strength_8","6","Strength of Pyrotechnical", FCVAR_PLUGIN)
	...
	CfgJobStrength[11] = CreateConVar("rpgkit_cfg_job_strength_11","8","Strength of Ninja", FCVAR_PLUGIN)
	CfgJobStrength[12] = CreateConVar("rpgkit_cfg_job_strength_12","8","Strength of General", FCVAR_PLUGIN)
	CfgJobStrength[13] = CreateConVar("rpgkit_cfg_job_strength_13","10","Strength of F**k Me IM FAMOUS", FCVAR_PLUGIN)
	...
	CfgJobEndurance[8] = CreateConVar("rpgkit_cfg_job_endurance_8","5","Endurance of Pyrotechnical", FCVAR_PLUGIN)
	...
	CfgJobEndurance[11] = CreateConVar("rpgkit_cfg_job_endurance_11","7","Endurance of Ninja", FCVAR_PLUGIN)
	CfgJobEndurance[12] = CreateConVar("rpgkit_cfg_job_endurance_12","8","Endurance of General", FCVAR_PLUGIN)
	CfgJobEndurance[13] = CreateConVar("rpgkit_cfg_job_endurance_13","10","Endurance of F**k Me IM FAMOUS", FCVAR_PLUGIN)
}
/* Commands */
...
public Action:RunOnPlayerSpawnFirst(Handle:event, String:event_name[], bool:dontBroadcast)
{
	...
	if(target != 0)
	{
		...
		if(!IsFakeClient(target))	ClientSaveToFileLoad(target)
	}
}
...
/* Run On Level Up */
public Action:RunOnLevelUp(targetid)
{
	/* Level */
	ClientLevel[targetid] += 1
	ClientJobLevel[targetid] += 1
	MsgLevelUp(targetid)
...
MsgPlayersSkills(client, targetid)
{
	...
	PrintToChat(client, "\x04[Battle-RPG] \x03Level: \x04%d\x03 JobLevel: \x04%d\x03", ClientLevel[targetid], ClientJobLevel[targetid])
...
ClientSaveToFileSave(targetid)
{
	...
	if(savetofilemode != 0)
	{
		...
		if(savetofilemode == 1)
		{
			GetClientName(targetid, cName, sizeof(cName))
		}
		...
		KvSetNum(kv, "Basic Level", ClientLevel[targetid])
		KvSetNum(kv, "Cash", ClientCash[targetid])
		KvRewind(kv)
...
ClientSaveToFileLoad(targetid)
{
	...
	if(savetofilemode != 0)
	{
		...
		KvJumpToKey(kv, cName, true)
		ClientLevel[targetid] = KvGetNum(kv, "Basic Level", 0)
		ClientCash[targetid] = KvGetNum(kv, "Cash", 0)
		CloseHandle(kv)
	}
}
	...
	if(ClientJob[targetid] != 0)
	{
		...
		if(GetConVarInt(CfgExpMode) == 1) // Subtract EXP
		{
			if(TargetEXP >= GetConVarInt(CfgExpLevelUp))
			{
				...
				RunOnLevelUp(targetid)
			}
		}
		if(GetConVarInt(CfgExpMode) == 2) // Keep EXP + multiply required EXP by job level
		{
			if(TargetEXP >= (GetConVarInt(CfgExpLevelUp)*(ClientJobLevel[targetid]+1)))
			{
				RunOnLevelUp(targetid)
			}
		}
...
public MenuHandler_JobConfirm(Handle:menu, MenuAction:action, client, itemNum)
{
	if(action == MenuAction_Select && itemNum == 0 && ClientLevel[client] >= GetJobReqLevel(ClientJobConfirm[client]) && ClientLockJob[client] == 0 && ClientJobConfirm[client] != 0)
	{
		...
		{
			TGiveTimedItems[client] = CreateTimer(GetConVarFloat(CfgItemsJobTimer), TimerGiveItems, client, TIMER_REPEAT)
		}
	}
