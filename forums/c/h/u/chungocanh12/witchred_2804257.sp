...
ConVar Cvar_VomitWitchHealth, Cvar_BlackWitchHealth, Cvar_IceWitchHealth, Cvar_FireWitchHealth, Cvar_GreenWitchHealth, Cvar_PurpleWitchHealth;
bool IsLeft4Dead2, VomitWitch, BlackWitch, IceWitch, FireWhite, GreenWitch, PurpleWitch;
...
void CreateEffects(int witch, int Index)
{
	...
	switch (Index)	
	{
		...
		case 6:
		{
			int PurpleWitchHealth = Cvar_PurpleWitchHealth.IntValue;
