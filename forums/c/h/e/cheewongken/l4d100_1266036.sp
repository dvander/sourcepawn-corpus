...
GameModeCheck()
{
	...
	if (StrEqual(GameName, "survival", false))
		...
		g_GameMode = 2;
	else if (StrEqual(GameName, "coop", false) || StrEqual(GameName, "realism", false) || StrEqual(GameName, "mutation3", false) || StrEqual(GameName, "mutation9", false) || StrEqual(GameName, "mutation1", false) || StrEqual(GameName, "mutation7", false) || StrEqual(GameName, "mutation10", false) || StrEqual(GameName, "mutation14", false))
		g_GameMode = 1;
	else
	{
		g_GameMode = 0;
...
{
	if (g_GameMode == 0 && GetConVarBool(g_h_Activate))
	{
