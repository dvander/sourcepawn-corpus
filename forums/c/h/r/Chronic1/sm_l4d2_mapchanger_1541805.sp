...
public OnPluginStart()
{
	...
	DefM = CreateConVar("sm_l4d_fmc_def", "c11m1_greenhouse", "Mission for change by default.");
	...
	ChDelayCOOP = CreateConVar("sm_l4d_fmc_chdelaycoop", "0.0", "Delay before coop/realism/mutations mission change (float in sec).");
