...
public void OnPluginStart()
{
	...
	SIHealthAdjust = CreateConVar("director_si_health_auto","1","Enable SI health to be adjusted. Requires director_auto_difficulty 1", CVAR_FLAGS,true,0.0,true,1.0);
...
void AutoDifficultyCheck()
{
	...
	if(!InfectedAllowed && SiSpMore.BoolValue && l4dt() && !StrEqual(gameMode, "survival,mutation15")) // Not in survival modes, versus, scavenge or realism versus, l4dt required
	{
		...
		MaxSpecials = 4 + RoundToNearest(extrasurvivors * SiSpMore.FloatValue);
