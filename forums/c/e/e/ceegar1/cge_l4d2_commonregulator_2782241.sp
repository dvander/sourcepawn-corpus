...
new Handle:commonregulator_mobfinale = INVALID_HANDLE;
...
public OnPluginStart() 
{
	...
	commonregulator_mobfinale = CreateConVar("commonregulator_mobfinale", "20", "Finale mob spawn size for four players", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY);
...
SetDifficulty()
{
	...
	new mobfinalesize = survivors * RoundToCeil(float((GetConVarInt(commonregulator_mobfinale)) / 4));
	...
	SetConVarInt(FindConVar("z_mob_spawn_finale_size"), mobfinalesize);
}
