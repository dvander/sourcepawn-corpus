...
public EventShoveEntity(Handle:Event, const String:Name[], bool:Broadcast)
{
	...
	if(Ent > 0 && IsValidEntity(Ent) && IsValidEdict(Ent))
	{
		...
		if(StrEqual(class, "infected") || StrEqual(class, "witch") || StrEqual(class, "player"))
		{
			//Tissue:
			Roll = GetRandomInt(1, 100);
...
public Plugin:myinfo = 
{
	...
	//Initialize:
	name = "L4D2 Gore",
	author = "DiscoBBQ, CAPS LOCK FUCK YEAH",
	description = "Adds blood and gore, Fixed for l4d2",
	version = "2.4",
...
public OnPluginStart()
{
	...
	//Register:
	PrintToServer("[SM] L4D2 Gore v2.4 by DiscoBBQ and CAPS LOCK FUCK YEAH loaded!");
	...
	//Tracking:
	CreateConVar("l4dgore_version", "2.4", "Base L4DGore Version", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_UNLOGGED|FCVAR_DONTRECORD|FCVAR_REPLICATED|FCVAR_NOTIFY);
}
