...
public Plugin:dispenser_music =
{
  ...
  url = "https://forums.alliedmods.net/showthread.php?t=219800"
}
...
public OnPluginStart()
{
	...
	CreateConVar("sm_dispenser_music_version", PLUGIN_VERSION,
		"The version of the Dispenser Music plugin.", FCVAR_SPONLY | FCVAR_DONTRECORD | FCVAR_NOTIFY | FCVAR_REPLICATED);
