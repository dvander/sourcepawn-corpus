...
public OnPluginStart()
{
	...
	HookEvent("player_left_start_area",LeftStart);
	HookEvent("round_end",RoundEnd);
	HookEvent("map_transition",NewMap);
...
public Action:LeftStart(Handle:event, String:event_name[], bool:dontBroadcast)
{
	startspawn = 1;
}
...
public Action:NewMap(Handle:event, String:event_name[], bool:dontBroadcast)
{
	startspawn = 0;
}
