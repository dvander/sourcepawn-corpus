...
public OnPluginStart()
{
	...
	RegAdminCmd("hordemod_offend_player", Command_Offend, Admin_Cheats, "Add Offensive-class effects/powerups to the specified player");
	RegAdminCmd("hordemod_defend_player", Command_Defend, Admin_Cheats, "Add Defensive-class effects/powerups to the specified player");
}
...
public OnMapEnd()
{
	UnhookEvent("player_death", Event_Dead, EventHookMode_Pre);
	...
	UnhookEvent("teamplay_setup_finished", Event_SetupEnd, EventHookMode_Post);
...
public PrepareMediGun(client)
{
	...
	TF2Items_SetAttribute(handleMedigun, 0, 8, 0.6); //Faster Heal rate
...
public Action:Event_ChangeClass(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	new ClientID = GetClientOfUserId(UID);
	new Team = GetClientTeam(ClientID);

	if(RoundStart && Team == _:TFTeam_Red)
	{
