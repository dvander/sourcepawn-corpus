...
public Plugin:myinfo =
{
	...
	author = "chundo (Modded by Calystos)",
...
public OnPluginStart() {
	...
	RegConsoleCmd("sm_helpmenu_reload", Command_HelpMenuReload, "Reparse and reload the help menu config.", FCVAR_PLUGIN);
...
public Action:Command_HelpMenuReload(client, args) {
	new String:hc[PLATFORM_MAX_PATH];
	BuildPath(Path_SM, hc, sizeof(hc), "configs/helpmenu.cfg");
	ParseConfigFile(hc);
