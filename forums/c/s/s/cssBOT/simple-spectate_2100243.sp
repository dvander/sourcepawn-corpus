...
/*	Changelog:
	...
	1.2.3		Problem: Memory leaks persist but less frequent.
				Solution: Remove inclusion and load testing of dukehacks alltogether 
*/
#include <sdkhooks>						//v1.2.2 for DMG_FALL constant
...
public OnAllPluginsLoaded()
{
	...
	*/
	...
	Check for dukehacks
	*/
	g_aPluginSettings[bUseDukehacks] = false;		//v1.2.3 - Define duke hacks load status var false for all dependancies. 
