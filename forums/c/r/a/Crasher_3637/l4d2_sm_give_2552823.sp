...
{
	CreateConVar("l4d2_sm_give_version", PLUGIN_VERSION, "[L4D2] sm_give", FCVAR_PLUGIN | FCVAR_SPONLY | FCVAR_NOTIFY | FCVAR_DONTRECORD);
	g_Cvar_AdminsImmune = CreateConVar("l4d2_sm_give_adminsallowed", "1", "0 = Off | 1 = On -- Admins allowed to use command any time?");
	RegAdminCmd("sm_give", Cmd_SM_Give, ADMFLAG_ROOT, "sm_give [item_name] [item_name]");
	AutoExecConfig(true, "l4d2_sm_give");
}	
