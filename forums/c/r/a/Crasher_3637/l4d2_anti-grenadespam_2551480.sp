...
#define PLUGIN_DESCRIPTION "Blocks frequent use of molotovs, bile bombs, and pipe bombs."
...
public OnPluginStart()
{
	...
	vomitjar_timeout = CreateConVar("anti-grenadespam_vomitjar_timeout", "10.0", "Vomitjar timeout", FCVAR_PLUGIN);
	pipe_bomb_timeout = CreateConVar("anti-grenadespam_pipe_bomb_timeout", "5.0", "Pipe bomb timeout", FCVAR_PLUGIN);
	AutoExecConfig(true, "l4d2_anti-grenadespam");   
