...
public Action cmdSpawnInfected(int client, int args)
{
	...
	bIsL4D2Game() ? vInfectedMenu2(client, 0) : vInfectedMenu(client, 0);
	return Plugin_Handled;
}
...
public Action cmdSpawnWeapons(int client, int args)
{
	...
	bIsL4D2Game() ? vWeaponsMenu2(client, 0) : vWeaponsMenu(client, 0);
	return Plugin_Handled;
}
...
public Action cmdSpawnMelee(int client, int args)
{
	...
	bIsL4D2Game() ? vWeaponsMenu3(client, 0) : vWeaponsMenu(client, 0);
	return Plugin_Handled;
}
