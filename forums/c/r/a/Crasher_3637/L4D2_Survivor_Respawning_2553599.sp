...
{
	CreateConVar("l4d2_survivorrespawn_version", PLUGIN_VERSION, "Survivor Respawning Version", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);

	cvarEnable = CreateConVar("l4d2_survivorrespawn_enable", "1", "Enables Survivors to respawn automatically when incapped and/or killed (Def 1)", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	cvarEnableBot = CreateConVar("l4d2_survivorrespawn_enablebot", "1", "Allows Bots to respawn automatically when incapped and/or killed (Def 1)", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	cvarRespawnHanging = CreateConVar("l4d2_survivorrespawn_hanging", "0", "Survivors will be killed when hanging and respawn afterwards (Def 1)", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	cvarRespawnIncapped = CreateConVar("l4d2_survivorrespawn_incapped", "1", "Survivors will be killed when incapped and respawn afterwards (Def 1)", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	cvarRespawnRespect = CreateConVar("l4d2_survivorrespawn_limitenable", "1", "Enables the respawn limit for Survivors (Def 1)", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	cvarRespawnLimit = CreateConVar("l4d2_survivorrespawn_deathlimit", "2", "Amount of times a Survivor can respawn before permanently dying (Def 2)", FCVAR_PLUGIN, true, 0.0, false, _);
	cvarRespawnTimeout = CreateConVar("l4d2_survivorrespawn_respawntimeout", "10", "How many seconds till the Survivor respawns (Def 10)", FCVAR_PLUGIN, true, 0.0, false, _);
	cvarIncapDelay = CreateConVar("l4d2_survivorrespawn_incapdelay", "25", "How many seconds till the Survivor is killed after being incapacitated (Def 25)", FCVAR_PLUGIN, true, 0.0, false, _);
	cvarHangingDelay = CreateConVar("l4d2_survivorrespawn_hangingdelay", "25", "How many seconds till the Survivor is killed while hanging (Def 25)", FCVAR_PLUGIN, true, 0.0, false, _);
	...
	FirstWeapon = CreateConVar("l4d2_survivorrespawn_firstweapon", "1", "Which primary weapon will be given to the Survivor (1 - Autoshotgun, 2 - M16, 3 - Hunting Rifle, 4 - None)", FCVAR_PLUGIN, true, 0.0, false, _);
	SecondWeapon = CreateConVar("l4d2_survivorrespawn_secondweapon", "2", "Which secondary weapon will be given to the Survivor (1 - Bat, 2 - Dual Pistols, 3 - Magnum)", FCVAR_PLUGIN, true, 0.0, false, _);
	ThrownWeapon = CreateConVar("l4d2_survivorrespawn_thrownweapon", "4", "Which throwable will be given to the Survivor (1 - Molotov, 2 - Bile Jar, 3 - Pipe Bomb, 4 - None)", FCVAR_PLUGIN, true, 0.0, false, _);
	PrimeHealth = CreateConVar("l4d2_survivorrespawn_primehealth", "1", "Which carriable health unit will be given to the Survivor (1 - Medkit, 2 - Defib, 3 - None)", FCVAR_PLUGIN, true, 0.0, false, _);
	SecondaryHealth = CreateConVar("l4d2_survivorrespawn_secondaryhealth", "1", "Which medical supply will be given to the Survivor (1 - Pills, 2 - Adrenaline, 3 - None)", FCVAR_PLUGIN, true, 0.0, false, _);
