...
void populatePriceMap(){
	...
	hPriceMap.SetValue("medkit", FindConVar("l4d2_points_kit").IntValue, true);
	...
	hPriceMap.SetValue("silenced", FindConVar("l4d2_points_ssmg").IntValue, true);
	...
	hPriceMap.SetValue("ak47", FindConVar("l4d2_points_ak").IntValue, true);
	hPriceMap.SetValue("sg552", FindConVar("l4d2_points_sg").IntValue, true);
	hPriceMap.SetValue("m60", FindConVar("l4d2_points_m60").IntValue, true);

	// Snipers
	hPriceMap.SetValue("hunting", FindConVar("l4d2_points_hunting_rifle").IntValue, true);
	hPriceMap.SetValue("scout", FindConVar("l4d2_points_scout").IntValue, true);
	hPriceMap.SetValue("military", FindConVar("l4d2_points_military_sniper").IntValue, true);
	...
	// Melee
	hPriceMap.SetValue("baseball_bat", FindConVar("l4d2_points_bat").IntValue, true);
	...
	hPriceMap.SetValue("electric_guitar", FindConVar("l4d2_points_guitar").IntValue, true);
	hPriceMap.SetValue("fireaxe", FindConVar("l4d2_points_fireaxe").IntValue, true);
	hPriceMap.SetValue("frying_pan", FindConVar("l4d2_points_pan").IntValue, true);
...
public Action Cmd_Buy(int iClientIndex, int iNumArgs){
	...
	if(hItemMap.GetString(sPlayerInput, sPurchaseCmd, sizeof(sPurchaseCmd))){ // If an entry exists
		...
		else if(StrEqual(sPlayerInput, "gas", false)){
			decl String:sMapName[100]; sMapName[0] = '\0';

			GetCurrentMap(sMapName, 100);
			if(StrEqual(sMapName, "c1m4_atrium", false))
			if(StrEqual(sMapName, "c6m3_port", false))
				PrintToChat(iClientIndex, "[PS] This item is unavailable during this map");
		}
