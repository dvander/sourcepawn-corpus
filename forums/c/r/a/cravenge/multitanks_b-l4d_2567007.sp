...
int iMaxZombies, iFrustration[MAXPLAYERS+1], iMTHealthCoop[2], iMTHealthVersus[5], iMTHealthSurvival,
	iMTHealthScavenge, iMTCountCoop[2], iMTCountVersus[5], iMTCountSurvival, iFinaleWave, iTankHP,
...
ConVar hMTOn, hMTHealthCoop[2], hMTHealthVersus[5], hMTHealthSurvival, hMTCountCoop[2],
	hMTCountVersus[5], hMTCountSurvival, hMTAnnounce, hMTSameSpawn[3], hMTSpawnDelay[2], hMTDisplay,
	hGameMode;
