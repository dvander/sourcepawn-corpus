...
public void OnPluginStart()
{
	...
	cvarIBCDisableOnTanks = CreateConVar("infected_bots_control_disable_on_tanks", "1", "Enable/Disable Control On Tank Fights", FCVAR_NOTIFY|FCVAR_SPONLY);
...
void ResetCvarsDirector()
{
	...
	{
		FindConVar("z_hunter_limit").SetInt(3);
		FindConVar("z_smoker_limit").SetInt(2);
		FindConVar("z_boomer_limit").RestoreDefault();
		FindConVar("z_spitter_limit").RestoreDefault();
		FindConVar("z_jockey_limit").RestoreDefault();
		FindConVar("z_charger_limit").RestoreDefault();
