...
public Action:OnPounceOrChargerPummelEnd(Handle:event, const String:name[], bool:dontBroadcast)
{
...
new bool:bAlreadyChecked[MAXPLAYERS+1];
...
stock CollectGetUpAnimInfo(client, index_no)
{
	new playedGetUpAnim = 0;
...
stock CollectIncapAnimInfo(client, incap_type)
{
	new playedIncapAnim = 0;
	
	decl String:modelClient[PLATFORM_MAX_PATH];
