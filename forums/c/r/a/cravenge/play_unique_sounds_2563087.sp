...
{
	PrefetchSound("unique/midnightriders/badman.wav");
	PrecacheSound("unique/midnightriders/badman.wav", true);
	
	PrefetchSound("unique/midnightriders/midnightride.wav");
	PrecacheSound("unique/midnightriders/midnightride.wav", true);
