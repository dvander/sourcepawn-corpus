...
MapStatus msBase;
int iMaxZombies, iFrustration[MAXPLAYERS+1], iMTHealthCoop[2], iMTHealthVersus[5], iMTHealthSurvival,
	iMTHealthScavenge, iMTCountCoop[2], iMTCountVersus[5], iMTCountSurvival, iMTCountScavenge,
...
public void OnPluginStart()
{
	...
	hMTHealthSurvival = CreateConVar("multitanks_health_survival", "22500", "Health Of Tanks (Survival)", FCVAR_NOTIFY|FCVAR_SPONLY);
	hMTCountSurvival = CreateConVar("multitanks_count_survival", "2", "Total Count Of Tanks (Survival)", FCVAR_NOTIFY|FCVAR_SPONLY);
	hMTHealthScavenge = CreateConVar("multitanks_health_scavenge", "20000", "Health Of Tanks (Scavenge)", FCVAR_NOTIFY|FCVAR_SPONLY);
