...
public CreateCvars()
{
	...
	iron_bomber = CreateConVar("rank_iron_bomber_points","2","Points:Generic - The Iron Bomber");
	ai_flamethrower = CreateConVar("rank_ai_flamethrower_points","2","Points:Generic - The AI Flamethrower");
